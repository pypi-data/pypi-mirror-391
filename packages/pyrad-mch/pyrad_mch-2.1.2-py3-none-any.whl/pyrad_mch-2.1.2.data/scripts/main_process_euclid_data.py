...
def main():
    ...
    parser.add_argument(
        "days", nargs="+", type=str, help="Dates to process. Format YYYYMMDD"
    )
    ...
    parser.add_argument(
        ...
        help=(
            "longitude of the points defining the perimeter of the area "
            + "of interest"
        ),
    )
    ...
    parser.add_argument(
        ...
        help=(
            "latitude of the points defining the perimeter of the area " + "of interest"
        ),
    )
    ...
    print(
        "====== EUCLID data processing started: %s"
    ...
    roi = {"lon": lon_list, "lat": lat_list}

    bin_edges_intens = np.arange(-100.0, 101.0, 1.0)
    ...
    for day in day_vec:
        ...
        figfname = plot_pos(
            lat_CG[intens_CG > 0.0],
            lon_CG[intens_CG > 0.0],
            intens_CG[intens_CG > 0.0],
            [figfname],
            cb_label="stroke intensity [kA]",
