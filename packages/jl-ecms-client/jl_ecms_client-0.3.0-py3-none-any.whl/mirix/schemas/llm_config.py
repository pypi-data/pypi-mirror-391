...
class LLMConfig(BaseModel):
    ...
    Attributes:
        ...
        extra_config (dict, optional): Additional configuration (e.g., custom headers for OpenAI-compatible endpoints).
    """
    ...
    # Additional configuration (e.g., custom headers for OpenAI-compatible endpoints)
    extra_config: Optional[dict] = Field(
        None,
        description="Additional configuration (e.g., custom headers for OpenAI-compatible endpoints like Intuit LXS)",
    )
