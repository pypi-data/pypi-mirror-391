...
Welcome to `cellarr-frame` contributor's guide.
...
If you experience bugs or general issues with `cellarr-frame`, please have a look
...
You can help improve `cellarr-frame` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`cellarr-frame` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `cellarr-frame`'s files. While this mechanism can
...
```
conda create -n cellarr-frame python=3 six virtualenv pytest pytest-cov
conda activate cellarr-frame
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/cellarr-frame.git
   cd cellarr-frame
   ```
...
5. Install [pre-commit]:
   ...
   `cellarr-frame` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/cellarr-frame
[issue tracker]: https://github.com/<USERNAME>/cellarr-frame/issues
