...
"""
PyGremlinBox MPL-2.0 - Supply chain security testing module.

This package is licenced under the Mozilla Public License v2.0 (MPL-2.0).
...
maintaining compliance with MPL-2.0 requirements.
"""
...
def get_package_metadata():
    ...
    return {
        ...
        "version": __version__,
        "licence": __licence__,
        "description": "Supply chain security testing module with MPL-2.0 licence",
        "spdx_licence_id": "MPL-2.0"
    }
