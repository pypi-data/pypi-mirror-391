...
class TestResponseNormalizer(unittest.TestCase):
    ...
    def test_normalize_credit_card_expiry_dates(self):
        ...
        self.assertEqual(data["payment-method"]["credit-card-expiry-date"]["month"], 5)
    ...
    def test_post_process_response_successful(self):
        ...
        self.assertEqual(result["payment-response"]["response"][0]["credit-card-expiry-date"]["month"], 5)
