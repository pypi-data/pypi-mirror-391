...
def test_multi_value_boolean(clean_db):
    ...
    class Config(Entity):
        flags = EntityFlags(type_name="config_bool")
        name: Name = Flag(Key)
...
def test_multi_value_integer(clean_db):
    ...
    class Student(Entity):
        flags = EntityFlags(type_name="student_scores")
        name: Name = Flag(Key)
...
def test_multi_value_string(clean_db):
    ...
    class Article(Entity):
        flags = EntityFlags(type_name="article_tags")
        name: Name = Flag(Key)
...
def test_multi_value_double(clean_db):
    ...
    class Experiment(Entity):
        flags = EntityFlags(type_name="experiment_measures")
        name: Name = Flag(Key)
...
def test_multi_value_date(clean_db):
    ...
    class Project(Entity):
        flags = EntityFlags(type_name="project_dates")
        name: Name = Flag(Key)
...
def test_multi_value_datetime(clean_db):
    ...
    class Log(Entity):
        flags = EntityFlags(type_name="log_timestamps")
        name: Name = Flag(Key)
...
def test_multi_value_datetimetz(clean_db):
    ...
    class Cluster(Entity):
        flags = EntityFlags(type_name="cluster_syncs")
        name: Name = Flag(Key)
...
def test_multi_value_decimal(clean_db):
    ...
    class Product(Entity):
        flags = EntityFlags(type_name="product_prices")
        name: Name = Flag(Key)
...
def test_multi_value_duration(clean_db):
    ...
    class Schedule(Entity):
        flags = EntityFlags(type_name="schedule_intervals")
        name: Name = Flag(Key)
