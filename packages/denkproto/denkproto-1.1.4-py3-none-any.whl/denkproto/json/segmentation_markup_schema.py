...
class Annotations(BaseModel):
    ...
    polygon_annotation: Optional[geometry_schema.Polygon] = None
    rectangle_annotation: Optional[geometry_schema.Rectangle] = None
...
class Annotations6(BaseModel):
    ...
    pen_annotation: Optional[PenAnnotation] = None
    pixel_annotation: Optional[PixelAnnotation] = None
    polygon_annotation: geometry_schema.Polygon
    rectangle_annotation: Optional[geometry_schema.Rectangle] = None
    sausage_annotation: Optional[SausageAnnotation] = None
...
class Annotations7(BaseModel):
    ...
    pixel_annotation: Optional[PixelAnnotation] = None
    polygon_annotation: Optional[geometry_schema.Polygon] = None
    rectangle_annotation: geometry_schema.Rectangle
    sausage_annotation: Optional[SausageAnnotation] = None
...
class SegmentationMarkup(BaseModel):
    ...
    thumbnail: Optional[geometry_schema.BinaryMask] = None
