...
class DockerfileRenderer:
    ...
    def render_dockerfile(
        ...
        try:
            ...
            if create_dockerignore:
                dockerignore_path = os.path.join(output_dir or os.path.dirname(output_path), ".dockerignore")
                self._create_dockerignore(dockerignore_path, dockerignore_entries)
    ...
    def _create_dockerignore(self, dockerignore_path: str, additional_entries: Optional[List[str]] = None) -> None:
        """
        ...
        try:
            ...
            if os.path.exists(dockerignore_path):
                logger.info(f".dockerignore already exists at: {dockerignore_path}, skipping creation")
                return
...
class DockerManager:
    ...
    def is_docker_available(self) -> Tuple[bool, str]:
        ...
        try:
            ...
            success_msg = f"Docker is available (Version: {docker_version}, API: {api_version})"
