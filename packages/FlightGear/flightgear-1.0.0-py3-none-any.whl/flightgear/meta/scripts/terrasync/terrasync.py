...
"""TerraSync client for maintaining FlightGear scenery mirrors."""
...
from flightgear.meta.terrasync.exceptions import (
    UserError, NetworkError, RepoDataError, InvalidDirIndexFile,
...
class TerraSync:
    ...
    def handleDirindexFile(self, dirindexFile):
        dirIndex = DirIndex.readFromFile(dirindexFile)
...
def parseCommandLine():
    ...
    parser.add_argument("-u", "--url", dest="url", metavar="URL",
                        default="https://flightgear.sourceforge.net/scenery",
