...
class VirtualPath:
    ...
    def parents(self):
        ...
        3
        >>> p.parents[0]
        flightgear.meta.terrasync.virtual_path.VirtualPath('/foo/bar')
        >>> p.parents[1]
        flightgear.meta.terrasync.virtual_path.VirtualPath('/foo')
        >>> p.parents[2]
        flightgear.meta.terrasync.virtual_path.VirtualPath('/')
    ...
    def withName(self, newName):
        ...
        >>> p.withName('setup.py')
        flightgear.meta.terrasync.virtual_path.VirtualPath('/foobar/downloads/setup.py')
    ...
    def withSuffix(self, newSuffix):
        ...
        >>> p = VirtualPath('/foobar/downloads/pathlib.tar.gz')
        >>> p.withSuffix('.bz2')
        flightgear.meta.terrasync.virtual_path.VirtualPath('/foobar/downloads/pathlib.tar.bz2')
        >>> p = VirtualPath('/foobar/README')
        >>> p.withSuffix('.txt')
        flightgear.meta.terrasync.virtual_path.VirtualPath('/foobar/README.txt')
