...
def make_mermaid_tools(project_dir: str):
    ...
    def mermaid_draw(
        ...
        """
        MERMAID GENERATOR ΓÇö CONTRACT FOR THE AGENT
        ...
        3) Double-check rules 1ΓÇô3 before returning.
        ...
        Examples (BAD ΓÇö do NOT produce)
        -------------------------------
        - Multi-line labels:
        D --> K[ReAct Agent
        (FEATURE_INSTR)]
    ...
    def mermaid_png(
        ...
        """
        MERMAID PNG RENDERER ΓÇö CONTRACT FOR THE AGENT
        ...
        When to use
        -----------
        Only after you have valid Mermaid text. If you arenΓÇÖt 100% sure the text follows
        ...
        B -- yes --> C[Do thing]
        B -- no --> D[Skip]
        Examples (INVALID ΓÇö fix before calling)
