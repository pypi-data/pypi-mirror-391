...
class JobQuestionnaireApi(object):
    ...
    def delete_job_questionnaire(self, job_id, questionnarie_id, x_ph_userid, **kwargs):  # noqa: E501
        """Delete Job Questionnarie  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_job_questionnaire(job_id, questionnarie_id, x_ph_userid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str job_id: jobId (required)
        :param str questionnarie_id: (required)
        :param str x_ph_userid: (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_job_questionnaire_with_http_info(job_id, questionnarie_id, x_ph_userid, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_job_questionnaire_with_http_info(job_id, questionnarie_id, x_ph_userid, **kwargs)  # noqa: E501
            return data

    def delete_job_questionnaire_with_http_info(self, job_id, questionnarie_id, x_ph_userid, **kwargs):  # noqa: E501
        """Delete Job Questionnarie  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_job_questionnaire_with_http_info(job_id, questionnarie_id, x_ph_userid, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['job_id', 'questionnarie_id', 'x_ph_userid']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        # verify the required parameter 'questionnarie_id' is set
        if ('questionnarie_id' not in params or
                params['questionnarie_id'] is None):
            raise ValueError("Missing the required parameter `questionnarie_id` when calling `delete_job_questionnaire`")  # noqa: E501
        # verify the required parameter 'x_ph_userid' is set
        if ('x_ph_userid' not in params or
                params['x_ph_userid'] is None):
        ...
        if 'job_id' in params:
            path_params['jobId'] = params['job_id']  # noqa: E501
        if 'questionnarie_id' in params:
            path_params['questionnarieId'] = params['questionnarie_id']  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/jobs/{jobId}/questionnarie/{questionnarieId}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
