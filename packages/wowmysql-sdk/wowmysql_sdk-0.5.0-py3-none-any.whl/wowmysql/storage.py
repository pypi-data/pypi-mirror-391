"""WowMySQL Storage SDK - S3 Storage management with automatic quota validation."""
...
class WowMySQLStorage:
    """
    WowMySQL Storage Client - Manage S3 storage with automatic quota validation.
    ...
    Example:
        ...
        ...     base_url="https://api.wowmysql.com"
        ... )
        >>> 
    ...
    def __init__(
        ...
        project_slug: str,
        api_key: str,
        base_url: str = "https://api.wowmysql.com",
        timeout: int = 60,
        verify_ssl: bool = True,
        auto_check_quota: bool = True
    ):
        """
        Initialize WowMySQL Storage client.
        
        Args:
            project_slug: Project slug (e.g., 'myproject')
            api_key: API key for authentication
            base_url: API base URL (default: https://api.wowmysql.com)
    ...
    def upload_file(
        ...
        Returns:
            Dict with upload result:
            {
                ...
                'file_size': 1024000,
                'bucket_name': 'wowmysql-project-123',
    ...
    def __repr__(self):
        return f"WowMySQLStorage(project={self.project_slug})"
