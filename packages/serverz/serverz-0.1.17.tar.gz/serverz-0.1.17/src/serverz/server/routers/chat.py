...
from serverz.core.chatbox import ChatBox
...
async def generate_llm_response(messages: str, stream: bool, model: str):
    """
    ...
    if not stream:
        ...
        async def stream_generator():
            ...
            async for word in chatbox.astream_product(messages = messages,
                                                            model=model):
...
async def list_models():
    ...
    available_models = [ModelCard(id=ModelCardName) for ModelCardName in chatbox.model_list]
