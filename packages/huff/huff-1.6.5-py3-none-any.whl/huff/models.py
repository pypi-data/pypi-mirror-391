...
def get_isochrones(
    ...
    for x, y in coords:
        ...
        if donut:
            isochrone_gdf = overlay_difference(
                ...
                sort_col = helper.ORS_SEGMENT_COL
                )
        ...
        isochrone_gdf = isochrone_gdf.rename(columns={helper.ORS_SEGMENT_COL: helper.DEFAULT_SEGMENTS_COL})
        
        if range_type == "time":
            isochrone_gdf[f"{helper.DEFAULT_SEGMENTS_COL_ABBREV}_min"] = isochrone_gdf[helper.DEFAULT_SEGMENTS_COL]/60
        if range_type == "distance":
            isochrone_gdf[f"{helper.DEFAULT_SEGMENTS_COL_ABBREV}_km"] = isochrone_gdf[helper.DEFAULT_SEGMENTS_COL]/1000        
    ...
    if range_type == "time":
        isochrones_gdf[f"{helper.DEFAULT_SEGMENTS_COL_ABBREV}_min"] = isochrones_gdf[f"{helper.DEFAULT_SEGMENTS_COL_ABBREV}_min"].astype(int)
    if range_type == "distance":
        isochrones_gdf[f"{helper.DEFAULT_SEGMENTS_COL_ABBREV}_km"] = isochrones_gdf[f"{helper.DEFAULT_SEGMENTS_COL_ABBREV}_km"].astype(int)
