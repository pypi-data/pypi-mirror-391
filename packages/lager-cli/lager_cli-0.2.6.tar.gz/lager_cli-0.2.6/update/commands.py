...
@click.option('--branch', default='main', help='Git branch to pull from (default: main)')
@click.option('--check-jlink', is_flag=True, help='Check for J-Link and offer to install if missing')
def update(ctx, box, dut, yes, skip_restart, branch, check_jlink):
    """
    ...
    Example:
        ...
        lager update --box JUL-3 --branch staging
    """
