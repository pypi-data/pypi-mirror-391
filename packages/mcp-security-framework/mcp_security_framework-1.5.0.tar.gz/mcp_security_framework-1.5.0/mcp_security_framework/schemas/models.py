...
class CertificateRole(str, Enum):
    ...
    def to_string(self) -> str:
        ...
        This method serializes a CertificateRole enum value to its string representation.
        Since CertificateRole inherits from str, this is equivalent to accessing .value,
        but provides a consistent API for serialization.
