...
class PrescriptionApi:
    ...
    def get_prescription_change_requests(
        self,
        prescription_id: StrictStr,
        completed: Annotated[Optional[StrictBool], Field(description="Whether the message has been completed or not")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param prescription_id: (required)
        :type prescription_id: str
        :param completed: Whether the message has been completed or not
        :type completed: bool
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
