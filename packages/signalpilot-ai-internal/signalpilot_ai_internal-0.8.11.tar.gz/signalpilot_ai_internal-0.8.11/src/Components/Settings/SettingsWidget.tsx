...
import { SessionTimer, SessionExpiredBanner } from './SessionTimer';
import { isCloudDemoSession } from '../../sessionUtils';
...
function SettingsContent({
  ...
  const [showExpiredBanner, setShowExpiredBanner] = React.useState<boolean>(false);
  const [isCloudSession] = React.useState<boolean>(isCloudDemoSession());
