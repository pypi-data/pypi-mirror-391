...
const simpleDemo: DemoMessage[] = [
  { role: 'user', content: 'Hello!' },
  { role: 'assistant', content: 'Hi! How can I help you today?' },
  { role: 'user', content: 'What can you do?' },
  { role: 'assistant', content: 'I can help you analyze data, write code, create visualizations, and more!' }
];
...
// ============================================
const dataAnalysisDemo: DemoMessage[] = [
  {
    role: 'user',
  ...
  },
  {
    role: 'assistant',
    content: [
      { type: 'text', text: 'I\'d be happy to help! Let me read your dataset first.' },
      {
        type: 'tool_use',
        id: 'tool_1',
  ...
  {
    role: 'assistant',
    content: 'I can see you have 150 rows of sales data. Let me create a visualization to show the trends.'
  },
  {
    role: 'assistant',
    content: [
  ...
  {
    role: 'assistant',
    content: 'Great! The chart shows your sales have been growing steadily over the past 6 months. Would you like me to calculate some statistics?'
  }
];
...
// ============================================
const debuggingDemo: DemoMessage[] = [
  {
    role: 'user',
  ...
  },
  {
    role: 'assistant',
    content: [
      { type: 'text', text: 'Of course! Let me read your cells to see what\'s going on.' },
      {
        type: 'tool_use',
        id: 'tool_1',
  ...
  {
    role: 'assistant',
    content: 'I see the issue - you\'re missing an import. Let me fix that for you.'
  },
  {
    role: 'assistant',
    content: [
  ...
  {
    role: 'assistant',
    content: 'Perfect! The cell ran successfully. The error was caused by the missing numpy import.'
  }
];
...
const mlDemo: DemoMessage[] = [
  ...
  {
    role: 'assistant',
    content: 'Excellent! Your model has a good R² score. You can now use it to make predictions.'
  }
];
...
// ============================================
const terminalDemo: DemoMessage[] = [
  {
    role: 'user',
  ...
  {
    role: 'assistant',
    content: 'Seaborn has been installed successfully! You can now import it in your notebook.'
  }
];
