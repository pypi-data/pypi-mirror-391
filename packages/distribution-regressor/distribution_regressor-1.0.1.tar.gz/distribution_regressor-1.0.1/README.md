...
- Fixed indexing bug in `uncertainty_quantification.py` example
- Added comprehensive example suite (4 examples total)
- Added examples README with documentation
- Updated all documentation with correct PyPI package name
