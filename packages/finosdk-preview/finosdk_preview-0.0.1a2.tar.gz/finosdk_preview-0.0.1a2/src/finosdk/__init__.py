...
def init(
    ...
    传参优先于环境变量。
    默认 base_url = http://127.0.0.1:8003/data_api, 无 token
    """
    ...
    resolved_base = base_url or env_base_new or env_base_old or "http://127.0.0.1:8003/data_api"
