...
class Client:
    ...
    def __init__(
        ...
        env_base = os.getenv("FINO_BASE_URL")  # e.g. https://api.finoview.com.cn/data_api
        env_token = os.getenv("FINO_API_KEY")
        self.base_url = (base_url or env_base or "https://api.finoview.com.cn/data_api").rstrip("/")
