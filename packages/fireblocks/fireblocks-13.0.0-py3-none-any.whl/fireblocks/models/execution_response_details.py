...
class ExecutionResponseDetails(BaseModel):
    ...
    oneof_schema_1_validator: Optional[LimitExecutionResponseDetails] = None
    # data type: MarketExecutionResponseDetails
    oneof_schema_2_validator: Optional[MarketExecutionResponseDetails] = None
    # data type: QuoteExecutionWithRequoteResponseDetails
    oneof_schema_3_validator: Optional[QuoteExecutionWithRequoteResponseDetails] = None
