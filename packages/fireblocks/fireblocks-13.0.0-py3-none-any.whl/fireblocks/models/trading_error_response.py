...
class TradingErrorResponse(BaseModel):
    """
    TradingErrorResponse
    """ # noqa: E501
    error: TradingErrorResponseError
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error": TradingErrorResponseError.from_dict(obj["error"]) if obj.get("error") is not None else None
        })
        return _obj
