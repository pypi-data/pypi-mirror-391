...
class PdfConverter(OWWidget):
    ...
    def setup_webengine(self):
        ...
        # Create a QWebEngineProfile with no caching
        profile = QWebEngineProfile(parent=self)
        profile.setCachePath("")  # disables disk cache
        profile.setPersistentStoragePath(
            ""
        )  # disables cookies, localStorage, IndexedDB
        ...
        self.view.setZoomFactor(0.8)
        # Connect the page loaded signal
