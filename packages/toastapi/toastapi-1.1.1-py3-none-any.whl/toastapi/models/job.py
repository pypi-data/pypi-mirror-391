...
class Job(BaseModel):
    ...
    deleted: Optional[StrictBool] = Field(default=None, description="If the job is deleted in the Toast platform. ")
    wage_frequency: Optional[StrictStr] = Field(default=None, description="An enumerated type specifying how to interpret the  default wage for this job. ", alias="wageFrequency")
    default_wage: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The default wage of the job. ", alias="defaultWage")
    tipped: Optional[StrictBool] = Field(default=None, description="Indicates whether the job receives gratuities (tips). ")
    code: Optional[StrictStr] = Field(default=None, description="A reference identifier for the job. ")
    __properties: ClassVar[List[str]] = ["guid", "entityType", "externalId", "createdDate", "modifiedDate", "title", "deleted", "wageFrequency", "defaultWage", "tipped", "code"]

    @field_validator('wage_frequency')
    def wage_frequency_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value

        if value not in set(['HOURLY', 'SALARY']):
            raise ValueError("must be one of enum values ('HOURLY', 'SALARY')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "wageFrequency": obj.get("wageFrequency"),
            "defaultWage": obj.get("defaultWage"),
            "tipped": obj.get("tipped"),
            "code": obj.get("code")
        })
        return _obj
