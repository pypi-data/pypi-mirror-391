...
class GuestReportingDataResponse(BaseModel):
    """
    ...
    restaurant_location_name: Optional[StrictStr] = Field(default=None, description="The restaurant's location name. ", alias="restaurantLocationName")
    restaurant_name: Optional[StrictStr] = Field(default=None, description="The restaurant's name. ", alias="restaurantName")
    __properties: ClassVar[List[str]] = ["cardFingerprint", "orderGuid", "paymentDate", "paymentGuid", "restaurantGuid", "restaurantLocationCode", "restaurantLocationName", "restaurantName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "cardFingerprint": obj.get("cardFingerprint"),
            ...
            "restaurantLocationCode": obj.get("restaurantLocationCode"),
            "restaurantLocationName": obj.get("restaurantLocationName"),
            "restaurantName": obj.get("restaurantName")
        })
        return _obj
