...
class URLs(BaseModel):
    ...
    """ # noqa: E501
    website: Optional[StrictStr] = Field(default=None, description="The primary website for the restaurant.")
    facebook: Optional[StrictStr] = Field(default=None, description="A Facebook™ page for the restaurant.")
    twitter: Optional[StrictStr] = Field(default=None, description="A Twitter™ handle for the restaurant.")
    order_online: Optional[StrictStr] = Field(default=None, description="A URL for the online ordering site for the restaurant.", alias="orderOnline")
    purchase_gift_card: Optional[StrictStr] = Field(default=None, description="A URL for the gift card purchasing site for the restaurant.", alias="purchaseGiftCard")
    check_gift_card: Optional[StrictStr] = Field(default=None, description="A URL for a site at which guests can find balances and other information about gift cards.", alias="checkGiftCard")
    __properties: ClassVar[List[str]] = ["website", "facebook", "twitter", "orderOnline", "purchaseGiftCard", "checkGiftCard"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "orderOnline": obj.get("orderOnline"),
            "purchaseGiftCard": obj.get("purchaseGiftCard"),
            "checkGiftCard": obj.get("checkGiftCard")
        })
        return _obj
