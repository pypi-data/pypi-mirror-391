...
class Hours(BaseModel):
    ...
    """ # noqa: E501
    start_time: Optional[StrictStr] = Field(default=None, description="The time of day that the service begins.", alias="startTime")
    end_time: Optional[StrictStr] = Field(default=None, description="The time of day that the service ends.", alias="endTime")
