...
class Delivery(BaseModel):
    ...
    """ # noqa: E501
    enabled: Optional[StrictBool] = Field(default=None, description="Indicates whether the restaurant has enabled the Toast delivery module. This value is `true` if the module has ever been enabled. The value _does not_ indicate that a restaurant is accepting delivery orders or that the restaurant is using the Toast delivery feature. ")
    radius: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The radius, in miles, of the delivery area for the restaurant. ")
    coordinates: Optional[StrictStr] = Field(default=None, description="The delivery area coordinates for the restaurant, encoded as a polyline using the Google polyline algorithm (https://github.com/mapbox/polyline). The delivery area coordinates are a JSON array of decimal degree latitude and longitude pairs. For example, `[[42.36083,-71.14798],[42.34028,-71.15673],[42.3272,-71.14386]]`. ")
    __properties: ClassVar[List[str]] = ["enabled", "radius", "coordinates"]
