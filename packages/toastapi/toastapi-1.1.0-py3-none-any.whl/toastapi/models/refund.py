...
class Refund(BaseModel):
    ...
    """ # noqa: E501
    refund_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The amount of the refund, excluding the tip.", alias="refundAmount")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tipRefundAmount": obj.get("tipRefundAmount"),
            "refundDate": obj.get("refundDate"),
            "refundBusinessDate": obj.get("refundBusinessDate"),
