...
class WeekSchedule(BaseModel):
    ...
    """ # noqa: E501
    monday: Optional[StrictStr] = Field(default=None, description="A key identifier for the `DaySchedule` object that represents the services and hours for the restaurant on this day of the week. ")
    tuesday: Optional[StrictStr] = Field(default=None, description="A key identifier for the `DaySchedule` object that represents the services and hours for the restaurant on this day of the week. ")
    wednesday: Optional[StrictStr] = Field(default=None, description="A key identifier for the `DaySchedule` object that represents the services and hours for the restaurant on this day of the week. ")
    thursday: Optional[StrictStr] = Field(default=None, description="A key identifier for the `DaySchedule` object that represents the services and hours for the restaurant on this day of the week. ")
    friday: Optional[StrictStr] = Field(default=None, description="A key identifier for the `DaySchedule` object that represents the services and hours for the restaurant on this day of the week. ")
    saturday: Optional[StrictStr] = Field(default=None, description="A key identifier for the `DaySchedule` object that represents the services and hours for the restaurant on this day of the week. ")
    sunday: Optional[StrictStr] = Field(default=None, description="A key identifier for the `DaySchedule` object that represents the services and hours for the restaurant on this day of the week. ")
