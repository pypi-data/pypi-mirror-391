...
class ErrorMessage(BaseModel):
    ...
    """ # noqa: E501
    status: Optional[StrictStr] = Field(default=None, description="The HTTP status code of the response. ")
    code: Optional[StrictInt] = Field(default=None, description="A numeric identifier for the error condition. ")
    message: Optional[StrictStr] = Field(default=None, description="A description of the error condition. ")
    message_key: Optional[StrictStr] = Field(default=None, description="Reserved for future use. ", alias="messageKey")
    field_name: Optional[StrictStr] = Field(default=None, description="Reserved for future use. ", alias="fieldName")
    link: Optional[StrictStr] = Field(default=None, description="The URL of a resource that provides more information about the error condition. ")
    request_id: Optional[StrictStr] = Field(default=None, description="The unique identifier of the HTTP request that your client sent to the Toast API. ", alias="requestId")
    developer_message: Optional[StrictStr] = Field(default=None, description="Additional detail about the error condition, if it is available. ", alias="developerMessage")
    errors: Optional[List[ErrorMessage]] = Field(default=None, description="A JSON array of `ErrorMessage` objects. ")
    can_retry: Optional[StrictStr] = Field(default=None, description="Reserved for future use. ", alias="canRetry")
    __properties: ClassVar[List[str]] = ["status", "code", "message", "messageKey", "fieldName", "link", "requestId", "developerMessage", "errors", "canRetry"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "developerMessage": obj.get("developerMessage"),
            "errors": [ErrorMessage.from_dict(_item) for _item in obj["errors"]] if obj.get("errors") is not None else None,
            "canRetry": obj.get("canRetry")
        })
        return _obj

# TODO: Rewrite to not use raise_errors
ErrorMessage.model_rebuild(raise_errors=False)
