...
class PaymentOptions(BaseModel):
    ...
    """ # noqa: E501
    delivery: Optional[DeliveryPaymentOptions] = None
    takeout: Optional[TakeoutPaymentOptions] = None
    cc_tip: Optional[StrictBool] = Field(default=None, description="enables credit card tips", alias="ccTip")
    __properties: ClassVar[List[str]] = ["delivery", "takeout", "ccTip"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of takeout
        if self.takeout:
            _dict['takeout'] = self.takeout.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "delivery": DeliveryPaymentOptions.from_dict(obj["delivery"]) if obj.get("delivery") is not None else None,
            "takeout": TakeoutPaymentOptions.from_dict(obj["takeout"]) if obj.get("takeout") is not None else None,
            "ccTip": obj.get("ccTip")
        })
        return _obj
