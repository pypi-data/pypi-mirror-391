...
class TestDiningOptionsApi(unittest.IsolatedAsyncioTestCase):
    """DiningOptionsApi unit test stubs"""

    async def asyncSetUp(self) -> None:
        self.api = DiningOptionsApi()

    async def asyncTearDown(self) -> None:
        await self.api.api_client.close()

    async def test_dining_options_get(self) -> None:
    ...
    async def test_dining_options_guid_get(self) -> None:
