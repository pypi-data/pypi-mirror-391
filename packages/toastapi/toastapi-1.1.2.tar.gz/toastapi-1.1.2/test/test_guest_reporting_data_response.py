...
class TestGuestReportingDataResponse(unittest.TestCase):
    """GuestReportingDataResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GuestReportingDataResponse:
        """Test GuestReportingDataResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GuestReportingDataResponse`
        """
        model = GuestReportingDataResponse()
        if include_optional:
            return GuestReportingDataResponse(
                card_fingerprint = '',
                order_guid = '',
                payment_date = 56,
                payment_guid = '',
    ...
    def testGuestReportingDataResponse(self):
        """Test GuestReportingDataResponse"""
