...
class TestCurbsidePickupInfo(unittest.TestCase):
    """CurbsidePickupInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CurbsidePickupInfo:
        """Test CurbsidePickupInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CurbsidePickupInfo`
        """
        model = CurbsidePickupInfo()
        if include_optional:
            return CurbsidePickupInfo(
                guid = '',
                entity_type = '',
                transport_color = '',
    ...
    def testCurbsidePickupInfo(self):
        """Test CurbsidePickupInfo"""
