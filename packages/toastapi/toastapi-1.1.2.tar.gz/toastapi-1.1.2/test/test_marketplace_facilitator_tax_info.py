...
class TestMarketplaceFacilitatorTaxInfo(unittest.TestCase):
    """MarketplaceFacilitatorTaxInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MarketplaceFacilitatorTaxInfo:
        """Test MarketplaceFacilitatorTaxInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MarketplaceFacilitatorTaxInfo`
        """
        model = MarketplaceFacilitatorTaxInfo()
        if include_optional:
            return MarketplaceFacilitatorTaxInfo(
                facilitator_collect_and_remit_tax_order = True,
                taxes = [
                    toastapi.models.applied_tax_rate.AppliedTaxRate()
                    ]
            )
        else:
            return MarketplaceFacilitatorTaxInfo(
    ...
    def testMarketplaceFacilitatorTaxInfo(self):
        """Test MarketplaceFacilitatorTaxInfo"""
