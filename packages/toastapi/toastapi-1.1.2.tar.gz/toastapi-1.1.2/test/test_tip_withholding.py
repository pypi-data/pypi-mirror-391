...
class TestTipWithholding(unittest.TestCase):
    """TipWithholding unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TipWithholding:
        """Test TipWithholding
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TipWithholding`
        """
        model = TipWithholding()
        if include_optional:
            return TipWithholding(
                guid = '',
                entity_type = '',
                enabled = True,
                percentage = 1.337
