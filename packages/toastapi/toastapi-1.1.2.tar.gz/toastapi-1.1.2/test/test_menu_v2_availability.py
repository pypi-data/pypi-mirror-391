...
class TestMenuV2Availability(unittest.TestCase):
    """MenuV2Availability unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MenuV2Availability:
        """Test MenuV2Availability
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MenuV2Availability`
        """
        model = MenuV2Availability()
        if include_optional:
            return MenuV2Availability(
    ...
    def testMenuV2Availability(self):
        """Test MenuV2Availability"""
