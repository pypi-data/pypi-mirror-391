...
class TestNoSaleReasonsApi(unittest.IsolatedAsyncioTestCase):
    """NoSaleReasonsApi unit test stubs"""

    async def asyncSetUp(self) -> None:
        self.api = NoSaleReasonsApi()

    async def asyncTearDown(self) -> None:
        await self.api.api_client.close()

    async def test_no_sale_reasons_get(self) -> None:
    ...
    async def test_no_sale_reasons_guid_get(self) -> None:
