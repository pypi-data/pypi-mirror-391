...
class TestMenuItemSimpleImagesInner(unittest.TestCase):
    """MenuItemSimpleImagesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MenuItemSimpleImagesInner:
        """Test MenuItemSimpleImagesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MenuItemSimpleImagesInner`
        """
        model = MenuItemSimpleImagesInner()
        if include_optional:
            return MenuItemSimpleImagesInner(
                url = ''
            )
        else:
            return MenuItemSimpleImagesInner(
    ...
    def testMenuItemSimpleImagesInner(self):
        """Test MenuItemSimpleImagesInner"""
