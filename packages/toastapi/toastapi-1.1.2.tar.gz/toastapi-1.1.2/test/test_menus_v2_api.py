...
class TestMenusV2Api(unittest.IsolatedAsyncioTestCase):
    """MenusV2Api unit test stubs"""
    ...
    async def test_menus_v2_get(self) -> None:
        """Test case for menus_v2_get

        Get menus (V2)
        """
        pass

    async def test_menus_v2_metadata_get(self) -> None:
        """Test case for menus_v2_metadata_get
