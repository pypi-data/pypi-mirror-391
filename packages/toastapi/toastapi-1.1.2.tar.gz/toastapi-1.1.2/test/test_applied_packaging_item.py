...
class TestAppliedPackagingItem(unittest.TestCase):
    """AppliedPackagingItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppliedPackagingItem:
        """Test AppliedPackagingItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppliedPackagingItem`
        """
        model = AppliedPackagingItem()
        if include_optional:
            return AppliedPackagingItem(
                guid = '',
                entity_type = '',
                item_config_id = '',
                inclusion = 'YES',
    ...
    def testAppliedPackagingItem(self):
        """Test AppliedPackagingItem"""
