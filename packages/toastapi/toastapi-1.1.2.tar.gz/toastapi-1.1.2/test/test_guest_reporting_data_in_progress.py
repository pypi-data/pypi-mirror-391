...
class TestGuestReportingDataInProgress(unittest.TestCase):
    """GuestReportingDataInProgress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GuestReportingDataInProgress:
        """Test GuestReportingDataInProgress
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GuestReportingDataInProgress`
        """
        model = GuestReportingDataInProgress()
        if include_optional:
            return GuestReportingDataInProgress(
                message = '',
                report_request_guid = '',
                report_status = ''
            )
    ...
    def testGuestReportingDataInProgress(self):
        """Test GuestReportingDataInProgress"""
