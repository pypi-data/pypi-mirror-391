...
class TestRestaurantBasic(unittest.TestCase):
    """RestaurantBasic unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RestaurantBasic:
        """Test RestaurantBasic
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RestaurantBasic`
        """
        model = RestaurantBasic()
        if include_optional:
