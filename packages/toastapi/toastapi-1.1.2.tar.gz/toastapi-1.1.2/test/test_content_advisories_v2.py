...
class TestContentAdvisoriesV2(unittest.TestCase):
    """ContentAdvisoriesV2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContentAdvisoriesV2:
        """Test ContentAdvisoriesV2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContentAdvisoriesV2`
        """
        model = ContentAdvisoriesV2()
        if include_optional:
            return ContentAdvisoriesV2(
                alcohol = toastapi.models.alcohol_v2.AlcoholV2(
    ...
    def testContentAdvisoriesV2(self):
        """Test ContentAdvisoriesV2"""
