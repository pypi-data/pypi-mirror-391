...
class TestMenuOptionGroup(unittest.TestCase):
    """MenuOptionGroup unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MenuOptionGroup:
        """Test MenuOptionGroup
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MenuOptionGroup`
        """
        ...
        if include_optional:
            return MenuOptionGroup(
                ...
                name = '',
                options = [
                    toastapi.models.external_reference.ExternalReference()
                    ],
                min_selections = 1.337,
                max_selections = 1.337
            )
        else:
            return MenuOptionGroup(
                guid = '',
