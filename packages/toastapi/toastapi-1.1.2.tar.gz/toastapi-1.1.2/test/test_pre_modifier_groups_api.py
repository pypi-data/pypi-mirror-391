...
class TestPreModifierGroupsApi(unittest.IsolatedAsyncioTestCase):
    """PreModifierGroupsApi unit test stubs"""

    async def asyncSetUp(self) -> None:
        self.api = PreModifierGroupsApi()

    async def asyncTearDown(self) -> None:
        await self.api.api_client.close()

    async def test_pre_modifier_groups_get(self) -> None:
    ...
    async def test_pre_modifier_groups_guid_get(self) -> None:
