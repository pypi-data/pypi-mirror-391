...
class TestOnlineOrdering(unittest.TestCase):
    """OnlineOrdering unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OnlineOrdering:
        """Test OnlineOrdering
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OnlineOrdering`
        """
        model = OnlineOrdering()
        if include_optional:
