...
class TestServiceChargeCriteria(unittest.TestCase):
    """ServiceChargeCriteria unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServiceChargeCriteria:
        """Test ServiceChargeCriteria
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ServiceChargeCriteria`
        """
        model = ServiceChargeCriteria()
        if include_optional:
            return ServiceChargeCriteria(
                min_check_amount = 1.337,
                delivery = True,
                max_check_amount = 1.337,
                min_delivery_distance = 1.337,
                takeout = True,
                dine_in = True
            )
        else:
    ...
    def testServiceChargeCriteria(self):
        """Test ServiceChargeCriteria"""
