...
class TestDiningOption(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DiningOption:
        """Test DiningOption
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DiningOption`
        """
        model = DiningOption()
        if include_optional:
            return DiningOption(
