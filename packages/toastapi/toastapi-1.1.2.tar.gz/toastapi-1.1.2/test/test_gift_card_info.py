...
class TestGiftCardInfo(unittest.TestCase):
    """GiftCardInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GiftCardInfo:
        """Test GiftCardInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GiftCardInfo`
        """
        model = GiftCardInfo()
        if include_optional:
            return GiftCardInfo(
