...
class TestMenusV3Api(unittest.IsolatedAsyncioTestCase):
    """MenusV3Api unit test stubs"""
    ...
    async def test_menus_v3_get(self) -> None:
        """Test case for menus_v3_get

        Get menus
        """
        pass

    async def test_menus_v3_metadata_get(self) -> None:
        """Test case for menus_v3_metadata_get
