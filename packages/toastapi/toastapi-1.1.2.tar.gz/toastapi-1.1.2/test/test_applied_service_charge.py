...
class TestAppliedServiceCharge(unittest.TestCase):
    """AppliedServiceCharge unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppliedServiceCharge:
        """Test AppliedServiceCharge
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppliedServiceCharge`
        """
        ...
        if include_optional:
            return AppliedServiceCharge(
                ...
                service_charge_calculation = 'PRE_DISCOUNT',
                refund_details = None,
                service_charge_category = 'SERVICE_CHARGE',
                payment_guid = ''
            )
        else:
            return AppliedServiceCharge(
    ...
    def testAppliedServiceCharge(self):
        """Test AppliedServiceCharge"""
