...
class TestPricingRules(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PricingRules:
        """Test PricingRules
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PricingRules`
        """
        model = PricingRules()
        if include_optional:
            return PricingRules(
                time_specific_pricing_rules = [
                    toastapi.models.time_specific_price.TimeSpecificPrice(
                        time_specific_price = 1.337, 
                        base_price = 1.337, 
                        schedule = [
                            toastapi.models.schedule.Schedule(
                                days = [
                                    'MONDAY'
                                    ], 
                                time_ranges = [
                                    toastapi.models.time_range.TimeRange(
                                        start = '', 
                                        end = '', )
                                    ], )
                            ], )
                ...
                size_sequence_pricing_rules = [
                    toastapi.models.size_sequence_pricing_rule.SizeSequencePricingRule(
                        size_name = '', 
                        size_guid = '', 
                        sequence_prices = [
                            toastapi.models.sequence_price.SequencePrice(
                                sequence = 56, 
                                price = 1.337, )
                            ], )
                    ]
