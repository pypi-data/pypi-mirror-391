...
class TestMenuGroupV2(unittest.TestCase):
    """MenuGroupV2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MenuGroupV2:
        """Test MenuGroupV2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MenuGroupV2`
        """
        model = MenuGroupV2()
        if include_optional:
            return MenuGroupV2(
