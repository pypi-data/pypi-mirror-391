...
class TestVoidReasonsApi(unittest.IsolatedAsyncioTestCase):
    """VoidReasonsApi unit test stubs"""

    async def asyncSetUp(self) -> None:
        self.api = VoidReasonsApi()

    async def asyncTearDown(self) -> None:
        await self.api.api_client.close()

    async def test_void_reasons_get(self) -> None:
    ...
    async def test_void_reasons_guid_get(self) -> None:
        """Test case for void_reasons_guid_get
