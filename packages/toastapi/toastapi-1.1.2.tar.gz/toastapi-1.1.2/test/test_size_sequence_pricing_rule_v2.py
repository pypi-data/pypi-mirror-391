...
class TestSizeSequencePricingRuleV2(unittest.TestCase):
    """SizeSequencePricingRuleV2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SizeSequencePricingRuleV2:
        """Test SizeSequencePricingRuleV2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SizeSequencePricingRuleV2`
        """
        model = SizeSequencePricingRuleV2()
        if include_optional:
            return SizeSequencePricingRuleV2(
                size_name = '',
                size_guid = '',
                sequence_prices = [
    ...
    def testSizeSequencePricingRuleV2(self):
        """Test SizeSequencePricingRuleV2"""
