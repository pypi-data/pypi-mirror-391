...
class TestServiceAreasApi(unittest.IsolatedAsyncioTestCase):
    """ServiceAreasApi unit test stubs"""

    async def asyncSetUp(self) -> None:
        self.api = ServiceAreasApi()

    async def asyncTearDown(self) -> None:
        await self.api.api_client.close()

    async def test_service_areas_get(self) -> None:
    ...
    async def test_service_areas_guid_get(self) -> None:
