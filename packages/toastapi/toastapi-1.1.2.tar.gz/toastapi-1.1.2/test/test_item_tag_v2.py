...
class TestItemTagV2(unittest.TestCase):
    """ItemTagV2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ItemTagV2:
        """Test ItemTagV2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ItemTagV2`
        """
        model = ItemTagV2()
        if include_optional:
            return ItemTagV2(
