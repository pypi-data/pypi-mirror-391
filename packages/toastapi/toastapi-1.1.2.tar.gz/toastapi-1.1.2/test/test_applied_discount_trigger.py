...
class TestAppliedDiscountTrigger(unittest.TestCase):
    """AppliedDiscountTrigger unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppliedDiscountTrigger:
        """Test AppliedDiscountTrigger
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppliedDiscountTrigger`
        """
        model = AppliedDiscountTrigger()
        if include_optional:
            return AppliedDiscountTrigger(
                selection = toastapi.models.external_reference.ExternalReference(),
                quantity = 1.337
            )
        else:
            return AppliedDiscountTrigger(
    ...
    def testAppliedDiscountTrigger(self):
        """Test AppliedDiscountTrigger"""
