...
class TestSizeSequencePricingRule(unittest.TestCase):
    """SizeSequencePricingRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SizeSequencePricingRule:
        """Test SizeSequencePricingRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SizeSequencePricingRule`
        """
        model = SizeSequencePricingRule()
        if include_optional:
            return SizeSequencePricingRule(
                size_name = '',
                size_guid = '',
                sequence_prices = [
    ...
    def testSizeSequencePricingRule(self):
        """Test SizeSequencePricingRule"""
