...
class TestAlternatePaymentTypesApi(unittest.IsolatedAsyncioTestCase):
    """AlternatePaymentTypesApi unit test stubs"""

    async def asyncSetUp(self) -> None:
        self.api = AlternatePaymentTypesApi()

    async def asyncTearDown(self) -> None:
        await self.api.api_client.close()

    async def test_alternate_payment_types_get(self) -> None:
    ...
    async def test_alternate_payment_types_guid_get(self) -> None:
