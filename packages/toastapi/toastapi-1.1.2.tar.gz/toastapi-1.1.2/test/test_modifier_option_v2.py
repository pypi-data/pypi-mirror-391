...
class TestModifierOptionV2(unittest.TestCase):
    """ModifierOptionV2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ModifierOptionV2:
        """Test ModifierOptionV2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ModifierOptionV2`
        """
        model = ModifierOptionV2()
        if include_optional:
            return ModifierOptionV2(
                reference_id = 56,
                name = '',
                guid = '',
                price = 1.337,
