...
class TestMenuItemV2(unittest.TestCase):
    """MenuItemV2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MenuItemV2:
        """Test MenuItemV2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MenuItemV2`
        """
        model = MenuItemV2()
        if include_optional:
            return MenuItemV2(
