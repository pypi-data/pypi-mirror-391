...
class TestTipWithholdingApi(unittest.IsolatedAsyncioTestCase):
    """TipWithholdingApi unit test stubs"""

    async def asyncSetUp(self) -> None:
        self.api = TipWithholdingApi()

    async def asyncTearDown(self) -> None:
        await self.api.api_client.close()

    async def test_tip_withholding_get(self) -> None:
        """Test case for tip_withholding_get
