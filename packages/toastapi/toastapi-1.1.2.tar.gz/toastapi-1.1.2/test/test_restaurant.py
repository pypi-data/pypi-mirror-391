    ...
    def make_instance(self, include_optional) -> Restaurant:
        ...
        if include_optional:
            return Restaurant(
                ...
                menus = [
                    toastapi.models.menu.Menu(
                        name = '', 
                        guid = '', 
                        description = '', 
                        menu_groups = [
                            toastapi.models.menu_group.MenuGroup(
                                name = '', 
                                guid = '', 
                                menu_items = [
                                    toastapi.models.menu_item.MenuItem(
                                        name = '', 
                                        guid = '', 
                                        price = 1.337, )
                                    ], )
                ...
                modifier_group_references = {
                    'key' : toastapi.models.modifier_group.ModifierGroup(
                        name = '', 
                        guid = '', 
                        reference_id = 56, 
                ...
                modifier_option_references = {
                    'key' : toastapi.models.modifier_option.ModifierOption(
                        name = '', 
                        guid = '', 
                        reference_id = 56, 
                        price = 1.337, )
                ...
                pre_modifier_group_references = {
                    'key' : toastapi.models.pre_modifier_group.PreModifierGroup(
                        name = '', 
                        guid = '', 
                        reference_id = 56, 
                        pre_modifiers = [
                            toastapi.models.pre_modifier.PreModifier(
                                name = '', 
                                guid = '', 
                                fixed_price = 1.337, 
                                display_mode = 'PREFIX', )
