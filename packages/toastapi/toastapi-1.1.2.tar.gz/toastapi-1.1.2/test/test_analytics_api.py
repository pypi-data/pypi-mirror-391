...
class TestAnalyticsApi(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_create_guest_reporting_data_request(self) -> None:
        """Test case for create_guest_reporting_data_request

        Post a guest reporting data request organized by payment for a specific time range
        """
        pass

    async def test_get_guest_reporting_data(self) -> None:
        """Test case for get_guest_reporting_data
