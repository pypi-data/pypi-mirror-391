...
class TestNoSaleReason(unittest.TestCase):
    """NoSaleReason unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NoSaleReason:
        """Test NoSaleReason
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NoSaleReason`
        """
        model = NoSaleReason()
        if include_optional:
            return NoSaleReason(
