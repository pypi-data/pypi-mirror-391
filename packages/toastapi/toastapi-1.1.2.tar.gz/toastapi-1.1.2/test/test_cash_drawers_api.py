...
class TestCashDrawersApi(unittest.IsolatedAsyncioTestCase):
    """CashDrawersApi unit test stubs"""

    async def asyncSetUp(self) -> None:
        self.api = CashDrawersApi()

    async def asyncTearDown(self) -> None:
        await self.api.api_client.close()

    async def test_cash_drawers_get(self) -> None:
    ...
    async def test_cash_drawers_guid_get(self) -> None:
