...
class TestDimensionUnitOfMeasureV2(unittest.TestCase):
    """DimensionUnitOfMeasureV2 unit test stubs"""
    ...
    def testDimensionUnitOfMeasureV2(self):
        """Test DimensionUnitOfMeasureV2"""
        # inst = DimensionUnitOfMeasureV2()
