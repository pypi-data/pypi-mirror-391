...
class TestRefundDetails(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> RefundDetails:
        """Test RefundDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RefundDetails`
        """
        model = RefundDetails()
        if include_optional:
            return RefundDetails(
                refund_amount = 1.337,
                tax_refund_amount = 1.337,
                refund_transaction = toastapi.models.toast_reference.ToastReference(
                    guid = '', 
                    entity_type = '', )
            )
        else:
