...
class TestAlcoholV2(unittest.TestCase):
    """AlcoholV2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AlcoholV2:
        """Test AlcoholV2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AlcoholV2`
        """
        model = AlcoholV2()
        if include_optional:
            return AlcoholV2(
