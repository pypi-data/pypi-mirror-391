...
class TestUpdateDeliveryInfoRequest(unittest.TestCase):
    """UpdateDeliveryInfoRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateDeliveryInfoRequest:
        """Test UpdateDeliveryInfoRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateDeliveryInfoRequest`
        """
        model = UpdateDeliveryInfoRequest()
        if include_optional:
    ...
    def testUpdateDeliveryInfoRequest(self):
        """Test UpdateDeliveryInfoRequest"""
