...
class DeliveryPaymentOptions(BaseModel):
    """
    Information about the forms of payment that the restaurant will accept for delivery orders. 
    """ # noqa: E501
    cash: Optional[StrictBool] = Field(default=None, description="Indicates whether the restaurant accepts cash payment for delivery orders that are placed online. ")
    cc_same_day: Optional[StrictBool] = Field(default=None, description="Indicates whether the restaurant accepts online credit card payment for delivery orders that are delivered on the same day. ", alias="ccSameDay")
    cc_future: Optional[StrictBool] = Field(default=None, description="Indicates whether the restaurant accepts online credit card payment for delivery orders that are to be delivered on a day after the guest places the order. ", alias="ccFuture")
    __properties: ClassVar[List[str]] = ["cash", "ccSameDay", "ccFuture"]
