...
class GuestReportingDataInProgress(BaseModel):
    """
    Response when the Toast platform is still processing the reporting data request. 
    """ # noqa: E501
    message: Optional[StrictStr] = Field(default=None, description="A brief message describing that the reporting data is still in progress and to try again at a later time. ")
    report_request_guid: Optional[StrictStr] = Field(default=None, description="The Toast platform assigned identifier used to identify a specific analytics reporting data request. ", alias="reportRequestGuid")
    report_status: Optional[StrictStr] = Field(default=None, description="Reflects the in progress status of the reporting data using the IN_PROGRESS value. ", alias="reportStatus")
    __properties: ClassVar[List[str]] = ["message", "reportRequestGuid", "reportStatus"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "reportRequestGuid": obj.get("reportRequestGuid"),
