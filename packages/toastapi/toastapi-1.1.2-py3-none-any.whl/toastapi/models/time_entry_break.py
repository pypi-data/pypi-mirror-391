...
class TimeEntryBreak(BaseModel):
    """
    ...
    missed: Optional[StrictBool] = Field(default=None, description="Indicates whether the break was a missed break. ")
    __properties: ClassVar[List[str]] = ["guid", "breakType", "paid", "inDate", "outDate", "missed"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of break_type
        if self.break_type:
            _dict['breakType'] = self.break_type.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "guid": obj.get("guid"),
            "breakType": ToastReference.from_dict(obj["breakType"]) if obj.get("breakType") is not None else None,
            "paid": obj.get("paid"),
