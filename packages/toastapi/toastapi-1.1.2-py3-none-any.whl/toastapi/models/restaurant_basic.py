...
class RestaurantBasic(BaseModel):
    ...
    """ # noqa: E501
    guid: Optional[StrictStr] = Field(default=None, description="The unique identifier that the Toast POS assigns to a restaurant. ")
    __properties: ClassVar[List[str]] = ["guid"]
