...
class AuthenticationResponse(BaseModel):
    ...
    status: Optional[StrictStr] = Field(default=None, description="The value `SUCCESS` indicates that your authentication request was successful.")
    __properties: ClassVar[List[str]] = ["token", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "token": AuthenticationToken.from_dict(obj["token"]) if obj.get("token") is not None else None,
