...
class OnlineOrdering(BaseModel):
    ...
    """ # noqa: E501
    enabled: Optional[StrictBool] = Field(default=None, description="Indicates whether the restaurant has enabled the Toast online  ordering module. This value is `true` if the module has ever  been enabled. The value _does not_ indicate that a restaurant  is accepting online orders or that the restaurant is using  the Toast online ordering feature. ")
    scheduling: Optional[StrictBool] = Field(default=None, description="Indicates whether the online ordering function for the restaurant allows guests to place orders that will be fulfilled in the future. If this value is `false`, orders will be fulfilled as soon as possible. ")
    special_requests: Optional[StrictBool] = Field(default=None, description="Indicates whether the online ordering function for the restaurant allows guests to include written notes with additional instructions for their orders. ", alias="specialRequests")
    special_requests_message: Optional[StrictStr] = Field(default=None, description="A written message that is shown to guests when they include additional instructions with an order. For example, the message might be \"no substitutions.\" ", alias="specialRequestsMessage")
    payment_options: Optional[PaymentOptions] = Field(default=None, alias="paymentOptions")
    __properties: ClassVar[List[str]] = ["enabled", "scheduling", "specialRequests", "specialRequestsMessage", "paymentOptions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "specialRequestsMessage": obj.get("specialRequestsMessage"),
