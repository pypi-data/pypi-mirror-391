...
class TakeoutPaymentOptions(BaseModel):
    """
    Information about the forms of payment that the restaurant will accept for orders that a guest picks up in person. 
    """ # noqa: E501
    cash: Optional[StrictBool] = Field(default=None, description="Indicates whether the restaurant accepts cash payment for takeout orders that are placed online. ")
    cc_same_day: Optional[StrictBool] = Field(default=None, description="Indicates whether the restaurant accepts online credit card payment for takeout orders that the guest will pick up on the same day. ", alias="ccSameDay")
    cc_future: Optional[StrictBool] = Field(default=None, description="Indicates whether the restaurant accepts online credit card payment for takeout orders that the guest will pick up on a day after the guest places the order. ", alias="ccFuture")
    cc_in_store: Optional[StrictBool] = Field(default=None, description="Indicates whether the restaurant accepts credit card payment at the time the guest picks up a takeout order. ", alias="ccInStore")
    __properties: ClassVar[List[str]] = ["cash", "ccSameDay", "ccFuture", "ccInStore"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "cash": obj.get("cash"),
            "ccSameDay": obj.get("ccSameDay"),
            "ccFuture": obj.get("ccFuture"),
            "ccInStore": obj.get("ccInStore")
        })
        return _obj
