...
class RevenueCenter(BaseModel):
    ...
    name: Optional[StrictStr] = Field(default=None, description="The name of this revenue center.")
    description: Optional[StrictStr] = Field(default=None, description="The description of this revenue center.")
    __properties: ClassVar[List[str]] = ["guid", "entityType", "name", "description"]
