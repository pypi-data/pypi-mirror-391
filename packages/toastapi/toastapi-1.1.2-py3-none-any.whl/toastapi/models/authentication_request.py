...
class AuthenticationRequest(BaseModel):
    ...
    """ # noqa: E501
    client_id: StrictStr = Field(description="The identifier string for your Toast API client. You receive the identifier string from the Toast integrations team. ", alias="clientId")
    client_secret: StrictStr = Field(description="The secret string that corresponds to your Toast API client. You receive the secret string from the Toast integrations team. ", alias="clientSecret")
    user_access_type: StrictStr = Field(description="Always include the `userAccessType` value and set it to `TOAST_MACHINE_CLIENT`. ", alias="userAccessType")
    __properties: ClassVar[List[str]] = ["clientId", "clientSecret", "userAccessType"]
