...
class ModifierGroupsApi:
    ...
    @validate_call
    async def get_menu_option_group_by_id(
        self,
        ...
        guid: Annotated[StrictStr, Field(description="The Toast POS GUID of the modifier group.")],
        ...
        :param guid: The Toast POS GUID of the modifier group. (required)
        :type guid: str
        ...
        _param = self._get_menu_option_group_by_id_serialize(
    ...
    @validate_call
    async def get_menu_option_group_by_id_with_http_info(
        self,
        toast_restaurant_external_id: Annotated[StrictStr, Field(description="The Toast POS GUID of the restaurant that the configuration applies to. ")],
        guid: Annotated[StrictStr, Field(description="The Toast POS GUID of the modifier group.")],
        _request_timeout: Union[
    ...
    @validate_call
    async def get_menu_option_group_by_id_without_preload_content(
        self,
        toast_restaurant_external_id: Annotated[StrictStr, Field(description="The Toast POS GUID of the restaurant that the configuration applies to. ")],
        guid: Annotated[StrictStr, Field(description="The Toast POS GUID of the modifier group.")],
        _request_timeout: Union[
    ...
    def _get_menu_option_group_by_id_serialize(
        self,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/config/v2/menuOptionGroups/{guid}',
    ...
    @validate_call
    async def list_menu_option_groups(
        self,
        toast_restaurant_external_id: Annotated[StrictStr, Field(description="The Toast POS GUID of the restaurant that the configuration applies to. ")],
        ...
        _param = self._list_menu_option_groups_serialize(
            toast_restaurant_external_id=toast_restaurant_external_id,
    ...
    @validate_call
    async def list_menu_option_groups_with_http_info(
        self,
        toast_restaurant_external_id: Annotated[StrictStr, Field(description="The Toast POS GUID of the restaurant that the configuration applies to. ")],
        page_token: Annotated[Optional[StrictStr], Field(description="A string that identifies the set of data objects that the endpoint will return in its response data. You can use this parameter to retrieve one page of response data. You get the value that you supply in the `pageToken` parameter from the `Toast-Next-Page-Token` header field value of a previous request to the endpoint. For more information, see <a href=\"https://doc.toasttab.com/doc/devguide/apiResponseDataPagination.html\">Paginating response data</a>. ")] = None,
        last_modified: Annotated[Optional[StrictStr], Field(description="Limits the return data to objects created or modified after a specific date and time. For example: `2024-06-20T00:00:00.000+0000`. ")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[MenuOptionGroup]]:
        """Get modifier groups 
    ...
    @validate_call
    async def list_menu_option_groups_without_preload_content(
        self,
        toast_restaurant_external_id: Annotated[StrictStr, Field(description="The Toast POS GUID of the restaurant that the configuration applies to. ")],
        page_token: Annotated[Optional[StrictStr], Field(description="A string that identifies the set of data objects that the endpoint will return in its response data. You can use this parameter to retrieve one page of response data. You get the value that you supply in the `pageToken` parameter from the `Toast-Next-Page-Token` header field value of a previous request to the endpoint. For more information, see <a href=\"https://doc.toasttab.com/doc/devguide/apiResponseDataPagination.html\">Paginating response data</a>. ")] = None,
        last_modified: Annotated[Optional[StrictStr], Field(description="Limits the return data to objects created or modified after a specific date and time. For example: `2024-06-20T00:00:00.000+0000`. ")] = None,
    ...
    def _list_menu_option_groups_serialize(
        self,
        toast_restaurant_external_id,
        page_token,
        last_modified,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/config/v2/menuOptionGroups',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
