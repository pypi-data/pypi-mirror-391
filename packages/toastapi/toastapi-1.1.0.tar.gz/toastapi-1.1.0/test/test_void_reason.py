...
class TestVoidReason(unittest.TestCase):
    """VoidReason unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VoidReason:
        """Test VoidReason
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VoidReason`
        """
        model = VoidReason()
        if include_optional:
            return VoidReason(
