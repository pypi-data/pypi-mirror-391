...
class TestDeliveryPaymentOptions(unittest.TestCase):
    """DeliveryPaymentOptions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeliveryPaymentOptions:
        """Test DeliveryPaymentOptions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeliveryPaymentOptions`
        """
        model = DeliveryPaymentOptions()
        if include_optional:
            return DeliveryPaymentOptions(
                cash = True,
                cc_same_day = True,
                cc_future = True
            )
    ...
    def testDeliveryPaymentOptions(self):
        """Test DeliveryPaymentOptions"""
