...
class TestSalesCategory(unittest.TestCase):
    """SalesCategory unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SalesCategory:
        """Test SalesCategory
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SalesCategory`
        """
        model = SalesCategory()
        if include_optional:
