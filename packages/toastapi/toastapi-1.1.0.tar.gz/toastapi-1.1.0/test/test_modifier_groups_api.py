...
class TestModifierGroupsApi(unittest.IsolatedAsyncioTestCase):
    """ModifierGroupsApi unit test stubs"""

    async def asyncSetUp(self) -> None:
        self.api = ModifierGroupsApi()

    async def asyncTearDown(self) -> None:
        await self.api.api_client.close()

    async def test_get_menu_option_group_by_id(self) -> None:
        """Test case for get_menu_option_group_by_id

        Get a modifier group 
        """
        pass

    async def test_list_menu_option_groups(self) -> None:
        """Test case for list_menu_option_groups
