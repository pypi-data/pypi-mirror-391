...
class TestDimensionUnitOfMeasure(unittest.TestCase):
    """DimensionUnitOfMeasure unit test stubs"""
    ...
    def testDimensionUnitOfMeasure(self):
        """Test DimensionUnitOfMeasure"""
        # inst = DimensionUnitOfMeasure()
