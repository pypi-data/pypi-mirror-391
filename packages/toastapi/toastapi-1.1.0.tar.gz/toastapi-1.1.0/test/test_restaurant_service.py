...
class TestRestaurantService(unittest.TestCase):
    """RestaurantService unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RestaurantService:
        """Test RestaurantService
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RestaurantService`
        """
    ...
    def testRestaurantService(self):
        """Test RestaurantService"""
