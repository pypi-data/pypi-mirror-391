...
class TestDeliveryServiceInfo(unittest.TestCase):
    """DeliveryServiceInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeliveryServiceInfo:
        """Test DeliveryServiceInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeliveryServiceInfo`
        """
        model = DeliveryServiceInfo()
        if include_optional:
    ...
    def testDeliveryServiceInfo(self):
        """Test DeliveryServiceInfo"""
