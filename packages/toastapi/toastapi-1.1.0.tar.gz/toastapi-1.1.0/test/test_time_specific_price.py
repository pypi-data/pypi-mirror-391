...
class TestTimeSpecificPrice(unittest.TestCase):
    """TimeSpecificPrice unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TimeSpecificPrice:
        """Test TimeSpecificPrice
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TimeSpecificPrice`
        """
        model = TimeSpecificPrice()
        if include_optional:
            return TimeSpecificPrice(
    ...
    def testTimeSpecificPrice(self):
        """Test TimeSpecificPrice"""
