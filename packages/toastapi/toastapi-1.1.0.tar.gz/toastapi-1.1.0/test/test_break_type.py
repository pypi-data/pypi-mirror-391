...
class TestBreakType(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> BreakType:
        """Test BreakType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BreakType`
        """
        model = BreakType()
        if include_optional:
            return BreakType(
                ...
                track_missed_breaks = True,
                break_interval_hrs = 56,
                break_interval_mins = 56,
                track_break_acknowledgement = True
            )
        else:
            return BreakType(
                guid = '',
