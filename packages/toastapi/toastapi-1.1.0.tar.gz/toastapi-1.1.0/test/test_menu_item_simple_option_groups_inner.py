...
class TestMenuItemSimpleOptionGroupsInner(unittest.TestCase):
    """MenuItemSimpleOptionGroupsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MenuItemSimpleOptionGroupsInner:
        """Test MenuItemSimpleOptionGroupsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MenuItemSimpleOptionGroupsInner`
        """
        model = MenuItemSimpleOptionGroupsInner()
        if include_optional:
            return MenuItemSimpleOptionGroupsInner(
                guid = '',
                entity_type = '',
                external_id = ''
            )
    ...
    def testMenuItemSimpleOptionGroupsInner(self):
        """Test MenuItemSimpleOptionGroupsInner"""
