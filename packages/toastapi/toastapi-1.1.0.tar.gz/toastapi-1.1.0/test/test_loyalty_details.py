...
class TestLoyaltyDetails(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> LoyaltyDetails:
        """Test LoyaltyDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LoyaltyDetails`
        """
        model = LoyaltyDetails()
        if include_optional:
