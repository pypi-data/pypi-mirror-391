...
class TestModifierGroupV2(unittest.TestCase):
    """ModifierGroupV2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ModifierGroupV2:
        """Test ModifierGroupV2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ModifierGroupV2`
        """
        model = ModifierGroupV2()
        if include_optional:
            return ModifierGroupV2(
                name = '',
                guid = '',
                reference_id = 56,
