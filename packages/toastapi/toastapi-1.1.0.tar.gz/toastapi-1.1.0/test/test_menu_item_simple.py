...
class TestMenuItemSimple(unittest.TestCase):
    """MenuItemSimple unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MenuItemSimple:
        """Test MenuItemSimple
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MenuItemSimple`
        """
        model = MenuItemSimple()
        if include_optional:
            return MenuItemSimple(
                guid = '',
                entity_type = '',
                external_id = '',
                inherit_unit_of_measure = True,
                images = [
                    ''
                    ],
                inherit_option_groups = True,
                visibility = '',
