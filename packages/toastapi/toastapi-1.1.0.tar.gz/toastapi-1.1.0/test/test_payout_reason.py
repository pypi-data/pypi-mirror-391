...
class TestPayoutReason(unittest.TestCase):
    """PayoutReason unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PayoutReason:
        """Test PayoutReason
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PayoutReason`
        """
        model = PayoutReason()
        if include_optional:
            return PayoutReason(
