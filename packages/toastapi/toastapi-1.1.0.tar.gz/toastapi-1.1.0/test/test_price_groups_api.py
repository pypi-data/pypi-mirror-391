...
class TestPriceGroupsApi(unittest.IsolatedAsyncioTestCase):
    """PriceGroupsApi unit test stubs"""

    async def asyncSetUp(self) -> None:
        self.api = PriceGroupsApi()

    async def asyncTearDown(self) -> None:
        await self.api.api_client.close()

    async def test_price_groups_get(self) -> None:
    ...
    async def test_price_groups_guid_get(self) -> None:
