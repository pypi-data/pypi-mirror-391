...
class TestCashDrawer(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CashDrawer:
        """Test CashDrawer
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CashDrawer`
        """
        model = CashDrawer()
        if include_optional:
            return CashDrawer(
