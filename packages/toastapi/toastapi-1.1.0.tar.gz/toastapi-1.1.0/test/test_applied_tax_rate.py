...
class TestAppliedTaxRate(unittest.TestCase):
    """AppliedTaxRate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppliedTaxRate:
        """Test AppliedTaxRate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppliedTaxRate`
        """
        model = AppliedTaxRate()
        if include_optional:
            return AppliedTaxRate(
                ...
                tax_amount = 1.337,
                type = 'PERCENT',
                facilitator_collect_and_remit_tax = True,
                display_name = '',
                jurisdiction = '',
                jurisdiction_type = ''
            )
