...
class UpdatePaymentRequest(BaseModel):
    ...
    """ # noqa: E501
    tip_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The amount tipped on a payment. ", alias="tipAmount")
    __properties: ClassVar[List[str]] = ["tipAmount"]
