...
class BreakType(BaseModel):
    ...
    name: Optional[StrictStr] = Field(default=None, description="The name of the work break type, as recognized by restaurant employees. ")
    active: Optional[StrictBool] = Field(default=None, description="Indicates whether the break is available and can be taken by restaurant employees. ")
    paid: Optional[StrictBool] = Field(default=None, description="Indicates whether the break is paid.")
    duration: Optional[StrictInt] = Field(default=None, description="The duration of the break in minutes.")
    enforce_minimum_time: Optional[StrictBool] = Field(default=None, description="Indicates whether the duration is enforced as the minimum time for the break. ", alias="enforceMinimumTime")
    track_missed_breaks: Optional[StrictBool] = Field(default=None, description="True if breaks that are not taken within the specified break interval should be generated in Toast. ", alias="trackMissedBreaks")
    break_interval_hrs: Optional[StrictInt] = Field(default=None, description="The number of hours between break intervals. Break intervals are specified in hours and minutes. If missed breaks are not tracked, this value may be null. ", alias="breakIntervalHrs")
    break_interval_mins: Optional[StrictInt] = Field(default=None, description="The number of minutes between break intervals. Break intervals are specified in hours and minutes. If missed breaks are not tracked, this value may be null. ", alias="breakIntervalMins")
    track_break_acknowledgement: Optional[StrictBool] = Field(default=None, description="Indicates whether break acknowledgements are collected for this type of break. Break acknowledgements will not be collected if `trackMissedBreaks` is false. ", alias="trackBreakAcknowledgement")
    __properties: ClassVar[List[str]] = ["guid", "entityType", "name", "active", "paid", "duration", "enforceMinimumTime", "trackMissedBreaks", "breakIntervalHrs", "breakIntervalMins", "trackBreakAcknowledgement"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "enforceMinimumTime": obj.get("enforceMinimumTime"),
            "trackMissedBreaks": obj.get("trackMissedBreaks"),
            "breakIntervalHrs": obj.get("breakIntervalHrs"),
            "breakIntervalMins": obj.get("breakIntervalMins"),
            "trackBreakAcknowledgement": obj.get("trackBreakAcknowledgement")
        })
        return _obj
