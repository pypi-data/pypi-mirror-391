...
class AlternatePaymentType(BaseModel):
    """
    ...
    name: Optional[StrictStr] = Field(default=None, description="The name of the alternate payment type.")
    __properties: ClassVar[List[str]] = ["guid", "entityType", "externalId", "name"]
