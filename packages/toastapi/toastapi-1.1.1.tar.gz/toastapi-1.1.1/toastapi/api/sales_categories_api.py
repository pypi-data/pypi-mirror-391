...
class SalesCategoriesApi:
    ...
    @validate_call
    async def get_sales_category_by_id(
        self,
        ...
        guid: Annotated[StrictStr, Field(description="The Toast POS GUID of the sales category.")],
        ...
        :param guid: The Toast POS GUID of the sales category. (required)
        :type guid: str
        ...
        _param = self._get_sales_category_by_id_serialize(
    ...
    @validate_call
    async def get_sales_category_by_id_with_http_info(
        self,
        toast_restaurant_external_id: Annotated[StrictStr, Field(description="The Toast POS GUID of the restaurant that the configuration applies to. ")],
        guid: Annotated[StrictStr, Field(description="The Toast POS GUID of the sales category.")],
        _request_timeout: Union[
    ...
    @validate_call
    async def get_sales_category_by_id_without_preload_content(
        self,
        toast_restaurant_external_id: Annotated[StrictStr, Field(description="The Toast POS GUID of the restaurant that the configuration applies to. ")],
        guid: Annotated[StrictStr, Field(description="The Toast POS GUID of the sales category.")],
        _request_timeout: Union[
    ...
    def _get_sales_category_by_id_serialize(
        self,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/config/v2/salesCategories/{guid}',
    ...
    async def list_sales_categories(
        ...
        last_modified: Annotated[Optional[datetime], Field(description="Limits the return data to objects created or modified after a specific date and time. For example: `2024-06-20T00:00:00.000+0000`. ")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        Returns an array of `SalesCategory` objects containing information about the types of menu item used to analyze purchases at a restaurant. For example, food and alcohol might be sales categories for a restaurant. If a `lastModified` date is specified, returns all objects that were created or modified after that date. 
        ...
        _param = self._list_sales_categories_serialize(
            toast_restaurant_external_id=toast_restaurant_external_id,
            limit=limit,
    ...
    @validate_call
    async def list_sales_categories_with_http_info(
        self,
        toast_restaurant_external_id: Annotated[StrictStr, Field(description="The Toast POS GUID of the restaurant that the configuration applies to. ")],
        limit: Annotated[Optional[Annotated[int, Field(le=300, strict=True)]], Field(description="The maximum number of objects to return. The default value is 300. The maximum value is 300.")] = None,
        page_token: Annotated[Optional[StrictStr], Field(description="A string that identifies the set of data objects that the endpoint will return in its response data. You can use this parameter to retrieve one page of response data. You get the value that you supply in the `pageToken` parameter from the `Toast-Next-Page-Token` header field value of a previous request to the endpoint. For more information, see https://doc.toasttab.com/doc/devguide/apiResponseDataPagination.html. ")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[SalesCategory]]:
        """Get menu item sales categories
    ...
    @validate_call
    async def list_sales_categories_without_preload_content(
        self,
        toast_restaurant_external_id: Annotated[StrictStr, Field(description="The Toast POS GUID of the restaurant that the configuration applies to. ")],
        limit: Annotated[Optional[Annotated[int, Field(le=300, strict=True)]], Field(description="The maximum number of objects to return. The default value is 300. The maximum value is 300.")] = None,
        page_token: Annotated[Optional[StrictStr], Field(description="A string that identifies the set of data objects that the endpoint will return in its response data. You can use this parameter to retrieve one page of response data. You get the value that you supply in the `pageToken` parameter from the `Toast-Next-Page-Token` header field value of a previous request to the endpoint. For more information, see https://doc.toasttab.com/doc/devguide/apiResponseDataPagination.html. ")] = None,
    ...
    def _list_sales_categories_serialize(
        self,
        toast_restaurant_external_id,
        limit,
        page_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/config/v2/salesCategories',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
