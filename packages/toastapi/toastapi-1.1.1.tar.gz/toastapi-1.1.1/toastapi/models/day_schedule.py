...
class DaySchedule(BaseModel):
    ...
    """ # noqa: E501
    schedule_name: Optional[StrictStr] = Field(default=None, description="The name of the type of day. For example, `weekday`.", alias="scheduleName")
    services: Optional[List[Service]] = Field(default=None, description="An array of `Service` objects that are available during the type of day. ")
    open_time: Optional[StrictStr] = Field(default=None, description="The time of day that the first service for the type of day begins. For example, the first service might begin at `06:00:00.000`. ", alias="openTime")
    close_time: Optional[StrictStr] = Field(default=None, description="The time of day that the last service for the type of day ends. For example, the last service might end at `02:00:00.000`. ", alias="closeTime")
    __properties: ClassVar[List[str]] = ["scheduleName", "services", "openTime", "closeTime"]
