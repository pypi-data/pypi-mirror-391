...
class VoidOrderRequest(BaseModel):
    ...
    VoidOrderRequest
    """ # noqa: E501
    selections: Optional[VoidOrderRequestSelections] = None
    payments: Optional[VoidOrderRequestSelections] = None
    __properties: ClassVar[List[str]] = ["selections", "payments"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "selections": VoidOrderRequestSelections.from_dict(obj["selections"]) if obj.get("selections") is not None else None,
            "payments": VoidOrderRequestSelections.from_dict(obj["payments"]) if obj.get("payments") is not None else None
        })
        return _obj
