...
class DeliveryServiceInfo(BaseModel):
    """
    ...
    provider_id: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Reserved for future use. ", alias="providerId")
    provider_name: Optional[Annotated[str, Field(strict=True, max_length=36)]] = Field(default=None, description="Reserved for future use. ", alias="providerName")
    driver_name: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Reserved for future use. ", alias="driverName")
    driver_phone_number: Optional[Annotated[str, Field(strict=True, max_length=30)]] = Field(default=None, description="Reserved for future use. ", alias="driverPhoneNumber")
    provider_info: Optional[Union[StrictBytes, StrictStr]] = Field(default=None, description="Reserved for future use. ", alias="providerInfo")
    original_quoted_delivery_date: Optional[StrictStr] = Field(default=None, description="Reserved for future use. ", alias="originalQuotedDeliveryDate")
    __properties: ClassVar[List[str]] = ["guid", "entityType", "providerId", "providerName", "driverName", "driverPhoneNumber", "providerInfo", "originalQuotedDeliveryDate"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "driverPhoneNumber": obj.get("driverPhoneNumber"),
            "providerInfo": obj.get("providerInfo"),
            "originalQuotedDeliveryDate": obj.get("originalQuotedDeliveryDate")
        })
        return _obj
