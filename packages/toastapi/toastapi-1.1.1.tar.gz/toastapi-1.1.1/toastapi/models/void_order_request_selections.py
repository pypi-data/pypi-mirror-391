...
class VoidOrderRequestSelections(BaseModel):
    """
    VoidOrderRequestSelections
    """ # noqa: E501
    void_all: Optional[StrictBool] = Field(default=False, alias="voidAll")
    __properties: ClassVar[List[str]] = ["voidAll"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "voidAll": obj.get("voidAll") if obj.get("voidAll") is not None else False
        })
        return _obj
