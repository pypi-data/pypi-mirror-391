...
class AppliedPackagingInfo(BaseModel):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in applied_packaging_items (list)
        _items = []
        if self.applied_packaging_items:
            for _item_applied_packaging_items in self.applied_packaging_items:
                if _item_applied_packaging_items:
                    _items.append(_item_applied_packaging_items.to_dict())
            _dict['appliedPackagingItems'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "appliedPackagingItems": [AppliedPackagingItem.from_dict(_item) for _item in obj["appliedPackagingItems"]] if obj.get("appliedPackagingItems") is not None else None
        })
        return _obj
