...
class TestRestaurantServicesApi(unittest.IsolatedAsyncioTestCase):
    """RestaurantServicesApi unit test stubs"""

    async def asyncSetUp(self) -> None:
        self.api = RestaurantServicesApi()

    async def asyncTearDown(self) -> None:
        await self.api.api_client.close()

    async def test_restaurant_services_get(self) -> None:
    ...
    async def test_restaurant_services_guid_get(self) -> None:
