    ...
    def make_instance(self, include_optional) -> VoidOrderRequest:
        ...
        if include_optional:
            return VoidOrderRequest(
                selections = toastapi.models.void_order_request_selections.voidOrder_request_selections(
                    void_all = True, ),
                payments = toastapi.models.void_order_request_selections.voidOrder_request_selections(
                    void_all = True, )
            )
        else:
            return VoidOrderRequest(
