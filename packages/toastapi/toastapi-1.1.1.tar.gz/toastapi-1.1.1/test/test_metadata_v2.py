...
class TestMetadataV2(unittest.TestCase):
    """MetadataV2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetadataV2:
        """Test MetadataV2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetadataV2`
        """
        model = MetadataV2()
        if include_optional:
            return MetadataV2(
