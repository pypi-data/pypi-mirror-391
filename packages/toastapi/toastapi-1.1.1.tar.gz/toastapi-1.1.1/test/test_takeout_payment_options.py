...
class TestTakeoutPaymentOptions(unittest.TestCase):
    """TakeoutPaymentOptions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TakeoutPaymentOptions:
        """Test TakeoutPaymentOptions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TakeoutPaymentOptions`
        """
        model = TakeoutPaymentOptions()
        if include_optional:
            return TakeoutPaymentOptions(
                cash = True,
                cc_same_day = True,
                cc_future = True,
                cc_in_store = True
    ...
    def testTakeoutPaymentOptions(self):
        """Test TakeoutPaymentOptions"""
