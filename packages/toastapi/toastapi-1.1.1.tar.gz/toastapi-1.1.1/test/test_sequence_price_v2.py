...
class TestSequencePriceV2(unittest.TestCase):
    """SequencePriceV2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SequencePriceV2:
        """Test SequencePriceV2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SequencePriceV2`
        """
        model = SequencePriceV2()
        if include_optional:
            return SequencePriceV2(
                sequence = 56,
                price = 1.337
            )
        else:
