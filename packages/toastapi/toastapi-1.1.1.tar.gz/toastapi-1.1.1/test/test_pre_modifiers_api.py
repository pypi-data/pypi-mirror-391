...
class TestPreModifiersApi(unittest.IsolatedAsyncioTestCase):
    """PreModifiersApi unit test stubs"""

    async def asyncSetUp(self) -> None:
        self.api = PreModifiersApi()

    async def asyncTearDown(self) -> None:
        await self.api.api_client.close()

    async def test_pre_modifiers_get(self) -> None:
