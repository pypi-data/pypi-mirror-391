...
class TestAppliedPackagingInfo(unittest.TestCase):
    """AppliedPackagingInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppliedPackagingInfo:
        """Test AppliedPackagingInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppliedPackagingInfo`
        """
        model = AppliedPackagingInfo()
        if include_optional:
            return AppliedPackagingInfo(
                guid = '',
                entity_type = '',
                applied_packaging_items = [
                    toastapi.models.applied_packaging_item.AppliedPackagingItem()
                    ]
            )
        else:
            return AppliedPackagingInfo(
    ...
    def testAppliedPackagingInfo(self):
        """Test AppliedPackagingInfo"""
