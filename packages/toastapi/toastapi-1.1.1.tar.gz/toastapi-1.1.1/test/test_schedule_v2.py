...
class TestScheduleV2(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ScheduleV2:
        """Test ScheduleV2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ScheduleV2`
        """
        model = ScheduleV2()
        if include_optional:
            return ScheduleV2(
