...
class TestTaxTableRow(unittest.TestCase):
    """TaxTableRow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TaxTableRow:
        """Test TaxTableRow
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TaxTableRow`
        """
        model = TaxTableRow()
        if include_optional:
            return TaxTableRow(
