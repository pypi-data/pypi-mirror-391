...
class TestWeightUnitOfMeasureV2(unittest.TestCase):
    """WeightUnitOfMeasureV2 unit test stubs"""
    ...
    def testWeightUnitOfMeasureV2(self):
        """Test WeightUnitOfMeasureV2"""
        # inst = WeightUnitOfMeasureV2()
