...
class TestPreModifierV2(unittest.TestCase):
    """PreModifierV2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PreModifierV2:
        """Test PreModifierV2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PreModifierV2`
        """
        model = PreModifierV2()
        if include_optional:
            return PreModifierV2(
                name = '',
                guid = '',
                fixed_price = 1.337,
