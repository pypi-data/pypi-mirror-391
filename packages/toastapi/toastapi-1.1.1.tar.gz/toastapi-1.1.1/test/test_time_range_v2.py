...
class TestTimeRangeV2(unittest.TestCase):
    """TimeRangeV2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TimeRangeV2:
        """Test TimeRangeV2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TimeRangeV2`
        """
        model = TimeRangeV2()
        if include_optional:
            return TimeRangeV2(
