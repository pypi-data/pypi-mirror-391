...
class TestPortionV2(unittest.TestCase):
    """PortionV2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PortionV2:
        """Test PortionV2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PortionV2`
        """
        model = PortionV2()
        if include_optional:
            return PortionV2(
