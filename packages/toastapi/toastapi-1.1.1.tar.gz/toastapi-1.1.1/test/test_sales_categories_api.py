...
class TestSalesCategoriesApi(unittest.IsolatedAsyncioTestCase):
    """SalesCategoriesApi unit test stubs"""

    async def asyncSetUp(self) -> None:
        self.api = SalesCategoriesApi()

    async def asyncTearDown(self) -> None:
        await self.api.api_client.close()

    async def test_get_sales_category_by_id(self) -> None:
        """Test case for get_sales_category_by_id

        Get a menu item sales category
        """
        pass

    async def test_list_sales_categories(self) -> None:
        """Test case for list_sales_categories
