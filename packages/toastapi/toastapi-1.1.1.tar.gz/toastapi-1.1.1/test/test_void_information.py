...
class TestVoidInformation(unittest.TestCase):
    """VoidInformation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VoidInformation:
        """Test VoidInformation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VoidInformation`
        """
        model = VoidInformation()
        if include_optional:
            return VoidInformation(
                void_user = toastapi.models.external_reference.ExternalReference(),
                void_approver = toastapi.models.external_reference.ExternalReference(),
                void_date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                void_business_date = 56,
                void_reason = toastapi.models.external_reference.ExternalReference()
            )
        else:
            return VoidInformation(
        )
