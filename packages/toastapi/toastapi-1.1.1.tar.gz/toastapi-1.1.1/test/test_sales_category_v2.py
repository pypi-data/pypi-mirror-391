...
class TestSalesCategoryV2(unittest.TestCase):
    """SalesCategoryV2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SalesCategoryV2:
        """Test SalesCategoryV2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SalesCategoryV2`
        """
        model = SalesCategoryV2()
        if include_optional:
            return SalesCategoryV2(
                name = '',
                guid = ''
            )
        else:
