...
class TestMenuItemV2PricingRules(unittest.TestCase):
    """MenuItemV2PricingRules unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MenuItemV2PricingRules:
        """Test MenuItemV2PricingRules
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MenuItemV2PricingRules`
        """
        model = MenuItemV2PricingRules()
        if include_optional:
            return MenuItemV2PricingRules(
    ...
    def testMenuItemV2PricingRules(self):
        """Test MenuItemV2PricingRules"""
