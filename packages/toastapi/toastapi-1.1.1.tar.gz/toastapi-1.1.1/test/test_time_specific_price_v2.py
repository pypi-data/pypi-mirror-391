...
class TestTimeSpecificPriceV2(unittest.TestCase):
    """TimeSpecificPriceV2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TimeSpecificPriceV2:
        """Test TimeSpecificPriceV2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TimeSpecificPriceV2`
        """
        model = TimeSpecificPriceV2()
        if include_optional:
            return TimeSpecificPriceV2(
    ...
    def testTimeSpecificPriceV2(self):
        """Test TimeSpecificPriceV2"""
