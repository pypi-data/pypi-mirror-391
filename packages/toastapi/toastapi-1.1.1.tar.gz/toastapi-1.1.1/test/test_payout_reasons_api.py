...
class TestPayoutReasonsApi(unittest.IsolatedAsyncioTestCase):
    """PayoutReasonsApi unit test stubs"""

    async def asyncSetUp(self) -> None:
        self.api = PayoutReasonsApi()

    async def asyncTearDown(self) -> None:
        await self.api.api_client.close()

    async def test_payout_reasons_get(self) -> None:
    ...
    async def test_payout_reasons_guid_get(self) -> None:
