...
class TestRestaurantsApi(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_groups_management_group_guid_restaurants_get(self) -> None:
        """Test case for groups_management_group_guid_restaurants_get

        Get restaurants in a management group
        """
        pass

    async def test_restaurants_restaurant_guid_get(self) -> None:
        """Test case for restaurants_restaurant_guid_get
