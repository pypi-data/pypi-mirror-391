    ...
    def make_instance(self, include_optional) -> Check:
        ...
        if include_optional:
            return Check(
                ...
                selections = [
                    toastapi.models.selection.Selection()
                    ],
                customer = toastapi.models.customer.Customer(),
                amount = 1.337,
                tax_amount = 1.337,
                total_amount = 1.337,
                payments = [
                    toastapi.models.payment.Payment()
                    ],
                applied_discounts = [
                    toastapi.models.applied_discount.AppliedDiscount()
                    ],
                voided = True,
