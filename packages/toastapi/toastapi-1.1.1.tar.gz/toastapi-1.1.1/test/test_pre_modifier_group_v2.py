...
class TestPreModifierGroupV2(unittest.TestCase):
    """PreModifierGroupV2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PreModifierGroupV2:
        """Test PreModifierGroupV2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PreModifierGroupV2`
        """
        model = PreModifierGroupV2()
        if include_optional:
            return PreModifierGroupV2(
                name = '',
                guid = '',
                pre_modifiers = [
    ...
    def testPreModifierGroupV2(self):
        """Test PreModifierGroupV2"""
