...
class TestContentAdvisories(unittest.TestCase):
    """ContentAdvisories unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContentAdvisories:
        """Test ContentAdvisories
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContentAdvisories`
        """
        model = ContentAdvisories()
        if include_optional:
            return ContentAdvisories(
                alcohol = toastapi.models.alcohol.Alcohol(
    ...
    def testContentAdvisories(self):
        """Test ContentAdvisories"""
