...
class TestAppliedDiscountReason(unittest.TestCase):
    """AppliedDiscountReason unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppliedDiscountReason:
        """Test AppliedDiscountReason
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppliedDiscountReason`
        """
        model = AppliedDiscountReason()
        if include_optional:
            return AppliedDiscountReason(
                name = '',
                description = '',
                comment = '',
                discount_reason = toastapi.models.toast_reference.ToastReference(
                    guid = '', 
                    entity_type = '', )
            )
        else:
    ...
    def testAppliedDiscountReason(self):
        """Test AppliedDiscountReason"""
