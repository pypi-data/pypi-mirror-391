...
class TestAppliedLoyaltyInfo(unittest.TestCase):
    """AppliedLoyaltyInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppliedLoyaltyInfo:
        """Test AppliedLoyaltyInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppliedLoyaltyInfo`
        """
        model = AppliedLoyaltyInfo()
        if include_optional:
            return AppliedLoyaltyInfo(
                guid = '',
                entity_type = '',
                loyalty_identifier = '',
                masked_loyalty_identifier = '',
                vendor = 'TOAST',
                accrual_family_guid = '',
                accrual_text = ''
            )
    ...
    def testAppliedLoyaltyInfo(self):
        """Test AppliedLoyaltyInfo"""
