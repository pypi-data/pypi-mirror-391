...
class OutputEncodingReconCommand:
    ...
    def start_output_encoding(self, target_name: str) -> uuid.UUID:
        f"Starting output encoding recon for target: {str(target_name)}"
        response = self.service.start_output_encoding(StartOutputEncodingRequest(target_name=target_name))
