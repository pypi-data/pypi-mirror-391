...
class CodeGenerationReconCommand:
    ...
    def start_code_generation(self, target_name: str) -> uuid.UUID:
        f"""Starting code generation recon for target: {str(target_name)}"""
        response = self.service.start_code_generation(StartCodeGenerationRequest(target_name=target_name))
