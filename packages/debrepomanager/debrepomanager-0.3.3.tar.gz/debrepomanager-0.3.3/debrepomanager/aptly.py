...
class AptlyManager:
    ...
    def delete_repo(self, codename: str, component: str) -> bool:
        ...
        """
        repo_name = self._get_repo_name(codename, component)
        # Use same prefix format as publish: just codename with filesystem endpoint
        prefix = f"filesystem:public:{codename}"
    ...
    def _publish_snapshot(
        ...
        Example:
            ...
            True
        """
        # With FileSystemPublishEndpoints, prefix is just codename
        # Component is specified in -distribution
        # Result: /opt/repo/public/{codename}/dists/{component}/
        prefix = codename
