...
#define NEURON_DATA_DIR "/tmp/tmpq4ccugn9/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmpq4ccugn9/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-pl5pv371/bin/python)"};
