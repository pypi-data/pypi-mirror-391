...
#define NEURON_DATA_DIR "/tmp/tmp592375mx/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmp592375mx/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-f1ukswrw/bin/python)"};
