...
#define NEURON_DATA_DIR "/tmp/tmppq0za_s5/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmppq0za_s5/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-rij491i6/bin/python)"};
