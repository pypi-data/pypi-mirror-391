...
#define NEURON_DATA_DIR "/tmp/tmpewk6flwq/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmpewk6flwq/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-d2p4bxxg/bin/python)"};
