...
#define NEURON_DATA_DIR "/tmp/tmpwfnupgs_/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmpwfnupgs_/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-0z63ro0b/bin/python)"};
