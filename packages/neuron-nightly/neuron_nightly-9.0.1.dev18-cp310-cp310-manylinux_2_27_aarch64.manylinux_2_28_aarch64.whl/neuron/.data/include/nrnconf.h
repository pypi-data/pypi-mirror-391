...
#define NEURON_DATA_DIR "/tmp/tmpzjnsgrtu/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmpzjnsgrtu/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-46xm_e6b/bin/python)"};
