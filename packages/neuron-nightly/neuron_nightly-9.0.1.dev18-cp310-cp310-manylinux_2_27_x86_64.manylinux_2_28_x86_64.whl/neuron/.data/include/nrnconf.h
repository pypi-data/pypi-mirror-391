...
#define NEURON_DATA_DIR "/tmp/tmpujsc3ler/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmpujsc3ler/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-3uv_5u_f/bin/python)"};
