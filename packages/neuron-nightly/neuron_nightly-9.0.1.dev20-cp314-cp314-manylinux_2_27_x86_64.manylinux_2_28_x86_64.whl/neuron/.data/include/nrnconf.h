...
#define NEURON_DATA_DIR "/tmp/tmpqduq5o6t/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmpqduq5o6t/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-khsgxhh5/bin/python)"};
