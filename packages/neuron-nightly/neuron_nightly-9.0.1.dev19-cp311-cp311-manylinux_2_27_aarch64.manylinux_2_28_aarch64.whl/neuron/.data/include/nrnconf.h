...
#define NEURON_DATA_DIR "/tmp/tmpdujw9yb5/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmpdujw9yb5/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-b8hwkipq/bin/python)"};
