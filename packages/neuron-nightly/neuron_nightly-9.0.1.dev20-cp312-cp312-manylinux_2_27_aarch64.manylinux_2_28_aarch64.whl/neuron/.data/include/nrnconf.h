...
#define NEURON_DATA_DIR "/tmp/tmp2rc2k55w/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmp2rc2k55w/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-t63h1yhl/bin/python)"};
