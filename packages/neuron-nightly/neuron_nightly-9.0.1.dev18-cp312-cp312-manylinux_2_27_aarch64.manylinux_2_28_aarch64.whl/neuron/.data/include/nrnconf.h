...
#define NEURON_DATA_DIR "/tmp/tmpm1jeufly/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmpm1jeufly/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-64t5e2_n/bin/python)"};
