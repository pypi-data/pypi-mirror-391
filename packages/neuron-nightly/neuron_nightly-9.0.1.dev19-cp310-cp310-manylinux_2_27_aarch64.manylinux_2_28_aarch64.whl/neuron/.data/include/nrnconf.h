...
#define NEURON_DATA_DIR "/tmp/tmp629bnij4/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmp629bnij4/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-_er0z8s4/bin/python)"};
