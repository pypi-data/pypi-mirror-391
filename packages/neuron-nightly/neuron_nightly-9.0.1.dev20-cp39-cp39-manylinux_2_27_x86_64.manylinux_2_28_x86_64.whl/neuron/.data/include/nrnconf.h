...
#define NEURON_DATA_DIR "/tmp/tmps_ebsu9w/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmps_ebsu9w/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-bbha8n06/bin/python)"};
