...
#define NEURON_DATA_DIR "/tmp/tmpkqstw3ic/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmpkqstw3ic/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-02omj5ea/bin/python)"};
