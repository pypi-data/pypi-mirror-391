...
#define NEURON_DATA_DIR "/tmp/tmpdin_lvkp/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmpdin_lvkp/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-tkrw32bs/bin/python)"};
