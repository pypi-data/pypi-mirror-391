...
#define NEURON_DATA_DIR "/tmp/tmp0ol_4zo_/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmp0ol_4zo_/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-u2pvgg5c/bin/python)"};
