...
#define NEURON_DATA_DIR "/tmp/tmp7vc_81qh/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmp7vc_81qh/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-ihqf9nih/bin/python)"};
