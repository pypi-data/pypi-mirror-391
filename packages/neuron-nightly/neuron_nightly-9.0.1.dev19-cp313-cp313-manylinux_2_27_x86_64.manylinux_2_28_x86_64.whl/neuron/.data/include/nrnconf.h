...
#define NEURON_DATA_DIR "/tmp/tmp96eaof8y/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmp96eaof8y/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-d6y9v9xy/bin/python)"};
