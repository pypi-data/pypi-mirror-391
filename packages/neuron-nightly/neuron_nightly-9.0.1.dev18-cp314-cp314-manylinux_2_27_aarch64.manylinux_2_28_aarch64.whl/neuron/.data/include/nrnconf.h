...
#define NEURON_DATA_DIR "/tmp/tmp0ev2u1eq/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmp0ev2u1eq/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-q2iq83zd/bin/python)"};
