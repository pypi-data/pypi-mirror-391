...
#define NEURON_DATA_DIR "/tmp/tmpcpk_piaq/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmpcpk_piaq/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-0t6nj4sh/bin/python)"};
