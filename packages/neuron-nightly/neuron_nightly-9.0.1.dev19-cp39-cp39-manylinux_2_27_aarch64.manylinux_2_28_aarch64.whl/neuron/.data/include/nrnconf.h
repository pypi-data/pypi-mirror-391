...
#define NEURON_DATA_DIR "/tmp/tmph_sdiu7a/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmph_sdiu7a/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-yqrgnuli/bin/python)"};
