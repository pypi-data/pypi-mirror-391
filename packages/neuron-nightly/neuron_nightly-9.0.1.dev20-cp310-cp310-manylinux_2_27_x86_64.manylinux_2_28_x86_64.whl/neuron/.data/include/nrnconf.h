...
#define NEURON_DATA_DIR "/tmp/tmpiullm76o/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmpiullm76o/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-quds5pli/bin/python)"};
