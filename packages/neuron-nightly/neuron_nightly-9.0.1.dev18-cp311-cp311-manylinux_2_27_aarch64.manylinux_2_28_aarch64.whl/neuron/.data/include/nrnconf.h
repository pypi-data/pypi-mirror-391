...
#define NEURON_DATA_DIR "/tmp/tmpeoj2caz7/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmpeoj2caz7/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-x3le6iq2/bin/python)"};
