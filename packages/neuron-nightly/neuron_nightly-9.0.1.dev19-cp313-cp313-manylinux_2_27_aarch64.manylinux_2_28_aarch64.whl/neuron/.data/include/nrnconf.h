...
#define NEURON_DATA_DIR "/tmp/tmpod2vms03/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmpod2vms03/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-0zijaqdf/bin/python)"};
