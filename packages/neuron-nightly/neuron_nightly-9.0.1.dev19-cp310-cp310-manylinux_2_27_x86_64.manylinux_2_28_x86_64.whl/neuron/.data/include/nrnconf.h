...
#define NEURON_DATA_DIR "/tmp/tmpzc99iz0d/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmpzc99iz0d/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-qpa7mt2j/bin/python)"};
