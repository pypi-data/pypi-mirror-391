...
#define NEURON_DATA_DIR "/tmp/tmpb5rv9j91/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmpb5rv9j91/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-8tlvpmrp/bin/python)"};
