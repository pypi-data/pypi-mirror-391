...
#define NEURON_DATA_DIR "/tmp/tmph_c3gtqm/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmph_c3gtqm/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-qrlt89n3/bin/python)"};
