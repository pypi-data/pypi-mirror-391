...
#define NEURON_DATA_DIR "/tmp/tmp_2vhdm_t/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmp_2vhdm_t/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-fh1ar2hm/bin/python)"};
