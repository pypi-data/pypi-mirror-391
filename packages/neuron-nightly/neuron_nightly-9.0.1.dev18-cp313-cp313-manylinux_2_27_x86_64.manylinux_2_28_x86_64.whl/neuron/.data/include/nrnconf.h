...
#define NEURON_DATA_DIR "/tmp/tmpq59ulli4/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmpq59ulli4/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-nxh1t6v2/bin/python)"};
