...
#define NEURON_DATA_DIR "/tmp/tmparrvy8ks/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmparrvy8ks/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-x_rxaokr/bin/python)"};
