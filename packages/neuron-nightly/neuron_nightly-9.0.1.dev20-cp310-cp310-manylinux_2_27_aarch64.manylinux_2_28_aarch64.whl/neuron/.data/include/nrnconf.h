...
#define NEURON_DATA_DIR "/tmp/tmpouuzwxp8/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmpouuzwxp8/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-75ht19u3/bin/python)"};
