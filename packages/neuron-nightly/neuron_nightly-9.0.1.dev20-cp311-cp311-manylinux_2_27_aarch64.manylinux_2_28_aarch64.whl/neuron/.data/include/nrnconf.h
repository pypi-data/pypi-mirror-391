...
#define NEURON_DATA_DIR "/tmp/tmpx1vw0uc7/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmpx1vw0uc7/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-tshvibnu/bin/python)"};
