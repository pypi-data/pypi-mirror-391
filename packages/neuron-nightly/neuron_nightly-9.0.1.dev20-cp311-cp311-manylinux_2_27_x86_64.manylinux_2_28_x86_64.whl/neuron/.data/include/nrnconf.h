...
#define NEURON_DATA_DIR "/tmp/tmp1bs483i9/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmp1bs483i9/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-qmgx9g9c/bin/python)"};
