...
#define NEURON_DATA_DIR "/tmp/tmp61v4aswx/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmp61v4aswx/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-oyc7ergf/bin/python)"};
