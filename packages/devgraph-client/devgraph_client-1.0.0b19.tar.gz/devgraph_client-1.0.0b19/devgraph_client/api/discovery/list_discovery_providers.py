...
from ...models.discovery_providers_list_response import DiscoveryProvidersListResponse
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = DiscoveryProvidersListResponse.from_dict(response.json())
...
def sync(
    *,
    ...
    Returns:
        Any | DiscoveryProvidersListResponse
    """
