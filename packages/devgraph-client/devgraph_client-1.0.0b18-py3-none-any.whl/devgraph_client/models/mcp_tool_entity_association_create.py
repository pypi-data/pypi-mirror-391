...
if TYPE_CHECKING:
    from ..models.mcp_tool_entity_association_create_tool_config_type_0 import (
        MCPToolEntityAssociationCreateToolConfigType0,
    )


T = TypeVar("T", bound="MCPToolEntityAssociationCreate")


@_attrs_define
class MCPToolEntityAssociationCreate:
    """
    Attributes:
        ...
        tool_config (MCPToolEntityAssociationCreateToolConfigType0 | None | Unset):
    """
    ...
    tool_config: MCPToolEntityAssociationCreateToolConfigType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.tool_config, Unset):
            tool_config = UNSET
        elif isinstance(self.tool_config, MCPToolEntityAssociationCreateToolConfigType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_tool_config(data: object) -> MCPToolEntityAssociationCreateToolConfigType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                tool_config_type_0 = MCPToolEntityAssociationCreateToolConfigType0.from_dict(data)

                return tool_config_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(MCPToolEntityAssociationCreateToolConfigType0 | None | Unset, data)

        tool_config = _parse_tool_config(d.pop("tool_config", UNSET))

        mcp_tool_entity_association_create = cls(
            mcp_endpoint_name=mcp_endpoint_name,
            tool_name=tool_name,
            entity_definition_id=entity_definition_id,
        ...
        mcp_tool_entity_association_create.additional_properties = d
        return mcp_tool_entity_association_create
