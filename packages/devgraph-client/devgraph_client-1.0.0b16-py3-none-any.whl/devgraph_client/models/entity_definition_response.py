...
if TYPE_CHECKING:
    from ..models.entity_definition_response_spec import EntityDefinitionResponseSpec


T = TypeVar("T", bound="EntityDefinitionResponse")


@_attrs_define
class EntityDefinitionResponse:
    """
    Attributes:
        group (str):
        kind (str):
        list_kind (str):
        singular (str):
        spec (EntityDefinitionResponseSpec):
        id (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        spec = EntityDefinitionResponseSpec.from_dict(d.pop("spec"))
        ...
        entity_definition_response = cls(
            group=group,
            kind=kind,
            list_kind=list_kind,
            singular=singular,
        ...
        entity_definition_response.additional_properties = d
        return entity_definition_response
