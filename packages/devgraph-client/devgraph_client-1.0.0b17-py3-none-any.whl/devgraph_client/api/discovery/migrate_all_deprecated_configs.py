...
from ...models.migration_results_response import MigrationResultsResponse
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = MigrationResultsResponse.from_dict(response.json())
...
def sync(
    *,
    ...
    Returns:
        Any | HTTPValidationError | MigrationResultsResponse
    """
