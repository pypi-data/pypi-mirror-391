...
if TYPE_CHECKING:
    from ..models.mcp_endpoint_response_headers import MCPEndpointResponseHeaders


T = TypeVar("T", bound="MCPEndpointResponse")
...
class MCPEndpointResponse:
    ...
    Attributes:
        ...
        headers (MCPEndpointResponseHeaders | Unset):
    ...
    headers: MCPEndpointResponseHeaders | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_headers, Unset):
            ...
            headers = MCPEndpointResponseHeaders.from_dict(_headers)
