...
from libcrypto.cryptod.Crypto.Util.py3compat import byte_string, bchr, bord

from libcrypto.cryptod.Crypto.Util.number import long_to_bytes, bytes_to_long
...
class DerInteger(DerObject):
    """Class to model a DER INTEGER.
        ...
        An example of encoding is::
          ...
          >>> from libcrypto.cryptod.Crypto.Util.asn1 import DerInteger
...
class DerBoolean(DerObject):
    ...
    >>> from libcrypto.cryptod.Crypto.Util.asn1 import DerBoolean
...
class DerSequence(DerObject):
    """Class to model a DER SEQUENCE.
        ...
        An example of encoding is:
          ...
          >>> from libcrypto.cryptod.Crypto.Util.asn1 import DerSequence, DerInteger
          >>> from binascii import hexlify, unhexlify
...
class DerOctetString(DerObject):
    ...
    >>> from libcrypto.cryptod.Crypto.Util.asn1 import DerOctetString
    >>> from binascii import hexlify, unhexlify
...
class DerBitString(DerObject):
    ...
    >>> from libcrypto.cryptod.Crypto.Util.asn1 import DerBitString
