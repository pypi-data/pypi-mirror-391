...
class SessionReaderStub(_SessionStub):
    ...
    async def Get(
        ...
        *,
        ...
        proto_request = SessionGetRequestToProto(
            request,
        )
...
class SessionTasksStub(_SessionStub):
    ...
    async def HandleMessage(
        ...
        *,
        ...
        proto_request = SessionHandleMessageRequestToProto(
            request,
        )
    ...
    async def Run(
        ...
        *,
        ...
        idempotency_key: IMPORT_typing.Optional[IMPORT_uuid.UUID]
        proto_request = SessionRunRequestToProto(
            request,
        )
    ...
    async def HandleMessage(
        ...
        *,
        ...
        task = IMPORT_reboot_aio_tasks.TaskEffect(
            ...
            request=SessionHandleMessageRequestToProto(
                request,
            ),
    ...
    async def Run(
        ...
        *,
        ...
        task = IMPORT_reboot_aio_tasks.TaskEffect(
            ...
            state_ref=self._state_ref,
            method_name='Run',
            request=SessionRunRequestToProto(
                request,
            ),
            schedule=(IMPORT_reboot_time_DateTimeWithTimeZone.now() + schedule) if isinstance(
                schedule, IMPORT_datetime_timedelta
...
class SessionSingletonServicer(SessionBaseServicer):
    ...
    async def _HandleMessage(
        ...
        with IMPORT_reboot_aio_tracing.span(
            ...
            return SessionHandleMessageResponseToProto(
    ...
    async def _Run(
        ...
        with IMPORT_reboot_aio_tracing.span(
            ...
            return SessionRunResponseToProto(
                await self.Run(
                    context,
                    typed_request,
                )
    ...
    async def _Get(
        ...
        try:
            ...
            with IMPORT_reboot_aio_tracing.span(
                ...
                return SessionGetResponseToProto(
                    await instance.Get(
                        context,
                        typed_request,
                    )
