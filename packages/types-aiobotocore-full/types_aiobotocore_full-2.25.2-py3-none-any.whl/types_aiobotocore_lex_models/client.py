...
class LexModelBuildingServiceClient(AioBaseClient):
    ...
    async def get_bots(self, **kwargs: Unpack[GetBotsRequestTypeDef]) -> GetBotsResponseTypeDef:
        """
    ...
    async def get_intent(
        self, **kwargs: Unpack[GetIntentRequestTypeDef]
    ) -> GetIntentResponseTypeDef:
        """
    ...
    async def get_intents(
        self, **kwargs: Unpack[GetIntentsRequestTypeDef]
    ) -> GetIntentsResponseTypeDef:
        """
    ...
    async def put_bot(self, **kwargs: Unpack[PutBotRequestTypeDef]) -> PutBotResponseTypeDef:
        """
    ...
    async def put_intent(
        self, **kwargs: Unpack[PutIntentRequestTypeDef]
    ) -> PutIntentResponseTypeDef:
        """
