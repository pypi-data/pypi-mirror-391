...
if TYPE_CHECKING:
    _ListADAssessmentsPaginatorBase = AioPaginator[ListADAssessmentsResultTypeDef]
else:
    _ListADAssessmentsPaginatorBase = AioPaginator  # type: ignore[assignment]
...
class ListADAssessmentsPaginator(_ListADAssessmentsPaginatorBase):
    ...
    [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_ds/paginators/#listadassessmentspaginator)
    """

    def paginate(  # type: ignore[override]
        self, **kwargs: Unpack[ListADAssessmentsRequestPaginateTypeDef]
    ) -> AioPageIterator[ListADAssessmentsResultTypeDef]:
        """
