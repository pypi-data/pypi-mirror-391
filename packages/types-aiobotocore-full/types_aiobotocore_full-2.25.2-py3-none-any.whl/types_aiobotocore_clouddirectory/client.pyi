...
class CloudDirectoryClient(AioBaseClient):
    ...
    async def batch_read(
        self, **kwargs: Unpack[BatchReadRequestTypeDef]
    ) -> BatchReadResponseTypeDef:
        """
    ...
    async def batch_write(
        self, **kwargs: Unpack[BatchWriteRequestTypeDef]
    ) -> BatchWriteResponseTypeDef:
        """
    ...
    async def get_facet(self, **kwargs: Unpack[GetFacetRequestTypeDef]) -> GetFacetResponseTypeDef:
        """
    ...
    async def list_index(
        self, **kwargs: Unpack[ListIndexRequestTypeDef]
    ) -> ListIndexResponseTypeDef:
        """
