...
class GetPlanEvaluationStatusPaginator(_GetPlanEvaluationStatusPaginatorBase):
    ...
    [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_arc_region_switch/paginators/#getplanevaluationstatuspaginator)
    """
...
class GetPlanExecutionPaginator(_GetPlanExecutionPaginatorBase):
    ...
    [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_arc_region_switch/paginators/#getplanexecutionpaginator)
    """
    def paginate(  # type: ignore[override]
...
class ListPlanExecutionEventsPaginator(_ListPlanExecutionEventsPaginatorBase):
    ...
    [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_arc_region_switch/paginators/#listplanexecutioneventspaginator)
    """
    def paginate(  # type: ignore[override]
...
class ListPlanExecutionsPaginator(_ListPlanExecutionsPaginatorBase):
    ...
    [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_arc_region_switch/paginators/#listplanexecutionspaginator)
    """
    def paginate(  # type: ignore[override]
...
class ListPlansInRegionPaginator(_ListPlansInRegionPaginatorBase):
    ...
    [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_arc_region_switch/paginators/#listplansinregionpaginator)
    """
    def paginate(  # type: ignore[override]
...
class ListRoute53HealthChecksPaginator(_ListRoute53HealthChecksPaginatorBase):
    ...
    [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_arc_region_switch/paginators/#listroute53healthcheckspaginator)
    """
    def paginate(  # type: ignore[override]
