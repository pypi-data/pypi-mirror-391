...
class PlanEvaluationStatusPassedWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_arc_region_switch/waiters/#planevaluationstatuspassedwaiter)
    """
...
class PlanExecutionCompletedWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_arc_region_switch/waiters/#planexecutioncompletedwaiter)
    """
    async def wait(  # type: ignore[override]
