...
class DeploymentCompleteWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_appconfig/waiters/#deploymentcompletewaiter)
    """
...
class EnvironmentReadyForDeploymentWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_appconfig/waiters/#environmentreadyfordeploymentwaiter)
    """
    async def wait(  # type: ignore[override]
