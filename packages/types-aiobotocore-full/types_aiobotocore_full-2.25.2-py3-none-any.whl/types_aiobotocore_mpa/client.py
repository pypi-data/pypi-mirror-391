...
class MultipartyApprovalClient(AioBaseClient):
    ...
    [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_mpa/client/)
    """
    ...
    def exceptions(self) -> Exceptions:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/mpa.html#MultipartyApproval.Client)
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_mpa/client/#exceptions)
        """
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_mpa/client/#can_paginate)
        """
    ...
    async def generate_presigned_url(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_mpa/client/#generate_presigned_url)
        """
    ...
    async def cancel_session(self, **kwargs: Unpack[CancelSessionRequestTypeDef]) -> dict[str, Any]:
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_mpa/client/#cancel_session)
        """
    ...
    async def create_approval_team(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_mpa/client/#create_approval_team)
        """
    ...
    async def create_identity_source(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_mpa/client/#create_identity_source)
        """
    ...
    async def delete_identity_source(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_mpa/client/#delete_identity_source)
        """
    ...
    async def delete_inactive_approval_team_version(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_mpa/client/#delete_inactive_approval_team_version)
        """
    ...
    async def get_approval_team(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_mpa/client/#get_approval_team)
        """
    ...
    async def get_identity_source(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_mpa/client/#get_identity_source)
        """
    ...
    async def get_policy_version(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_mpa/client/#get_policy_version)
        """
    ...
    async def get_resource_policy(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_mpa/client/#get_resource_policy)
        """
    ...
    async def get_session(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_mpa/client/#get_session)
        """
    ...
    async def list_approval_teams(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_mpa/client/#list_approval_teams)
        """
    ...
    async def list_identity_sources(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_mpa/client/#list_identity_sources)
        """
    ...
    async def list_policies(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_mpa/client/#list_policies)
        """
    ...
    async def list_policy_versions(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_mpa/client/#list_policy_versions)
        """
    ...
    async def list_resource_policies(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_mpa/client/#list_resource_policies)
        """
    ...
    async def list_sessions(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_mpa/client/#list_sessions)
        """
    ...
    async def list_tags_for_resource(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_mpa/client/#list_tags_for_resource)
        """
    ...
    async def start_active_approval_team_deletion(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_mpa/client/#start_active_approval_team_deletion)
        """
    ...
    async def tag_resource(self, **kwargs: Unpack[TagResourceRequestTypeDef]) -> dict[str, Any]:
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_mpa/client/#tag_resource)
        """
    ...
    async def untag_resource(self, **kwargs: Unpack[UntagResourceRequestTypeDef]) -> dict[str, Any]:
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_mpa/client/#untag_resource)
        """
    ...
    async def update_approval_team(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_mpa/client/#update_approval_team)
        """
    ...
    def get_paginator(  # type: ignore[override]
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_mpa/client/#get_paginator)
        """
