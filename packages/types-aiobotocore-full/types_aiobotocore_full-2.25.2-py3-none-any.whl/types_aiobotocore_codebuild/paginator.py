...
class ListCommandExecutionsForSandboxPaginator(_ListCommandExecutionsForSandboxPaginatorBase):
    ...
    [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_codebuild/paginators/#listcommandexecutionsforsandboxpaginator)
    """
...
class ListSandboxesForProjectPaginator(_ListSandboxesForProjectPaginatorBase):
    ...
    [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_codebuild/paginators/#listsandboxesforprojectpaginator)
    """
...
class ListSandboxesPaginator(_ListSandboxesPaginatorBase):
    ...
    [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_codebuild/paginators/#listsandboxespaginator)
    """
