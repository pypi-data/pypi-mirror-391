...
class S3ControlClient(AioBaseClient):
    ...
    async def delete_access_point_scope(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_s3control/client/#delete_access_point_scope)
        """
    ...
    async def get_access_point_scope(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_s3control/client/#get_access_point_scope)
        """
    ...
    async def list_access_points_for_directory_buckets(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_s3control/client/#list_access_points_for_directory_buckets)
        """
    ...
    async def put_access_point_scope(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_s3control/client/#put_access_point_scope)
        """
