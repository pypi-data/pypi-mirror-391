...
class MemoryCreatedWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_bedrock_agentcore_control/waiters/#memorycreatedwaiter)
    """
