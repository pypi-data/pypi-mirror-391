...
class RePostPrivateClient(AioBaseClient):
    ...
    async def batch_add_channel_role_to_accessors(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_repostspace/client/#batch_add_channel_role_to_accessors)
        """
    ...
    async def batch_remove_channel_role_from_accessors(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_repostspace/client/#batch_remove_channel_role_from_accessors)
        """
    ...
    async def create_channel(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_repostspace/client/#create_channel)
        """
    ...
    async def get_channel(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_repostspace/client/#get_channel)
        """
    ...
    async def list_channels(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_repostspace/client/#list_channels)
        """
    ...
    async def update_channel(self, **kwargs: Unpack[UpdateChannelInputTypeDef]) -> dict[str, Any]:
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_repostspace/client/#update_channel)
        """
    ...
    def get_waiter(  # type: ignore[override]
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_repostspace/client/#get_waiter)
        """
