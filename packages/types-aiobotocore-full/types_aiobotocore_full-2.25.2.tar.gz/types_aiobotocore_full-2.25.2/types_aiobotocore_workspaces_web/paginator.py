...
class ListSessionLoggersPaginator(_ListSessionLoggersPaginatorBase):
    ...
    [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_workspaces_web/paginators/#listsessionloggerspaginator)
    """
