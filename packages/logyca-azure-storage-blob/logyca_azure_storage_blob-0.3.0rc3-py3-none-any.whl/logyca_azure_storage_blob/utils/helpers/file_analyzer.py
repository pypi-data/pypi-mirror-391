...
DEFAULT_DATE_FORMAT = FormatDates.ISO_DATETIME
...
class FileAnalyzer:
    def __init__(self,
                 full_path_name:str,
                 date_format:Literal[
                        FormatDates.ISO_DATE,
                        FormatDates.ISO_DATETIME,
                        FormatDates.ISO_DATETIME_WITH_TZ,
                        FormatDates.SQL_SERVER,        
                        FormatDates.SQL_SERVER_WITH_TZ,
                        FormatDates.POSTGRES,        
                        FormatDates.POSTGRES_WITH_TZ,
                        "%Y-%m-%d %H:%M:%S"
                    ] = DEFAULT_DATE_FORMAT
            ) -> None:
        """
        ...
        date_format : str
            Defines the format in which dates retrieved from the file system will be returned.
            It must be a valid string compatible with `datetime.strftime()`, or one of the values ​​defined in `FormatDates`.
        ...
        self._file_properties.timestamps.date_format = date_format
