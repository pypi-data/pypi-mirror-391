...
### Changed
- Updated repository URLs to AletheionGuard-Pypi
- Updated contact email to contact@aletheionagi.com
- Updated documentation links to aletheionguard.com/docs
...
We welcome contributions! Please see our [Contributing Guide](https://github.com/AletheionAGI/AletheionGuard-Pypi/blob/main/CONTRIBUTING.md).

## License

AletheionGuard is dual-licensed:
- **AGPL-3.0-or-later** for open source use
- **Commercial License** available - contact contact@aletheionagi.com

---

**Full Changelog**: https://github.com/AletheionAGI/AletheionGuard-Pypi/blob/main/CHANGELOG.md
