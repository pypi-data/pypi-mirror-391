...
class DNS_ThreatDetector:
    ...
    def _predict_ensemble(self, domain: str) -> Tuple[str, float]:
        ...
        # RULE 1: Trusted TLDs (.gov, .edu, .mil) - Require BOTH models to agree strongly
        ...
        # RULE 2: Very short domains (x.com, t.co, a.co) - Need both models to agree
        ...
        # RULE 3: High entropy + high LSTM = DGA (very reliable signal)
        ...
        # RULE 4: LSTM extremely high confidence on DGA (even if low entropy)
