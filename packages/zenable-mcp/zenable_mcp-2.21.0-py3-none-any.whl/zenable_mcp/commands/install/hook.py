...
from zenable_mcp.ide_config import ClaudeCodeConfig, find_git_root
...
def get_settings_path(is_global: bool) -> Path:
    ...
    Raises:
        ...
        IDECapabilityError: If IDE doesn't support the requested installation mode
    """
    try:
        config = ClaudeCodeConfig(is_global=is_global)
        # Validate that the IDE supports the requested hook installation mode
        ...
        # Handle IDE capability exceptions
        echo(str(e), err=True)
