...
print(checkout.checkout_callback_urls)
```
...
client.with_options(max_retries=5).checkout.create(
    checkout_callback_urls={
        "cancelled_url": "https://example.com/callback",
        "success_url": "https://example.com/callback",
    },
...
client.with_options(timeout=5.0).checkout.create(
    checkout_callback_urls={
        "cancelled_url": "https://example.com/callback",
        "success_url": "https://example.com/callback",
    },
...
checkout = response.parse()  # get the object that `checkout.create()` would have returned
print(checkout.id)
```
