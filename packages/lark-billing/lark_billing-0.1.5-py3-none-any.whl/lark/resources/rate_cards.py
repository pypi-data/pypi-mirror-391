        ...
        *,
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                timeout=timeout,
                query=maybe_transform({"limit": limit}, rate_card_list_params.RateCardListParams),
            ),
        ...
        *,
        ...
        return await self._get(
            ...
            options=make_request_options(
                ...
                extra_body=extra_body,
                timeout=timeout,
                query=await async_maybe_transform({"limit": limit}, rate_card_list_params.RateCardListParams),
            ),
            cast_to=RateCardListResponse,
        )
