...
class TestConvertHttpToRayGcs:
    ...
    def test_convert_http_to_ray_gcs_success(
    ...
    @patch('synapse_sdk.plugins.upload.download_file')
    def test_convert_http_to_ray_gcs_already_exists(
        self, mock_download, mock_ray_module, mock_http_url, mock_gcs_uri
    ):
    ...
    @patch('synapse_sdk.plugins.upload.download_file')
    def test_convert_https_to_ray_gcs(
        self, mock_download, mock_ray_module, mock_https_url, mock_gcs_uri
    ):
    ...
    def test_convert_http_to_ray_gcs_ray_not_initialized(
        self, mock_ray_module, mock_http_url
    ):
    ...
    @patch('synapse_sdk.plugins.upload.download_file')
    def test_convert_http_to_ray_gcs_download_fails(
        self, mock_download, mock_ray_module, mock_http_url
    ):
    ...
    @patch('synapse_sdk.plugins.upload.download_file')
    def test_convert_http_to_ray_gcs_upload_fails(
        self, mock_download, mock_ray_module, mock_http_url, mock_gcs_uri
    ):
