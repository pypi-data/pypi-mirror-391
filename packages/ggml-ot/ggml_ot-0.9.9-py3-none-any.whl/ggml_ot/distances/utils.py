# TODO handle this better before publication
# Credit to https://github.com/steveli/pytorch-sqrtm
import torch
...
# Credit https://github.com/KingJamesSong/FastDifferentiableMatSqrt
from mpmath import *
...
class MPA_Lya(torch.autograd.Function):
    ...
    def forward(ctx, M):
        ...
        I = (
            torch.eye(M.size(1), requires_grad=False, device=M.device)
            .reshape(1, M.size(1), M.size(1))
            .repeat(M.size(0), 1, 1)
        )
