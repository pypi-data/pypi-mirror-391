...
class ListReputationEntitiesPaginator(_ListReputationEntitiesPaginatorBase):
    ...
    [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_sesv2/paginators/#listreputationentitiespaginator)
    """
    def paginate(  # type: ignore[override]
...
class ListResourceTenantsPaginator(_ListResourceTenantsPaginatorBase):
    ...
    [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_sesv2/paginators/#listresourcetenantspaginator)
    """
    def paginate(  # type: ignore[override]
...
class ListTenantResourcesPaginator(_ListTenantResourcesPaginatorBase):
    ...
    [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_sesv2/paginators/#listtenantresourcespaginator)
    """
    def paginate(  # type: ignore[override]
...
class ListTenantsPaginator(_ListTenantsPaginatorBase):
    ...
    [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_sesv2/paginators/#listtenantspaginator)
    """
    def paginate(  # type: ignore[override]
