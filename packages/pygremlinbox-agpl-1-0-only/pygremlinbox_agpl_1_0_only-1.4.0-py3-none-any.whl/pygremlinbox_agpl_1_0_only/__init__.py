...
"""
PyGremlinBox AGPL-1.0-only - Supply chain security testing module.

This package is licenced under AGPL-1.0-only.
...
maintaining compliance with AGPL-1.0-only requirements.
"""

__version__ = "1.4.0"
__licence__ = "AGPL-1.0-only"
...
def get_package_metadata():
    ...
    """
    return {
        "name": "PyGremlinBox-AGPL-1-0-only",
        "version": __version__,
        "licence": __licence__,
        "description": "Supply chain security testing module with AGPL-1.0-only licence",
        "spdx_licence_id": "AGPL-1.0-only"
    }
