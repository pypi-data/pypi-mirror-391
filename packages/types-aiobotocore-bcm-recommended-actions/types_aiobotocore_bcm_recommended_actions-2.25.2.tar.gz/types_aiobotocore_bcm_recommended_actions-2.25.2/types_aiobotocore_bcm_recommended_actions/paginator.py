...
class ListRecommendedActionsPaginator(_ListRecommendedActionsPaginatorBase):
    ...
    [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_bcm_recommended_actions/paginators/#listrecommendedactionspaginator)
    """
