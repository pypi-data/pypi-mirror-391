...
# Configure APIs
#scilink.configure('google', 'AIzaSyCeWoJCJWbBO6TmPcs3AFE8ZfieZ5wrOiY') #I suggest change 'google' to LLM key
#scilink.configure('futurehouse', '')


# Define image and metadata
image_path = "data/GO_cafm.tif" # GO_cafm.tif, nanoparticles.npy
system_info_path = "data/GO_cafm.json" # GO_cafm.json, nanoparticles.json
