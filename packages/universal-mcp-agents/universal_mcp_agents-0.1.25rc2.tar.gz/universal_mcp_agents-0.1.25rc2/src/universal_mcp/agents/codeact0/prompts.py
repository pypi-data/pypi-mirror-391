...
def _compose_poem(theme: str, style: str = "free verse", lines: int = 12) -> str:
    ...

def poem_generator(theme: str, style: str = "free verse", lines: int = 12) -> str:
    return _compose_poem(theme=theme, style=style, lines=lines)
```
