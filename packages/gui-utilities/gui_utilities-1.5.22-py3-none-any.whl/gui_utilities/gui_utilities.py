...
def create_information_message_box(
    ...
    if minimum_width is not None: message_box.setMinimumWidth(minimum_width)
    if maximum_width is not None: message_box.setMaximumWidth(maximum_width)
    style_sheet = f"""
        QDialog#message_box {{
            background-color: {background_color};
            border: {border_width}px solid {border_color};
...
def create_confirmation_message_box(
    ...
    if minimum_width is not None: confirm_message_box.setMinimumWidth(minimum_width)
    if maximum_width is not None: confirm_message_box.setMaximumWidth(maximum_width)
    style_sheet = f"""
