...
def create_information_message_box(
    ...
    text_label = create_label(
        ...
        maximum_width = fixed_width - left_margin - right_margin - (label_padding_left if label_padding_left is not None else label_padding) - (label_padding_right if label_padding_right is not None else label_padding),
        word_wrap = True,
        math_expression = math_expression,
        parent = message_box
    )
