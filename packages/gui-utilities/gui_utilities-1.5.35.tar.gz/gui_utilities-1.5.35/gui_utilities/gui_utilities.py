...
def format_html(expression):
    ...
    html_expression = re.sub(r"\\frac\{(.*?)\}\{(.*?)\}", r"<span style = 'white-space: normal;'>\1⁄\2</span>", html_expression)
    html_expression = re.sub(r"_\{([^}]+)\}", r"<sub style = 'white-space: normal;'>\1</sub>", html_expression)
    html_expression = re.sub(r"\^\{([^}]+)\}", r"<sup style = 'white-space: normal;'>\1</sup>", html_expression)
    html_expression = re.sub(r"_([a-zA-Z0-9]+)", r"<sub style = 'white-space: normal;'>\1</sub>", html_expression)
    html_expression = re.sub(r"\^([a-zA-Z0-9]+)", r"<sup style = 'white-space: normal;'>\1</sup>", html_expression)
