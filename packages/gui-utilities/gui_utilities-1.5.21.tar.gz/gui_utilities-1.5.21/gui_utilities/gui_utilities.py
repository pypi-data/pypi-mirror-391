...
def create_information_message_box(
    ...
    # Ajustar el tamaño del diálogo basado en el contenido
    if fixed_width is not None:
        message_box.setFixedWidth(fixed_width)
...
def create_confirmation_message_box(
    ...
    # Calcular el ancho disponible para el label
    label_padding_left_val = label_padding_left if label_padding_left is not None else label_padding
    label_padding_right_val = label_padding_right if label_padding_right is not None else label_padding
    available_width = fixed_width - left_margin - right_margin - label_padding_left_val - label_padding_right_val if fixed_width else None
    ...
    # Ajustar el tamaño del diálogo basado en el contenido
    if fixed_width is not None:
        confirm_message_box.setFixedWidth(fixed_width)
