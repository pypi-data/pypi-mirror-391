...
def _get_alignment_flag(alignment_str):
    ...
    parts = alignment_str.lower().split()
    ...
    for part in parts:
        final_alignment |= alignment_map.get(part, Qt.AlignmentFlag(0))
...
def create_menu(
    ...
    scrollbar_handle_background_color = "#1e1e1e",
