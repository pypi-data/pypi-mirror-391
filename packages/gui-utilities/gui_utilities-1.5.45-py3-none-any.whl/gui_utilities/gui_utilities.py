...
def create_text_box(
    ...
    disabled_border_width = 2,
    disabled_border_color = "#4a4a4a",
    show_text_icon_url = resource_path("gui_utilities/icons/show_text_icon.png"),
    hide_text_icon_url = resource_path("gui_utilities/icons/hide_text_icon.png"),
    focused_show_text_icon_url = resource_path("gui_utilities/icons/focused_show_text_icon.png"),
    focused_hide_text_icon_url = resource_path("gui_utilities/icons/focused_hide_text_icon.png"),
    hide_text = False,
    math_expression = False,
    parent = None
):
...
def create_information_message_box(
    ...
    buttons_layout.addWidget(accept_button, 2)
    buttons_layout.addStretch(1)
...
def create_confirmation_message_box(
    ...
    buttons_layout.addWidget(confirm_button, 2)
    ...
    buttons_layout.addWidget(decline_button, 2)
    buttons_layout.addStretch(1)
...
tlds_list_path = resource_path("gui_utilities/tlds/tlds_list.txt")
