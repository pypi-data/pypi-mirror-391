...
def create_information_message_box(
    ...
    text_label.setMaximumWidth(message_box.width() - main_layout.contentsMargins().left() - main_layout.contentsMargins().right())
...
def create_confirmation_message_box(
    ...
    main_layout.addWidget(text_label)
    text_label.setMaximumWidth(confirm_message_box.width() - main_layout.contentsMargins().left() - main_layout.contentsMargins().right())
