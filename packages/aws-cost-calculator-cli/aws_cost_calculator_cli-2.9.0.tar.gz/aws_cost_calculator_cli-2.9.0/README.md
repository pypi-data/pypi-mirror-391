...
- **S3 Caching**: Automatically caches finalized dates for 33%+ faster repeated queries
...
- **Usage Types Drill-Down**: Click any single service to see top 10 usage types (requires CUR/Athena)
- `--force` flag to bypass cache and refresh data
...
- **Drill into usage types** to understand what's driving service costs
- Export comprehensive cost data for analysis

**📖 Documentation**:
- [USAGE_TYPES_FEATURE.md](USAGE_TYPES_FEATURE.md) - Usage types drill-down
- [S3_CACHING.md](S3_CACHING.md) - S3 caching performance guide
