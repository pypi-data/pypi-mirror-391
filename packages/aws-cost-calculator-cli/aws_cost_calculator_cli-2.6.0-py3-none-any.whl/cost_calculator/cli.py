...
def daily_report(profile, offset, window, top_services, top_accounts, share, sso, access_key_id, secret_access_key, session_token):
    ...
    This command queries Cost Explorer day-by-day for comprehensive cost data
    across all accounts and services in the profile. Perfect for creating
    unified charts showing account and service breakdowns over time.
    
    Examples:
        # Last 30 days (T-2 to T-32)
        cc daily-report --profile khoros
        
        # Last 40 days from Oct 1
        cc daily-report --profile khoros --offset 2 --window 40
        
        # Generate shareable chart
        cc daily-report --profile khoros --share
    """
    from cost_calculator.executor import get_credentials_dict
