...
class DbuiV1Notable(BaseModel):
    ...
    last_id: StrictStr = Field(description="The ID of the last notable ing the group.")
    summary: StrictStr
    ...
    __properties: ClassVar[List[str]] = ["id", "last_id", "summary", "context", "state", "assignedTo", "rule", "observables", "severity", "collate"]
