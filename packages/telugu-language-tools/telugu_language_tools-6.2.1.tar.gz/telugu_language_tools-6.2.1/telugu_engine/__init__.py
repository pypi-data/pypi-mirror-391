...
- Enhanced grammar integration with varga classifications (from v6.2.0)
...
- Consonant nature detection (harsh/soft/stable) (from v6.2.0)
- Word ending classifications for morphophonology (from v6.2.0)
- Merged pipeline with comprehensive API (from v6.2.0)
