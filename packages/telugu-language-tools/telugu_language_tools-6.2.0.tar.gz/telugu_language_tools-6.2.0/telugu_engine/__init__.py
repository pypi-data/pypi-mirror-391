...
Complete v3.0 compliant Telugu processing library with enhanced grammar integration:
...
v6.2.0 Features:
- Enhanced grammar integration with varga classifications
- Context-aware anusvara resolution
- Sandhi rule applications (Athva, Yadagama, etc.)
- Grammar-based validation and scoring
- Consonant nature detection (harsh/soft/stable)
- Word ending classifications for morphophonology
- Merged pipeline with comprehensive API
