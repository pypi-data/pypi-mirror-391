...
class FeatrixSphereClient:
    ...
    def train_single_predictor(self, session_id: str, target_column: str, target_column_type: str,
        ...
        =======================================================
        **THE PRIMARY USE CASE**: Use file_path to train your predictor on DIFFERENT data 
        ...
        ⚠️  IMPORTANT: The predictor training file MUST have:
        ...
        🏗️ AUTOMATIC ARCHITECTURE SELECTION (NEW):
        ------------------------------------------
        ...
        🏗️ ARCHITECTURE DECISION: 4 hidden layers
           → Reasoning:
        ...
        Args:
            ...
            file_path: ⚡ **RECOMMENDED** Path to DIFFERENT training file (CSV or .csv.gz) to use for 
                      predictor training. If not provided, uses session's original data file.
                      🎯 USE THIS to train predictor on different/filtered/recent data than your 
                      embedding space! This is the primary way to split ES and predictor training data.
