...
from ..sessions import SessionExtraProperties, SessionStatus, SessionUpdateFields
...
class SessionsSearchRequest(BaseModel):
    ...
    extra_properties: Optional[List[SessionExtraProperties]] = Field(default=None, description="Propriedades extras a serem incluídas na resposta")
