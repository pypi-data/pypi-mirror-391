...
# Next Steps for ndx-wearables Extension for NWB

## Creating Your Extension

1. In a terminal, change directory into the new ndx-wearables directory: `cd ndx-wearables`
...
`spec/ndx-wearables.namespace.yaml` and
`spec/ndx-wearables.extensions.yaml` files.

6. Define API classes for your new extension data types.

    - As a starting point, `src/pynwb/ndx_wearables/__init__.py` includes an
...
`src/pynwb/ndx_wearables/tests` or `src/matnwb/tests`.
...
`src/pynwb/ndx_wearables/widgets` so that the visualizations can be displayed with
[nwbwidgets](https://github.com/NeurodataWithoutBorders/nwbwidgets).
You will also need to update the `vis_spec` dictionary in 
`src/pynwb/ndx_wearables/widgets/__init__.py` so that
...
2. Start a git repository for your extension directory ndx-wearables
...
8. Make a release for the extension on GitHub with the version number specified. e.g. if version is 0.1.0, then this page should exist: https://github.com/TomekFraczek/ndx-wearables/releases/tag/0.1.0 . For instructions on how to make a release on GitHub see [here](https://help.github.com/en/github/administering-a-repository/creating-releases).
...
9. Publish your updated extension on [PyPI](https://pypi.org/).
    ...
    - If your extension version is 0.1.0, then this page should exist: https://pypi.org/project/ndx-wearables/0.1.0
...
`staged-extensions/ndx-wearables`:

    ```bash
    cp -r staged-extensions/example staged-extensions/ndx-wearables
    ```

13. Edit `staged-extensions/ndx-wearables/ndx-meta.yaml`
with information on where to find your NWB extension.
    ...
    - You may copy and modify the following YAML that was auto-generated:
      ...
      name: ndx-wearables
      version: 0.1.0
      src: https://github.com/TomekFraczek/ndx-wearables
      pip: https://pypi.org/project/ndx-wearables/
      license: BSD-3
      maintainers: 
        - TomekFraczek
      ```

14. Edit `staged-extensions/ndx-wearables/README.md`
to add information about your extension. You may copy it from
`ndx-wearables/README.md`.

  ```bash
  cp ndx-wearables/README.md staged-extensions/ndx-wearables/README.md
  ```

15. Add and commit your changes to Git and push your changes to GitHub.
```
cd staged-extensions
git add ndx-wearables
git commit -m "Add new catalog entry for ndx-wearables" .
git push
```
...
ndx-wearables-record will be created in the nwb-extensions
GitHub organization and you will be added as a maintainer for that repository.


## Updating Your Published Extension

1. Update your ndx-wearables GitHub repository.

2. Publish your updated extension on PyPI.

3. Fork the ndx-wearables-record repository on GitHub.
