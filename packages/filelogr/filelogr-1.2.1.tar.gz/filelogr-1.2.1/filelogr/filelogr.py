...
optionally printing them to the console with optional colors.
...
class Logger:
    ...
    @classmethod
    def log_action(cls, action: str, print_to_console: bool = True, separator: bool = False,
                   tag: str = None, color: str = None):
        """
        ...
        - color: optional console color (red, green, yellow, blue, magenta, cyan, white)
        """
        ...
        # handle console printing with optional color
        if print_to_console:
            if color:
                colors = {
                    "black": "\033[30m",
