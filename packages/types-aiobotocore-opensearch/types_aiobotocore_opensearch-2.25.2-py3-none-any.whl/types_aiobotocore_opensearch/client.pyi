...
class OpenSearchServiceClient(AioBaseClient):
    ...
    async def get_default_application_setting(self) -> GetDefaultApplicationSettingResponseTypeDef:
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_opensearch/client/#get_default_application_setting)
        """
