...
def ec_shared_key(ec_public_key: ec.EllipticCurvePublicKey, ec_private_key: ec.EllipticCurvePrivateKey) -> bytes:
    shared_secret = ec_private_key.exchange(ec.ECDH(), ec_public_key)
...
def encrypt_ec(data: bytes, ec_public_key: ec.EllipticCurvePublicKey) -> bytes:
    ...
    encryption_key = ec_shared_key(ec_public_key, e_private_key)
