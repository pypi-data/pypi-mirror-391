...
"""
PyGremlinBox GPL-2.0 - Supply chain security testing module.

This package is licenced under the GNU General Public License v2.0 (GPL-2.0).
...
maintaining compliance with GPL-2.0 requirements.
"""
...
def get_package_metadata():
    ...
    """
    return {
        "name": "pygremlinbox-gpl-2.0",
        "version": __version__,
        "licence": __licence__,
        "description": "Supply chain security testing module with GPL-2.0 licence",
        "spdx_licence_id": "GPL-2.0"
    }
