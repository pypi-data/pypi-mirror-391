from pro_craft_infer import AsyncIntel

from utils_z.test_func import atest_by_use_case
...
class Test_UserInfo():
    ...
    async def test_relationship(self,userinfo):
        ...
        await atest_by_use_case(func=userinfo.auser_relationship_extraction,
                                eval=evals,
    ...
    async def test_user_overview(self,userinfo):
        ...
        await atest_by_use_case(func=userinfo.auser_overview,
                                eval=evals,
                                PASS_THRESHOLD_PERCENT=100)
...
class Test_MemoryCard():
    ...
    async def test_ascore_from_memory_card(self,manager):
        ...
        await atest_by_use_case(func=manager.ascore_from_memory_card,
                                eval=evals,
                                PASS_THRESHOLD_PERCENT=100)
    ...
    async def test_amemory_card_merge(self,manager):
        ...
        await atest_by_use_case(func=manager.amemory_card_merge,
                                eval=evals,
                                PASS_THRESHOLD_PERCENT=100)
    ...
    async def test_amemory_card_polish(self,manager):
        ...
        await atest_by_use_case(func=manager.amemory_card_polish,
                                eval=evals,
                                PASS_THRESHOLD_PERCENT=100)
    ...
    async def test_get_time(self,manager):
        ...
        await atest_by_use_case(func=manager.get_time,
                                eval=evals,
                                PASS_THRESHOLD_PERCENT=100)
