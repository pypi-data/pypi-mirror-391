...
class MemoryCardManager:
    ...
    async def agenerate_memory_card_by_text(self, chat_history_str: str, birthday: str, age : str):
        ...
        # 生成最初的文本
        # logger.notice(f'chapters & {type(chapters)} &  {chapters}')
        ...
        # logger.notice(f'chapters_with_tags & {type(chapters_with_tags)} &  {chapters_with_tags}')
        ...
        # logger.notice(f'chapters_with_time & {type(chapters_with_tags)} &  {chapters_with_tags}')
