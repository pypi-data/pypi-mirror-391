"""
Extended from torch/utils/data/_utils/collate.py
"""
...
def collate(
    ...
    *,
    ...
    return collate_fn_map.get(elem_type, collate_default_fn)(batch, collate_fn_map=collate_fn_map)
