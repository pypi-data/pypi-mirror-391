...
class EC():
  ...
  def to_be_presence(self,target_CS_WE,timeout=5,parent_CS_WE=None)->WebElement|None:
    '''
    ...
    return self.__wait(wait_func,timeout,parent_CS_WE)

  @ECElementDeco('all_to_be_presence')
  def all_to_be_presence(self,target_CS_WE,timeout=5,parent_CS_WE=None)->list[WebElement]|None:
    '''
  ...
  def to_be_visible(self,target_CS_WE,timeout=5,parent_CS_WE=None)->WebElement|None:
    '''
  ...
  def all_to_be_visible(self,target_CS_WE,timeout=5,parent_CS_WE=None)->list[WebElement]|None:  
    '''
  ...
  def any_to_be_visible(self,target_CS_WE,timeout=5,parent_CS_WE=None)->list[WebElement]|None:
    '''
  ...
  def to_be_invisible(self,target_CS_WE,timeout=5,parent_CS_WE=None)->bool:  
    '''
    ...
    return bool(self.__wait(wait_func,timeout,parent_CS_WE))

  #-- module 5: wait for text and value --#
  @ECElementTextDeco('value_contains')
  def value_contains(self,target_CS_WE,text,timeout=5,parent_CS_WE=None)->bool:
    '''
  ...
  def text_contains(self,target_CS_WE,text,timeout=5,parent_CS_WE=None)->bool:
    '''
  ...
  def to_be_clickable(self,target_CS_WE,timeout=5,parent_CS_WE=None)->WebElement|None:
    '''
  ...
  def to_be_selected(self,target_CS_WE,timeout=5,parent_CS_WE=None)->bool:
    '''
  ...
  def to_be_stale(self,target_CS_WE,timeout=5,parent_CS_WE=None)->bool:
    '''
    ...
    @returns {true|None}
    '''
    web_element = self.to_be_presence(target_CS_WE,1,parent_CS_WE)
    if not web_element:
      return True
  ...
  def frame_to_be_switched(self,target_CS_WE,timeout=5,parent_CS_WE=None)->bool:
    '''
  ...
  def __wait(self,wait_func,timeout=5,parent_CS_WE=None)->any:
    '''
    ...
    '''
    try:
      context = self.__finder.get_context(parent_CS_WE)
