...
class LLMCall:
	...
	def _save_llm_call(
		...
		# Determine prompt reference - only the template path
		prompt_ref_path = None
		prompt_ref_type = None
		
		# Check if this is using a final prompt or a versioned prompt
		if hasattr(prompt_template, "_saved_version_path"):
