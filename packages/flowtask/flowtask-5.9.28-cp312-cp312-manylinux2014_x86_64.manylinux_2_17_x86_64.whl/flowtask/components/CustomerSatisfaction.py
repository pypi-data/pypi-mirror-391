    ...
    """
        ...
        CustomerSatisfaction:
          ...
          llm:
            ...
            max_tokens: 4096
          survey: true
          eval_column: response_label
          description_column: account_name
          question_prompt: |
            Question: What is the overall sentiment, likes and dislikes and insights 
            from these survey answers for account: {obj_name}?
          columns:
          - account_name
          output_column: retailer_evaluation
        ```
