...
FLAG_DATASET_DEFAULT_HOST = "https://ei2rmd.baai.ac.cn"
# FLAG_DATASET_DEFAULT_AUTH_LOGIN_API = "api/user-srv/userAccessKey/v1/getAccessToken"
FLAG_DATASET_DEFAULT_AUTH_LOGIN_API = "api/eai/userAccessKey/getAccessToken"
FLAG_DATASET_DEFAULT_SING_DOWNLOAD_API = "api/storage-download/api/v1/provider-storage/download/presign"
FLAG_DATASET_DEFAULT_META_DOWNLOAD_API = "api/storage-download/api/v1/provider-meta/storage/meta-down"
...
class Application:
    ...
    def __init__(self):
        if not self._initialized:
            ...
            # size
            self.executor_worker_size = config_default.get(FLAG_DATASET_EXECUTOR_WORKER_SIZE, 10)
            self.executor_down_size = config_default.get(FLAG_DATASET_EXECUTOR_DOWN_SIZE, 20)
            self.executor_merge_size = config_default.get(FLAG_DATASET_EXECUTOR_MERGE_SIZE, 5)
