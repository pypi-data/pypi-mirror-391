...
##Description
Afan_oromo_tokenizer is a linguistically informed and computationally efficient tokenizer for **Afaan Oromo**, one of the most widely spoken low-resource languages in Africa.  

-It can be used for different tasks such as:-
