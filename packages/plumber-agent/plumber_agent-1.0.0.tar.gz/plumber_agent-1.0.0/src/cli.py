...
def install_service(host, port, auto_start):
    ...
    try:
        ...
        if success:
            click.secho("✓ Service installed successfully!", fg='green')
            click.echo("\nNext steps:")
            ...
            click.secho("✗ Service installation failed", fg='red')
            sys.exit(1)
...
def uninstall_service():
    ...
    try:
        ...
        if success:
            click.secho("✓ Service uninstalled successfully!", fg='green')
        else:
            click.secho("✗ Service uninstallation failed", fg='red')
            sys.exit(1)
    except Exception as e:
        click.secho(f"✗ Error: {e}", fg='red')
        sys.exit(1)
...
def start():
    ...
    try:
        ...
        if success:
            ...
            click.secho("✗ Service start failed", fg='red')
            sys.exit(1)
    except Exception as e:
        click.secho(f"✗ Error: {e}", fg='red')
        sys.exit(1)
...
def stop():
    ...
    try:
        ...
        if success:
            ...
            click.secho("✗ Service stop failed", fg='red')
            sys.exit(1)
    except Exception as e:
        click.secho(f"✗ Error: {e}", fg='red')
        sys.exit(1)
...
def restart():
    ...
    try:
        ...
        if success:
            ...
            click.secho("✗ Service restart failed", fg='red')
            sys.exit(1)
    except Exception as e:
        click.secho(f"✗ Error: {e}", fg='red')
        sys.exit(1)
...
def status():
    ...
    try:
        ...
        if status_info['is_running']:
            click.secho("● Plumber Agent is running", fg='green', bold=True)
        else:
            click.secho("○ Plumber Agent is stopped", fg='yellow', bold=True)
...
def discover():
    ...
    dccs = discovery_instance.discovered_dccs
