...
def HNSW_shrink_neighbor_list(qdis, input, output, max_size, keep_max_size_level0=False):
    return _swigfaiss.HNSW_shrink_neighbor_list(qdis, input, output, max_size, keep_max_size_level0)
...
class RaBitQuantizer(Quantizer):
    ...
    def get_distance_computer(self, qb, centroid_in=None, centered=False):
        return _swigfaiss.RaBitQuantizer_get_distance_computer(self, qb, centroid_in, centered)
...
class FactorsData(object):
    ...
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    or_minus_c_l2sqr = property(_swigfaiss.FactorsData_or_minus_c_l2sqr_get, _swigfaiss.FactorsData_or_minus_c_l2sqr_set)
    dp_multiplier = property(_swigfaiss.FactorsData_dp_multiplier_get, _swigfaiss.FactorsData_dp_multiplier_set)
...
def TimeoutCallback_reset(timeout_in_seconds):
    return _swigfaiss.TimeoutCallback_reset(timeout_in_seconds)
...
def MaybeOwnedVectorUInt8_create_view(address, n_elements, owner):
    return _swigfaiss.MaybeOwnedVectorUInt8_create_view(address, n_elements, owner)
...
def MaybeOwnedVectorInt32_create_view(address, n_elements, owner):
    return _swigfaiss.MaybeOwnedVectorInt32_create_view(address, n_elements, owner)
...
def MaybeOwnedVectorFloat32_create_view(address, n_elements, owner):
    return _swigfaiss.MaybeOwnedVectorFloat32_create_view(address, n_elements, owner)
...
def PythonInterruptCallback_reset():
    return _swigfaiss.PythonInterruptCallback_reset()
