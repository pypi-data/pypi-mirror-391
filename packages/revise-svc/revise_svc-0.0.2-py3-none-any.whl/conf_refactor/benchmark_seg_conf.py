...
from conf_refactor.base_conf import BaseConf
...
class BenchmarkSegConf(BaseConf):
    ...
    @property
    def result_dir(self):
        return os.path.join(self.result_root_path, self.sub_file_path, self.seg_method)

    @property
    def st_file_path(self):
        return os.path.join(self.data_root_path, self.sub_file_path, self.seg_method, self.st_file)
