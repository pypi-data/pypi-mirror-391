...
def merge_subcluster(ct_adata_sc, subcluster, mode="mean"):
    """
    Merge single-cell data into pseudo-bulk data based on subcluster (optimized for sparse matrix processing)
    ...
    mode : str
        Merge mode: "mean", "max", or "median"

    Returns:
    --------
    AnnData
        Merged pseudo-bulk data
    """
