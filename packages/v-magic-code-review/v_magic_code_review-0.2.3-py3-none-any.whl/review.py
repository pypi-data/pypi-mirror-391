...
def code_review(
    ...
    logger.info("code changes line length: {}", len(ri.mr_diff))
    logger.info("code changes file count: {}", len(ri.mr_diff_by_file))

    if len(ri.mr_diff) < 1000 or len(ri.mr_diff_by_file) == 1:
