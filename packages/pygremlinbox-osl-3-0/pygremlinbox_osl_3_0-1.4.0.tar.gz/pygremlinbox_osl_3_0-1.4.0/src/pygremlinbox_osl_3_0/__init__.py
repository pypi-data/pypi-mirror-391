...
"""
PyGremlinBox OSL-3.0 - Supply chain security testing module.

This package is licenced under the Open Software License v3.0 (OSL-3.0).
...
def get_package_metadata():
    ...
    """
    return {
        "name": "pygremlinbox-osl-3.0",
        "version": __version__,
        "licence": __licence__,
        "description": "Supply chain security testing module with OSL-3.0 licence",
        "spdx_licence_id": "OSL-3.0"
    }
