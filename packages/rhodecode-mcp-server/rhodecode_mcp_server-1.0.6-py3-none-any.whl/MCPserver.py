...
def rc_jsonrpc(method: str, args: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
    ...
    # Si RC_CERT_PATH está configurado, úsalo (para certificados auto-firmados)
    # Si no, usa el valor booleano de RC_VERIFY_SSL
    if RC_CERT_PATH:
        verify_ssl = RC_CERT_PATH
    else:
        verify_ssl = RC_VERIFY_SSL
