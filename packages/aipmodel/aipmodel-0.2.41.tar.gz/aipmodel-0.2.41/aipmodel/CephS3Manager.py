...
class CephS3Manager:
    ...
    def is_folder(self, key):
        ...
        try:
            ...
            if key.endswith("/"):
                if self.verbose:
                    print(f"[OK] {key} is a folder (ends with /)")
                return True
            ...
            if is_folder:
                if self.verbose:
                    print(f"[OK] {key} is a folder (contains objects)")
            else:
                if self.verbose:
    ...
    def delete_folder(self, prefix):
        ...
        try:
            ...
            if not objects_to_delete:
                print(f"[WARN] No objects found to delete for prefix: {prefix}")
                print("[OK] Folder delete (no-op) completed successfully")
                return

            print(f"Found {len(objects_to_delete)} objects to delete. Deleting in chunks of 1000...")
            ...
            for i in range(0, len(objects_to_delete), 1000):
                ...
                if self.verbose:
                    print(f"Deleted chunk {i//1000 + 1}")
    ...
    def move_folder(self, src_prefix, dest_prefix):
        ...
        try:
            ...
            print(f"Found {len(keys_to_copy)} objects to move. Copying...")
            ...
            print("Copy complete. Deleting source folder...")
