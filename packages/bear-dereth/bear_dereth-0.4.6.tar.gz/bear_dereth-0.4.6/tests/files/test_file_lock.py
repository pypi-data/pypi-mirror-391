...
from funcy_bear.files.file_lock import EXCLUSIVE_LOCK, SHARED_LOCK, UNLOCK, FileLock, LockExclusive, LockShared
import pytest
...
def test_file_lock_acquire_and_release(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr("funcy_bear.files.file_lock.fcntl.flock", fake_flock)
