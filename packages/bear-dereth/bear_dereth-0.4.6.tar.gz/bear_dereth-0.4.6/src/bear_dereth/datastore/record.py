...
class Records(RootModel[tuple[Record, ...]]):
    ...
    def order_by(self, *keys: str, reverse: bool = False) -> Records:
        ...
        Note:
            None values are always sorted last (or first if reverse=True)
        """
        ...
        return Records(sorted(self.root, key=sort_key))
