...
```python
from bear_dereth.encoders.message_pack import pack, unpack
...
```python
from bear_dereth.encoders.message_pack import MsgPackHandler
...
stream = pack(obj1) + pack(obj2) + pack(obj3)
...
```python
from bear_dereth.files.msgpack import MsgPackFileHandler
...
```python
from bear_dereth.encoders.message_pack.common import Tag, FixFamily
