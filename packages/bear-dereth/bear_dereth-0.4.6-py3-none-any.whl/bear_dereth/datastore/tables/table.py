...
from bear_dereth.datastore.wal_helper import WALHelper, WALHelperDummy
...
class Table(TableProtocol[Record, Records]):
    ...
    def __init__(
        ...
        Args:
            ...
            save_callback: Callback to save changes to storage
    ...
    def update(
        ...
        **kwargs,
        ...
        # Remove primary key from update fields (it's used as a filter, not updated)
    ...
    def update_all(
        ...
        if wal_updates:
            self._with_wal_or_save(
                wal_log_fn=self.wal_helper.update_batch,
                updates=wal_updates,
                flush=flush,
            )
    ...
    def delete_all(
        ...
        if pk_values:
            self._with_wal_or_save(
                wal_log_fn=self.wal_helper.delete_batch,
