...
"""
PyGremlinBox LGPL-2.0 - Supply chain security testing module.

This package is licenced under LGPL-2.0.
...
maintaining compliance with LGPL-2.0 requirements.
"""

__version__ = "1.4.0"
__licence__ = "LGPL-2.0"
...
def get_package_metadata():
    ...
    """
    return {
        "name": "PyGremlinBox-LGPL-2-0",
        "version": __version__,
        "licence": __licence__,
        "description": "Supply chain security testing module with LGPL-2.0 licence",
        "spdx_licence_id": "LGPL-2.0"
    }
