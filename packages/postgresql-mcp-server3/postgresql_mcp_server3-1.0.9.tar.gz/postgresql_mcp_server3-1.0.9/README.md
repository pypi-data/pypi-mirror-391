...
#### Using FastMCP CLI
```bash
fastmcp run postgresql_mcp_server3/server.py
```

#### Direct Python Execution
```bash
python postgresql_mcp_server3/server.py
```

#### Development Mode with UV
```bash
uv run postgresql_mcp_server3/server.py
```

#### Using fastmcp debug
```bash
fastmcp dev postgresql_mcp_server3/server.py
```
...
```json
{
  "mcpServers": {
    "postgresql-dev": {
      "command": "uv",
      "args": ["run", "postgresql_mcp_server3/server.py"],
...
```python
# Test SQL execution
from postgresql_mcp_server3.tools.db_tool import sql_exec
...
```bash
# Format code
black postgresql_mcp_server3/
isort postgresql_mcp_server3/

# Lint code
flake8 postgresql_mcp_server3/
mypy postgresql_mcp_server3/

# Run tests
pytest tests/ -v

# Run tests with coverage
pytest --cov=postgresql_mcp_server3 --cov-report=html
```
