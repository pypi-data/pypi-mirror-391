...
from postgresql_mcp_server3 import get_base_package_info

project_path=os.path.abspath(os.path.join(os.path.dirname(__file__), '..'))
# Add current directory to Python module search path
sys.path.insert(0,project_path)
from postgresql_mcp_server3.utils.logger_util import logger, db_config_path
from postgresql_mcp_server3.utils.db_operate import execute_sql
from postgresql_mcp_server3.utils import load_activate_db_config
from postgresql_mcp_server3.tools.db_tool import generate_test_data
from postgresql_mcp_server3.resources.db_resources import generate_database_config, generate_database_tables
...
def main():
    ...
    logger.info("PostgreSQL DataSource MCP Client server is ready to accept connections")
