...
from .. import GetAllProxiesRequestData, GetAllProxiesResponseData, CreateProxyRequestData, CreateProxyResponseData, \
    DeleteProxyResponseData, DeleteProxyRequestData, GetProxyRequestData, GetProxyResponseData, UpdateProxyRequestData, \
    UpdateProxyResponseData
...
class ProxyRouter(Router):
    ...
    @route(
        path='/update',
        request_data=UpdateProxyRequestData,
        response_data=UpdateProxyResponseData,
        response_field='proxy'
    )
