...
# def get_model(model_or_cls):
#     if isinstance(model_or_cls, pf.Model):
#         model = model_or_cls
#         cls = model.__class__
#         kwargs = model.parametric_kwargs
#     else:
#         cls = model_or_cls
#         model = model_or_cls()
#         if not isinstance(model, pf.Model):
#             raise TypeError("Expected 'Model' type.")
#         kwargs = {}
#     return Model(
#         **{
#             "id": model._id,
#             "base_class": cls.__name__,
#             "parameters": inspect_parameters(cls, kwargs)[0],
#         }
#     )


# def get_reference(reference, component_id):
#     x, y = (10 * int(x) for x in reference.center())
#     z = 0
#     r = (round(reference.rotation / 90) % 4) * 90
#     if component_id in reference._metadata:
#         x, y, z, r = reference._metadata[component_id]
#     return Reference(
#         **{
#             "id": reference._id,
#             "component": reference.component._id,
#             "position": (x, y),
#             "z_index": z,
#             "rotation": r,
#         }
