...
_OptModel = _pft.annotate(_typ.Literal["Tidy3D", "Waveguide"], optional=True)
_OptTechnology = _pft.annotate(_pf.Technology, optional=True)
_OptStr = _pft.annotate(str, optional=True)


def _opt_kwargs_for(fn_or_cls):
    type_, metadata = _typ.get_args(_pft.kwargs_for(fn_or_cls))
    metadata = dict(metadata.items())
    metadata["optional"] = True
    return _typ.Annotated[type_, _pft._Metadata(**metadata)]
...
def straight(
    *,
    ...
    active_model: _OptModel | None = None,
    technology: _OptTechnology | None = None,
    name: _OptStr | None = None,
    tidy3d_model_kwargs: _opt_kwargs_for(_Tidy3DModel) | None = None,
    waveguide_model_kwargs: _opt_kwargs_for(_WaveguideModel) | None = None,
) -> _pf.Component:
    ...
    c.add_model(_WaveguideModel(**dict(waveguide_model_kwargs)), "Waveguide", False)

    model_kwargs = {"port_symmetries": [(p1, p0)]}
    model_kwargs.update(tidy3d_model_kwargs)
    c.add_model(_Tidy3DModel(**model_kwargs), "Tidy3D", False)
...
def transition(
    *,
    ...
    c.add_model(_Tidy3DModel(**dict(tidy3d_model_kwargs)), "Tidy3D")
    return c
...
def bend(
    *,
    ...
    c.add_model(_WaveguideModel(**model_kwargs), "Waveguide", False)
...
def ring_coupler(
    *,
    ...
    if xp == 0:
        model_kwargs["port_symmetries"] = [(p1, p0)]
    model_kwargs.update(tidy3d_model_kwargs)
    c.add_model(_Tidy3DModel(**model_kwargs), "Tidy3D")
    return c
...
def rectangular_spiral(
    *,
    ...
    technology: _OptTechnology | None = None,
    name: _OptStr | None = None,
    straight_kwargs: _opt_kwargs_for(straight) | None = None,
    bend_kwargs: _opt_kwargs_for(bend) | None = None,
    tidy3d_model_kwargs: _opt_kwargs_for(_Tidy3DModel) | None = None,
    circuit_model_kwargs: _opt_kwargs_for(_CircuitModel) | None = None,
) -> _pf.Component:
    """Rectangular spiral.
    ...
    c.add_model(_CircuitModel(**dict(circuit_model_kwargs)), "Circuit", False)
...
def route(
    *,
    ...
    straight_kwargs: _opt_kwargs_for(straight) | None = None,
    bend_kwargs: _opt_kwargs_for(bend) | None = None,
    s_bend_kwargs: _opt_kwargs_for(s_bend) | None = None,
    circuit_model_kwargs: _opt_kwargs_for(_CircuitModel) | None = None,
) -> _pf.Component:
    ...
    component.add_model(_CircuitModel(**dict(circuit_model_kwargs)), "Circuit")
