...
class CountThreadsRequest(_message.Message):
    ...
    values: _struct_pb2.Struct
    status: _enum_thread_status_pb2.ThreadStatus
    def __init__(self, filters: _Optional[_Mapping[str, AuthFilter]] = ..., metadata: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ..., values: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ..., status: _Optional[_Union[_enum_thread_status_pb2.ThreadStatus, str]] = ...) -> None: ...
...
class SetThreadStatusRequest(_message.Message):
    ...
    def __init__(self, thread_id: _Optional[_Union[UUID, _Mapping]] = ..., status: _Optional[_Union[_enum_thread_status_pb2.ThreadStatus, str]] = ..., checkpoint: _Optional[_Union[CheckpointPayload, _Mapping]] = ..., exception: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ..., expected_status: _Optional[_Iterable[_Union[_enum_thread_status_pb2.ThreadStatus, str]]] = ...) -> None: ...
