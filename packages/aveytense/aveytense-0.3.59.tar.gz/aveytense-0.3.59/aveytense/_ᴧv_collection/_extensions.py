...
AnnotateFunc: TypeAlias = AVT_Callable[[Format], AVT_Dict[str, AnnotationForm]] # >= 0.3.57 // _typeshed.AnnotateFunc
ColorType: TypeAlias = Union[int, str, None] # >= 0.3.25 // renamed from SupportsColor (0.3.26b3)
ColourType: TypeAlias = ColorType # >= 0.3.26b3
EvaluateFunc: TypeAlias = AVT_Callable[[Format], AnnotationForm] # >= 0.3.59 // _typeshed.EvaluateFunc

### File Types ###
# These aim to allow service in non-stub Python files.
...
if _sys.version_info >= (3, 9): # >= 0.3.44 // 0.3.53: '_hashlib.HASHXOF' undefined before Python 3.9
