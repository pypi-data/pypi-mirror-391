...
"""
PyGremlinBox AGPL-3.0-only - Supply chain security testing module.

This package is licenced under AGPL-3.0-only.
...
maintaining compliance with AGPL-3.0-only requirements.
"""
...
def get_package_metadata():
    ...
    """
    return {
        "name": "PyGremlinBox-AGPL-3-0-only",
        "version": __version__,
        "licence": __licence__,
        "description": "Supply chain security testing module with AGPL-3.0-only licence",
        "spdx_licence_id": "AGPL-3.0-only"
    }
