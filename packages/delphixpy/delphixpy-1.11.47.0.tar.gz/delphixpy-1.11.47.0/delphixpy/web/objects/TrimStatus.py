...
class TrimStatus(TypedObject):
    ...
    *(extends* :py:class:`delphixpy.web.vo.TypedObject` *)* The TRIM status and
    ...
    def is_dirty(self):
        return any([self._state[1], self._start_time[1], self._end_time[1], self._autotrim_enabled[1]])
    ...
    def __eq__(self, other):
        ...
        return super().__eq__(other) and \
               ...
               self.autotrim_enabled == other.autotrim_enabled
