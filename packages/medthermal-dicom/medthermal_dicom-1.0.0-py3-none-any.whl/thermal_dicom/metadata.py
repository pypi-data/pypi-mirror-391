"""
Thermal DICOM metadata handling for standards compliance and interoperability.
"""
...
class ThermalMetadata:
    ...
    def set_equipment_information(self,
                                manufacturer: str = "Thermal DICOM Library",
    ...
    def create_dicom_conformance_statement(self) -> Dict[str, Any]:
        ...
        conformance = {
            ...
            'implementation_version_name': 'THERMAL_DICOM_1.0',
