...
class ThermalViewer:
    ...
    def __init__(self, thermal_dicom=None):
        """
        Initialize thermal viewer.
        
        Args:
            thermal_dicom: ThermalDicom instance to visualize
        """
        self.thermal_dicom = thermal_dicom
    ...
    def set_thermal_dicom(self, thermal_dicom):
    ...
    def create_interactive_plot(self, 
        ...
        if self.thermal_dicom.temperature_data is not None:
            ...
            thermal_array = self.thermal_dicom.thermal_array
        ...
        # Update layout
        fig.update_layout(
            title=title or "Thermal DICOM Visualization",
            width=width,
            height=height,
