		...
		breast_views = [
			{
				...
				'acquisition_view': 'Frontal breast view'
			},
			{
				...
				'image_laterality': 'L',
				'patient_position': 'HFS',
				'acquisition_view': 'Left lateral breast view'
			},
			{
				...
				'image_laterality': 'R',
				'patient_position': 'HFS',
				'acquisition_view': 'Right lateral breast view'
			},
			{
				'view_key': 'left_oblique',
				'view_position': 'LAO',
				'view_comment': 'Left anterior oblique view',
				'image_laterality': 'L',
				'patient_position': 'HFS',
				'acquisition_view': 'Left oblique breast view'
			},
			{
				'view_key': 'right_oblique',
				'view_position': 'RAO',
				'view_comment': 'Right anterior oblique view',
				'image_laterality': 'R',
				'patient_position': 'HFS',
				'acquisition_view': 'Right oblique breast view'
			}
		]
...
def main():
    ...
    breast_thermal_data = {
        'anterior': generate_sample_thermal_data((512, 512), 37.0, 1.5),
        'left_lateral': generate_sample_thermal_data((512, 512), 37.0, 1.8),
    ...
    hand_view_configs = [
        {
            'view_key': 'palmar',
            'view_position': 'A',
            'view_comment': 'Palmar view of hand',
            'image_laterality': 'R',
            'patient_position': 'SITTING',
            'acquisition_view': 'Palm up view'
        },
        {
            'view_key': 'dorsal',
            'view_position': 'P',
            'view_comment': 'Dorsal view of hand',
            'image_laterality': 'R',
            'patient_position': 'SITTING',
            'acquisition_view': 'Back of hand view'
        },
        {
            'view_key': 'lateral',
            'view_position': 'L',
            'view_comment': 'Lateral view of hand',
            'image_laterality': 'R',
            'patient_position': 'SITTING',
            'acquisition_view': 'Side view of hand'
        }
    ]
    
    # Generate sample thermal data for hand views
    hand_thermal_data = {
        'palmar': io.loadmat(r"D:\Bharath\work\kidwai\345\2022001832\1\front.mat")['mappedTemperatureImage'],
        'dorsal': io.loadmat(r"D:\Bharath\work\kidwai\345\2022001832\1\left_obl.mat")['mappedTemperatureImage'],
        'lateral': io.loadmat(r"D:\Bharath\work\kidwai\345\2022001832\1\right_obl.mat")['mappedTemperatureImage']
    }
    # hand_thermal_data = {
    #     'palmar': np.array(Image.open(r"D:\Bharath\work\therm_files\HCG\148329\front.jpg")),
    #     'dorsal': np.array(Image.open(r"D:\Bharath\work\therm_files\HCG\148329\left_obl.jpg")),
    #     'lateral': np.array(Image.open(r"D:\Bharath\work\therm_files\HCG\148329\right_obl.jpg"))
    # }
    
    # Create custom hand thermography views
    hand_files = multi_view.create_custom_multi_view_series(
        patient_name=patient_name,
        patient_id=patient_id,
        anatomical_region="hand",
        view_configs=hand_view_configs,
        thermal_data_dict=hand_thermal_data,
        output_dir="multi_view_output/hand"
    )
    
    print(f"\nCreated {len(hand_files)} hand thermography DICOM files")
