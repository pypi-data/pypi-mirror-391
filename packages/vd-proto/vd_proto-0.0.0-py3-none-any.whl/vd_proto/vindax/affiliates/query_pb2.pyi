...
from v4_proto.vindax.affiliates import affiliates_pb2 as _affiliates_pb2
...
class AffiliateInfoResponse(_message.Message):
    __slots__ = ("is_whitelisted", "tier", "fee_share_ppm", "referred_volume", "staked_amount", "referred_volume_30d_rolling")
    ...
    def __init__(self, is_whitelisted: bool = ..., tier: _Optional[int] = ..., fee_share_ppm: _Optional[int] = ..., referred_volume: _Optional[bytes] = ..., staked_amount: _Optional[bytes] = ..., referred_volume_30d_rolling: _Optional[bytes] = ...) -> None: ...
