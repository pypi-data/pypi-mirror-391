...
class BlockStats(_message.Message):
    ...
    class Fill(_message.Message):
        __slots__ = ("taker", "maker", "notional", "affiliate_fee_generated_quantums")
        ...
        def __init__(self, taker: _Optional[str] = ..., maker: _Optional[str] = ..., notional: _Optional[int] = ..., affiliate_fee_generated_quantums: _Optional[int] = ...) -> None: ...
...
class UserStats(_message.Message):
    __slots__ = ("taker_notional", "maker_notional", "affiliate_30d_revenue_generated_quantums", "affiliate_30d_referred_volume_quote_quantums")
    ...
    def __init__(self, taker_notional: _Optional[int] = ..., maker_notional: _Optional[int] = ..., affiliate_30d_revenue_generated_quantums: _Optional[int] = ..., affiliate_30d_referred_volume_quote_quantums: _Optional[int] = ...) -> None: ...
