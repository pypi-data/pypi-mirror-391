...
# source: .proto-export/cosmos/tx/signing/v1beta1/signing.proto
...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    '.proto-export/cosmos/tx/signing/v1beta1/signing.proto'
)
