...
# source: .proto-export/cosmos/orm/query/v1alpha1/query.proto
...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    '.proto-export/cosmos/orm/query/v1alpha1/query.proto'
)
