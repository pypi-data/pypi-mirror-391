...
MODULES_CONFIG = """\
#ifndef MODULES_CONFIG_HH
#define MODULES_CONFIG_HH
...
main(int argc, char ** argv) {{
  ...
  {LC_APPNAME}::control<state>::write_graph("{UC_APPNAME}", "cm.dot");
  {LC_APPNAME}::control<state>::write_actions("{UC_APPNAME}", "actions.dot");
#endif
...
#include <modules/cmmn/exports.hh>
#include <modules/spec/control.hh>
...
void inline time_vars(exec::cpu,
