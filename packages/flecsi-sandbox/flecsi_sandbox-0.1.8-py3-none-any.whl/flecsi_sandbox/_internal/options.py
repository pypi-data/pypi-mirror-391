...
argParser.add_argument('-g', '--git', action='store_true',
                       help="initialize project as a git directory")
...
def parse_args():
    ...
    return argparse.Namespace(root = root, name = args.name, git = args.git), \
        {
            "ROOT" : root,
