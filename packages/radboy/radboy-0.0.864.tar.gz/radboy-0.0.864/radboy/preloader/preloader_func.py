...
{Fore.light_red}[{Fore.cyan}Logged{Fore.light_yellow} Temperature{Fore.light_red}] {Fore.light_green}{processed_templerature_string} {Fore.green_yellow}or {processed_templerature_string.to('degF')} {Fore.light_magenta}or {processed_templerature_string.to('degK')}
