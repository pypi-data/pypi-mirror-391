...
#### Chart.draw\_chart()
Function that draws the basic elements of the chart.
It is called when the on_draw event occurs, and also during chart movement.

#### Chart.draw\_artists()
Function that draws the artists on the chart.
It is called when the on_draw event occurs, but not during chart movement.
