...
class SourceDiscovery:
    ...
    async def discover_from_domain(
        ...
        if discovery_mode == "sitemap":
            result = await self._discover_from_sitemap(domain, path_patterns, content_types)
    ...
    async def discover_all_for_domain(
        ...
        return await self.discover_from_domain(
            domain=domain,
            discovery_mode=discovery_mode,
            path_patterns=path_patterns,
            content_types=content_types,
            enable_rss_discovery=enable_rss_discovery,
            max_rss_feeds=max_rss_feeds,
            enable_link_following=enable_link_following,
            link_following_depth=link_following_depth,
            max_links_per_page=max_links_per_page,
