...
prompt_template_zh = """
请针对以下学科和难度级别自由生成一个合适的问题，并给出标准答案。问题类型为{question_type}。
...
prompt_template_en = """
Please freely generate an appropriate question for the given subject and difficulty level, and provide a standard answer. The question type is {question_type}.
...
"Question": "The specific content of the question (options)"
"Answer": ""
"""
...
def get_question_and_answer(subject: str, level: str, question_type: str, lang: str = "en") -> Optional[dict]:
    """Generate a question and its answer based on language selection."""
...
def main(lang: str = "en"):
    ...
    output_file = os.path.join(output_dir, f"{lang}_question_and_answer_{current_time}.jsonl")
