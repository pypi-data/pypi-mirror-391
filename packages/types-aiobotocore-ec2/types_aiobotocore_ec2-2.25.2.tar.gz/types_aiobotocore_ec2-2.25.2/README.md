...
[aiobotocore EC2 2.25.2](https://pypi.org/project/aiobotocore/) compatible with
...
async with session.create_client("ec2") as client:
    ...
    describe_capacity_manager_data_exports_paginator: DescribeCapacityManagerDataExportsPaginator = client.get_paginator(
    ...
    get_capacity_manager_metric_dimensions_paginator: GetCapacityManagerMetricDimensionsPaginator = client.get_paginator(
