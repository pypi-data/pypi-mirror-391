...
## Command‑line tools (v0.5.0)

ARGscape 0.5.0 includes a set of CLI tools for running the backend and performing inference from the terminal.
...
- In 0.5.0 the visualization snapshot command (`argscape_vis`) is temporarily disabled while it's stabilized.
