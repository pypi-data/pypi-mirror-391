...
@click.group(
    ...
    lazy_subcommands={
        ...
        "sync_findings": "regscale.integrations.commercial.qradar.qradar_integration.sync_findings",
        "sync_assets": "regscale.integrations.commercial.qradar.qradar_integration.sync_assets",
