...
class TestGetTaxesAndFeesResponseDataInnerDateRangesInnerAmountAdult(unittest.TestCase):
    """GetTaxesAndFeesResponseDataInnerDateRangesInnerAmountAdult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetTaxesAndFeesResponseDataInnerDateRangesInnerAmountAdult:
        """Test GetTaxesAndFeesResponseDataInnerDateRangesInnerAmountAdult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetTaxesAndFeesResponseDataInnerDateRangesInnerAmountAdult`
        """
        model = GetTaxesAndFeesResponseDataInnerDateRangesInnerAmountAdult()
        if include_optional:
            return GetTaxesAndFeesResponseDataInnerDateRangesInnerAmountAdult(
            )
        else:
            return GetTaxesAndFeesResponseDataInnerDateRangesInnerAmountAdult(
        )
    ...
    def testGetTaxesAndFeesResponseDataInnerDateRangesInnerAmountAdult(self):
        """Test GetTaxesAndFeesResponseDataInnerDateRangesInnerAmountAdult"""
