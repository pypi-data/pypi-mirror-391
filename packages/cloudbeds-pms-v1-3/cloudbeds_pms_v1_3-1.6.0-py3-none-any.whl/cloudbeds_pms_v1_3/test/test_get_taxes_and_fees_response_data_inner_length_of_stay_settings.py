...
class TestGetTaxesAndFeesResponseDataInnerLengthOfStaySettings(unittest.TestCase):
    """GetTaxesAndFeesResponseDataInnerLengthOfStaySettings unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetTaxesAndFeesResponseDataInnerLengthOfStaySettings:
        """Test GetTaxesAndFeesResponseDataInnerLengthOfStaySettings
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetTaxesAndFeesResponseDataInnerLengthOfStaySettings`
        """
        model = GetTaxesAndFeesResponseDataInnerLengthOfStaySettings()
        if include_optional:
    ...
    def testGetTaxesAndFeesResponseDataInnerLengthOfStaySettings(self):
        """Test GetTaxesAndFeesResponseDataInnerLengthOfStaySettings"""
