...
class TestGetTaxesAndFeesResponseDataInnerDateRangesInnerLengthOfStaySettings(unittest.TestCase):
    """GetTaxesAndFeesResponseDataInnerDateRangesInnerLengthOfStaySettings unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetTaxesAndFeesResponseDataInnerDateRangesInnerLengthOfStaySettings:
        """Test GetTaxesAndFeesResponseDataInnerDateRangesInnerLengthOfStaySettings
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetTaxesAndFeesResponseDataInnerDateRangesInnerLengthOfStaySettings`
        """
        ...
        if include_optional:
            return GetTaxesAndFeesResponseDataInnerDateRangesInnerLengthOfStaySettings(
                ...
                ranges = [
                    cloudbeds_pms_v1_3.models.get_taxes_and_fees_response_data_inner_date_ranges_inner_length_of_stay_settings_ranges_inner.GetTaxesAndFeesResponse_data_inner_dateRanges_inner_lengthOfStaySettings_ranges_inner(
                        minimum_nights = 56, 
                        maximum_nights = 56, 
                        amount = 1.337, 
                        amount_adult = 1.337, 
    ...
    def testGetTaxesAndFeesResponseDataInnerDateRangesInnerLengthOfStaySettings(self):
        """Test GetTaxesAndFeesResponseDataInnerDateRangesInnerLengthOfStaySettings"""
