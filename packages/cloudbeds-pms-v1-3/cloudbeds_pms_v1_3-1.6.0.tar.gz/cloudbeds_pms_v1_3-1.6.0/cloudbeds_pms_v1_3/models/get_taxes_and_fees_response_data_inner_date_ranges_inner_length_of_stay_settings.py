...
class GetTaxesAndFeesResponseDataInnerDateRangesInnerLengthOfStaySettings(BaseModel):
    """
    Length of Stay configuration settings specific to this date range
    """ # noqa: E501
    application_type: Optional[StrictStr] = Field(default=None, description="Application type for Length of Stay rules", alias="applicationType")
    ranges: Optional[List[GetTaxesAndFeesResponseDataInnerDateRangesInnerLengthOfStaySettingsRangesInner]] = Field(default=None, description="Night-based ranges for Length of Stay configuration")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ranges": [GetTaxesAndFeesResponseDataInnerDateRangesInnerLengthOfStaySettingsRangesInner.from_dict(_item) for _item in obj["ranges"]] if obj.get("ranges") is not None else None
        })
        return _obj
