...
class TrimodalBert(pl.LightningModule):
    def __init__(
        self,
        ...
        super().__init__()
        self.config = config
        self.model_class = "trimodal_bert"
    ...
    def export_to_onnx(
        ...
        class TrimodalBertONNXWrapper(nn.Module):
        ...
        wrapper = TrimodalBertONNXWrapper(model_to_export).to("cpu").eval()
