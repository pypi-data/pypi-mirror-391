...
class BaseChainlitEmitter:
    ...
    async def set_knowledge_types(self, types: List[Dict[str, Any]]):
        """Stub method to set knowledge types."""
        pass

    async def set_knowledge_items(self, items: List[Dict[str, Any]]):
        """Stub method to set knowledge items."""
        pass

    async def update_knowledge_item(self, item: Dict[str, Any]):
        """Stub method to update a single knowledge item."""
        pass

    async def set_active_knowledge_ids(self, ids: List[str]):
        """Stub method to set active knowledge IDs."""
        pass
...
class ChainlitEmitter(BaseChainlitEmitter):
    ...
    def set_knowledge_types(self, types: List[Dict[str, Any]]):
        """Send knowledge types to the UI."""
        return self.emit("set_knowledge_types", types)

    def set_knowledge_items(self, items: List[Dict[str, Any]]):
        """Send knowledge items to the UI."""
        return self.emit("set_knowledge_items", items)

    def update_knowledge_item(self, item: Dict[str, Any]):
        """Update a single knowledge item in the UI."""
        return self.emit("update_knowledge_item", item)

    def set_active_knowledge_ids(self, ids: List[str]):
        """Send active knowledge IDs to the UI."""
        return self.emit("set_active_knowledge_ids", ids)
