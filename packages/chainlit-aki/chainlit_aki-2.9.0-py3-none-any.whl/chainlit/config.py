...
class FeaturesSettings(BaseModel):
    ...
    knowledge: KnowledgeFeature = Field(default_factory=KnowledgeFeature)
...
class CodeSettings(BaseModel):
    ...
    on_mcp_toggle: Optional[Callable] = None
    on_settings_update: Optional[Callable[[Dict[str, Any]], Any]] = None
    on_knowledge_create: Optional[Callable[[Dict[str, Any]], str]] = None
    on_knowledge_update: Optional[Callable[[str, Dict[str, Any]], Any]] = None
    on_knowledge_delete: Optional[Callable[[str], Any]] = None
    on_knowledge_select: Optional[Callable[[List[str]], Any]] = None
