...
from . import robots
__all__: list[str] = ['Always', 'BimanualMotion', 'Box', 'Camera', 'CameraStream', 'Capsule', 'CartesianRegion', 'CartesianRegionBound', 'CartesianWaypoint', 'CircularPath', 'Color', 'Continuous', 'Convex', 'Cylinder', 'Depth', 'DepthMap', 'DynamicRobotTrajectory', 'Element', 'Environment', 'FileReference', 'Fixed', 'Frame', 'FutureExpectedTrajectory', 'Intrinsics', 'JacobiError', 'JointType', 'LinearApproximation', 'LinearMotion', 'LinearPath', 'LinearSection', 'LowLevelMotion', 'MeshFile', 'Motion', 'MultiRobotLinearSection', 'MultiRobotPoint', 'NearSingularity', 'Never', 'Obstacle', 'Path', 'PathCommand', 'PathFollowingMotion', 'Planner', 'PlanningError', 'PointCloud', 'Prismatic', 'Region', 'ReturnCode', 'Revolute', 'Robot', 'RobotArm', 'Sampler', 'Sphere', 'State', 'Studio', 'Trainer', 'Trajectory', 'Twist', 'Waypoint', 'activate_license', 'drivers', 'exceptions', 'robots', 'start_studio_daemon']
...
class LinearSection:
    ...
    def __init__(self, offset: Frame, speed: float = 1.0, approximation: LinearApproximation = ..., smooth_transition: bool = True) -> None:
        ...
    @property
    def approximation(self) -> LinearApproximation:
        """
