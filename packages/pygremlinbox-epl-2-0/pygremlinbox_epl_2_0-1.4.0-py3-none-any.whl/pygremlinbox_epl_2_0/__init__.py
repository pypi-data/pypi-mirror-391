...
"""
PyGremlinBox EPL-2.0 - Supply chain security testing module.

This package is licenced under the Eclipse Public License v2.0 (EPL-2.0).
...
maintaining compliance with EPL-2.0 requirements.
"""
...
def get_package_metadata():
    ...
    return {
        ...
        "version": __version__,
        "licence": __licence__,
        "description": "Supply chain security testing module with EPL-2.0 licence",
        "spdx_licence_id": "EPL-2.0"
    }
