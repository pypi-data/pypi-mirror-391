...
class Polygon2DOMjudge:
    ...
    def __init__(
        ...
        **kwargs: Unpack[_Polygon2DOMjudgeArgs],
        ...
        global_config = kwargs.get("global_config", GlobalConfig())
        ...
        self._problem = self.Problem(
            ...
            language_preference=self._cfg.language_preference,
        ...
        if self._use_std_checker:
            if force_default_validator:
                ...
                self._validator_flags = self._cfg.flag.get(self._problem.checker.name[5:], None)
            else:
...
""")
    ...
    def _add_tests(self) -> Polygon2DOMjudge:
        ...
        sample_input_path_pattern = self._cfg.example_path_pattern.input
        sample_output_path_pattern = self._cfg.example_path_pattern.output
    ...
    def _add_jury_solutions(self) -> Polygon2DOMjudge:
        ...
        for solution in self._problem.solutions:
            ...
            results = self._cfg.tag.get(tag, None)
    ...
    def _add_solutions_with_expected_result(self, src: Path, dst: Path, lang: str, results: Optional[List[Result]]) -> None:
        ...
        if "@EXPECTED_RESULTS@" in content or "@EXPECTED_SCORE@" in content:
            ...
            with open(dst, "w") as f:
                ...
                if comment_str := self._cfg.comment_str.get(lang, None):
    ...
    def _archive(self) -> Polygon2DOMjudge:
