...
class PolicyObjectClass(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, insured_object_name, data, insured_object_id, code, created_at, updated_at, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, insured_object_name, data, insured_object_id, code, created_at, updated_at, *args, **kwargs):  # noqa: E501
        """PolicyObjectClass - a model defined in OpenAPI
