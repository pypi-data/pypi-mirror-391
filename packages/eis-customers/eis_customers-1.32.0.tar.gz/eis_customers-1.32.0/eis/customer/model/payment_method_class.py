...
class PaymentMethodClass(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, code, provider_token, psp_customer_id, psp, type, created_by, updated_by, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            updated_by (str): Identifier of the user who updated the record.
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, code, provider_token, psp_customer_id, psp, type, created_by, updated_by, *args, **kwargs):  # noqa: E501
        """PaymentMethodClass - a model defined in OpenAPI
