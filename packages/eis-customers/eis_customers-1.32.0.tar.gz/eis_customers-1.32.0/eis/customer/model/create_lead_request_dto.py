...
class CreateLeadRequestDto(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, product_version_id, policy_objects, product_code, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            status (str): Lead status. [optional]  # noqa: E501
            ...
            partner (bool, date, datetime, dict, float, int, list, str, none_type): Optional partner object contains necessary information to link a partner to the policy.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, product_version_id, policy_objects, product_code, *args, **kwargs):  # noqa: E501
        """CreateLeadRequestDto - a model defined in OpenAPI
