...
class ProductsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_product_endpoint = _Endpoint(
            settings={
                ...
                'auth': [],
                'endpoint_path': '/v1/customers/{customerCode}/products/{productCode}',
        ...
        self.list_products_endpoint = _Endpoint(
            settings={
                ...
                'auth': [],
                'endpoint_path': '/v1/customers/{customerCode}/products',
    ...
    def get_product(
        ...
        **kwargs
        ...
        Get detailed product that a customer can insure; the details can be expanded using expand query parameter.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_product(product_code, customer_code, async_req=True)
        >>> result = thread.get()
    ...
    def list_products(
        ...
        **kwargs
        ...
        List all the products that a customer can insure, the products can be filtered by product code, product number.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_products(customer_code, async_req=True)
        >>> result = thread.get()
