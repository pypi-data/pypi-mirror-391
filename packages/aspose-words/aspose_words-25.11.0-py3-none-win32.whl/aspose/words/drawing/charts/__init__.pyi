...
class ChartSeriesCollection:
    ...
    @overload
    def add1(self, series_name: str, categories: List[str], values: List[float]) -> aspose.words.drawing.charts.ChartSeries:
    ...
    @overload
    def add1(self, series_name: str, categories: List[str], values: List[float], is_subtotal: List[bool]) -> aspose.words.drawing.charts.ChartSeries:
        """Adds new :class:`ChartSeries` to this collection.
