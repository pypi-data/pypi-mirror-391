...
class MCPServerV1alpha1SpecAddress(BaseModel):
    ...
    value_from: Optional[EvaluatorV1alpha1SpecAddressValueFrom] = Field(default=None, alias="valueFrom")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": obj.get("value"),
            "valueFrom": EvaluatorV1alpha1SpecAddressValueFrom.from_dict(obj["valueFrom"]) if obj.get("valueFrom") is not None else None
        })
        return _obj
