...
"""
PyGremlinBox CC-BY-SA-3.0-AT - Supply chain security testing module.

This package is licenced under CC-BY-SA-3.0-AT.
...
maintaining compliance with CC-BY-SA-3.0-AT requirements.
"""

__version__ = "1.4.0"
__licence__ = "CC-BY-SA-3.0-AT"
...
def get_package_metadata():
    ...
    """
    return {
        "name": "PyGremlinBox-CC-BY-SA-3-0-AT",
        "version": __version__,
        "licence": __licence__,
        "description": "Supply chain security testing module with CC-BY-SA-3.0-AT licence",
        "spdx_licence_id": "CC-BY-SA-3.0-AT"
    }
