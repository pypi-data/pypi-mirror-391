<a id="mypy-boto3-rtbfabric"></a>

# mypy-boto3-rtbfabric

[![PyPI - mypy-boto3-rtbfabric](https://img.shields.io/pypi/v/mypy-boto3-rtbfabric.svg?color=blue)](https://pypi.org/project/mypy-boto3-rtbfabric/)
[![PyPI - Python Version](https://img.shields.io/pypi/pyversions/mypy-boto3-rtbfabric.svg?color=blue)](https://pypi.org/project/mypy-boto3-rtbfabric/)
[![Docs](https://img.shields.io/readthedocs/boto3-stubs.svg?color=blue)](https://youtype.github.io/boto3_stubs_docs/)
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-rtbfabric)](https://pypistats.org/packages/mypy-boto3-rtbfabric)
...
[mypy-boto3-rtbfabric docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_rtbfabric/).

See how it helps you find and fix potential bugs:

![types-boto3 demo](https://github.com/youtype/mypy_boto3_builder/raw/main/demo.gif)

- [mypy-boto3-rtbfabric](#mypy-boto3-rtbfabric)
...
- Install `boto3-stubs[rtbfabric]` in your environment:
...
- Install `boto3-stubs[rtbfabric]` with services you use in your environment:
...
`mypy-boto3-rtbfabric` dependency in production. However, there is an issue in
...
`mypy_boto3_rtbfabric.paginator` module contains type annotations for all
paginators.
...
`mypy_boto3_rtbfabric.waiter` module contains type annotations for all waiters.
...
`mypy_boto3_rtbfabric.literals` module contains literals extracted from shapes
that can be used in user code for type checking.

Full list of `RTBFabric` Literals can be found in
[docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_rtbfabric/literals/).
...
`mypy_boto3_rtbfabric.type_defs` module contains structures and shapes
assembled to typed dictionaries and unions for additional type checking.

Full list of `RTBFabric` TypeDefs can be found in
[docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_rtbfabric/type_defs/).
...
`mypy-boto3-rtbfabric` version is the same as related `boto3` version and
follows
...
[boto3 docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_rtbfabric/)
