...
from zephyr.app._utils import AwaitableOrContextManager, AwaitableOrContextManagerWrapper
from zephyr.app.datastructures import URL, Address, FormData, Headers, QueryParams, State
from zephyr.app.exceptions import HTTPException
from zephyr.app.formparsers import FormParser, MultiPartException, MultiPartParser
from zephyr._types import Message, Receive, Scope, Send

if typing.TYPE_CHECKING:
    from python_multipart.multipart import parse_options_header

    from zephyr.app.application import Zephyr
...
class HTTPConnection(typing.Mapping[str, typing.Any]):
    ...
    def url_for(self, name: str, /, **path_params: typing.Any) -> URL:
        url_path_provider: Router | Zephyr | None = self.scope.get("router") or self.scope.get("app")
        if url_path_provider is None:
            raise RuntimeError("The `url_for` method can only be used inside a Zephyr application or with a router.")
