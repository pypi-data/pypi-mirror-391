...
from zephyr.app.exceptions import RequestErrorModel
from zephyr._types import IncEx, ModelNameMap, UnionType
from pydantic import BaseModel, create_model
from pydantic.version import VERSION as PYDANTIC_VERSION
from zephyr.app.datastructures import UploadFile
...
if PYDANTIC_V2:
    ...
    from zephyr.openapi.constants import REF_PREFIX as REF_PREFIX
    ...
    def get_schema_from_model_field(
        *,
        ...
        # This expects that GenerateJsonSchema was already used to generate the definitions
        return field_schema(field, model_name_map=model_name_map, ref_prefix=REF_PREFIX)[  # type: ignore[no-any-return]
            0
        ]
