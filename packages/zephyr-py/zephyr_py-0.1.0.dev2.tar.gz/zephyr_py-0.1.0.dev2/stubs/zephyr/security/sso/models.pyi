...
class SSOAuthResult(BaseModel):
    ...
    @classmethod
    def success_result(
        cls, user: SSOUser, provider: str, state: str | None = None, redirect_url: str | None = None, **kwargs: Any
    ) -> SSOAuthResult: ...
    @classmethod
    def error_result(
...
def create_auth_state(
    provider: str, expires_in: int = 600, redirect_url: str | None = None, user_id: str | None = None, **kwargs: Any
) -> SSOAuthState: ...
