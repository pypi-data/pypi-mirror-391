...
from .exceptions import (
    ...
    DeviceCodeAccessDeniedError as DeviceCodeAccessDeniedError,
    DeviceCodeExpiredError as DeviceCodeExpiredError,
    DeviceCodePendingError as DeviceCodePendingError,
    DeviceCodeSlowDownError as DeviceCodeSlowDownError,
    InvalidClientError as InvalidClientError,
    InvalidCodeChallengeError as InvalidCodeChallengeError,
    InvalidCodeVerifierError as InvalidCodeVerifierError,
...
from .models import (
    OAuth2AccessToken as OAuth2AccessToken,
    OAuth2AuthorizationCode as OAuth2AuthorizationCode,
    OAuth2Client as OAuth2Client,
    OAuth2DeviceCode as OAuth2DeviceCode,
    OAuth2RefreshToken as OAuth2RefreshToken,
    generate_access_token as generate_access_token,
    generate_authorization_code as generate_authorization_code,
    generate_device_code as generate_device_code,
    generate_refresh_token as generate_refresh_token,
    generate_user_code as generate_user_code,
)
...
class AuthorizationCodeFlow(BaseFlow):
    ...
    def exchange_code_for_tokens(
        self, code: str, client: OAuth2Client, redirect_uri: str, code_verifier: str | None = None, **kwargs: Any
    ) -> tuple[OAuth2AccessToken, OAuth2RefreshToken | None]: ...
...
class RefreshTokenFlow(BaseFlow):
    ...
    def refresh_access_token(
        self, refresh_token: str, client: OAuth2Client, requested_scopes: list[str] | None = None, **kwargs: Any
