...
class HTTPBase(SecurityBase):
    ...
    def __init__(
        self, *, scheme: str, scheme_name: str | None = None, description: str | None = None, auto_error: bool = True
    ) -> None: ...
...
class HTTPBasic(HTTPBase):
    ...
    def __init__(
        ...
        *,
        ...
        realm: Annotated[str | None, None] = None,
...
class HTTPBearer(HTTPBase):
    ...
    def __init__(
        self,
        *,
        bearerFormat: Annotated[str | None, None] = None,
        scheme_name: Annotated[str | None, None] = None,
        description: Annotated[str | None, None] = None,
        auto_error: Annotated[bool, None] = True,
    ) -> None: ...
