...
from zephyr.app._utils import (
    AwaitableOrContextManager as AwaitableOrContextManager,
    AwaitableOrContextManagerWrapper as AwaitableOrContextManagerWrapper,
)
...
from zephyr.app.formparsers import (
    FormParser as FormParser,
    MultiPartException as MultiPartException,
...
class Request(HTTPConnection):
    ...
    def form(
        self, *, max_files: int | float = 1000, max_fields: int | float = 1000, max_part_size: int = ...
