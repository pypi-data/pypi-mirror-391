...
from zephyr._types import (
    ASGIApp as ASGIApp,
    AppType as AppType,
    DecoratedCallable as DecoratedCallable,
    IncEx as IncEx,
    Receive as Receive,
    Scope as Scope,
    Send as Send,
...
from zephyr.app._utils import (
    create_model_field as create_model_field,
    generate_unique_id as generate_unique_id,
    get_name as get_name,
    get_route_path as get_route_path,
    get_typed_return_annotation as get_typed_return_annotation,
    get_value_or_default as get_value_or_default,
    is_async_callable as is_async_callable,
    is_body_allowed_for_status_code as is_body_allowed_for_status_code,
)
...
from zephyr.app.dependencies.utils import (
    get_body_field as get_body_field,
    get_dependant as get_dependant,
    get_flat_dependant as get_flat_dependant,
    get_parameterless_sub_dependant as get_parameterless_sub_dependant,
    solve_dependencies as solve_dependencies,
)
from zephyr.app.encoders import jsonable_encoder as jsonable_encoder
from zephyr.app.exceptions import (
...
from zephyr.app.responses import (
...
class Route(BaseRoute):
    ...
    def __init__(
        ...
        *,
        ...
        generate_unique_id_fn: Callable[Route, str] | DefaultPlaceholder = ...,
...
class Router:
    ...
    def __init__(
        ...
        *,
        ...
        prefix: Annotated[str, None] = "",
        generate_unique_id_fn: Annotated[Callable[[Route], str], None] = ...,
        redirect_slashes: Annotated[bool, None] = True,
    ) -> None: ...
    async def __call__(self, scope: Scope, receive: Receive, send: Send) -> None: ...
    def __eq__(self, other: Any) -> bool: ...
    async def lifespan(self, scope: Scope, receive: Receive, send: Send) -> None: ...
    def route(
        self, path: str, methods: list[str] | None = None, name: str | None = None, include_in_schema: bool = True
