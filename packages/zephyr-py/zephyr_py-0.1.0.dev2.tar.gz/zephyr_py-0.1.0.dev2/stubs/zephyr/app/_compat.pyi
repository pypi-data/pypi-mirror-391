...
def get_definitions(
    *,
    ...
    dict[tuple[ModelField, Literal["validation", "serialization"]], JsonSchemaValue], dict[str, dict[str, Any]]
]: ...
...
def get_model_definitions(
    *, flat_models: set[type[BaseModel] | type[Enum]], model_name_map: dict[type[BaseModel] | type[Enum], str]
) -> dict[str, Any]: ...
