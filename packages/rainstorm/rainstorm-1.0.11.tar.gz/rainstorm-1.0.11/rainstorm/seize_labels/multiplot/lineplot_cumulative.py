...
def lineplot_cumulative_exploration_time(
    ...
    **kwargs
    ...
    # Load raw and truncated dataframes
    raw_dfs = _load_and_truncate_raw_summary_data(
        base_path=base_path,
        group=group,
        trial=trial,
    ...
    # Generate Target Colors based on group_color
    ...
    # Prepare columns_info for the general plotting helper
    columns_info = []
    ...
    # Plot Lines and Fill-Between using the generalized helper
    _plot_cumulative_lines_and_fill(
        ax=ax,
        df_agg=df_agg,
        columns_info=columns_info,
    ...
    # Set Plot Aesthetics using the generalized helper
    _set_cumulative_plot_aesthetics(
        ax=ax,
        df_agg=df_agg,
