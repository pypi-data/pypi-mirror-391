...
@tool(requires_auth=OAuth2(id="arcade-hubspot", scopes=["conversations.read"]))
...
@tool(requires_auth=OAuth2(id="arcade-hubspot", scopes=["conversations.write"]))
...
@tool(requires_auth=OAuth2(id="arcade-hubspot", scopes=["conversations.custom_channels.read"]))
...
@tool(requires_auth=OAuth2(id="arcade-hubspot", scopes=["conversations.custom_channels.write"]))
