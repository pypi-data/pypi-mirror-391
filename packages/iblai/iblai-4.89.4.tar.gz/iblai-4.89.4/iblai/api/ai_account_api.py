...
class AiAccountApi:
    ...
    def ai_account_connected_services_orgs_users_list(
        ...
        provider: Annotated[Optional[StrictStr], Field(description="* `google` - Google")] = None,
        search: Annotated[Optional[StrictStr], Field(description="A search term.")] = None,
        service: Annotated[Optional[StrictStr], Field(description="* `google_drive` - Google Drive * `google_document` - Google Document * `google_slides` - Google Slides * `google_calendar` - Google Calendar")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type ordering: str
        :param provider: * `google` - Google
        :type provider: str
        :param search: A search term.
        :type search: str
        :param service: * `google_drive` - Google Drive * `google_document` - Google Document * `google_slides` - Google Slides * `google_calendar` - Google Calendar
        :type service: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
