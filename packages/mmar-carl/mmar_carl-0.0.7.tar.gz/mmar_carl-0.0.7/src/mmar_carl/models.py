...
class VectorSearchStrategy(SearchStrategy):
    ...
    def _get_embeddings(self, texts: List[str]) -> List[List[float]]:
        ...
        try:
            ...
            # Fallback to simple character embeddings if sentence-transformers not available
...
class PromptTemplate(BaseModel):
    ...
    def format_chain_prompt(
        self, outer_context: str, current_task: str, history: str = "", language: Language = Language.RUSSIAN, system_prompt: str = ""
    ) -> str:
