...
To visually develop the component run, you have to first
generate the [MSW service worker](https://storybook.js.org/addons/msw-storybook-addon)
and the [MSW Docs](https://mswjs.io/docs/best-practices/managing-the-worker#generating-the-worker-script).
