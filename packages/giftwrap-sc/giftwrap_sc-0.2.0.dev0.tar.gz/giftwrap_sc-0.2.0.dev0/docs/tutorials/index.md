...
3. [Analyzing GIFT-seq Data](analyzing_giftseq_data.ipynb): Instructions on how to perform quality control and basic analysis of GIFT-seq data using the `giftwrap` Python API.
