...
language = "en"
release = metadata_version("qiskit-addon-pna")
...
modindex_common_prefix = ["qiskit_addon_pna."]
...
def linkcode_resolve(domain, info):
    ...
    if module is None or "qiskit_addon_pna" not in module_name:
        return None
    ...
    try:
        ...
        return None
    if full_file_name is None or "/qiskit_addon_pna/" not in full_file_name:
        return None
    file_name = full_file_name.split("/qiskit_addon_pna/")[-1]
    ...
    return f"https://github.com/Qiskit/qiskit-addon-pna/tree/{GITHUB_BRANCH}/qiskit_addon_pna/{file_name}{linespec}"
