...
"""
PyGremlinBox Artistic-1.0 - Supply chain security testing module.

This package is licenced under Artistic-1.0.
...
maintaining compliance with Artistic-1.0 requirements.
"""

__version__ = "1.4.0"
__licence__ = "Artistic-1.0"
...
def get_package_metadata():
    ...
    """
    return {
        "name": "PyGremlinBox-Artistic-1-0",
        "version": __version__,
        "licence": __licence__,
        "description": "Supply chain security testing module with Artistic-1.0 licence",
        "spdx_licence_id": "Artistic-1.0"
    }
