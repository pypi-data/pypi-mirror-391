...
class WidgetFactory:
    ...
    def table(self, title, widget_id=None, source=None, sheet_id=None, column_names=None, group_by=None):
        return Table(
            kawa=self._k,
            widget_id=WidgetFactory.widget_id_or_random(widget_id=widget_id),
            dashboard_id_supplier=self._dashboard_id_supplier,
    ...
    def indicator_chart(self, title, indicator, widget_id=None, aggregation='SUM', source=None, sheet_id=None,
                        filters=None,
    ...
    def pie_chart(self, title, labels, values, widget_id=None, aggregation='SUM', source=None,
                  show_values=False,
                  show_labels=False,
    ...
    def boxplot(self, title, x, y, widget_id=None, aggregation='SUM', source=None, show_values=False,
    ...
    def scatter_chart(self, title, x, y, granularity, widget_id=None, aggregation_x='SUM',
                      aggregation_y='SUM',
    ...
    def line_chart(self, title, x, y, widget_id=None, aggregation='SUM', legend='BOTTOM', show_values=False,
                   time_sampling=None,
    ...
    def bar_chart(self, title, x, y, widget_id=None, aggregation='SUM', legend='BOTTOM', show_values=False,
                  time_sampling=None,
    ...
    def _simple_chart(self, title, x, y, aggregation, chart_type, widget_id=None, time_sampling=None, color=None,
                      source=None,
