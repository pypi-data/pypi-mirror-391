...
# import yaml We will migrate to codec-cub
...
class YamlFileHandler(BaseFileHandler[YamlData]):
    ...
    def read(self, **_) -> dict[str, Any]:
        ...
        with LockShared(handle):
            ...
            # return data or {}
            return {}  # Placeholder until PyYAML is reintroduced

    def write(self, data: YamlData, **kwargs) -> None:  # noqa: ARG002
    ...
    def to_string(self, data: YamlData | None = None, **kwargs) -> str:
        ...
        """
        to_serialize: YamlData = data if data is not None else self.read()  # noqa: F841
        options: dict[str, Any] = self.options.copy()
        options.update(kwargs)
