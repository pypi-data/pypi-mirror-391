    ...
    def __init__(self, template_dir: Optional[Path] = None):
        ...
        if template_dir is not None:
            ...
            try:
                ...
                # ignore if PackageLoader cannot be created
                pass

        if not loaders:
            raise FileNotFoundError("Templates directory not found: tried vyte/templates and ../templates")
