...
class PreSignalRepository(BaseRepository[PreSignal]):
    ...
    async def create_pre_signal(
        ...
        try:
            ...
            logger.error(f"Error creating pre-signal: {e}")
            return None
    ...
    async def get_pre_signals_by_token(
        ...
        try:
            ...
            logger.error(f"Error getting pre-signals for token: {e}")
            return []
    ...
    async def get_pre_signal_with_token(
        ...
        try:
            ...
            logger.error(f"Error fetching pre-signal by ID: {e}")
            return None
    ...
    async def get_recent_pre_signals(
        ...
        try:
            ...
            logger.error(f"Error getting recent pre-signals: {e}")
            return []
    ...
    async def update_pre_signal_status(
        ...
        try:
            ...
            logger.error(f"Error updating pre-signal status: {e}")
            return False
    ...
    async def get_pre_signal_counts_by_type(
        ...
        try:
            ...
            if chain:
                query = query.where(PreSignal.chain == chain)
            ...
            logger.error(f"Error getting pre-signal counts: {e}")
            return {}
    ...
    async def get_trending_tokens_by_pre_signals(
        ...
        try:
            ...
            logger.error(f"Error getting trending tokens by pre-signals: {e}")
            return []
    ...
    async def get_pre_signals_by_source(
        ...
        try:
            ...
            logger.error(f"Error getting pre-signals by source: {e}")
            return []
