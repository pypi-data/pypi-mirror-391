...
"""
PyGremlinBox EPL-1.0 - Supply chain security testing module.

This package is licenced under EPL-1.0.
...
maintaining compliance with EPL-1.0 requirements.
"""
...
def get_package_metadata():
    ...
    """
    return {
        "name": "PyGremlinBox-EPL-1-0",
        "version": __version__,
        "licence": __licence__,
        "description": "Supply chain security testing module with EPL-1.0 licence",
        "spdx_licence_id": "EPL-1.0"
    }
