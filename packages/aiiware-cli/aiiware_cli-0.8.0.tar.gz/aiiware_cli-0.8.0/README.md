...
> **What's New in v0.8.0:** Choose your AI model per request! Use `--model` to try different models without changing config. Perfect for comparing GPT-4, Claude, and Gemini side-by-side. [See CHANGELOG](CHANGELOG.md)
