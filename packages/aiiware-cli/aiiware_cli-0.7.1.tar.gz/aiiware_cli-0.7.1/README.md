...
**One CLI. 39 AI Functions + 25 Content Prompts. 5 LLM Providers.**
...
> **What's New in v0.7.1:** New providers! Moonshot AI (Kimi) with 262K context and DeepSeek with ultra-low pricing (10x cheaper than GPT-4). Plus bug fixes for cost tracking and display. [See CHANGELOG](CHANGELOG.md)
...
#  4. Moonshot AI (Kimi K2, up to 262K context)
