...
from drl_wizard.algorithms.algos.sac_algo.network.distributions import Categorical, DiagGaussian, Bernoulli
...
class ACTLayer(nn.Module):
    ...
    def __init__(self, action_space, inputs_dim, use_orthogonal, gain):
        ...
        if self.action_type == "Discrete":
            ...
            self.action_out = DiagGaussian(inputs_dim, action_dim,action_space, use_orthogonal, gain)
            ...
            self.action_outs = nn.ModuleList(
                [DiagGaussian(inputs_dim, continuous_dim, action_space, use_orthogonal, gain), Categorical(
