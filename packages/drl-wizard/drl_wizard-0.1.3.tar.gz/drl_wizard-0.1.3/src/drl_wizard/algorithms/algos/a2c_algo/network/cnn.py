...
from drl_wizard.configs.algo_cfg import A2CConfig


class CNNLayer(nn.Module):
    """
            Initialize a CNN layer for processing observations in A2C algorithm.
            ...
            """
    def __init__(self, obs_shape,output_dim, cfg: A2CConfig,norm_last_layer):
