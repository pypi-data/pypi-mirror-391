...
class IDrawingContext():
    ...
    @abstractmethod
    def draw_image(self, origin: IPoint, pixels: list[Color], width: int | None = None, height: int | None = None) -> None:
        ...
        result = self._value.DrawImage(origin._value, pixels, width, height)
        return result
