...
class ARCZonalShiftClient(AioBaseClient):
    ...
    async def cancel_practice_run(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_arc_zonal_shift/client/#cancel_practice_run)
        """
    ...
    async def start_practice_run(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_arc_zonal_shift/client/#start_practice_run)
        """
