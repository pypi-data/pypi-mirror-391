...
Tests the JSON file output formatting with metadata.
"""
...
def test_json_output_with_filters():
    """Test JSON output includes filters_applied."""
    tools = [
        Tool(
            name="test",
            description="Test",
...
def test_json_basic_output_no_verbose_fields():
...
def test_json_multiple_tools():
    """Test JSON output with multiple tools."""
    tools = [
        Tool(
            name="tool1",
            description="First",
...
def test_json_with_custom_toolset_source():
    """Test JSON output includes toolset source."""
    tool = Tool(
        name="sourced_tool",
