...
class VPCLatticeClient(AioBaseClient):
    ...
    async def delete_domain_verification(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_vpc_lattice/client/#delete_domain_verification)
        """
    ...
    async def get_domain_verification(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_vpc_lattice/client/#get_domain_verification)
        """
    ...
    async def list_domain_verifications(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_vpc_lattice/client/#list_domain_verifications)
        """
    ...
    async def start_domain_verification(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_vpc_lattice/client/#start_domain_verification)
        """
