...
> 📦 **NEW**: CCPM is now available as a proper Claude Code plugin! See [PLUGIN_README.md](PLUGIN_README.md) for details on the plugin version, or [PLUGIN_INSTALL.md](PLUGIN_INSTALL.md) for installation as a plugin.
