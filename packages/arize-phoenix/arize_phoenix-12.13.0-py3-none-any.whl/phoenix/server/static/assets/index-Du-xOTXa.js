import{U as g,j as o,ea as y,eb as x,ec as z,ed as w,V as c,cA as P,ee as a,r as k,o as S,ef as L}from"./vendor-lqxaAnN2.js";import{L as R,h as C,r as E,i as I,j,F as A,k as D,P as F,l as T,M as t,n as M,D as G,o as _,E as O,p as V,q as N,s as W,t as B,v as d,w as q,x as U,y as $,z as K,B as H,C as J,G as Q,H as X,I as Y,J as Z,K as oo,N as m,O as p,Q as ao,U as lo,V as ro,W as co,X as go,Y as eo,Z as bo,_ as no,$ as io,a0 as so,a1 as to,a2 as mo,a3 as po,a4 as uo,a5 as fo,a6 as vo,a7 as u,a8 as ho,a9 as yo,aa as xo,ab as zo,ac as wo,ad as f,ae as v,af as Po,ag as ko,ah as So,ai as Lo,aj as Ro,ak as Co,al as Eo,am as Io,an as jo,ao as Ao,ap as Do,aq as Fo,ar as To,as as Mo,at as Go,au as _o,av as Oo,aw as n,ax as Vo,ay as No,az as Wo,aA as Bo,aB as qo,aC as Uo,aD as $o,aE as Ko}from"./pages-hIZSnDeQ.js";import{db as Ho,gj as Jo,R as Qo,gk as Xo}from"./components-DNqs7T90.js";import"./vendor-three-BtCyLs1w.js";import"./vendor-codemirror-Ci4D0cBP.js";import"./vendor-shiki-BIjPbHhu.js";import"./vendor-recharts-DYROl3N9.js";(function(){const b=document.createElement("link").relList;if(b&&b.supports&&b.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))s(r);new MutationObserver(r=>{for(const e of r)if(e.type==="childList")for(const i of e.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&s(i)}).observe(document,{childList:!0,subtree:!0});function h(r){const e={};return r.integrity&&(e.integrity=r.integrity),r.referrerPolicy&&(e.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?e.credentials="include":r.crossOrigin==="anonymous"?e.credentials="omit":e.credentials="same-origin",e}function s(r){if(r.ep)return;r.ep=!0;const e=h(r);fetch(r.href,e)}})();const Yo=g`
  :root,
  .ac-theme {
...
`;function ia(){const{theme:l}=Ho();return o(y,{styles:g(oa,Zo,l==="dark"?aa:la,ra(l),Yo,ca,ga,ea,ba,na)})}const sa=x(z(c(a,{path:"/",errorElement:o(n,{}),element:o(qo,{}),children:[o(a,{path:"/v1/*",element:o(P,{to:"/",replace:!0})}),o(a,{path:"/login",element:o(R,{})}),o(a,{path:"/logout",element:o(C,{})}),o(a,{path:"/reset-password",element:o(I,{}),loader:E}),o(a,{path:"/reset-password-with-token",element:o(j,{})}),o(a,{path:"/forgot-password",element:o(A,{})}),o(a,{element:o(Bo,{}),loader:D,children:c(a,{element:o(Wo,{}),children:[o(a,{path:"/profile",handle:{crumb:()=>"profile"},element:o(F,{})}),o(a,{index:!0,loader:T}),c(a,{path:"/model",handle:{crumb:()=>"model"},element:o(V,{}),children:[o(a,{index:!0,element:o(t,{})}),o(a,{element:o(t,{}),children:o(a,{path:"dimensions",children:o(a,{path:":dimensionId",element:o(G,{}),loader:M})})}),o(a,{path:"embeddings",children:o(a,{path:":embeddingDimensionId",element:o(O,{}),loader:_,handle:{crumb:l=>l.embedding.name}})})]}),c(a,{path:"/projects",handle:{crumb:()=>"Projects"},element:o(Z,{}),children:[o(a,{index:!0,element:o(N,{})}),c(a,{path:":projectId",loader:W,handle:{crumb:l=>l.project.name},element:o(Y,{}),children:[o(a,{index:!0,element:o(B,{})}),c(a,{element:o(X,{}),children:[o(a,{path:"traces",element:o(q,{}),children:o(a,{path:":traceId",element:o(d,{})})}),o(a,{path:"spans",element:o(U,{}),children:o(a,{path:":traceId",element:o(d,{})})}),o(a,{path:"sessions",element:o(H,{}),children:o(a,{path:":sessionId",element:o(K,{}),loader:$})}),o(a,{path:"config",element:o(J,{})}),o(a,{path:"metrics",element:o(Q,{})})]})]})]}),c(a,{path:"/datasets",handle:{crumb:()=>"Datasets"},children:[o(a,{index:!0,element:o(oo,{})}),c(a,{path:":datasetId",loader:m,handle:{crumb:l=>l.dataset.name},children:[c(a,{element:o(bo,{}),loader:m,children:[o(a,{index:!0,element:o(p,{})}),o(a,{path:"experiments",element:o(p,{})}),o(a,{path:"examples",element:o(ro,{}),loader:ao,children:o(a,{path:":exampleId",element:o(lo,{})})}),o(a,{path:"versions",element:o(go,{}),loader:co}),o(a,{path:"evaluators",element:o(eo,{})})]}),o(a,{path:"compare",element:o(no,{}),handle:{crumb:()=>"compare"}})]})]}),c(a,{path:"/playground",handle:{crumb:()=>"Playground"},children:[o(a,{index:!0,element:o(io,{})}),o(a,{path:"spans/:spanId",element:o(to,{}),loader:so,handle:{crumb:l=>l.span.__typename==="Span"?`span ${l.span.spanId}`:"span unknown"}})]}),c(a,{path:"/prompts",handle:{crumb:()=>"Prompts"},children:[o(a,{index:!0,element:o(po,{}),loader:mo}),c(a,{path:":promptId",loader:uo,shouldRevalidate:()=>!0,handle:{crumb:l=>l.prompt.__typename==="Prompt"?l.prompt.name:"unknown"},children:[c(a,{element:o(wo,{}),children:[o(a,{index:!0,element:o(fo,{})}),o(a,{path:"versions",loader:vo,element:o(yo,{}),children:o(a,{path:":versionId",loader:u,element:o(ho,{})})}),o(a,{path:"config",element:o(zo,{}),loader:xo})]}),o(a,{path:"versions/:versionId",loader:u,handle:{crumb:l=>l==null?void 0:l.promptVersion.id},children:o(a,{path:"playground",element:o(v,{}),loader:f,handle:{crumb:()=>"playground"}})}),o(a,{path:"playground",element:o(v,{}),loader:f,handle:{crumb:()=>"playground"}})]})]}),o(a,{path:"/apis",element:o(Po,{}),handle:{crumb:()=>"APIs"}}),o(a,{path:"/support",element:o(ko,{}),handle:{crumb:()=>"Support"}}),c(a,{path:"/settings",element:o(_o,{}),handle:{crumb:()=>"Settings"},children:[o(a,{path:"general",loader:So,element:o(Lo,{}),handle:{crumb:()=>"General"}}),o(a,{path:"providers",loader:Ro,element:o(Co,{}),handle:{crumb:()=>"AI Providers"}}),o(a,{path:"models",loader:Eo,element:o(Io,{}),handle:{crumb:()=>"Models"}}),o(a,{path:"datasets",element:o(jo,{}),handle:{crumb:()=>"Datasets"}}),o(a,{path:"annotations",loader:Ao,element:o(Do,{}),handle:{crumb:()=>"Annotations"}}),o(a,{path:"data",element:o(To,{}),handle:{crumb:()=>"Data Retention"},loader:Fo}),o(a,{path:"prompts",element:o(Go,{}),loader:Mo,handle:{crumb:()=>"Prompts"}})]}),o(a,{path:"/redirects/spans/:span_otel_id",loader:Oo,errorElement:o(n,{})}),o(a,{path:"/redirects/traces/:trace_otel_id",loader:Vo,errorElement:o(n,{})}),o(a,{path:"/redirects/sessions/:session_id",loader:No,errorElement:o(n,{})})]})})]})),{basename:window.Config.basename});function ta(){return o(w,{router:sa})}function da(){return o(Uo,{children:o(Jo,{children:o(ma,{})})})}function ma(){return c(S.RelayEnvironmentProvider,{environment:Qo,children:[o(ia,{}),o(Ko,{children:o(Xo,{children:o($o,{children:o(k.Suspense,{children:o(ta,{})})})})})]})}const pa=document.getElementById("root"),ua=L.createRoot(pa);ua.render(o(da,{}));
