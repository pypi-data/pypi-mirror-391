...
Please switch to using the
[`pydabpumps`](https://github.com/ankohanse/pydabpumps) library, which has exactly the same functionality but supports both
async and sync function calls.
