...
class TestRunner:
    ...
    async def run_all_tests(
        ...
        async with InProcessTaskApp(
            ...
            # Wait a moment for DNS to propagate for Cloudflare tunnel URLs
            # Cloudflare tunnel DNS can take a few seconds to become resolvable
            if "trycloudflare.com" in task_app.url:
