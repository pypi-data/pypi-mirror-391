...
class ServiceQuotasClient(AioBaseClient):
    ...
    async def get_auto_management_configuration(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_service_quotas/client/#get_auto_management_configuration)
        """
    ...
    async def start_auto_management(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_service_quotas/client/#start_auto_management)
        """
    ...
    async def stop_auto_management(self) -> dict[str, Any]:
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_service_quotas/client/#stop_auto_management)
        """
    ...
    async def update_auto_management(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_service_quotas/client/#update_auto_management)
        """
