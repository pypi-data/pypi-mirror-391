...
#define YGGDRASIL_RAPIDJSON_NAMESPACE my::rapid::json
#define YGGDRASIL_RAPIDJSON_NAMESPACE_BEGIN namespace my { namespace rapid { namespace json {
...
TEST(NamespaceTest,Direct) {
    typedef YGGDRASIL_RAPIDJSON_NAMESPACE::Document Document;
    typedef YGGDRASIL_RAPIDJSON_NAMESPACE::Reader Reader;
    typedef YGGDRASIL_RAPIDJSON_NAMESPACE::StringStream StringStream;
    typedef YGGDRASIL_RAPIDJSON_NAMESPACE::StringBuffer StringBuffer;
    typedef YGGDRASIL_RAPIDJSON_NAMESPACE::Writer<StringBuffer> WriterType;
