...
#ifndef YGGDRASIL_RAPIDJSON_MEMORYSTREAM_H_
#define YGGDRASIL_RAPIDJSON_MEMORYSTREAM_H_
...
struct MemoryStream {
    ...
    Ch Peek() const { return YGGDRASIL_RAPIDJSON_UNLIKELY(src_ == end_) ? '\0' : *src_; }
    Ch Take() { return YGGDRASIL_RAPIDJSON_UNLIKELY(src_ == end_) ? '\0' : *src_++; }
...
#endif // YGGDRASIL_RAPIDJSON_MEMORYBUFFER_H_
