...
#ifndef YGGDRASIL_RAPIDJSON_INTERNAL_SWAP_H_
#define YGGDRASIL_RAPIDJSON_INTERNAL_SWAP_H_
...
*/
template <typename T>
inline void Swap(T& a, T& b) YGGDRASIL_RAPIDJSON_NOEXCEPT {
    T tmp = a;
        a = b;
        b = tmp;
}
...
#endif // YGGDRASIL_RAPIDJSON_INTERNAL_SWAP_H_
