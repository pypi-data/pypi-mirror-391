...
def _style_snapshot(fig, ax, ax2, sc_charge, sc_discharge, sc_eff, file_data=None) -> Dict:
    ...
    cfg = {
        ...
        'series': {
            ...
            'efficiency': {
                'color': _color_of(sc_eff) if sc_eff else '#2ca02c',
                    ...
                    if sub == 'ly':
                        ...
                        if is_multi_file:
                            ...
                            if user_colors:
                                ...
                                print("Use user color: e.g., enter '2' to apply user color #2")
                            
                            choice = input("Enter curve number (1-{}), 'a' for all, 'u' to manage colors, q=cancel: ".format(len(file_data))).strip()
                            ...
                            if choice.lower() == 'u':
                                while True:
                                    ...
                                    print(f"{_colorize_menu('q : return to color menu')}")
                            ...
                            if choice.lower() == 'a':
                                ...
                                pal1 = _display_palette_preview('Reds')
                                pal2 = _display_palette_preview('Oranges')
                                pal3 = _display_palette_preview('RdPu')
                                pal4 = _display_palette_preview('Purples')
                                pal5 = _display_palette_preview('OrRd')
                                print(f"  {pal1} 1. Reds")
                                print(f"  {pal2} 2. Oranges")
                                print(f"  {pal3} 3. Pinks/Magentas")
                                print(f"  {pal4} 4. Purples")
                                print(f"  {pal5} 5. Deep oranges/reds")
                                if user_colors:
                                    print("\nOr use saved color number (e.g., 6 if you have 6+ saved colors)")
                                spec = input("Enter color (name/hex), palette number (1-5), user color number, or 'r' for random (q=cancel): ").strip()
                                ...
                                for i, f in enumerate(file_data):
                                    if spec.lower() == 'r':
                                        ...
                                        # Check if it's a user color index
                                        charge_col = spec
                                        try:
                                            color_idx = int(spec) - 1
                                            if 0 <= color_idx < len(user_colors):
                                                charge_col = user_colors[color_idx]
                                        except ValueError:
                                            pass  # Use as-is (name/hex)
                        ...
                        if is_multi_file:
                            ...
                            if choice.lower() == 'a':
                                ...
                                pal1 = _display_palette_preview('Blues')
                                pal2 = _display_palette_preview('BuGn')
                                pal3 = _display_palette_preview('Purples')
                                pal4 = _display_palette_preview('BuPu')
                                pal5 = _display_palette_preview('GnBu')
                                print(f"  {pal1} 1. Blues")
                                print(f"  {pal2} 2. Cyans/Teals")
                                print(f"  {pal3} 3. Purples/Indigos")
                                print(f"  {pal4} 4. Deep blues")
                                print(f"  {pal5} 5. Dark cyans/purples")
                                if user_colors:
                                    print("\nOr use saved color number (e.g., 6 if you have 6+ saved colors)")
                                val = input("Enter color (hex/name), palette number (1-5), user color number, or 'r' for random (q=cancel): ").strip()
