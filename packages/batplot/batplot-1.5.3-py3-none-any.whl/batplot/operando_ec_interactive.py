...
def operando_ec_interactive_menu(fig, ax, im, cbar, ec_ax, file_paths=None):
    ...
    Args:
        ...
        file_paths: Optional list of file paths for save location prompts
    """
    ...
    while True:
        ...
        if cmd == 'e':
            try:
                ...
                base_path = choose_save_path(file_paths if file_paths else [])
        ...
        if cmd == 's':
            try:
                ...
                # Choose base path (terminal cwd vs file directories)
                folder = choose_save_path(file_paths if file_paths else [])
