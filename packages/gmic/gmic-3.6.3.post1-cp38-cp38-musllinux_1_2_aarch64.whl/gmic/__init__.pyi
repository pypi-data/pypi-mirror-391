...
class Gmic:
    ...
    def run(self, cmd: str, img_list: Optional[ImageList] = None, img_names: Optional[StringList] = None) -> ImageList: ...
...
class Image:
    ...
    def at(self, x: int, y: int, z: Optional[int] = None) -> tuple:
        """
    ...
    def fill(self, expression: str, repeat_values: bool = True, allow_formula: bool = True, list_images: Optional["cimg_library::CImgList<float>"] = None) -> Image:
        """
    ...
    def assign_load_file(self, filename: Union[str, os.PathLike]) -> Image:
        """
        Construct image from reading an image file
    ...
    class YXCWrapper:
        ...
        dtypes: typing.List[str] = ...
        """(arg: object, /) -> typing.List[str]"""
...
__build__: str = 'Built on Nov 13 2025 at 16:15:22'

__build_flags__: dict = ...

__pyversion__: str = '3.6.3.post1'

def run(cmd: str, img_list: Optional[ImageList] = None, img_names: Optional[StringList] = None) -> ImageList: ...
