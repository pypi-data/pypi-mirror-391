import "./9B4_veAf.js";
import "./BAp-OWo-.js";
import { p as push, I as onMount, i as legacy_pre_effect, u as deep_read_state, k as get, m as mutable_source, K as tick, n as legacy_pre_effect_reset, c as from_html, d as child, s as sibling, y as untrack, r as reset, V as remove_textarea_child, t as template_effect, z as event, b as append, o as pop, j as set, D as comment, v as first_child, g as set_text, F as text } from "./DEzry6cj.js";
import { p as prop, i as if_block, b as bind_this } from "./DUftb7my.js";
import { p as set_style, a as set_class, q as bind_value, t as each, v as index } from "./DXi4jxVF.js";
import { i as init } from "./DB0xzveP.js";
import { C as Code } from "./cOBxa0vB.js";
/* empty css         */
import { M as Markdown } from "./BIgjM4qn.js";
/* empty css         */
...
function Index($$anchor, $$props) {
  ...
  const submit = async (queryText) => {
    ...
    post.then(async ([response, status_code]) => {
      ...
      set(message_history, get(message_history).map((msg, index2) => {
        console.log(index2, userMessageIndex, responseData.hash);
        return index2 === userMessageIndex ? { ...msg, hash: responseData.hash } : msg;
      }));
      set(message_history, get(message_history).map((msg, index2) => index2 === botMessageIndex ? {
      ...
      set(message_history, get(message_history).map((msg, index2) => index2 === botMessageIndex ? { text: "Error occurred.", isBot: true, isPending: false } : msg));
      await tick();
      scroll_to_bottom();
    });
  };
  ...
  var node = sibling(child(button_2));
  {
    var consequent_2 = ($$anchor2) => {
      ...
      var node_1 = child(span);
      {
        var consequent = ($$anchor3) => {
          ...
          reset(span_1);
          template_effect(() => set_text(text2, `+${(get(diffStats), untrack(() => get(diffStats).lines_added)) ?? ""}`));
          append($$anchor3, span_1);
        };
        if_block(node_1, ($$render) => {
          if (get(diffStats), untrack(() => get(diffStats).lines_added > 0)) $$render(consequent);
        });
      }
      var node_2 = sibling(node_1, 2);
      {
        var consequent_1 = ($$anchor3) => {
          ...
          reset(span_2);
          template_effect(() => set_text(text_1, `-${(get(diffStats), untrack(() => get(diffStats).lines_removed)) ?? ""}`));
          append($$anchor3, span_2);
        };
        if_block(node_2, ($$render) => {
          if (get(diffStats), untrack(() => get(diffStats).lines_removed > 0)) $$render(consequent_1);
        });
      }
      reset(span);
      append($$anchor2, span);
    ...
    if_block(node, ($$render) => {
      if (get(diffStats), untrack(() => get(diffStats) && (get(diffStats).lines_added > 0 || get(diffStats).lines_removed > 0))) $$render(consequent_2);
    });
  }
  reset(button_2);
  reset(div_1);
  ...
  var node_3 = child(div_2);
  {
    var consequent_6 = ($$anchor2) => {
      ...
      each(node_4, 1, () => get(message_history), index, ($$anchor3, message, index2) => {
        var div_4 = root_6();
        let classes_2;
        ...
        var node_6 = sibling(span_3, 2);
        {
          var consequent_3 = ($$anchor4) => {
            var button_3 = root_7();
            event("click", button_3, () => undoMessage(get(message).hash || "", index2));
            append($$anchor4, button_3);
          };
          if_block(node_6, ($$render) => {
            if (get(message), untrack(() => !get(message).isBot && get(message).hash && !get(message).isPending)) $$render(consequent_3);
          });
        }
        reset(div_5);
        reset(div_4);
      ...
      var node_7 = sibling(node_4, 2);
      {
        ...
        if_block(node_7, ($$render) => {
          if (get(message_history), untrack(() => get(message_history).length === 0)) $$render(consequent_4);
        });
      }
      var node_8 = sibling(node_7, 2);
      {
        var consequent_5 = ($$anchor3) => {
          ...
          each(div_8, 5, () => get(starterQueries), index, ($$anchor4, query) => {
        ...
        if_block(node_8, ($$render) => {
          if (get(message_history), untrack(() => get(message_history).length === 0)) $$render(consequent_5);
        });
      }
      reset(div_3);
        ...
        var consequent_8 = ($$anchor3) => {
          ...
          var node_11 = child(button_5);
          {
            ...
            if_block(node_11, ($$render) => {
              if (get(code_updated)) $$render(consequent_7);
    ...
    if_block(node_3, ($$render) => {
      if (get(activeTab) === "chat") $$render(consequent_6);
...
//# sourceMappingURL=D3uJu3KR.js.map
