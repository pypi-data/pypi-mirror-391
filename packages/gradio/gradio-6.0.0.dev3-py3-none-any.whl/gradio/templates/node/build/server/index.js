import { D as DEV } from './chunks/browser-fallback-CYSLhaFr.js';
...
import { t as text_decoder, b as base64_decode, a as base, d as decode_pathname, c as app_dir, e as decode_params, v as validate_server_exports, n as normalize_path, f as disable_search, w as with_request_store, g as validate_layout_server_exports, h as validate_layout_exports, i as validate_page_server_exports, j as validate_page_exports, k as assets, l as text_encoder, r as resolve, m as make_trackable, o as get_relative_path, p as base64_encode, q as readable, S as SCHEME, s as try_get_request_store, u as relative$1, x as override, y as writable, z as reset } from './chunks/exports-CZNtHRrU.js';
import { a as async_mode_flag, s as set, L as LEGACY_PROPS, g as get, f as flushSync, d as define_property, m as mutable_source, i as init_operations, b as get_first_child, C as COMMENT_NODE, H as HYDRATION_START, c as get_next_sibling, e as HYDRATION_ERROR, h as hydration_failed, j as clear_text_content, S as STATE_SYMBOL, k as state_proxy_unmount, l as lifecycle_double_unmount, n as hydration_mismatch, o as array_from, p as component_root, q as set_active_reaction, r as set_active_effect, t as active_effect, u as active_reaction, v as create_text, w as setContext, x as block, y as branch, B as Batch, z as pause_effect, A as set_component_context, D as handle_error, E as component_context, F as move_effect, G as internal_set, I as destroy_effect, J as invoke_error_boundary, K as queue_micro_task, M as svelte_boundary_reset_onerror, N as tag, O as source, P as effect_tracking, Q as render_effect, R as HYDRATION_END, T as svelte_boundary_reset_noop, U as HYDRATION_START_ELSE, V as untrack, W as increment, X as push$1, Y as pop$1, Z as EFFECT_TRANSPARENT, _ as EFFECT_PRESERVED, $ as BOUNDARY_EFFECT } from './chunks/async-lbsxUSUV.js';
import { r as render, i as is_passive_event } from './chunks/index5-fDzIzGoO.js';
import { b as browser } from './chunks/index4-DpKVuxl4.js';
...
function get_global_name(options2) {
  return DEV ? "__sveltekit_dev" : `__sveltekit_${options2.version_hash}`;
}
...
\x1B[1;31m[${status}] ${event.request.method} ${event.url.pathname}\x1B[0m`;
  ...
  return `${formatted_text}
${DEV ? clean_up_stack_trace(error2) : error2.stack}`;
}
...
class BaseProvider {
  ...
  constructor(use_hashes, directives, nonce) {
    ...
    this.#style_needs_csp = !DEV && (this.#style_src_needs_csp || this.#style_src_attr_needs_csp || this.#style_src_elem_needs_csp);
