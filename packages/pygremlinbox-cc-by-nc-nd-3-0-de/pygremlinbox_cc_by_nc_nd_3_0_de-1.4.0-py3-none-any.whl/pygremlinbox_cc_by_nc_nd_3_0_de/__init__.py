...
"""
PyGremlinBox CC-BY-NC-ND-3.0-DE - Supply chain security testing module.

This package is licenced under CC-BY-NC-ND-3.0-DE.
...
maintaining compliance with CC-BY-NC-ND-3.0-DE requirements.
"""

__version__ = "1.4.0"
__licence__ = "CC-BY-NC-ND-3.0-DE"
...
def get_package_metadata():
    ...
    """
    return {
        "name": "PyGremlinBox-CC-BY-NC-ND-3-0-DE",
        "version": __version__,
        "licence": __licence__,
        "description": "Supply chain security testing module with CC-BY-NC-ND-3.0-DE licence",
        "spdx_licence_id": "CC-BY-NC-ND-3.0-DE"
    }
