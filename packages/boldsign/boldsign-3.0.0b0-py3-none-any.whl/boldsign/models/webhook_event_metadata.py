...
class WebhookEventMetadata(BaseModel):
    ...
    def event_type_validate_enum(cls, value):
        ...
        if value not in set(['Sent', 'Signed', 'Completed', 'Declined', 'Revoked', 'Reassigned', 'Expired', 'Viewed', 'AuthenticationFailed', 'DeliveryFailed', 'Verification', 'SendFailed', 'DraftCreated', 'SenderIdentityCreated', 'SenderIdentityUpdated', 'SenderIdentityDeleted', 'SenderIdentityRevoked', 'SenderIdentityVerified', 'SenderIdentityDenied', 'TemplateCreated', 'TemplateCreateFailed', 'TemplateDraftCreated', 'TemplateSendFailed', 'IdentityVerificationInitiated', 'IdentityVerificationSucceeded', 'IdentityVerificationFailed', 'Reminder', 'Edited', 'EditFailed']):
