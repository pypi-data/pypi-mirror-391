...
*DocumentApi* | [**draft_send**](docs/DocumentApi.md#draft_send) | **POST** /v1-beta/document/draftSend | Sends a draft-status document out for signature.
*DocumentApi* | [**edit_document**](docs/DocumentApi.md#edit_document) | **PUT** /v1-beta/document/edit | Edit and updates an existing document.
...
*UserApi* | [**change_team**](docs/UserApi.md#change_team) | **PUT** /v1-beta/users/changeTeam | Change users to other team.
