...
"""
PyGremlinBox TAPR-OHL-1.0 - Supply chain security testing module.

This package is licenced under TAPR-OHL-1.0.
...
maintaining compliance with TAPR-OHL-1.0 requirements.
"""

__version__ = "1.4.0"
__licence__ = "TAPR-OHL-1.0"
...
def get_package_metadata():
    ...
    """
    return {
        "name": "PyGremlinBox-TAPR-OHL-1-0",
        "version": __version__,
        "licence": __licence__,
        "description": "Supply chain security testing module with TAPR-OHL-1.0 licence",
        "spdx_licence_id": "TAPR-OHL-1.0"
    }
