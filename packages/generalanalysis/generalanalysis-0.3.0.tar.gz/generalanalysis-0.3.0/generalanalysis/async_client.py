...
from .core.project import resolve_default_project_id
...
class AsyncClient:
    ...
    Example:
        ...
        ...     result = await client.guards.invoke(text="Check this text", guard_name="@pii_guard")
        ...     await client.close()
        >>>
        >>> asyncio.run(main())
    """
    ...
    def __init__(
        ...
        self._default_project_id = resolve_default_project_id(project_id)
        ...
        self.guards = AsyncGuards(self._http_client, default_project_id=self._default_project_id)
        self.guard_configurations = AsyncGuardConfigurations(
            self._http_client,
