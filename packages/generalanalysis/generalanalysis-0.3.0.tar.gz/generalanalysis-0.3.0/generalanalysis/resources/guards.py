...
class Guards:
    ...
    def list(self, project_id: int | None = None) -> builtins.list[Guard]:
        ...
        response = self._client.get("/guards", params=params or None)
        guards_data = response if isinstance(response, list) else [response]
        return [Guard(**guard) for guard in guards_data]

    def list_policies(self, project_id: int | None = None) -> builtins.list[GuardPolicyDetail]:
        ...
        response = self._client.get("/policies", params=params or None)
    ...
    def invoke(
        ...
        *,
        ...
        """Invoke a guard via id/name or guard configuration."""
        ...
        if guard_id is not None:
            ...
            resolved_guard_name = self._resolve_guard_name_by_id(
                normalized_guard_id, resolved_project_id
            )
        ...
        try:
            response = self._client.post("/guards/invoke", data=payload)
    ...
    def _resolve_guard_name_by_id(self, guard_id: int, project_id: int | None) -> str:
