...
class Client:
    ...
    Example:
        ...
        >>> result = client.guards.invoke(text="Check this text", guard_name="@pii_guard")
    """
    ...
    def __init__(
        ...
        self.guards = Guards(self._http_client, default_project_id=self._default_project_id)
        self.guard_configurations = GuardConfigurations(
            self._http_client,
