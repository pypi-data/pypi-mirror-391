...
class Guards:
    ...
    def invoke(
        ...
        *,
        ...
        if guard_id is not None:
            ...
            resolved_guard_name = self._resolve_guard_name_by_id(normalized_guard_id)
    ...
    def _resolve_guard_name_by_id(self, guard_id: int) -> str:
