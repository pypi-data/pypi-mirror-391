...
T = TypeVar("T", bound="NetworkUserAccessActor")


@_attrs_define
class NetworkUserAccessActor:
    """
    Attributes:
        uuid (UUID):
        user (User):
        ...
        type_ (Union[Literal['network_user_v2'], Unset]):  Default: 'network_user_v2'.
    """
    ...
    session_uuid: UUID
    source_address: list[Union[int, str]]
    type_: Union[Literal["network_user_v2"], Unset] = "network_user_v2"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        session_uuid = UUID(d.pop("session_uuid"))
        ...
        type_ = cast(Union[Literal["network_user_v2"], Unset], d.pop("type", UNSET))
        if type_ != "network_user_v2" and not isinstance(type_, Unset):
            raise ValueError(f"type must match const 'network_user_v2', got '{type_}'")

        network_user_access_actor = cls(
            uuid=uuid,
            user=user,
            session_uuid=session_uuid,
            source_address=source_address,
        ...
        network_user_access_actor.additional_properties = d
        return network_user_access_actor
