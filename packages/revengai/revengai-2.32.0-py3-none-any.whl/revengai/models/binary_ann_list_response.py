...
class BinaryAnnListResponse(BaseModel):
    """
    BinaryAnnListResponse
    """ # noqa: E501
    list: List[ExportedBinaryAnnResult]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "list": [ExportedBinaryAnnResult.from_dict(_item) for _item in obj["list"]] if obj.get("list") is not None else None
        })
        return _obj
