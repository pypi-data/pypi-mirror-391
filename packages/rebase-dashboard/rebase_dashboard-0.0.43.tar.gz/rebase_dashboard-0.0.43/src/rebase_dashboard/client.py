...
from .layers.client import AsyncLayersClient, LayersClient
from .weather.client import AsyncWeatherClient, WeatherClient


class RebaseDashboardClient:
    """
    ...
    environment : RebaseDashboardClientEnvironment
        The environment to use for requests from the client. from .environment import RebaseDashboardClientEnvironment



        Defaults to RebaseDashboardClientEnvironment.PRODUCTION
    ...
    def __init__(
        ...
        *,
        ...
        environment: RebaseDashboardClientEnvironment = RebaseDashboardClientEnvironment.PRODUCTION,
        api_key: str,
        ...
        self.layers = LayersClient(client_wrapper=self._client_wrapper)
        self.dashboards = DashboardsClient(client_wrapper=self._client_wrapper)


class AsyncRebaseDashboardClient:
    """
    Use this class to access the different functions within the SDK. You can instantiate any number of clients with different configuration that will propagate to these functions.
    ...
    def __init__(
        ...
        *,
        ...
        self.layers = AsyncLayersClient(client_wrapper=self._client_wrapper)
        self.dashboards = AsyncDashboardsClient(client_wrapper=self._client_wrapper)


def _get_base_url(*, base_url: typing.Optional[str] = None, environment: RebaseDashboardClientEnvironment) -> str:
