...
class ReactServicer(react_pb2_grpc.ReactServicer):
    ...
    async def Query(
        ...
        try:
            ...
            # We would love to abort with an error, which represents the
            # specific request type, like we do in the generated code,
            # i.e., `State.MyRequestAborted`.
            # https://github.com/reboot-dev/mono/issues/4695
