...
class ApplicationConfig(google.protobuf.message.Message):
    ...
    class Spec(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["_servers", b"_servers", "servers", b"servers"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["_servers", b"_servers", "container_image_name", b"container_image_name", "file_descriptor_set", b"file_descriptor_set", "legacy_grpc_service_full_names", b"legacy_grpc_service_full_names", "reboot_version", b"reboot_version", "revision", b"revision", "revision_number", b"revision_number", "servers", b"servers", "service_names", b"service_names", "states", b"states"]) -> None: ...
