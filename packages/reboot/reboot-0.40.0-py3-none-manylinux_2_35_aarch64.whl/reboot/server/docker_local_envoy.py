...
class DockerLocalEnvoy(LocalEnvoy):
    ...
    def __init__(
        ...
        *,
        ...
        self._stopped_servers = stopped_servers
    ...
    async def set_servers(self, servers: list[ServerInfo]):
        ...
        for server in servers:
            if server.address.host == 'localhost':
        ...
        if self._using_localhost_direct:
            await asyncio.gather(
                *(
                    self.
                    _wait_for_localhost_direct_grpc_health_check(server_id)
