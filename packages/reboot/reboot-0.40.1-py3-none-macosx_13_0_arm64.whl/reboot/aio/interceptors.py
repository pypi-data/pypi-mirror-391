...
class LegacyGrpcContext(grpc.aio.ServicerContext):
    ...
    def external_context(
        ...
        return ExternalContext(
            ...
            # Passing the app-internal API key secret here is safe, since this
            # ExternalContext can only be used to make requests via the
            # `channel_manager`, and the `channel_manager` can only route within
            # our own application.
            app_internal_authorization=self._app_internal_api_key_secret,
        )
