...
class PaymentManagerPaymentAdditionalInfo(BaseModel):
    sender_name: str | None = None
    sender_masked_pan: str | None = None
...
class PaymentManagerPaymentResponse(BaseModel):
    ...
    data: PaymentData
    additional: PaymentManagerPaymentAdditionalInfo | None = None
