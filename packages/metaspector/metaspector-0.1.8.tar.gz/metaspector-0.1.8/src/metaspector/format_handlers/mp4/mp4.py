...
class Mp4Parser(BaseMediaParser):
    ...
    def _order_video_track(self, track: Dict[str, Any]) -> Dict[str, Any]:
        ...
        ordered_keys = [
            ...
            "dolby_vision_level",
            "dolby_vision_version",
            "dolby_vision_bl_compatibility_id",
            "dolby_vision_rpu_present",
            "dolby_vision_el_present",
            "dolby_vision_bl_present",
                    ...
                    if mdia_type == b"mdhd":
                        ...
                        while minf_pos < mdia_end:
                            ...
                            if not minf_type or minf_end > mdia_end:
                                break
                            if minf_type == b"stbl":
                                stbl_container_start = f.tell()
                                stbl_container_end = minf_end
                                stbl_pos = f.tell()
                                while stbl_pos < minf_end:
                                    ...
                                    if stbl_type == b"stsd":
                                        ...
                                        if handler_type_from_hdlr == b"soun":
                                            ...
                                            video_stsd_info = (
                                                MP4BoxParser.parse_stsd_video_with_bitstream(
                                                    f, stbl_end, stbl_container_start, stbl_container_end
                                                )
                                            )
