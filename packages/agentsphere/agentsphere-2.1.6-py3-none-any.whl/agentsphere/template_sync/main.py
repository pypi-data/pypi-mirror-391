...
from agentsphere.template.main import TemplateBase, TemplateClass
from agentsphere.template.types import LogEntry

import os
from datetime import datetime

from agentsphere.api import ApiClient
from agentsphere.connection_config import ConnectionConfig
from agentsphere.template_sync.build_api import (
...
class Template(TemplateBase):
    ...
    def build(
        ...
        domain = domain or os.environ.get("AGENTSPHERE_DOMAIN", "agentsphere.run")
        config = ConnectionConfig(
            domain=domain, api_key=api_key or os.environ.get("AGENTSPHERE_API_KEY")
        )
        client = ApiClient(
            config,
