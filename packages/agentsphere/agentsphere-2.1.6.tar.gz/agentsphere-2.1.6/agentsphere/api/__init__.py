...
from agentsphere.api.client.client import AuthenticatedClient
from agentsphere.connection_config import ConnectionConfig
from agentsphere.api.metadata import default_headers
from agentsphere.exceptions import (
    AuthenticationException,
    SandboxException,
    RateLimitException,
)
from agentsphere.api.client.types import Response
        ...
        **kwargs,
        ...
        if require_api_key:
            if config.api_key is None:
                raise AuthenticationException(
                    "API key is required, please visit the Team tab at https://www.agentsphere.run/dashboard to get your API key. "
        ...
        if require_access_token:
            if config.access_token is None:
                raise AuthenticationException(
                    "Access token is required, please visit the Personal tab at https://www.agentsphere.run/dashboard to get your access token. "
