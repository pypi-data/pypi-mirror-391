...
class PteredactylRecogniser(EntityRecognizer):
    ...
    in a given text using regular expressions. Optionally, a custom check function can
    be used to further validate the matches.
    ...
    def analyze(
        ...
        """Analyzes text to find tokens that match the provided regex pattern and
        optionally checks them with a custom check function."""
        results = []
