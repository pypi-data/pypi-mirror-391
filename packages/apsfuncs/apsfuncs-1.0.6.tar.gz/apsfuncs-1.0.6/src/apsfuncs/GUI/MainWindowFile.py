...
class MainWindowAPSBase(QMainWindow):
    ...
    def __init__(self, program_title, feedback_name, main_screen, data_log, log_filename, config_dict, default_screen_name):
        super().__init__()
        ...
        # Add a crash screen for error handling
        self.feedback_screen = FeedbackScreen(feedback_name=feedback_name, config_dict=config_dict, main_window=self, logger=data_log, current_version=self.current_version)
