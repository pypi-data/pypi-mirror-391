...
class V2ChildalertlistPost200ResponseAlertListInnerChildrenAlertListAlertListInnerChildrenAlertListAlertListInnerChildrenAlertListAlertListInnerChildrenAlertList(BaseModel):
    """
    ...
    """ # noqa: E501
    alert_list: Optional[List[V2ChildalertlistPost200ResponseAlertListInnerChildrenAlertListAlertListInnerChildrenAlertListAlertListInnerChildrenAlertListAlertListInnerChildrenAlertListAlertListInner]] = Field(default=None, alias="alertList")
    __properties: ClassVar[List[str]] = ["alertList"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in alert_list (list)
        _items = []
        if self.alert_list:
            for _item_alert_list in self.alert_list:
                if _item_alert_list:
                    _items.append(_item_alert_list.to_dict())
            _dict['alertList'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "alertList": [V2ChildalertlistPost200ResponseAlertListInnerChildrenAlertListAlertListInnerChildrenAlertListAlertListInnerChildrenAlertListAlertListInnerChildrenAlertListAlertListInner.from_dict(_item) for _item in obj["alertList"]] if obj.get("alertList") is not None else None
        })
        return _obj
