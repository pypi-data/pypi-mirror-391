...
class V1AppsAppSummaryPost200ResponseAppSummaryCircuitsIncidentsInner(BaseModel):
    """
    V1AppsAppSummaryPost200ResponseAppSummaryCircuitsIncidentsInner
    """ # noqa: E501
    data: Optional[List[V1AppsAppSummaryPost200ResponseAppSummaryCircuitsIncidentsInnerDataInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [V1AppsAppSummaryPost200ResponseAppSummaryCircuitsIncidentsInnerDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "name": obj.get("name")
        })
        return _obj
