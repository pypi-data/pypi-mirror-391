...
class V2AssuranceTopologyRegionSummaryPost200Response(BaseModel):
    """
    V2AssuranceTopologyRegionSummaryPost200Response
    """ # noqa: E501
    sites: Optional[List[V2AssuranceTopologyRegionSummaryPost200ResponseSitesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "sites": [V2AssuranceTopologyRegionSummaryPost200ResponseSitesInner.from_dict(_item) for _item in obj["sites"]] if obj.get("sites") is not None else None
        })
        return _obj
