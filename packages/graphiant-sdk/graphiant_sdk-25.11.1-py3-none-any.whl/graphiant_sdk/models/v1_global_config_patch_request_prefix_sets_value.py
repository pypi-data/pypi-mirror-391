...
class V1GlobalConfigPatchRequestPrefixSetsValue(BaseModel):
    """
    V1GlobalConfigPatchRequestPrefixSetsValue
    """ # noqa: E501
    target: Optional[V1GlobalConfigPatchRequestPrefixSetsValueTarget] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "target": V1GlobalConfigPatchRequestPrefixSetsValueTarget.from_dict(obj["target"]) if obj.get("target") is not None else None
        })
        return _obj
