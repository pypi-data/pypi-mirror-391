...
class V1ExtranetsGet200ResponsePoliciesInnerBranchesExcludedDevicesInnerSnmpNotifyFilterProfilesInnerIncludeExcludeListInner(BaseModel):
    """
    ...
    subtree: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["id", "include", "subtree"]
