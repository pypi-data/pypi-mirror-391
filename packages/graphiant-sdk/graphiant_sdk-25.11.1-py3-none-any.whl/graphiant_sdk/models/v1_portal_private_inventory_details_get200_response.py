...
class V1PortalPrivateInventoryDetailsGet200Response(BaseModel):
    """
    V1PortalPrivateInventoryDetailsGet200Response
    """ # noqa: E501
    details: Optional[List[V1PortalPrivateInventoryDetailsGet200ResponseDetailsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "details": [V1PortalPrivateInventoryDetailsGet200ResponseDetailsInner.from_dict(_item) for _item in obj["details"]] if obj.get("details") is not None else None
        })
        return _obj
