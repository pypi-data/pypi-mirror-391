...
class V1DiagnosticArchivesDeviceIdGet200Response(BaseModel):
    """
    V1DiagnosticArchivesDeviceIdGet200Response
    """ # noqa: E501
    archives: Optional[List[V1DiagnosticArchivesDeviceIdGet200ResponseArchivesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "archives": [V1DiagnosticArchivesDeviceIdGet200ResponseArchivesInner.from_dict(_item) for _item in obj["archives"]] if obj.get("archives") is not None else None
        })
        return _obj
