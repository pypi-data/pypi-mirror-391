...
class V1NatUtilizationDeviceIdGet200Response(BaseModel):
    """
    V1NatUtilizationDeviceIdGet200Response
    """ # noqa: E501
    nat_usage: Optional[V1NatUtilizationDeviceIdGet200ResponseNatUsage] = Field(default=None, alias="natUsage")
    ts: Optional[V1AlarmHistoryGet200ResponseHistoryInnerTime] = None
    __properties: ClassVar[List[str]] = ["natUsage", "ts"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of nat_usage
        if self.nat_usage:
            _dict['natUsage'] = self.nat_usage.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "natUsage": V1NatUtilizationDeviceIdGet200ResponseNatUsage.from_dict(obj["natUsage"]) if obj.get("natUsage") is not None else None,
