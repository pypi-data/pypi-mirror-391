...
class V1DevicesDeviceIdConfigPutRequestCorePrometheusSink(BaseModel):
    """
    V1DevicesDeviceIdConfigPutRequestCorePrometheusSink
    """ # noqa: E501
    sink: Optional[V1DevicesDeviceIdConfigPutRequestCorePrometheusSinkSink] = None
    __properties: ClassVar[List[str]] = ["sink"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "sink": V1DevicesDeviceIdConfigPutRequestCorePrometheusSinkSink.from_dict(obj["sink"]) if obj.get("sink") is not None else None
        })
        return _obj
