...
class V1TroubleshootingSiteConnectivityStatusGet200Response(BaseModel):
    """
    V1TroubleshootingSiteConnectivityStatusGet200Response
    """ # noqa: E501
    connectivity_status: Optional[List[V1TroubleshootingSiteConnectivityStatusGet200ResponseConnectivityStatusInner]] = Field(default=None, alias="connectivityStatus")
    __properties: ClassVar[List[str]] = ["connectivityStatus"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "connectivityStatus": [V1TroubleshootingSiteConnectivityStatusGet200ResponseConnectivityStatusInner.from_dict(_item) for _item in obj["connectivityStatus"]] if obj.get("connectivityStatus") is not None else None
        })
        return _obj
