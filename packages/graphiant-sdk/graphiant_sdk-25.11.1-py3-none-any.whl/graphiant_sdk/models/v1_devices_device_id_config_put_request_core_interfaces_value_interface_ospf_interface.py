...
class V1DevicesDeviceIdConfigPutRequestCoreInterfacesValueInterfaceOspfInterface(BaseModel):
    """
    V1DevicesDeviceIdConfigPutRequestCoreInterfacesValueInterfaceOspfInterface
    """ # noqa: E501
    interface: Optional[V1DevicesDeviceIdConfigPutRequestCoreInterfacesValueInterfaceOspfInterfaceInterface] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "interface": V1DevicesDeviceIdConfigPutRequestCoreInterfacesValueInterfaceOspfInterfaceInterface.from_dict(obj["interface"]) if obj.get("interface") is not None else None
        })
        return _obj
