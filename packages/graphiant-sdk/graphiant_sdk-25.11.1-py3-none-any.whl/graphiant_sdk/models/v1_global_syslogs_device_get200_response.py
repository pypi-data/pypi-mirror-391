...
class V1GlobalSyslogsDeviceGet200Response(BaseModel):
    """
    V1GlobalSyslogsDeviceGet200Response
    """ # noqa: E501
    collectors: Optional[List[V1ExtranetsGet200ResponsePoliciesInnerBranchesExcludedDevicesInnerSegmentsInnerSyslogTargetsInner]] = None
    __properties: ClassVar[List[str]] = ["collectors"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "collectors": [V1ExtranetsGet200ResponsePoliciesInnerBranchesExcludedDevicesInnerSegmentsInnerSyslogTargetsInner.from_dict(_item) for _item in obj["collectors"]] if obj.get("collectors") is not None else None
        })
        return _obj
