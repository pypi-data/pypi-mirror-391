...
class V1ExtranetsB2bPost200Response(BaseModel):
    """
    V1ExtranetsB2bPost200Response
    """ # noqa: E501
    id: Optional[StrictInt] = None
    policy: Optional[V1ExtranetsB2bPost200ResponsePolicy] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "policy": V1ExtranetsB2bPost200ResponsePolicy.from_dict(obj["policy"]) if obj.get("policy") is not None else None
        })
        return _obj
