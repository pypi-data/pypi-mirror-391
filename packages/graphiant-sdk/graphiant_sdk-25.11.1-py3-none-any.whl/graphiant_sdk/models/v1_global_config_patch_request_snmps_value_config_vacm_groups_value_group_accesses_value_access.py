...
class V1GlobalConfigPatchRequestSnmpsValueConfigVacmGroupsValueGroupAccessesValueAccess(BaseModel):
    """
    V1GlobalConfigPatchRequestSnmpsValueConfigVacmGroupsValueGroupAccessesValueAccess
    """ # noqa: E501
    context: Optional[StrictStr] = None
    context_match: Optional[StrictStr] = Field(default=None, alias="contextMatch")
    ...
    __properties: ClassVar[List[str]] = ["context", "contextMatch", "name", "readView", "securityLevel", "securityModel", "writeView"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "contextMatch": obj.get("contextMatch"),
            "name": obj.get("name"),
            "readView": obj.get("readView"),
            "securityLevel": obj.get("securityLevel"),
            "securityModel": obj.get("securityModel"),
            "writeView": obj.get("writeView")
        })
        return _obj
