...
class V2MonitoringSystemGenericPost200ResponseDataInner(BaseModel):
    """
    ...
    selector: Optional[V1AccountMfaGet200Response] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "selector": V1AccountMfaGet200Response.from_dict(obj["selector"]) if obj.get("selector") is not None else None
        })
        return _obj
