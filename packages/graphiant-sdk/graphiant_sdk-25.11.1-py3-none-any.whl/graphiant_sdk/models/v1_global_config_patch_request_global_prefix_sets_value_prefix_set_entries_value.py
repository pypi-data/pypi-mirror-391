...
class V1GlobalConfigPatchRequestGlobalPrefixSetsValuePrefixSetEntriesValue(BaseModel):
    """
    V1GlobalConfigPatchRequestGlobalPrefixSetsValuePrefixSetEntriesValue
    """ # noqa: E501
    entry: Optional[V1GlobalConfigPatchRequestGlobalPrefixSetsValuePrefixSetEntriesValueEntry] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entry": V1GlobalConfigPatchRequestGlobalPrefixSetsValuePrefixSetEntriesValueEntry.from_dict(obj["entry"]) if obj.get("entry") is not None else None
        })
        return _obj
