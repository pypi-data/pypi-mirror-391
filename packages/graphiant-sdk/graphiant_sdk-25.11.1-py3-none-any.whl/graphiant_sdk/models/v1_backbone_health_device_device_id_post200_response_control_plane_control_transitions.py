...
class V1BackboneHealthDeviceDeviceIdPost200ResponseControlPlaneControlTransitions(BaseModel):
    """
    V1BackboneHealthDeviceDeviceIdPost200ResponseControlPlaneControlTransitions
    """ # noqa: E501
    transitions: Optional[List[V1BackboneHealthDeviceDeviceIdPost200ResponseControlPlaneControlTransitionsTransitionsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "transitions": [V1BackboneHealthDeviceDeviceIdPost200ResponseControlPlaneControlTransitionsTransitionsInner.from_dict(_item) for _item in obj["transitions"]] if obj.get("transitions") is not None else None
        })
        return _obj
