...
class V1ExtranetsB2bIdCustomerPost200Response(BaseModel):
    """
    V1ExtranetsB2bIdCustomerPost200Response
    """ # noqa: E501
    responses: Optional[List[V1ExtranetsB2bIdCustomerPost200ResponseResponsesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "responses": [V1ExtranetsB2bIdCustomerPost200ResponseResponsesInner.from_dict(_item) for _item in obj["responses"]] if obj.get("responses") is not None else None
        })
        return _obj
