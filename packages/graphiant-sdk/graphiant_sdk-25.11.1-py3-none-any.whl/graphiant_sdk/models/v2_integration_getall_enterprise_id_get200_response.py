...
class V2IntegrationGetallEnterpriseIdGet200Response(BaseModel):
    """
    V2IntegrationGetallEnterpriseIdGet200Response
    """ # noqa: E501
    integrations: Optional[List[V2IntegrationPost200ResponseIntegration]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "integrations": [V2IntegrationPost200ResponseIntegration.from_dict(_item) for _item in obj["integrations"]] if obj.get("integrations") is not None else None
        })
        return _obj
