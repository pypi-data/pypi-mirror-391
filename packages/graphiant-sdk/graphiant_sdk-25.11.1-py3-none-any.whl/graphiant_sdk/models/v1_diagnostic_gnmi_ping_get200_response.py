...
class V1DiagnosticGnmiPingGet200Response(BaseModel):
    """
    V1DiagnosticGnmiPingGet200Response
    """ # noqa: E501
    results: Optional[List[V1DiagnosticGnmiPingGet200ResponseResultsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [V1DiagnosticGnmiPingGet200ResponseResultsInner.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj
