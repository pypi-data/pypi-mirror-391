...
class V1DevicesDeviceIdConfigPutRequestCorePrometheusRuleGroupsValueRuleGroupRulesValue(BaseModel):
    """
    V1DevicesDeviceIdConfigPutRequestCorePrometheusRuleGroupsValueRuleGroupRulesValue
    """ # noqa: E501
    rule_group: Optional[V1DevicesDeviceIdConfigPutRequestCorePrometheusRuleGroupsValueRuleGroupRulesValueRuleGroup] = Field(default=None, alias="ruleGroup")
    __properties: ClassVar[List[str]] = ["ruleGroup"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ruleGroup": V1DevicesDeviceIdConfigPutRequestCorePrometheusRuleGroupsValueRuleGroupRulesValueRuleGroup.from_dict(obj["ruleGroup"]) if obj.get("ruleGroup") is not None else None
        })
        return _obj
