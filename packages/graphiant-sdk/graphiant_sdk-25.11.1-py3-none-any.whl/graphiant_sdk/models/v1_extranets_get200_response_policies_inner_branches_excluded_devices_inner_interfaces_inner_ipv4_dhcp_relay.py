...
class V1ExtranetsGet200ResponsePoliciesInnerBranchesExcludedDevicesInnerInterfacesInnerIpv4DhcpRelay(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "dhcpv4Relays": obj.get("dhcpv4Relays"),
            "dhcpv6Relays": obj.get("dhcpv6Relays"),
            "id": obj.get("id")
        })
        return _obj
