...
class V1PolicyPrefixSetsPost200Response(BaseModel):
    """
    V1PolicyPrefixSetsPost200Response
    """ # noqa: E501
    prefix_set: Optional[V1ExtranetsGet200ResponsePoliciesInnerBranchesExcludedDevicesInnerPrefixSetsInner] = Field(default=None, alias="prefixSet")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "prefixSet": V1ExtranetsGet200ResponsePoliciesInnerBranchesExcludedDevicesInnerPrefixSetsInner.from_dict(obj["prefixSet"]) if obj.get("prefixSet") is not None else None
        })
        return _obj
