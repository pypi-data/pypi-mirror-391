...
class V1ExtranetsB2bPeeringConsumerIdPostRequestSiteToSiteVpnIpsecGatewayDetailsTunnel1(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of V1ExtranetsB2bPeeringConsumerIdPostRequestSiteToSiteVpnIpsecGatewayDetailsTunnel1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of V1ExtranetsB2bPeeringConsumerIdPostRequestSiteToSiteVpnIpsecGatewayDetailsTunnel1 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "insideIpv4Cidr": obj.get("insideIpv4Cidr"),
            "insideIpv6Cidr": obj.get("insideIpv6Cidr"),
