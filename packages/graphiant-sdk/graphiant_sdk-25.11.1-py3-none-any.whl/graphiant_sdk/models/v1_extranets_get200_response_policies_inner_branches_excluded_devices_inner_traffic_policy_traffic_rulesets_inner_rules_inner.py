...
class V1ExtranetsGet200ResponsePoliciesInnerBranchesExcludedDevicesInnerTrafficPolicyTrafficRulesetsInnerRulesInner(BaseModel):
    """
    V1ExtranetsGet200ResponsePoliciesInnerBranchesExcludedDevicesInnerTrafficPolicyTrafficRulesetsInnerRulesInner
    """ # noqa: E501
    action: Optional[V1ExtranetsGet200ResponsePoliciesInnerBranchesExcludedDevicesInnerTrafficPolicyTrafficRulesetsInnerRulesInnerAction] = None
    description: Optional[StrictStr] = None
    id: Optional[StrictInt] = None
    index: Optional[Annotated[int, Field(strict=True, ge=0)]] = None
    match: Optional[V1ExtranetsGet200ResponsePoliciesInnerBranchesExcludedDevicesInnerTrafficPolicySecurityRulesetsInnerRulesInnerMatch] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "action": V1ExtranetsGet200ResponsePoliciesInnerBranchesExcludedDevicesInnerTrafficPolicyTrafficRulesetsInnerRulesInnerAction.from_dict(obj["action"]) if obj.get("action") is not None else None,
            "description": obj.get("description"),
            "id": obj.get("id"),
            "index": obj.get("index"),
            "match": V1ExtranetsGet200ResponsePoliciesInnerBranchesExcludedDevicesInnerTrafficPolicySecurityRulesetsInnerRulesInnerMatch.from_dict(obj["match"]) if obj.get("match") is not None else None,
            "name": obj.get("name"),
            "seq": obj.get("seq")
        })
        return _obj
