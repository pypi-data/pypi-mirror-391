...
class V2DeviceDeviceIdLanSegmentsPost200ResponseDeviceSegmentsInnerVrfRoutesInner(BaseModel):
    """
    ...
    vrf_route: Optional[List[V2DeviceDeviceIdLanSegmentsPost200ResponseDeviceSegmentsInnerVrfRoutesInnerVrfRouteInner]] = Field(default=None, alias="vrfRoute")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "vrfRoute": [V2DeviceDeviceIdLanSegmentsPost200ResponseDeviceSegmentsInnerVrfRoutesInnerVrfRouteInner.from_dict(_item) for _item in obj["vrfRoute"]] if obj.get("vrfRoute") is not None else None
        })
        return _obj
