...
class V1EnterprisesGet200ResponseEnterprisesInnerCounts(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "activeDownCount": obj.get("activeDownCount"),
            "activeUpCount": obj.get("activeUpCount"),
            "deactivatedDownCount": obj.get("deactivatedDownCount"),
            "downSitesCount": obj.get("downSitesCount"),
            "emptySitesCount": obj.get("emptySitesCount"),
            "impairedSitesCount": obj.get("impairedSitesCount"),
            "stagingDownCount": obj.get("stagingDownCount"),
            "stagingUpCount": obj.get("stagingUpCount"),
            "totalCustomers": obj.get("totalCustomers"),
            "totalEdges": obj.get("totalEdges"),
            "totalMsps": obj.get("totalMsps"),
            "totalSites": obj.get("totalSites"),
            "upSitesCount": obj.get("upSitesCount")
        })
        return _obj
