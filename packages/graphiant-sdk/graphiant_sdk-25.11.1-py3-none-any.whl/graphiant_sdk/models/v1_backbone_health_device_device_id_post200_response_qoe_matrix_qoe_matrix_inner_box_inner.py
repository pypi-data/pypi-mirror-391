...
class V1BackboneHealthDeviceDeviceIdPost200ResponseQoeMatrixQoeMatrixInnerBoxInner(BaseModel):
    """
    ...
    end_time: Optional[V1AlarmHistoryGet200ResponseHistoryInnerTime] = Field(default=None, alias="endTime")
    ...
    start_time: Optional[V1AlarmHistoryGet200ResponseHistoryInnerTime] = Field(default=None, alias="startTime")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "endTime": V1AlarmHistoryGet200ResponseHistoryInnerTime.from_dict(obj["endTime"]) if obj.get("endTime") is not None else None,
            "jitterValue": obj.get("jitterValue"),
            "lossValue": obj.get("lossValue"),
            "startTime": V1AlarmHistoryGet200ResponseHistoryInnerTime.from_dict(obj["startTime"]) if obj.get("startTime") is not None else None,
