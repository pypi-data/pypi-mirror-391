...
class V1GatewaysPutRequestDetailsIpsecGatewayRouting(BaseModel):
    """
    V1GatewaysPutRequestDetailsIpsecGatewayRouting
    """ # noqa: E501
    bgp: Optional[V1GatewaysPutRequestDetailsIpsecGatewayRoutingBgp] = None
    static: Optional[V1ExtranetsGet200ResponsePoliciesInnerBranchesExcludedDevicesInnerIpsecTunnelsInnerStatic] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "bgp": V1GatewaysPutRequestDetailsIpsecGatewayRoutingBgp.from_dict(obj["bgp"]) if obj.get("bgp") is not None else None,
            "static": V1ExtranetsGet200ResponsePoliciesInnerBranchesExcludedDevicesInnerIpsecTunnelsInnerStatic.from_dict(obj["static"]) if obj.get("static") is not None else None
        })
        return _obj
