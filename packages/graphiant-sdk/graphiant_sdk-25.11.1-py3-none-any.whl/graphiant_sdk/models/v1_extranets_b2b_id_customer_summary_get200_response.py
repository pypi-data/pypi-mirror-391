...
class V1ExtranetsB2bIdCustomerSummaryGet200Response(BaseModel):
    """
    V1ExtranetsB2bIdCustomerSummaryGet200Response
    """ # noqa: E501
    customers: Optional[List[V1ExtranetsB2bIdCustomerSummaryGet200ResponseCustomersInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "customers": [V1ExtranetsB2bIdCustomerSummaryGet200ResponseCustomersInner.from_dict(_item) for _item in obj["customers"]] if obj.get("customers") is not None else None
        })
        return _obj
