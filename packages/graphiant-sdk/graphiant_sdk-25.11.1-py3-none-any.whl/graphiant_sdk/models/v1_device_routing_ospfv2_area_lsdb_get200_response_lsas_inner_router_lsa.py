...
class V1DeviceRoutingOspfv2AreaLsdbGet200ResponseLsasInnerRouterLsa(BaseModel):
    """
    V1DeviceRoutingOspfv2AreaLsdbGet200ResponseLsasInnerRouterLsa
    """ # noqa: E501
    links: Optional[List[V1DeviceRoutingOspfv2AreaLsdbGet200ResponseLsasInnerRouterLsaLinksInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "links": [V1DeviceRoutingOspfv2AreaLsdbGet200ResponseLsasInnerRouterLsaLinksInner.from_dict(_item) for _item in obj["links"]] if obj.get("links") is not None else None
        })
        return _obj
