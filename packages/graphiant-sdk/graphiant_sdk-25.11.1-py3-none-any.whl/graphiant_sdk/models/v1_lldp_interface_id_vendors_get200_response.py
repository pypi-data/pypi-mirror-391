...
class V1LldpInterfaceIdVendorsGet200Response(BaseModel):
    """
    V1LldpInterfaceIdVendorsGet200Response
    """ # noqa: E501
    vendors: Optional[List[V1LldpInterfaceIdVendorsGet200ResponseVendorsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "vendors": [V1LldpInterfaceIdVendorsGet200ResponseVendorsInner.from_dict(_item) for _item in obj["vendors"]] if obj.get("vendors") is not None else None
        })
        return _obj
