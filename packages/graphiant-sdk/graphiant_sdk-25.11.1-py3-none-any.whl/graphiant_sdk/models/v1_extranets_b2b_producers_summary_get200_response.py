...
class V1ExtranetsB2bProducersSummaryGet200Response(BaseModel):
    """
    V1ExtranetsB2bProducersSummaryGet200Response
    """ # noqa: E501
    info: Optional[List[V1ExtranetsB2bProducersSummaryGet200ResponseInfoInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "info": [V1ExtranetsB2bProducersSummaryGet200ResponseInfoInner.from_dict(_item) for _item in obj["info"]] if obj.get("info") is not None else None
        })
        return _obj
