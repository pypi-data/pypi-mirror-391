...
class V1DevicesDeviceIdConfigPutRequestCoreInterfacesValueInterfaceSubinterfacesValueInterfaceWanGwGwDhcp(BaseModel):
    """
    ...
    dhcp_relay: Optional[Dict[str, Any]] = Field(default=None, alias="dhcpRelay")
