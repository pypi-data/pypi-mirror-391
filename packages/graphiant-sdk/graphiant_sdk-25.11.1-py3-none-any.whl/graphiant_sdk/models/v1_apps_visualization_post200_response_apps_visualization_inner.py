...
class V1AppsVisualizationPost200ResponseAppsVisualizationInner(BaseModel):
    """
    ...
    circuit_map: Optional[Dict[str, V1AppsVisualizationPost200ResponseAppsVisualizationInnerCircuitMapValue]] = Field(default=None, alias="circuitMap")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "circuitMap": dict(
                (_k, V1AppsVisualizationPost200ResponseAppsVisualizationInnerCircuitMapValue.from_dict(_v))
