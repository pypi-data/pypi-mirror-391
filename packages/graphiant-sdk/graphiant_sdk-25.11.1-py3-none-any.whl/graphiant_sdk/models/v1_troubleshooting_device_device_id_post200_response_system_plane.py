...
class V1TroubleshootingDeviceDeviceIdPost200ResponseSystemPlane(BaseModel):
    """
    ...
    temperature: Optional[List[V2NotificationlistPostRequest]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "temperature": [V2NotificationlistPostRequest.from_dict(_item) for _item in obj["temperature"]] if obj.get("temperature") is not None else None,
