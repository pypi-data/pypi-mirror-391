...
class V1DevicesRoutingVrfProtocolRouteCountGet200Response(BaseModel):
    """
    V1DevicesRoutingVrfProtocolRouteCountGet200Response
    """ # noqa: E501
    counts: Optional[List[V1DevicesRoutingVrfProtocolRouteCountGet200ResponseCountsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "counts": [V1DevicesRoutingVrfProtocolRouteCountGet200ResponseCountsInner.from_dict(_item) for _item in obj["counts"]] if obj.get("counts") is not None else None
        })
        return _obj
