...
class V1PortalPrivateInventoryDetailsGet200ResponseDetailsInner(BaseModel):
    """
    ...
    private_gcs_id: Optional[StrictInt] = Field(default=None, alias="privateGcsId")
    uuid: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["deviceModel", "deviceSerial", "privateGcsId", "uuid"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "privateGcsId": obj.get("privateGcsId"),
            "uuid": obj.get("uuid")
        })
        return _obj
