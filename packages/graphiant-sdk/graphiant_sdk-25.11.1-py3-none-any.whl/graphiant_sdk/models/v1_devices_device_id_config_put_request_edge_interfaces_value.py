...
class V1DevicesDeviceIdConfigPutRequestEdgeInterfacesValue(BaseModel):
    """
    V1DevicesDeviceIdConfigPutRequestEdgeInterfacesValue
    """ # noqa: E501
    interface: Optional[V1DevicesDeviceIdConfigPutRequestEdgeInterfacesValueInterface] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "interface": V1DevicesDeviceIdConfigPutRequestEdgeInterfacesValueInterface.from_dict(obj["interface"]) if obj.get("interface") is not None else None
        })
        return _obj
