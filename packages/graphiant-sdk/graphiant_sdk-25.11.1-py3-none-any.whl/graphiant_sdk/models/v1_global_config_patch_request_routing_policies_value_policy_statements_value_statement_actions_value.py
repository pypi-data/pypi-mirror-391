...
class V1GlobalConfigPatchRequestRoutingPoliciesValuePolicyStatementsValueStatementActionsValue(BaseModel):
    """
    V1GlobalConfigPatchRequestRoutingPoliciesValuePolicyStatementsValueStatementActionsValue
    """ # noqa: E501
    action: Optional[V1GlobalConfigPatchRequestRoutingPoliciesValuePolicyStatementsValueStatementActionsValueAction] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "action": V1GlobalConfigPatchRequestRoutingPoliciesValuePolicyStatementsValueStatementActionsValueAction.from_dict(obj["action"]) if obj.get("action") is not None else None
        })
        return _obj
