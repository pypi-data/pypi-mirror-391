...
class V1FlowsTopologyPost200ResponseNetworkTopologyInnerDeltaEdgesAddedInnerConnectionsControlConnectionInner(BaseModel):
    """
    ...
    last_established_time: Optional[V1AlarmHistoryGet200ResponseHistoryInnerTime] = Field(default=None, alias="lastEstablishedTime")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "lastEstablishedTime": V1AlarmHistoryGet200ResponseHistoryInnerTime.from_dict(obj["lastEstablishedTime"]) if obj.get("lastEstablishedTime") is not None else None,
