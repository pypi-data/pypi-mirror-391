...
class V1SoftwareRunningDetailsGet200Response(BaseModel):
    """
    V1SoftwareRunningDetailsGet200Response
    """ # noqa: E501
    devices: Optional[List[V1SoftwareRunningDetailsGet200ResponseDevicesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "devices": [V1SoftwareRunningDetailsGet200ResponseDevicesInner.from_dict(_item) for _item in obj["devices"]] if obj.get("devices") is not None else None
        })
        return _obj
