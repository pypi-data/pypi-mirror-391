...
class V1DevicesDeviceIdSlicePeersGet200Response(BaseModel):
    """
    V1DevicesDeviceIdSlicePeersGet200Response
    """ # noqa: E501
    slices: Optional[List[V1DevicesDeviceIdSlicePeersGet200ResponseSlicesInner]] = None
    __properties: ClassVar[List[str]] = ["slices"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        _items = []
        if self.slices:
            for _item_slices in self.slices:
                if _item_slices:
                    _items.append(_item_slices.to_dict())
            _dict['slices'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "slices": [V1DevicesDeviceIdSlicePeersGet200ResponseSlicesInner.from_dict(_item) for _item in obj["slices"]] if obj.get("slices") is not None else None
        })
        return _obj
