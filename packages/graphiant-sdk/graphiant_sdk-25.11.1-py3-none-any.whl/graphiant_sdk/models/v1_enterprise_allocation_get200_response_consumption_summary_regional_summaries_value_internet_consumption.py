...
class V1EnterpriseAllocationGet200ResponseConsumptionSummaryRegionalSummariesValueInternetConsumption(BaseModel):
    """
    V1EnterpriseAllocationGet200ResponseConsumptionSummaryRegionalSummariesValueInternetConsumption
    """ # noqa: E501
    internet_bandwidth: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="internetBandwidth")
    internet_credits: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="internetCredits")
