...
class V1AppsBandwidthPost200Response(BaseModel):
    """
    V1AppsBandwidthPost200Response
    """ # noqa: E501
    stats: Optional[List[V1AppsBandwidthPost200ResponseStatsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "stats": [V1AppsBandwidthPost200ResponseStatsInner.from_dict(_item) for _item in obj["stats"]] if obj.get("stats") is not None else None
        })
        return _obj
