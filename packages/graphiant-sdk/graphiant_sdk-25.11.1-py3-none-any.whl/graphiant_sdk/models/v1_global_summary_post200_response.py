...
class V1GlobalSummaryPost200Response(BaseModel):
    """
    V1GlobalSummaryPost200Response
    """ # noqa: E501
    summaries: Optional[List[V1GlobalSummaryPost200ResponseSummariesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "summaries": [V1GlobalSummaryPost200ResponseSummariesInner.from_dict(_item) for _item in obj["summaries"]] if obj.get("summaries") is not None else None
        })
        return _obj
