...
class V1GlobalAppsCategoriesGet200ResponseEntriesInner(BaseModel):
    """
    V1GlobalAppsCategoriesGet200ResponseEntriesInner
    """ # noqa: E501
    app_count: Optional[StrictInt] = Field(default=None, alias="appCount")
    category: Optional[V1GlobalAppsAppListsGet200ResponseEntriesInnerAppList] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "category": V1GlobalAppsAppListsGet200ResponseEntriesInnerAppList.from_dict(obj["category"]) if obj.get("category") is not None else None
        })
        return _obj
