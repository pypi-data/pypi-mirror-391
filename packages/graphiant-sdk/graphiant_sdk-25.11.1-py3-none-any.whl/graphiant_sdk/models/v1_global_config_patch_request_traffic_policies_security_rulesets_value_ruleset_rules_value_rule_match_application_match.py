...
class V1GlobalConfigPatchRequestTrafficPoliciesSecurityRulesetsValueRulesetRulesValueRuleMatchApplicationMatch(BaseModel):
    """
    V1GlobalConfigPatchRequestTrafficPoliciesSecurityRulesetsValueRulesetRulesValueRuleMatchApplicationMatch
    """ # noqa: E501
    builtin: Optional[StrictStr] = None
    custom: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["builtin", "custom"]
