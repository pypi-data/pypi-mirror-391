...
class V1GlobalConfigPatchRequestTrafficPoliciesZonesValue(BaseModel):
    """
    V1GlobalConfigPatchRequestTrafficPoliciesZonesValue
    """ # noqa: E501
    zone: Optional[V1GlobalConfigPatchRequestTrafficPoliciesZonesValueZone] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "zone": V1GlobalConfigPatchRequestTrafficPoliciesZonesValueZone.from_dict(obj["zone"]) if obj.get("zone") is not None else None
        })
        return _obj
