...
class V1DevicesDeviceIdJobsJobIdGet200ResponseJobStatus(BaseModel):
    """
    V1DevicesDeviceIdJobsJobIdGet200ResponseJobStatus
    """ # noqa: E501
    completed_at: Optional[V1AlarmHistoryGet200ResponseHistoryInnerTime] = Field(default=None, alias="completedAt")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "completedAt": V1AlarmHistoryGet200ResponseHistoryInnerTime.from_dict(obj["completedAt"]) if obj.get("completedAt") is not None else None,
