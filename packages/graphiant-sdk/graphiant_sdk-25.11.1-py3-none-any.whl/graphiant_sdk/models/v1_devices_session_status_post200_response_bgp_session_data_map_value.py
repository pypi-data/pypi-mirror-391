...
class V1DevicesSessionStatusPost200ResponseBgpSessionDataMapValue(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "coreBgpNeighborsCount": obj.get("coreBgpNeighborsCount"),
            "deviceId": obj.get("deviceId"),
            "odpBgpNeighborsCount": obj.get("odpBgpNeighborsCount"),
            "wanInterfacesCount": obj.get("wanInterfacesCount")
        })
        return _obj
