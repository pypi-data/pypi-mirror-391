...
class V1DevicesDeviceIdJobsJobIdGet200Response(BaseModel):
    """
    V1DevicesDeviceIdJobsJobIdGet200Response
    """ # noqa: E501
    device_id: Optional[StrictInt] = Field(default=None, alias="deviceId")
    job_status: Optional[V1DevicesDeviceIdJobsJobIdGet200ResponseJobStatus] = Field(default=None, alias="jobStatus")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "jobStatus": V1DevicesDeviceIdJobsJobIdGet200ResponseJobStatus.from_dict(obj["jobStatus"]) if obj.get("jobStatus") is not None else None
        })
        return _obj
