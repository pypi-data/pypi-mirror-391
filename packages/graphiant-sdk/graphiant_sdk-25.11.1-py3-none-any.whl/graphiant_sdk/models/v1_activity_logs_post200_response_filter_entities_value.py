...
class V1ActivityLogsPost200ResponseFilterEntitiesValue(BaseModel):
    """
    V1ActivityLogsPost200ResponseFilterEntitiesValue
    """ # noqa: E501
    items: Optional[List[V1ActivityLogsPostRequestSelectorJobEntity]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [V1ActivityLogsPostRequestSelectorJobEntity.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
