...
class V1GlobalConfigPatchRequestTrafficPoliciesSecurityRulesetsValueRulesetRulesValueRuleMatchDscpMatch(BaseModel):
    """
    V1GlobalConfigPatchRequestTrafficPoliciesSecurityRulesetsValueRulesetRulesValueRuleMatchDscpMatch
    """ # noqa: E501
    code_point: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, alias="codePoint")
