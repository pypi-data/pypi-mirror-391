...
class V1DevicesDeviceIdConfigPutRequestCoreInterfacesValue(BaseModel):
    """
    V1DevicesDeviceIdConfigPutRequestCoreInterfacesValue
    """ # noqa: E501
    interface: Optional[V1DevicesDeviceIdConfigPutRequestCoreInterfacesValueInterface] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "interface": V1DevicesDeviceIdConfigPutRequestCoreInterfacesValueInterface.from_dict(obj["interface"]) if obj.get("interface") is not None else None
        })
        return _obj
