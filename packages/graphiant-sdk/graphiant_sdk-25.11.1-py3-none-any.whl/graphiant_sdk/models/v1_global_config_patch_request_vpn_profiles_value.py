...
class V1GlobalConfigPatchRequestVpnProfilesValue(BaseModel):
    """
    V1GlobalConfigPatchRequestVpnProfilesValue
    """ # noqa: E501
    vpn_profile: Optional[V1GlobalConfigPatchRequestVpnProfilesValueVpnProfile] = Field(default=None, alias="vpnProfile")
    __properties: ClassVar[List[str]] = ["vpnProfile"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "vpnProfile": V1GlobalConfigPatchRequestVpnProfilesValueVpnProfile.from_dict(obj["vpnProfile"]) if obj.get("vpnProfile") is not None else None
        })
        return _obj
