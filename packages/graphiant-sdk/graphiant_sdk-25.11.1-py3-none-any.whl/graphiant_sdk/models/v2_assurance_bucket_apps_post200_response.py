...
class V2AssuranceBucketAppsPost200Response(BaseModel):
    """
    V2AssuranceBucketAppsPost200Response
    """ # noqa: E501
    apps: Optional[List[V2AssuranceBucketAppsPost200ResponseAppsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "apps": [V2AssuranceBucketAppsPost200ResponseAppsInner.from_dict(_item) for _item in obj["apps"]] if obj.get("apps") is not None else None
        })
        return _obj
