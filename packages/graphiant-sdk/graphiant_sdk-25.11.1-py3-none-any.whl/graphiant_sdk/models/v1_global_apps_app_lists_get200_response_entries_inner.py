...
class V1GlobalAppsAppListsGet200ResponseEntriesInner(BaseModel):
    """
    V1GlobalAppsAppListsGet200ResponseEntriesInner
    """ # noqa: E501
    app_count: Optional[StrictInt] = Field(default=None, alias="appCount")
    app_list: Optional[V1GlobalAppsAppListsGet200ResponseEntriesInnerAppList] = Field(default=None, alias="appList")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.app_list:
            _dict['appList'] = self.app_list.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "appList": V1GlobalAppsAppListsGet200ResponseEntriesInnerAppList.from_dict(obj["appList"]) if obj.get("appList") is not None else None,
