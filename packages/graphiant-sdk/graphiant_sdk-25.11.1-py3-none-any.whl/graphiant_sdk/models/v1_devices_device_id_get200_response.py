...
class V1DevicesDeviceIdGet200Response(BaseModel):
    """
    V1DevicesDeviceIdGet200Response
    """ # noqa: E501
    device: Optional[V1ExtranetsGet200ResponsePoliciesInnerBranchesExcludedDevicesInner] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "device": V1ExtranetsGet200ResponsePoliciesInnerBranchesExcludedDevicesInner.from_dict(obj["device"]) if obj.get("device") is not None else None
        })
        return _obj
