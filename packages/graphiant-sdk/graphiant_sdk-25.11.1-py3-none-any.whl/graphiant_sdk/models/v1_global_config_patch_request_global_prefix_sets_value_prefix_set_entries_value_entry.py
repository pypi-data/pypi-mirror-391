...
class V1GlobalConfigPatchRequestGlobalPrefixSetsValuePrefixSetEntriesValueEntry(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["ipPrefix", "maskLower", "maskUpper", "seq"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "maskLower": obj.get("maskLower"),
            "maskUpper": obj.get("maskUpper"),
            "seq": obj.get("seq")
        })
        return _obj
