...
class V1DevicesDeviceIdConfigPutRequestCorePrometheusRuleGroupsValueRuleGroup(BaseModel):
    """
    ...
    rules: Optional[Dict[str, V1DevicesDeviceIdConfigPutRequestCorePrometheusRuleGroupsValueRuleGroupRulesValue]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "rules": dict(
                (_k, V1DevicesDeviceIdConfigPutRequestCorePrometheusRuleGroupsValueRuleGroupRulesValue.from_dict(_v))
