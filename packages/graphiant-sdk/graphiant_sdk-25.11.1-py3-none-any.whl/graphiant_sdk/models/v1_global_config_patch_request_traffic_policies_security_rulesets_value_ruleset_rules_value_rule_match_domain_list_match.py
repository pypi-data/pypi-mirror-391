...
class V1GlobalConfigPatchRequestTrafficPoliciesSecurityRulesetsValueRulesetRulesValueRuleMatchDomainListMatch(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["domainWildcards"]
