...
class V1AppsAppSummaryPost200ResponseAppSummaryAppIncidents(BaseModel):
    """
    V1AppsAppSummaryPost200ResponseAppSummaryAppIncidents
    """ # noqa: E501
    data: Optional[List[V1AppsAppSummaryPost200ResponseAppSummaryAppIncidentsDataInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [V1AppsAppSummaryPost200ResponseAppSummaryAppIncidentsDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
