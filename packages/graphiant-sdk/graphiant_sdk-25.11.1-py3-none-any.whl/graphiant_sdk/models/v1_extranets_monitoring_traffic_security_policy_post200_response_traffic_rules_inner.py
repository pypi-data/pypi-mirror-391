...
class V1ExtranetsMonitoringTrafficSecurityPolicyPost200ResponseTrafficRulesInner(BaseModel):
    """
    ...
    traffic_policy_rule: Optional[V1ExtranetsB2bConsumerPost200ResponsePolicyInnerTrafficRulesInner] = Field(default=None, alias="trafficPolicyRule")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "trafficPolicyRule": V1ExtranetsB2bConsumerPost200ResponsePolicyInnerTrafficRulesInner.from_dict(obj["trafficPolicyRule"]) if obj.get("trafficPolicyRule") is not None else None,
