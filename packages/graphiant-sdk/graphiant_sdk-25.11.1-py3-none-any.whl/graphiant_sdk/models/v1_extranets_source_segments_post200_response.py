...
class V1ExtranetsSourceSegmentsPost200Response(BaseModel):
    """
    V1ExtranetsSourceSegmentsPost200Response
    """ # noqa: E501
    vrfs: Optional[List[V1ExtranetsGet200ResponsePoliciesInnerBranchesExcludedDevicesInnerSegmentsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "vrfs": [V1ExtranetsGet200ResponsePoliciesInnerBranchesExcludedDevicesInnerSegmentsInner.from_dict(_item) for _item in obj["vrfs"]] if obj.get("vrfs") is not None else None
        })
        return _obj
