...
class V1GlobalLanSegmentsGet200Response(BaseModel):
    """
    V1GlobalLanSegmentsGet200Response
    """ # noqa: E501
    entries: Optional[List[V1GlobalLanSegmentsGet200ResponseEntriesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entries": [V1GlobalLanSegmentsGet200ResponseEntriesInner.from_dict(_item) for _item in obj["entries"]] if obj.get("entries") is not None else None
        })
        return _obj
