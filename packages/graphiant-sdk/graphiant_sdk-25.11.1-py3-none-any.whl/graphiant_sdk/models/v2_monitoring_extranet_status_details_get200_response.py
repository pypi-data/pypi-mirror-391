...
class V2MonitoringExtranetStatusDetailsGet200Response(BaseModel):
    """
    ...
    site_status: Optional[V2MonitoringExtranetServiceStatusDetailsGet200ResponseStatusesInner] = Field(default=None, alias="siteStatus")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "siteStatus": V2MonitoringExtranetServiceStatusDetailsGet200ResponseStatusesInner.from_dict(obj["siteStatus"]) if obj.get("siteStatus") is not None else None
        })
        return _obj
