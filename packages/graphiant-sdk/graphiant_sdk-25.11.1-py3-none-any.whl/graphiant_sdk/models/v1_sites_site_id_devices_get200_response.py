...
class V1SitesSiteIdDevicesGet200Response(BaseModel):
    """
    V1SitesSiteIdDevicesGet200Response
    """ # noqa: E501
    device: Optional[List[V1SitesSiteIdDevicesGet200ResponseDeviceInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "device": [V1SitesSiteIdDevicesGet200ResponseDeviceInner.from_dict(_item) for _item in obj["device"]] if obj.get("device") is not None else None
        })
        return _obj
