...
class V1DevicesDeviceIdPolicyZonepairsGet200Response(BaseModel):
    """
    V1DevicesDeviceIdPolicyZonepairsGet200Response
    """ # noqa: E501
    zone_pairs: Optional[List[V1DevicesDeviceIdPolicyZonepairsGet200ResponseZonePairsInner]] = Field(default=None, alias="zonePairs")
    __properties: ClassVar[List[str]] = ["zonePairs"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "zonePairs": [V1DevicesDeviceIdPolicyZonepairsGet200ResponseZonePairsInner.from_dict(_item) for _item in obj["zonePairs"]] if obj.get("zonePairs") is not None else None
        })
        return _obj
