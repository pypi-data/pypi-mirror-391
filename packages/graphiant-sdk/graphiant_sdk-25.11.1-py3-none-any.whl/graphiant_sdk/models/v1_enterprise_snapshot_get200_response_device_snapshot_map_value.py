...
class V1EnterpriseSnapshotGet200ResponseDeviceSnapshotMapValue(BaseModel):
    """
    V1EnterpriseSnapshotGet200ResponseDeviceSnapshotMapValue
    """ # noqa: E501
    count: Optional[StrictInt] = None
    snapshots: Optional[List[V1DeviceSnapshotGet200ResponseFirstSnapshot]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "count": obj.get("count"),
            "snapshots": [V1DeviceSnapshotGet200ResponseFirstSnapshot.from_dict(_item) for _item in obj["snapshots"]] if obj.get("snapshots") is not None else None
        })
        return _obj
