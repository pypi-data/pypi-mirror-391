...
class V1BwtrackerRegionEdgeSummaryPost200ResponseBwusageSummary(BaseModel):
    """
    V1BwtrackerRegionEdgeSummaryPost200ResponseBwusageSummary
    """ # noqa: E501
    bwusage_top_sites: Optional[List[V1BwtrackerRegionEdgeSummaryPost200ResponseBwusageSummaryBwusageTopSitesInner]] = Field(default=None, alias="bwusageTopSites")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "bwusageTopSites": [V1BwtrackerRegionEdgeSummaryPost200ResponseBwusageSummaryBwusageTopSitesInner.from_dict(_item) for _item in obj["bwusageTopSites"]] if obj.get("bwusageTopSites") is not None else None,
