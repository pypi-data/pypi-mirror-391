...
class V1GlobalConfigPatchRequestSnmpsValueConfigVacmGroupsValueGroupMembersValue(BaseModel):
    """
    V1GlobalConfigPatchRequestSnmpsValueConfigVacmGroupsValueGroupMembersValue
    """ # noqa: E501
    member: Optional[V1GlobalConfigPatchRequestSnmpsValueConfigVacmGroupsValueGroupMembersValueMember] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "member": V1GlobalConfigPatchRequestSnmpsValueConfigVacmGroupsValueGroupMembersValueMember.from_dict(obj["member"]) if obj.get("member") is not None else None
        })
        return _obj
