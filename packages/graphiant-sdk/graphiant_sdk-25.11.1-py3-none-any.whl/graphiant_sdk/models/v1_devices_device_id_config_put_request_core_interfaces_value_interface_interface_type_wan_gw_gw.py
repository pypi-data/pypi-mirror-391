...
class V1DevicesDeviceIdConfigPutRequestCoreInterfacesValueInterfaceInterfaceTypeWanGwGw(BaseModel):
    """
    ...
    dhcp: Optional[V1DevicesDeviceIdConfigPutRequestCoreInterfacesValueInterfaceGwGwDhcp] = None
    vrrp: Optional[V1DevicesDeviceIdConfigPutRequestCoreInterfacesValueInterfaceInterfaceTypeWanGwGwVrrp] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "dhcp": V1DevicesDeviceIdConfigPutRequestCoreInterfacesValueInterfaceGwGwDhcp.from_dict(obj["dhcp"]) if obj.get("dhcp") is not None else None,
            "vrrp": V1DevicesDeviceIdConfigPutRequestCoreInterfacesValueInterfaceInterfaceTypeWanGwGwVrrp.from_dict(obj["vrrp"]) if obj.get("vrrp") is not None else None
        })
        return _obj
