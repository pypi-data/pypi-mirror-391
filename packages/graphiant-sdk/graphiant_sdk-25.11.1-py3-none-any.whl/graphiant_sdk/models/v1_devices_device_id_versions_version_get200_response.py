...
class V1DevicesDeviceIdVersionsVersionGet200Response(BaseModel):
    """
    V1DevicesDeviceIdVersionsVersionGet200Response
    """ # noqa: E501
    config: Optional[V1DevicesDeviceIdDraftGet200ResponseDraft] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "config": V1DevicesDeviceIdDraftGet200ResponseDraft.from_dict(obj["config"]) if obj.get("config") is not None else None
        })
        return _obj
