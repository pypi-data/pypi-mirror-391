...
class V2ExtranetsMonitoringConsumersPost200Response(BaseModel):
    """
    V2ExtranetsMonitoringConsumersPost200Response
    """ # noqa: E501
    consumers: Optional[List[V2ExtranetsMonitoringConsumersPost200ResponseConsumersInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "consumers": [V2ExtranetsMonitoringConsumersPost200ResponseConsumersInner.from_dict(_item) for _item in obj["consumers"]] if obj.get("consumers") is not None else None
        })
        return _obj
