...
class V1GlobalConfigPatchRequestSnmpsValueConfigVacmViewsValue(BaseModel):
    """
    V1GlobalConfigPatchRequestSnmpsValueConfigVacmViewsValue
    """ # noqa: E501
    view: Optional[V1GlobalConfigPatchRequestSnmpsValueConfigNotifyFilterProfilesValueNotifyFilterProfile] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "view": V1GlobalConfigPatchRequestSnmpsValueConfigNotifyFilterProfilesValueNotifyFilterProfile.from_dict(obj["view"]) if obj.get("view") is not None else None
        })
        return _obj
