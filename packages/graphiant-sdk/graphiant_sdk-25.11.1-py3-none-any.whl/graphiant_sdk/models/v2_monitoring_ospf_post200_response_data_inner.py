...
class V2MonitoringOspfPost200ResponseDataInner(BaseModel):
    """
    V2MonitoringOspfPost200ResponseDataInner
    """ # noqa: E501
    samples: Optional[List[V2MonitoringBfdPost200ResponseDataInnerSamplesInner]] = None
    selector: Optional[V2MonitoringOspfPostRequestSelectorsInner] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "selector": V2MonitoringOspfPostRequestSelectorsInner.from_dict(obj["selector"]) if obj.get("selector") is not None else None
        })
        return _obj
