...
class V2AssuranceApplicationprofilesummaryPost200ResponseApplicationProfileSummaryBucketSummaryListInnerBucketStats(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "prevUniqueAppCount": obj.get("prevUniqueAppCount"),
            "prevUniqueThreatCount": obj.get("prevUniqueThreatCount"),
            "uniqueAppCount": obj.get("uniqueAppCount"),
            "uniqueThreatCount": obj.get("uniqueThreatCount")
        })
        return _obj
