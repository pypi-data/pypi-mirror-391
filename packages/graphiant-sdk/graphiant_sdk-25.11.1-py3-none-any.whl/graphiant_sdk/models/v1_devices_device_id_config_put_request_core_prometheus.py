...
class V1DevicesDeviceIdConfigPutRequestCorePrometheus(BaseModel):
    """
    V1DevicesDeviceIdConfigPutRequestCorePrometheus
    """ # noqa: E501
    rule_groups: Optional[Dict[str, V1DevicesDeviceIdConfigPutRequestCorePrometheusRuleGroupsValue]] = Field(default=None, alias="ruleGroups")
    sink: Optional[V1DevicesDeviceIdConfigPutRequestCorePrometheusSink] = None
    sysdb_monitors: Optional[Dict[str, V1DevicesDeviceIdConfigPutRequestCorePrometheusSysdbMonitorsValue]] = Field(default=None, alias="sysdbMonitors")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ruleGroups": dict(
                (_k, V1DevicesDeviceIdConfigPutRequestCorePrometheusRuleGroupsValue.from_dict(_v))
                for _k, _v in obj["ruleGroups"].items()
            )
            if obj.get("ruleGroups") is not None
            else None,
            "sink": V1DevicesDeviceIdConfigPutRequestCorePrometheusSink.from_dict(obj["sink"]) if obj.get("sink") is not None else None,
            "sysdbMonitors": dict(
                (_k, V1DevicesDeviceIdConfigPutRequestCorePrometheusSysdbMonitorsValue.from_dict(_v))
