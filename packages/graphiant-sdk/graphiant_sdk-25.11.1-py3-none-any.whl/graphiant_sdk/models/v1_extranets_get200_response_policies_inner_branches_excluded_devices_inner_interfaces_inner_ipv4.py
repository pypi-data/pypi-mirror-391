...
class V1ExtranetsGet200ResponsePoliciesInnerBranchesExcludedDevicesInnerInterfacesInnerIpv4(BaseModel):
    """
    ...
    dhcp_relay: Optional[V1ExtranetsGet200ResponsePoliciesInnerBranchesExcludedDevicesInnerInterfacesInnerIpv4DhcpRelay] = Field(default=None, alias="dhcpRelay")
    dhcp_server: Optional[StrictBool] = Field(default=None, alias="dhcpServer")
    origin: Optional[StrictStr] = None
    vrrp_group: Optional[V1ExtranetsGet200ResponsePoliciesInnerBranchesExcludedDevicesInnerInterfacesInnerIpv4VrrpGroup] = Field(default=None, alias="vrrpGroup")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "dhcpRelay": V1ExtranetsGet200ResponsePoliciesInnerBranchesExcludedDevicesInnerInterfacesInnerIpv4DhcpRelay.from_dict(obj["dhcpRelay"]) if obj.get("dhcpRelay") is not None else None,
            "dhcpServer": obj.get("dhcpServer"),
            "origin": obj.get("origin"),
            "vrrpGroup": V1ExtranetsGet200ResponsePoliciesInnerBranchesExcludedDevicesInnerInterfacesInnerIpv4VrrpGroup.from_dict(obj["vrrpGroup"]) if obj.get("vrrpGroup") is not None else None
        })
        return _obj
