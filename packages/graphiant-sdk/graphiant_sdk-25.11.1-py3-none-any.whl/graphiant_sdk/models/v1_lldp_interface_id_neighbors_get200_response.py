...
class V1LldpInterfaceIdNeighborsGet200Response(BaseModel):
    """
    V1LldpInterfaceIdNeighborsGet200Response
    """ # noqa: E501
    neighbors: Optional[List[V1LldpInterfaceIdNeighborsGet200ResponseNeighborsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "neighbors": [V1LldpInterfaceIdNeighborsGet200ResponseNeighborsInner.from_dict(_item) for _item in obj["neighbors"]] if obj.get("neighbors") is not None else None
        })
        return _obj
