...
class V1ExtranetsGet200ResponsePoliciesInnerBranchesExcludedDevicesInnerTrafficPolicyNetworkListsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "networks"]
