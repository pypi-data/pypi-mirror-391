...
class V1ExtranetsGet200ResponsePoliciesInnerBranchesExcludedDevicesInnerCircuitsInnerBgpNeighborsInnerBfdNeighbor(BaseModel):
    """
    ...
    last_updated: Optional[V1AlarmHistoryGet200ResponseHistoryInnerTime] = Field(default=None, alias="lastUpdated")
    ...
    time_in_state: Optional[V1AlarmHistoryGet200ResponseHistoryInnerTime] = Field(default=None, alias="timeInState")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "lastUpdated": V1AlarmHistoryGet200ResponseHistoryInnerTime.from_dict(obj["lastUpdated"]) if obj.get("lastUpdated") is not None else None,
            ...
            "state": obj.get("state"),
            "timeInState": V1AlarmHistoryGet200ResponseHistoryInnerTime.from_dict(obj["timeInState"]) if obj.get("timeInState") is not None else None,
            "up": obj.get("up")
        })
        return _obj
