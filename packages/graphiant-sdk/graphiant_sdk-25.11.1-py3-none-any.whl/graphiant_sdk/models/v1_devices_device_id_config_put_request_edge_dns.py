...
class V1DevicesDeviceIdConfigPutRequestEdgeDns(BaseModel):
    """
    V1DevicesDeviceIdConfigPutRequestEdgeDns
    """ # noqa: E501
    dns: Optional[V1DevicesDeviceIdConfigPutRequestEdgeDnsDns] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "dns": V1DevicesDeviceIdConfigPutRequestEdgeDnsDns.from_dict(obj["dns"]) if obj.get("dns") is not None else None
        })
        return _obj
