...
class V1GatewaysPutRequestDetailsAwsAdvanceSettings(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "amazonBgpRouterIp": obj.get("amazonBgpRouterIp"),
            "bgpAuthKey": obj.get("bgpAuthKey"),
            "customerBgpRouterIp": obj.get("customerBgpRouterIp"),
            "isJumbo": obj.get("isJumbo")
        })
        return _obj
