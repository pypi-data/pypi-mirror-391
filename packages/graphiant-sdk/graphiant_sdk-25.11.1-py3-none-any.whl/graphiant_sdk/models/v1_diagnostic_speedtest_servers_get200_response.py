...
class V1DiagnosticSpeedtestServersGet200Response(BaseModel):
    """
    V1DiagnosticSpeedtestServersGet200Response
    """ # noqa: E501
    server: Optional[List[V1DiagnosticSpeedtestServersGet200ResponseServerInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "server": [V1DiagnosticSpeedtestServersGet200ResponseServerInner.from_dict(_item) for _item in obj["server"]] if obj.get("server") is not None else None
        })
        return _obj
