...
class V1BackboneHealthOverviewPostRequestFilter(BaseModel):
    """
    V1BackboneHealthOverviewPostRequestFilter
    """ # noqa: E501
    circuit_names: Optional[List[StrictStr]] = Field(default=None, alias="circuitNames")
    ...
    site_ids: Optional[List[StrictInt]] = Field(default=None, alias="siteIds")
    __properties: ClassVar[List[str]] = ["circuitNames", "deviceIds", "lanSegments", "regionIds", "siteIds"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "circuitNames": obj.get("circuitNames"),
