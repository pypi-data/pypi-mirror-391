...
class V1ExtranetsGet200ResponsePoliciesInnerBranchesExcludedDevicesInnerCircuitsInnerStaticRoutesInner(BaseModel):
    """
    ...
    next_hop: Optional[V1ExtranetsGet200ResponsePoliciesInnerBranchesExcludedDevicesInnerCircuitsInnerStaticRoutesInnerNextHop] = Field(default=None, alias="nextHop")
    next_hops: Optional[List[V1ExtranetsGet200ResponsePoliciesInnerBranchesExcludedDevicesInnerCircuitsInnerStaticRoutesInnerNextHop]] = Field(default=None, alias="nextHops")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "administrativeDistance": obj.get("administrativeDistance"),
            "description": obj.get("description"),
            "id": obj.get("id"),
            "nextHop": V1ExtranetsGet200ResponsePoliciesInnerBranchesExcludedDevicesInnerCircuitsInnerStaticRoutesInnerNextHop.from_dict(obj["nextHop"]) if obj.get("nextHop") is not None else None,
            "nextHops": [V1ExtranetsGet200ResponsePoliciesInnerBranchesExcludedDevicesInnerCircuitsInnerStaticRoutesInnerNextHop.from_dict(_item) for _item in obj["nextHops"]] if obj.get("nextHops") is not None else None,
