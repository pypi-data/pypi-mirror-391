...
class V1DeviceRoutingOspfv2RibGet200Response(BaseModel):
    """
    ...
    routes: Optional[List[V1DeviceRoutingOspfv2RibGet200ResponseRoutesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "routes": [V1DeviceRoutingOspfv2RibGet200ResponseRoutesInner.from_dict(_item) for _item in obj["routes"]] if obj.get("routes") is not None else None,
            "token": obj.get("token")
        })
        return _obj
