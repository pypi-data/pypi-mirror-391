...
class V1AuditLogsPost200Response(BaseModel):
    """
    ...
    logs: Optional[List[V1AuditLogsPost200ResponseLogsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "logs": [V1AuditLogsPost200ResponseLogsInner.from_dict(_item) for _item in obj["logs"]] if obj.get("logs") is not None else None,
