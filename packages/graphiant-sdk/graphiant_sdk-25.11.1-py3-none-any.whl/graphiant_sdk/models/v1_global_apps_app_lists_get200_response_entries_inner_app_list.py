...
class V1GlobalAppsAppListsGet200ResponseEntriesInnerAppList(BaseModel):
    """
    V1GlobalAppsAppListsGet200ResponseEntriesInnerAppList
    """ # noqa: E501
    description: Optional[StrictStr] = None
    identifier: Optional[V1GlobalAppsAppListsGet200ResponseEntriesInnerAppListIdentifier] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "identifier": V1GlobalAppsAppListsGet200ResponseEntriesInnerAppListIdentifier.from_dict(obj["identifier"]) if obj.get("identifier") is not None else None,
            "name": obj.get("name")
        })
        return _obj
