...
class V2AssuranceTopologyClientSessionDetailsPost200ResponseSessionPopLinksInner(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "firstPopName": obj.get("firstPopName"),
            "jitter": obj.get("jitter"),
            "latency": obj.get("latency"),
            "loss": obj.get("loss"),
            "secondPopName": obj.get("secondPopName")
        })
        return _obj
