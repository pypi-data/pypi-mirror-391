...
class V1GlobalConfigPatchRequestGlobalPrefixSetsValuePrefixSet(BaseModel):
    """
    V1GlobalConfigPatchRequestGlobalPrefixSetsValuePrefixSet
    """ # noqa: E501
    description: Optional[StrictStr] = None
    entries: Optional[Dict[str, V1GlobalConfigPatchRequestGlobalPrefixSetsValuePrefixSetEntriesValue]] = None
    ...
    __properties: ClassVar[List[str]] = ["description", "entries", "globalId", "isGlobalSync", "mode", "name"]
