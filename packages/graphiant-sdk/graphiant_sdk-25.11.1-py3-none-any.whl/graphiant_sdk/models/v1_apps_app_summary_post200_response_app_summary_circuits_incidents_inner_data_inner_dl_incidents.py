...
class V1AppsAppSummaryPost200ResponseAppSummaryCircuitsIncidentsInnerDataInnerDlIncidents(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "numFairIncidents": obj.get("numFairIncidents"),
            "numPoorIncidents": obj.get("numPoorIncidents")
        })
        return _obj
