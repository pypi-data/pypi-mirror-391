...
class V1ExtranetsIdApplyPost202Response(BaseModel):
    """
    V1ExtranetsIdApplyPost202Response
    """ # noqa: E501
    devices: Optional[List[V1ExtranetsIdApplyPost202ResponseDevicesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "devices": [V1ExtranetsIdApplyPost202ResponseDevicesInner.from_dict(_item) for _item in obj["devices"]] if obj.get("devices") is not None else None,
            "jobId": obj.get("jobId")
        })
        return _obj
