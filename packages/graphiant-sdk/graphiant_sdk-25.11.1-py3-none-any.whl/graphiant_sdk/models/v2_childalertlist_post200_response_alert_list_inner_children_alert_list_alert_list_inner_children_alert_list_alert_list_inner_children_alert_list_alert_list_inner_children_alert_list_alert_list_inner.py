...
class V2ChildalertlistPost200ResponseAlertListInnerChildrenAlertListAlertListInnerChildrenAlertListAlertListInnerChildrenAlertListAlertListInnerChildrenAlertListAlertListInner(BaseModel):
    """
    ...
    children_alert_list: Optional[Dict[str, Any]] = Field(default=None, alias="childrenAlertList")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "childrenAlertList": obj.get("childrenAlertList"),
