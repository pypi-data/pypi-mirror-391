...
class V1DevicesSummaryGet200ResponseSitesInner(BaseModel):
    """
    V1DevicesSummaryGet200ResponseSitesInner
    """ # noqa: E501
    devices: Optional[List[V1DevicesSummaryGet200ResponseSitesInnerDevicesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "devices": [V1DevicesSummaryGet200ResponseSitesInnerDevicesInner.from_dict(_item) for _item in obj["devices"]] if obj.get("devices") is not None else None,
