...
class V1GlobalConfigPatchRequestTrafficPoliciesTrafficRulesetsValue(BaseModel):
    """
    V1GlobalConfigPatchRequestTrafficPoliciesTrafficRulesetsValue
    """ # noqa: E501
    ruleset: Optional[V1GlobalConfigPatchRequestTrafficPoliciesTrafficRulesetsValueRuleset] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ruleset": V1GlobalConfigPatchRequestTrafficPoliciesTrafficRulesetsValueRuleset.from_dict(obj["ruleset"]) if obj.get("ruleset") is not None else None
        })
        return _obj
