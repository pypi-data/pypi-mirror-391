...
class V2RulelistPost200Response(BaseModel):
    """
    V2RulelistPost200Response
    """ # noqa: E501
    rule_list: Optional[List[V2RulelistPost200ResponseRuleListInner]] = Field(default=None, alias="ruleList")
    __properties: ClassVar[List[str]] = ["ruleList"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ruleList": [V2RulelistPost200ResponseRuleListInner.from_dict(_item) for _item in obj["ruleList"]] if obj.get("ruleList") is not None else None
        })
        return _obj
