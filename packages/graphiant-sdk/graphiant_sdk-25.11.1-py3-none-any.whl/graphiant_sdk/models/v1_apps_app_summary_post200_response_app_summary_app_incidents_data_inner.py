...
class V1AppsAppSummaryPost200ResponseAppSummaryAppIncidentsDataInner(BaseModel):
    """
    V1AppsAppSummaryPost200ResponseAppSummaryAppIncidentsDataInner
    """ # noqa: E501
    app_count: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, alias="appCount")
