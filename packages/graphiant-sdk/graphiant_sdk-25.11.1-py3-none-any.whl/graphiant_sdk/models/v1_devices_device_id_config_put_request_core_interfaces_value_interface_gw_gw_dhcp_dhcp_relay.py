...
class V1DevicesDeviceIdConfigPutRequestCoreInterfacesValueInterfaceGwGwDhcpDhcpRelay(BaseModel):
    """
    V1DevicesDeviceIdConfigPutRequestCoreInterfacesValueInterfaceGwGwDhcpDhcpRelay
    """ # noqa: E501
    relay_servers: Optional[List[StrictStr]] = Field(default=None, alias="relayServers")
    __properties: ClassVar[List[str]] = ["relayServers"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "relayServers": obj.get("relayServers")
        })
        return _obj
