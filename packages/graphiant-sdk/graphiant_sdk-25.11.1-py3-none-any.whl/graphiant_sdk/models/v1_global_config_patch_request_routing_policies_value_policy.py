...
class V1GlobalConfigPatchRequestRoutingPoliciesValuePolicy(BaseModel):
    """
    ...
    statements: Optional[Dict[str, V1GlobalConfigPatchRequestRoutingPoliciesValuePolicyStatementsValue]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "statements": dict(
                (_k, V1GlobalConfigPatchRequestRoutingPoliciesValuePolicyStatementsValue.from_dict(_v))
