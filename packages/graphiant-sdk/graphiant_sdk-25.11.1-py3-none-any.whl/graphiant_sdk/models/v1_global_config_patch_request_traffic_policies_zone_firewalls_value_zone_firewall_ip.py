...
class V1GlobalConfigPatchRequestTrafficPoliciesZoneFirewallsValueZoneFirewallIp(BaseModel):
    """
    ...
    session_limit: Optional[V1GlobalConfigPatchRequestTrafficPoliciesZoneFirewallsValueZoneFirewallIpSessionLimit] = Field(default=None, alias="sessionLimit")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sessionLimit": V1GlobalConfigPatchRequestTrafficPoliciesZoneFirewallsValueZoneFirewallIpSessionLimit.from_dict(obj["sessionLimit"]) if obj.get("sessionLimit") is not None else None,
            "urpf": obj.get("urpf")
        })
        return _obj
