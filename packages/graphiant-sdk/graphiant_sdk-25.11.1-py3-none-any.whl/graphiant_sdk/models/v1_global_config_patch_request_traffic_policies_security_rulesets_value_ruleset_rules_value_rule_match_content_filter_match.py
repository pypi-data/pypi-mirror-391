...
class V1GlobalConfigPatchRequestTrafficPoliciesSecurityRulesetsValueRulesetRulesValueRuleMatchContentFilterMatch(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["domainCategoryIds"]
