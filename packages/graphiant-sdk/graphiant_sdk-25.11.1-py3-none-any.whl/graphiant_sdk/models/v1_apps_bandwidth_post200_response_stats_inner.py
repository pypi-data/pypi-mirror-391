...
class V1AppsBandwidthPost200ResponseStatsInner(BaseModel):
    """
    V1AppsBandwidthPost200ResponseStatsInner
    """ # noqa: E501
    dl_bw: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="dlBw")
    ts: Optional[V1AlarmHistoryGet200ResponseHistoryInnerTime] = None
    ul_bw: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="ulBw")
