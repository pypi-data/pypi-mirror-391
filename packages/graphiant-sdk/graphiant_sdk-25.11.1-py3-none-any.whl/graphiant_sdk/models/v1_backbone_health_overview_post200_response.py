...
class V1BackboneHealthOverviewPost200Response(BaseModel):
    """
    V1BackboneHealthOverviewPost200Response
    """ # noqa: E501
    devices: Optional[List[V1BackboneHealthOverviewPost200ResponseDevicesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "devices": [V1BackboneHealthOverviewPost200ResponseDevicesInner.from_dict(_item) for _item in obj["devices"]] if obj.get("devices") is not None else None
        })
        return _obj
