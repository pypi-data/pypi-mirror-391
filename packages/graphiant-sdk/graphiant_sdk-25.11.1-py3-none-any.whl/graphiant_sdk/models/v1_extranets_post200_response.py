...
class V1ExtranetsPost200Response(BaseModel):
    """
    V1ExtranetsPost200Response
    """ # noqa: E501
    policy: Optional[V1ExtranetsGet200ResponsePoliciesInner] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "policy": V1ExtranetsGet200ResponsePoliciesInner.from_dict(obj["policy"]) if obj.get("policy") is not None else None
        })
        return _obj
