...
class V1DevicesInventoryGet200Response(BaseModel):
    """
    V1DevicesInventoryGet200Response
    """ # noqa: E501
    inventory: Optional[List[V1DevicesInventoryGet200ResponseInventoryInner]] = None
    page_info: Optional[V1NatEntriesDeviceIdGet200ResponsePageInfo] = Field(default=None, alias="pageInfo")
    __properties: ClassVar[List[str]] = ["inventory", "pageInfo"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "inventory": [V1DevicesInventoryGet200ResponseInventoryInner.from_dict(_item) for _item in obj["inventory"]] if obj.get("inventory") is not None else None,
