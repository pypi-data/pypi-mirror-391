...
class V1DeviceRoutingBgpNbrsCountersGet200ResponseCountersInner(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "gracefulRestart": obj.get("gracefulRestart"),
            "localAsNumber": obj.get("localAsNumber"),
            "localIpAddress": obj.get("localIpAddress"),
            "localRouterId": obj.get("localRouterId"),
            "peerRouterId": obj.get("peerRouterId"),
