...
class V1MonitoringCircuitsBandwidthPost200Response(BaseModel):
    """
    V1MonitoringCircuitsBandwidthPost200Response
    """ # noqa: E501
    data: Optional[List[V1MonitoringCircuitsBandwidthPost200ResponseDataInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [V1MonitoringCircuitsBandwidthPost200ResponseDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
