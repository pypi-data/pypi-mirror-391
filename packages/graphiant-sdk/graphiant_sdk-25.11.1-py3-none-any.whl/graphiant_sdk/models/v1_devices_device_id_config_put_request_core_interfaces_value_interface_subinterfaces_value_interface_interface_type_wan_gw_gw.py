...
class V1DevicesDeviceIdConfigPutRequestCoreInterfacesValueInterfaceSubinterfacesValueInterfaceInterfaceTypeWanGwGw(BaseModel):
    """
    V1DevicesDeviceIdConfigPutRequestCoreInterfacesValueInterfaceSubinterfacesValueInterfaceInterfaceTypeWanGwGw
    """ # noqa: E501
    address: Optional[Dict[str, Any]] = None
    dhcp: Optional[Dict[str, Any]] = None
    vrrp: Optional[Dict[str, Any]] = None
