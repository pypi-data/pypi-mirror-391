...
class V1GlobalConfigPatchRequestSnmpsValueConfigVacmGroupsValueGroupAccessesValue(BaseModel):
    """
    V1GlobalConfigPatchRequestSnmpsValueConfigVacmGroupsValueGroupAccessesValue
    """ # noqa: E501
    access: Optional[V1GlobalConfigPatchRequestSnmpsValueConfigVacmGroupsValueGroupAccessesValueAccess] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "access": V1GlobalConfigPatchRequestSnmpsValueConfigVacmGroupsValueGroupAccessesValueAccess.from_dict(obj["access"]) if obj.get("access") is not None else None
        })
        return _obj
