...
class V2MonitoringExtranetLogDetailsPost200Response(BaseModel):
    """
    V2MonitoringExtranetLogDetailsPost200Response
    """ # noqa: E501
    logs: Optional[List[V2MonitoringExtranetLogDetailsPost200ResponseLogsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "logs": [V2MonitoringExtranetLogDetailsPost200ResponseLogsInner.from_dict(_item) for _item in obj["logs"]] if obj.get("logs") is not None else None
        })
        return _obj
