...
class V1SearchGet200Response(BaseModel):
    """
    V1SearchGet200Response
    """ # noqa: E501
    results: Optional[List[V1SearchGet200ResponseResultsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [V1SearchGet200ResponseResultsInner.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj
