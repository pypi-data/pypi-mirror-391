...
class V2MonitoringExtranetServiceStatusDetailsGet200ResponseStatusesInner(BaseModel):
    """
    ...
    statuses: Optional[List[V2MonitoringExtranetServiceStatusDetailsGet200ResponseStatusesInnerStatusesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "statuses": [V2MonitoringExtranetServiceStatusDetailsGet200ResponseStatusesInnerStatusesInner.from_dict(_item) for _item in obj["statuses"]] if obj.get("statuses") is not None else None
        })
        return _obj
