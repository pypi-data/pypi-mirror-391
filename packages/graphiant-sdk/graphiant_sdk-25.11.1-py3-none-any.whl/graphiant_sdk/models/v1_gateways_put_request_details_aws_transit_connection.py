...
class V1GatewaysPutRequestDetailsAwsTransitConnection(BaseModel):
    """
    V1GatewaysPutRequestDetailsAwsTransitConnection
    """ # noqa: E501
    credentials: Optional[V1GatewaysPutRequestDetailsAwsTransitConnectionCredentials] = None
    customer_asn: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, alias="customerAsn")
    gateway: Optional[V1GatewaysPutRequestDetailsAwsTransitConnectionGateway] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "credentials": V1GatewaysPutRequestDetailsAwsTransitConnectionCredentials.from_dict(obj["credentials"]) if obj.get("credentials") is not None else None,
            "customerAsn": obj.get("customerAsn"),
            "gateway": V1GatewaysPutRequestDetailsAwsTransitConnectionGateway.from_dict(obj["gateway"]) if obj.get("gateway") is not None else None,
