...
class V1ExtranetsB2bPeeringConsumerMatchIdPostRequestSiteToSiteVpn(BaseModel):
    """
    V1ExtranetsB2bPeeringConsumerMatchIdPostRequestSiteToSiteVpn
    """ # noqa: E501
    emails: Optional[List[StrictStr]] = None
    ipsec_gateway_details: Optional[V1ExtranetsB2bPeeringConsumerMatchIdPostRequestSiteToSiteVpnIpsecGatewayDetails] = Field(default=None, alias="ipsecGatewayDetails")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ipsecGatewayDetails": V1ExtranetsB2bPeeringConsumerMatchIdPostRequestSiteToSiteVpnIpsecGatewayDetails.from_dict(obj["ipsecGatewayDetails"]) if obj.get("ipsecGatewayDetails") is not None else None,
