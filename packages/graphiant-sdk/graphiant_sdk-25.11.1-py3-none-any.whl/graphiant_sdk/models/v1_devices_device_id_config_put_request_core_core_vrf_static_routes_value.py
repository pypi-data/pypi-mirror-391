...
class V1DevicesDeviceIdConfigPutRequestCoreCoreVrfStaticRoutesValue(BaseModel):
    """
    V1DevicesDeviceIdConfigPutRequestCoreCoreVrfStaticRoutesValue
    """ # noqa: E501
    route: Optional[V1DevicesDeviceIdConfigPutRequestCoreCoreVrfStaticRoutesValueRoute] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "route": V1DevicesDeviceIdConfigPutRequestCoreCoreVrfStaticRoutesValueRoute.from_dict(obj["route"]) if obj.get("route") is not None else None
        })
        return _obj
