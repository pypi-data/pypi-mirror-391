...
class V1MonitoringCircuitsUtilizationPost200ResponseCircuitUtilizationInnerQueueUtilizationInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["allocatedPct", "defaultQueue", "excessWeight", "slaClass", "utilizationPct"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "allocatedPct": obj.get("allocatedPct"),
            "defaultQueue": obj.get("defaultQueue"),
            "excessWeight": obj.get("excessWeight"),
            "slaClass": obj.get("slaClass"),
            "utilizationPct": obj.get("utilizationPct")
        })
        return _obj
