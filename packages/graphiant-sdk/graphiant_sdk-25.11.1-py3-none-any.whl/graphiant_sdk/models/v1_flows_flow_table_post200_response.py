...
class V1FlowsFlowTablePost200Response(BaseModel):
    """
    ...
    flow_table: Optional[List[V1FlowsFlowTablePost200ResponseFlowTableInner]] = Field(default=None, alias="flowTable")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "flowTable": [V1FlowsFlowTablePost200ResponseFlowTableInner.from_dict(_item) for _item in obj["flowTable"]] if obj.get("flowTable") is not None else None
        })
        return _obj
