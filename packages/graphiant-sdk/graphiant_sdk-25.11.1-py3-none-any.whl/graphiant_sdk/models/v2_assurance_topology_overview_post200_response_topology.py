...
class V2AssuranceTopologyOverviewPost200ResponseTopology(BaseModel):
    """
    V2AssuranceTopologyOverviewPost200ResponseTopology
    """ # noqa: E501
    edges: Optional[List[V2AssuranceTopologyOverviewPost200ResponseTopologyEdgesInner]] = None
    nodes: Optional[List[V2AssuranceTopologyOverviewPost200ResponseTopologyNodesInner]] = None
    paths: Optional[List[V2AssuranceTopologyOverviewPost200ResponseTopologyPathsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "edges": [V2AssuranceTopologyOverviewPost200ResponseTopologyEdgesInner.from_dict(_item) for _item in obj["edges"]] if obj.get("edges") is not None else None,
            "nodes": [V2AssuranceTopologyOverviewPost200ResponseTopologyNodesInner.from_dict(_item) for _item in obj["nodes"]] if obj.get("nodes") is not None else None,
            "paths": [V2AssuranceTopologyOverviewPost200ResponseTopologyPathsInner.from_dict(_item) for _item in obj["paths"]] if obj.get("paths") is not None else None
        })
        return _obj
