...
class V2SiteSiteIdDetailPost200Response(BaseModel):
    """
    V2SiteSiteIdDetailPost200Response
    """ # noqa: E501
    site: Optional[V2SiteSiteIdDetailPost200ResponseSite] = None
    snapshots: Optional[List[V1AlarmHistoryGet200ResponseHistoryInnerTime]] = None
    __properties: ClassVar[List[str]] = ["site", "snapshots"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "site": V2SiteSiteIdDetailPost200ResponseSite.from_dict(obj["site"]) if obj.get("site") is not None else None,
            "snapshots": [V1AlarmHistoryGet200ResponseHistoryInnerTime.from_dict(_item) for _item in obj["snapshots"]] if obj.get("snapshots") is not None else None
        })
        return _obj
