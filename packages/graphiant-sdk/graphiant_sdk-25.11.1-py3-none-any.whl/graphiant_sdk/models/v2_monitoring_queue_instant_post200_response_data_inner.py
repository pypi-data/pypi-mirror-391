...
class V2MonitoringQueueInstantPost200ResponseDataInner(BaseModel):
    """
    ...
    selector: Optional[V2MonitoringQueueInstantPostRequestSelectorsInner] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "selector": V2MonitoringQueueInstantPostRequestSelectorsInner.from_dict(obj["selector"]) if obj.get("selector") is not None else None
        })
        return _obj
