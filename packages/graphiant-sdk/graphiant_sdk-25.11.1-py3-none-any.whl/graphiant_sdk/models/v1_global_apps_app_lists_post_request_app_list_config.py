...
class V1GlobalAppsAppListsPostRequestAppListConfig(BaseModel):
    """
    V1GlobalAppsAppListsPostRequestAppListConfig
    """ # noqa: E501
    apps: Optional[List[V1GlobalAppsAppListsGet200ResponseEntriesInnerAppListIdentifier]] = None
    description: Optional[StrictStr] = None
    name: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["apps", "description", "name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "apps": [V1GlobalAppsAppListsGet200ResponseEntriesInnerAppListIdentifier.from_dict(_item) for _item in obj["apps"]] if obj.get("apps") is not None else None,
