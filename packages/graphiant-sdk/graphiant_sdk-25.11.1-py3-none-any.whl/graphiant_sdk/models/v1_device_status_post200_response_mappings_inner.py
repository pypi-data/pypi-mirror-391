...
class V1DeviceStatusPost200ResponseMappingsInner(BaseModel):
    """
    V1DeviceStatusPost200ResponseMappingsInner
    """ # noqa: E501
    connect_time: Optional[V1AlarmHistoryGet200ResponseHistoryInnerTime] = Field(default=None, alias="connectTime")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "connectTime": V1AlarmHistoryGet200ResponseHistoryInnerTime.from_dict(obj["connectTime"]) if obj.get("connectTime") is not None else None,
