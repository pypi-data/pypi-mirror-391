...
class V1PolicyRouteTagSetsTagsSummaryGet200Response(BaseModel):
    """
    V1PolicyRouteTagSetsTagsSummaryGet200Response
    """ # noqa: E501
    tags: Optional[List[V1PolicyRouteTagSetsTagsSummaryGet200ResponseTagsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tags": [V1PolicyRouteTagSetsTagsSummaryGet200ResponseTagsInner.from_dict(_item) for _item in obj["tags"]] if obj.get("tags") is not None else None
        })
        return _obj
