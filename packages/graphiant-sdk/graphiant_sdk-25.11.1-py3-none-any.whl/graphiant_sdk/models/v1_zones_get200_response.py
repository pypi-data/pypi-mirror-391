...
class V1ZonesGet200Response(BaseModel):
    """
    V1ZonesGet200Response
    """ # noqa: E501
    page_info: Optional[V1NatEntriesDeviceIdGet200ResponsePageInfo] = Field(default=None, alias="pageInfo")
    zones: Optional[List[V1ZonesGet200ResponseZonesInner]] = None
    __properties: ClassVar[List[str]] = ["pageInfo", "zones"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "zones": [V1ZonesGet200ResponseZonesInner.from_dict(_item) for _item in obj["zones"]] if obj.get("zones") is not None else None
        })
        return _obj
