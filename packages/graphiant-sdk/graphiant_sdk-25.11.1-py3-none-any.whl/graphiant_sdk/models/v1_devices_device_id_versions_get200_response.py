...
class V1DevicesDeviceIdVersionsGet200Response(BaseModel):
    """
    V1DevicesDeviceIdVersionsGet200Response
    """ # noqa: E501
    versions: Optional[List[V1DevicesDeviceIdDraftGet200ResponseDraftVersionInfo]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "versions": [V1DevicesDeviceIdDraftGet200ResponseDraftVersionInfo.from_dict(_item) for _item in obj["versions"]] if obj.get("versions") is not None else None
        })
        return _obj
