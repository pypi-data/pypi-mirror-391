...
class V1DiagnosticPingPauseResumePost204Response(BaseModel):
    """
    V1DiagnosticPingPauseResumePost204Response
    """ # noqa: E501
    result: Optional[V1DiagnosticPingPauseResumePost204ResponseResult] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "result": V1DiagnosticPingPauseResumePost204ResponseResult.from_dict(obj["result"]) if obj.get("result") is not None else None,
            "token": obj.get("token")
        })
        return _obj
