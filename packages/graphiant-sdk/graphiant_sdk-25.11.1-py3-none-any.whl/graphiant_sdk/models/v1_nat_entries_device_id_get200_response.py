...
class V1NatEntriesDeviceIdGet200Response(BaseModel):
    """
    V1NatEntriesDeviceIdGet200Response
    """ # noqa: E501
    nat_entries: Optional[List[V1NatEntriesDeviceIdGet200ResponseNatEntriesInner]] = Field(default=None, alias="natEntries")
    ...
    __properties: ClassVar[List[str]] = ["natEntries", "pageInfo", "ts"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in nat_entries (list)
        _items = []
        if self.nat_entries:
            for _item_nat_entries in self.nat_entries:
                if _item_nat_entries:
                    _items.append(_item_nat_entries.to_dict())
            _dict['natEntries'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "natEntries": [V1NatEntriesDeviceIdGet200ResponseNatEntriesInner.from_dict(_item) for _item in obj["natEntries"]] if obj.get("natEntries") is not None else None,
