...
class V2ChildalertlistPost200ResponseAlertListInner(BaseModel):
    """
    ...
    children_alert_list: Optional[V2ChildalertlistPost200ResponseAlertListInnerChildrenAlertList] = Field(default=None, alias="childrenAlertList")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "childrenAlertList": V2ChildalertlistPost200ResponseAlertListInnerChildrenAlertList.from_dict(obj["childrenAlertList"]) if obj.get("childrenAlertList") is not None else None,
