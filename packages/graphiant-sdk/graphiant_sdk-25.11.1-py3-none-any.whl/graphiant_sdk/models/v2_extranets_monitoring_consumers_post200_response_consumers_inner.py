...
class V2ExtranetsMonitoringConsumersPost200ResponseConsumersInner(BaseModel):
    """
    V2ExtranetsMonitoringConsumersPost200ResponseConsumersInner
    """ # noqa: E501
    id: Optional[StrictInt] = None
    name: Optional[StrictStr] = None
    vrfs: Optional[List[StrictInt]] = None
    __properties: ClassVar[List[str]] = ["id", "name", "vrfs"]
