...
class V1DevicesDeviceIdConfigPutRequestCoreInterfacesValueInterfaceGwGwDhcp(BaseModel):
    """
    ...
    dhcp_relay: Optional[V1DevicesDeviceIdConfigPutRequestCoreInterfacesValueInterfaceGwGwDhcpDhcpRelay] = Field(default=None, alias="dhcpRelay")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "dhcpRelay": V1DevicesDeviceIdConfigPutRequestCoreInterfacesValueInterfaceGwGwDhcpDhcpRelay.from_dict(obj["dhcpRelay"]) if obj.get("dhcpRelay") is not None else None
        })
        return _obj
