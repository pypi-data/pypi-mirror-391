...
class V1DevicesDeviceIdCandidateCircuitsGet200Response(BaseModel):
    """
    V1DevicesDeviceIdCandidateCircuitsGet200Response
    """ # noqa: E501
    circuits: Optional[List[V1DevicesDeviceIdCandidateCircuitsGet200ResponseCircuitsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "circuits": [V1DevicesDeviceIdCandidateCircuitsGet200ResponseCircuitsInner.from_dict(_item) for _item in obj["circuits"]] if obj.get("circuits") is not None else None
        })
        return _obj
