...
class V2MonitoringIpsecPost200ResponseDataInner(BaseModel):
    """
    V2MonitoringIpsecPost200ResponseDataInner
    """ # noqa: E501
    samples: Optional[List[V2MonitoringBfdPost200ResponseDataInnerSamplesInner]] = None
    selector: Optional[V2MonitoringIpsecPostRequestSelectorsInner] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "selector": V2MonitoringIpsecPostRequestSelectorsInner.from_dict(obj["selector"]) if obj.get("selector") is not None else None
        })
        return _obj
