...
class V1MonitoringCircuitsVisualizationPost200Response(BaseModel):
    """
    V1MonitoringCircuitsVisualizationPost200Response
    """ # noqa: E501
    data: Optional[List[V1MonitoringCircuitsVisualizationPost200ResponseDataInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [V1MonitoringCircuitsVisualizationPost200ResponseDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
