...
class V1DiagnosticSpeedtestPost200Response(BaseModel):
    """
    V1DiagnosticSpeedtestPost200Response
    """ # noqa: E501
    result: Optional[V1DiagnosticSpeedtestPost200ResponseResult] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "result": V1DiagnosticSpeedtestPost200ResponseResult.from_dict(obj["result"]) if obj.get("result") is not None else None,
            "token": obj.get("token")
        })
        return _obj
