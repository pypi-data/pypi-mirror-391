...
class V1BwtrackerRegionSiteDetailsPost200ResponseBwusageDetailsBwuageProviderInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["providerId", "providerName", "usageKbps"]
