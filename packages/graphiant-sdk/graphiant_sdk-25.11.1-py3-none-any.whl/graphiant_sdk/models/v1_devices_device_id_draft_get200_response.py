...
class V1DevicesDeviceIdDraftGet200Response(BaseModel):
    """
    V1DevicesDeviceIdDraftGet200Response
    """ # noqa: E501
    draft: Optional[V1DevicesDeviceIdDraftGet200ResponseDraft] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "draft": V1DevicesDeviceIdDraftGet200ResponseDraft.from_dict(obj["draft"]) if obj.get("draft") is not None else None
        })
        return _obj
