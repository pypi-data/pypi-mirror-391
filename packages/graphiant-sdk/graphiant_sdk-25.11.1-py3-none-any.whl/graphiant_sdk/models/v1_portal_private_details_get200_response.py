...
class V1PortalPrivateDetailsGet200Response(BaseModel):
    """
    V1PortalPrivateDetailsGet200Response
    """ # noqa: E501
    details: Optional[List[V1PortalPrivatePostRequestDetails]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "details": [V1PortalPrivatePostRequestDetails.from_dict(_item) for _item in obj["details"]] if obj.get("details") is not None else None
        })
        return _obj
