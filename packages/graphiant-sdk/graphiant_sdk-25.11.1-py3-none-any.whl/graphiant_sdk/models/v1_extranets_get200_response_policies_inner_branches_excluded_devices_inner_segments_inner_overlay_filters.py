...
class V1ExtranetsGet200ResponsePoliciesInnerBranchesExcludedDevicesInnerSegmentsInnerOverlayFilters(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "inboundFilter": obj.get("inboundFilter"),
            "outboundFilter": obj.get("outboundFilter")
        })
        return _obj
