...
class V1ExtranetsGet200ResponsePoliciesInnerBranchesExcludedDevicesInnerInterfacesInnerLagInterfaceLacpConfig(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["mode", "timer"]
