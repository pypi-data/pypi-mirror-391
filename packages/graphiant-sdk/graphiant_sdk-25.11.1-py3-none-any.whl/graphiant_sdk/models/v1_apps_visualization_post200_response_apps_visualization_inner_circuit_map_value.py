...
class V1AppsVisualizationPost200ResponseAppsVisualizationInnerCircuitMapValue(BaseModel):
    """
    ...
    stats: Optional[V1AppsVisualizationPost200ResponseAppsVisualizationInnerCircuitMapValueStats] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "stats": V1AppsVisualizationPost200ResponseAppsVisualizationInnerCircuitMapValueStats.from_dict(obj["stats"]) if obj.get("stats") is not None else None,
            "usage": obj.get("usage"),
            "usagePct": obj.get("usagePct")
        })
        return _obj
