...
class V1GlobalSiteListsIdSitesGet200Response(BaseModel):
    """
    V1GlobalSiteListsIdSitesGet200Response
    """ # noqa: E501
    entries: Optional[List[V1GlobalSiteListsIdSitesGet200ResponseEntriesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entries": [V1GlobalSiteListsIdSitesGet200ResponseEntriesInner.from_dict(_item) for _item in obj["entries"]] if obj.get("entries") is not None else None
        })
        return _obj
