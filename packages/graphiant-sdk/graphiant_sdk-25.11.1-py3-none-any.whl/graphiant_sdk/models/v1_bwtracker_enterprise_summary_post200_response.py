...
class V1BwtrackerEnterpriseSummaryPost200Response(BaseModel):
    """
    V1BwtrackerEnterpriseSummaryPost200Response
    """ # noqa: E501
    bwusage_summary: Optional[V1BwtrackerEnterpriseSummaryPost200ResponseBwusageSummary] = Field(default=None, alias="bwusageSummary")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "bwusageSummary": V1BwtrackerEnterpriseSummaryPost200ResponseBwusageSummary.from_dict(obj["bwusageSummary"]) if obj.get("bwusageSummary") is not None else None
        })
        return _obj
