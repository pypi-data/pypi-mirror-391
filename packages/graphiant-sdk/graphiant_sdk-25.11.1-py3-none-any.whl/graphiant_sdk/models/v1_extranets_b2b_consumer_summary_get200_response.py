...
class V1ExtranetsB2bConsumerSummaryGet200Response(BaseModel):
    """
    V1ExtranetsB2bConsumerSummaryGet200Response
    """ # noqa: E501
    summary: Optional[List[V1ExtranetsB2bConsumerSummaryGet200ResponseSummaryInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "summary": [V1ExtranetsB2bConsumerSummaryGet200ResponseSummaryInner.from_dict(_item) for _item in obj["summary"]] if obj.get("summary") is not None else None
        })
        return _obj
