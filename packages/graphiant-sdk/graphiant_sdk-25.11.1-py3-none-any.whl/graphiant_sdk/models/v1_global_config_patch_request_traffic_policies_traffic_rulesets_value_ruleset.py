...
class V1GlobalConfigPatchRequestTrafficPoliciesTrafficRulesetsValueRuleset(BaseModel):
    """
    ...
    rules: Optional[Dict[str, V1GlobalConfigPatchRequestTrafficPoliciesTrafficRulesetsValueRulesetRulesValue]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "rules": dict(
                (_k, V1GlobalConfigPatchRequestTrafficPoliciesTrafficRulesetsValueRulesetRulesValue.from_dict(_v))
