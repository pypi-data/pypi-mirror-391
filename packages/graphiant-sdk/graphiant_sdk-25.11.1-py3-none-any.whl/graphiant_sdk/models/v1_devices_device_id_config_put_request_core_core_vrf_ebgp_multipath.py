...
class V1DevicesDeviceIdConfigPutRequestCoreCoreVrfEbgpMultipath(BaseModel):
    """
    V1DevicesDeviceIdConfigPutRequestCoreCoreVrfEbgpMultipath
    """ # noqa: E501
    config: Optional[V1ExtranetsGet200ResponsePoliciesInnerBranchesExcludedDevicesInnerCircuitsInnerBgpMultipath] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "config": V1ExtranetsGet200ResponsePoliciesInnerBranchesExcludedDevicesInnerCircuitsInnerBgpMultipath.from_dict(obj["config"]) if obj.get("config") is not None else None
        })
        return _obj
