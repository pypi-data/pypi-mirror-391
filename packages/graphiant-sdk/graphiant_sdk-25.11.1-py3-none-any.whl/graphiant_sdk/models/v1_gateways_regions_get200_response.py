...
class V1GatewaysRegionsGet200Response(BaseModel):
    """
    V1GatewaysRegionsGet200Response
    """ # noqa: E501
    regions: Optional[List[V1ExtranetsGet200ResponsePoliciesInnerBranchesExcludedDevicesInnerRegion]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "regions": [V1ExtranetsGet200ResponsePoliciesInnerBranchesExcludedDevicesInnerRegion.from_dict(_item) for _item in obj["regions"]] if obj.get("regions") is not None else None
        })
        return _obj
