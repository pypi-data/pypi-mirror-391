...
class V2AssuranceBucketAppServersAllGet200ResponseAppServerChangesInnerAddedServersInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["serverIp", "serverPort", "serverProtocol"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "serverProtocol": obj.get("serverProtocol")
        })
        return _obj
