...
class V1GlobalConfigPatchRequestGlobalPrefixSetsValue(BaseModel):
    """
    V1GlobalConfigPatchRequestGlobalPrefixSetsValue
    """ # noqa: E501
    prefix_set: Optional[V1GlobalConfigPatchRequestGlobalPrefixSetsValuePrefixSet] = Field(default=None, alias="prefixSet")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "prefixSet": V1GlobalConfigPatchRequestGlobalPrefixSetsValuePrefixSet.from_dict(obj["prefixSet"]) if obj.get("prefixSet") is not None else None
        })
        return _obj
