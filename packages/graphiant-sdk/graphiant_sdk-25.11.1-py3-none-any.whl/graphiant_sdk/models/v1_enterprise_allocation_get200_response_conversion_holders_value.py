...
class V1EnterpriseAllocationGet200ResponseConversionHoldersValue(BaseModel):
    """
    V1EnterpriseAllocationGet200ResponseConversionHoldersValue
    """ # noqa: E501
    bins: Optional[List[V1EnterpriseAllocationGet200ResponseConversionHoldersValueBinsInner]] = None
    __properties: ClassVar[List[str]] = ["bins"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "bins": [V1EnterpriseAllocationGet200ResponseConversionHoldersValueBinsInner.from_dict(_item) for _item in obj["bins"]] if obj.get("bins") is not None else None
        })
        return _obj
