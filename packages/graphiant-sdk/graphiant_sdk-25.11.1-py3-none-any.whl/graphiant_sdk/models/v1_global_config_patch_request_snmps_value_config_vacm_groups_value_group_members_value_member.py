...
class V1GlobalConfigPatchRequestSnmpsValueConfigVacmGroupsValueGroupMembersValueMember(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["community", "securityModel", "securityName", "type"]
