...
class V1GlobalConfigSitePostRequestIpfixExporterOpsV2Value(BaseModel):
    """
    V1GlobalConfigSitePostRequestIpfixExporterOpsV2Value
    """ # noqa: E501
    interface: Optional[V1GlobalConfigPatchRequestRoutingPoliciesValuePolicyStatementsValueStatementMatchesValueMatchSourceInterface] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "interface": V1GlobalConfigPatchRequestRoutingPoliciesValuePolicyStatementsValueStatementMatchesValueMatchSourceInterface.from_dict(obj["interface"]) if obj.get("interface") is not None else None,
