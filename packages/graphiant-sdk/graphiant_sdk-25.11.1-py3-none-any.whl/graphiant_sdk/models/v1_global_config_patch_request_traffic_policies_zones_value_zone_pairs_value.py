...
class V1GlobalConfigPatchRequestTrafficPoliciesZonesValueZonePairsValue(BaseModel):
    """
    V1GlobalConfigPatchRequestTrafficPoliciesZonesValueZonePairsValue
    """ # noqa: E501
    pair: Optional[V1GlobalConfigPatchRequestTrafficPoliciesZonesValueZonePairsValuePair] = None
    __properties: ClassVar[List[str]] = ["pair"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of pair
        if self.pair:
            _dict['pair'] = self.pair.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "pair": V1GlobalConfigPatchRequestTrafficPoliciesZonesValueZonePairsValuePair.from_dict(obj["pair"]) if obj.get("pair") is not None else None
        })
        return _obj
