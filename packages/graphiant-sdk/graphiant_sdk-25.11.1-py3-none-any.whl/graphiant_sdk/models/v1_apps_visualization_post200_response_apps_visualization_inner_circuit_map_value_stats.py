...
class V1AppsVisualizationPost200ResponseAppsVisualizationInnerCircuitMapValueStats(BaseModel):
    """
    V1AppsVisualizationPost200ResponseAppsVisualizationInnerCircuitMapValueStats
    """ # noqa: E501
    health_avg: Optional[StrictStr] = Field(default=None, alias="healthAvg")
