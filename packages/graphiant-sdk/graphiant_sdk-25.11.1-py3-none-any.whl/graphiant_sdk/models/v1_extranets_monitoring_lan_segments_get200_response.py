...
class V1ExtranetsMonitoringLanSegmentsGet200Response(BaseModel):
    """
    V1ExtranetsMonitoringLanSegmentsGet200Response
    """ # noqa: E501
    vrfs: Optional[List[V1ExtranetsMonitoringLanSegmentsGet200ResponseVrfsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "vrfs": [V1ExtranetsMonitoringLanSegmentsGet200ResponseVrfsInner.from_dict(_item) for _item in obj["vrfs"]] if obj.get("vrfs") is not None else None
        })
        return _obj
