...
class V1GlobalConfigPatchRequestRoutingPoliciesValue(BaseModel):
    """
    V1GlobalConfigPatchRequestRoutingPoliciesValue
    """ # noqa: E501
    policy: Optional[V1GlobalConfigPatchRequestRoutingPoliciesValuePolicy] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "policy": V1GlobalConfigPatchRequestRoutingPoliciesValuePolicy.from_dict(obj["policy"]) if obj.get("policy") is not None else None
        })
        return _obj
