...
class V2AssuranceTopologyClientSessionDetailsPost200Response(BaseModel):
    """
    V2AssuranceTopologyClientSessionDetailsPost200Response
    """ # noqa: E501
    session: Optional[V2AssuranceTopologyClientSessionDetailsPost200ResponseSession] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "session": V2AssuranceTopologyClientSessionDetailsPost200ResponseSession.from_dict(obj["session"]) if obj.get("session") is not None else None
        })
        return _obj
