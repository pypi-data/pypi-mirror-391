...
class V1GlobalAppsAppListOptionsGet200Response(BaseModel):
    """
    V1GlobalAppsAppListOptionsGet200Response
    """ # noqa: E501
    apps: Optional[List[V1GlobalAppsAppListsGet200ResponseEntriesInnerAppList]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "apps": [V1GlobalAppsAppListsGet200ResponseEntriesInnerAppList.from_dict(_item) for _item in obj["apps"]] if obj.get("apps") is not None else None
        })
        return _obj
