...
class V1DiagnosticPacketcapturePcapIdGet200Response(BaseModel):
    """
    ...
    upload_progress: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, alias="uploadProgress")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "uploadProgress": obj.get("uploadProgress"),
            "url": obj.get("url")
        })
        return _obj
