...
class V1GlobalConfigPatchRequestSnmpsValueConfigVacmGroupsValue(BaseModel):
    """
    V1GlobalConfigPatchRequestSnmpsValueConfigVacmGroupsValue
    """ # noqa: E501
    group: Optional[V1GlobalConfigPatchRequestSnmpsValueConfigVacmGroupsValueGroup] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "group": V1GlobalConfigPatchRequestSnmpsValueConfigVacmGroupsValueGroup.from_dict(obj["group"]) if obj.get("group") is not None else None
        })
        return _obj
