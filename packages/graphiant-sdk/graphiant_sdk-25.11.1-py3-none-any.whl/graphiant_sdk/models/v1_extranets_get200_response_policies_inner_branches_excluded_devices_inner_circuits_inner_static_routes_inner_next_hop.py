...
class V1ExtranetsGet200ResponsePoliciesInnerBranchesExcludedDevicesInnerCircuitsInnerStaticRoutesInnerNextHop(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "nextHopAddress": obj.get("nextHopAddress"),
            "nexthop": obj.get("nexthop"),
            "outgoingInterface": obj.get("outgoingInterface"),
            "thirdPartyIpsecTunnel": obj.get("thirdPartyIpsecTunnel")
        })
        return _obj
