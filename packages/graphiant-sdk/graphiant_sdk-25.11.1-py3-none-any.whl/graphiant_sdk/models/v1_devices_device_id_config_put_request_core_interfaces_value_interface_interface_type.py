...
class V1DevicesDeviceIdConfigPutRequestCoreInterfacesValueInterfaceInterfaceType(BaseModel):
    """
    ...
    wan: Optional[V1DevicesDeviceIdConfigPutRequestCoreInterfacesValueInterfaceInterfaceTypeWan] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "wan": V1DevicesDeviceIdConfigPutRequestCoreInterfacesValueInterfaceInterfaceTypeWan.from_dict(obj["wan"]) if obj.get("wan") is not None else None,
