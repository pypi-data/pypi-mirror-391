...
class V2AssuranceTopologyOverviewPost200ResponseTopologyNodesInner(BaseModel):
    """
    V2AssuranceTopologyOverviewPost200ResponseTopologyNodesInner
    """ # noqa: E501
    active: Optional[StrictBool] = None
    location: Optional[V2AssuranceTopologyOverviewPost200ResponseTopologyNodesInnerLocation] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "location": V2AssuranceTopologyOverviewPost200ResponseTopologyNodesInnerLocation.from_dict(obj["location"]) if obj.get("location") is not None else None,
            "name": obj.get("name"),
