...
class V1AlarmHistoryGet200ResponseHistoryInner(BaseModel):
    """
    ...
    time: Optional[V1AlarmHistoryGet200ResponseHistoryInnerTime] = None
    __properties: ClassVar[List[str]] = ["bootId", "description", "isCleared", "perceivedSeverity", "sequenceNumber", "time"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "time": V1AlarmHistoryGet200ResponseHistoryInnerTime.from_dict(obj["time"]) if obj.get("time") is not None else None
        })
        return _obj
