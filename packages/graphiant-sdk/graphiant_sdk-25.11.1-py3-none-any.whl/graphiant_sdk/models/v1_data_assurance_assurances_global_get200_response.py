...
class V1DataAssuranceAssurancesGlobalGet200Response(BaseModel):
    """
    V1DataAssuranceAssurancesGlobalGet200Response
    """ # noqa: E501
    rows: Optional[List[V1DataAssuranceAssurancesGlobalGet200ResponseRowsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "rows": [V1DataAssuranceAssurancesGlobalGet200ResponseRowsInner.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
        return _obj
