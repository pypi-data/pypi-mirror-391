...
class V1DeviceRoutingOspfv2AreaInterfaceGet200Response(BaseModel):
    """
    V1DeviceRoutingOspfv2AreaInterfaceGet200Response
    """ # noqa: E501
    interfaces: Optional[List[V1DeviceRoutingOspfv2AreaInterfaceGet200ResponseInterfacesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "interfaces": [V1DeviceRoutingOspfv2AreaInterfaceGet200ResponseInterfacesInner.from_dict(_item) for _item in obj["interfaces"]] if obj.get("interfaces") is not None else None,
