...
class V1GlobalConfigPatchRequestPrefixSetsValueTargetPrefixSet(BaseModel):
    """
    V1GlobalConfigPatchRequestPrefixSetsValueTargetPrefixSet
    """ # noqa: E501
    description: Optional[StrictStr] = None
    entries: Optional[List[V1GlobalConfigPatchRequestGlobalPrefixSetsValuePrefixSetEntriesValueEntry]] = None
    mode: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["description", "entries", "mode"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "entries": [V1GlobalConfigPatchRequestGlobalPrefixSetsValuePrefixSetEntriesValueEntry.from_dict(_item) for _item in obj["entries"]] if obj.get("entries") is not None else None,
            "mode": obj.get("mode")
        })
        return _obj
