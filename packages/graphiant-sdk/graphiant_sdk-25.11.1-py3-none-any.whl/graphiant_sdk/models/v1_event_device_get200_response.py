...
class V1EventDeviceGet200Response(BaseModel):
    """
    V1EventDeviceGet200Response
    """ # noqa: E501
    events: Optional[List[V1EventDeviceGet200ResponseEventsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "events": [V1EventDeviceGet200ResponseEventsInner.from_dict(_item) for _item in obj["events"]] if obj.get("events") is not None else None
        })
        return _obj
