...
class V1GlobalConfigPatchRequestTrafficPoliciesTrafficRulesetsValueRulesetRulesValue(BaseModel):
    """
    V1GlobalConfigPatchRequestTrafficPoliciesTrafficRulesetsValueRulesetRulesValue
    """ # noqa: E501
    rule: Optional[V1GlobalConfigPatchRequestTrafficPoliciesTrafficRulesetsValueRulesetRulesValueRule] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "rule": V1GlobalConfigPatchRequestTrafficPoliciesTrafficRulesetsValueRulesetRulesValueRule.from_dict(obj["rule"]) if obj.get("rule") is not None else None
        })
        return _obj
