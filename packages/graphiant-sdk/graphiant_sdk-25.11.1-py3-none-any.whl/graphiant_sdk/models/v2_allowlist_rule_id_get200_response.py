...
class V2AllowlistRuleIdGet200Response(BaseModel):
    """
    V2AllowlistRuleIdGet200Response
    """ # noqa: E501
    records: Optional[List[V2AllowlistRuleIdGet200ResponseRecordsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "records": [V2AllowlistRuleIdGet200ResponseRecordsInner.from_dict(_item) for _item in obj["records"]] if obj.get("records") is not None else None
        })
        return _obj
