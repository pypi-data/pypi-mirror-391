...
class V2AuditLogsPost200Response(BaseModel):
    """
    V2AuditLogsPost200Response
    """ # noqa: E501
    cursor_ref: Optional[StrictStr] = Field(default=None, alias="cursorRef")
    logs: Optional[List[V2AuditLogsPost200ResponseLogsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "logs": [V2AuditLogsPost200ResponseLogsInner.from_dict(_item) for _item in obj["logs"]] if obj.get("logs") is not None else None,
