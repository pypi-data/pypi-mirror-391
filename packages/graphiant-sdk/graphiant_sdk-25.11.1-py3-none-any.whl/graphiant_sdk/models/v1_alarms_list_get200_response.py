...
class V1AlarmsListGet200Response(BaseModel):
    """
    V1AlarmsListGet200Response
    """ # noqa: E501
    alarms: Optional[List[V1AlarmsListGet200ResponseAlarmsInner]] = None
    __properties: ClassVar[List[str]] = ["alarms"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "alarms": [V1AlarmsListGet200ResponseAlarmsInner.from_dict(_item) for _item in obj["alarms"]] if obj.get("alarms") is not None else None
        })
        return _obj
