...
class V2IntegrationPost200Response(BaseModel):
    """
    V2IntegrationPost200Response
    """ # noqa: E501
    integration: Optional[V2IntegrationPost200ResponseIntegration] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "integration": V2IntegrationPost200ResponseIntegration.from_dict(obj["integration"]) if obj.get("integration") is not None else None
        })
        return _obj
