...
class V1MonitoringCircuitsVisualizationPost200ResponseDataInner(BaseModel):
    """
    ...
    selector: Optional[V1MonitoringCircuitsVisualizationPostRequestSelectorsInner] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "selector": V1MonitoringCircuitsVisualizationPostRequestSelectorsInner.from_dict(obj["selector"]) if obj.get("selector") is not None else None
        })
        return _obj
