...
class V1ExtranetsGet200ResponsePoliciesInnerBranchesExcludedDevicesInnerRoutingPoliciesInnerStatementsInner(BaseModel):
    """
    V1ExtranetsGet200ResponsePoliciesInnerBranchesExcludedDevicesInnerRoutingPoliciesInnerStatementsInner
    """ # noqa: E501
    actions: Optional[List[V1ExtranetsGet200ResponsePoliciesInnerBranchesExcludedDevicesInnerRoutingPoliciesInnerStatementsInnerActionsInner]] = None
    id: Optional[StrictInt] = None
    matches: Optional[List[V1ExtranetsGet200ResponsePoliciesInnerBranchesExcludedDevicesInnerRoutingPoliciesInnerStatementsInnerMatchesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "actions": [V1ExtranetsGet200ResponsePoliciesInnerBranchesExcludedDevicesInnerRoutingPoliciesInnerStatementsInnerActionsInner.from_dict(_item) for _item in obj["actions"]] if obj.get("actions") is not None else None,
            "id": obj.get("id"),
            "matches": [V1ExtranetsGet200ResponsePoliciesInnerBranchesExcludedDevicesInnerRoutingPoliciesInnerStatementsInnerMatchesInner.from_dict(_item) for _item in obj["matches"]] if obj.get("matches") is not None else None,
            "seq": obj.get("seq")
        })
        return _obj
