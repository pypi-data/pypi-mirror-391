...
class V1ExtranetsGet200ResponsePoliciesInnerBranchesExcludedDevicesInnerTrafficPolicySecurityRulesetsInnerRulesInner(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "downlinkBurstRate": obj.get("downlinkBurstRate"),
            "downlinkPolicerRate": obj.get("downlinkPolicerRate"),
            "id": obj.get("id"),
            "index": obj.get("index"),
            ...
            "name": obj.get("name"),
            "seq": obj.get("seq"),
            "uplinkBurstRate": obj.get("uplinkBurstRate"),
            "uplinkPolicerRate": obj.get("uplinkPolicerRate")
        })
        return _obj
