...
class V1PolicyApplicationsGet200Response(BaseModel):
    """
    V1PolicyApplicationsGet200Response
    """ # noqa: E501
    applications: Optional[List[V1PolicyApplicationsGet200ResponseApplicationsInner]] = None
    page_info: Optional[V1NatEntriesDeviceIdGet200ResponsePageInfo] = Field(default=None, alias="pageInfo")
    __properties: ClassVar[List[str]] = ["applications", "pageInfo"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "applications": [V1PolicyApplicationsGet200ResponseApplicationsInner.from_dict(_item) for _item in obj["applications"]] if obj.get("applications") is not None else None,
