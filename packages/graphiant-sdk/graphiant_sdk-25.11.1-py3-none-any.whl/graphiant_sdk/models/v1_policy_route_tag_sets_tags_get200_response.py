...
class V1PolicyRouteTagSetsTagsGet200Response(BaseModel):
    """
    V1PolicyRouteTagSetsTagsGet200Response
    """ # noqa: E501
    tags: Optional[List[V1PolicyRouteTagSetsTagsGet200ResponseTagsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tags": [V1PolicyRouteTagSetsTagsGet200ResponseTagsInner.from_dict(_item) for _item in obj["tags"]] if obj.get("tags") is not None else None
        })
        return _obj
