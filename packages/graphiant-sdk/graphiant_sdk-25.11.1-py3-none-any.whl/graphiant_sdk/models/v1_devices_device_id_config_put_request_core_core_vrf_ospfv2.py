...
class V1DevicesDeviceIdConfigPutRequestCoreCoreVrfOspfv2(BaseModel):
    """
    V1DevicesDeviceIdConfigPutRequestCoreCoreVrfOspfv2
    """ # noqa: E501
    process: Optional[V1DevicesDeviceIdConfigPutRequestCoreCoreVrfOspfv2Process] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "process": V1DevicesDeviceIdConfigPutRequestCoreCoreVrfOspfv2Process.from_dict(obj["process"]) if obj.get("process") is not None else None
        })
        return _obj
