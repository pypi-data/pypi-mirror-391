...
class V1GlobalConfigPatchRequestIpfixExportersValue(BaseModel):
    """
    V1GlobalConfigPatchRequestIpfixExportersValue
    """ # noqa: E501
    exporter: Optional[V1GlobalConfigPatchRequestIpfixExportersValueExporter] = None
    __properties: ClassVar[List[str]] = ["exporter"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "exporter": V1GlobalConfigPatchRequestIpfixExportersValueExporter.from_dict(obj["exporter"]) if obj.get("exporter") is not None else None
        })
        return _obj
