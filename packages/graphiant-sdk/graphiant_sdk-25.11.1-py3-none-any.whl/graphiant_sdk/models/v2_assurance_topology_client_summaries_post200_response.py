...
class V2AssuranceTopologyClientSummariesPost200Response(BaseModel):
    """
    V2AssuranceTopologyClientSummariesPost200Response
    """ # noqa: E501
    summaries: Optional[List[V2AssuranceTopologyClientSummariesPost200ResponseSummariesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "summaries": [V2AssuranceTopologyClientSummariesPost200ResponseSummariesInner.from_dict(_item) for _item in obj["summaries"]] if obj.get("summaries") is not None else None
        })
        return _obj
