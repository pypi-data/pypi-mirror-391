...
class V1EnterprisesManagedGet200Response(BaseModel):
    """
    V1EnterprisesManagedGet200Response
    """ # noqa: E501
    counts: Optional[V1EnterprisesGet200ResponseEnterprisesInnerCounts] = None
    enterprises: Optional[List[V1EnterprisesGet200ResponseEnterprisesInner]] = None
    __properties: ClassVar[List[str]] = ["counts", "enterprises"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "enterprises": [V1EnterprisesGet200ResponseEnterprisesInner.from_dict(_item) for _item in obj["enterprises"]] if obj.get("enterprises") is not None else None
        })
        return _obj
