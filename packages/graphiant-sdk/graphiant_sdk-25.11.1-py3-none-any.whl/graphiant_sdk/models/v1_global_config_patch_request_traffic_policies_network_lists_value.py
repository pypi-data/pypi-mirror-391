...
class V1GlobalConfigPatchRequestTrafficPoliciesNetworkListsValue(BaseModel):
    """
    V1GlobalConfigPatchRequestTrafficPoliciesNetworkListsValue
    """ # noqa: E501
    list: Optional[V1GlobalConfigPatchRequestTrafficPoliciesDpiApplicationsValueApplicationDestinationNetworks] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "list": V1GlobalConfigPatchRequestTrafficPoliciesDpiApplicationsValueApplicationDestinationNetworks.from_dict(obj["list"]) if obj.get("list") is not None else None
        })
        return _obj
