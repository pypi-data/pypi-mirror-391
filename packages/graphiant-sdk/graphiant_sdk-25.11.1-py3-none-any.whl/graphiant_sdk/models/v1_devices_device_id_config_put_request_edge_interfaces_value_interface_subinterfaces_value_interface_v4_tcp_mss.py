...
class V1DevicesDeviceIdConfigPutRequestEdgeInterfacesValueInterfaceSubinterfacesValueInterfaceV4TcpMss(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["tcpMssV4"]
