...
class V1DiagnosticClearArpDeviceIdPutRequestEntryInner(BaseModel):
    """
    V1DiagnosticClearArpDeviceIdPutRequestEntryInner
    """ # noqa: E501
    address: Optional[V1DiagnosticClearArpDeviceIdPutRequestEntryInnerAddress] = None
    all_entry: Optional[StrictBool] = Field(default=None, alias="allEntry")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "address": V1DiagnosticClearArpDeviceIdPutRequestEntryInnerAddress.from_dict(obj["address"]) if obj.get("address") is not None else None,
            "allEntry": obj.get("allEntry"),
