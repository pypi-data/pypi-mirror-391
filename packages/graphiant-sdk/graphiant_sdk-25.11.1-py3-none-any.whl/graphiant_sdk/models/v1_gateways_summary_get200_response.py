...
class V1GatewaysSummaryGet200Response(BaseModel):
    """
    V1GatewaysSummaryGet200Response
    """ # noqa: E501
    summaries: Optional[List[V1GatewaysSummaryGet200ResponseSummariesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "summaries": [V1GatewaysSummaryGet200ResponseSummariesInner.from_dict(_item) for _item in obj["summaries"]] if obj.get("summaries") is not None else None
        })
        return _obj
