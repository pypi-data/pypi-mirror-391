...
class V1GatewaysPutRequestDetailsIpsecGatewayRoutingBgpAddressFamiliesValue(BaseModel):
    """
    V1GatewaysPutRequestDetailsIpsecGatewayRoutingBgpAddressFamiliesValue
    """ # noqa: E501
    family: Optional[V1GatewaysPutRequestDetailsIpsecGatewayRoutingBgpAddressFamiliesValueFamily] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "family": V1GatewaysPutRequestDetailsIpsecGatewayRoutingBgpAddressFamiliesValueFamily.from_dict(obj["family"]) if obj.get("family") is not None else None
        })
        return _obj
