...
class V1DevicesDeviceIdConfigPutRequestEdgeNatPolicyNatRulesetsValue(BaseModel):
    """
    V1DevicesDeviceIdConfigPutRequestEdgeNatPolicyNatRulesetsValue
    """ # noqa: E501
    ruleset: Optional[V1DevicesDeviceIdConfigPutRequestEdgeNatPolicyNatRulesetsValueRuleset] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ruleset": V1DevicesDeviceIdConfigPutRequestEdgeNatPolicyNatRulesetsValueRuleset.from_dict(obj["ruleset"]) if obj.get("ruleset") is not None else None
        })
        return _obj
