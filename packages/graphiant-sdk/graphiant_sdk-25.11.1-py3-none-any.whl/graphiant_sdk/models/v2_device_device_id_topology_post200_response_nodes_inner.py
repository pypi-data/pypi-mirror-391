...
class V2DeviceDeviceIdTopologyPost200ResponseNodesInner(BaseModel):
    """
    V2DeviceDeviceIdTopologyPost200ResponseNodesInner
    """ # noqa: E501
    circuit_info: Optional[List[V2DeviceDeviceIdTopologyPost200ResponseNodesInnerCircuitInfoInner]] = Field(default=None, alias="circuitInfo")
    ...
    node_info: Optional[V2DeviceDeviceIdTopologyPost200ResponseNodesInnerNodeInfo] = Field(default=None, alias="nodeInfo")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "circuitInfo": [V2DeviceDeviceIdTopologyPost200ResponseNodesInnerCircuitInfoInner.from_dict(_item) for _item in obj["circuitInfo"]] if obj.get("circuitInfo") is not None else None,
            ...
            "id": obj.get("id"),
            "name": obj.get("name"),
            "nodeInfo": V2DeviceDeviceIdTopologyPost200ResponseNodesInnerNodeInfo.from_dict(obj["nodeInfo"]) if obj.get("nodeInfo") is not None else None,
