...
class V1BwtrackerRegionCloudSummaryPost200ResponseBwusageSummaryBwusageTopProvidersInner(BaseModel):
    """
    V1BwtrackerRegionCloudSummaryPost200ResponseBwusageSummaryBwusageTopProvidersInner
    """ # noqa: E501
    capacity_kbps: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="capacityKbps")
    ...
    __properties: ClassVar[List[str]] = ["capacityKbps", "providerId", "providerName", "usageKbps"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "capacityKbps": obj.get("capacityKbps"),
