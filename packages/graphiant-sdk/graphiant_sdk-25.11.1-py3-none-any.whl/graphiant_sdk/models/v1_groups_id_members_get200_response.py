...
class V1GroupsIdMembersGet200Response(BaseModel):
    """
    V1GroupsIdMembersGet200Response
    """ # noqa: E501
    users: Optional[List[V1GroupsIdMembersGet200ResponseUsersInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "users": [V1GroupsIdMembersGet200ResponseUsersInner.from_dict(_item) for _item in obj["users"]] if obj.get("users") is not None else None
        })
        return _obj
