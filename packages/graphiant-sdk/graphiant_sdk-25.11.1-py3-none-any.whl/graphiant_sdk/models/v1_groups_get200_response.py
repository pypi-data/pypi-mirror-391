...
class V1GroupsGet200Response(BaseModel):
    """
    V1GroupsGet200Response
    """ # noqa: E501
    groups: Optional[List[V1GroupsGet200ResponseGroupsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "groups": [V1GroupsGet200ResponseGroupsInner.from_dict(_item) for _item in obj["groups"]] if obj.get("groups") is not None else None
        })
        return _obj
