...
class V1DataAssuranceAssurancesGlobalIdPut200Response(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["unsyncedDeviceNames"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "unsyncedDeviceNames": obj.get("unsyncedDeviceNames")
        })
        return _obj
