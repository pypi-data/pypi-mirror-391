...
class V1AppsAppSummaryPost200ResponseAppSummaryCircuitsIncidentsv2Inner(BaseModel):
    """
    V1AppsAppSummaryPost200ResponseAppSummaryCircuitsIncidentsv2Inner
    """ # noqa: E501
    data: Optional[V1AppsAppSummaryPost200ResponseAppSummaryCircuitsIncidentsv2InnerData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": V1AppsAppSummaryPost200ResponseAppSummaryCircuitsIncidentsv2InnerData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
