...
class V1DevicesDeviceIdConfigPutRequestCoreInterfacesValueInterfaceFlexAlgos(BaseModel):
    """
    V1DevicesDeviceIdConfigPutRequestCoreInterfacesValueInterfaceFlexAlgos
    """ # noqa: E501
    flex_algo_names: Optional[List[StrictStr]] = Field(default=None, alias="flexAlgoNames")
    __properties: ClassVar[List[str]] = ["flexAlgoNames"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "flexAlgoNames": obj.get("flexAlgoNames")
        })
        return _obj
