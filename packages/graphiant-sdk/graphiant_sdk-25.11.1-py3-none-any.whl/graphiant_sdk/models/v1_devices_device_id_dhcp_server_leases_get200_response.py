...
class V1DevicesDeviceIdDhcpServerLeasesGet200Response(BaseModel):
    """
    V1DevicesDeviceIdDhcpServerLeasesGet200Response
    """ # noqa: E501
    pools: Optional[List[V1ExtranetsGet200ResponsePoliciesInnerBranchesExcludedDevicesInnerSegmentsInnerDhcpSubnetsInner]] = None
    __properties: ClassVar[List[str]] = ["pools"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "pools": [V1ExtranetsGet200ResponsePoliciesInnerBranchesExcludedDevicesInnerSegmentsInnerDhcpSubnetsInner.from_dict(_item) for _item in obj["pools"]] if obj.get("pools") is not None else None
        })
        return _obj
