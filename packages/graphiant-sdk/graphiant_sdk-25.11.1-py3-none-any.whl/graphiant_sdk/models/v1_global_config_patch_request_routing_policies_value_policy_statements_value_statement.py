...
class V1GlobalConfigPatchRequestRoutingPoliciesValuePolicyStatementsValueStatement(BaseModel):
    """
    V1GlobalConfigPatchRequestRoutingPoliciesValuePolicyStatementsValueStatement
    """ # noqa: E501
    actions: Optional[Dict[str, V1GlobalConfigPatchRequestRoutingPoliciesValuePolicyStatementsValueStatementActionsValue]] = None
    matches: Optional[Dict[str, V1GlobalConfigPatchRequestRoutingPoliciesValuePolicyStatementsValueStatementMatchesValue]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "actions": dict(
                (_k, V1GlobalConfigPatchRequestRoutingPoliciesValuePolicyStatementsValueStatementActionsValue.from_dict(_v))
                for _k, _v in obj["actions"].items()
            )
            if obj.get("actions") is not None
            else None,
            "matches": dict(
                (_k, V1GlobalConfigPatchRequestRoutingPoliciesValuePolicyStatementsValueStatementMatchesValue.from_dict(_v))
