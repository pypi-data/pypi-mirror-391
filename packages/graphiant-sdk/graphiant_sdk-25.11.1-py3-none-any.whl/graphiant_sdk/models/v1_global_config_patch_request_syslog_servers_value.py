...
class V1GlobalConfigPatchRequestSyslogServersValue(BaseModel):
    """
    V1GlobalConfigPatchRequestSyslogServersValue
    """ # noqa: E501
    target: Optional[V1GlobalConfigPatchRequestSyslogServersValueTarget] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "target": V1GlobalConfigPatchRequestSyslogServersValueTarget.from_dict(obj["target"]) if obj.get("target") is not None else None
        })
        return _obj
