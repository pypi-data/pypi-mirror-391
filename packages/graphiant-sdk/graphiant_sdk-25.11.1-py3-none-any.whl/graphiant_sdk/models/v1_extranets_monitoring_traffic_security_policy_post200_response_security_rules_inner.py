...
class V1ExtranetsMonitoringTrafficSecurityPolicyPost200ResponseSecurityRulesInner(BaseModel):
    """
    V1ExtranetsMonitoringTrafficSecurityPolicyPost200ResponseSecurityRulesInner
    """ # noqa: E501
    device: Optional[V1ExtranetsGet200ResponsePoliciesInnerBranchesExcludedDevicesInnerSiteDevicesInner] = None
    security_policy_rule: Optional[V1ExtranetsB2bConsumerPost200ResponsePolicyInnerInboundSecurityRulesInner] = Field(default=None, alias="securityPolicyRule")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of security_policy_rule
        if self.security_policy_rule:
            _dict['securityPolicyRule'] = self.security_policy_rule.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "device": V1ExtranetsGet200ResponsePoliciesInnerBranchesExcludedDevicesInnerSiteDevicesInner.from_dict(obj["device"]) if obj.get("device") is not None else None,
            "securityPolicyRule": V1ExtranetsB2bConsumerPost200ResponsePolicyInnerInboundSecurityRulesInner.from_dict(obj["securityPolicyRule"]) if obj.get("securityPolicyRule") is not None else None,
