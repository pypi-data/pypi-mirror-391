...
class V1DevicesDeviceIdConfigPutRequestEdgeNatPolicyNatRulesetsValueRuleset(BaseModel):
    """
    V1DevicesDeviceIdConfigPutRequestEdgeNatPolicyNatRulesetsValueRuleset
    """ # noqa: E501
    description: Optional[StrictStr] = None
    name: Optional[StrictStr] = None
    rules: Optional[Dict[str, V1DevicesDeviceIdConfigPutRequestEdgeNatPolicyNatRulesetsValueRulesetRulesValue]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "rules": dict(
                (_k, V1DevicesDeviceIdConfigPutRequestEdgeNatPolicyNatRulesetsValueRulesetRulesValue.from_dict(_v))
