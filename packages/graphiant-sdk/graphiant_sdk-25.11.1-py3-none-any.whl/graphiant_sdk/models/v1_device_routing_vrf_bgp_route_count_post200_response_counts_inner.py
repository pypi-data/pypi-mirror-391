...
class V1DeviceRoutingVrfBgpRouteCountPost200ResponseCountsInner(BaseModel):
    """
    V1DeviceRoutingVrfBgpRouteCountPost200ResponseCountsInner
    """ # noqa: E501
    route_count: Optional[StrictInt] = Field(default=None, alias="routeCount")
