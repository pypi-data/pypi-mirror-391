...
class V1DevicesDeviceIdConfigPutRequestCoreInterfacesValueInterfaceGwGwVrrp(BaseModel):
    """
    V1DevicesDeviceIdConfigPutRequestCoreInterfacesValueInterfaceGwGwVrrp
    """ # noqa: E501
    group: Optional[V1DevicesDeviceIdConfigPutRequestCoreInterfacesValueInterfaceGwGwVrrpGroup] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "group": V1DevicesDeviceIdConfigPutRequestCoreInterfacesValueInterfaceGwGwVrrpGroup.from_dict(obj["group"]) if obj.get("group") is not None else None
        })
        return _obj
