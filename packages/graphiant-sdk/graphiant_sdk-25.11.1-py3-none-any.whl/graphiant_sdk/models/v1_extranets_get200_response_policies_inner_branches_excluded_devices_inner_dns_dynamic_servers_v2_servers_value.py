...
class V1ExtranetsGet200ResponsePoliciesInnerBranchesExcludedDevicesInnerDnsDynamicServersV2ServersValue(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["dynamicServers"]
