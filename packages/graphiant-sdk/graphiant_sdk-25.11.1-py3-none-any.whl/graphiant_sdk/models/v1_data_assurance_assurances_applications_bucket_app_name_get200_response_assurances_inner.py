...
class V1DataAssuranceAssurancesApplicationsBucketAppNameGet200ResponseAssurancesInner(BaseModel):
    """
    V1DataAssuranceAssurancesApplicationsBucketAppNameGet200ResponseAssurancesInner
    """ # noqa: E501
    configs: Optional[V1DataAssuranceAssurancesGlobalPostRequestConfig] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "configs": V1DataAssuranceAssurancesGlobalPostRequestConfig.from_dict(obj["configs"]) if obj.get("configs") is not None else None,
            "id": obj.get("id")
        })
        return _obj
