...
class V1GlobalConfigPatchRequestTrafficPoliciesPortListsValue(BaseModel):
    """
    V1GlobalConfigPatchRequestTrafficPoliciesPortListsValue
    """ # noqa: E501
    list: Optional[V1GlobalConfigPatchRequestTrafficPoliciesDpiApplicationsValueApplicationDestinationPorts] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "list": V1GlobalConfigPatchRequestTrafficPoliciesDpiApplicationsValueApplicationDestinationPorts.from_dict(obj["list"]) if obj.get("list") is not None else None
        })
        return _obj
