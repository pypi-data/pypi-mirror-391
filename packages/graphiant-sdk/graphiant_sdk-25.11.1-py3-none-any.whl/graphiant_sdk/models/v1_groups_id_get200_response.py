...
class V1GroupsIdGet200Response(BaseModel):
    """
    V1GroupsIdGet200Response
    """ # noqa: E501
    group: Optional[V1GroupsGet200ResponseGroupsInner] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "group": V1GroupsGet200ResponseGroupsInner.from_dict(obj["group"]) if obj.get("group") is not None else None
        })
        return _obj
