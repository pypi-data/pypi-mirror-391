...
class V1EnterpriseConfigurationGet200Response(BaseModel):
    """
    V1EnterpriseConfigurationGet200Response
    """ # noqa: E501
    configuration: Optional[V1EnterpriseConfigurationGet200ResponseConfiguration] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "configuration": V1EnterpriseConfigurationGet200ResponseConfiguration.from_dict(obj["configuration"]) if obj.get("configuration") is not None else None
        })
        return _obj
