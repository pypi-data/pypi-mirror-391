...
class V1DeviceStatusPost200Response(BaseModel):
    """
    V1DeviceStatusPost200Response
    """ # noqa: E501
    mappings: Optional[List[V1DeviceStatusPost200ResponseMappingsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "mappings": [V1DeviceStatusPost200ResponseMappingsInner.from_dict(_item) for _item in obj["mappings"]] if obj.get("mappings") is not None else None
        })
        return _obj
