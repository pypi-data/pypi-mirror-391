...
class V1AppsAppSummaryPost200ResponseAppSummaryCircuitsIncidentsv2InnerData(BaseModel):
    """
    V1AppsAppSummaryPost200ResponseAppSummaryCircuitsIncidentsv2InnerData
    """ # noqa: E501
    samples: Optional[List[V1AppsAppSummaryPost200ResponseAppSummaryCircuitsIncidentsInnerDataInner]] = None
    selector: Optional[V2AssuranceTopologyClientSessionDetailsPost200ResponseSessionLocalDiaLinksInner] = None
    __properties: ClassVar[List[str]] = ["samples", "selector"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "samples": [V1AppsAppSummaryPost200ResponseAppSummaryCircuitsIncidentsInnerDataInner.from_dict(_item) for _item in obj["samples"]] if obj.get("samples") is not None else None,
