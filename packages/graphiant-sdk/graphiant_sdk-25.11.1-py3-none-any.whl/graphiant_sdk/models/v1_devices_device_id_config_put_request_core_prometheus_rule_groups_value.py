...
class V1DevicesDeviceIdConfigPutRequestCorePrometheusRuleGroupsValue(BaseModel):
    """
    V1DevicesDeviceIdConfigPutRequestCorePrometheusRuleGroupsValue
    """ # noqa: E501
    rule_group: Optional[V1DevicesDeviceIdConfigPutRequestCorePrometheusRuleGroupsValueRuleGroup] = Field(default=None, alias="ruleGroup")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ruleGroup": V1DevicesDeviceIdConfigPutRequestCorePrometheusRuleGroupsValueRuleGroup.from_dict(obj["ruleGroup"]) if obj.get("ruleGroup") is not None else None
        })
        return _obj
