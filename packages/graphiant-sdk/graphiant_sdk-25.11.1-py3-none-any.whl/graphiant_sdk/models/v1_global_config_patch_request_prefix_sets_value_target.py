...
class V1GlobalConfigPatchRequestPrefixSetsValueTarget(BaseModel):
    """
    V1GlobalConfigPatchRequestPrefixSetsValueTarget
    """ # noqa: E501
    prefix_set: Optional[V1GlobalConfigPatchRequestPrefixSetsValueTargetPrefixSet] = Field(default=None, alias="prefixSet")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "prefixSet": V1GlobalConfigPatchRequestPrefixSetsValueTargetPrefixSet.from_dict(obj["prefixSet"]) if obj.get("prefixSet") is not None else None
        })
        return _obj
