...
class V1ExtranetsGet200ResponsePoliciesInnerBranchesExcludedDevicesInnerSegmentsInnerDhcpSubnetsInnerLeasesInner(BaseModel):
    """
    V1ExtranetsGet200ResponsePoliciesInnerBranchesExcludedDevicesInnerSegmentsInnerDhcpSubnetsInnerLeasesInner
    """ # noqa: E501
    ends_at: Optional[V1AlarmHistoryGet200ResponseHistoryInnerTime] = Field(default=None, alias="endsAt")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "endsAt": V1AlarmHistoryGet200ResponseHistoryInnerTime.from_dict(obj["endsAt"]) if obj.get("endsAt") is not None else None,
            "id": obj.get("id"),
