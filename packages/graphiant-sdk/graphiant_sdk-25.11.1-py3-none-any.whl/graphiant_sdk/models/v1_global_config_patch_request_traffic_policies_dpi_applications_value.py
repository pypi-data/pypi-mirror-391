...
class V1GlobalConfigPatchRequestTrafficPoliciesDpiApplicationsValue(BaseModel):
    """
    V1GlobalConfigPatchRequestTrafficPoliciesDpiApplicationsValue
    """ # noqa: E501
    application: Optional[V1GlobalConfigPatchRequestTrafficPoliciesDpiApplicationsValueApplication] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "application": V1GlobalConfigPatchRequestTrafficPoliciesDpiApplicationsValueApplication.from_dict(obj["application"]) if obj.get("application") is not None else None
        })
        return _obj
