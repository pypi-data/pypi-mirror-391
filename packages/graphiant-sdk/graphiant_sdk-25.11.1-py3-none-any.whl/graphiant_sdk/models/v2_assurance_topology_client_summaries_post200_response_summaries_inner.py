...
class V2AssuranceTopologyClientSummariesPost200ResponseSummariesInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["appServerKey", "clientIp", "lanSegments", "serverIp", "serverPort", "serverSiteName", "sessionCount"]
