...
class V1PortalPrivateSyncPostRequestInventoryInner(BaseModel):
    """
    ...
    is_delete: Optional[StrictBool] = Field(default=None, alias="isDelete")
    uuid: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["deviceModel", "deviceSerial", "isDelete", "uuid"]
