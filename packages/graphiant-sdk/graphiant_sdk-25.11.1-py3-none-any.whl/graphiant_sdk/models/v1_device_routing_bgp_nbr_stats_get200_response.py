...
class V1DeviceRoutingBgpNbrStatsGet200Response(BaseModel):
    """
    ...
    stats: Optional[V1DeviceRoutingBgpNbrStatsGet200ResponseStats] = None
    token: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["pageInfo", "stats", "token"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "stats": V1DeviceRoutingBgpNbrStatsGet200ResponseStats.from_dict(obj["stats"]) if obj.get("stats") is not None else None,
            "token": obj.get("token")
        })
        return _obj
