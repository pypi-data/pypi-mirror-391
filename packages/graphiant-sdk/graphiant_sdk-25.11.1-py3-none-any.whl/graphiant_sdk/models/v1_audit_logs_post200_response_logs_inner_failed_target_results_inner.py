...
class V1AuditLogsPost200ResponseLogsInnerFailedTargetResultsInner(BaseModel):
    """
    V1AuditLogsPost200ResponseLogsInnerFailedTargetResultsInner
    """ # noqa: E501
    reason: Optional[StrictStr] = None
    status: Optional[StrictStr] = None
    target: Optional[V1AuditLogsPost200ResponseLogsInnerFailedTargetResultsInnerTarget] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "target": V1AuditLogsPost200ResponseLogsInnerFailedTargetResultsInnerTarget.from_dict(obj["target"]) if obj.get("target") is not None else None
        })
        return _obj
