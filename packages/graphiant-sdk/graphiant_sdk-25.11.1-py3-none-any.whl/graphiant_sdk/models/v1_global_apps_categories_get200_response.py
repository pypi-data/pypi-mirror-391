...
class V1GlobalAppsCategoriesGet200Response(BaseModel):
    """
    V1GlobalAppsCategoriesGet200Response
    """ # noqa: E501
    entries: Optional[List[V1GlobalAppsCategoriesGet200ResponseEntriesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entries": [V1GlobalAppsCategoriesGet200ResponseEntriesInner.from_dict(_item) for _item in obj["entries"]] if obj.get("entries") is not None else None
        })
        return _obj
