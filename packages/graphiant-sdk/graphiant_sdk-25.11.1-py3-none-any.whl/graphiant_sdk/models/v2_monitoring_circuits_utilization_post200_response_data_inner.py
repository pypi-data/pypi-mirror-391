...
class V2MonitoringCircuitsUtilizationPost200ResponseDataInner(BaseModel):
    """
    ...
    queue_utilization: Optional[List[V2MonitoringCircuitsUtilizationPost200ResponseDataInnerQueueUtilizationInner]] = Field(default=None, alias="queueUtilization")
    selector: Optional[V2AssuranceTopologyClientSessionDetailsPost200ResponseSessionLocalDiaLinksInner] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "queueUtilization": [V2MonitoringCircuitsUtilizationPost200ResponseDataInnerQueueUtilizationInner.from_dict(_item) for _item in obj["queueUtilization"]] if obj.get("queueUtilization") is not None else None,
            "selector": V2AssuranceTopologyClientSessionDetailsPost200ResponseSessionLocalDiaLinksInner.from_dict(obj["selector"]) if obj.get("selector") is not None else None
        })
        return _obj
