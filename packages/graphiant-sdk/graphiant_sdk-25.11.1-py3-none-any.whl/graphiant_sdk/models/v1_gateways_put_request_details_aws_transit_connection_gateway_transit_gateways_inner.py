...
class V1GatewaysPutRequestDetailsAwsTransitConnectionGatewayTransitGatewaysInner(BaseModel):
    """
    ...
    vpcs: Optional[List[V1GatewaysPutRequestDetailsAwsTransitConnectionGatewayTransitGatewaysInnerVpcsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "asn": obj.get("asn"),
            "id": obj.get("id"),
            "vpcs": [V1GatewaysPutRequestDetailsAwsTransitConnectionGatewayTransitGatewaysInnerVpcsInner.from_dict(_item) for _item in obj["vpcs"]] if obj.get("vpcs") is not None else None
        })
        return _obj
