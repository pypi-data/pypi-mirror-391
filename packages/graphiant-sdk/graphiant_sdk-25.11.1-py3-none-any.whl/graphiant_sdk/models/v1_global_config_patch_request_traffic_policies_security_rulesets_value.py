...
class V1GlobalConfigPatchRequestTrafficPoliciesSecurityRulesetsValue(BaseModel):
    """
    V1GlobalConfigPatchRequestTrafficPoliciesSecurityRulesetsValue
    """ # noqa: E501
    ruleset: Optional[V1GlobalConfigPatchRequestTrafficPoliciesSecurityRulesetsValueRuleset] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ruleset": V1GlobalConfigPatchRequestTrafficPoliciesSecurityRulesetsValueRuleset.from_dict(obj["ruleset"]) if obj.get("ruleset") is not None else None
        })
        return _obj
