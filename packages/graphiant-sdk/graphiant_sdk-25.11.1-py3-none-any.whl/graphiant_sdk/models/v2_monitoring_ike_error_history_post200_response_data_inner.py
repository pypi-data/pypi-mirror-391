...
class V2MonitoringIkeErrorHistoryPost200ResponseDataInner(BaseModel):
    """
    ...
    timestamp: Optional[V1AlarmHistoryGet200ResponseHistoryInnerTime] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "timestamp": V1AlarmHistoryGet200ResponseHistoryInnerTime.from_dict(obj["timestamp"]) if obj.get("timestamp") is not None else None,
