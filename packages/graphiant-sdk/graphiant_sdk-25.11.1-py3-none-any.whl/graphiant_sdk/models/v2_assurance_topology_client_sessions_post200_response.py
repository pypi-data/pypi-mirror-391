...
class V2AssuranceTopologyClientSessionsPost200Response(BaseModel):
    """
    V2AssuranceTopologyClientSessionsPost200Response
    """ # noqa: E501
    sessions: Optional[List[V2AssuranceTopologyClientSessionDetailsPost200ResponseSession]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "sessions": [V2AssuranceTopologyClientSessionDetailsPost200ResponseSession.from_dict(_item) for _item in obj["sessions"]] if obj.get("sessions") is not None else None
        })
        return _obj
