...
class V1GlobalConfigPatchRequestTrafficPoliciesZoneFirewallsValueZoneFirewall(BaseModel):
    """
    V1GlobalConfigPatchRequestTrafficPoliciesZoneFirewallsValueZoneFirewall
    """ # noqa: E501
    ip: Optional[V1GlobalConfigPatchRequestTrafficPoliciesZoneFirewallsValueZoneFirewallIp] = None
    udp: Optional[V1GlobalConfigPatchRequestTrafficPoliciesZoneFirewallsValueZoneFirewallUdp] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ip": V1GlobalConfigPatchRequestTrafficPoliciesZoneFirewallsValueZoneFirewallIp.from_dict(obj["ip"]) if obj.get("ip") is not None else None,
            "udp": V1GlobalConfigPatchRequestTrafficPoliciesZoneFirewallsValueZoneFirewallUdp.from_dict(obj["udp"]) if obj.get("udp") is not None else None
        })
        return _obj
