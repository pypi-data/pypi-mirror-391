...
class V1DevicesDeviceIdConfigPutRequestCoreCoreVrfOspfv2ProcessAreasValue(BaseModel):
    """
    V1DevicesDeviceIdConfigPutRequestCoreCoreVrfOspfv2ProcessAreasValue
    """ # noqa: E501
    area: Optional[V1DevicesDeviceIdConfigPutRequestCoreCoreVrfOspfv2ProcessAreasValueArea] = None
    __properties: ClassVar[List[str]] = ["area"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "area": V1DevicesDeviceIdConfigPutRequestCoreCoreVrfOspfv2ProcessAreasValueArea.from_dict(obj["area"]) if obj.get("area") is not None else None
        })
        return _obj
