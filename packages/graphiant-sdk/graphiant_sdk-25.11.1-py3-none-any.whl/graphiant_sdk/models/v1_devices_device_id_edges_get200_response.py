...
class V1DevicesDeviceIdEdgesGet200Response(BaseModel):
    """
    V1DevicesDeviceIdEdgesGet200Response
    """ # noqa: E501
    devices: Optional[List[V1ExtranetsGet200ResponsePoliciesInnerBranchesExcludedDevicesInner]] = None
    page_info: Optional[V1NatEntriesDeviceIdGet200ResponsePageInfo] = Field(default=None, alias="pageInfo")
    __properties: ClassVar[List[str]] = ["devices", "pageInfo"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "devices": [V1ExtranetsGet200ResponsePoliciesInnerBranchesExcludedDevicesInner.from_dict(_item) for _item in obj["devices"]] if obj.get("devices") is not None else None,
