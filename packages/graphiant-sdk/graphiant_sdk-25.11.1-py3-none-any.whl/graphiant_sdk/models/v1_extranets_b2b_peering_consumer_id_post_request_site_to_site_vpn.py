...
class V1ExtranetsB2bPeeringConsumerIdPostRequestSiteToSiteVpn(BaseModel):
    """
    V1ExtranetsB2bPeeringConsumerIdPostRequestSiteToSiteVpn
    """ # noqa: E501
    emails: Optional[List[StrictStr]] = None
    ipsec_gateway_details: Optional[V1ExtranetsB2bPeeringConsumerIdPostRequestSiteToSiteVpnIpsecGatewayDetails] = Field(default=None, alias="ipsecGatewayDetails")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ipsecGatewayDetails": V1ExtranetsB2bPeeringConsumerIdPostRequestSiteToSiteVpnIpsecGatewayDetails.from_dict(obj["ipsecGatewayDetails"]) if obj.get("ipsecGatewayDetails") is not None else None,
