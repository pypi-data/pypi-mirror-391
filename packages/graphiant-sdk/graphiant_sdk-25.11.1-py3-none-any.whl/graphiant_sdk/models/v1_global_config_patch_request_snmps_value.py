...
class V1GlobalConfigPatchRequestSnmpsValue(BaseModel):
    """
    V1GlobalConfigPatchRequestSnmpsValue
    """ # noqa: E501
    config: Optional[V1GlobalConfigPatchRequestSnmpsValueConfig] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "config": V1GlobalConfigPatchRequestSnmpsValueConfig.from_dict(obj["config"]) if obj.get("config") is not None else None
        })
        return _obj
