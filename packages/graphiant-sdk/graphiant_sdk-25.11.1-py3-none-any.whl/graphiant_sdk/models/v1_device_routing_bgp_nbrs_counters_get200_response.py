...
class V1DeviceRoutingBgpNbrsCountersGet200Response(BaseModel):
    """
    V1DeviceRoutingBgpNbrsCountersGet200Response
    """ # noqa: E501
    counters: Optional[List[V1DeviceRoutingBgpNbrsCountersGet200ResponseCountersInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "counters": [V1DeviceRoutingBgpNbrsCountersGet200ResponseCountersInner.from_dict(_item) for _item in obj["counters"]] if obj.get("counters") is not None else None
        })
        return _obj
