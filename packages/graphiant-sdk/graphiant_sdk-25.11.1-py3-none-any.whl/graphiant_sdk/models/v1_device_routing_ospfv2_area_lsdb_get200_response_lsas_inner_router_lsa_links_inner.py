...
class V1DeviceRoutingOspfv2AreaLsdbGet200ResponseLsasInnerRouterLsaLinksInner(BaseModel):
    """
    ...
    tos_metric: Optional[V1DeviceRoutingOspfv2AreaLsdbGet200ResponseLsasInnerAsexternalLsaTosMetric] = Field(default=None, alias="tosMetric")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "linkData": obj.get("linkData"),
            "linkId": obj.get("linkId"),
            "linkType": obj.get("linkType"),
            "metric": obj.get("metric"),
            "tosMetric": V1DeviceRoutingOspfv2AreaLsdbGet200ResponseLsasInnerAsexternalLsaTosMetric.from_dict(obj["tosMetric"]) if obj.get("tosMetric") is not None else None
        })
        return _obj
