...
class V1ExtranetsGet200Response(BaseModel):
    """
    V1ExtranetsGet200Response
    """ # noqa: E501
    page_info: Optional[V1NatEntriesDeviceIdGet200ResponsePageInfo] = Field(default=None, alias="pageInfo")
    policies: Optional[List[V1ExtranetsGet200ResponsePoliciesInner]] = None
    __properties: ClassVar[List[str]] = ["pageInfo", "policies"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "policies": [V1ExtranetsGet200ResponsePoliciesInner.from_dict(_item) for _item in obj["policies"]] if obj.get("policies") is not None else None
        })
        return _obj
