...
class V1DevicesDeviceIdConfigPutRequestEdgeLagInterfacesValue(BaseModel):
    """
    V1DevicesDeviceIdConfigPutRequestEdgeLagInterfacesValue
    """ # noqa: E501
    interface: Optional[V1DevicesDeviceIdConfigPutRequestEdgeLagInterfacesValueInterface] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "interface": V1DevicesDeviceIdConfigPutRequestEdgeLagInterfacesValueInterface.from_dict(obj["interface"]) if obj.get("interface") is not None else None
        })
        return _obj
