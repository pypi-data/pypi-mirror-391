...
class V1DevicesDeviceIdConfigPutRequestCoreInterfacesValueInterfaceCoreNeighbor(BaseModel):
    """
    V1DevicesDeviceIdConfigPutRequestCoreInterfacesValueInterfaceCoreNeighbor
    """ # noqa: E501
    cost: Optional[V1DevicesDeviceIdConfigPutRequestCoreInterfacesValueInterfaceCoreNeighborCost] = Field(default=None, alias="Cost")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Cost": V1DevicesDeviceIdConfigPutRequestCoreInterfacesValueInterfaceCoreNeighborCost.from_dict(obj["Cost"]) if obj.get("Cost") is not None else None,
