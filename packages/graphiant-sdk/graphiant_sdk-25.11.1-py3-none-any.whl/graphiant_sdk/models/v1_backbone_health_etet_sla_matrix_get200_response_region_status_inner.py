...
class V1BackboneHealthEtetSlaMatrixGet200ResponseRegionStatusInner(BaseModel):
    """
    V1BackboneHealthEtetSlaMatrixGet200ResponseRegionStatusInner
    """ # noqa: E501
    peer_region: Optional[V2AssuranceTopologyInventoryPost200ResponseRegionsInner] = Field(default=None, alias="peerRegion")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "peerRegion": V2AssuranceTopologyInventoryPost200ResponseRegionsInner.from_dict(obj["peerRegion"]) if obj.get("peerRegion") is not None else None,
