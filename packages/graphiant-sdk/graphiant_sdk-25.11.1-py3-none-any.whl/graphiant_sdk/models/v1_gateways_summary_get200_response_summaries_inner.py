...
class V1GatewaysSummaryGet200ResponseSummariesInner(BaseModel):
    """
    ...
    gateway_device_summary: Optional[List[V1GatewaysSummaryGet200ResponseSummariesInnerGatewayDeviceSummaryInner]] = Field(default=None, alias="gatewayDeviceSummary")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "gatewayDeviceSummary": [V1GatewaysSummaryGet200ResponseSummariesInnerGatewayDeviceSummaryInner.from_dict(_item) for _item in obj["gatewayDeviceSummary"]] if obj.get("gatewayDeviceSummary") is not None else None,
