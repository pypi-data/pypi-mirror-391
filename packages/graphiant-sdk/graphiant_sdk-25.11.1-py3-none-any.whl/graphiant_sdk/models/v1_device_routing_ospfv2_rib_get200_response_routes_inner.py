...
class V1DeviceRoutingOspfv2RibGet200ResponseRoutesInner(BaseModel):
    """
    V1DeviceRoutingOspfv2RibGet200ResponseRoutesInner
    """ # noqa: E501
    ip_prefix: Optional[StrictStr] = Field(default=None, alias="ipPrefix")
    path: Optional[List[V1DeviceRoutingOspfv2RibGet200ResponseRoutesInnerPathInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "path": [V1DeviceRoutingOspfv2RibGet200ResponseRoutesInnerPathInner.from_dict(_item) for _item in obj["path"]] if obj.get("path") is not None else None
        })
        return _obj
