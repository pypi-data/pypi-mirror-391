...
class V1DevicesDeviceIdConfigPutRequestCoreCoreVrfDhcpSubnetsValue(BaseModel):
    """
    V1DevicesDeviceIdConfigPutRequestCoreCoreVrfDhcpSubnetsValue
    """ # noqa: E501
    subnet: Optional[V1DevicesDeviceIdConfigPutRequestCoreCoreVrfDhcpSubnetsValueSubnet] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "subnet": V1DevicesDeviceIdConfigPutRequestCoreCoreVrfDhcpSubnetsValueSubnet.from_dict(obj["subnet"]) if obj.get("subnet") is not None else None
        })
        return _obj
