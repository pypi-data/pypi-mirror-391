...
class V1DevicesDeviceIdConfigPutRequestEdgeSiteToSiteVpnValue(BaseModel):
    """
    V1DevicesDeviceIdConfigPutRequestEdgeSiteToSiteVpnValue
    """ # noqa: E501
    site_to_site_vpn: Optional[V1DevicesDeviceIdConfigPutRequestEdgeSiteToSiteVpnValueSiteToSiteVpn] = Field(default=None, alias="siteToSiteVpn")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "siteToSiteVpn": V1DevicesDeviceIdConfigPutRequestEdgeSiteToSiteVpnValueSiteToSiteVpn.from_dict(obj["siteToSiteVpn"]) if obj.get("siteToSiteVpn") is not None else None
        })
        return _obj
