...
class V1AlarmHistoryGet200Response(BaseModel):
    """
    V1AlarmHistoryGet200Response
    """ # noqa: E501
    history: Optional[List[V1AlarmHistoryGet200ResponseHistoryInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "history": [V1AlarmHistoryGet200ResponseHistoryInner.from_dict(_item) for _item in obj["history"]] if obj.get("history") is not None else None
        })
        return _obj
