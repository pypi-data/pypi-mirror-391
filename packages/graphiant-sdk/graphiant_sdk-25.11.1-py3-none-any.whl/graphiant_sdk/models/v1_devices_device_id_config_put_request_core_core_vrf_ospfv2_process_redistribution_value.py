...
class V1DevicesDeviceIdConfigPutRequestCoreCoreVrfOspfv2ProcessRedistributionValue(BaseModel):
    """
    V1DevicesDeviceIdConfigPutRequestCoreCoreVrfOspfv2ProcessRedistributionValue
    """ # noqa: E501
    protocol: Optional[V1DevicesDeviceIdConfigPutRequestCoreCoreVrfOspfv2ProcessRedistributionValueProtocol] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "protocol": V1DevicesDeviceIdConfigPutRequestCoreCoreVrfOspfv2ProcessRedistributionValueProtocol.from_dict(obj["protocol"]) if obj.get("protocol") is not None else None
        })
        return _obj
