...
class V1ExtranetsGet200ResponsePoliciesInnerBranchesExcludedDevicesInnerTrafficPolicyZonePairsInner(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "outside": obj.get("outside"),
            "ruleset": obj.get("ruleset"),
            "tcpProtection": obj.get("tcpProtection")
        })
        return _obj
