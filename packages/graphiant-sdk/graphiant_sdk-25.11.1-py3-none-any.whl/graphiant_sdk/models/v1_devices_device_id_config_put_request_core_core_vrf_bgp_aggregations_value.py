...
class V1DevicesDeviceIdConfigPutRequestCoreCoreVrfBgpAggregationsValue(BaseModel):
    """
    V1DevicesDeviceIdConfigPutRequestCoreCoreVrfBgpAggregationsValue
    """ # noqa: E501
    config: Optional[V1DevicesDeviceIdConfigPutRequestCoreCoreVrfBgpAggregationsValueConfig] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "config": V1DevicesDeviceIdConfigPutRequestCoreCoreVrfBgpAggregationsValueConfig.from_dict(obj["config"]) if obj.get("config") is not None else None
        })
        return _obj
