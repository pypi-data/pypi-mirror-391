...
class TestV1SitesSiteIdCircuitsGet200Response(unittest.TestCase):
    """V1SitesSiteIdCircuitsGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1SitesSiteIdCircuitsGet200Response:
        """Test V1SitesSiteIdCircuitsGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1SitesSiteIdCircuitsGet200Response`
        """
        model = V1SitesSiteIdCircuitsGet200Response()
        if include_optional:
            return V1SitesSiteIdCircuitsGet200Response(
                data = [
                    graphiant_sdk.models._v1_sites__site_id__circuits_get_200_response_data_inner._v1_sites__siteId__circuits_get_200_response_data_inner(
                        circuits = [
    ...
    def testV1SitesSiteIdCircuitsGet200Response(self):
        """Test V1SitesSiteIdCircuitsGet200Response"""
