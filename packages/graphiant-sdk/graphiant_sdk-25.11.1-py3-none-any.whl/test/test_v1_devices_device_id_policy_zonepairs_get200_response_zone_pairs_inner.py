...
class TestV1DevicesDeviceIdPolicyZonepairsGet200ResponseZonePairsInner(unittest.TestCase):
    """V1DevicesDeviceIdPolicyZonepairsGet200ResponseZonePairsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1DevicesDeviceIdPolicyZonepairsGet200ResponseZonePairsInner:
        """Test V1DevicesDeviceIdPolicyZonepairsGet200ResponseZonePairsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1DevicesDeviceIdPolicyZonepairsGet200ResponseZonePairsInner`
        """
        model = V1DevicesDeviceIdPolicyZonepairsGet200ResponseZonePairsInner()
        if include_optional:
            return V1DevicesDeviceIdPolicyZonepairsGet200ResponseZonePairsInner(
    ...
    def testV1DevicesDeviceIdPolicyZonepairsGet200ResponseZonePairsInner(self):
        """Test V1DevicesDeviceIdPolicyZonepairsGet200ResponseZonePairsInner"""
