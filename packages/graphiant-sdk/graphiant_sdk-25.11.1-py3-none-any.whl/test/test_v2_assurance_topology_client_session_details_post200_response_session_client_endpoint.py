...
class TestV2AssuranceTopologyClientSessionDetailsPost200ResponseSessionClientEndpoint(unittest.TestCase):
    """V2AssuranceTopologyClientSessionDetailsPost200ResponseSessionClientEndpoint unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2AssuranceTopologyClientSessionDetailsPost200ResponseSessionClientEndpoint:
        """Test V2AssuranceTopologyClientSessionDetailsPost200ResponseSessionClientEndpoint
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2AssuranceTopologyClientSessionDetailsPost200ResponseSessionClientEndpoint`
        """
        model = V2AssuranceTopologyClientSessionDetailsPost200ResponseSessionClientEndpoint()
        if include_optional:
            return V2AssuranceTopologyClientSessionDetailsPost200ResponseSessionClientEndpoint(
                circuits = [
                    'example string'
                    ],
                edges = [
    ...
    def testV2AssuranceTopologyClientSessionDetailsPost200ResponseSessionClientEndpoint(self):
        """Test V2AssuranceTopologyClientSessionDetailsPost200ResponseSessionClientEndpoint"""
