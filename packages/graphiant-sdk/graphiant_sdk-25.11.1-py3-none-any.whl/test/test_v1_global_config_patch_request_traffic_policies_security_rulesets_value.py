...
class TestV1GlobalConfigPatchRequestTrafficPoliciesSecurityRulesetsValue(unittest.TestCase):
    """V1GlobalConfigPatchRequestTrafficPoliciesSecurityRulesetsValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1GlobalConfigPatchRequestTrafficPoliciesSecurityRulesetsValue:
        """Test V1GlobalConfigPatchRequestTrafficPoliciesSecurityRulesetsValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1GlobalConfigPatchRequestTrafficPoliciesSecurityRulesetsValue`
        """
        model = V1GlobalConfigPatchRequestTrafficPoliciesSecurityRulesetsValue()
        if include_optional:
            return V1GlobalConfigPatchRequestTrafficPoliciesSecurityRulesetsValue(
    ...
    def testV1GlobalConfigPatchRequestTrafficPoliciesSecurityRulesetsValue(self):
        """Test V1GlobalConfigPatchRequestTrafficPoliciesSecurityRulesetsValue"""
