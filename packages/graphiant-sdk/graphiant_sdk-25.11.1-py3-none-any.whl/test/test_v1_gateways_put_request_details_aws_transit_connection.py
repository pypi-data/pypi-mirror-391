...
class TestV1GatewaysPutRequestDetailsAwsTransitConnection(unittest.TestCase):
    """V1GatewaysPutRequestDetailsAwsTransitConnection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1GatewaysPutRequestDetailsAwsTransitConnection:
        """Test V1GatewaysPutRequestDetailsAwsTransitConnection
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1GatewaysPutRequestDetailsAwsTransitConnection`
        """
        model = V1GatewaysPutRequestDetailsAwsTransitConnection()
        if include_optional:
            return V1GatewaysPutRequestDetailsAwsTransitConnection(
    ...
    def testV1GatewaysPutRequestDetailsAwsTransitConnection(self):
        """Test V1GatewaysPutRequestDetailsAwsTransitConnection"""
