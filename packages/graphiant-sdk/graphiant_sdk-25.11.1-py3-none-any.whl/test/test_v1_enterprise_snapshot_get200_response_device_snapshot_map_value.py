...
class TestV1EnterpriseSnapshotGet200ResponseDeviceSnapshotMapValue(unittest.TestCase):
    """V1EnterpriseSnapshotGet200ResponseDeviceSnapshotMapValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1EnterpriseSnapshotGet200ResponseDeviceSnapshotMapValue:
        """Test V1EnterpriseSnapshotGet200ResponseDeviceSnapshotMapValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1EnterpriseSnapshotGet200ResponseDeviceSnapshotMapValue`
        """
        model = V1EnterpriseSnapshotGet200ResponseDeviceSnapshotMapValue()
        if include_optional:
            return V1EnterpriseSnapshotGet200ResponseDeviceSnapshotMapValue(
                count = 123,
                snapshots = [
    ...
    def testV1EnterpriseSnapshotGet200ResponseDeviceSnapshotMapValue(self):
        """Test V1EnterpriseSnapshotGet200ResponseDeviceSnapshotMapValue"""
