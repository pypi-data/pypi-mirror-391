...
class TestV1AlarmsListGet200ResponseAlarmsInner(unittest.TestCase):
    """V1AlarmsListGet200ResponseAlarmsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1AlarmsListGet200ResponseAlarmsInner:
        """Test V1AlarmsListGet200ResponseAlarmsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1AlarmsListGet200ResponseAlarmsInner`
        """
        model = V1AlarmsListGet200ResponseAlarmsInner()
        if include_optional:
            return V1AlarmsListGet200ResponseAlarmsInner(
                ...
                last_changed = graphiant_sdk.models._v1_alarm_history_get_200_response_history_inner_time._v1_alarm_history_get_200_response_history_inner_time(
                    nanos = 123, 
                    seconds = 1234567891011, ),
                last_raised = graphiant_sdk.models._v1_alarm_history_get_200_response_history_inner_time._v1_alarm_history_get_200_response_history_inner_time(
                    nanos = 123, 
                    seconds = 1234567891011, ),
    ...
    def testV1AlarmsListGet200ResponseAlarmsInner(self):
        """Test V1AlarmsListGet200ResponseAlarmsInner"""
