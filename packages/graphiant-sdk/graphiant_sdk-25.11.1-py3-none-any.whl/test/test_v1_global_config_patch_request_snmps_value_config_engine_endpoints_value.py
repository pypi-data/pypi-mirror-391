...
class TestV1GlobalConfigPatchRequestSnmpsValueConfigEngineEndpointsValue(unittest.TestCase):
    """V1GlobalConfigPatchRequestSnmpsValueConfigEngineEndpointsValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1GlobalConfigPatchRequestSnmpsValueConfigEngineEndpointsValue:
        """Test V1GlobalConfigPatchRequestSnmpsValueConfigEngineEndpointsValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1GlobalConfigPatchRequestSnmpsValueConfigEngineEndpointsValue`
        """
        model = V1GlobalConfigPatchRequestSnmpsValueConfigEngineEndpointsValue()
        if include_optional:
            return V1GlobalConfigPatchRequestSnmpsValueConfigEngineEndpointsValue(
    ...
    def testV1GlobalConfigPatchRequestSnmpsValueConfigEngineEndpointsValue(self):
        """Test V1GlobalConfigPatchRequestSnmpsValueConfigEngineEndpointsValue"""
