...
class TestV1DataAssuranceAssurancesApplicationsBucketAppNameGet200ResponseAssurancesInner(unittest.TestCase):
    """V1DataAssuranceAssurancesApplicationsBucketAppNameGet200ResponseAssurancesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1DataAssuranceAssurancesApplicationsBucketAppNameGet200ResponseAssurancesInner:
        """Test V1DataAssuranceAssurancesApplicationsBucketAppNameGet200ResponseAssurancesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1DataAssuranceAssurancesApplicationsBucketAppNameGet200ResponseAssurancesInner`
        """
        model = V1DataAssuranceAssurancesApplicationsBucketAppNameGet200ResponseAssurancesInner()
        if include_optional:
            return V1DataAssuranceAssurancesApplicationsBucketAppNameGet200ResponseAssurancesInner(
    ...
    def testV1DataAssuranceAssurancesApplicationsBucketAppNameGet200ResponseAssurancesInner(self):
        """Test V1DataAssuranceAssurancesApplicationsBucketAppNameGet200ResponseAssurancesInner"""
