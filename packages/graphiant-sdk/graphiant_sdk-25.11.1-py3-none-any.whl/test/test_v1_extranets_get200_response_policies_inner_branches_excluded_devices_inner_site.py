...
class TestV1ExtranetsGet200ResponsePoliciesInnerBranchesExcludedDevicesInnerSite(unittest.TestCase):
    """V1ExtranetsGet200ResponsePoliciesInnerBranchesExcludedDevicesInnerSite unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1ExtranetsGet200ResponsePoliciesInnerBranchesExcludedDevicesInnerSite:
        """Test V1ExtranetsGet200ResponsePoliciesInnerBranchesExcludedDevicesInnerSite
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1ExtranetsGet200ResponsePoliciesInnerBranchesExcludedDevicesInnerSite`
        """
        model = V1ExtranetsGet200ResponsePoliciesInnerBranchesExcludedDevicesInnerSite()
        if include_optional:
            return V1ExtranetsGet200ResponsePoliciesInnerBranchesExcludedDevicesInnerSite(
    ...
    def testV1ExtranetsGet200ResponsePoliciesInnerBranchesExcludedDevicesInnerSite(self):
        """Test V1ExtranetsGet200ResponsePoliciesInnerBranchesExcludedDevicesInnerSite"""
