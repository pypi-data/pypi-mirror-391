...
class TestV1GlobalConfigPatchRequestSnmpsValueConfigVacmGroupsValueGroup(unittest.TestCase):
    """V1GlobalConfigPatchRequestSnmpsValueConfigVacmGroupsValueGroup unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1GlobalConfigPatchRequestSnmpsValueConfigVacmGroupsValueGroup:
        """Test V1GlobalConfigPatchRequestSnmpsValueConfigVacmGroupsValueGroup
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1GlobalConfigPatchRequestSnmpsValueConfigVacmGroupsValueGroup`
        """
        model = V1GlobalConfigPatchRequestSnmpsValueConfigVacmGroupsValueGroup()
        if include_optional:
            return V1GlobalConfigPatchRequestSnmpsValueConfigVacmGroupsValueGroup(
                accesses = {
    ...
    def testV1GlobalConfigPatchRequestSnmpsValueConfigVacmGroupsValueGroup(self):
        """Test V1GlobalConfigPatchRequestSnmpsValueConfigVacmGroupsValueGroup"""
