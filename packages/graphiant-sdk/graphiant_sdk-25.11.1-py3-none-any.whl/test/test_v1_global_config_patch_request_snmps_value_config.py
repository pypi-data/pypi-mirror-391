...
class TestV1GlobalConfigPatchRequestSnmpsValueConfig(unittest.TestCase):
    """V1GlobalConfigPatchRequestSnmpsValueConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1GlobalConfigPatchRequestSnmpsValueConfig:
        """Test V1GlobalConfigPatchRequestSnmpsValueConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1GlobalConfigPatchRequestSnmpsValueConfig`
        """
        model = V1GlobalConfigPatchRequestSnmpsValueConfig()
        if include_optional:
            return V1GlobalConfigPatchRequestSnmpsValueConfig(
                communities = {
    ...
    def testV1GlobalConfigPatchRequestSnmpsValueConfig(self):
        """Test V1GlobalConfigPatchRequestSnmpsValueConfig"""
