...
class TestV1GlobalConfigPatchRequestTrafficPoliciesZoneFirewallsValueZoneFirewall(unittest.TestCase):
    """V1GlobalConfigPatchRequestTrafficPoliciesZoneFirewallsValueZoneFirewall unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1GlobalConfigPatchRequestTrafficPoliciesZoneFirewallsValueZoneFirewall:
        """Test V1GlobalConfigPatchRequestTrafficPoliciesZoneFirewallsValueZoneFirewall
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1GlobalConfigPatchRequestTrafficPoliciesZoneFirewallsValueZoneFirewall`
        """
        model = V1GlobalConfigPatchRequestTrafficPoliciesZoneFirewallsValueZoneFirewall()
        if include_optional:
            return V1GlobalConfigPatchRequestTrafficPoliciesZoneFirewallsValueZoneFirewall(
    ...
    def testV1GlobalConfigPatchRequestTrafficPoliciesZoneFirewallsValueZoneFirewall(self):
        """Test V1GlobalConfigPatchRequestTrafficPoliciesZoneFirewallsValueZoneFirewall"""
