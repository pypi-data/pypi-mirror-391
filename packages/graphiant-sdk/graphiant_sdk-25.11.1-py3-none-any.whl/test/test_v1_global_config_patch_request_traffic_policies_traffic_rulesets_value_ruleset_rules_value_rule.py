...
class TestV1GlobalConfigPatchRequestTrafficPoliciesTrafficRulesetsValueRulesetRulesValueRule(unittest.TestCase):
    """V1GlobalConfigPatchRequestTrafficPoliciesTrafficRulesetsValueRulesetRulesValueRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1GlobalConfigPatchRequestTrafficPoliciesTrafficRulesetsValueRulesetRulesValueRule:
        """Test V1GlobalConfigPatchRequestTrafficPoliciesTrafficRulesetsValueRulesetRulesValueRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1GlobalConfigPatchRequestTrafficPoliciesTrafficRulesetsValueRulesetRulesValueRule`
        """
        model = V1GlobalConfigPatchRequestTrafficPoliciesTrafficRulesetsValueRulesetRulesValueRule()
        if include_optional:
            return V1GlobalConfigPatchRequestTrafficPoliciesTrafficRulesetsValueRulesetRulesValueRule(
    ...
    def testV1GlobalConfigPatchRequestTrafficPoliciesTrafficRulesetsValueRulesetRulesValueRule(self):
        """Test V1GlobalConfigPatchRequestTrafficPoliciesTrafficRulesetsValueRulesetRulesValueRule"""
