...
class TestV1GroupsGet200Response(unittest.TestCase):
    """V1GroupsGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1GroupsGet200Response:
        """Test V1GroupsGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1GroupsGet200Response`
        """
        model = V1GroupsGet200Response()
        if include_optional:
            return V1GroupsGet200Response(
                groups = [
                    graphiant_sdk.models._v1_groups_get_200_response_groups_inner._v1_groups_get_200_response_groups_inner(
    ...
    def testV1GroupsGet200Response(self):
        """Test V1GroupsGet200Response"""
