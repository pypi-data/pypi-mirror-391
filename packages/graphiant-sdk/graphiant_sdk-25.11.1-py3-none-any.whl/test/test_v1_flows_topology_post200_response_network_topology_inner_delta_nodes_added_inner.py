...
class TestV1FlowsTopologyPost200ResponseNetworkTopologyInnerDeltaNodesAddedInner(unittest.TestCase):
    """V1FlowsTopologyPost200ResponseNetworkTopologyInnerDeltaNodesAddedInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1FlowsTopologyPost200ResponseNetworkTopologyInnerDeltaNodesAddedInner:
        """Test V1FlowsTopologyPost200ResponseNetworkTopologyInnerDeltaNodesAddedInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1FlowsTopologyPost200ResponseNetworkTopologyInnerDeltaNodesAddedInner`
        """
        model = V1FlowsTopologyPost200ResponseNetworkTopologyInnerDeltaNodesAddedInner()
        if include_optional:
            return V1FlowsTopologyPost200ResponseNetworkTopologyInnerDeltaNodesAddedInner(
    ...
    def testV1FlowsTopologyPost200ResponseNetworkTopologyInnerDeltaNodesAddedInner(self):
        """Test V1FlowsTopologyPost200ResponseNetworkTopologyInnerDeltaNodesAddedInner"""
