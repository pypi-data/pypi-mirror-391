...
class TestV1DevicesDeviceIdConfigPutRequestCoreCoreVrfOverlayFilters(unittest.TestCase):
    """V1DevicesDeviceIdConfigPutRequestCoreCoreVrfOverlayFilters unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1DevicesDeviceIdConfigPutRequestCoreCoreVrfOverlayFilters:
        """Test V1DevicesDeviceIdConfigPutRequestCoreCoreVrfOverlayFilters
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1DevicesDeviceIdConfigPutRequestCoreCoreVrfOverlayFilters`
        """
        model = V1DevicesDeviceIdConfigPutRequestCoreCoreVrfOverlayFilters()
        if include_optional:
            return V1DevicesDeviceIdConfigPutRequestCoreCoreVrfOverlayFilters(
    ...
    def testV1DevicesDeviceIdConfigPutRequestCoreCoreVrfOverlayFilters(self):
        """Test V1DevicesDeviceIdConfigPutRequestCoreCoreVrfOverlayFilters"""
