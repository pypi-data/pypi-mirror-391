...
class TestV1EdgesHardwareAssignedGet200ResponseEdgesSummaryInnerUpgradeSummary(unittest.TestCase):
    """V1EdgesHardwareAssignedGet200ResponseEdgesSummaryInnerUpgradeSummary unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1EdgesHardwareAssignedGet200ResponseEdgesSummaryInnerUpgradeSummary:
        """Test V1EdgesHardwareAssignedGet200ResponseEdgesSummaryInnerUpgradeSummary
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1EdgesHardwareAssignedGet200ResponseEdgesSummaryInnerUpgradeSummary`
        """
        model = V1EdgesHardwareAssignedGet200ResponseEdgesSummaryInnerUpgradeSummary()
        if include_optional:
            return V1EdgesHardwareAssignedGet200ResponseEdgesSummaryInnerUpgradeSummary(
    ...
    def testV1EdgesHardwareAssignedGet200ResponseEdgesSummaryInnerUpgradeSummary(self):
        """Test V1EdgesHardwareAssignedGet200ResponseEdgesSummaryInnerUpgradeSummary"""
