...
class TestV1DevicesDeviceIdConfigPutRequestEdgeLagInterfacesValue(unittest.TestCase):
    """V1DevicesDeviceIdConfigPutRequestEdgeLagInterfacesValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1DevicesDeviceIdConfigPutRequestEdgeLagInterfacesValue:
        """Test V1DevicesDeviceIdConfigPutRequestEdgeLagInterfacesValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1DevicesDeviceIdConfigPutRequestEdgeLagInterfacesValue`
        """
        model = V1DevicesDeviceIdConfigPutRequestEdgeLagInterfacesValue()
        if include_optional:
            return V1DevicesDeviceIdConfigPutRequestEdgeLagInterfacesValue(
                interface = graphiant_sdk.models._v1_devices__device_id__config_put_request_edge_lag_interfaces_value_interface._v1_devices__deviceId__config_put_request_edge_lagInterfaces_value_interface(
                    admin_status = True, 
    ...
    def testV1DevicesDeviceIdConfigPutRequestEdgeLagInterfacesValue(self):
        """Test V1DevicesDeviceIdConfigPutRequestEdgeLagInterfacesValue"""
