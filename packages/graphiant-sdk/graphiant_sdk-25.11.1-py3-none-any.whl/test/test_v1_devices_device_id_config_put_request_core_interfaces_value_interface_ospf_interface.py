...
class TestV1DevicesDeviceIdConfigPutRequestCoreInterfacesValueInterfaceOspfInterface(unittest.TestCase):
    """V1DevicesDeviceIdConfigPutRequestCoreInterfacesValueInterfaceOspfInterface unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1DevicesDeviceIdConfigPutRequestCoreInterfacesValueInterfaceOspfInterface:
        """Test V1DevicesDeviceIdConfigPutRequestCoreInterfacesValueInterfaceOspfInterface
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1DevicesDeviceIdConfigPutRequestCoreInterfacesValueInterfaceOspfInterface`
        """
        model = V1DevicesDeviceIdConfigPutRequestCoreInterfacesValueInterfaceOspfInterface()
        if include_optional:
            return V1DevicesDeviceIdConfigPutRequestCoreInterfacesValueInterfaceOspfInterface(
    ...
    def testV1DevicesDeviceIdConfigPutRequestCoreInterfacesValueInterfaceOspfInterface(self):
        """Test V1DevicesDeviceIdConfigPutRequestCoreInterfacesValueInterfaceOspfInterface"""
