...
class TestV1DevicesDeviceIdConfigPutRequestCoreCoreVrfOspfv2Process(unittest.TestCase):
    """V1DevicesDeviceIdConfigPutRequestCoreCoreVrfOspfv2Process unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1DevicesDeviceIdConfigPutRequestCoreCoreVrfOspfv2Process:
        """Test V1DevicesDeviceIdConfigPutRequestCoreCoreVrfOspfv2Process
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1DevicesDeviceIdConfigPutRequestCoreCoreVrfOspfv2Process`
        """
        model = V1DevicesDeviceIdConfigPutRequestCoreCoreVrfOspfv2Process()
        if include_optional:
            return V1DevicesDeviceIdConfigPutRequestCoreCoreVrfOspfv2Process(
                address_families = [
                    'ENUM_VALUE'
                    ],
    ...
    def testV1DevicesDeviceIdConfigPutRequestCoreCoreVrfOspfv2Process(self):
        """Test V1DevicesDeviceIdConfigPutRequestCoreCoreVrfOspfv2Process"""
