...
class TestV1DevicesDeviceIdConfigPutRequestCoreInterfacesValueInterfaceInterfaceTypeWan(unittest.TestCase):
    """V1DevicesDeviceIdConfigPutRequestCoreInterfacesValueInterfaceInterfaceTypeWan unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1DevicesDeviceIdConfigPutRequestCoreInterfacesValueInterfaceInterfaceTypeWan:
        """Test V1DevicesDeviceIdConfigPutRequestCoreInterfacesValueInterfaceInterfaceTypeWan
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1DevicesDeviceIdConfigPutRequestCoreInterfacesValueInterfaceInterfaceTypeWan`
        """
        model = V1DevicesDeviceIdConfigPutRequestCoreInterfacesValueInterfaceInterfaceTypeWan()
        if include_optional:
            return V1DevicesDeviceIdConfigPutRequestCoreInterfacesValueInterfaceInterfaceTypeWan(
                gw = graphiant_sdk.models._v1_devices__device_id__config_put_request_core_interfaces_value_interface_interface_type_wan_gw._v1_devices__deviceId__config_put_request_core_interfaces_value_interface_interfaceType_wan_gw(
                    gw = graphiant_sdk.models._v1_devices__device_id__config_put_request_core_interfaces_value_interface_interface_type_wan_gw_gw._v1_devices__deviceId__config_put_request_core_interfaces_value_interface_interfaceType_wan_gw_gw(
    ...
    def testV1DevicesDeviceIdConfigPutRequestCoreInterfacesValueInterfaceInterfaceTypeWan(self):
        """Test V1DevicesDeviceIdConfigPutRequestCoreInterfacesValueInterfaceInterfaceTypeWan"""
