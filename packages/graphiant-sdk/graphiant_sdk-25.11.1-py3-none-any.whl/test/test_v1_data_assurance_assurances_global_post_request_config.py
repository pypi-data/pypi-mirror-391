...
class TestV1DataAssuranceAssurancesGlobalPostRequestConfig(unittest.TestCase):
    """V1DataAssuranceAssurancesGlobalPostRequestConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1DataAssuranceAssurancesGlobalPostRequestConfig:
        """Test V1DataAssuranceAssurancesGlobalPostRequestConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1DataAssuranceAssurancesGlobalPostRequestConfig`
        """
        model = V1DataAssuranceAssurancesGlobalPostRequestConfig()
        if include_optional:
            return V1DataAssuranceAssurancesGlobalPostRequestConfig(
                apps = [
    ...
    def testV1DataAssuranceAssurancesGlobalPostRequestConfig(self):
        """Test V1DataAssuranceAssurancesGlobalPostRequestConfig"""
