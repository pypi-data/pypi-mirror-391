...
class TestV1GlobalConfigPatchRequestSnmpsValueConfigNotifyFilterProfilesValue(unittest.TestCase):
    """V1GlobalConfigPatchRequestSnmpsValueConfigNotifyFilterProfilesValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1GlobalConfigPatchRequestSnmpsValueConfigNotifyFilterProfilesValue:
        """Test V1GlobalConfigPatchRequestSnmpsValueConfigNotifyFilterProfilesValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1GlobalConfigPatchRequestSnmpsValueConfigNotifyFilterProfilesValue`
        """
        model = V1GlobalConfigPatchRequestSnmpsValueConfigNotifyFilterProfilesValue()
        if include_optional:
            return V1GlobalConfigPatchRequestSnmpsValueConfigNotifyFilterProfilesValue(
    ...
    def testV1GlobalConfigPatchRequestSnmpsValueConfigNotifyFilterProfilesValue(self):
        """Test V1GlobalConfigPatchRequestSnmpsValueConfigNotifyFilterProfilesValue"""
