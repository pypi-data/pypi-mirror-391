...
class TestV1MonitoringCircuitsBandwidthPost200Response(unittest.TestCase):
    """V1MonitoringCircuitsBandwidthPost200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1MonitoringCircuitsBandwidthPost200Response:
        """Test V1MonitoringCircuitsBandwidthPost200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1MonitoringCircuitsBandwidthPost200Response`
        """
        model = V1MonitoringCircuitsBandwidthPost200Response()
        if include_optional:
            return V1MonitoringCircuitsBandwidthPost200Response(
                data = [
                    graphiant_sdk.models._v1_monitoring_circuits_bandwidth_post_200_response_data_inner._v1_monitoring_circuits_bandwidth_post_200_response_data_inner(
    ...
    def testV1MonitoringCircuitsBandwidthPost200Response(self):
        """Test V1MonitoringCircuitsBandwidthPost200Response"""
