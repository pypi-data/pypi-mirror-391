...
class TestV1GlobalConfigPatchRequestRoutingPoliciesValue(unittest.TestCase):
    """V1GlobalConfigPatchRequestRoutingPoliciesValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1GlobalConfigPatchRequestRoutingPoliciesValue:
        """Test V1GlobalConfigPatchRequestRoutingPoliciesValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1GlobalConfigPatchRequestRoutingPoliciesValue`
        """
        model = V1GlobalConfigPatchRequestRoutingPoliciesValue()
        if include_optional:
            return V1GlobalConfigPatchRequestRoutingPoliciesValue(
    ...
    def testV1GlobalConfigPatchRequestRoutingPoliciesValue(self):
        """Test V1GlobalConfigPatchRequestRoutingPoliciesValue"""
