...
class TestV1ExtranetsMonitoringTrafficSecurityPolicyPost200ResponseTrafficRulesInner(unittest.TestCase):
    """V1ExtranetsMonitoringTrafficSecurityPolicyPost200ResponseTrafficRulesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1ExtranetsMonitoringTrafficSecurityPolicyPost200ResponseTrafficRulesInner:
        """Test V1ExtranetsMonitoringTrafficSecurityPolicyPost200ResponseTrafficRulesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1ExtranetsMonitoringTrafficSecurityPolicyPost200ResponseTrafficRulesInner`
        """
        model = V1ExtranetsMonitoringTrafficSecurityPolicyPost200ResponseTrafficRulesInner()
        if include_optional:
            return V1ExtranetsMonitoringTrafficSecurityPolicyPost200ResponseTrafficRulesInner(
    ...
    def testV1ExtranetsMonitoringTrafficSecurityPolicyPost200ResponseTrafficRulesInner(self):
        """Test V1ExtranetsMonitoringTrafficSecurityPolicyPost200ResponseTrafficRulesInner"""
