...
class TestV2AssuranceApplicationdetailsbynamePost200ResponseAppIdRecord(unittest.TestCase):
    """V2AssuranceApplicationdetailsbynamePost200ResponseAppIdRecord unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2AssuranceApplicationdetailsbynamePost200ResponseAppIdRecord:
        """Test V2AssuranceApplicationdetailsbynamePost200ResponseAppIdRecord
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2AssuranceApplicationdetailsbynamePost200ResponseAppIdRecord`
        """
        model = V2AssuranceApplicationdetailsbynamePost200ResponseAppIdRecord()
        if include_optional:
            return V2AssuranceApplicationdetailsbynamePost200ResponseAppIdRecord(
    ...
    def testV2AssuranceApplicationdetailsbynamePost200ResponseAppIdRecord(self):
        """Test V2AssuranceApplicationdetailsbynamePost200ResponseAppIdRecord"""
