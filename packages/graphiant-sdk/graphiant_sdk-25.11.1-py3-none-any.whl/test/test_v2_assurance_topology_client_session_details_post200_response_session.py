...
class TestV2AssuranceTopologyClientSessionDetailsPost200ResponseSession(unittest.TestCase):
    """V2AssuranceTopologyClientSessionDetailsPost200ResponseSession unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2AssuranceTopologyClientSessionDetailsPost200ResponseSession:
        """Test V2AssuranceTopologyClientSessionDetailsPost200ResponseSession
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2AssuranceTopologyClientSessionDetailsPost200ResponseSession`
        """
        model = V2AssuranceTopologyClientSessionDetailsPost200ResponseSession()
        if include_optional:
            return V2AssuranceTopologyClientSessionDetailsPost200ResponseSession(
    ...
    def testV2AssuranceTopologyClientSessionDetailsPost200ResponseSession(self):
        """Test V2AssuranceTopologyClientSessionDetailsPost200ResponseSession"""
