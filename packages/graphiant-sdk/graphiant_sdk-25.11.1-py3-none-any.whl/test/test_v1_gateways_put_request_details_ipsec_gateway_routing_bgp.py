...
class TestV1GatewaysPutRequestDetailsIpsecGatewayRoutingBgp(unittest.TestCase):
    """V1GatewaysPutRequestDetailsIpsecGatewayRoutingBgp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1GatewaysPutRequestDetailsIpsecGatewayRoutingBgp:
        """Test V1GatewaysPutRequestDetailsIpsecGatewayRoutingBgp
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1GatewaysPutRequestDetailsIpsecGatewayRoutingBgp`
        """
        model = V1GatewaysPutRequestDetailsIpsecGatewayRoutingBgp()
        if include_optional:
            return V1GatewaysPutRequestDetailsIpsecGatewayRoutingBgp(
                address_families = {
    ...
    def testV1GatewaysPutRequestDetailsIpsecGatewayRoutingBgp(self):
        """Test V1GatewaysPutRequestDetailsIpsecGatewayRoutingBgp"""
