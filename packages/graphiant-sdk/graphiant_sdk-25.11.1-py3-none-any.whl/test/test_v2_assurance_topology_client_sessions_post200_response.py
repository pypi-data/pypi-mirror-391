...
class TestV2AssuranceTopologyClientSessionsPost200Response(unittest.TestCase):
    """V2AssuranceTopologyClientSessionsPost200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2AssuranceTopologyClientSessionsPost200Response:
        """Test V2AssuranceTopologyClientSessionsPost200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2AssuranceTopologyClientSessionsPost200Response`
        """
        model = V2AssuranceTopologyClientSessionsPost200Response()
        if include_optional:
            return V2AssuranceTopologyClientSessionsPost200Response(
                sessions = [
                    graphiant_sdk.models._v2_assurance_topology_client_session_details_post_200_response_session._v2_assurance_topology_client_session_details_post_200_response_session(
    ...
    def testV2AssuranceTopologyClientSessionsPost200Response(self):
        """Test V2AssuranceTopologyClientSessionsPost200Response"""
