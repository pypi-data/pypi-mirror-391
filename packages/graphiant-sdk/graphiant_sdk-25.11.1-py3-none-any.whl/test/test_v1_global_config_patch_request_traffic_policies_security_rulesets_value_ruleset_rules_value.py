...
class TestV1GlobalConfigPatchRequestTrafficPoliciesSecurityRulesetsValueRulesetRulesValue(unittest.TestCase):
    """V1GlobalConfigPatchRequestTrafficPoliciesSecurityRulesetsValueRulesetRulesValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1GlobalConfigPatchRequestTrafficPoliciesSecurityRulesetsValueRulesetRulesValue:
        """Test V1GlobalConfigPatchRequestTrafficPoliciesSecurityRulesetsValueRulesetRulesValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1GlobalConfigPatchRequestTrafficPoliciesSecurityRulesetsValueRulesetRulesValue`
        """
        model = V1GlobalConfigPatchRequestTrafficPoliciesSecurityRulesetsValueRulesetRulesValue()
        if include_optional:
            return V1GlobalConfigPatchRequestTrafficPoliciesSecurityRulesetsValueRulesetRulesValue(
    ...
    def testV1GlobalConfigPatchRequestTrafficPoliciesSecurityRulesetsValueRulesetRulesValue(self):
        """Test V1GlobalConfigPatchRequestTrafficPoliciesSecurityRulesetsValueRulesetRulesValue"""
