...
class TestV2AssuranceBucketAppServersAllGet200ResponseAppServerChangesInner(unittest.TestCase):
    """V2AssuranceBucketAppServersAllGet200ResponseAppServerChangesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2AssuranceBucketAppServersAllGet200ResponseAppServerChangesInner:
        """Test V2AssuranceBucketAppServersAllGet200ResponseAppServerChangesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2AssuranceBucketAppServersAllGet200ResponseAppServerChangesInner`
        """
        model = V2AssuranceBucketAppServersAllGet200ResponseAppServerChangesInner()
        if include_optional:
            return V2AssuranceBucketAppServersAllGet200ResponseAppServerChangesInner(
                added_servers = [
    ...
    def testV2AssuranceBucketAppServersAllGet200ResponseAppServerChangesInner(self):
        """Test V2AssuranceBucketAppServersAllGet200ResponseAppServerChangesInner"""
