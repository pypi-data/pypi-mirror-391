...
class TestV1FlowsTopologyPost200ResponseNetworkTopologyInnerDeltaEdgesAddedInner(unittest.TestCase):
    """V1FlowsTopologyPost200ResponseNetworkTopologyInnerDeltaEdgesAddedInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1FlowsTopologyPost200ResponseNetworkTopologyInnerDeltaEdgesAddedInner:
        """Test V1FlowsTopologyPost200ResponseNetworkTopologyInnerDeltaEdgesAddedInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1FlowsTopologyPost200ResponseNetworkTopologyInnerDeltaEdgesAddedInner`
        """
        model = V1FlowsTopologyPost200ResponseNetworkTopologyInnerDeltaEdgesAddedInner()
        if include_optional:
            return V1FlowsTopologyPost200ResponseNetworkTopologyInnerDeltaEdgesAddedInner(
                a = 123,
                b = 123,
    ...
    def testV1FlowsTopologyPost200ResponseNetworkTopologyInnerDeltaEdgesAddedInner(self):
        """Test V1FlowsTopologyPost200ResponseNetworkTopologyInnerDeltaEdgesAddedInner"""
