...
class TestV1GlobalConfigPatchRequestRoutingPoliciesValuePolicyStatementsValue(unittest.TestCase):
    """V1GlobalConfigPatchRequestRoutingPoliciesValuePolicyStatementsValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1GlobalConfigPatchRequestRoutingPoliciesValuePolicyStatementsValue:
        """Test V1GlobalConfigPatchRequestRoutingPoliciesValuePolicyStatementsValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1GlobalConfigPatchRequestRoutingPoliciesValuePolicyStatementsValue`
        """
        model = V1GlobalConfigPatchRequestRoutingPoliciesValuePolicyStatementsValue()
        if include_optional:
            return V1GlobalConfigPatchRequestRoutingPoliciesValuePolicyStatementsValue(
    ...
    def testV1GlobalConfigPatchRequestRoutingPoliciesValuePolicyStatementsValue(self):
        """Test V1GlobalConfigPatchRequestRoutingPoliciesValuePolicyStatementsValue"""
