...
class TestV1DevicesDeviceIdConfigPutRequestEdgeNatPolicy(unittest.TestCase):
    """V1DevicesDeviceIdConfigPutRequestEdgeNatPolicy unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1DevicesDeviceIdConfigPutRequestEdgeNatPolicy:
        """Test V1DevicesDeviceIdConfigPutRequestEdgeNatPolicy
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1DevicesDeviceIdConfigPutRequestEdgeNatPolicy`
        """
        model = V1DevicesDeviceIdConfigPutRequestEdgeNatPolicy()
        if include_optional:
            return V1DevicesDeviceIdConfigPutRequestEdgeNatPolicy(
                nat_rulesets = {
    ...
    def testV1DevicesDeviceIdConfigPutRequestEdgeNatPolicy(self):
        """Test V1DevicesDeviceIdConfigPutRequestEdgeNatPolicy"""
