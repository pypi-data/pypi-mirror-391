...
class TestV1DevicesDeviceIdConfigPutRequestCoreCoreVrfBgpNeighborsValueNeighbor(unittest.TestCase):
    """V1DevicesDeviceIdConfigPutRequestCoreCoreVrfBgpNeighborsValueNeighbor unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1DevicesDeviceIdConfigPutRequestCoreCoreVrfBgpNeighborsValueNeighbor:
        """Test V1DevicesDeviceIdConfigPutRequestCoreCoreVrfBgpNeighborsValueNeighbor
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1DevicesDeviceIdConfigPutRequestCoreCoreVrfBgpNeighborsValueNeighbor`
        """
        model = V1DevicesDeviceIdConfigPutRequestCoreCoreVrfBgpNeighborsValueNeighbor()
        if include_optional:
            return V1DevicesDeviceIdConfigPutRequestCoreCoreVrfBgpNeighborsValueNeighbor(
                address_families = {
    ...
    def testV1DevicesDeviceIdConfigPutRequestCoreCoreVrfBgpNeighborsValueNeighbor(self):
        """Test V1DevicesDeviceIdConfigPutRequestCoreCoreVrfBgpNeighborsValueNeighbor"""
