...
class TestV1GatewaysPutRequestDetailsIpsecGatewayRoutingBgpAddressFamiliesValue(unittest.TestCase):
    """V1GatewaysPutRequestDetailsIpsecGatewayRoutingBgpAddressFamiliesValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1GatewaysPutRequestDetailsIpsecGatewayRoutingBgpAddressFamiliesValue:
        """Test V1GatewaysPutRequestDetailsIpsecGatewayRoutingBgpAddressFamiliesValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1GatewaysPutRequestDetailsIpsecGatewayRoutingBgpAddressFamiliesValue`
        """
        model = V1GatewaysPutRequestDetailsIpsecGatewayRoutingBgpAddressFamiliesValue()
        if include_optional:
            return V1GatewaysPutRequestDetailsIpsecGatewayRoutingBgpAddressFamiliesValue(
    ...
    def testV1GatewaysPutRequestDetailsIpsecGatewayRoutingBgpAddressFamiliesValue(self):
        """Test V1GatewaysPutRequestDetailsIpsecGatewayRoutingBgpAddressFamiliesValue"""
