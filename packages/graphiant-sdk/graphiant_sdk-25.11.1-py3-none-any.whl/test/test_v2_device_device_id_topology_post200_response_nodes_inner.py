...
class TestV2DeviceDeviceIdTopologyPost200ResponseNodesInner(unittest.TestCase):
    """V2DeviceDeviceIdTopologyPost200ResponseNodesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2DeviceDeviceIdTopologyPost200ResponseNodesInner:
        """Test V2DeviceDeviceIdTopologyPost200ResponseNodesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2DeviceDeviceIdTopologyPost200ResponseNodesInner`
        """
        model = V2DeviceDeviceIdTopologyPost200ResponseNodesInner()
        if include_optional:
            return V2DeviceDeviceIdTopologyPost200ResponseNodesInner(
                circuit_info = [
    ...
    def testV2DeviceDeviceIdTopologyPost200ResponseNodesInner(self):
        """Test V2DeviceDeviceIdTopologyPost200ResponseNodesInner"""
