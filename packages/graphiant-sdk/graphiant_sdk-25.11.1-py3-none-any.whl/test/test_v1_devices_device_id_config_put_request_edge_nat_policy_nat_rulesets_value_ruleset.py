...
class TestV1DevicesDeviceIdConfigPutRequestEdgeNatPolicyNatRulesetsValueRuleset(unittest.TestCase):
    """V1DevicesDeviceIdConfigPutRequestEdgeNatPolicyNatRulesetsValueRuleset unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1DevicesDeviceIdConfigPutRequestEdgeNatPolicyNatRulesetsValueRuleset:
        """Test V1DevicesDeviceIdConfigPutRequestEdgeNatPolicyNatRulesetsValueRuleset
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1DevicesDeviceIdConfigPutRequestEdgeNatPolicyNatRulesetsValueRuleset`
        """
        model = V1DevicesDeviceIdConfigPutRequestEdgeNatPolicyNatRulesetsValueRuleset()
        if include_optional:
            return V1DevicesDeviceIdConfigPutRequestEdgeNatPolicyNatRulesetsValueRuleset(
    ...
    def testV1DevicesDeviceIdConfigPutRequestEdgeNatPolicyNatRulesetsValueRuleset(self):
        """Test V1DevicesDeviceIdConfigPutRequestEdgeNatPolicyNatRulesetsValueRuleset"""
