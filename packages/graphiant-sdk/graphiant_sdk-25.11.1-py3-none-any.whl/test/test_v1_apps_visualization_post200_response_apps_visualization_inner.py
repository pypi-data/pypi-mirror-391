...
class TestV1AppsVisualizationPost200ResponseAppsVisualizationInner(unittest.TestCase):
    """V1AppsVisualizationPost200ResponseAppsVisualizationInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1AppsVisualizationPost200ResponseAppsVisualizationInner:
        """Test V1AppsVisualizationPost200ResponseAppsVisualizationInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1AppsVisualizationPost200ResponseAppsVisualizationInner`
        """
        model = V1AppsVisualizationPost200ResponseAppsVisualizationInner()
        if include_optional:
            return V1AppsVisualizationPost200ResponseAppsVisualizationInner(
                app_id = 123,
    ...
    def testV1AppsVisualizationPost200ResponseAppsVisualizationInner(self):
        """Test V1AppsVisualizationPost200ResponseAppsVisualizationInner"""
