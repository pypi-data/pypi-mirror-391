...
class TestV1GlobalConfigPatchRequestTrafficPoliciesSecurityRulesetsValueRuleset(unittest.TestCase):
    """V1GlobalConfigPatchRequestTrafficPoliciesSecurityRulesetsValueRuleset unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1GlobalConfigPatchRequestTrafficPoliciesSecurityRulesetsValueRuleset:
        """Test V1GlobalConfigPatchRequestTrafficPoliciesSecurityRulesetsValueRuleset
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1GlobalConfigPatchRequestTrafficPoliciesSecurityRulesetsValueRuleset`
        """
        model = V1GlobalConfigPatchRequestTrafficPoliciesSecurityRulesetsValueRuleset()
        if include_optional:
            return V1GlobalConfigPatchRequestTrafficPoliciesSecurityRulesetsValueRuleset(
    ...
    def testV1GlobalConfigPatchRequestTrafficPoliciesSecurityRulesetsValueRuleset(self):
        """Test V1GlobalConfigPatchRequestTrafficPoliciesSecurityRulesetsValueRuleset"""
