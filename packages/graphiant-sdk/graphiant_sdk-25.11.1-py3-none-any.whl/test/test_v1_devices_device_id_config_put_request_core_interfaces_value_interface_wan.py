...
class TestV1DevicesDeviceIdConfigPutRequestCoreInterfacesValueInterfaceWan(unittest.TestCase):
    """V1DevicesDeviceIdConfigPutRequestCoreInterfacesValueInterfaceWan unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1DevicesDeviceIdConfigPutRequestCoreInterfacesValueInterfaceWan:
        """Test V1DevicesDeviceIdConfigPutRequestCoreInterfacesValueInterfaceWan
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1DevicesDeviceIdConfigPutRequestCoreInterfacesValueInterfaceWan`
        """
        model = V1DevicesDeviceIdConfigPutRequestCoreInterfacesValueInterfaceWan()
        if include_optional:
            return V1DevicesDeviceIdConfigPutRequestCoreInterfacesValueInterfaceWan(
                gw = graphiant_sdk.models._v1_devices__device_id__config_put_request_core_interfaces_value_interface_gw._v1_devices__deviceId__config_put_request_core_interfaces_value_interface_gw(
                    gw = graphiant_sdk.models._v1_devices__device_id__config_put_request_core_interfaces_value_interface_gw_gw._v1_devices__deviceId__config_put_request_core_interfaces_value_interface_gw_gw(
    ...
    def testV1DevicesDeviceIdConfigPutRequestCoreInterfacesValueInterfaceWan(self):
        """Test V1DevicesDeviceIdConfigPutRequestCoreInterfacesValueInterfaceWan"""
