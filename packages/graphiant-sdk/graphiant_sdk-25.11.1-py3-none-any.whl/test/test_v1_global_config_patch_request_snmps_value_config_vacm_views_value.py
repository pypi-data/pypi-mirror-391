...
class TestV1GlobalConfigPatchRequestSnmpsValueConfigVacmViewsValue(unittest.TestCase):
    """V1GlobalConfigPatchRequestSnmpsValueConfigVacmViewsValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1GlobalConfigPatchRequestSnmpsValueConfigVacmViewsValue:
        """Test V1GlobalConfigPatchRequestSnmpsValueConfigVacmViewsValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1GlobalConfigPatchRequestSnmpsValueConfigVacmViewsValue`
        """
        model = V1GlobalConfigPatchRequestSnmpsValueConfigVacmViewsValue()
        if include_optional:
            return V1GlobalConfigPatchRequestSnmpsValueConfigVacmViewsValue(
    ...
    def testV1GlobalConfigPatchRequestSnmpsValueConfigVacmViewsValue(self):
        """Test V1GlobalConfigPatchRequestSnmpsValueConfigVacmViewsValue"""
