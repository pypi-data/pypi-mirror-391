...
class TestV1TroubleshootingDeviceDeviceIdPost200ResponseControlPlane(unittest.TestCase):
    """V1TroubleshootingDeviceDeviceIdPost200ResponseControlPlane unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1TroubleshootingDeviceDeviceIdPost200ResponseControlPlane:
        """Test V1TroubleshootingDeviceDeviceIdPost200ResponseControlPlane
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1TroubleshootingDeviceDeviceIdPost200ResponseControlPlane`
        """
        model = V1TroubleshootingDeviceDeviceIdPost200ResponseControlPlane()
        if include_optional:
            return V1TroubleshootingDeviceDeviceIdPost200ResponseControlPlane(
                control_transitions = [
    ...
    def testV1TroubleshootingDeviceDeviceIdPost200ResponseControlPlane(self):
        """Test V1TroubleshootingDeviceDeviceIdPost200ResponseControlPlane"""
