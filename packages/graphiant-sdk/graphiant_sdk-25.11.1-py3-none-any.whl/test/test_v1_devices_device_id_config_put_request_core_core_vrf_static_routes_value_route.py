...
class TestV1DevicesDeviceIdConfigPutRequestCoreCoreVrfStaticRoutesValueRoute(unittest.TestCase):
    """V1DevicesDeviceIdConfigPutRequestCoreCoreVrfStaticRoutesValueRoute unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1DevicesDeviceIdConfigPutRequestCoreCoreVrfStaticRoutesValueRoute:
        """Test V1DevicesDeviceIdConfigPutRequestCoreCoreVrfStaticRoutesValueRoute
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1DevicesDeviceIdConfigPutRequestCoreCoreVrfStaticRoutesValueRoute`
        """
        model = V1DevicesDeviceIdConfigPutRequestCoreCoreVrfStaticRoutesValueRoute()
        if include_optional:
            return V1DevicesDeviceIdConfigPutRequestCoreCoreVrfStaticRoutesValueRoute(
                admin_distance = 123,
    ...
    def testV1DevicesDeviceIdConfigPutRequestCoreCoreVrfStaticRoutesValueRoute(self):
        """Test V1DevicesDeviceIdConfigPutRequestCoreCoreVrfStaticRoutesValueRoute"""
