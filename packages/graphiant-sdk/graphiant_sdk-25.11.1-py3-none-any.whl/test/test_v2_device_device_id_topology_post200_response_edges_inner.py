...
class TestV2DeviceDeviceIdTopologyPost200ResponseEdgesInner(unittest.TestCase):
    """V2DeviceDeviceIdTopologyPost200ResponseEdgesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2DeviceDeviceIdTopologyPost200ResponseEdgesInner:
        """Test V2DeviceDeviceIdTopologyPost200ResponseEdgesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2DeviceDeviceIdTopologyPost200ResponseEdgesInner`
        """
        model = V2DeviceDeviceIdTopologyPost200ResponseEdgesInner()
        if include_optional:
            return V2DeviceDeviceIdTopologyPost200ResponseEdgesInner(
                a = 123,
                b = 123,
                circuits_info = [
    ...
    def testV2DeviceDeviceIdTopologyPost200ResponseEdgesInner(self):
        """Test V2DeviceDeviceIdTopologyPost200ResponseEdgesInner"""
