...
class TestV1GlobalConfigPatchRequestTrafficPoliciesTrafficRulesetsValueRulesetRulesValue(unittest.TestCase):
    """V1GlobalConfigPatchRequestTrafficPoliciesTrafficRulesetsValueRulesetRulesValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1GlobalConfigPatchRequestTrafficPoliciesTrafficRulesetsValueRulesetRulesValue:
        """Test V1GlobalConfigPatchRequestTrafficPoliciesTrafficRulesetsValueRulesetRulesValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1GlobalConfigPatchRequestTrafficPoliciesTrafficRulesetsValueRulesetRulesValue`
        """
        model = V1GlobalConfigPatchRequestTrafficPoliciesTrafficRulesetsValueRulesetRulesValue()
        if include_optional:
            return V1GlobalConfigPatchRequestTrafficPoliciesTrafficRulesetsValueRulesetRulesValue(
    ...
    def testV1GlobalConfigPatchRequestTrafficPoliciesTrafficRulesetsValueRulesetRulesValue(self):
        """Test V1GlobalConfigPatchRequestTrafficPoliciesTrafficRulesetsValueRulesetRulesValue"""
