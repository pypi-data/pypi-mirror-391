...
class TestV1HealthcheckDevicesGet200ResponseDetailsInner(unittest.TestCase):
    """V1HealthcheckDevicesGet200ResponseDetailsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1HealthcheckDevicesGet200ResponseDetailsInner:
        """Test V1HealthcheckDevicesGet200ResponseDetailsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1HealthcheckDevicesGet200ResponseDetailsInner`
        """
        model = V1HealthcheckDevicesGet200ResponseDetailsInner()
        if include_optional:
            return V1HealthcheckDevicesGet200ResponseDetailsInner(
                bgp_core_state = [
                    True
                    ],
                bgp_odp_state = [
    ...
    def testV1HealthcheckDevicesGet200ResponseDetailsInner(self):
        """Test V1HealthcheckDevicesGet200ResponseDetailsInner"""
