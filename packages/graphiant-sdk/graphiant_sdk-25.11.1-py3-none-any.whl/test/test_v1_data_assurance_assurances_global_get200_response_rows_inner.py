...
class TestV1DataAssuranceAssurancesGlobalGet200ResponseRowsInner(unittest.TestCase):
    """V1DataAssuranceAssurancesGlobalGet200ResponseRowsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1DataAssuranceAssurancesGlobalGet200ResponseRowsInner:
        """Test V1DataAssuranceAssurancesGlobalGet200ResponseRowsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1DataAssuranceAssurancesGlobalGet200ResponseRowsInner`
        """
        model = V1DataAssuranceAssurancesGlobalGet200ResponseRowsInner()
        if include_optional:
            return V1DataAssuranceAssurancesGlobalGet200ResponseRowsInner(
                apps = [
    ...
    def testV1DataAssuranceAssurancesGlobalGet200ResponseRowsInner(self):
        """Test V1DataAssuranceAssurancesGlobalGet200ResponseRowsInner"""
