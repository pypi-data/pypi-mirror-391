...
class TestV1DevicesDeviceIdConfigPutRequestCoreInterfacesValueInterfaceGw(unittest.TestCase):
    """V1DevicesDeviceIdConfigPutRequestCoreInterfacesValueInterfaceGw unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1DevicesDeviceIdConfigPutRequestCoreInterfacesValueInterfaceGw:
        """Test V1DevicesDeviceIdConfigPutRequestCoreInterfacesValueInterfaceGw
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1DevicesDeviceIdConfigPutRequestCoreInterfacesValueInterfaceGw`
        """
        model = V1DevicesDeviceIdConfigPutRequestCoreInterfacesValueInterfaceGw()
        if include_optional:
            return V1DevicesDeviceIdConfigPutRequestCoreInterfacesValueInterfaceGw(
    ...
    def testV1DevicesDeviceIdConfigPutRequestCoreInterfacesValueInterfaceGw(self):
        """Test V1DevicesDeviceIdConfigPutRequestCoreInterfacesValueInterfaceGw"""
