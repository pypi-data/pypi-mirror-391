...
class TestV1ExtranetsB2bPeeringConsumerIdPostRequestSiteToSiteVpn(unittest.TestCase):
    """V1ExtranetsB2bPeeringConsumerIdPostRequestSiteToSiteVpn unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1ExtranetsB2bPeeringConsumerIdPostRequestSiteToSiteVpn:
        """Test V1ExtranetsB2bPeeringConsumerIdPostRequestSiteToSiteVpn
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1ExtranetsB2bPeeringConsumerIdPostRequestSiteToSiteVpn`
        """
        model = V1ExtranetsB2bPeeringConsumerIdPostRequestSiteToSiteVpn()
        if include_optional:
            return V1ExtranetsB2bPeeringConsumerIdPostRequestSiteToSiteVpn(
                emails = [
                    'example string'
                    ],
    ...
    def testV1ExtranetsB2bPeeringConsumerIdPostRequestSiteToSiteVpn(self):
        """Test V1ExtranetsB2bPeeringConsumerIdPostRequestSiteToSiteVpn"""
