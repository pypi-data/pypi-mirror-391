...
class TestV1GlobalSnmpsDeviceGet200Response(unittest.TestCase):
    """V1GlobalSnmpsDeviceGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1GlobalSnmpsDeviceGet200Response:
        """Test V1GlobalSnmpsDeviceGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1GlobalSnmpsDeviceGet200Response`
        """
        model = V1GlobalSnmpsDeviceGet200Response()
        if include_optional:
            return V1GlobalSnmpsDeviceGet200Response(
                snmps = [
                    graphiant_sdk.models._v1_extranets_get_200_response_policies_inner_branches_excluded_devices_inner_snmp._v1_extranets_get_200_response_policies_inner_branches_excludedDevices_inner_snmp(
                        communities = [
    ...
    def testV1GlobalSnmpsDeviceGet200Response(self):
        """Test V1GlobalSnmpsDeviceGet200Response"""
