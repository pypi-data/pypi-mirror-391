...
class TestV1FlowsTopologyPost200ResponseNetworkTopologyInner(unittest.TestCase):
    """V1FlowsTopologyPost200ResponseNetworkTopologyInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1FlowsTopologyPost200ResponseNetworkTopologyInner:
        """Test V1FlowsTopologyPost200ResponseNetworkTopologyInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1FlowsTopologyPost200ResponseNetworkTopologyInner`
        """
        model = V1FlowsTopologyPost200ResponseNetworkTopologyInner()
        if include_optional:
            return V1FlowsTopologyPost200ResponseNetworkTopologyInner(
                circuit_status = {
                    'key' : 123
                    },
                delta = graphiant_sdk.models._v1_flows_topology_post_200_response_network_topology_inner_delta._v1_flows_topology_post_200_response_networkTopology_inner_delta(
                    edges_added = [
    ...
    def testV1FlowsTopologyPost200ResponseNetworkTopologyInner(self):
        """Test V1FlowsTopologyPost200ResponseNetworkTopologyInner"""
