...
class TestV1DevicesDeviceIdPolicyZonepairsGet200Response(unittest.TestCase):
    """V1DevicesDeviceIdPolicyZonepairsGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1DevicesDeviceIdPolicyZonepairsGet200Response:
        """Test V1DevicesDeviceIdPolicyZonepairsGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1DevicesDeviceIdPolicyZonepairsGet200Response`
        """
        model = V1DevicesDeviceIdPolicyZonepairsGet200Response()
        if include_optional:
            return V1DevicesDeviceIdPolicyZonepairsGet200Response(
                zone_pairs = [
                    graphiant_sdk.models._v1_devices__device_id__policy_zonepairs_get_200_response_zone_pairs_inner._v1_devices__deviceId__policy_zonepairs_get_200_response_zonePairs_inner(
    ...
    def testV1DevicesDeviceIdPolicyZonepairsGet200Response(self):
        """Test V1DevicesDeviceIdPolicyZonepairsGet200Response"""
