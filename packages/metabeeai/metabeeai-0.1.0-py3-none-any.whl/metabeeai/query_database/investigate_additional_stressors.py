    ...
    for stressor_type, stressor_details in matches:
        ...
        if stressor_type_clean and specific_name:
            stressor_data.append({
                'stressor_type': standardize_stressor_type(stressor_type_clean),
                'stressor_name': specific_name
            })
        ...
        for match in matches:
            ...
            if stressor_name and is_valid_stressor_name(stressor_name):
                ...
                stressor_data.append({
                    ...
                    'stressor_name': standardize_stressor_name(stressor_name)
                })
...
"""
        ...
        if object_match:
            ...
            return {
                'stressor_type': stressor.get('type', 'other'),
                'stressor_name': stressor.get('name', stressor_name)
            }
        elif array_match:
...
def is_valid_stressor_name(name: str) -> bool:
    ...
    skip_words = [
        ...
        'stress', 'stressor', 'additional', 'environmental', 'factors', 'conditions'
    ]
