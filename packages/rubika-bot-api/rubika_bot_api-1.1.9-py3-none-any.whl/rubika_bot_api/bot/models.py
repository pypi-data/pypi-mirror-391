...
from rubika_bot_api.enums import ParseMode
from .enums import (
    ChatKeypadTypeEnum,
    ChatTypeEnum,
    ForwardedFromEnum,
...
if TYPE_CHECKING:
    # Import the top-level package for type-checkers (Pylance/pyright).
    # We guard under TYPE_CHECKING so at runtime we don't introduce an
    # import cycle or an unnecessary runtime dependency.
    import rubika_bot_api  # noqa: F401
...
class MessageId(DictLike):
    ...
    file_id: Optional[str] = None
    chat_id: Optional[str] = None
    client: Optional["rubika_bot_api.BotClient"] = None
...
class Update(DictLike):
    ...
    async def edit_keypad(self, chat_keypad: Optional["rubika_bot_api.bot.models.Keypad"] = None, message_id: Optional[str] = None):
...
class InlineMessage(DictLike):
    ...
    message_id: Optional[str] = None
    chat_id: Optional[str] = None
    client: "rubika_bot_api.BotClient" = None
    ...
    async def edit_keypad(self, inline_keypad: Optional["rubika_bot_api.bot.models.Keypad"] = None, message_id: Optional[str] = None):
    ...
    async def reply(
        self,
        text: str,
        chat_keypad: Optional["rubika_bot_api.bot.models.Keypad"] = None,
        inline_keypad: Optional["rubika_bot_api.bot.models.Keypad"] = None,
        disable_notification: bool = False,
        chat_keypad_type: "rubika_bot_api.bot.enums.ChatKeypadTypeEnum" = ChatKeypadTypeEnum.NONE,
        chat_id: str = None,
        parse_mode: Optional[Union[ParseMode, str]] = None,
        metadata: Optional[Metadata] = None,
    ):
