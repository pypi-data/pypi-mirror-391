...
from .helpers import delay, get_screenshot, get_exception_body_map
...
class GptDriverCore:
    ...
    def _log_code_execution(
        ...
        if not base64_screenshot:
            base64_screenshot = get_screenshot(self._driver)
    ...
    def _perform_agentic_loop(
        ...
        try:
            ...
            while not condition_succeeded:
                ...
                time.sleep(1.5)
                logger().debug(">>\t Waited 1.5s before next action")
