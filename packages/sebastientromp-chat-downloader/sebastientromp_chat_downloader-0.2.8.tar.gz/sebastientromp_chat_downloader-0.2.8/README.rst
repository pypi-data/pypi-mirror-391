...
.. image:: https://img.shields.io/pypi/pyversions/sebastientromp-chat-downloader
   :target: https://pypi.org/project/sebastientromp-chat-downloader
   :alt: Python

.. image:: https://img.shields.io/pypi/v/sebastientromp-chat-downloader.svg
   :target: https://pypi.org/project/sebastientromp-chat-downloader
   :alt: PyPI version

.. image:: https://pepy.tech/badge/sebastientromp-chat-downloader/month
   :target: https://pypi.org/project/sebastientromp-chat-downloader
   :alt: Downloads
...
..
    [![GitHub issues](https://img.shields.io/github/issues/xenova/chat-downloader)](https://badge.fury.io/py/sebastientromp-chat-downloader)
    [![GitHub forks](https://img.shields.io/github/forks/xenova/chat-downloader)](https://badge.fury.io/py/sebastientromp-chat-downloader)
    [![GitHub stars](https://img.shields.io/github/stars/xenova/chat-downloader)](https://badge.fury.io/py/sebastientromp-chat-downloader)
...
.. _PyPI: https://pypi.org/project/sebastientromp-chat-downloader/

.. code:: console

   $ pip install sebastientromp-chat-downloader
