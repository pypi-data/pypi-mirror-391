...
class StorageClusterCreateRequest(object):
    """object used to create the ACE Storage Cluster"""
    ...
    def storageMountPrefix(self):
        ...
        r prefix . If not provided, mount prefix will be default to em
        pty string"""
    ...
    def isValid(self):
        if self._name is None:
            raise ValueError(
                "StorageClusterCreateRequest.name doesnt match requirement:" 
                "required: True"
            )
        if self._description is None:
            raise ValueError(
                "StorageClusterCreateRequest.description doesnt match requirement:" 
                "required: True"
            )
        if self._destination is None:
            raise ValueError(
                "StorageClusterCreateRequest.destination doesnt match requirement:" 
                "required: True"
            )
        if self._type is None:
            raise ValueError(
                "StorageClusterCreateRequest.type doesnt match requirement:" 
                "required: True"
            )
        if self._isDefault is None:
            raise ValueError(
                "StorageClusterCreateRequest.isDefault doesnt match requirement:" 
                "required: True"
            )
        if self._initialDefaultQuotaSizeGb is None:
            raise ValueError(
                "StorageClusterCreateRequest.initialDefaultQuotaSizeGb doesnt match requirement:" 
                "required: True"
            )
        if self._maxQuotaSizeGb is None:
            raise ValueError(
                "StorageClusterCreateRequest.maxQuotaSizeGb doesnt match requirement:" 
                "required: True"
            )
        if self._inboundHttpDisabled is None:
            raise ValueError(
                "StorageClusterCreateRequest.inboundHttpDisabled doesnt match requirement:" 
                "required: True"
            )
        if self._storageLocation is None:
            raise ValueError(
                "StorageClusterCreateRequest.storageLocation doesnt match requirement:" 
                "required: True"
            )
        return True
