...
class LabelSet(object):
    ...
    @property
    def display(self):
        """str: Label set display name i.e. category, precision, gpuModel etc.
        ."""
    ...
    @property
    def value(self):
        """str: Label set name i.e. category, precision, gpuModel etc.."""
        return self._value
    ...
    def isValid(self):
        if self._value is None:
            raise ValueError(
                "LabelSet.value doesnt match requirement:" 
                "required: True"
            )
        if (self._value is not None
            and
            len(self._value) > 64):
            raise ValueError(
                "LabelSet.value: " + str(self._value) + 
        ...
        if self._display is None:
            raise ValueError(
                "LabelSet.display doesnt match requirement:" 
                "required: True"
            )
        if (self._display is not None
            and
            ...
            raise ValueError(
                "LabelSet.display: " + str(self._display) + 
                " doesnt match requirement: maxLength: 64")
        if (self._display is not None
            and
            not re.match(
