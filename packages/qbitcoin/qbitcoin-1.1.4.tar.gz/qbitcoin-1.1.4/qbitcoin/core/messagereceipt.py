...
class MessageReceipt(object):
    ...
    services_arg = {
        ######################
        qbitlegacy_pb2.LegacyMessage.VE: 'veData',
        qbitlegacy_pb2.LegacyMessage.PL: 'plData',
        qbitlegacy_pb2.LegacyMessage.PONG: 'pongData',

        ######################
        qbitlegacy_pb2.LegacyMessage.MR: 'mrData',
        qbitlegacy_pb2.LegacyMessage.SFM: 'mrData',

        qbitlegacy_pb2.LegacyMessage.BK: 'block',
        qbitlegacy_pb2.LegacyMessage.FB: 'fbData',
        qbitlegacy_pb2.LegacyMessage.PB: 'pbData',

        ############################
        qbitlegacy_pb2.LegacyMessage.TX: 'txData',
        qbitlegacy_pb2.LegacyMessage.MT: 'mtData',
        qbitlegacy_pb2.LegacyMessage.TK: 'tkData',
        qbitlegacy_pb2.LegacyMessage.TT: 'ttData',
        qbitlegacy_pb2.LegacyMessage.LT: 'ltData',
        qbitlegacy_pb2.LegacyMessage.SL: 'slData',

        qbitlegacy_pb2.LegacyMessage.EPH: 'ephData',

        qbitlegacy_pb2.LegacyMessage.SYNC: 'syncData',

        qbitlegacy_pb2.LegacyMessage.MC: 'mcData',
        qbitlegacy_pb2.LegacyMessage.MS: 'msData',
        qbitlegacy_pb2.LegacyMessage.MV: 'mvData',
    }
    ...
    def get(self, msg_type, msg_hash: bytes) -> Optional[qbitlegacy_pb2.LegacyMessage]:
        if not self.contains(msg_hash, msg_type):
            return None

        msg = self._hash_msg[msg_hash].msg
        data = qbitlegacy_pb2.LegacyMessage(**{'func_name': msg_type,
