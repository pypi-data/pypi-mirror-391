...
from qbitcoin.core.OutgoingMessage import OutgoingMessage
from qbitcoin.core.misc import logger, ntp
from qbitcoin.core.p2p.IPMetadata import IPMetadata
from qbitcoin.core.p2p.p2pObservable import P2PObservable
...
class P2PProtocol(Protocol):
    ...
    def dataReceived(self, data: bytes) -> None:
        ...
        if msg is not None and read_bytes[0] and msg.func_name != qbitlegacy_pb2.LegacyMessage.P2P_ACK:
            p2p_ack = qbit_pb2.P2PAcknowledgement(bytes_processed=read_bytes[0])
            msg = qbitlegacy_pb2.LegacyMessage(func_name=qbitlegacy_pb2.LegacyMessage.P2P_ACK,
                                              p2pAckData=p2p_ack)
            self.send(msg)
    ...
    def send(self, message: qbitlegacy_pb2.LegacyMessage):
    ...
    def _wrap_message(protobuf_obj) -> Optional[bytes]:
        ...
        '000000191a170a0776657273696f6e120c67656e657369735f68617368'
                ...
                msg = qbitlegacy_pb2.LegacyMessage(func_name=qbitlegacy_pb2.LegacyMessage.PL,
                                          plData=qbitlegacy_pb2.PLData(peer_ips=trusted_peers,
                                                                      public_port=config.user.p2p_public_port))

        >>> plData = qbitlegacy_pb2.PLData(peer_ips=[])
        >>> msg = qbitlegacy_pb2.LegacyMessage(func_name=qbitlegacy_pb2.LegacyMessage.PL, plData=plData)
        >>> bin2hstr(P2PProtocol._wrap_message(msg))
        '0000000408012200'
        """
    ...
    def _parse_buffer(self, total_read):
        ...
        while self._buffer:
            ...
            try:
                ...
                message = qbitlegacy_pb2.LegacyMessage()
    ...
    def send_version_request(self):
        msg = qbitlegacy_pb2.LegacyMessage(func_name=qbitlegacy_pb2.LegacyMessage.VE,
                                          veData=qbitlegacy_pb2.VEData())
        self.send(msg)
    ...
    def send_sync(self, synced=False):
        ...
        msg = qbitlegacy_pb2.LegacyMessage(func_name=qbitlegacy_pb2.LegacyMessage.SYNC,
                                          syncData=qbitlegacy_pb2.SYNCData(state=state_str))
        self.send(msg)
    ...
    def send_fetch_block(self, block_idx):
        ...
        msg = qbitlegacy_pb2.LegacyMessage(func_name=qbitlegacy_pb2.LegacyMessage.FB,
                                          fbData=qbitlegacy_pb2.FBData(index=block_idx))
        self.send(msg)
    ...
    def send_get_headerhash_list(self, current_block_height):
        ...
        node_header_hash = qbit_pb2.NodeHeaderHash(block_number=start_blocknumber,
                                                  headerhashes=[])
