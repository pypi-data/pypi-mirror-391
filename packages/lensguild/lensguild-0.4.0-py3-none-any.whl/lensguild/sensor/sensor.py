...
from lensguild.objective.model_id import  ModelID #TODO move ModelID  to another place
from .pixel import Pixel
from .bit_depth import BitDepth
from .sensor_type import SensorFormats, SensorType
...
class Sensor:
    ...
    def r_sequence(self, step_mm: Length) -> np.ndarray:
        ...
        r_max_mm = 0.5 * self.diagonal.value_mm
