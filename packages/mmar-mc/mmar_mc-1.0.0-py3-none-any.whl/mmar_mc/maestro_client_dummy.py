...
from mmar_mc.models import MessageData


class MaestroClientDummy(MaestroClient):
    async def process(self, context: Context, msg_data: MessageData | str) -> list[MessageData]:
