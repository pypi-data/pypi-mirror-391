...
from ..exceptions import GammaAPIError, LeagueNotFoundError, SportNotFoundError
from ..models.sports import League, Sport, SportEvent
from .base import BaseEndpoint


def _parse_response_data(error_response: httpx.Response) -> Any | None:
