...
class League(BaseGammaModel):
    ...
    # Core fields
    id: str | None = Field(None, description="League identifier")
    name: str | None = Field(None, description="League name")
    slug: str | None = Field(None, description="URL-friendly slug")
    sport: str | None = Field(None, description="Sport this league belongs to")

    # League metadata
    description: str | None = Field(None, description="League description")
    logo: str | None = Field(None, description="URL to league logo")
    website: str | None = Field(None, description="League website URL")

    # Status and configuration
    active: bool | None = Field(
        None, description="Whether league is currently active"
    )
    featured: bool | None = Field(None, description="Whether league is featured")
    ...
    # Additional metadata
    country: str | None = Field(None, description="Country where league operates")
    season: str | None = Field(None, description="Current or default season")
...
class SportEvent(BaseGammaModel):
    ...
    # Event metadata
    venue: str | None = Field(None, description="Event venue")
    location: str | None = Field(None, description="Event location")

    # Participants (for team sports)
    participants: list[dict[str, Any]] | None = Field(
...
class SportList(BaseGammaModel):
    ...
    total: int | None = Field(None, description="Total number of sports")
    ...
    def get_sport_by_identifier(self, sport_identifier: str) -> Sport | None:
...
class LeagueList(BaseGammaModel):
    ...
    total: int | None = Field(None, description="Total number of leagues")
    ...
    def get_league_by_id(self, league_id: str) -> League | None:
