...
from py_gamma import GammaAPIError, GammaClient, GammaConfig, Series, SeriesNotFoundError
        ...
        try:
            ...
            if series_list:
                ...
                try:
                    ...
                    if "404" in str(e):
                        print("   ⚠ Markets for series endpoint not implemented yet (404)")
                        print("   ℹ This endpoint (/series/{id}/markets) may not be available")
                    else:
            ...
            try:
                ...
                print("   ⚠ Sync method test skipped (requires sync context)")
