...
from py_gamma.exceptions import (
    AuthenticationError,
    GammaAPIError,
    ...
    async with GammaClient(config) as client:
        ...
        try:
            ...
            if "Expected JSON response but got" in error_msg or "404 page not found" in error_msg:
                print("   ✗ get_profile() failed: Endpoint not found or requires authentication\n")
            else:
        ...
        try:
            ...
            error_msg = str(e)
            if "Expected JSON response but got" in error_msg or "404 page not found" in error_msg:
                print("   ✗ get_profile_by_id() failed: Endpoint not found or requires authentication\n")
            else:
        ...
        try:
            ...
            error_msg = str(e)
            if "Expected JSON response but got" in error_msg or "404 page not found" in error_msg:
                print("   ✗ get_stats() failed: Endpoint not found or requires authentication\n")
            else:
        ...
        try:
            ...
            error_msg = str(e)
            if "Expected JSON response but got" in error_msg or "404 page not found" in error_msg:
                print("   ✗ get_positions() failed: Endpoint not found or requires authentication\n")
            else:
        ...
        try:
            ...
            error_msg = str(e)
            if "Expected JSON response but got" in error_msg or "404 page not found" in error_msg:
                print("   ✗ get_history() failed: Endpoint not found or requires authentication\n")
            else:
        ...
        try:
            ...
            error_msg = str(e)
            if "Expected JSON response but got" in error_msg or "404 page not found" in error_msg:
                print("   ✗ get_user() failed: Endpoint not found or requires authentication\n")
            else:
        ...
        try:
            ...
            error_msg = str(e)
            if "Expected JSON response but got" in error_msg or "404 page not found" in error_msg:
                print("   ✗ iter_all_positions() failed: Endpoint not found or requires authentication\n")
            else:
...
def test_sync_endpoints():
    ...
    try:
        ...
        error_msg = str(e)
        if "Expected JSON response but got" in error_msg or "404 page not found" in error_msg:
            print("   ✗ get_profile_sync() failed: Endpoint not found or requires authentication")
        else:
