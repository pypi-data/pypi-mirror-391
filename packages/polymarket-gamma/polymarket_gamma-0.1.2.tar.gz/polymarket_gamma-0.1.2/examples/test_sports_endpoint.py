...
from py_gamma.exceptions import SportNotFoundError
...
async def test_sports_basic():
    ...
    try:
        ...
        for sport in sports[:3]:  # Test first 3 sports
            ...
            assert hasattr(sport, 'sport'), "Sport object missing 'sport' field"
            assert hasattr(sport, 'image'), "Sport object missing 'image' field"
            assert hasattr(sport, 'resolution'), "Sport object missing 'resolution' field"
