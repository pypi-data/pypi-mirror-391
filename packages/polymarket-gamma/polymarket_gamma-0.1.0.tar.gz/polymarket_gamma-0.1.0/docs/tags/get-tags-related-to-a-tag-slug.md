...
|-----------|------|----------|-------------|-------------|
| slug | string | Yes | Path parameter | URL-friendly slug of the tag to get related tags for |
...
- Returns an array of complete Tag objects that are related to the specified tag slug
