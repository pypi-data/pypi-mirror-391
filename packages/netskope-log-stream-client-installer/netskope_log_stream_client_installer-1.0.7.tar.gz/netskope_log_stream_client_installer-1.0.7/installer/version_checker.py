...
def get_latest_version_from_pypi(package_name: str = "netskope-log-stream-client-installer", include_prereleases: bool = False) -> Optional[str]:
    ...
    try:
        ...
        if not include_prereleases:
            ...
            # Include pre-releases, just get the latest from info
...
def check_for_updates(auto_upgrade: bool = False, package_name: str = "netskope-log-stream-client-installer", include_prereleases: bool = False) -> bool:
    """
    ...
    Args:
        ...
        package_name: The name of the package on PyPI
        include_prereleases: If True, include beta/alpha/rc versions in check
    ...
    try:
        ...
        if include_prereleases:
            print("Checking for updates (including pre-releases)...")
            logger.info("Checking for updates including pre-releases")
        else:
            print("Checking for updates...")
        
        latest = get_latest_version_from_pypi(package_name, include_prereleases=include_prereleases)
