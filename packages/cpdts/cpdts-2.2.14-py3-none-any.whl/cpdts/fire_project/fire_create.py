...
def creat_process(project_name):
    ...
    items = {
        ...
        f"src/scripts/clean":{
            "template":"templates/src/scripts/clean"
        },
        f"src/scripts/build":{
            "template":"templates/src/scripts/build"
        },
        f"src/scripts/public":{
            "template":"templates/src/scripts/public"
        },
        f"src/scripts/ccx":{
            "template":"templates/src/scripts/ccx"
        },
