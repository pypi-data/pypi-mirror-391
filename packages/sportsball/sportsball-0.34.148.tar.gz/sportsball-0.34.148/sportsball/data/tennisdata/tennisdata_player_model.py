...
def _create_tennisdata_player_model(
    name: str,
    league: League,
    version: str,
) -> PlayerModel:
    return PlayerModel(
        ...
        father=None,
        sex=str(Sex.FEMALE) if league == League.WTA else str(Sex.MALE),
        age=None,
...
def _cached_create_tennisdata_player_model(
    name: str,
    league: League,
    version: str,
) -> PlayerModel:
    return _create_tennisdata_player_model(
        name=name,
        league=league,
        version=version,
    )
...
def create_tennisdata_player_model(
    name: str,
    league: League,
) -> PlayerModel:
    """Create a player model from tennisdata."""
    if not pytest_is_running.is_running():
        return _cached_create_tennisdata_player_model(
            name=name,
            league=league,
            version=VERSION,
        )
