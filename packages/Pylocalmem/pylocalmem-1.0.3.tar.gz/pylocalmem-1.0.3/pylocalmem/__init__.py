...
class Process():
    ...
    def hide_module(self, module:str):
        ...
        def replace_flink_blink(_address):
            ...
            self.write_longlong(blink + 0x0, flink)

            # Go to next module and replace its blink
            self.write_longlong(flink + 0x8, blink)
        ...
        def process_module_list(module_list, module, offset):
            ...
            while True:
                ...
                if unicode_string.Buffer and unicode_string.Length: # Apparently all of a sudden in this windows install sometimes we get a invalid buffer or invalid length so this wasnt needed before
