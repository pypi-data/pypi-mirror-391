class Media:
  ...
  # ------------------------
    ...
    def create_media(self, avatar_id=None, banner_id=None, image_id=None):
        ...
        return self.client._post("/media/media", data)

    def get_media(self, media_id):
        """Получить объект Media по media_id"""
        return self.client._get(f"/media/media/{media_id}")
    ...
    def update_media(self, media_id, avatar_id=None, banner_id=None, image_id=None):
        ...
        if image_id is not None:
            data["image_id"] = image_id
        return self.client._put(f"/media/media/{media_id}", data)

    def delete_media(self, media_id):
        """Удалить объект Media"""
        return self.client._delete(f"/media/media/{media_id}")