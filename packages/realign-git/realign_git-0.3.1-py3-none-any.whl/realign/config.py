...
redact_on_match: false           # Whether to automatically redact detected sensitive information (not implemented in MVP)
...
# export ANTHROPIC_API_KEY="your-anthropic-api-key"  # Recommended: Claude (Anthropic)
# export OPENAI_API_KEY="your-openai-api-key"        # Or use OpenAI (GPT)
