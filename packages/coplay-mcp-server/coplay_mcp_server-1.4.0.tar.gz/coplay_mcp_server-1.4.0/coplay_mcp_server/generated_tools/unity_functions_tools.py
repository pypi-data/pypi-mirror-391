...
async def create_gameobject(
    ...
    try:
        logger.debug(f"Executing create_gameobject with parameters: {locals()}")
        ...
        logger.debug(f"create_gameobject completed successfully")
        return result

    except Exception as e:
        logger.error(f"Failed to execute create_gameobject: {e}")
...
async def delete_gameobject(
    ...
    try:
        logger.debug(f"Executing delete_gameobject with parameters: {locals()}")
        ...
        # Execute Unity RPC call
        result = await _unity_client.execute_request('delete_gameobject', params)
        logger.debug(f"delete_gameobject completed successfully")
        return result

    except Exception as e:
        logger.error(f"Failed to execute delete_gameobject: {e}")
        raise RuntimeError(f"Tool execution failed for delete_gameobject: {e}")
...
async def duplicate_gameobject(
    ...
    try:
        logger.debug(f"Executing duplicate_gameobject with parameters: {locals()}")
        ...
        # Execute Unity RPC call
        result = await _unity_client.execute_request('duplicate_gameobject', params)
        logger.debug(f"duplicate_gameobject completed successfully")
        return result

    except Exception as e:
        logger.error(f"Failed to execute duplicate_gameobject: {e}")
        raise RuntimeError(f"Tool execution failed for duplicate_gameobject: {e}")


async def parent_gameobject(
    ...
    try:
        logger.debug(f"Executing parent_gameobject with parameters: {locals()}")
        ...
        # Execute Unity RPC call
        result = await _unity_client.execute_request('parent_gameobject', params)
        logger.debug(f"parent_gameobject completed successfully")
        return result

    except Exception as e:
        logger.error(f"Failed to execute parent_gameobject: {e}")
        raise RuntimeError(f"Tool execution failed for parent_gameobject: {e}")


async def rename_gameobject(
    ...
    try:
        logger.debug(f"Executing rename_gameobject with parameters: {locals()}")
        ...
        # Execute Unity RPC call
        result = await _unity_client.execute_request('rename_gameobject', params)
        logger.debug(f"rename_gameobject completed successfully")
        return result

    except Exception as e:
        logger.error(f"Failed to execute rename_gameobject: {e}")
        raise RuntimeError(f"Tool execution failed for rename_gameobject: {e}")
...
def register_tools(mcp: FastMCP, unity_client: UnityRpcClient) -> None:
    ...
    # Register create_gameobject
    mcp.tool()(create_gameobject)
    # Register delete_gameobject
    ...
    # Register duplicate_gameobject
    mcp.tool()(duplicate_gameobject)
    # Register parent_gameobject
    mcp.tool()(parent_gameobject)
    # Register rename_gameobject
    mcp.tool()(rename_gameobject)
    # Register set_tag
    mcp.tool()(set_tag)
    # Register set_layer
    mcp.tool()(set_layer)
