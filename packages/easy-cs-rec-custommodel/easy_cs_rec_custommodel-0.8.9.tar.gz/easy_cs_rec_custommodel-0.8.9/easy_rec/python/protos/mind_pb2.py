...
_MIND_USERSEQCOMBINEMETHOD = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            name='CONCAT', index=0, number=0, options=None, type=None),
        _descriptor.EnumValueDescriptor(
...
_CAPSULE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='max_k',
            full_name='protos.Capsule.max_k',
            index=0,
            number=1,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name='max_seq_len',
            full_name='protos.Capsule.max_seq_len',
            index=1,
            number=2,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name='high_dim',
            full_name='protos.Capsule.high_dim',
            index=2,
            number=3,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name='num_iters',
            full_name='protos.Capsule.num_iters',
            index=3,
            number=4,
            type=13,
            cpp_type=3,
            ...
            options=None),
        _descriptor.FieldDescriptor(
            name='routing_logits_scale',
            full_name='protos.Capsule.routing_logits_scale',
            index=4,
            number=5,
            type=2,
            cpp_type=6,
            ...
            options=None),
        _descriptor.FieldDescriptor(
            name='routing_logits_stddev',
            full_name='protos.Capsule.routing_logits_stddev',
            index=5,
            number=6,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name='squash_pow',
            full_name='protos.Capsule.squash_pow',
            index=6,
            number=7,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name='scale_ratio',
            full_name='protos.Capsule.scale_ratio',
            index=7,
            number=8,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name='const_caps_num',
            full_name='protos.Capsule.const_caps_num',
            index=8,
            number=9,
            type=8,
            cpp_type=7,
...
_MIND = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='pre_capsule_dnn',
            full_name='protos.MIND.pre_capsule_dnn',
            index=0,
            number=101,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='user_dnn',
            full_name='protos.MIND.user_dnn',
            index=1,
            number=102,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='concat_dnn',
            full_name='protos.MIND.concat_dnn',
            index=2,
            number=103,
            type=11,
            cpp_type=10,
            ...
            options=None),
        _descriptor.FieldDescriptor(
            name='user_seq_combine',
            full_name='protos.MIND.user_seq_combine',
            index=3,
            number=104,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='item_dnn',
            full_name='protos.MIND.item_dnn',
            index=4,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='capsule_config',
            full_name='protos.MIND.capsule_config',
            index=5,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='simi_pow',
            full_name='protos.MIND.simi_pow',
            index=6,
            number=4,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name='simi_func',
            full_name='protos.MIND.simi_func',
            index=7,
            number=5,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='scale_simi',
            full_name='protos.MIND.scale_simi',
            index=8,
            number=6,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='protos.MIND.l2_regularization',
            index=9,
            number=7,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name='time_id_fea',
            full_name='protos.MIND.time_id_fea',
            index=10,
            number=8,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            options=None),
        _descriptor.FieldDescriptor(
            name='ignore_in_batch_neg_sam',
            full_name='protos.MIND.ignore_in_batch_neg_sam',
            index=12,
            number=10,
            type=8,
            cpp_type=7,
            ...
            options=None),
        _descriptor.FieldDescriptor(
            name='max_interests_simi',
            full_name='protos.MIND.max_interests_simi',
            index=13,
            number=11,
            type=2,
            cpp_type=6,
...
_MIND.fields_by_name[
    'pre_capsule_dnn'].message_type = easy__rec_dot_python_dot_protos_dot_dnn__pb2._DNN
_MIND.fields_by_name[
    'user_dnn'].message_type = easy__rec_dot_python_dot_protos_dot_dnn__pb2._DNN
_MIND.fields_by_name[
    'concat_dnn'].message_type = easy__rec_dot_python_dot_protos_dot_dnn__pb2._DNN
_MIND.fields_by_name['user_seq_combine'].enum_type = _MIND_USERSEQCOMBINEMETHOD
_MIND.fields_by_name[
    'item_dnn'].message_type = easy__rec_dot_python_dot_protos_dot_dnn__pb2._DNN
...
MIND = _reflection.GeneratedProtocolMessageType(
    'MIND',
    (_message.Message,),
    dict(
        DESCRIPTOR=_MIND,
