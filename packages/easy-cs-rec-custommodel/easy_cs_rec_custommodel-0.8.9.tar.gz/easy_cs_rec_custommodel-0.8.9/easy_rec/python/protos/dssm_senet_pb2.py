...
_DSSM_SENET_TOWER = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='id',
            full_name='protos.DSSM_SENet_Tower.id',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='senet',
            full_name='protos.DSSM_SENet_Tower.senet',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='dnn',
            full_name='protos.DSSM_SENet_Tower.dnn',
            index=2,
            number=3,
            type=11,
            cpp_type=10,
...
_DSSM_SENET = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='user_tower',
            full_name='protos.DSSM_SENet.user_tower',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='item_tower',
            full_name='protos.DSSM_SENet.item_tower',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='protos.DSSM_SENet.l2_regularization',
            index=2,
            number=3,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name='simi_func',
            full_name='protos.DSSM_SENet.simi_func',
            index=3,
            number=4,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='scale_simi',
            full_name='protos.DSSM_SENet.scale_simi',
            index=4,
            number=5,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name='item_id',
            full_name='protos.DSSM_SENet.item_id',
            index=5,
            number=9,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='protos.DSSM_SENet.ignore_in_batch_neg_sam',
            index=6,
            number=10,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name='temperature',
            full_name='protos.DSSM_SENet.temperature',
            index=7,
            number=11,
            type=2,
            cpp_type=6,
...
_DSSM_SENET_TOWER.fields_by_name[
...
DSSM_SENet_Tower = _reflection.GeneratedProtocolMessageType(
    'DSSM_SENet_Tower',
    (_message.Message,),
    dict(
...
DSSM_SENet = _reflection.GeneratedProtocolMessageType(
    'DSSM_SENet',
    (_message.Message,),
    dict(
