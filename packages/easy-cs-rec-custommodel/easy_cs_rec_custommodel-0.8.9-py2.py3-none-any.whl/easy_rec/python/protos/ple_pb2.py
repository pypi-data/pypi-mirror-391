...
_EXTRACTIONNETWORK = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='network_name',
            full_name='protos.ExtractionNetwork.network_name',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
            ...
            options=None),
        _descriptor.FieldDescriptor(
            name='expert_num_per_task',
            full_name='protos.ExtractionNetwork.expert_num_per_task',
            index=1,
            number=2,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name='share_num',
            full_name='protos.ExtractionNetwork.share_num',
            index=2,
            number=3,
            type=13,
            cpp_type=3,
            ...
            options=None),
        _descriptor.FieldDescriptor(
            name='task_expert_net',
            full_name='protos.ExtractionNetwork.task_expert_net',
            index=3,
            number=4,
            type=11,
            cpp_type=10,
            ...
            options=None),
        _descriptor.FieldDescriptor(
            name='share_expert_net',
            full_name='protos.ExtractionNetwork.share_expert_net',
            index=4,
            number=5,
            type=11,
            cpp_type=10,
...
_PLE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='extraction_networks',
            full_name='protos.PLE.extraction_networks',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='task_towers',
            full_name='protos.PLE.task_towers',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='protos.PLE.l2_regularization',
            index=2,
            number=3,
            type=2,
            cpp_type=6,
...
_EXTRACTIONNETWORK.fields_by_name[
    'task_expert_net'].message_type = easy__rec_dot_python_dot_protos_dot_dnn__pb2._DNN
_EXTRACTIONNETWORK.fields_by_name[
    'share_expert_net'].message_type = easy__rec_dot_python_dot_protos_dot_dnn__pb2._DNN
_PLE.fields_by_name['extraction_networks'].message_type = _EXTRACTIONNETWORK
_PLE.fields_by_name[
    'task_towers'].message_type = easy__rec_dot_python_dot_protos_dot_tower__pb2._TASKTOWER
DESCRIPTOR.message_types_by_name['ExtractionNetwork'] = _EXTRACTIONNETWORK
DESCRIPTOR.message_types_by_name['PLE'] = _PLE
_sym_db.RegisterFileDescriptor(DESCRIPTOR)

ExtractionNetwork = _reflection.GeneratedProtocolMessageType(
    'ExtractionNetwork',
    (_message.Message,),
    dict(
...
PLE = _reflection.GeneratedProtocolMessageType(
    'PLE',
    (_message.Message,),
    dict(
        DESCRIPTOR=_PLE,
