...
_DBMTL = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='bottom_cmbf',
            full_name='protos.DBMTL.bottom_cmbf',
            index=0,
            number=101,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='bottom_uniter',
            full_name='protos.DBMTL.bottom_uniter',
            index=1,
            number=102,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='bottom_dnn',
            full_name='protos.DBMTL.bottom_dnn',
            index=2,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='expert_dnn',
            full_name='protos.DBMTL.expert_dnn',
            index=3,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='num_expert',
            full_name='protos.DBMTL.num_expert',
            index=4,
            number=3,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name='task_towers',
            full_name='protos.DBMTL.task_towers',
            index=5,
            number=4,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='protos.DBMTL.l2_regularization',
            index=6,
            number=5,
            type=2,
            cpp_type=6,
...
_DBMTL.fields_by_name[
    'bottom_cmbf'].message_type = easy__rec_dot_python_dot_protos_dot_cmbf__pb2._CMBFTOWER
_DBMTL.fields_by_name[
    'bottom_uniter'].message_type = easy__rec_dot_python_dot_protos_dot_uniter__pb2._UNITERTOWER
_DBMTL.fields_by_name[
    'bottom_dnn'].message_type = easy__rec_dot_python_dot_protos_dot_dnn__pb2._DNN
_DBMTL.fields_by_name[
    'expert_dnn'].message_type = easy__rec_dot_python_dot_protos_dot_dnn__pb2._DNN
_DBMTL.fields_by_name[
...
DBMTL = _reflection.GeneratedProtocolMessageType(
    'DBMTL',
    (_message.Message,),
    dict(
        DESCRIPTOR=_DBMTL,
