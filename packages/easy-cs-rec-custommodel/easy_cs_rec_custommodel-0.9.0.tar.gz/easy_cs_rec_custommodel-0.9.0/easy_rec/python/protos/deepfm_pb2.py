...
_DEEPFM = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name='final_dnn',
            full_name='protos.DeepFM.final_dnn',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='protos.DeepFM.wide_output_dim',
            index=2,
            number=3,
            type=13,
            cpp_type=3,
            ...
            options=None),
        _descriptor.FieldDescriptor(
            name='wide_regularization',
            full_name='protos.DeepFM.wide_regularization',
            index=3,
            number=4,
            type=2,
            cpp_type=6,
            ...
            options=None),
        _descriptor.FieldDescriptor(
            name='dense_regularization',
            full_name='protos.DeepFM.dense_regularization',
            index=4,
            number=5,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='protos.DeepFM.l2_regularization',
            index=5,
            number=6,
            type=2,
            cpp_type=6,
...
DeepFM = _reflection.GeneratedProtocolMessageType(
    'DeepFM',
    (_message.Message,),
    dict(
        DESCRIPTOR=_DEEPFM,
