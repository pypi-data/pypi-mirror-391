...
class Correlations:
    ...
    def average_chunks(self, listOfChunks):
        ...
        for corr in listOfCorr2:
            Gtemp = getattr(self, corr + 'chunk0') * 0
            GtempSquared = getattr(self, corr + 'chunk0') * 0
            for chunk in listOfChunks:
                Gtemp += getattr(self, corr + 'chunk' + str(chunk))
                GtempSquared += getattr(self, corr + 'chunk' + str(chunk))**2
            ...
            setattr(self, corr + 'averageX', Gtot)
