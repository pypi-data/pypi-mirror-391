...
if TYPE_CHECKING:
    from zempy.zosapi.application.protocols.IApplication import IApplication  # IZOSAPI_Application owner
    ...
    from zempy.zosapi.tools.protocols.IOpticalSystemTools import IOpticalSystemTools
    from zempy.zosapi.systemdata.protocols.ISystemData import ISystemData
    from zempy.zosapi.editors.lde.protocols.ILensDataEditor import ILensDataEditor
