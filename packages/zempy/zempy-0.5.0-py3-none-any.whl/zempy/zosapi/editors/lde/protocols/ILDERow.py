...
from zempy.zosapi.editors.enums.SurfaceType import SurfaceType
from zempy.zosapi.editors.lde.enums.SurfaceColumn import SurfaceColumn
if TYPE_CHECKING:
    from zempy.zosapi.editors.protocols.IEditorCell import IEditorCell
    from zempy.zosapi.editors.lde.protocols.ISurfaceTypeSettings import ISurfaceTypeSettings
    from zempy.zosapi.editors.lde.protocols.ISurface import ISurface
    from zempy.zosapi.editors.lde.protocols.ICoatingPerformanceData import ICoatingPerformanceData
    from zempy.zosapi.common.protocols.IMetaData import IMetadata
