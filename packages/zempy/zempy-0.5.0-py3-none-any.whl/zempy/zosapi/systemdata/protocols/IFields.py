...
if TYPE_CHECKING:
    from zempy.zosapi.systemdata.protocols.IField import IField
    from zempy.zosapi.analysis.protocols.IMessage import IMessage
    from zempy.zosapi.systemdata.enums.FieldType import FieldType
    from zempy.zosapi.systemdata.enums.FieldPattern import FieldPattern
    from zempy.zosapi.systemdata.enums.FieldNormalizationType import FieldNormalizationType
