...
from zempy.zosapi.analysis.data.adapters.RayInfo import RayInfo

if TYPE_CHECKING:
    from zempy.zosapi.analysis.data.protocols.IAR_RayData import IAR_RayData as IAR_RayDataProto
    from zempy.zosapi.analysis.data.protocols.IAR_RayInfo import IAR_RayInfo as IAR_RayInfoProto
