...
if TYPE_CHECKING:
    ...
    from zempy.zosapi.analysis.data.protocols.IAR_PathAnalysisEntry import IAR_PathAnalysisEntry
    from zempy.zosapi.analysis.data.adapters.PathAnalysisEntry import PathAnalysisEntry
