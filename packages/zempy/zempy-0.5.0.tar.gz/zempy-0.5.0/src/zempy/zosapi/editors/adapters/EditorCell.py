...
from zempy.zosapi.editors.enums.CellDataType import CellDataType
from zempy.zosapi.editors.enums.SolveType import SolveType
from zempy.zosapi.editors.enums.SolveStatus import SolveStatus
from zempy.zosapi.editors.adapters.EditorRow import EditorRow

if TYPE_CHECKING:
    from zempy.zosapi.editors.protocols.ISolveData import ISolveData
