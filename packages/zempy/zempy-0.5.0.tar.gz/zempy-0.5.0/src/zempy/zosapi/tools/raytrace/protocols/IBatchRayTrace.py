...
if TYPE_CHECKING:
    from zempy.zosapi.tools.protocols.ISystemTool import ISystemTool
    from zempy.zosapi.tools.raytrace.protocols.IRayTraceNormUnpolData import (
        IRayTraceNormUnpolData,
    )
    from zempy.zosapi.tools.raytrace.protocols.IRayTraceDirectUnpolData import (
        IRayTraceDirectUnpolData,
    )
    from zempy.zosapi.tools.raytrace.protocols.IRayTraceDirectPolData import (
        IRayTraceDirectPolData,
    )
    from zempy.zosapi.tools.raytrace.protocols.IRayTraceNormPolData import (
        IRayTraceNormPolData,
    )

    from zempy.zosapi.tools.raytrace.protocols.IRayTraceNSCData import (
        IRayTraceNSCData,
    )

    from zempy.zosapi.tools.raytrace.protocols.IRayTraceNSCSourceData import (
