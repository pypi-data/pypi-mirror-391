"""Command line utility for inspecting a CRSD file"""
...
def _parser():
    parser = argparse.ArgumentParser(description="Display information about CRSD files")
...
def main(args=None):
    ...
    with open(config.filename, "rb") as file:
        _, kvp_list = skcrsd.read_file_header(file)
