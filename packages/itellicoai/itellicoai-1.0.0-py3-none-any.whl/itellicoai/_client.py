...
class Itellicoai(SyncAPIClient):
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new synchronous Itellicoai client instance.

        This automatically infers the `api_key` argument from the `ITELLICOAI_API_KEY` environment variable if it is not provided.
        """
        if api_key is None:
            api_key = os.environ.get("ITELLICOAI_API_KEY")
        if api_key is None:
            raise ItellicoaiError(
                "The api_key client option must be set either by passing api_key to the client or by setting the ITELLICOAI_API_KEY environment variable"
            )
...
class AsyncItellicoai(AsyncAPIClient):
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new async AsyncItellicoai client instance.
