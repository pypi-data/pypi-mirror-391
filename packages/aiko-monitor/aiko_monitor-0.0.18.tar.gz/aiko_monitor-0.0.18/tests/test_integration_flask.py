...
def flask_fixture():
    ...
    def post_empty():
        ...
        return jsonify({"message": "POST empty success", "size": len(raw)})
...
def test_post_empty_body_records_none(flask_fixture):
    fx = flask_fixture
...
def test_response_body_none_for_204(flask_fixture):
    fx = flask_fixture
