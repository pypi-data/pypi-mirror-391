...
def test_body_from_content_type_empty():
    assert body_from_content_type("application/json", b"") is None
    assert body_from_content_type("text/html", b"") is None
    assert body_from_content_type("application/octet-stream", b"") is None
