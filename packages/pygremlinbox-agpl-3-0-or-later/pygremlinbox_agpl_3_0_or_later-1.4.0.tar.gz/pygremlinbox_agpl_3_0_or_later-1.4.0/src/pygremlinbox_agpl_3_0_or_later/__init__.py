...
"""
PyGremlinBox AGPL-3.0-or-later - Supply chain security testing module.

This package is licenced under AGPL-3.0-or-later.
...
maintaining compliance with AGPL-3.0-or-later requirements.
"""
...
def get_package_metadata():
    ...
    """
    return {
        "name": "PyGremlinBox-AGPL-3-0-or-later",
        "version": __version__,
        "licence": __licence__,
        "description": "Supply chain security testing module with AGPL-3.0-or-later licence",
        "spdx_licence_id": "AGPL-3.0-or-later"
    }
