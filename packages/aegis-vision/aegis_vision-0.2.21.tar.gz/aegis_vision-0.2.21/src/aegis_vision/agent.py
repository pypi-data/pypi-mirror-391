...
"""
    ...
    def _run_training_script(
        ...
        training_config = {
            ...
            'labelStrategy': config.get('labelStrategy', 'merge_all'),  # 'merge_all' or 'base_dataset'
            'baseDatasetIndex': config.get('baseDatasetIndex', None),  # Index of base dataset (0-based)
            'baseDatasetName': config.get('baseDatasetName', None),  # Name of base dataset for matching
