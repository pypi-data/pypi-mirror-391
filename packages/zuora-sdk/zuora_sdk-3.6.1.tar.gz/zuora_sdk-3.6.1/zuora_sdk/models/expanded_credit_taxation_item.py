...
class ExpandedCreditTaxationItem(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["accountingCode", "appliedAmount", "exemptAmount", "jurisdiction", "locationCode", "name", "refundAmount", "taxableAmount", "taxAmount", "taxCode", "taxCodeDescription", "taxDate", "periodEndDate", "periodStartDate", "taxMode", "taxRate", "taxRateDescription", "taxRateType", "unappliedAmount", "creditMemoItemId", "taxableItemSnapshotId", "taxationItemId", "id", "createdById", "createdDate", "updatedById", "updatedDate", "journalEntryId", "accountReceivableAccountingCodeId", "salesTaxPayableAccountingCodeId", "onAccountAccountingCodeId"]
