...
class AttachInvoiceScheduleRequest(BaseModel):
    ...
    specific_subscriptions: Optional[List[InvoiceScheduleSubscription]] = Field(default=None, description="A list of the numbers of specific charge numbers to be attached to the invoice schedule ", alias="specificSubscriptions")
