...
class ExpandedRatePlanCharge(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["prepaidUOM", "drawdownUom", "recognizedRevenueAccountingCodeId", "ratePlanId", "productRatePlanChargeId", "accountingCode", "accountingCodeEntityId", "applyDiscountTo", "billCycleDay", "billCycleType", "billingPeriod", "billingPeriodAlignment", "billingTiming", "chargedThroughDate", "chargeFunction", "chargeModel", "chargeNumber", "chargeType", "description", "discountLevel", "dMRC", "drawdownRate", "dTCV", "effectiveEndDate", "effectiveStartDate", "endDateCondition", "excludeItemBookingFromRevenueAccounting", "reflectDiscountInNetAmount", "revenueRecognitionTiming", "revenueAmortizationMethod", "excludeItemBillingFromRevenueAccounting", "invoiceScheduleId", "isLastSegment", "isPrepaid", "isRollover", "rolloverPeriods", "rolloverPeriodLength", "rolloverApply", "isProcessed", "listPriceBase", "specificListPriceBase", "priceUpsellQuantityStacked", "commitmentType", "isCommitted", "mRR", "name", "numberOfPeriods", "originalId", "overageCalculationOption", "overageUnusedUnitsCreditOption", "prepaidOperationType", "prepaidQuantity", "prepaidTotalQuantity", "salesPrice", "estimatedStartDate", "estimatedEndDate", "priceChangeOption", "priceIncreasePercentage", "processedThroughDate", "prorationOption", "quantity", "numberOfDeliveries", "ratingGroup", "revenueRecognitionRuleName", "revRecCode", "revRecTriggerCondition", "segment", "specificBillingPeriod", "specificEndDate", "taxable", "taxCodeName", "taxModeOption", "tCV", "triggerDate", "triggerEvent", "uOM", "upToPeriods", "upToPeriodsType", "version", "weeklyBillCycleDay", "id", "createdById", "createdDate", "updatedById", "updatedDate", "subscriptionId", "subscriptionOwnerId", "invoiceOwnerId", "originalOrderDate", "amendedByOrderOn", "validityPeriodType", "creditOption", "applyToBillingPeriodPartially", "productChargeDefinitionId", "reverted", "originalListPrice", "upsellOriginChargeNumber", "deferredRevenueAccountingCodeId", "isProratePartialMonth", "prorationUnit", "daysInMonth", "accountReceivableAccountingCodeId", "ratePlan", "productRatePlanCharge", "ratePlanChargeTiers"]
