...
class ExpandedUsage(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["fileId", "fileName", "accountId", "accountNumber", "ratePlanChargeId", "endDateTime", "productRatePlanChargeId", "quantity", "rbeStatus", "sourceType", "startDateTime", "subscriptionId", "submissionDateTime", "uOM", "description", "id", "createdById", "createdDate", "updatedById", "updatedDate", "importId", "uniqueKey", "account"]
