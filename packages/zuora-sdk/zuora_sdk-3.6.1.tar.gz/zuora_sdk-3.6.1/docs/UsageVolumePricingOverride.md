...
usage_volume_pricing_override_instance = UsageVolumePricingOverride.from_json(json)
# print the JSON string representation of the object
print(UsageVolumePricingOverride.to_json())

# convert the object into a dict
usage_volume_pricing_override_dict = usage_volume_pricing_override_instance.to_dict()
# create an instance of UsageVolumePricingOverride from a dict
usage_volume_pricing_override_from_dict = UsageVolumePricingOverride.from_dict(usage_volume_pricing_override_dict)
```
