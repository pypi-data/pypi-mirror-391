# zuora_sdk.PaymentMethodTransactionLogsApi

All URIs are relative to *https://rest.zuora.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_payment_method_transaction_log**](PaymentMethodTransactionLogsApi.md#get_payment_method_transaction_log) | **GET** /v1/object/payment-method-transaction-log/{id} | CRUD: Retrieve a payment method transaction log


# **get_payment_method_transaction_log**
> PaymentMethodTransactionLogResponse get_payment_method_transaction_log(id, accept_encoding=accept_encoding, content_encoding=content_encoding, authorization=authorization, zuora_entity_ids=zuora_entity_ids, zuora_track_id=zuora_track_id, fields=fields, zuora_version=zuora_version, zuora_org_ids=zuora_org_ids)
...
with zuora_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = zuora_sdk.PaymentMethodTransactionLogsApi(api_client)
    ...
    try:
        # CRUD: Retrieve a payment method transaction log
        api_response = api_instance.get_payment_method_transaction_log(id, accept_encoding=accept_encoding, content_encoding=content_encoding, authorization=authorization, zuora_entity_ids=zuora_entity_ids, zuora_track_id=zuora_track_id, fields=fields, zuora_version=zuora_version, zuora_org_ids=zuora_org_ids)
        print("The response of PaymentMethodTransactionLogsApi->get_payment_method_transaction_log:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PaymentMethodTransactionLogsApi->get_payment_method_transaction_log: %s\n" % e)
```
...
[**PaymentMethodTransactionLogResponse**](PaymentMethodTransactionLogResponse.md)
