...
create_order_change_plan_rate_plan_override_instance = CreateOrderChangePlanRatePlanOverride.from_json(json)
# print the JSON string representation of the object
print(CreateOrderChangePlanRatePlanOverride.to_json())

# convert the object into a dict
create_order_change_plan_rate_plan_override_dict = create_order_change_plan_rate_plan_override_instance.to_dict()
# create an instance of CreateOrderChangePlanRatePlanOverride from a dict
create_order_change_plan_rate_plan_override_from_dict = CreateOrderChangePlanRatePlanOverride.from_dict(create_order_change_plan_rate_plan_override_dict)
```
