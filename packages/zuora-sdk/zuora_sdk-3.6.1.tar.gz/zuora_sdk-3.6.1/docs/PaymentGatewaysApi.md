# zuora_sdk.PaymentGatewaysApi

All URIs are relative to *https://rest.zuora.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**create_predebit_notification**](PaymentGatewaysApi.md#create_predebit_notification) | **POST** /v1/payment-gateways/pre-debit-notification | Trigger a pre-debit notification
[**get_payment_gateways**](PaymentGatewaysApi.md#get_payment_gateways) | **GET** /v1/payment-gateways | List all payment gateways


# **create_predebit_notification**
> CreatePaymentPredebitNotifyResponse create_predebit_notification(request, accept_encoding=accept_encoding, content_encoding=content_encoding, authorization=authorization, zuora_track_id=zuora_track_id, zuora_entity_ids=zuora_entity_ids, zuora_version=zuora_version, zuora_org_ids=zuora_org_ids)

Trigger a pre-debit notification

Triggers a pre-debit notification for an invoice and sends a request to the gateway. This is currently applicable/functional ONLY for the Adyen payment gateway. 
...
with zuora_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = zuora_sdk.PaymentGatewaysApi(api_client)
    request = zuora_sdk.CreatePaymentPredebitNotifyRequest() # CreatePaymentPredebitNotifyRequest | 
    ...
    try:
        # Trigger a pre-debit notification
        api_response = api_instance.create_predebit_notification(request, accept_encoding=accept_encoding, content_encoding=content_encoding, authorization=authorization, zuora_track_id=zuora_track_id, zuora_entity_ids=zuora_entity_ids, zuora_version=zuora_version, zuora_org_ids=zuora_org_ids)
        print("The response of PaymentGatewaysApi->create_predebit_notification:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PaymentGatewaysApi->create_predebit_notification: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **request** | [**CreatePaymentPredebitNotifyRequest**](CreatePaymentPredebitNotifyRequest.md)|  | 
...
[**CreatePaymentPredebitNotifyResponse**](CreatePaymentPredebitNotifyResponse.md)
...
> PaymentGatewaysResponse get_payment_gateways(accept_encoding=accept_encoding, content_encoding=content_encoding, authorization=authorization, zuora_track_id=zuora_track_id, zuora_entity_ids=zuora_entity_ids, zuora_version=zuora_version, zuora_org_ids=zuora_org_ids)
...
with zuora_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # List all payment gateways
        api_response = api_instance.get_payment_gateways(accept_encoding=accept_encoding, content_encoding=content_encoding, authorization=authorization, zuora_track_id=zuora_track_id, zuora_entity_ids=zuora_entity_ids, zuora_version=zuora_version, zuora_org_ids=zuora_org_ids)
        print("The response of PaymentGatewaysApi->get_payment_gateways:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PaymentGatewaysApi->get_payment_gateways: %s\n" % e)
```
...
[**PaymentGatewaysResponse**](PaymentGatewaysResponse.md)
