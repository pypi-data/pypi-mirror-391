# zuora_sdk.PaymentMethodSnapshotsApi

All URIs are relative to *https://rest.zuora.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_payment_method_snapshot**](PaymentMethodSnapshotsApi.md#get_payment_method_snapshot) | **GET** /v1/object/payment-method-snapshot/{id} | CRUD: Retrieve a payment method snapshot


# **get_payment_method_snapshot**
> PaymentMethodSnapshotResponse get_payment_method_snapshot(id, accept_encoding=accept_encoding, content_encoding=content_encoding, authorization=authorization, zuora_entity_ids=zuora_entity_ids, zuora_track_id=zuora_track_id, fields=fields, zuora_version=zuora_version, zuora_org_ids=zuora_org_ids)
...
with zuora_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = zuora_sdk.PaymentMethodSnapshotsApi(api_client)
    ...
    try:
        # CRUD: Retrieve a payment method snapshot
        api_response = api_instance.get_payment_method_snapshot(id, accept_encoding=accept_encoding, content_encoding=content_encoding, authorization=authorization, zuora_entity_ids=zuora_entity_ids, zuora_track_id=zuora_track_id, fields=fields, zuora_version=zuora_version, zuora_org_ids=zuora_org_ids)
        print("The response of PaymentMethodSnapshotsApi->get_payment_method_snapshot:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PaymentMethodSnapshotsApi->get_payment_method_snapshot: %s\n" % e)
```
...
[**PaymentMethodSnapshotResponse**](PaymentMethodSnapshotResponse.md)
