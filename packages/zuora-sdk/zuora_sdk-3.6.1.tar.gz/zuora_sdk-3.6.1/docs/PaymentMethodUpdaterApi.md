# zuora_sdk.PaymentMethodUpdaterApi

All URIs are relative to *https://rest.zuora.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**create_payment_method_updater_batch**](PaymentMethodUpdaterApi.md#create_payment_method_updater_batch) | **POST** /v1/payment-method-updaters/batches | Create a Payment Method Updater batch asynchronously
[**get_payment_method_updater_instances**](PaymentMethodUpdaterApi.md#get_payment_method_updater_instances) | **GET** /v1/payment-method-updaters | List Payment Method Updater instances


# **create_payment_method_updater_batch**
> CreatePaymentMethodUpdaterBatchResponse create_payment_method_updater_batch(request, idempotency_key=idempotency_key, accept_encoding=accept_encoding, content_encoding=content_encoding, authorization=authorization, zuora_track_id=zuora_track_id, zuora_entity_ids=zuora_entity_ids, zuora_version=zuora_version, zuora_org_ids=zuora_org_ids)
...
with zuora_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = zuora_sdk.PaymentMethodUpdaterApi(api_client)
    request = zuora_sdk.CreatePaymentMethodUpdaterBatchRequest() # CreatePaymentMethodUpdaterBatchRequest | 
    ...
    try:
        # Create a Payment Method Updater batch asynchronously
        api_response = api_instance.create_payment_method_updater_batch(request, idempotency_key=idempotency_key, accept_encoding=accept_encoding, content_encoding=content_encoding, authorization=authorization, zuora_track_id=zuora_track_id, zuora_entity_ids=zuora_entity_ids, zuora_version=zuora_version, zuora_org_ids=zuora_org_ids)
        print("The response of PaymentMethodUpdaterApi->create_payment_method_updater_batch:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PaymentMethodUpdaterApi->create_payment_method_updater_batch: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **request** | [**CreatePaymentMethodUpdaterBatchRequest**](CreatePaymentMethodUpdaterBatchRequest.md)|  | 
...
[**CreatePaymentMethodUpdaterBatchResponse**](CreatePaymentMethodUpdaterBatchResponse.md)
...
# **get_payment_method_updater_instances**
> PaymentMethodUpdaterInstancesResponse get_payment_method_updater_instances(accept_encoding=accept_encoding, content_encoding=content_encoding, authorization=authorization, zuora_track_id=zuora_track_id, zuora_entity_ids=zuora_entity_ids, zuora_version=zuora_version, zuora_org_ids=zuora_org_ids)
...
with zuora_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # List Payment Method Updater instances
        api_response = api_instance.get_payment_method_updater_instances(accept_encoding=accept_encoding, content_encoding=content_encoding, authorization=authorization, zuora_track_id=zuora_track_id, zuora_entity_ids=zuora_entity_ids, zuora_version=zuora_version, zuora_org_ids=zuora_org_ids)
        print("The response of PaymentMethodUpdaterApi->get_payment_method_updater_instances:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PaymentMethodUpdaterApi->get_payment_method_updater_instances: %s\n" % e)
```
...
[**PaymentMethodUpdaterInstancesResponse**](PaymentMethodUpdaterInstancesResponse.md)
