...
payment_schedule_response_instance = PaymentScheduleResponse.from_json(json)
# print the JSON string representation of the object
print(PaymentScheduleResponse.to_json())

# convert the object into a dict
payment_schedule_response_dict = payment_schedule_response_instance.to_dict()
# create an instance of PaymentScheduleResponse from a dict
payment_schedule_response_from_dict = PaymentScheduleResponse.from_dict(payment_schedule_response_dict)
```
