...
update_credit_memo_request_instance = UpdateCreditMemoRequest.from_json(json)
# print the JSON string representation of the object
print(UpdateCreditMemoRequest.to_json())

# convert the object into a dict
update_credit_memo_request_dict = update_credit_memo_request_instance.to_dict()
# create an instance of UpdateCreditMemoRequest from a dict
update_credit_memo_request_from_dict = UpdateCreditMemoRequest.from_dict(update_credit_memo_request_dict)
```
