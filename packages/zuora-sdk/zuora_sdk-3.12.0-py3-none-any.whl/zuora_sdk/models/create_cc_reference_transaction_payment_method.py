...
class CreateCCReferenceTransactionPaymentMethod(BaseModel):
    ...
    card_holder_info: Optional[CreateCreditCardReferenceCardholderInfo] = Field(default=None, alias="cardHolderInfo")
    ...
    def to_alias_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Dict[str, Any]]:
        ...
        return {
            ...
            "cardHolderInfo": CreateCreditCardReferenceCardholderInfo.from_dict(obj["cardHolderInfo"]) if obj.get("cardHolderInfo") is not None else None,
