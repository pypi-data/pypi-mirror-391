...
class CreateBetalingsservicePaymentMethod(BaseModel):
    ...
    identity_number: Annotated[str, Field(min_length=1, strict=True)] = Field(description="The identity number of the customer.", alias="identityNumber")
    bank_code: Annotated[str, Field(min_length=1, strict=True)] = Field(description="The sort code or number that identifies the bank. This is also known as the sort code.", alias="bankCode")
