...
class ExpandedCommitment(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "commitmentNumber", "version", "accountNumber", "orderNumber", "name", "priority", "type", "description", "eligibleAccountConditions", "eligibleChargeConditions", "taxable", "taxCode", "taxMode", "currency", "cyclePeriodType", "cyclePeriodLength", "cycleDayType", "cycleDay", "cycleAlignmentDate", "accountingCode", "adjustmentLiabilityAccountingCode", "adjustmentRevenueAccountingCode", "contractAssetAccountingCode", "contractLiabilityAccountingCode", "contractRecognizedRevenueAccountingCode", "deferredRevenueAccountingCode", "excludeItemBillingFromRevenueAccounting", "excludeItemBookingFromRevenueAccounting", "isAllocationEligible", "isUnbilled", "recognizedRevenueAccountingCode", "revenueRecognitionRuleName", "unbilledReceivablesAccountingCode", "revenueRecognitionTiming", "revenueAmortizationMethod", "accountReceivableAccountingCode", "prorationOption", "createdDate", "updatedDate", "createdById", "updatedById"]
