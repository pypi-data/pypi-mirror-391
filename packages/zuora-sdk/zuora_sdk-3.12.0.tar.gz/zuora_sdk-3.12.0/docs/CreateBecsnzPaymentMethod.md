...
create_becsnz_payment_method_instance = CreateBecsnzPaymentMethod.from_json(json)
# print the JSON string representation of the object
print(CreateBecsnzPaymentMethod.to_json())

# convert the object into a dict
create_becsnz_payment_method_dict = create_becsnz_payment_method_instance.to_dict()
# create an instance of CreateBecsnzPaymentMethod from a dict
create_becsnz_payment_method_from_dict = CreateBecsnzPaymentMethod.from_dict(create_becsnz_payment_method_dict)
```
