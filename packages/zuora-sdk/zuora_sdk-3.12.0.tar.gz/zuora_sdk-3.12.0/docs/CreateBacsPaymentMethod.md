...
**account_number** | **str** | The number of the customer&#39;s bank account. | [optional] 
...
create_bacs_payment_method_instance = CreateBacsPaymentMethod.from_json(json)
# print the JSON string representation of the object
print(CreateBacsPaymentMethod.to_json())

# convert the object into a dict
create_bacs_payment_method_dict = create_bacs_payment_method_instance.to_dict()
# create an instance of CreateBacsPaymentMethod from a dict
create_bacs_payment_method_from_dict = CreateBacsPaymentMethod.from_dict(create_bacs_payment_method_dict)
```
