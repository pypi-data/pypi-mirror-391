...
create_sepa_payment_method_instance = CreateSEPAPaymentMethod.from_json(json)
# print the JSON string representation of the object
print(CreateSEPAPaymentMethod.to_json())

# convert the object into a dict
create_sepa_payment_method_dict = create_sepa_payment_method_instance.to_dict()
# create an instance of CreateSEPAPaymentMethod from a dict
create_sepa_payment_method_from_dict = CreateSEPAPaymentMethod.from_dict(create_sepa_payment_method_dict)
```
