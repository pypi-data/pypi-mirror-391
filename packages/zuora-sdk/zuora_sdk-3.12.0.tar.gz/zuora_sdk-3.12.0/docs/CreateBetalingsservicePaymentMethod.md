...
**bank_code** | **str** | The sort code or number that identifies the bank. This is also known as the sort code. | 
...
create_betalingsservice_payment_method_instance = CreateBetalingsservicePaymentMethod.from_json(json)
# print the JSON string representation of the object
print(CreateBetalingsservicePaymentMethod.to_json())

# convert the object into a dict
create_betalingsservice_payment_method_dict = create_betalingsservice_payment_method_instance.to_dict()
# create an instance of CreateBetalingsservicePaymentMethod from a dict
create_betalingsservice_payment_method_from_dict = CreateBetalingsservicePaymentMethod.from_dict(create_betalingsservice_payment_method_dict)
```
