...
**email** | **str** | Email address associated with the payment method. | 
...
create_pay_pal_adaptive_payment_method_instance = CreatePayPalAdaptivePaymentMethod.from_json(json)
# print the JSON string representation of the object
print(CreatePayPalAdaptivePaymentMethod.to_json())

# convert the object into a dict
create_pay_pal_adaptive_payment_method_dict = create_pay_pal_adaptive_payment_method_instance.to_dict()
# create an instance of CreatePayPalAdaptivePaymentMethod from a dict
create_pay_pal_adaptive_payment_method_from_dict = CreatePayPalAdaptivePaymentMethod.from_dict(create_pay_pal_adaptive_payment_method_dict)
```
