...
create_pay_pal_ec_payment_method_instance = CreatePayPalECPaymentMethod.from_json(json)
# print the JSON string representation of the object
print(CreatePayPalECPaymentMethod.to_json())

# convert the object into a dict
create_pay_pal_ec_payment_method_dict = create_pay_pal_ec_payment_method_instance.to_dict()
# create an instance of CreatePayPalECPaymentMethod from a dict
create_pay_pal_ec_payment_method_from_dict = CreatePayPalECPaymentMethod.from_dict(create_pay_pal_ec_payment_method_dict)
```
