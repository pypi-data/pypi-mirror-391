...
create_open_payment_method_instance = CreateOpenPaymentMethod.from_json(json)
# print the JSON string representation of the object
print(CreateOpenPaymentMethod.to_json())

# convert the object into a dict
create_open_payment_method_dict = create_open_payment_method_instance.to_dict()
# create an instance of CreateOpenPaymentMethod from a dict
create_open_payment_method_from_dict = CreateOpenPaymentMethod.from_dict(create_open_payment_method_dict)
```
