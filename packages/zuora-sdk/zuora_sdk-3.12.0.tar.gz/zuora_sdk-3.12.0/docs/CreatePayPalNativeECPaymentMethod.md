...
create_pay_pal_native_ec_payment_method_instance = CreatePayPalNativeECPaymentMethod.from_json(json)
# print the JSON string representation of the object
print(CreatePayPalNativeECPaymentMethod.to_json())

# convert the object into a dict
create_pay_pal_native_ec_payment_method_dict = create_pay_pal_native_ec_payment_method_instance.to_dict()
# create an instance of CreatePayPalNativeECPaymentMethod from a dict
create_pay_pal_native_ec_payment_method_from_dict = CreatePayPalNativeECPaymentMethod.from_dict(create_pay_pal_native_ec_payment_method_dict)
```
