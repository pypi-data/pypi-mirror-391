...
class UpdateAccountRequest(BaseModel):
    ...
    bill_to_contact_id: Optional[StrictStr] = Field(default=None, description="The ID of the contact that receives the bill. The contact must be   associated with the account. ", alias="billToContactId")
    bill_to_contact: Optional[UpdateAccountContact] = Field(default=None, alias="billToContact")
    ship_to_contact_id: Optional[StrictStr] = Field(default=None, description="The ID of the contact that receives the goods or services. The   contact must be associated with the account. ", alias="shipToContactId")
    ...
    sold_to_contact_id: Optional[StrictStr] = Field(default=None, description="The ID of the contact that receives the goods or services. The contact   must be associated with the account. ", alias="soldToContactId")
