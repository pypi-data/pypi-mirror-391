...
class ExpandedTaxationItem(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["taxableItemSnapshotId", "id", "createdById", "createdDate", "creditAmount", "updatedById", "updatedDate", "accountingCode", "exemptAmount", "invoiceItemId", "jurisdiction", "locationCode", "name", "paymentAmount", "taxableAmount", "taxAmount", "taxAmountUnrounded", "countryCode", "taxCodeDescription", "customerCode", "exemptCertificate", "sellerRegistration", "taxDescription", "taxRuleId", "taxCode", "taxMode", "taxDate", "periodEndDate", "periodStartDate", "taxRate", "taxRateDescription", "taxRateType", "balance", "journalEntryId", "salesTaxPayableAccountingCodeId", "accountReceivableAccountingCodeId"]
