...
class ExpandedInvoiceItem(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["productId", "contractLiabilityAccountingCodeId", "bookingReference", "itemType", "purchaseOrderNumber", "revRecCode", "revRecTriggerCondition", "revenueRecognitionRuleName", "adjustmentRevenueAccountingCodeId", "invoiceId", "invoiceScheduleId", "invoiceScheduleItemId", "ratePlanChargeId", "productRatePlanChargeId", "accountingCode", "appliedToInvoiceItemId", "chargeAmount", "chargeDate", "chargeName", "chargeNumber", "commitmentChargeNumber", "commitmentChargeSegmentNumber", "description", "discountAmount", "excludeItemBillingFromRevenueAccounting", "fulfillmentId", "itemShipToContactId", "itemSoldToContactId", "itemSoldToContactSnapshotId", "processingType", "quantity", "reflectDiscountInNetAmount", "revRecStartDate", "serviceEndDate", "serviceStartDate", "sKU", "sourceItemType", "orderLineItemId", "subscriptionId", "subscriptionNumber", "taxAmount", "taxCode", "taxExemptAmount", "taxMode", "unitPrice", "uOM", "balance", "numberOfDeliveries", "id", "createdById", "createdDate", "updatedById", "updatedDate", "ratePlanId", "deferredRevenueAccountingCodeId", "journalEntryId", "accountReceivableAccountingCodeId", "amendmentId", "parentAccountId", "billToContactId", "soldToContactId", "shipToContactId", "defaultPaymentMethodId", "adjustmentLiabilityAccountingCodeId", "contractRecognizedRevenueAccountingCodeId", "productRatePlanId", "recognizedRevenueAccountingCodeId", "unbilledReceivablesAccountingCodeId", "contractAssetAccountingCodeId", "subscriptionOwnerId", "accountId", "billToContactSnapshotId", "soldToContactSnapshotId", "shipToContactSnapshotId", "invoice", "subscription", "subscriptionOwner", "taxationItems", "ratePlanCharge", "orderLineItem"]
