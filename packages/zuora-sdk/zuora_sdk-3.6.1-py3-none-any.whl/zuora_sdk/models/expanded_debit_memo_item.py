...
class ExpandedDebitMemoItem(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["recognizedRevenueAccountingCodeId", "amount", "amountWithoutTax", "appliedToItemId", "appliedToOthersAmount", "beAppliedByOthersAmount", "chargeDate", "creditMemoItemId", "excludeItemBillingFromRevenueAccounting", "description", "itemShipToContactId", "itemSoldToContactId", "itemSoldToContactSnapshotId", "processingType", "quantity", "serviceEndDate", "serviceStartDate", "sku", "sourceItemType", "chargeName", "chargeNumber", "taxAmount", "taxCodeName", "taxExemptAmount", "taxMode", "unitOfMeasure", "unitPrice", "subscriptionId", "subscriptionNumber", "invoiceItemId", "productRatePlanChargeId", "ratePlanChargeId", "debitMemoId", "balance", "reflectDiscountInNetAmount", "id", "createdById", "createdDate", "updatedById", "updatedDate", "soldToContactSnapshotId", "billToContactSnapshotId", "shipToContactSnapshotId", "deferredRevenueAccountingCodeId", "subscriptionOwnerId", "journalEntryId", "accountReceivableAccountingCodeId", "subscription", "ratePlanCharge", "subscriptionOwner", "debitTaxationItems"]
