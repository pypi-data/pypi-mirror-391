...
class DetachInvoiceScheduleRequest(BaseModel):
    ...
    specific_subscriptions: Optional[List[InvoiceScheduleSubscription]] = Field(default=None, description="A list of the numbers of specific charge numbers to be detached from the invoice schedule ", alias="specificSubscriptions")
