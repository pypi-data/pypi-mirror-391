...
class SubscriptionChangeLogsApi:
    ...
    @validate_call
    def get_subscription_change_logs_by_order_number(
        self,
        order_number: Annotated[StrictStr, Field(description="The order number associated with the subscription to be retrieved.")],
        ...
        **Note:** This operation is only available if you have the [Orders](https://knowledgecenter.zuora.com/BC_Subscription_Management/Orders/AA_Overview_of_Orders#Orders) feature enabled. You also need to enable SingleVersionedSubscription to revert an order. 
        ...
        :param order_number: The order number associated with the subscription to be retrieved. (required)
        ...
        _param = self._get_subscription_change_logs_by_order_number_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetSubscriptionChangeLogsResponse",
            '400': "CommonResponse",
    ...
    @validate_call
    def get_subscription_change_logs_by_order_number_with_http_info(
        self,
        order_number: Annotated[StrictStr, Field(description="The order number associated with the subscription to be retrieved.")],
        accept_encoding: Annotated[Optional[StrictStr], Field(description="Include the `Accept-Encoding: gzip` header to compress responses as a gzipped file. It can significantly reduce the bandwidth required for a response.   If specified, Zuora automatically compresses responses that contain over 1000 bytes of data, and the response contains a `Content-Encoding` header with the compression algorithm so that your client can decompress it. ")] = None,
        content_encoding: Annotated[Optional[StrictStr], Field(description="Include the `Content-Encoding: gzip` header to compress a request. With this header specified, you should upload a gzipped file for the request payload instead of sending the JSON payload. ")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetSubscriptionChangeLogsResponse]:
        """Retrieve change logs for a subscription
    ...
    def _get_subscription_change_logs_by_order_number_serialize(
        self,
        order_number,
        accept_encoding,
        content_encoding,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscription-change-logs/orders/{orderNumber}',
    ...
    @validate_call
    def get_subscription_change_logs_by_subscription_number(
        self,
        subscription_number: Annotated[StrictStr, Field(description="The subscription number to be retrieved.")],
        accept_encoding: Annotated[Optional[StrictStr], Field(description="Include the `Accept-Encoding: gzip` header to compress responses as a gzipped file. It can significantly reduce the bandwidth required for a response.   If specified, Zuora automatically compresses responses that contain over 1000 bytes of data, and the response contains a `Content-Encoding` header with the compression algorithm so that your client can decompress it. ")] = None,
        content_encoding: Annotated[Optional[StrictStr], Field(description="Include the `Content-Encoding: gzip` header to compress a request. With this header specified, you should upload a gzipped file for the request payload instead of sending the JSON payload. ")] = None,
        authorization: Annotated[Optional[StrictStr], Field(description="The value is in the `Bearer {token}` format where {token} is a valid OAuth token generated by calling [Create an OAuth token](https://www.zuora.com/developer/api-references/api/operation/createToken). ")] = None,
        zuora_track_id: Annotated[Optional[Annotated[str, Field(strict=True, max_length=64)]], Field(description="A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`\"`), and quote (`'`). ")] = None,
        ...
        **Note:** This operation is only available if you have the [Orders](https://knowledgecenter.zuora.com/BC_Subscription_Management/Orders/AA_Overview_of_Orders#Orders) feature enabled. You also need to enable SingleVersionedSubscription to revert an order. 
        ...
        :param subscription_number: The subscription number to be retrieved. (required)
        ...
        _param = self._get_subscription_change_logs_by_subscription_number_serialize(
    ...
    @validate_call
    def get_subscription_change_logs_by_subscription_number_with_http_info(
        self,
        subscription_number: Annotated[StrictStr, Field(description="The subscription number to be retrieved.")],
        accept_encoding: Annotated[Optional[StrictStr], Field(description="Include the `Accept-Encoding: gzip` header to compress responses as a gzipped file. It can significantly reduce the bandwidth required for a response.   If specified, Zuora automatically compresses responses that contain over 1000 bytes of data, and the response contains a `Content-Encoding` header with the compression algorithm so that your client can decompress it. ")] = None,
        content_encoding: Annotated[Optional[StrictStr], Field(description="Include the `Content-Encoding: gzip` header to compress a request. With this header specified, you should upload a gzipped file for the request payload instead of sending the JSON payload. ")] = None,
    ...
    def _get_subscription_change_logs_by_subscription_number_serialize(
        self,
        subscription_number,
        accept_encoding,
        content_encoding,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscription-change-logs/{subscriptionNumber}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_subscription_change_logs_by_subscription_number_and_version(
        self,
        subscription_number: Annotated[StrictStr, Field(description="The subscription number to be retrieved.")],
        version: Annotated[StrictStr, Field(description="The subscription version to be retrieved.")],
        accept_encoding: Annotated[Optional[StrictStr], Field(description="Include the `Accept-Encoding: gzip` header to compress responses as a gzipped file. It can significantly reduce the bandwidth required for a response.   If specified, Zuora automatically compresses responses that contain over 1000 bytes of data, and the response contains a `Content-Encoding` header with the compression algorithm so that your client can decompress it. ")] = None,
        content_encoding: Annotated[Optional[StrictStr], Field(description="Include the `Content-Encoding: gzip` header to compress a request. With this header specified, you should upload a gzipped file for the request payload instead of sending the JSON payload. ")] = None,
        authorization: Annotated[Optional[StrictStr], Field(description="The value is in the `Bearer {token}` format where {token} is a valid OAuth token generated by calling [Create an OAuth token](https://www.zuora.com/developer/api-references/api/operation/createToken). ")] = None,
        zuora_track_id: Annotated[Optional[Annotated[str, Field(strict=True, max_length=64)]], Field(description="A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`\"`), and quote (`'`). ")] = None,
        ...
        **Note:** This operation is only available if you have the [Orders](https://knowledgecenter.zuora.com/BC_Subscription_Management/Orders/AA_Overview_of_Orders#Orders) feature enabled. You also need to enable SingleVersionedSubscription to revert an order. 
        ...
        :param subscription_number: The subscription number to be retrieved. (required)
        :type subscription_number: str
        :param version: The subscription version to be retrieved. (required)
        :type version: str
        :param accept_encoding: Include the `Accept-Encoding: gzip` header to compress responses as a gzipped file. It can significantly reduce the bandwidth required for a response.   If specified, Zuora automatically compresses responses that contain over 1000 bytes of data, and the response contains a `Content-Encoding` header with the compression algorithm so that your client can decompress it. 
        :type accept_encoding: str
        :param content_encoding: Include the `Content-Encoding: gzip` header to compress a request. With this header specified, you should upload a gzipped file for the request payload instead of sending the JSON payload. 
        ...
        _param = self._get_subscription_change_logs_by_subscription_number_and_version_serialize(
            subscription_number=subscription_number,
            version=version,
            accept_encoding=accept_encoding,
            content_encoding=content_encoding,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetSubscriptionChangeLogResponse",
            '400': "CommonResponse",
            '401': "ProxyUnauthorizedResponse",
            '403': "CommonErrorResponse",
        }
    ...
    @validate_call
    def get_subscription_change_logs_by_subscription_number_and_version_with_http_info(
        self,
        subscription_number: Annotated[StrictStr, Field(description="The subscription number to be retrieved.")],
        version: Annotated[StrictStr, Field(description="The subscription version to be retrieved.")],
        accept_encoding: Annotated[Optional[StrictStr], Field(description="Include the `Accept-Encoding: gzip` header to compress responses as a gzipped file. It can significantly reduce the bandwidth required for a response.   If specified, Zuora automatically compresses responses that contain over 1000 bytes of data, and the response contains a `Content-Encoding` header with the compression algorithm so that your client can decompress it. ")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetSubscriptionChangeLogResponse]:
        """Retrieve change logs for a subscription
    ...
    def _get_subscription_change_logs_by_subscription_number_and_version_serialize(
        self,
        subscription_number,
        version,
        accept_encoding,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscription-change-logs/{subscriptionNumber}/versions/{version}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
