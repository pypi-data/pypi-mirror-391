...
class RatePlansApi:
    ...
    def get_rate_plan(
        ...
        get_prev_rate_plan_version: Annotated[Optional[StrictBool], Field(description="Specify if you want to retrieve the previous version id of the rate plan.  *  `true` - Returns the previous version id of the subscription rate plan. *  `false` - Returns the previous version id of the subscription rate plan in the request.")] = None,
        ...
        :param get_prev_rate_plan_version: Specify if you want to retrieve the previous version id of the rate plan.  *  `true` - Returns the previous version id of the subscription rate plan. *  `false` - Returns the previous version id of the subscription rate plan in the request.
        :type get_prev_rate_plan_version: bool
        ...
        _param = self._get_rate_plan_serialize(
            ...
            get_prev_rate_plan_version=get_prev_rate_plan_version,
    ...
    def _get_rate_plan_serialize(
        ...
        if get_prev_rate_plan_version is not None:
            
            _query_params.append(('getPrevRatePlanVersion', get_prev_rate_plan_version))
