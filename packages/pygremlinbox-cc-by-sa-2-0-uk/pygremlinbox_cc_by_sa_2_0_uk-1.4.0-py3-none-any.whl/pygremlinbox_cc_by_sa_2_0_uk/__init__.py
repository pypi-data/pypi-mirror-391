...
"""
PyGremlinBox CC-BY-SA-2.0-UK - Supply chain security testing module.

This package is licenced under CC-BY-SA-2.0-UK.
...
maintaining compliance with CC-BY-SA-2.0-UK requirements.
"""

__version__ = "1.4.0"
__licence__ = "CC-BY-SA-2.0-UK"
...
def get_package_metadata():
    ...
    """
    return {
        "name": "PyGremlinBox-CC-BY-SA-2-0-UK",
        "version": __version__,
        "licence": __licence__,
        "description": "Supply chain security testing module with CC-BY-SA-2.0-UK licence",
        "spdx_licence_id": "CC-BY-SA-2.0-UK"
    }
