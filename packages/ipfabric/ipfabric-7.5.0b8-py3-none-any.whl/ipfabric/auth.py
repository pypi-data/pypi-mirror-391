...
import jwt
from niquests import Session, Request, Response, PreparedRequest, RetryConfiguration, TimeoutConfiguration
...
class Setup(BaseSettings):
    ...
    http2: bool = True
    event_hooks: Optional[HookType] = Field(default_factory=dict)
