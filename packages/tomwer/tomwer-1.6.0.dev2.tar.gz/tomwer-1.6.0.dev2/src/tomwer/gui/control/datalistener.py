...
class ConfigurationWidget(qt.QDialog):
    ...
    def __init__(
        ...
        self.layout().addWidget(self._hostQLE, 0, 1, 1, 2)
        ...
        self.layout().addWidget(self._vLine1, 10, 0, 1, 3)

        # configuration file to use
        self._cfgLabel = qt.QLabel("config file")
        self.layout().addWidget(self._cfgLabel, 11, 0, 1, 1)
        ...
        self.layout().addWidget(self._cfgWidget, 11, 1, 1, 2)
        tooltip = (
        ...
        self.layout().addWidget(self._lrMechanicalFlipLabel, 12, 0, 1, 1)
        ...
        self.layout().addWidget(self._lrMechanicalFlip, 12, 1, 1, 2)

        self._udMechanicalFlipLabel = qt.QLabel("left-right mechanical flip")
        ud_icon = tomwericons.getQIcon("ud_mirroring")
        self.layout().addWidget(self._udMechanicalFlipLabel, 13, 0, 1, 1)
        ...
        self.layout().addWidget(self._udMechanicalFlip, 13, 1, 1, 2)
        ...
        self.layout().addWidget(self._vLine2, 20, 0, 1, 3)

        # output folder
        self._outputFolderLabel = qt.QLabel("nexus file output dir")
        self.layout().addWidget(self._outputFolderLabel, 21, 0, 1, 1)
        ...
        self.layout().addWidget(self._nxTomomillOutputWidget, 21, 1, 1, 2)
        ...
        self.layout().addWidget(self._buttons, 21, 0, 1, 3)

        # height spacer
        spacer = qt.QWidget(parent=self)
        spacer.setSizePolicy(qt.QSizePolicy.Minimum, qt.QSizePolicy.Expanding)
        self.layout().addWidget(spacer, 90, 0, 1, 1)
