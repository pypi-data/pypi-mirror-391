...
"""
PyGremlinBox copyleft-next-0.3.1 - Supply chain security testing module.

This package is licenced under copyleft-next-0.3.1.
...
maintaining compliance with copyleft-next-0.3.1 requirements.
"""

__version__ = "1.4.0"
__licence__ = "copyleft-next-0.3.1"
...
def get_package_metadata():
    ...
    """
    return {
        "name": "PyGremlinBox-copyleft-next-0-3-1",
        "version": __version__,
        "licence": __licence__,
        "description": "Supply chain security testing module with copyleft-next-0.3.1 licence",
        "spdx_licence_id": "copyleft-next-0.3.1"
    }
