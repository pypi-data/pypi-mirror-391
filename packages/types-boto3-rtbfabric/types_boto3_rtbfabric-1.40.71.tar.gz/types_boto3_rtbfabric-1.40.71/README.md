<a id="types-boto3-rtbfabric"></a>

# types-boto3-rtbfabric

[![PyPI - types-boto3-rtbfabric](https://img.shields.io/pypi/v/types-boto3-rtbfabric.svg?color=blue)](https://pypi.org/project/types-boto3-rtbfabric/)
[![PyPI - Python Version](https://img.shields.io/pypi/pyversions/types-boto3-rtbfabric.svg?color=blue)](https://pypi.org/project/types-boto3-rtbfabric/)
[![Docs](https://img.shields.io/readthedocs/boto3-stubs.svg?color=blue)](https://youtype.github.io/types_boto3_docs/)
[![PyPI - Downloads](https://static.pepy.tech/badge/types-boto3-rtbfabric)](https://pypistats.org/packages/types-boto3-rtbfabric)

![boto3.typed](https://github.com/youtype/mypy_boto3_builder/raw/main/logo.png)

Type annotations for [boto3 RTBFabric 1.40.71](https://pypi.org/project/boto3/)
...
[types-boto3-rtbfabric docs](https://youtype.github.io/types_boto3_docs/types_boto3_rtbfabric/).

See how it helps you find and fix potential bugs:

![types-boto3 demo](https://github.com/youtype/mypy_boto3_builder/raw/main/demo.gif)

- [types-boto3-rtbfabric](#types-boto3-rtbfabric)
...
- Install `types-boto3[rtbfabric]` in your environment:
...
- Install `types-boto3[rtbfabric]` with services you use in your environment:
...
`types-boto3-rtbfabric` dependency in production. However, there is an issue in
...
`RTBFabricClient` provides annotations for `boto3.client("rtbfabric")`.

```python
from boto3.session import Session

from types_boto3_rtbfabric import RTBFabricClient
...
`types_boto3_rtbfabric.paginator` module contains type annotations for all
paginators.
...
`types_boto3_rtbfabric.waiter` module contains type annotations for all
waiters.
...
`types_boto3_rtbfabric.literals` module contains literals extracted from shapes
that can be used in user code for type checking.

Full list of `RTBFabric` Literals can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_rtbfabric/literals/).
...
`types_boto3_rtbfabric.type_defs` module contains structures and shapes
assembled to typed dictionaries and unions for additional type checking.

Full list of `RTBFabric` TypeDefs can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_rtbfabric/type_defs/).
...
`types-boto3-rtbfabric` version is the same as related `boto3` version and
follows
...
[boto3 docs](https://youtype.github.io/types_boto3_docs/types_boto3_rtbfabric/)
