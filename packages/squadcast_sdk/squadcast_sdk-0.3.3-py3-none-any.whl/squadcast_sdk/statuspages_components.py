...
class StatusPagesComponents(BaseSDK):
    def delete_by_id(
        self,
        *,
        statuspage_id: str,
        ...
        request = models.ComponentsDeleteComponentByIDRequest(
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="Components_deleteComponentById",
                oauth2_scopes=None,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.ComponentsDeleteComponentByIDResponse, http_res
            )
