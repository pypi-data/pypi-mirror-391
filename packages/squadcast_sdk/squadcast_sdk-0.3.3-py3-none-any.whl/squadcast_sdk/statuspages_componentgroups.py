...
class StatusPagesComponentGroups(BaseSDK):
    def list(
        ...
        *,
        ...
        request = models.ComponentGroupsListComponentGroupsRequest(
            statuspage_id=statuspage_id,
        )

        req = self._build_request(
            method="GET",
            path="/v4/statuspages/{statuspageID}/groups",
            base_url=base_url,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="ComponentGroups_listComponentGroups",
                oauth2_scopes=None,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.ComponentGroupsListComponentGroupsResponse, http_res
            )
    ...
    def remove_by_id(
        ...
        *,
        ...
        request = models.ComponentGroupsDeleteComponentGroupByIDRequest(
            statuspage_id=statuspage_id,
            group_id=group_id,
        )
        ...
        req = self._build_request(
            method="DELETE",
            path="/v4/statuspages/{statuspageID}/groups/{group_id}",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="ComponentGroups_deleteComponentGroupById",
                oauth2_scopes=None,
                security_source=self.sdk_configuration.security,
            ),
            request=req,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.ComponentGroupsDeleteComponentGroupByIDResponse, http_res
            )
        if utils.match_response(http_res, "400", "application/json"):
            response_data = unmarshal_json_response(
                errors.BadRequestErrorData, http_res
    ...
    def get_by_id(
        ...
        *,
        ...
        request = models.ComponentGroupsGetComponentGroupByIDRequest(
            statuspage_id=statuspage_id,
            group_id=group_id,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="ComponentGroups_getComponentGroupById",
                oauth2_scopes=None,
                security_source=self.sdk_configuration.security,
            ),
            request=req,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.ComponentGroupsGetComponentGroupByIDResponse, http_res
            )
        if utils.match_response(http_res, "400", "application/json"):
            response_data = unmarshal_json_response(
                errors.BadRequestErrorData, http_res
