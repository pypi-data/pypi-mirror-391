    ...
    def create_or_update(
        ...
        *,
        ...
        req = self._build_request(
            method="POST",
            path="/v3/services/{serviceID}/dependencies",
            base_url=base_url,
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request.v3_services_dependencies_create_or_update_dependencies_request,
                False,
                False,
                "json",
        ...
        if utils.match_response(http_res, "201", "application/json"):
            return unmarshal_json_response(
                models.DependenciesCreateOrUpdateDependenciesResponse, http_res
            )
