...
class Notes(BaseSDK):
    def create(
        ...
        *,
        ...
        request = models.NotesCreateNotesRequest(
        ...
        req = self._build_request(
            method="POST",
            path="/v3/incidents/{IncidentId}/warroom",
            base_url=base_url,
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request.v3_incidents_notes_create_note_request,
                False,
                False,
                "json",
        ...
        if utils.match_response(http_res, "201", "application/json"):
            return unmarshal_json_response(models.NotesCreateNotesResponse, http_res)
    ...
    def list(
        ...
        *   Requires `access_token` as a `Bearer {{token}}` in the `Authorization` header.
        ...
        request = models.NotesGetAllNotesRequest(
            incident_id=incident_id,
        )
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.NotesGetAllNotesResponse, http_res)
        if utils.match_response(http_res, "400", "application/json"):
            response_data = unmarshal_json_response(
                errors.BadRequestErrorData, http_res
            )
    ...
    def delete(
        ...
        *,
        ...
        request = models.NotesDeleteNoteRequest(
            incident_id=incident_id,
            note_id=note_id,
        )
        ...
        req = self._build_request(
            method="DELETE",
            path="/v3/incidents/{IncidentId}/warroom/{NoteId}",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
    ...
    def update(
        ...
        *,
        ...
        request = models.NotesUpdateNoteRequest(
            incident_id=incident_id,
            note_id=note_id,
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request.v3_incidents_notes_update_note_request,
                False,
                False,
                "json",
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.NotesUpdateNoteResponse, http_res)
        if utils.match_response(http_res, "400", "application/json"):
            response_data = unmarshal_json_response(
                errors.BadRequestErrorData, http_res
            )
