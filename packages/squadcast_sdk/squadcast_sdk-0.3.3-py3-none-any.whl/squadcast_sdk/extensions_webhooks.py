...
class ExtensionsWebhooks(BaseSDK):
    def get_all(
        self,
        *,
        ...
        request = models.WebhooksGetAllWebhooksRequest(
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="Webhooks_getAllWebhooks",
                oauth2_scopes=None,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.V3ExtensionsWebhooksGetAllWebhooksResponse, http_res
            )
