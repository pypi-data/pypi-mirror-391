...
class Maintenances(BaseSDK):
    def delete(
        ...
        *,
        ...
        request = models.MaintenancesDeleteMaintenanceByIDRequest(
        ...
        req = self._build_request(
            method="DELETE",
            path="/v4/statuspages/{statuspageID}/maintenance/{maintenance_id}",
            base_url=base_url,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.MaintenancesDeleteMaintenanceByIDResponse, http_res
            )
    ...
    def update_by_id(
        ...
        *,
        ...
        request = models.MaintenancesUpdateMaintenanceByIDRequest(
            statuspage_id=statuspage_id,
            maintenance_id=maintenance_id,
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request.v4_status_pages_maintenances_update_maintenance_by_id_request,
                False,
                False,
                "json",
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.MaintenancesUpdateMaintenanceByIDResponse, http_res
            )
        if utils.match_response(http_res, "400", "application/json"):
            response_data = unmarshal_json_response(
                errors.BadRequestErrorData, http_res
