...
class ServicesDedupKey(BaseSDK):
    def update(
        self,
        *,
        service_id: str,
        ...
        dedup_key_overlay: Union[
            models.DedupKeyOverlay, models.DedupKeyOverlayTypedDict
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.OverlayUpdateDedupKeyOverlayResponse:
        r"""Update Dedup Key Overlay

        :param service_id:
        :param alert_source:
        :param overlay_template_type:
        :param dedup_key_overlay:
        ...
        request = models.OverlayUpdateDedupKeyOverlayRequest(
            service_id=service_id,
            alert_source=alert_source,
            v3_services_overlay_update_dedup_key_overlay_request=models.V3ServicesOverlayUpdateDedupKeyOverlayRequest(
                overlay_template_type=overlay_template_type,
                dedup_key_overlay=utils.get_pydantic_model(
                    dedup_key_overlay, models.DedupKeyOverlay
                ),
            ),
        )
        ...
        req = self._build_request(
            method="PUT",
            path="/v3/services/{serviceID}/overlays/dedup-key/{alertSource}",
            base_url=base_url,
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request.v3_services_overlay_update_dedup_key_overlay_request,
                False,
                False,
                "json",
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="Overlay_updateDedupKeyOverlay",
                oauth2_scopes=None,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.OverlayUpdateDedupKeyOverlayResponse, http_res
            )
