...
class Roles(BaseSDK):
    def get_all(
        ...
        *,
        ...
        request = models.TeamsGetAllTeamRolesRequest(
            team_id=team_id,
        )

        req = self._build_request(
            method="GET",
            path="/v3/teams/{teamId}/roles",
            base_url=base_url,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="Teams_getAllTeamRoles",
                oauth2_scopes=None,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.TeamsGetAllTeamRolesResponse, http_res
            )
    ...
    def create(
        ...
        *,
        team_id: str,
        name: str,
        abilities: Union[models.V3TeamsAbilities, models.V3TeamsAbilitiesTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
        ...
        request = models.TeamsCreateTeamRoleRequest(
            team_id=team_id,
            v3_teams_create_team_role_request=models.V3TeamsCreateTeamRoleRequest(
                name=name,
                abilities=utils.get_pydantic_model(abilities, models.V3TeamsAbilities),
            ),
        )
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request.v3_teams_create_team_role_request,
                False,
                False,
                "json",
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="Teams_createTeamRole",
                oauth2_scopes=None,
                security_source=self.sdk_configuration.security,
            ),
            request=req,
        ...
        if utils.match_response(http_res, "201", "application/json"):
            return unmarshal_json_response(models.TeamsCreateTeamRoleResponse, http_res)
        if utils.match_response(http_res, "400", "application/json"):
            response_data = unmarshal_json_response(
                errors.BadRequestErrorData, http_res
            )
    ...
    def update(
        ...
        *,
        ...
        abilities: Optional[
            Union[models.V3TeamsAbilities, models.V3TeamsAbilitiesTypedDict]
        ] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        request = models.TeamsUpdateTeamRoleRequest(
            team_id=team_id,
            role_id=role_id,
            v3_teams_update_team_role_request=models.V3TeamsUpdateTeamRoleRequest(
                name=name,
                abilities=utils.get_pydantic_model(
                    abilities, Optional[models.V3TeamsAbilities]
                ),
            ),
        )
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request.v3_teams_update_team_role_request,
                False,
                False,
                "json",
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="Teams_updateTeamRole",
                oauth2_scopes=None,
                security_source=self.sdk_configuration.security,
            ),
            request=req,
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.TeamsUpdateTeamRoleResponse, http_res)
        if utils.match_response(http_res, "400", "application/json"):
            response_data = unmarshal_json_response(
                errors.BadRequestErrorData, http_res
            )
