...
class IncidentsSnoozeNotifications(BaseSDK):
    def unsnooze(
        self,
        *,
        incident_id: str,
        reassign_to: Union[
            models.V3IncidentsSnoozeNotificationsReassignTo,
            models.V3IncidentsSnoozeNotificationsReassignToTypedDict,
        ],
        ...
        request = models.SnoozeNotificationsUnsnoozeIncidentNotificationsRequest(
            incident_id=incident_id,
            v3_incidents_snooze_notifications_unsnooze_incident_request=models.V3IncidentsSnoozeNotificationsUnsnoozeIncidentRequest(
                reassign_to=utils.get_pydantic_model(
                    reassign_to, models.V3IncidentsSnoozeNotificationsReassignTo
                ),
            ),
        )
        ...
        req = self._build_request(
            method="PUT",
            path="/v3/incidents/{incidentID}/unsnooze",
            base_url=base_url,
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request.v3_incidents_snooze_notifications_unsnooze_incident_request,
                False,
                False,
                "json",
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="SnoozeNotifications_unsnoozeIncidentNotifications",
                oauth2_scopes=None,
