...
class V3SLOSLODetailedResponseTagsTypedDict(TypedDict):
    pass


class V3SLOSLODetailedResponseTags(BaseModel):
    pass


class V3SLOSLODetailedResponseTypedDict(TypedDict):
    id: int
    name: str
    ...
    tags: NotRequired[Nullable[V3SLOSLODetailedResponseTagsTypedDict]]
...
class V3SLOSLODetailedResponse(BaseModel):
    id: int
    ...
    tags: OptionalNullable[V3SLOSLODetailedResponseTags] = UNSET
