...
class RunbooksSDK(BaseSDK):
    def attach(
        ...
        *,
        ...
        req = self._build_request(
            method="POST",
            path="/v3/incidents/{IncidentId}/runbooks",
            base_url=base_url,
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request.v3_incidents_runbooks_attach_runbooks_request,
                False,
                False,
                "json",
        ...
        if utils.match_response(http_res, "201", "application/json"):
            return unmarshal_json_response(
                models.RunbooksAttachRunbooksResponse, http_res
            )
    ...
    def get_all_by_team(
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.RunbooksGetAllRunbooksByTeamResponse, http_res
            )
        if utils.match_response(http_res, "400", "application/json"):
            response_data = unmarshal_json_response(
                errors.BadRequestErrorData, http_res
    ...
    async def get_all_by_team_async(
        self,
        *,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
    ...
    def create(
        ...
        *,
        ...
        :param steps: The steps that make up the runbook.
        :param owner_id: The ID of the team that owns this runbook.
        ...
        request = models.V3RunbooksCreateRunbookRequest(
            name=name,
            steps=utils.get_pydantic_model(steps, List[models.V3RunbooksStep]),
            owner_id=owner_id,
        ...
        if utils.match_response(http_res, "201", "application/json"):
            return unmarshal_json_response(
                models.RunbooksCreateRunbookResponse, http_res
            )
        if utils.match_response(http_res, "400", "application/json"):
            response_data = unmarshal_json_response(
                errors.BadRequestErrorData, http_res
    ...
    def delete(
        ...
        *,
        ...
        request = models.RunbooksRemoveRunbookRequest(
            runbook_id=runbook_id,
        )

        req = self._build_request(
            method="DELETE",
            path="/v3/runbooks/{runbookID}",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
    ...
    def get_by_id(
        ...
        *,
        ...
        request = models.RunbooksGetRunbookByIDRequest(
            runbook_id=runbook_id,
        )
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.RunbooksGetRunbookByIDResponse, http_res
            )
        if utils.match_response(http_res, "400", "application/json"):
            response_data = unmarshal_json_response(
                errors.BadRequestErrorData, http_res
    ...
    def update(
        ...
        *,
        ...
        request = models.RunbooksUpdateRunbookRequest(
            runbook_id=runbook_id,
            v3_runbooks_update_runbook_request=models.V3RunbooksUpdateRunbookRequest(
                name=name,
                steps=utils.get_pydantic_model(steps, List[models.V3RunbooksStep]),
                entity_owner=utils.get_pydantic_model(
                    entity_owner, Optional[models.CommonV3EntityOwner]
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request.v3_runbooks_update_runbook_request,
                False,
                False,
                "json",
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.RunbooksUpdateRunbookResponse, http_res
            )
        if utils.match_response(http_res, "400", "application/json"):
            response_data = unmarshal_json_response(
                errors.BadRequestErrorData, http_res
