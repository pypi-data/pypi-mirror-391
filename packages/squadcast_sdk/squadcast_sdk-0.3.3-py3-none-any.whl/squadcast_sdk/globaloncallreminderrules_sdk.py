...
class GlobalOncallReminderRulesSDK(BaseSDK):
    def delete(
        self,
        *,
        owner_id: str,
        ...
        r"""Delete Global Oncall Reminder Rules
        ...
        request = (
            models.GlobalOncallReminderRulesDeleteGlobalOncallReminderRulesRequest(
                owner_id=owner_id,
            )
        )
        ...
        req = self._build_request(
            method="DELETE",
            path="/v3/global-oncall-reminder-rules",
            base_url=base_url,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="GlobalOncallReminderRules_deleteGlobalOncallReminderRules",
                oauth2_scopes=None,
    ...
    def get(
        ...
        *,
        ...
        request = models.GlobalOncallReminderRulesGetGlobalOncallReminderRulesRequest(
            owner_id=owner_id,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="GlobalOncallReminderRules_getGlobalOncallReminderRules",
                oauth2_scopes=None,
                security_source=self.sdk_configuration.security,
            ),
            request=req,
    ...
    def create(
        ...
        *,
        ...
        owner_id: str,
        rules: Union[
            List[models.V3GlobalOncallReminderRulesRule],
            List[models.V3GlobalOncallReminderRulesRuleTypedDict],
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        request = (
            models.V3GlobalOncallReminderRulesCreateGlobalOncallReminderRulesRequest(
                ...
                rules=utils.get_pydantic_model(
                    rules, List[models.V3GlobalOncallReminderRulesRule]
                ),
            )
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="GlobalOncallReminderRules_createGlobalOncallReminderRules",
                oauth2_scopes=None,
                security_source=self.sdk_configuration.security,
            ),
            request=req,
    ...
    def update(
        ...
        *,
        ...
        request = models.GlobalOncallReminderRulesUpdateGlobalOncallReminderRulesRequest(
            owner_id=owner_id,
            v3_global_oncall_reminder_rules_update_global_oncall_reminder_rules_request=models.V3GlobalOncallReminderRulesUpdateGlobalOncallReminderRulesRequest(
                is_enabled=is_enabled,
                rules=utils.get_pydantic_model(
                    rules, List[models.V3GlobalOncallReminderRulesRule]
                ),
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request.v3_global_oncall_reminder_rules_update_global_oncall_reminder_rules_request,
                False,
                False,
                "json",
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="GlobalOncallReminderRules_updateGlobalOncallReminderRules",
                oauth2_scopes=None,
                security_source=self.sdk_configuration.security,
            ),
            request=req,
