...
class DedupKey(BaseSDK):
    def get_for_alert_source(
        self,
        *,
        service_id: str,
        alert_source: str,
    ...
    ) -> models.V3ServicesOverlayOverlayResponse:
        r"""Get Dedup Key Overlay for Alert Source
        ...
        request = models.OverlayGetDedupKeyOverlayForAlertSourceRequest(
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="Overlay_getDedupKeyOverlayForAlertSource",
                oauth2_scopes=None,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.OverlayGetDedupKeyOverlayForAlertSourceResponse, http_res
            )
    ...
    async def get_for_alert_source_async(
        self,
        *,
        service_id: str,
        alert_source: str,
