...
class StatuspagesMaintenances2(BaseSDK):
    def get_by_id(
        self,
        *,
        statuspage_id: str,
    ...
    ) -> models.V4StatusPagesMaintenancesGetMaintenanceByIDResponse:
        r"""Get Maintenance By ID
        ...
        request = models.MaintenancesGetMaintenanceByIDRequest(
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="Maintenances_getMaintenanceById",
                oauth2_scopes=None,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.MaintenancesGetMaintenanceByIDResponse, http_res
            )
