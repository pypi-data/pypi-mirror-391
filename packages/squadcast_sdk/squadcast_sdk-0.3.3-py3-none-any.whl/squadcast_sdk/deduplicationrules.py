...
class DeduplicationRules(BaseSDK):
    def get(
        ...
        *,
    ...
    ) -> models.DeduplicationRulesGetDeduplicationRulesData:
        r"""Get Deduplication Rules
        ...
        request = models.DeduplicationRulesGetDeduplicationRulesRequest(
            service_id=service_id,
        )

        req = self._build_request(
            method="GET",
            path="/v3/services/{serviceID}/deduplication-rules",
            base_url=base_url,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.DeduplicationRulesGetDeduplicationRulesResponse, http_res
            )
    ...
    def create_or_update(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.DeduplicationRulesCreateOrUpdateDeduplicationRulesData:
        r"""Create or Update Deduplication Rules
        ...
        request = models.DeduplicationRulesCreateOrUpdateDeduplicationRulesRequest(
            service_id=service_id,
            v3_services_deduplication_rules_create_deduplication_rules_request=models.V3ServicesDeduplicationRulesCreateDeduplicationRulesRequest(
                rules=utils.get_pydantic_model(
                    rules, List[models.V3ServicesDeduplicationRulesDeduplicationRule]
                ),
            ),
        )
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request.v3_services_deduplication_rules_create_deduplication_rules_request,
                False,
                False,
                "json",
        ...
        if utils.match_response(http_res, "201", "application/json"):
            return unmarshal_json_response(
                models.DeduplicationRulesCreateOrUpdateDeduplicationRulesResponse,
                http_res,
            )
        if utils.match_response(http_res, "400", "application/json"):
            response_data = unmarshal_json_response(
