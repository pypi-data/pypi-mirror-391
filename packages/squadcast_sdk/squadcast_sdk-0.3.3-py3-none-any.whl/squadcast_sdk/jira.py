...
class Jira(BaseSDK):
    def create_ticket(
        ...
        *,
        ...
        r"""Create a Ticket on Jira Cloud
        ...
        request = models.IncidentActionsCreateATicketOnJiraCloudRequest(
            incident_id=incident_id,
        )

        req = self._build_request(
            method="POST",
            path="/v3/incidents/{incidentID}/actions/jira/new/jira-cloud",
            base_url=base_url,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="IncidentActions_createATicketOnJiraCloud",
                oauth2_scopes=None,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.IncidentActionsCreateATicketOnJiraCloudResponse, http_res
            )
