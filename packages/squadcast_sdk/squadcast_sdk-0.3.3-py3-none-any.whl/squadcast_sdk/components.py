...
class Components(BaseSDK):
    def list(
        ...
        *,
        ...
        request = models.ComponentsListComponentsRequest(
            statuspage_id=statuspage_id,
        )

        req = self._build_request(
            method="GET",
            path="/v4/statuspages/{statuspageID}/components",
            base_url=base_url,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="Components_listComponents",
                oauth2_scopes=None,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.ComponentsListComponentsResponse, http_res
            )
    ...
    def create(
        ...
        *,
        ...
        allow_subscription: Optional[bool] = None,
        ...
        request = models.ComponentsCreateComponentRequest(
            statuspage_id=statuspage_id,
            v4_status_pages_components_create_component_request=models.V4StatusPagesComponentsCreateComponentRequest(
                name=name,
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request.v4_status_pages_components_create_component_request,
                False,
                False,
                "json",
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="Components_createComponent",
                oauth2_scopes=None,
                security_source=self.sdk_configuration.security,
            ),
            request=req,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.ComponentsCreateComponentResponse, http_res
            )
        if utils.match_response(http_res, "400", "application/json"):
            response_data = unmarshal_json_response(
                errors.BadRequestErrorData, http_res
    ...
    def get_by_id(
        ...
        *,
        ...
        request = models.ComponentsGetComponentByIDRequest(
            statuspage_id=statuspage_id,
        ...
        req = self._build_request(
            method="GET",
            path="/v4/statuspages/{statuspageID}/components/{component_id}",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="Components_getComponentById",
                oauth2_scopes=None,
                security_source=self.sdk_configuration.security,
            ),
            request=req,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.ComponentsGetComponentByIDResponse, http_res
            )
        if utils.match_response(http_res, "400", "application/json"):
            response_data = unmarshal_json_response(
                errors.BadRequestErrorData, http_res
    ...
    def update_by_id(
        ...
        *,
        ...
        request = models.ComponentsUpdateComponentByIDRequest(
            statuspage_id=statuspage_id,
            component_id=component_id,
            v4_status_pages_components_update_component_by_id_request=models.V4StatusPagesComponentsUpdateComponentByIDRequest(
                name=name,
                description=description,
                allow_subscription=allow_subscription,
                group_id=group_id,
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request.v4_status_pages_components_update_component_by_id_request,
                False,
                False,
                "json",
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="Components_updateComponentById",
                oauth2_scopes=None,
                security_source=self.sdk_configuration.security,
            ),
            request=req,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.ComponentsUpdateComponentByIDResponse, http_res
            )
        if utils.match_response(http_res, "400", "application/json"):
            response_data = unmarshal_json_response(
                errors.BadRequestErrorData, http_res
