...
class Subscribers(BaseSDK):
    def list(
        ...
        *,
        ...
        request = models.StatusPagesListSubscribersRequest(
            statuspage_id=statuspage_id,
        )

        req = self._build_request(
            method="GET",
            path="/v4/statuspages/{statuspageID}/subscribers",
            base_url=base_url,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="StatusPages_listSubscribers",
                oauth2_scopes=None,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.V4StatusPagesListSubscribersResponse, http_res
            )
