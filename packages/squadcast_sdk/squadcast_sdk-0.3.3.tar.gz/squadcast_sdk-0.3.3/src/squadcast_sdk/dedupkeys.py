...
class DedupKeys(BaseSDK):
    def list_by_service(
        ...
        *,
    ...
    ) -> List[models.V3ServicesOverlayOverlayResponse]:
        r"""Get All Dedup Key Overlay by Service
        ...
        request = models.OverlayGetAllDedupKeyOverlayByServiceRequest(
            service_id=service_id,
        )

        req = self._build_request(
            method="GET",
            path="/v3/services/{serviceID}/overlays/dedup-key",
            base_url=base_url,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="Overlay_getAllDedupKeyOverlayByService",
                oauth2_scopes=None,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.OverlayGetAllDedupKeyOverlayByServiceResponse, http_res
            )
    ...
    async def list_by_service_async(
        self,
        *,
        service_id: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
    ...
    def delete(
        ...
        *,
        ...
        request = models.OverlayDeleteDedupKeyOverlayRequest(
            service_id=service_id,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="Overlay_deleteDedupKeyOverlay",
                oauth2_scopes=None,
                security_source=self.sdk_configuration.security,
            ),
            request=req,
