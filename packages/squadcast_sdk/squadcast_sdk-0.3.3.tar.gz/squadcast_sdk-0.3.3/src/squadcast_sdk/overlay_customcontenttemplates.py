...
class OverlayCustomContentTemplates(BaseSDK):
    def get_all(
        ...
        *,
        ...
        request = models.OverlayGetAllCustomContentTemplateOverlayByServiceRequest(
            service_id=service_id,
        )

        req = self._build_request(
            method="GET",
            path="/v3/services/{serviceID}/overlays/custom-content",
            base_url=base_url,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="Overlay_getAllCustomContentTemplateOverlayByService",
                oauth2_scopes=None,
    ...
    def create_or_update(
        ...
        *,
        ...
        message_overlay: Union[models.MessageOverlay, models.MessageOverlayTypedDict],
        description_overlay: Union[
            models.DescriptionOverlay, models.DescriptionOverlayTypedDict
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        :param message_overlay:
        :param description_overlay:
        :param retries: Override the default retry configuration for this method
        :param server_url: Override the default server URL for this method
        :param timeout_ms: Override the default request timeout configuration for this method in milliseconds
        :param http_headers: Additional headers to set or replace on requests.
        ...
        request = models.OverlayCreateOrUpdateNotificationTemplateOverlayRequest(
            service_id=service_id,
            alert_source=alert_source,
            v3_services_overlay_update_custom_content_template_overlay_request=models.V3ServicesOverlayUpdateCustomContentTemplateOverlayRequest(
                overlay_template_type=overlay_template_type,
                message_overlay=utils.get_pydantic_model(
                    message_overlay, models.MessageOverlay
                ),
                description_overlay=utils.get_pydantic_model(
                    description_overlay, models.DescriptionOverlay
                ),
            ),
        )
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request.v3_services_overlay_update_custom_content_template_overlay_request,
                False,
                False,
                "json",
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="Overlay_createOrUpdateNotificationTemplateOverlay",
                oauth2_scopes=None,
                security_source=self.sdk_configuration.security,
            ),
            request=req,
