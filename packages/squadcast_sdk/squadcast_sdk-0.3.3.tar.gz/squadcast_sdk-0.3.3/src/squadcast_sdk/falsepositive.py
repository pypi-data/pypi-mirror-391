    ...
    def mark(
        ...
        *,
        ...
        request_body: Union[
            ...
            models.SLOMarkSLOFalsePositiveRequestBodyTypedDict,
        ],
        ...
        request = models.SLOMarkSLOFalsePositiveRequest(
            slo_id=slo_id,
            incident_id=incident_id,
            value=value,
            owner_id=owner_id,
            request_body=utils.get_pydantic_model(
                request_body, models.SLOMarkSLOFalsePositiveRequestBody
            ),
        )

        req = self._build_request(
            method="PATCH",
            path="/v3/slo/{sloID}/incident/{incidentID}/false-positive/{value}",
            base_url=base_url,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="SLO_markSLOFalsePositive",
                oauth2_scopes=None,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.SLOMarkSLOFalsePositiveResponse, http_res
            )
