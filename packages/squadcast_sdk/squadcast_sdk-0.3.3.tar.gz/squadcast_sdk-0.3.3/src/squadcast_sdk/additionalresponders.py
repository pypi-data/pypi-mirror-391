...
class AdditionalResponders(BaseSDK):
    def remove(
        self,
        *,
        incident_id: str,
        ...
        r"""Remove Additional Responders
        ...
        request = models.AdditionalRespondersRemoveAdditionalRespondersRequest(
        ...
        req = self._build_request(
            method="DELETE",
            path="/v3/incidents/{incidentID}/additional-responders/{responderID}",
            base_url=base_url,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="AdditionalResponders_removeAdditionalResponders",
                oauth2_scopes=None,
