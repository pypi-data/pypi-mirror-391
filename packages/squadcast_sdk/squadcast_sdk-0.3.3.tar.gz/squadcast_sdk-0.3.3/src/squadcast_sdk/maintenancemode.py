...
class MaintenanceMode(BaseSDK):
    def get(
        ...
        *,
    ...
    ) -> List[models.V3ServicesMaintenanceModeMaintenanceModeResponse]:
        r"""Get Maintenance Mode
        ...
        request = models.MaintenanceModeGetMaintenanceModeRequest(
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="MaintenanceMode_getMaintenanceMode",
                oauth2_scopes=None,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.MaintenanceModeGetMaintenanceModeResponse, http_res
            )
