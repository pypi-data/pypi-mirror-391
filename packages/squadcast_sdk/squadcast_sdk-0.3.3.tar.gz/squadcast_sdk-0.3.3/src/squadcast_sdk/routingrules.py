...
class RoutingRules(BaseSDK):
    def get(
        ...
        *,
    ...
    ) -> models.RoutingRulesGetRoutingRulesData:
        r"""Get Routing Rules
        ...
        request = models.RoutingRulesGetRoutingRulesRequest(
            service_id=service_id,
        )

        req = self._build_request(
            method="GET",
            path="/v3/services/{serviceID}/routing-rules",
            base_url=base_url,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.RoutingRulesGetRoutingRulesResponse, http_res
            )
    ...
    def create_or_update(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.RoutingRulesCreateOrUpdateRoutingRulesData:
        r"""Create or Update Routing Rules
        ...
        request = models.RoutingRulesCreateOrUpdateRoutingRulesRequest(
            service_id=service_id,
            v3_services_routing_rules_create_or_update_routing_rules_request=models.V3ServicesRoutingRulesCreateOrUpdateRoutingRulesRequest(
                rules=utils.get_pydantic_model(
                    rules, List[models.V3ServicesRoutingRulesRoutingRule]
                ),
            ),
        )
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request.v3_services_routing_rules_create_or_update_routing_rules_request,
                False,
                False,
                "json",
        ...
        if utils.match_response(http_res, "201", "application/json"):
            return unmarshal_json_response(
                models.RoutingRulesCreateOrUpdateRoutingRulesResponse, http_res
            )
        if utils.match_response(http_res, "400", "application/json"):
            response_data = unmarshal_json_response(
                errors.BadRequestErrorData, http_res
