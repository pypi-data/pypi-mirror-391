...
class Webhook(BaseSDK):
    def trigger(
        ...
        *,
    ...
    ) -> models.V3IncidentsIncidentActionsWebhookActionResponse:
        r"""Trigger a Webhook Manually
        ...
        request = models.IncidentActionsTriggerAWebhookManuallyRequest(
        ...
        req = self._build_request(
            method="POST",
            path="/v3/incidents/{incidentID}/actions/webhook/{eventWebhookID}",
            base_url=base_url,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="IncidentActions_triggerAWebhookManually",
                oauth2_scopes=None,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.IncidentActionsTriggerAWebhookManuallyResponse, http_res
            )
