...
class V3ServicesDeduplicationRulesDeduplicationRuleResponseTypedDict(TypedDict):
    expression: str
    time_window: int
    time_unit: V3ServicesDeduplicationRulesDeduplicationRuleResponseTimeUnit
    is_basic: bool
...
class V3ServicesDeduplicationRulesDeduplicationRuleResponse(BaseModel):
    expression: str
