...
class TaggingRules(BaseSDK):
    def get(
        ...
        *,
    ...
    ) -> models.TaggingRulesGetTaggingRulesData:
        r"""Get Tagging Rules
        ...
        request = models.TaggingRulesGetTaggingRulesRequest(
            service_id=service_id,
        )

        req = self._build_request(
            method="GET",
            path="/v3/services/{serviceID}/tagging-rules",
            base_url=base_url,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.TaggingRulesGetTaggingRulesResponse, http_res
            )
    ...
    def create_or_update(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.TaggingRulesCreateOrUpdateTaggingRulesData:
        r"""Create or Update Tagging Rules
        ...
        request = models.TaggingRulesCreateOrUpdateTaggingRulesRequest(
            service_id=service_id,
            v3_services_tagging_rules_create_or_update_tagging_rules_request=models.V3ServicesTaggingRulesCreateOrUpdateTaggingRulesRequest(
                rules=utils.get_pydantic_model(
                    rules, List[models.V3ServicesTaggingRulesTagRule]
                ),
            ),
        )
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request.v3_services_tagging_rules_create_or_update_tagging_rules_request,
                False,
                False,
                "json",
        ...
        if utils.match_response(http_res, "201", "application/json"):
            return unmarshal_json_response(
                models.TaggingRulesCreateOrUpdateTaggingRulesResponse, http_res
            )
        if utils.match_response(http_res, "400", "application/json"):
            response_data = unmarshal_json_response(
                errors.BadRequestErrorData, http_res
