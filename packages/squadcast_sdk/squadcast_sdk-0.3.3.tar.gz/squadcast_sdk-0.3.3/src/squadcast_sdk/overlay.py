...
from squadcast_sdk.overlay_customcontenttemplates import OverlayCustomContentTemplates
...
class Overlay(BaseSDK):
    custom_content_templates: OverlayCustomContentTemplates
    ...
    def _init_sdks(self):
        self.custom_content_templates = OverlayCustomContentTemplates(
            self.sdk_configuration, parent_ref=self.parent_ref
        )

    def get_optin_for_key_based_deduplication(
        self,
        *,
        service_id: str,
        ...
        request = models.OverlayGetOptinForKeyBasedDeduplicationForAServiceRequest(
            service_id=service_id,
        )

        req = self._build_request(
            method="GET",
            path="/v3/services/{serviceID}/config",
            base_url=base_url,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="Overlay_getOptinForKeyBasedDeduplicationForAService",
                oauth2_scopes=None,
    ...
    async def get_optin_for_key_based_deduplication_async(
        self,
        *,
        service_id: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
    ...
    def optin_for_key_based_deduplication(
        self,
        *,
        service_id: str,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.OverlayOptinForKeyBasedDeduplicationForAServiceResponse:
        r"""Opt-in for Key Based Deduplication for a service

        :param service_id:
        :param dedup_key_enabled:
        :param retries: Override the default retry configuration for this method
        :param server_url: Override the default server URL for this method
        :param timeout_ms: Override the default request timeout configuration for this method in milliseconds
        :param http_headers: Additional headers to set or replace on requests.
        ...
        request = models.OverlayOptinForKeyBasedDeduplicationForAServiceRequest(
            service_id=service_id,
            v3_services_overlay_opt_in_for_key_based_deduplication_request=models.V3ServicesOverlayOptInForKeyBasedDeduplicationRequest(
                dedup_key_enabled=dedup_key_enabled,
            ),
        )
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request.v3_services_overlay_opt_in_for_key_based_deduplication_request,
                False,
                False,
                "json",
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="Overlay_optinForKeyBasedDeduplicationForAService",
                oauth2_scopes=None,
                security_source=self.sdk_configuration.security,
            ),
            request=req,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.OverlayOptinForKeyBasedDeduplicationForAServiceResponse, http_res
            )
        if utils.match_response(http_res, "400", "application/json"):
            response_data = unmarshal_json_response(
                errors.BadRequestErrorData, http_res
    ...
    async def optin_for_key_based_deduplication_async(
        self,
        *,
        service_id: str,
        dedup_key_enabled: Optional[bool] = None,
