...
class StatusPagesIssues(BaseSDK):
    def list(
        self,
        *,
        statuspage_id: str,
    ...
    ) -> List[models.V4StatusPagesIssuesIssue]:
        r"""List Issues
        ...
        request = models.IssuesListIssuesRequest(
            statuspage_id=statuspage_id,
        )

        req = self._build_request(
            method="GET",
            path="/v4/statuspages/{statuspageID}/issues",
            base_url=base_url,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="Issues_listIssues",
                oauth2_scopes=None,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.V4StatusPagesIssuesListIssuesResponse, http_res
            )
    ...
    def create(
        ...
        *,
        ...
        title: str,
        components: Union[
            List[models.V4StatusPagesIssuesCreateIssueRequestComponent],
            List[models.V4StatusPagesIssuesCreateIssueRequestComponentTypedDict],
        ],
        issues: Union[
            List[models.V4StatusPagesIssuesCreateIssueRequestIssue],
            List[models.V4StatusPagesIssuesCreateIssueRequestIssueTypedDict],
        ],
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.V4StatusPagesIssuesCreateIssueResponse:
        r"""Create Issue
        ...
        request = models.IssuesCreateIssueRequest(
            statuspage_id=statuspage_id,
            v4_status_pages_issues_create_issue_request=models.V4StatusPagesIssuesCreateIssueRequest(
                title=title,
                status_id=status_id,
                ...
                issues=utils.get_pydantic_model(
                    issues, List[models.V4StatusPagesIssuesCreateIssueRequestIssue]
                ),
            ),
        )
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request.v4_status_pages_issues_create_issue_request,
                False,
                False,
                "json",
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="Issues_createIssue",
                oauth2_scopes=None,
                security_source=self.sdk_configuration.security,
            ),
            request=req,
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.IssuesCreateIssueResponse, http_res)
        if utils.match_response(http_res, "400", "application/json"):
            response_data = unmarshal_json_response(
                errors.BadRequestErrorData, http_res
            )
    ...
    def get_by_id(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.V4StatusPagesIssuesGetIssueByIDResponse:
        r"""Get Issue By ID
        ...
        request = models.IssuesGetIssueByIDRequest(
            statuspage_id=statuspage_id,
            issue_id=issue_id,
        )
        ...
        req = self._build_request(
            method="GET",
            path="/v4/statuspages/{statuspageID}/issues/{issue_id}",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="Issues_getIssueById",
                oauth2_scopes=None,
                security_source=self.sdk_configuration.security,
            ),
            request=req,
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.IssuesGetIssueByIDResponse, http_res)
        if utils.match_response(http_res, "400", "application/json"):
            response_data = unmarshal_json_response(
                errors.BadRequestErrorData, http_res
            )
