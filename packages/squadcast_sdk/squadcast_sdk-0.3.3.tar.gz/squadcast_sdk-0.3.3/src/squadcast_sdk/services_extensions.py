...
class ServicesExtensions(BaseSDK):
    def update(
        self,
        *,
        service_id: str,
        ...
        request = models.ExtensionsUpdateSlackExtensionRequest(
            service_id=service_id,
            v3_services_extensions_update_slack_extension_request=models.V3ServicesExtensionsUpdateSlackExtensionRequest(
        ...
        req = self._build_request(
            method="PUT",
            path="/v3/services/{serviceID}/extensions",
            base_url=base_url,
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request.v3_services_extensions_update_slack_extension_request,
                False,
                False,
                "json",
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="Extensions_updateSlackExtension",
                oauth2_scopes=None,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.ExtensionsUpdateSlackExtensionResponse, http_res
            )
