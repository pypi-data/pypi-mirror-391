...
from squadcast_sdk.overlays_customcontenttemplates import OverlaysCustomContentTemplates
from squadcast_sdk.services_dedupkey import ServicesDedupKey
...
class ServicesOverlays(BaseSDK):
    custom_content_templates: OverlaysCustomContentTemplates
    dedup_key: ServicesDedupKey
    ...
    def _init_sdks(self):
        self.custom_content_templates = OverlaysCustomContentTemplates(
            self.sdk_configuration, parent_ref=self.parent_ref
        )
        self.dedup_key = ServicesDedupKey(
            self.sdk_configuration, parent_ref=self.parent_ref
        )

    def render_dedup_key(
        self,
        *,
        service_id: str,
        ...
        request = models.OverlayRenderDedupKeyTemplateRequest(
            service_id=service_id,
            v3_services_overlay_render_dedup_key_template_request=models.V3ServicesOverlayRenderDedupKeyTemplateRequest(
        ...
        req = self._build_request(
            method="POST",
            path="/v3/services/{serviceID}/overlays/dedup-key/render",
            base_url=base_url,
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request.v3_services_overlay_render_dedup_key_template_request,
                False,
                False,
                "json",
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="Overlay_renderDedupKeyTemplate",
                oauth2_scopes=None,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.OverlayRenderDedupKeyTemplateResponse, http_res
            )
    ...
    async def render_dedup_key_async(
        self,
        *,
        service_id: str,
        overlay_template_type: str,
