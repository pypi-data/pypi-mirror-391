...
class CommunicationCards(BaseSDK):
    def get_all(
        ...
        *   Requires `access_token` as a `Bearer {{token}}` in the `Authorization` header.
        ...
        request = models.CommunicationCardsGetAllCommunicationCardRequest(
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="CommunicationCards_getAllCommunicationCard",
                oauth2_scopes=None,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.CommunicationCardsGetAllCommunicationCardResponse, http_res
            )
