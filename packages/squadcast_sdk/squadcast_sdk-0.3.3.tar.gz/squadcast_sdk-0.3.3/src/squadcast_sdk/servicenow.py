...
class ServiceNow(BaseSDK):
    def create_incident(
        ...
        *,
    ...
    ) -> models.IncidentActionsCreateAnIncidentInServicenowResponse:
        r"""Create an Incident in ServiceNow
        ...
        request = models.IncidentActionsCreateAnIncidentInServicenowRequest(
            incident_id=incident_id,
        )

        req = self._build_request(
            method="POST",
            path="/v3/incidents/{incidentID}/actions/servicenow/new",
            base_url=base_url,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="IncidentActions_createAnIncidentInServicenow",
                oauth2_scopes=None,
        ...
        if utils.match_response(http_res, "201", "application/json"):
            return unmarshal_json_response(
                models.IncidentActionsCreateAnIncidentInServicenowResponse, http_res
            )
