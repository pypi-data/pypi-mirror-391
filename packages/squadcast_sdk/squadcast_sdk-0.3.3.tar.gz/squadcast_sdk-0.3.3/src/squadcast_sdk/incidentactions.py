...
class IncidentActions(BaseSDK):
    def create_jira_ticket(
        ...
        *,
        ...
        request = models.IncidentActionsCreateATicketOnJiraServerRequest(
            incident_id=incident_id,
        )

        req = self._build_request(
            method="POST",
            path="/v3/incidents/{incidentID}/actions/jira/new/jira-server",
            base_url=base_url,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="IncidentActions_createATicketOnJiraServer",
                oauth2_scopes=None,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.IncidentActionsCreateATicketOnJiraServerResponse, http_res
            )
    ...
    async def create_jira_ticket_async(
        self,
        *,
        incident_id: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
