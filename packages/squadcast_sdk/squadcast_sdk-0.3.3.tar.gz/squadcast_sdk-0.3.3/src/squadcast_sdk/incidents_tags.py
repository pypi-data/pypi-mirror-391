...
class IncidentsTags(BaseSDK):
    def update(
        self,
        *,
        incident_id: str,
        tags: Union[
            models.V3IncidentsTagsUpdateTagRequestTags,
            models.V3IncidentsTagsUpdateTagRequestTagsTypedDict,
        ],
        ...
        request = models.TagsUpdateTagRequest(
            incident_id=incident_id,
            v3_incidents_tags_update_tag_request=models.V3IncidentsTagsUpdateTagRequest(
                tags=utils.get_pydantic_model(
                    tags, models.V3IncidentsTagsUpdateTagRequestTags
                ),
            ),
        )
        ...
        req = self._build_request(
            method="PUT",
            path="/v3/incidents/{IncidentId}/tags",
            base_url=base_url,
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request.v3_incidents_tags_update_tag_request,
                False,
                False,
                "json",
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.TagsUpdateTagResponse, http_res)
    ...
    def append(
        ...
        *,
        ...
        tags: Optional[
            Union[
                models.V3IncidentsTagsAppendTagRequestTags,
                models.V3IncidentsTagsAppendTagRequestTagsTypedDict,
            ]
        ] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        ...
        request = models.TagsAppendTagRequest(
            incident_id=incident_id,
            v3_incidents_tags_append_tag_request=models.V3IncidentsTagsAppendTagRequest(
                tags=utils.get_pydantic_model(
                    tags, Optional[models.V3IncidentsTagsAppendTagRequestTags]
                ),
            ),
        )
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request.v3_incidents_tags_append_tag_request,
                False,
                False,
                "json",
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.TagsAppendTagResponse, http_res)
        if utils.match_response(http_res, "400", "application/json"):
            response_data = unmarshal_json_response(
                errors.BadRequestErrorData, http_res
            )
