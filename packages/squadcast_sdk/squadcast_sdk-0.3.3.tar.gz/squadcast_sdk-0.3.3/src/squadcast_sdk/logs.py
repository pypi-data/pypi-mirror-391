...
class Logs(BaseSDK):
    def get(
        ...
        *,
    ...
    ) -> Optional[models.WorkflowsGetWorkflowLogsResponse]:
        r"""Get Workflow Logs
        ...
        request = models.WorkflowsGetWorkflowLogsRequest(
        ...
        req = self._build_request(
            method="GET",
            path="/v3/workflows/{workflowID}/logs",
            base_url=base_url,
        ...
        def next_func() -> Optional[models.WorkflowsGetWorkflowLogsResponse]:
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.WorkflowsGetWorkflowLogsResponse(
                result=unmarshal_json_response(
                    models.V3WorkflowsGetWorkflowLogsResponse, http_res
                ),
                next=next_func,
            )
