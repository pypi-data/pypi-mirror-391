...
class Maintenance(BaseSDK):
    def create_or_update(
        ...
        *,
        service_id: str,
        on_maintenance: bool,
        service_maintenance: Union[
            List[models.V3ServicesMaintenanceModeServiceMaintenance],
            List[models.V3ServicesMaintenanceModeServiceMaintenanceTypedDict],
        ],
        ...
        :param service_id:
        :param on_maintenance:
        :param service_maintenance:
        ...
        request = models.MaintenanceModeCreateOrUpdateMaintenanceModeRequest(
            service_id=service_id,
            v3_services_maintenance_mode_create_or_update_maintenance_mode_request=models.V3ServicesMaintenanceModeCreateOrUpdateMaintenanceModeRequest(
                on_maintenance=on_maintenance,
                service_maintenance=utils.get_pydantic_model(
                    service_maintenance,
                    List[models.V3ServicesMaintenanceModeServiceMaintenance],
                ),
            ),
        ...
        req = self._build_request(
            method="POST",
            path="/v3/services/{serviceID}/maintenance",
            base_url=base_url,
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request.v3_services_maintenance_mode_create_or_update_maintenance_mode_request,
                False,
                False,
                "json",
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="MaintenanceMode_createOrUpdateMaintenanceMode",
                oauth2_scopes=None,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.MaintenanceModeCreateOrUpdateMaintenanceModeResponse, http_res
            )
