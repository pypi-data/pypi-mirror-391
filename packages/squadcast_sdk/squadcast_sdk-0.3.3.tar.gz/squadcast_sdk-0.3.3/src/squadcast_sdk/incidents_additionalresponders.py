...
class IncidentsAdditionalResponders(BaseSDK):
    def list(
        self,
        *,
        incident_id: str,
        ...
        request = models.AdditionalRespondersGetAdditionalRespondersRequest(
            incident_id=incident_id,
        )

        req = self._build_request(
            method="GET",
            path="/v3/incidents/{incidentID}/additional-responders",
            base_url=base_url,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="AdditionalResponders_getAdditionalResponders",
                oauth2_scopes=None,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.AdditionalRespondersGetAdditionalRespondersResponse, http_res
            )
    ...
    def add(
        ...
        *,
        incident_id: str,
        additional_responders: Union[
            List[models.AdditionalResponder], List[models.AdditionalResponderTypedDict]
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        request = models.AdditionalRespondersAddAdditionalRespondersRequest(
            incident_id=incident_id,
            v3_incidents_additional_responders_add_additional_responders_request=models.V3IncidentsAdditionalRespondersAddAdditionalRespondersRequest(
                additional_responders=utils.get_pydantic_model(
                    additional_responders, List[models.AdditionalResponder]
                ),
            ),
        )
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request.v3_incidents_additional_responders_add_additional_responders_request,
                False,
                False,
                "json",
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="AdditionalResponders_addAdditionalResponders",
                oauth2_scopes=None,
                security_source=self.sdk_configuration.security,
            ),
            request=req,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.AdditionalRespondersAddAdditionalRespondersResponse, http_res
            )
        if utils.match_response(http_res, "400", "application/json"):
            response_data = unmarshal_json_response(
                errors.BadRequestErrorData, http_res
