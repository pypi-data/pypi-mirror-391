...
class SuppressionRules(BaseSDK):
    def get(
        self,
        *,
        service_id: str,
        ...
        request = models.SuppressionRulesGetSuppressionRulesRequest(
            service_id=service_id,
        )

        req = self._build_request(
            method="GET",
            path="/v3/services/{serviceID}/suppression-rules",
            base_url=base_url,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="SuppressionRules_getSuppressionRules",
                oauth2_scopes=None,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.SuppressionRulesGetSuppressionRulesResponse, http_res
            )
    ...
    def create_or_update(
        ...
        *,
        service_id: str,
        rules: Union[
            List[models.V3ServicesSuppressionRulesSuppressionRule],
            List[models.V3ServicesSuppressionRulesSuppressionRuleTypedDict],
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        request = models.SuppressionRulesCreateOrUpdateSuppressionRulesRequest(
            service_id=service_id,
            v3_services_suppression_rules_create_or_update_suppression_rules_request=models.V3ServicesSuppressionRulesCreateOrUpdateSuppressionRulesRequest(
                rules=utils.get_pydantic_model(
                    rules, List[models.V3ServicesSuppressionRulesSuppressionRule]
                ),
            ),
        )
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request.v3_services_suppression_rules_create_or_update_suppression_rules_request,
                False,
                False,
                "json",
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="SuppressionRules_createOrUpdateSuppressionRules",
                oauth2_scopes=None,
                security_source=self.sdk_configuration.security,
            ),
            request=req,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.SuppressionRulesCreateOrUpdateSuppressionRulesResponse, http_res
            )
        if utils.match_response(http_res, "400", "application/json"):
            response_data = unmarshal_json_response(
                errors.BadRequestErrorData, http_res
