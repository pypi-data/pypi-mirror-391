...
class ComponentGroups(BaseSDK):
    def create(
        ...
        *,
        ...
        request = models.ComponentGroupsCreateComponentGroupRequest(
            statuspage_id=statuspage_id,
            v4_status_pages_component_groups_create_component_group_request=models.V4StatusPagesComponentGroupsCreateComponentGroupRequest(
                name=name,
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request.v4_status_pages_component_groups_create_component_group_request,
                False,
                False,
                "json",
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="ComponentGroups_createComponentGroup",
                oauth2_scopes=None,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.ComponentGroupsCreateComponentGroupResponse, http_res
            )
