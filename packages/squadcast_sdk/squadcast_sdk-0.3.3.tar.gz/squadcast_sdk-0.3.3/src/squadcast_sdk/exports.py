...
class Exports(BaseSDK):
    def get_details(
        ...
        *,
        ...
        request = models.ExportGetExportDetailsRequest(
            export_id=export_id,
        )

        req = self._build_request(
            method="GET",
            path="/v3/exports/{export_id}",
            base_url=base_url,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="Export_getExportDetails",
                oauth2_scopes=None,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.ExportGetExportDetailsResponse, http_res
            )
