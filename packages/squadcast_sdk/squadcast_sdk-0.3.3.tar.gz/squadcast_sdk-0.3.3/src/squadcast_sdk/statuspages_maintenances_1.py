...
class StatusPagesMaintenances1(BaseSDK):
    def list(
        self,
        *,
        statuspage_id: str,
        ...
        request = models.MaintenancesListMaintenancesRequest(
        ...
        req = self._build_request(
            method="GET",
            path="/v4/statuspages/{statuspageID}/maintenance",
            base_url=base_url,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="Maintenances_listMaintenances",
                oauth2_scopes=None,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.V4StatusPagesMaintenancesListMaintenancesResponse, http_res
            )
    ...
    def create(
        ...
        *,
        ...
        request = models.MaintenancesCreateMaintenanceRequest(
            statuspage_id=statuspage_id,
            v4_status_pages_maintenances_create_maintenance_request=models.V4StatusPagesMaintenancesCreateMaintenanceRequest(
                title=title,
                note=note,
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request.v4_status_pages_maintenances_create_maintenance_request,
                False,
                False,
                "json",
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="Maintenances_createMaintenance",
                oauth2_scopes=None,
                security_source=self.sdk_configuration.security,
            ),
            request=req,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.MaintenancesCreateMaintenanceResponse, http_res
            )
        if utils.match_response(http_res, "400", "application/json"):
            response_data = unmarshal_json_response(
                errors.BadRequestErrorData, http_res
