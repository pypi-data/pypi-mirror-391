...
class SnoozeNotifications(BaseSDK):
    def snooze(
        self,
        *,
        incident_id: str,
    ...
    ) -> models.V3IncidentsSnoozeNotificationsSnoozeIncidentResponse:
        r"""Snooze Incident Notifications

        :param incident_id:
        :param snooze_duration_in_mins:
        ...
        request = models.SnoozeNotificationsSnoozeIncidentNotificationsRequest(
            incident_id=incident_id,
            v3_incidents_snooze_notifications_snooze_incident_request=models.V3IncidentsSnoozeNotificationsSnoozeIncidentRequest(
                snooze_duration_in_mins=snooze_duration_in_mins,
            ),
        )

        req = self._build_request(
            method="PUT",
            path="/v3/incidents/{incidentID}/snooze",
            base_url=base_url,
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request.v3_incidents_snooze_notifications_snooze_incident_request,
                False,
                False,
                "json",
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="SnoozeNotifications_snoozeIncidentNotifications",
                oauth2_scopes=None,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.SnoozeNotificationsSnoozeIncidentNotificationsResponse, http_res
            )
