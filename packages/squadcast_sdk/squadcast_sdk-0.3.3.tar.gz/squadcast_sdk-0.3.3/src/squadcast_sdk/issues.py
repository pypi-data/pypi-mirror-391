...
class Issues(BaseSDK):
    def delete_by_id(
        ...
        *,
        ...
        request = models.IssuesDeleteIssueByIDRequest(
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="Issues_deleteIssueById",
                oauth2_scopes=None,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.IssuesDeleteIssueByIDResponse, http_res
            )
    ...
    def update(
        ...
        *,
        ...
        title: str,
        components: Union[
            List[models.V4StatusPagesIssuesUpdateIssueRequestComponent],
            List[models.V4StatusPagesIssuesUpdateIssueRequestComponentTypedDict],
        ],
        issues: Union[
            List[models.V4StatusPagesIssuesUpdateIssueRequestIssue],
            List[models.V4StatusPagesIssuesUpdateIssueRequestIssueTypedDict],
        ],
        ...
        request = models.IssuesUpdateIssueRequest(
            statuspage_id=statuspage_id,
            issue_id=issue_id,
            v4_status_pages_issues_update_issue_request=models.V4StatusPagesIssuesUpdateIssueRequest(
                title=title,
                status_id=status_id,
                ...
                issues=utils.get_pydantic_model(
                    issues, List[models.V4StatusPagesIssuesUpdateIssueRequestIssue]
                ),
            ),
        )
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request.v4_status_pages_issues_update_issue_request,
                False,
                False,
                "json",
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="Issues_updateIssue",
                oauth2_scopes=None,
                security_source=self.sdk_configuration.security,
            ),
            request=req,
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.IssuesUpdateIssueResponse, http_res)
        if utils.match_response(http_res, "400", "application/json"):
            response_data = unmarshal_json_response(
                errors.BadRequestErrorData, http_res
            )
    ...
    def list(
        ...
        *,
        ...
        request = models.IssuesListStatusPageIssueStatesRequest(
            statuspage_id=statuspage_id,
        )

        req = self._build_request(
            method="GET",
            path="/v4/statuspages/{statuspageID}/states",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="Issues_listStatusPageIssueStates",
                oauth2_scopes=None,
                security_source=self.sdk_configuration.security,
            ),
            request=req,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.IssuesListStatusPageIssueStatesResponse, http_res
            )
        if utils.match_response(http_res, "400", "application/json"):
            response_data = unmarshal_json_response(
                errors.BadRequestErrorData, http_res
