...
class CommunicationCard(BaseSDK):
    def create_slack_channel(
        ...
        *,
        ...
        req = self._build_request(
            method="POST",
            path="/v3/extensions/slack_v2/channel",
            base_url=base_url,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="CommunicationCards_createSlackChannelInCommunicationCard",
                oauth2_scopes=None,
    ...
    async def create_slack_channel_async(
        self,
        *,
        channel_name: str,
        incident_id: str,
    ...
    def archive_slack_channel(
        ...
        *,
        ...
        req = self._build_request(
            method="POST",
            path="/v3/extensions/slack_v2/channel/archive",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=True,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="CommunicationCards_archiveSlackChannel",
                oauth2_scopes=None,
                security_source=self.sdk_configuration.security,
            ),
            request=req,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.CommunicationCardsArchiveSlackChannelResponse, http_res
            )
        if utils.match_response(http_res, "400", "application/json"):
            response_data = unmarshal_json_response(
                errors.BadRequestErrorData, http_res
    ...
    async def archive_slack_channel_async(
        self,
        *,
        slack_channel_id: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
