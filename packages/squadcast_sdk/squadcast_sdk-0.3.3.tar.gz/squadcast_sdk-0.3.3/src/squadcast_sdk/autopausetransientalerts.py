...
class AutoPauseTransientAlerts(BaseSDK):
    def mark_as_not_transient(
        self,
        *,
        incident_id: str,
        ...
        request = models.AptaMarkAsNotTransientRequest(
            incident_id=incident_id,
        )

        req = self._build_request(
            method="PUT",
            path="/v3/incidents/{incidentID}/mark-as-non-transient",
            base_url=base_url,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="Apta_markAsNotTransient",
                oauth2_scopes=None,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.AptaMarkAsNotTransientResponse, http_res
            )
    ...
    async def mark_as_not_transient_async(
        self,
        *,
        incident_id: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
    ...
    def mark_as_transient(
        ...
        *,
        ...
        request = models.AptaMarkAsTransientRequest(
            incident_id=incident_id,
        )

        req = self._build_request(
            method="PUT",
            path="/v3/incidents/{incidentID}/mark-as-transient",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="Apta_markAsTransient",
                oauth2_scopes=None,
                security_source=self.sdk_configuration.security,
            ),
            request=req,
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.AptaMarkAsTransientResponse, http_res)
        if utils.match_response(http_res, "400", "application/json"):
            response_data = unmarshal_json_response(
                errors.BadRequestErrorData, http_res
            )
    ...
    async def mark_as_transient_async(
        self,
        *,
        incident_id: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
