...
@click.option('--baseModule', help='The base command module path to import', required=True, default="src.gitlab_docs")
@click.option('--baseCommand', help='The base command function to import', required=True, default="gitlab_docs")
@click.option('--docsPath', help='The docs dir path to write the md files', required=True, default="docs/")
def dumps(**kwargs):
    """
    # Click-md
