...
from PyQt5.QtGui import QIcon, QFont, QColor, QPainter, QPixmap, QImage
...
from qfluentwidgets import (CardWidget, setTheme, Theme, IconWidget, BodyLabel, CaptionLabel, PushButton,
                            ...
                            ComboBox, SearchLineEdit, FluentTitleBar)
...
def get_image(
    name: str): return f'.//minibt//miniqt//indicators//resource//{name}'
...
class GalleryCard(HeaderCardWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.flipView.addImages(
            [QImage(png) for png in [get_image(f"shoko{i}.jpg") for i in range(1, 5)]])
...
class SettinsCard(GroupHeaderCardWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.addGroup(QIcon(get_image("Rocket.svg")), "构建目录",
                      "选择 Nuitka 的输出目录", self.chooseButton)
        self.addGroup(QIcon(get_image("Joystick.svg")), "运行终端",
                      "设置是否显示命令行终端", self.comboBox)
        self.addGroup(QIcon(get_image("Python.svg")), "入口脚本",
                      "选择软件的入口脚本", self.lineEdit)
...
class LightBox(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.acrylicBrush = AcrylicBrush(
            self, 30, tintColor, QColor(0, 0, 0, 0))
...
class Demo2(FramelessWindow):
    ...
    def __init__(self):
        ...
        #     r'C:\Users\Lenovo\Desktop\test\PyQt-Fluent-Widgets-master\PyQt-Fluent-Widgets-master\examples\view\card_widget\resource\Hot face.png'))
        ...
        self.titleBar.setTitle('PyQt-Fluent-Widgets')
        self.titleBar.setIcon(QIcon(f":/qfluentwidgets/images/logo.png"))
        self.vBoxLayout = QVBoxLayout(self)
...
class IindicatorsInfo(ScrollArea):
