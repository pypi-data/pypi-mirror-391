...
class SettingInterface(ScrollArea):
    ...
    def _setTheme(self, theme):
        theme = cfg.get(theme)
        self.main_window.futuresinterface.setChartsStyle(isDarkTheme())
        setTheme(theme)
    ...
    def __connectSignalToSlot(self):
        ...
        self.themeCard.optionChanged.connect(lambda ci: self._setTheme(ci))
