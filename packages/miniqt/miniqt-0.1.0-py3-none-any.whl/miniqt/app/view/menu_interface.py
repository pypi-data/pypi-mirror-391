...
class MenuInterface(GalleryInterface):
    ...
    def __init__(self, parent=None):
        ...
        label = QLabel(
            self.tr('Click the image to open a command bar flyout 👇️🥵'))
    ...
    def createCustomWidgetMenu(self, pos):
        ...
        # add custom widget
        card = ProfileCard(':/gallery/images/shoko.png',
                           self.tr('Shoko'), 'shokokawaii@outlook.com', menu)
    ...
    def createCommandBarFlyout(self):
        ...
        view.addAction(Action(FIF.SAVE, self.tr(
            'Save'), triggered=self.saveImage))
        ...
        view.addHiddenAction(
            Action(FIF.PRINT, self.tr('Print'), shortcut='Ctrl+P'))
        view.addHiddenAction(
