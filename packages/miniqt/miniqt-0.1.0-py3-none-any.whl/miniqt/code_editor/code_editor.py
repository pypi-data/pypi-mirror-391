...
from PyQt5.QtWidgets import QPlainTextEdit, QTextEdit, QWidget, QMainWindow, QApplication
from PyQt5 import QtGui, QtCore
# https://blog.csdn.net/withstand/article/details/130486145
    ...
    def resizeEvent(self, *e):
        ...
        if self.DISPLAY_LINE_NUMBERS:  # resize LineNumberArea widget
            ...
            rec = QRect(cr.left(), cr.top(),
                        self.number_bar.get_width(), cr.height())
...
def main():
    ...
    myTree.setCentralWidget(content_edit)
    myTree.show()
    sys.exit(app.exec_())
