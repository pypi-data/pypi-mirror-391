...
class Crawler:
    ...
    def _create_engine(self):
        execution_engine_class: type[ExecutionEngine] = load_object(self.settings.get("EXECUTION_ENGINE", "scrapy.core.engine.ExecutionEngine"))
        return execution_engine_class(self, lambda _: self.stop())
