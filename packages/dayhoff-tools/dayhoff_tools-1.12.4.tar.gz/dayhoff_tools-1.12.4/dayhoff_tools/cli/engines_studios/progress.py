...
def format_idle_state(
    idle_state: Dict[str, Any], detailed: bool = False, attached_studios: Optional[list] = None
) -> str:
    ...
    if attached_studios:
        ...
        studio_names = ", ".join([f"\033[35m{s.get('user', s.get('studio_id', 'unknown'))}\033[0m" for s in attached_studios])
