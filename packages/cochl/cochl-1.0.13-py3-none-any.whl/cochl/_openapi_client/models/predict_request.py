...
class PredictRequest(BaseModel):
    ...
    PredictRequest
    """ # noqa: E501
    sequence: Optional[StrictInt] = Field(default=None, description="The prediction sequence number of this session. Invalid sequence number will fail prediction. ")
    data: StrictStr = Field(description="Audio data encoded in base64 ")
