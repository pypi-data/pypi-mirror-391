...
class GenericError(BaseModel):
    ...
    """ # noqa: E501
    status_code: StrictInt = Field(description="HTTP status code returned ")
    error: StrictStr = Field(description="Human-readable description of the error. *Note that the value should not be used programmatically as the description might be changed at any moment* ")
    __properties: ClassVar[List[str]] = ["status_code", "error"]
