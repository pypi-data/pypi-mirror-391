...
class AudioChunk(BaseModel):
    ...
    AudioChunk 
    """ # noqa: E501
    data: StrictStr = Field(description="Bytes of audio file chunk encoded in Base64 ")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AudioChunk from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AudioChunk from a dict"""
        if obj is None:
            return None
