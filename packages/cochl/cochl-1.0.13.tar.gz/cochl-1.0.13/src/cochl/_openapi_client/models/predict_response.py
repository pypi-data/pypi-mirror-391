...
class PredictResponse(BaseModel):
    ...
    """ # noqa: E501
    data: SenseEvent
    next_sequence: StrictInt = Field(description="The prediction sequence number that client needs to use in next prediction request. ")
    __properties: ClassVar[List[str]] = ["data", "next_sequence"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": SenseEvent.from_dict(obj["data"]) if obj.get("data") is not None else None,
