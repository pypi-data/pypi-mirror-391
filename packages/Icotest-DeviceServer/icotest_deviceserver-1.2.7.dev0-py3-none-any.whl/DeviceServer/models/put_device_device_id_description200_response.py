...
class PutDeviceDeviceIdDescription200Response(BaseModel):
    """
    PutDeviceDeviceIdDescription200Response
    """ # noqa: E501
    message: Optional[StrictStr] = Field(default=None, description="Confirmation message")
    updated_description: Optional[StrictStr] = Field(default=None, description="The updated description of the device")
    __properties: ClassVar[List[str]] = ["message", "updated_description"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "updated_description": obj.get("updated_description")
        })
        return _obj
