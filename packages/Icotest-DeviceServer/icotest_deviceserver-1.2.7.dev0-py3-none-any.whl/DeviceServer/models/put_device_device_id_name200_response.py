...
class PutDeviceDeviceIdName200Response(BaseModel):
    """
    PutDeviceDeviceIdName200Response
    """ # noqa: E501
    message: Optional[StrictStr] = Field(default=None, description="Confirmation message")
    updated_name: Optional[StrictStr] = Field(default=None, description="The updated name of the device")
    __properties: ClassVar[List[str]] = ["message", "updated_name"]
