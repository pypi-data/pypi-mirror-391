...
class DeviceTxBuffer(BaseModel):
    """
    Device message buffer model used for API and database. Internal usage.
    """ # noqa: E501
    message_id: Annotated[str, Field(min_length=1, strict=True, max_length=100)]
    timestamp: Optional[StrictInt] = None
    device_message: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=100)]] = None
    ...
    __properties: ClassVar[List[str]] = ["message_id", "timestamp", "device_message", "device_id", "device_serial", "device_type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "device_message": obj.get("device_message"),
