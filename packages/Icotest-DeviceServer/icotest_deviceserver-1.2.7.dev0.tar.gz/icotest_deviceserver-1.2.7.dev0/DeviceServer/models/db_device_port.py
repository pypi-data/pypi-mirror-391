...
class DbDevicePort(BaseModel):
    """
    Describes State of a port in database
    """ # noqa: E501
    port_id: Annotated[str, Field(strict=True, max_length=100)]
    ...
    __properties: ClassVar[List[str]] = ["port_id", "port_index", "device_id", "label", "state_index"]
