...
from aignx.codegen.api_response import ApiResponse, T as ApiResponseT
import aignx.codegen.models
from aignx.codegen import rest
from aignx.codegen.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(aignx.codegen.models, klass)
