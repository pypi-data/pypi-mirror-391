...
class TestRemoteNexusFS:
    ...
    def client(self, mock_session):
        """Create RemoteNexusFS client with mocked session."""
        with patch("nexus.remote.client.requests.Session", return_value=mock_session):
    ...
    def test_call_rpc_success(self, client, mock_session):
    ...
    def test_call_rpc_network_error(self, client, mock_session):
    ...
    def test_call_rpc_http_error(self, client, mock_session):
    ...
    def test_read(self, client, mock_session):
        """Test read method."""
        mock_response = Mock()
        mock_response.status_code = 200
    ...
    def test_write(self, client, mock_session):
        """Test write method."""
        mock_response = Mock()
        mock_response.status_code = 200
    ...
    def test_exists(self, client, mock_session):
        """Test exists method."""
        mock_response = Mock()
        mock_response.status_code = 200
    ...
    def test_glob(self, client, mock_session):
        """Test glob method."""
        mock_response = Mock()
        mock_response.status_code = 200
    ...
    def test_mkdir(self, client, mock_session):
        """Test mkdir method."""
        mock_response = Mock()
        mock_response.status_code = 200
    ...
    def test_is_directory(self, client, mock_session):
