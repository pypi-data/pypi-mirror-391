...
setup(
    ...
    install_requires=['numpy==1.26.4', 'scipy', 'sympy', 'pandas', 'matplotlib','plotly','scikit-learn','db-sqlite3'
                      ,'seaborn','pubchempy','biopython','pysb','bionetgen','bioservices','qgrid==1.3.0','kaleido','cython'],
