...
7. Если требуется фильтровать по времени попадания сделки в стадию, используй пользовательское поле "время попадания в {название стадии}" в filter_fields или select_fields.
