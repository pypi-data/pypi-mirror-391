...
def initialize_otel(settings: OTelSettings, configure_tracing: Callable[[TraceProvider], None] | None = None, configure_logging: Callable[[LoggerProvider], None] | None = None) -> None: ...
