import { i as se, a as j, r as le, Z as R, g as ae } from "./Index-Bdxki1Cc.js";
...
function Ke(e) {
  ...
  return {
    c() {
      t = ee("react-portal-target"), o = Fe(), n && n.c(), s = H(), this.h();
    },
    l(r) {
      t = $(r, "REACT-PORTAL-TARGET", {
        class: !0
      }), Q(t).forEach(I), o = Pe(r), n && n.l(r), s = H(), this.h();
    },
    h() {
      te(t, "class", "svelte-1rt0kpf");
    },
    ...
    p(r, [l]) {
      ...
      16 && k(n, 1)) : (n = q(r), n.c(), k(n, 1), n.m(s.parentNode, s)) : n && (We(), W(n, 1, 1, () => {
        n = null;
      }), ke());
    },
    i(r) {
      ...
      props: {
        svelteInit(r) {
          ...
          return d.nodes = [...d.nodes, l], J({
            ...
            d.nodes = d.nodes.filter((p) => p.svelteInstance !== i), J({
              createPortal: N,
              node: A
            });
          }), l;
  ...
  return ie(() => {
    ...
    if (h && window.MutationObserver) {
      let f = function() {
        ...
        a = S, d(w), a.style.display = "contents", y && clearTimeout(y), y = setTimeout(() => {
          g();
      ...
      a.style.display = "contents", g(), (E = r.current) == null || E.appendChild(a);
    return () => {
      var f, _;
