import { Z as m, g as M } from "./Index-ynovUJPi.js";
...
function ne(r) {
  ...
  return {
    c() {
      s = D("react-portal-target"), n = Y(), e && e.c(), l = S(), this.h();
    },
    l(t) {
...
function le(r, s, n) {
  ...
  const d = m();
  y(r, d, (i) => n(1, o = i));
  const h = [], A = te("$$ms-gr-react-wrapper"), {
    slotKey: K,
    slotIndex: L,
    subSlotIndex: O
  } = M() || {}, x = c({
