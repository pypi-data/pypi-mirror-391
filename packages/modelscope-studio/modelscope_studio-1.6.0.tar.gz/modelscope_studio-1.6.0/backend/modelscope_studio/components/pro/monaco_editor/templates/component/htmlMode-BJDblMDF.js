import { m as ft } from "./editor.main-BMgcVphl.js";
/*!-----------------------------------------------------------------------------
...
var gt = Object.defineProperty, ht = Object.getOwnPropertyDescriptor, vt = Object.getOwnPropertyNames, pt = Object.prototype.hasOwnProperty, mt = (e, n, i, r) => {
  if (n && typeof n == "object" || typeof n == "function")
    for (let t of vt(n)) !pt.call(e, t) && t !== i && gt(e, t, {
      get: () => n[t],
      enumerable: !(r = ht(n, t)) || r.enumerable
    });
  return e;
}, _t = (e, n, i) => (mt(e, n, "default"), i), c = {};
_t(c, ft);
function wt(e, n) {
  var r;
...
function bt(e) {
  ...
  if (i) {
    ...
    if (typeof i.getWorkerUrl == "function") {
      ...
      return new Worker(y ? y.createScriptURL(r) : r, {
        name: n,
        type: "module"
      });
    }
...
(function(e) {
  function n(r, t, o) {
    ...
    return typeof t == "string" ? (u = !1, s.kind = t) : E.is(t) ? s.command = t : s.edit = t, u && o !== void 0 && (s.kind = o), s;
  }
  e.create = n;
  function i(r) {
    let t = r;
...
var Wt = class {
  constructor(e, n, i) {
    ...
    this._disposables.push(c.editor.onDidCreateModel(r)), this._disposables.push(c.editor.onWillDisposeModel(t)), this._disposables.push(c.editor.onDidChangeModelLanguage((o) => {
      t(o.model), r(o.model);
...
var Pt = class {
  ...
  provideCompletionItems(e, n, i, r) {
    ...
    return this._worker(t).then((o) => o.doComplete(t.toString(), k(n))).then((o) => {
      if (!o)
        return;
      const s = e.getWordUntilPosition(n), u = new c.Range(n.lineNumber, s.startColumn, n.lineNumber, s.endColumn), f = o.items.map((d) => {
        const g = {
          label: d.label,
        ...
        } : g.range = m(d.textEdit.range), g.insertText = d.textEdit.newText), d.additionalTextEdits && (g.additionalTextEdits = d.additionalTextEdits.map(M)), d.insertTextFormat === G.Snippet && (g.insertTextRules = c.languages.CompletionItemInsertTextRule.InsertAsSnippet), g;
      });
      return {
