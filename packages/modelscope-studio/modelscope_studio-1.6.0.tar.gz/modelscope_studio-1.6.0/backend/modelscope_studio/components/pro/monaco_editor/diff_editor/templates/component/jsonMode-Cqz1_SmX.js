import { m as Lt } from "./editor.main-BMgcVphl.js";
/*!-----------------------------------------------------------------------------
...
var Ot = Object.defineProperty, Nt = Object.getOwnPropertyDescriptor, Mt = Object.getOwnPropertyNames, Rt = Object.prototype.hasOwnProperty, Tt = (e, r, i, n) => {
  if (r && typeof r == "object" || typeof r == "function")
    for (let t of Mt(r)) !Rt.call(e, t) && t !== i && Ot(e, t, {
      get: () => r[t],
...
function Ut(e, r) {
  ...
  try {
    return (n = globalThis.trustedTypes) == null ? void 0 : n.createPolicy(e, r);
  } catch (t) {
    console.error(t);
    return;
  }
...
function Ft(e) {
  ...
  if (i) {
    ...
    if (typeof i.getWorkerUrl == "function") {
      ...
      return new Worker(B ? B.createScriptURL(n) : n, {
        name: r,
        type: "module"
      });
    }
...
(function(e) {
  function r(n, t) {
    return n === Number.MAX_VALUE && (n = H.MAX_VALUE), t === Number.MAX_VALUE && (t = H.MAX_VALUE), {
      line: n,
      character: t
    };
  }
...
var Wt = class {
  constructor(e, r, i) {
    ...
    this._disposables.push(f.editor.onDidCreateModel(n)), this._disposables.push(f.editor.onWillDisposeModel(t)), this._disposables.push(f.editor.onDidChangeModelLanguage((o) => {
      t(o.model), n(o.model);
...
var Bt = class {
  ...
  provideCompletionItems(e, r, i, n) {
    ...
    return this._worker(t).then((o) => o.doComplete(t.toString(), M(r))).then((o) => {
      if (!o)
        return;
      const s = e.getWordUntilPosition(r), u = new f.Range(r.lineNumber, s.startColumn, r.lineNumber, s.endColumn), g = o.items.map((c) => {
        const v = {
          label: c.label,
...
function w(e) {
  if (e)
    return new f.Range(e.start.line + 1, e.start.character + 1, e.end.line + 1, e.end.character + 1);
}
function Ht(e) {
...
var en = class {
  ...
  provideColorPresentations(e, r, i) {
    const n = e.uri;
    return this._worker(n).then((t) => t.getColorPresentations(n.toString(), r.color, vt(r.range))).then((t) => {
      if (t)
        return t.map((o) => {
          let s = {
            label: o.label
...
var rn = class {
  ...
  provideSelectionRanges(e, r, i) {
    const n = e.uri;
    return this._worker(n).then((t) => t.getSelectionRanges(n.toString(), r.map(M))).then((t) => {
      if (t)
        return t.map((o) => {
          const s = [];
          for (; o; )
...
function hn(e, r, i, n = 0) {
  ...
  for (; ; ) {
    ...
    c.endState = new wt(i.getStateData(), s.getTokenError(), u, g), c.tokens.push({
      startIndex: v,
      scopes: d
    });
  }
...
var kn = class extends Wt {
  constructor(e, r, i) {
    super(e, r, i.onDidChange), this._disposables.push(f.editor.onWillDisposeModel((n) => {
      this._resetSchema(n.uri);
    })), this._disposables.push(f.editor.onDidChangeModelLanguage((n) => {
...
function Nn(e) {
  ...
  function t() {
    ...
    At(i), u.documentFormattingEdits && i.push(f.languages.registerDocumentFormattingEditProvider(s, new Kt(I))), u.documentRangeFormattingEdits && i.push(f.languages.registerDocumentRangeFormattingEditProvider(s, new Ct(I))), u.completionItems && i.push(f.languages.registerCompletionItemProvider(s, new Bt(I, [" ", ":", '"']))), u.hovers && i.push(f.languages.registerHoverProvider(s, new qt(I))), u.documentSymbols && i.push(f.languages.registerDocumentSymbolProvider(s, new Gt(I))), u.tokens && i.push(f.languages.setTokensProvider(s, an(!0))), u.colors && i.push(f.languages.registerColorProvider(s, new en(I))), u.foldingRanges && i.push(f.languages.registerFoldingRangeProvider(s, new tn(I))), u.diagnostics && i.push(new kn(s, I, e)), u.selectionRanges && i.push(f.languages.registerSelectionRangeProvider(s, new rn(I)));
  }
