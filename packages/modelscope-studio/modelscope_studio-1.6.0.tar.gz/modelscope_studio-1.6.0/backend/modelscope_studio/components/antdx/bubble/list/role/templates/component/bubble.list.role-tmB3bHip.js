import { Z as f, g as G, j as M } from "./Role-Ch44D43O.js";
...
const {
  SvelteComponent: ue
} = window.__gradio__svelte__internal, S = window.ms_globals.rerender, g = window.ms_globals.tree;
function ae(n, s = {}) {
  function l(r) {
    const o = f(), e = new ie({
      ...r,
