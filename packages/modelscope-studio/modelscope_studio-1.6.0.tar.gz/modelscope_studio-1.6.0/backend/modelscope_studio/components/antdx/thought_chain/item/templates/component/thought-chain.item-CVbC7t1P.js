import { Z as m, g as G } from "./Index-DfBZCO3X.js";
...
const {
  SvelteComponent: Ie
} = window.__gradio__svelte__internal, R = window.ms_globals.rerender, h = window.ms_globals.tree;
function he(r, t = {}) {
  function l(n) {
    const o = m(), e = new we({
      ...n,
...
const {
  ...
  ItemHandler: be
} = H("antdx-thought-chain-items"), ke = he((r) => /* @__PURE__ */ X.jsx(be, {
  ...r
}));
export {
