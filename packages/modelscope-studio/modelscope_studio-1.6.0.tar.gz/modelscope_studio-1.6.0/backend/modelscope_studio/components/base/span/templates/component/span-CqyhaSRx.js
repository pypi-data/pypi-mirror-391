import { Z as m, g as Y, t as Z, s as _ } from "./Index-Dx9faTkp.js";
...
function Re(n, t) {
  const l = j(() => T.Children.toArray(n.originalChildren || n).filter((e) => e.props.node && !e.props.node.ignore && (!e.props.nodeSlotKey || t)).sort((e, s) => {
