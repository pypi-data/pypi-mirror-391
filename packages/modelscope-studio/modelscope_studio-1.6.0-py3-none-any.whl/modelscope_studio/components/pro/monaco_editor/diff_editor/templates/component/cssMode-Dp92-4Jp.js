import { m as tt } from "./editor.main-BMgcVphl.js";
/*!-----------------------------------------------------------------------------
...
var rt = Object.defineProperty, nt = Object.getOwnPropertyDescriptor, it = Object.getOwnPropertyNames, ot = Object.prototype.hasOwnProperty, at = (e, n, i, r) => {
  if (n && typeof n == "object" || typeof n == "function")
    for (let t of it(n)) !ot.call(e, t) && t !== i && rt(e, t, {
      get: () => n[t],
...
function ct(e, n) {
  ...
  try {
    return (r = globalThis.trustedTypes) == null ? void 0 : r.createPolicy(e, n);
  } catch (t) {
    console.error(t);
    return;
  }
...
function ut(e) {
  ...
  if (i) {
    ...
    if (typeof i.getWorkerUrl == "function") {
      ...
      return new Worker(M ? M.createScriptURL(r) : r, {
        name: n,
        type: "module"
      });
    }
...
(function(e) {
  function n(r, t) {
    return r === Number.MAX_VALUE && (r = D.MAX_VALUE), t === Number.MAX_VALUE && (t = D.MAX_VALUE), {
      line: r,
      character: t
    };
  }
...
var mt = class {
  ...
  provideCompletionItems(e, n, i, r) {
    ...
    return this._worker(t).then((o) => o.doComplete(t.toString(), k(n))).then((o) => {
      if (!o)
        return;
      const s = e.getWordUntilPosition(n), c = new d.Range(n.lineNumber, s.startColumn, n.lineNumber, s.endColumn), f = o.items.map((u) => {
        const g = {
          label: u.label,
...
function m(e) {
  if (e)
    return new d.Range(e.start.line + 1, e.start.character + 1, e.end.line + 1, e.end.character + 1);
}
function _t(e) {
...
var jt = class {
  ...
  provideColorPresentations(e, n, i) {
    const r = e.uri;
    return this._worker(r).then((t) => t.getColorPresentations(r.toString(), n.color, Ge(n.range))).then((t) => {
      if (t)
        return t.map((o) => {
          let s = {
            label: o.label
...
function Vt(e) {
  ...
  function o() {
    ...
    Ke(i), c.completionItems && i.push(d.languages.registerCompletionItemProvider(s, new mt(t, ["/", "-", ":"]))), c.hovers && i.push(d.languages.registerHoverProvider(s, new kt(t))), c.documentHighlights && i.push(d.languages.registerDocumentHighlightProvider(s, new It(t))), c.definitions && i.push(d.languages.registerDefinitionProvider(s, new At(t))), c.references && i.push(d.languages.registerReferenceProvider(s, new Rt(t))), c.documentSymbols && i.push(d.languages.registerDocumentSymbolProvider(s, new Mt(t))), c.rename && i.push(d.languages.registerRenameProvider(s, new Pt(t))), c.colors && i.push(d.languages.registerColorProvider(s, new jt(t))), c.foldingRanges && i.push(d.languages.registerFoldingRangeProvider(s, new Ut(t))), c.diagnostics && i.push(new ht(s, t, e.onDidChange)), c.selectionRanges && i.push(d.languages.registerSelectionRangeProvider(s, new Nt(t))), c.documentFormattingEdits && i.push(d.languages.registerDocumentFormattingEditProvider(s, new Ct(t))), c.documentRangeFormattingEdits && i.push(d.languages.registerDocumentRangeFormattingEditProvider(s, new Ft(t)));
  }
