...
var dn = "[object Null]", gn = "[object Undefined]", Ge = P ? P.toStringTag : void 0;
function N(e) {
  return e == null ? e === void 0 ? gn : dn : Ge && Ge in Object(e) ? ln(e) : pn(e);
}
function I(e) {
...
var de = E["__core-js_shared__"], He = function() {
...
var xt = typeof exports == "object" && exports && !exports.nodeType && exports, Je = xt && typeof module == "object" && module && !module.nodeType && module, er = Je && Je.exports === xt, qe = er ? E.Buffer : void 0, tr = qe ? qe.isBuffer : void 0, ae = tr || kn, nr = "[object Arguments]", rr = "[object Array]", or = "[object Boolean]", ir = "[object Date]", ar = "[object Error]", sr = "[object Function]", ur = "[object Map]", lr = "[object Number]", cr = "[object Object]", fr = "[object RegExp]", pr = "[object Set]", dr = "[object String]", gr = "[object WeakMap]", _r = "[object ArrayBuffer]", hr = "[object DataView]", mr = "[object Float32Array]", br = "[object Float64Array]", yr = "[object Int8Array]", vr = "[object Int16Array]", Tr = "[object Int32Array]", wr = "[object Uint8Array]", Pr = "[object Uint8ClampedArray]", Or = "[object Uint16Array]", Ar = "[object Uint32Array]", v = {};
v[mr] = v[br] = v[yr] = v[vr] = v[Tr] = v[wr] = v[Pr] = v[Or] = v[Ar] = !0;
v[nr] = v[rr] = v[_r] = v[or] = v[hr] = v[ir] = v[ar] = v[sr] = v[ur] = v[lr] = v[cr] = v[fr] = v[pr] = v[dr] = v[gr] = !1;
function $r(e) {
...
var ri = "[object Boolean]", oi = "[object Date]", ii = "[object Map]", ai = "[object Number]", si = "[object RegExp]", ui = "[object Set]", li = "[object String]", ci = "[object Symbol]", fi = "[object ArrayBuffer]", pi = "[object DataView]", di = "[object Float32Array]", gi = "[object Float64Array]", _i = "[object Int8Array]", hi = "[object Int16Array]", mi = "[object Int32Array]", bi = "[object Uint8Array]", yi = "[object Uint8ClampedArray]", vi = "[object Uint16Array]", Ti = "[object Uint32Array]";
function wi(e, t, n) {
  var r = e.constructor;
  switch (t) {
    case fi:
...
function re(e, t, n, r, o, i) {
  ...
  if (c)
    return c;
  i.set(e, a), xi(e) ? e.forEach(function(d) {
    a.add(re(d, t, n, d, e, i));
  }) : Ai(e) && e.forEach(function(d, h) {
    a.set(h, re(d, t, n, h, e, i));
  });
  var _ = Kt, f = s ? void 0 : _(e);
  return Un(f || e, function(d, h) {
    f && (h = d, d = e[h]), Ot(a, h, re(d, t, n, h, e, i));
  }), a;
}
...
function zt(e, t, n, r, o, i) {
  ...
  if (l && c)
    return l == t && c == e;
  var _ = -1, f = !0, d = n & oa ? new ue() : void 0;
  for (i.set(e, t), i.set(t, e); ++_ < s; ) {
    var h = e[_], b = t[_];
    if (r)
      var p = a ? r(b, h, _, t, e, i) : r(h, b, _, e, t, i);
    if (p !== void 0) {
      if (p)
        continue;
      f = !1;
...
var sa = 1, ua = 2, la = "[object Boolean]", ca = "[object Date]", fa = "[object Error]", pa = "[object Map]", da = "[object Number]", ga = "[object RegExp]", _a = "[object Set]", ha = "[object String]", ma = "[object Symbol]", ba = "[object ArrayBuffer]", ya = "[object DataView]", ct = P ? P.prototype : void 0, _e = ct ? ct.valueOf : void 0;
...
var Aa = 1, ft = "[object Arguments]", pt = "[object Array]", ne = "[object Object]", $a = Object.prototype, dt = $a.hasOwnProperty;
function Sa(e, t, n, r, o, i) {
  var a = S(e), s = S(t), u = a ? pt : $(e), l = s ? pt : $(t);
  ...
  if (!(n & Aa)) {
    var d = c && dt.call(e, "__wrapped__"), h = _ && dt.call(t, "__wrapped__");
    if (d || h) {
      var b = d ? e.value() : e, p = h ? t.value() : t;
...
function os(e, t) {
  ...
  return {
    ...Array.from(/* @__PURE__ */ new Set([...Object.keys(r).map((u) => {
      ...
      const c = l.split("_"), _ = (...d) => {
        const h = d.map((p) => d && typeof p == "object" && (p.nativeEvent || p instanceof Event) ? {
          type: p.type,
          detail: p.detail,
      ...
      if (c.length > 1) {
        ...
        return d[`on${h.slice(0, 1).toUpperCase()}${h.slice(1)}`] = _, u;
      }
      const f = c[0];
...
function Js(e, t, n) {
  ...
  const h = ts(() => import("./monaco-editor-anZddxgG.js"));
  let {
    value: b
  } = t, {
    _loader: p
  ...
  return e.$$set = (g) => {
    ...
    524801 && n(2, r = {
      style: c.elem_style,
      className: vs(c.elem_classes, "ms-gr-pro-monaco-editor"),
      id: c.elem_id,
      ...c.restProps,
      ...c.props,
      ...os(c),
    ...
    256 && n(18, o = p == null ? void 0 : p.mode), e.$$.dirty & /*_loader*/
    256 && n(17, i = p == null ? void 0 : p.cdn_url), e.$$.dirty & /*mode, cdn_url*/
    393216 && n(1, a = o === "local" ? Ts() : i ? ws(i) : void 0);
  }, [c, a, r, h, O, Ke, Ue, b, p, T, w, x, A, V, k, ee, te, i, o, l, _, f, d];
}
class Ys extends Ps {
  constructor(t) {
