import { Z as m, g as B } from "./Index-DrvnVqUh.js";
const W = window.ms_globals.React, I = window.ms_globals.ReactDOM.createPortal, G = window.ms_globals.createItemsContext.createItemsContext;
var O = {
  exports: {}
}, g = {};
/**
  ...
  return {
    ...
    l(s) {
      t = D(s, "REACT-PORTAL-TARGET", {
        class: !0
      }), j(t).forEach(c), l = te(s), e && e.l(s), n = S(), this.h();
    },
    h() {
      z(t, "class", "svelte-1rt0kpf");
    },
...
const {
  ...
  useItems: ke,
  ItemHandler: ve
} = G("antd-slider-marks"), xe = be((r) => /* @__PURE__ */ X.jsx(ve, {
  ...r
}));
export {
  xe as SliderMark,
