import { Z as m, g as G } from "./Index-HdxTOijL.js";
  ...
  return {
    ...
    l(s) {
      t = D(s, "REACT-PORTAL-TARGET", {
        class: !0
      }), j(t).forEach(c), r = te(s), e && e.l(s), n = k(), this.h();
    },
    h() {
      z(t, "class", "svelte-1rt0kpf");
    },
    ...
    p(s, [a]) {
      ...
      16 && w(e, 1)) : (e = C(s), e.c(), w(e, 1), e.m(n.parentNode, n)) : e && (re(), v(e, 1, 1, () => {
        e = null;
      }), ee());
    },
    i(s) {
...
function we(l, t, r) {
  ...
  return l.$$set = (i) => {
    r(17, t = y(y({}, t), P(i))), "svelteInit" in i && r(5, _ = i.svelteInit), "$$scope" in i && r(6, s = i.$$scope);
  }, t = P(t), [n, o, f, d, a, _, s, e, F, W];
}
class ge extends $ {
  constructor(t) {
...
const {
  ...
  useItems: xe,
  ItemHandler: ve
} = H("splitter.panels"), Se = be((l) => /* @__PURE__ */ X.jsx(ve, {
  ...l
}));
export {
  Se as SplitterPanel,
