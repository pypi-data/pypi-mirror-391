import { Z as m, g as G } from "./Index-6-rv5lQ9.js";
  ...
  return {
    ...
    l(s) {
      t = D(s, "REACT-PORTAL-TARGET", {
        class: !0
      }), j(t).forEach(_), l = te(s), e && e.l(s), n = P(), this.h();
    },
    h() {
      z(t, "class", "svelte-1rt0kpf");
    },
    ...
    p(s, [a]) {
      ...
      16 && w(e, 1)) : (e = S(s), e.c(), w(e, 1), e.m(n.parentNode, n)) : e && (le(), v(e, 1, 1, () => {
        e = null;
      }), ee());
    },
    i(s) {
...
const {
  ...
  useItems: ke,
  ItemHandler: ve
} = H("antd-color-picker-presets"), xe = be((r) => /* @__PURE__ */ X.jsx(ve, {
  ...r
}));
export {
