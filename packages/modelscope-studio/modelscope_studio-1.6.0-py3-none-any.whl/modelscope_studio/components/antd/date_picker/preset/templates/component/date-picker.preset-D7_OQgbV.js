import { Z as m, g as G } from "./Index-Dh2U6X4l.js";
...
function pe(r) {
  ...
  return {
    c() {
      t = L("react-portal-target"), l = ce(), e && e.c(), n = P(), this.h();
    },
    l(s) {
      t = j(s, "REACT-PORTAL-TARGET", {
        class: !0
      }), D(t).forEach(_), l = te(s), e && e.l(s), n = P(), this.h();
    },
    h() {
      z(t, "class", "svelte-1rt0kpf");
    },
    ...
    p(s, [a]) {
      ...
      16 && w(e, 1)) : (e = C(s), e.c(), w(e, 1), e.m(n.parentNode, n)) : e && (le(), v(e, 1, 1, () => {
        e = null;
      }), ee());
    },
    i(s) {
...
const {
  ...
  useItems: ke,
  ItemHandler: ve
} = H("antd-date-picker-presets"), xe = be((r) => /* @__PURE__ */ X.jsx(ve, {
  ...r
}));
export {
