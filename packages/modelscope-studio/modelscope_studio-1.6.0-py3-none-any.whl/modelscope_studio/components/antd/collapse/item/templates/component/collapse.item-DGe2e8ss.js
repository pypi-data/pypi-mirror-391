import { Z as m, g as G } from "./Index-C5MYjllt.js";
...
function pe(l) {
  ...
  return {
    c() {
      t = L("react-portal-target"), r = ce(), e && e.c(), n = C(), this.h();
    },
    l(s) {
      t = D(s, "REACT-PORTAL-TARGET", {
        class: !0
      }), j(t).forEach(_), r = te(s), e && e.l(s), n = C(), this.h();
    },
    h() {
      z(t, "class", "svelte-1rt0kpf");
    },
...
function we(l, t, r) {
  ...
  return l.$$set = (i) => {
    r(17, t = y(y({}, t), S(i))), "svelteInit" in i && r(5, c = i.svelteInit), "$$scope" in i && r(6, s = i.$$scope);
  }, t = S(t), [n, o, f, d, a, c, s, e, F, W];
}
class ge extends $ {
  constructor(t) {
...
const {
  ...
  useItems: xe,
  ItemHandler: ve
} = H("antd-collapse-items"), ke = be((l) => /* @__PURE__ */ X.jsx(ve, {
  ...l
}));
export {
  ke as CollapseItem,
