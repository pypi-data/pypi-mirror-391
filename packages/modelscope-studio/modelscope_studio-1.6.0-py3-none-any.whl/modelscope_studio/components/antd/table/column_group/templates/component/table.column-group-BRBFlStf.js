import { Z as f, g as B } from "./Index-CBupeO53.js";
const W = window.ms_globals.React, x = window.ms_globals.ReactDOM.createPortal, I = window.ms_globals.createItemsContext.createItemsContext;
var T = {
  exports: {}
}, b = {};
/**
...
function pe(l) {
  ...
  return {
    ...
    p(o, [a]) {
      ...
      16 && w(e, 1)) : (e = R(o), e.c(), w(e, 1), e.m(s.parentNode, s)) : e && (re(), g(e, 1, 1, () => {
        e = null;
      }), ee());
    },
    i(o) {
