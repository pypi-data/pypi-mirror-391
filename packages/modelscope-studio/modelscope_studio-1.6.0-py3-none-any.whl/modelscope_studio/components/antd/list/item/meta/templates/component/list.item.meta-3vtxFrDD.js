import { i as se, a as W, r as le, Z as R, g as ae } from "./Index-CaC0Xwt1.js";
...
var D = NaN, pe = /^[-+]0x[0-9a-f]+$/i, he = /^0b[01]+$/i, ge = /^0o[0-7]+$/i, we = parseInt;
function U(e) {
  if (typeof e == "number")
    return e;
  if (se(e))
  ...
  e = _e(e);
  var o = he.test(e);
  return o || ge.test(e) ? we(e.slice(2), o ? 2 : 8) : pe.test(e) ? D : +e;
}
var L = function() {
  return le.Date.now();
  ...
  return ie(() => {
    ...
    if (h && window.MutationObserver) {
      let f = function() {
        ...
        a = S, d(w), a.style.display = "contents", E && clearTimeout(E), E = setTimeout(() => {
          g();
