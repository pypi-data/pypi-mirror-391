import { Z as m, g as G } from "./Index-sBn4yavE.js";
  ...
  return {
    ...
    l(o) {
      t = D(o, "REACT-PORTAL-TARGET", {
        class: !0
      }), j(t).forEach(_), r = te(o), e && e.l(o), n = k(), this.h();
    },
    h() {
      A(t, "class", "svelte-1rt0kpf");
    },
    ...
    p(o, [a]) {
      ...
      16 && w(e, 1)) : (e = E(o), e.c(), w(e, 1), e.m(n.parentNode, n)) : e && (re(), h(e, 1, 1, () => {
        e = null;
      }), ee());
    },
    i(o) {
...
function we(l, t, r) {
  ...
  const d = m();
  S(l, d, (i) => r(1, s = i));
  const v = [], z = fe("$$ms-gr-react-wrapper"), {
    slotKey: N,
    slotIndex: q,
    subSlotIndex: K
  } = G() || {}, U = c({
  ...
  return l.$$set = (i) => {
    r(17, t = y(y({}, t), C(i))), "svelteInit" in i && r(5, c = i.svelteInit), "$$scope" in i && r(6, o = i.$$scope);
  }, t = C(t), [n, s, f, d, a, c, o, e, F, W];
}
class ge extends $ {
  constructor(t) {
...
const {
  ...
  ItemHandler: he
} = H("antd-anchor-items"), Se = be((l) => /* @__PURE__ */ X.jsx(he, {
  ...l,
