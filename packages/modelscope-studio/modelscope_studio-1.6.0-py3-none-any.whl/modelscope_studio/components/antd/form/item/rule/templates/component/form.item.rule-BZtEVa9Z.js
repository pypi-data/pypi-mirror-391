import { Z as m, g as B } from "./Index-CnrtVViO.js";
const W = window.ms_globals.React, h = window.ms_globals.ReactDOM.createPortal, G = window.ms_globals.createItemsContext.createItemsContext;
var O = {
  exports: {}
}, g = {};
/**
...
function pe(r) {
  ...
  return {
    ...
    p(s, [a]) {
      ...
      16 && w(e, 1)) : (e = P(s), e.c(), w(e, 1), e.m(n.parentNode, n)) : e && (le(), v(e, 1, 1, () => {
        e = null;
      }), ee());
    },
    i(s) {
...
function we(r, t, l) {
  ...
  const d = m();
  x(r, d, (i) => l(1, o = i));
  const I = [], A = fe("$$ms-gr-react-wrapper"), {
    slotKey: N,
    slotIndex: q,
    subSlotIndex: F
  } = B() || {}, K = _({
...
const {
  SvelteComponent: he
} = window.__gradio__svelte__internal, E = window.ms_globals.rerender, b = window.ms_globals.tree;
function be(r, t = {}) {
  function l(n) {
    const o = m(), e = new ge({
      ...n,
      props: {
        svelteInit(s) {
          ...
          return _.nodes = [..._.nodes, a], E({
            createPortal: h,
            node: b
          }), s.onDestroy(() => {
            _.nodes = _.nodes.filter((u) => u.svelteInstance !== o), E({
              createPortal: h,
              node: b
            });
          }), a;
...
const {
  ...
  useItems: Re,
  ItemHandler: ve
} = G("antd-form-item-rules"), xe = be((r) => /* @__PURE__ */ X.jsx(ve, {
  ...r
}));
export {
  xe as FormItemRule,
