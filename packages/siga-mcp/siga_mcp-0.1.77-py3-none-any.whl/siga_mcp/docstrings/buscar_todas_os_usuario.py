...
- Agrupamentos predefinidos para consultas rápidas
...
Args:
    ...
    filtrar_por: Status para filtrar as OS. Consultas comuns:
        - "Todas OS em Aberto" - agrupamento automático disponível
        - ["Concluída", "Concluída por Encaminhamento", "Concluída por substituição"] - para OS concluídas
        - ["Cancelada-Usuário", "Cancelamento DTD | Arquivado"] - para OS canceladas
        - None - para todas as OS independente do status
        - Lista customizada de status individuais
...
Note:
    ...
    - Para OS finalizadas (concluídas + canceladas), combine as listas acima
    - Use filtrar_por=None para buscar TODAS as OS sem filtro de status
