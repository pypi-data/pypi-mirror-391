...
import typing
__all__: list[str] = ['Distribution', 'DistributionType', 'DoubleDistributionDescription', 'DoubleSampler', 'FractureSetDescription', 'FractureSimulationRunner', 'Gaussian', 'RandomEngine', 'SimulationConfigurator', 'SimulationPrinterConfigurator', 'StatisticsMonitor', 'StochasticLibrary', 'TruncatedGaussian', 'UniformClosed', 'UniformClosedOpen']
class Distribution:
    pass
...
class DoubleSampler:
    @staticmethod
    def create_distribution(desc: DoubleDistributionDescription) -> UniformClosed | UniformClosedOpen | Gaussian | TruncatedGaussian:
        """
        Create a distribution from a description
        """
    @staticmethod
    def sample(engine: RandomEngine, dist: UniformClosed | UniformClosedOpen | Gaussian | TruncatedGaussian) -> float:
        """
