...
class BaseCacheInterface(PluginBase):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if scope_prefix is not None:
            assert isinstance(
                scope_prefix, str
            ), f"Cache.scope_prefix must be a str, got {scope_prefix}"
    ...
    def fetch(
        self, args=None, *keys, named: bool = False
    ...
    def set(
        ...
        value,
        *,
        timeout: Union[int, timedelta, datetime] = ...,
    ...
    def update(
        self, data: Dict[str, Any], timeout: Union[int, timedelta, datetime] = ...
    ):
        if not data:
            return
        entity = self.get_entity()
    ...
    def get_stats(self):
        ...
        if not self.trace_keys:
            raise NotImplementedError(
                f"Cache.get_stats not implemented, "
