...
class AnomalyDetectorActiveWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_amp/waiters/#anomalydetectoractivewaiter)
    """
...
class AnomalyDetectorDeletedWaiter(AIOWaiter):
    ...
    [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_amp/waiters/#anomalydetectordeletedwaiter)
    """
