...
CQL_SPEC = SQL_SPEC + [
    ...
    'export_table                    > (                > export_table_lp_                        ^ (',
    'export_table_                   > (                > export_table_lp_                        ^ (',
    'export_table_lp_                > name             > export_table_lp_a                       ^ id',
    'export_table_lp_a               > ,                > export_table_lp_a_comma_',
    '-                               > )                > export_table_lp_a_comma_rp_',
    'export_table_lp_a_comma_        > name             > export_table_lp_a                       ^ id',
]

CQL_KEYWORDS = SQL_KEYWORDS + [
    'schema', 'keyspace', 'keyspaces', 'tables', 'export'
]
