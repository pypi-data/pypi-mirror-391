...
class CLIConfig:
    ...
    def from_env(cls) -> 'CLIConfig':
        ...
        # API URL - default to Render subdomain (more reliable than custom domain)
        # Custom domain (rohkun.com) may have DNS issues or sleep longer on free tier
        # Render subdomain is more reliable and wakes up faster
        api_url = os.getenv("ROHKUN_API_URL", "https://rohkun-api.onrender.com")
        if not api_url or not isinstance(api_url, str):
            api_url = "https://rohkun-api.onrender.com"
