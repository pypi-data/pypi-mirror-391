...
setup(
    ...
    # Explicitly include ONLY the CLI package - exclude everything else
    # MANIFEST.in handles exclusions of server, frontend, etc.
    packages=["cli"],
    include_package_data=True,
    # install_requires is defined in pyproject.toml - don't duplicate here
    python_requires=">=3.8",
    entry_points={
        "console_scripts": [
            "rohkun=cli.main:app",
    ...
    classifiers=[
        ...
        # License classifier removed - using SPDX expression in pyproject.toml instead
