...
"""
PyGremlinBox FDK-AAC - Supply chain security testing module.

This package is licenced under FDK-AAC.
...
maintaining compliance with FDK-AAC requirements.
"""
...
def get_package_metadata():
    ...
    """
    return {
        "name": "PyGremlinBox-FDK-AAC",
        "version": __version__,
        "licence": __licence__,
        "description": "Supply chain security testing module with FDK-AAC licence",
        "spdx_licence_id": "FDK-AAC"
    }
