...
from src.lindorm_memobase_client import LindormMemobaseADD, LindormMemobaseSearch, LindormMemobaseSearchSync
import argparse
...
if __name__ == "__main__":
    # memobase_manager = LindormMemobaseADD(data_path="datasets/locomo10.json")
    # memobase_manager.process_all_conversations()
    memobase_manager = LindormMemobaseSearchSync("./lindorm_output/results.json")
    memobase_manager.process_data_file("datasets/locomo10.json")

    # memobase_manager = LindormMemobaseADDSync(data_path="datasets/locomo10.json")
    # memobase_manager.process_all_conversations()
