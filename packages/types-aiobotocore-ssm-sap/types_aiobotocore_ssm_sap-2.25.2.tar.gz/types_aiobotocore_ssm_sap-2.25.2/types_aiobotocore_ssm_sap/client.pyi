...
class SsmSapClient(AioBaseClient):
    ...
    async def get_configuration_check_operation(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_ssm_sap/client/#get_configuration_check_operation)
        """
    ...
    async def list_configuration_check_definitions(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_ssm_sap/client/#list_configuration_check_definitions)
        """
    ...
    async def list_configuration_check_operations(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_ssm_sap/client/#list_configuration_check_operations)
        """
    ...
    async def list_sub_check_results(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_ssm_sap/client/#list_sub_check_results)
        """
    ...
    async def list_sub_check_rule_results(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_ssm_sap/client/#list_sub_check_rule_results)
        """
    ...
    async def start_configuration_checks(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_ssm_sap/client/#start_configuration_checks)
        """
