...
class MTurkClient(AioBaseClient):
    ...
    async def create_hit(
        self, **kwargs: Unpack[CreateHITRequestTypeDef]
    ) -> CreateHITResponseTypeDef:
        """
    ...
    async def get_hit(self, **kwargs: Unpack[GetHITRequestTypeDef]) -> GetHITResponseTypeDef:
        """
    ...
    async def list_hits(self, **kwargs: Unpack[ListHITsRequestTypeDef]) -> ListHITsResponseTypeDef:
        """
