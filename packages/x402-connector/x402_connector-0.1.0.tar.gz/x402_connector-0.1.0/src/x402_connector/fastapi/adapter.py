"""FastAPI framework adapter for x402-connector."""
...
class FastAPIAdapter(BaseAdapter):
    ...
    Translates between FastAPI's Request/Response objects and
    ...
    def create_payment_required_response(
        ...
        """Create FastAPI HTTP 402 Payment Required response (Solana-specific).
        ...
        Returns:
            FastAPI Response with status code 402
        """
        if is_browser:
    ...
    def add_payment_response_header(
        ...
        """Add X-PAYMENT-RESPONSE header to FastAPI response.
    ...
    def is_success_response(self, response: Response) -> bool:
        """Check if FastAPI response status code indicates success (2xx).
