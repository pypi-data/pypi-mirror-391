...
class PortLike(CarriesMultibitSignal, DirectedPortElement, ConnectableMultibit, SegmentContainer, Protocol):
    ...
    def create_port_segment(self, index: int) -> PortSegmentLike: ...
    def create_port_segments(self, count: int, offset: int = 0) -> PortSegmentLike: ...
    def remove_port_segment(self, index: int) -> None: ...
    def get_port_segment(self, index: int) -> Optional[PortSegmentLike]: ...
...
class WireLike(CarriesMultibitSignal, SegmentContainer, Protocol):
    ...
    def create_wire_segment(self, index: int) -> WireSegmentLike: ...
    def create_wire_segments(self, count: int, offset: int = 0) -> Dict[int, WireSegmentLike]: ...
    def remove_wire_segment(self, index: int) -> None: ...
    def get_wire_segment(self, index: int) -> WireSegmentLike: ...
...
class InstanceLike(NetlistElementLike, HasPorts, Protocol):
    ...
    def connect(
        self, port_name: str, ws_path: Optional[WireSegmentPath], direction: PortDirection = PortDirection.UNKNOWN, index: int = 0, width: int = 1
    ) -> None: ...
    def disconnect(self, port_name: str, index: int) -> None: ...
    def get_connection(self, port_name: str, index: int = -1) -> Union[WireSegmentPath, Dict[int, WireSegmentPath]]: ...
...
class ModuleLike(NetlistElementLike, HasPorts, Protocol):
    ...
    def create_port(
        self, port_name: str, direction: PortDirection = PortDirection.UNKNOWN, width: int = 1, offset: int = 0, is_locked: bool = False
    ) -> PortLike: ...
    def remove_port(self, port: Union[str, PortLike]) -> None: ...
    def get_port(self, port_name: str) -> PortLike: ...
    def get_ports(self, name: str = '', direction: Optional[PortDirection] = None, fuzzy: bool = False) -> List[PortLike]: ...
    def add_wire(self, wire: WireLike) -> WireLike: ...
    def create_wire(self, wire_name: Optional[str] = None, width: PositiveInt = 1, is_locked: bool = False, index_offset: int = 0) -> WireLike: ...
