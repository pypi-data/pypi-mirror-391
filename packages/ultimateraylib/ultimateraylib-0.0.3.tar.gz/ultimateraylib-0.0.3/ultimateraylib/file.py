...
def file_exists(file_name: str):
    return lib.FileExists(file_name)

makeconnect("DirectoryExists", [c_char_p], c_bool)
def directory_exists(dir_path: str):
    return lib.DirectoryExists(dir_path)

makeconnect("IsFileExtension", [c_char_p], c_bool)
def is_file_extension(file_name: str, ext: str):
    return lib.IsFileExtension(file_name, ext)
