...
#
#     # 客户端使用
#     from baai_flagdataset_ks3util.share_cp import share_cp_with_cmdargs_output
#
#     share_url = get_share_url("ks3://baai-datasets/d714895cca28be958783d0b358ba9e56")
#
#     share_cp_with_cmdargs_output(share_url)
#
...
def init_with_cmdargs(cmd_args):
    ...
    try:
        ...
        share_url = get_share_url("ks3://baai-datasets/d714895cca28be958783d0b358ba9e56")
        share_cp_with_cmdargs_output(share_url, jobs=parallel)
