...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, pulp_href=None, name=None, base_url=None, pulp_created=None, content_guard=None, pulp_labels=None, base_path=None, hidden=False, local_vars_configuration=None):  # noqa: E501
