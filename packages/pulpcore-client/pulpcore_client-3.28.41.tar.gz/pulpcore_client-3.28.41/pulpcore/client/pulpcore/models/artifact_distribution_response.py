...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, pulp_href=None, hidden=False, content_guard=None, pulp_created=None, pulp_labels=None, name=None, base_url=None, base_path=None, local_vars_configuration=None):  # noqa: E501
