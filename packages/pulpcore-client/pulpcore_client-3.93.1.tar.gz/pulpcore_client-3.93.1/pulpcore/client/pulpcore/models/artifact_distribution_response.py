...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["no_content_change_since", "content_guard", "pulp_labels", "base_url", "prn", "name", "hidden", "base_path", "pulp_href", "pulp_last_updated", "pulp_created"]
