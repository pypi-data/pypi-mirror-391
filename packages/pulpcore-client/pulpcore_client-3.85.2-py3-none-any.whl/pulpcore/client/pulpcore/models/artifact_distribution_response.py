...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["pulp_href", "pulp_labels", "pulp_last_updated", "pulp_created", "prn", "hidden", "name", "content_guard", "no_content_change_since", "base_url", "base_path"]
