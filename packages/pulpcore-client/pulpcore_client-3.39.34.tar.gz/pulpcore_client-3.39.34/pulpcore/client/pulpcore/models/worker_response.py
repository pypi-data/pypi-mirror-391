...
class WorkerResponse(object):
    ...
    def __init__(self, pulp_href=None, pulp_created=None, name=None, last_heartbeat=None, versions=None, current_task=None, local_vars_configuration=None):  # noqa: E501
