...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, prn=None, content_guard=None, pulp_labels=None, base_path=None, pulp_href=None, name=None, base_url=None, pulp_created=None, no_content_change_since=None, hidden=False, pulp_last_updated=None, local_vars_configuration=None):  # noqa: E501
