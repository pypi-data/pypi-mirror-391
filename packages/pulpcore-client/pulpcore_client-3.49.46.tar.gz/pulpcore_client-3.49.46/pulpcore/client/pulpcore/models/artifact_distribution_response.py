...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, hidden=False, pulp_created=None, pulp_last_updated=None, name=None, base_path=None, pulp_labels=None, base_url=None, content_guard=None, pulp_href=None, local_vars_configuration=None):  # noqa: E501
