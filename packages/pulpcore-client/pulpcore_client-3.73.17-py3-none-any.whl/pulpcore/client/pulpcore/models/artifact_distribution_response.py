...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["content_guard", "hidden", "pulp_created", "no_content_change_since", "prn", "base_url", "name", "pulp_last_updated", "pulp_href", "base_path", "pulp_labels"]
