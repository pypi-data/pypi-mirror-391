...
PyPNM is a Python module for reading PPM and PGM image files (both 8 and 16 bits per channel color depth) to image 3D integer lists for further editing, displaying 3D list thus obtained by converting it to Tkinter-compatible data in memory, and subsequent writing edited image pixel data 3D list to disk as PPM or PGM file, either binary or ASCII.
