# SPDX-License-Identifier: TPL-1.0
# SPDX-FileCopyrightText: 2025 PyGremlinBox Maintainer <simon@sigre.xyz>

"""
PyGremlinBox TPL-1.0 - Supply chain security testing module.

This package is licenced under TPL-1.0.
...
maintaining compliance with TPL-1.0 requirements.
"""
...
def get_package_metadata():
    ...
    """
    return {
        "name": "PyGremlinBox-TPL-1-0",
        "version": __version__,
        "licence": __licence__,
        "description": "Supply chain security testing module with TPL-1.0 licence",
        "spdx_licence_id": "TPL-1.0"
    }
