# fry 0cf6c70f14d7adce4b78c50ee1d7d7d162065825
...
def Button (
    ...
    return Element("button", {"call-client-script": ["fryui_button_Button", []], **{ key: True for key in (styles)}, ":dom": Element.ClientRef("dom"), "children": [(children)]})
