...
class PaymentCryptographyControlPlaneClient(AioBaseClient):
    ...
    async def add_key_replication_regions(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_payment_cryptography/client/#add_key_replication_regions)
        """
    ...
    async def disable_default_key_replication_regions(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_payment_cryptography/client/#disable_default_key_replication_regions)
        """
    ...
    async def enable_default_key_replication_regions(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_payment_cryptography/client/#enable_default_key_replication_regions)
        """
    ...
    async def get_certificate_signing_request(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_payment_cryptography/client/#get_certificate_signing_request)
        """
    ...
    async def get_default_key_replication_regions(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_payment_cryptography/client/#get_default_key_replication_regions)
        """
    ...
    async def remove_key_replication_regions(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_payment_cryptography/client/#remove_key_replication_regions)
        """
