...
ARABIC_EXTENDED_A = UnicodeBlock(name='Arabic Extended-A', start=0x08a0, end=0x08ff, assigned_ranges=[(0x08a0, 0x08b2), (0x08e4, 0x08ff)], aliases=['Arabic_Ext_A'])
...
TELUGU = UnicodeBlock(name='Telugu', start=0x0c00, end=0x0c7f, assigned_ranges=[(0x0c00, 0x0c03), (0x0c05, 0x0c0c), (0x0c0e, 0x0c10), (0x0c12, 0x0c28), (0x0c2a, 0x0c39), (0x0c3d, 0x0c44), (0x0c46, 0x0c48), (0x0c4a, 0x0c4d), (0x0c55, 0x0c56), (0x0c58, 0x0c59), (0x0c60, 0x0c63), (0x0c66, 0x0c6f), (0x0c78, 0x0c7f)])
...
MALAYALAM = UnicodeBlock(name='Malayalam', start=0x0d00, end=0x0d7f, assigned_ranges=[(0x0d01, 0x0d03), (0x0d05, 0x0d0c), (0x0d0e, 0x0d10), (0x0d12, 0x0d3a), (0x0d3d, 0x0d44), (0x0d46, 0x0d48), (0x0d4a, 0x0d4e), (0x0d57, 0x0d57), (0x0d60, 0x0d63), (0x0d66, 0x0d75), (0x0d79, 0x0d7f)])
...
CURRENCY_SYMBOLS = UnicodeBlock(name='Currency Symbols', start=0x20a0, end=0x20cf, assigned_ranges=[(0x20a0, 0x20bd)])
...
MISCELLANEOUS_SYMBOLS_AND_ARROWS = UnicodeBlock(name='Miscellaneous Symbols and Arrows', start=0x2b00, end=0x2bff, assigned_ranges=[(0x2b00, 0x2b73), (0x2b76, 0x2b95), (0x2b98, 0x2bb9), (0x2bbd, 0x2bc8), (0x2bca, 0x2bd1)], aliases=['Misc_Arrows'])
...
CYRILLIC_EXTENDED_B = UnicodeBlock(name='Cyrillic Extended-B', start=0xa640, end=0xa69f, assigned_ranges=[(0xa640, 0xa69d), (0xa69f, 0xa69f)], aliases=['Cyrillic_Ext_B'])
...
LATIN_EXTENDED_D = UnicodeBlock(name='Latin Extended-D', start=0xa720, end=0xa7ff, assigned_ranges=[(0xa720, 0xa78e), (0xa790, 0xa7ad), (0xa7b0, 0xa7b1), (0xa7f7, 0xa7ff)], aliases=['Latin_Ext_D'])
...
LATIN_EXTENDED_E = UnicodeBlock(name='Latin Extended-E', start=0xab30, end=0xab6f, assigned_ranges=[(0xab30, 0xab5f), (0xab64, 0xab65)], aliases=['Latin_Ext_E'])
...
COMBINING_HALF_MARKS = UnicodeBlock(name='Combining Half Marks', start=0xfe20, end=0xfe2f, assigned_ranges=[(0xfe20, 0xfe2d)], aliases=['Half_Marks'])
...
SHARADA = UnicodeBlock(name='Sharada', start=0x11180, end=0x111df, assigned_ranges=[(0x11180, 0x111c8), (0x111cd, 0x111cd), (0x111d0, 0x111da)])
...
GRANTHA = UnicodeBlock(name='Grantha', start=0x11300, end=0x1137f, assigned_ranges=[(0x11301, 0x11303), (0x11305, 0x1130c), (0x1130f, 0x11310), (0x11313, 0x11328), (0x1132a, 0x11330), (0x11332, 0x11333), (0x11335, 0x11339), (0x1133c, 0x11344), (0x11347, 0x11348), (0x1134b, 0x1134d), (0x11357, 0x11357), (0x1135d, 0x11363), (0x11366, 0x1136c), (0x11370, 0x11374)])
TIRHUTA = UnicodeBlock(name='Tirhuta', start=0x11480, end=0x114df, assigned_ranges=[(0x11480, 0x114c7), (0x114d0, 0x114d9)])
SIDDHAM = UnicodeBlock(name='Siddham', start=0x11580, end=0x115ff, assigned_ranges=[(0x11580, 0x115b5), (0x115b8, 0x115c9)])
...
CUNEIFORM = UnicodeBlock(name='Cuneiform', start=0x12000, end=0x123ff, assigned_ranges=[(0x12000, 0x12398)])
...
MISCELLANEOUS_SYMBOLS_AND_PICTOGRAPHS = UnicodeBlock(name='Miscellaneous Symbols and Pictographs', start=0x1f300, end=0x1f5ff, assigned_ranges=[(0x1f300, 0x1f32c), (0x1f330, 0x1f37d), (0x1f380, 0x1f3ce), (0x1f3d4, 0x1f3f7), (0x1f400, 0x1f4fe), (0x1f500, 0x1f54a), (0x1f550, 0x1f579), (0x1f57b, 0x1f5a3), (0x1f5a5, 0x1f5ff)], aliases=['Misc_Pictographs'])
EMOTICONS = UnicodeBlock(name='Emoticons', start=0x1f600, end=0x1f64f, assigned_ranges=[(0x1f600, 0x1f642), (0x1f645, 0x1f64f)])
ORNAMENTAL_DINGBATS = UnicodeBlock(name='Ornamental Dingbats', start=0x1f650, end=0x1f67f, assigned_ranges=[(0x1f650, 0x1f67f)])
TRANSPORT_AND_MAP_SYMBOLS = UnicodeBlock(name='Transport and Map Symbols', start=0x1f680, end=0x1f6ff, assigned_ranges=[(0x1f680, 0x1f6cf), (0x1f6e0, 0x1f6ec), (0x1f6f0, 0x1f6f3)], aliases=['Transport_And_Map'])
