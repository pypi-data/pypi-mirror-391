...
class GpuIndex(Index):
    ...
    def addEx(self, arg2, x, numeric_type):
        return _swigfaiss.GpuIndex_addEx(self, arg2, x, numeric_type)
    ...
    def add_with_idsEx(self, n, x, numeric_type, xids):
        return _swigfaiss.GpuIndex_add_with_idsEx(self, n, x, numeric_type, xids)
    ...
    def searchEx(self, n, x, numeric_type, k, distances, labels, params=None):
        return _swigfaiss.GpuIndex_searchEx(self, n, x, numeric_type, k, distances, labels, params)
