...
class TextractClient(AioBaseClient):
    ...
    async def analyze_id(
        self, **kwargs: Unpack[AnalyzeIDRequestTypeDef]
    ) -> AnalyzeIDResponseTypeDef:
        """
    ...
    async def delete_adapter(self, **kwargs: Unpack[DeleteAdapterRequestTypeDef]) -> dict[str, Any]:
        """
    ...
    async def get_adapter(
        self, **kwargs: Unpack[GetAdapterRequestTypeDef]
    ) -> GetAdapterResponseTypeDef:
        """
