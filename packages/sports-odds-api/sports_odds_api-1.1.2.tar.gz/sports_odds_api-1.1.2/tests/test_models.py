...
from sports_odds_api._utils import PropertyInfo
from sports_odds_api._compat import PYDANTIC_V1, parse_obj, model_dump, model_json
from sports_odds_api._models import BaseModel, construct_type
