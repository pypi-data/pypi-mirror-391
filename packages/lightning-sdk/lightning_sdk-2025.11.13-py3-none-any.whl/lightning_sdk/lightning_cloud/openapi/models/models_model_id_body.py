...
class ModelsModelIdBody(object):
    ...
    def to_dict(self) -> dict:
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ModelsModelIdBody, dict):
    ...
    def __eq__(self, other: 'ModelsModelIdBody') -> bool:
        """Returns true if both objects are equal"""
        if not isinstance(other, ModelsModelIdBody):
            return False

        return self.__dict__ == other.__dict__

    def __ne__(self, other: 'ModelsModelIdBody') -> bool:
