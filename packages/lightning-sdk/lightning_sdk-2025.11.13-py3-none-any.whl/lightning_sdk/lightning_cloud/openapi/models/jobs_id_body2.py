...
class JobsIdBody2(object):
    ...
    def to_dict(self) -> dict:
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(JobsIdBody2, dict):
    ...
    def __eq__(self, other: 'JobsIdBody2') -> bool:
        """Returns true if both objects are equal"""
        if not isinstance(other, JobsIdBody2):
            return False

        return self.__dict__ == other.__dict__

    def __ne__(self, other: 'JobsIdBody2') -> bool:
