...
class UserIdAffiliatelinksBody(object):
    ...
    @property
    def code(self) -> 'str':
        """Gets the code of this UserIdAffiliatelinksBody.  # noqa: E501


        :return: The code of this UserIdAffiliatelinksBody.  # noqa: E501
        :rtype: str
        """
        return self._code
    ...
    def code(self, code: 'str'):
        """Sets the code of this UserIdAffiliatelinksBody.


        :param code: The code of this UserIdAffiliatelinksBody.  # noqa: E501
        :type: str
        """
    ...
    def name(self) -> 'str':
        ...
        :return: The name of this UserIdAffiliatelinksBody.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    def name(self, name: 'str'):
        """Sets the name of this UserIdAffiliatelinksBody.


        :param name: The name of this UserIdAffiliatelinksBody.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self) -> dict:
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UserIdAffiliatelinksBody, dict):
    ...
    def __eq__(self, other: 'UserIdAffiliatelinksBody') -> bool:
        """Returns true if both objects are equal"""
        if not isinstance(other, UserIdAffiliatelinksBody):
            return False

        return self.__dict__ == other.__dict__

    def __ne__(self, other: 'UserIdAffiliatelinksBody') -> bool:
