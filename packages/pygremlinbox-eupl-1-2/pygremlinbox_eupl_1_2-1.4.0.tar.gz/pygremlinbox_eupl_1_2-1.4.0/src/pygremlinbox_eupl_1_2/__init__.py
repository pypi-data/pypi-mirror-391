...
"""
PyGremlinBox EUPL-1.2 - Supply chain security testing module.

This package is licenced under the European Union Public License v1.2 (EUPL-1.2).
...
maintaining compliance with EUPL-1.2 requirements.
"""

__version__ = "1.4.0"
__licence__ = "EUPL-1.2"
...
def get_package_metadata():
    ...
    """
    return {
        "name": "pygremlinbox-eupl-1.2",
        "version": __version__,
        "licence": __licence__,
        "description": "Supply chain security testing module with EUPL-1.2 licence",
        "spdx_licence_id": "EUPL-1.2"
    }
