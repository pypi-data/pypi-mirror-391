...
class HttpTransit:
    ...
    def __init_router(self):
        ...
        #AGREGA RESPONSE STATIC HEALTHCHECK
        self._app.route(
            "/",
            ['GET'],
            self._process_handler_healthcheck
        )
    ...
    def _process_handler(self, id=None):
        ...
        Key_op, meta = self.__create_meta(id)
    ...
    def _process_handler_healthcheck(self):
        """
            Retorna estáticamente OK para la ruta get
        """
    ...
    def __create_meta(self, id_resource=None):
        """
