...
class TestSpeech:
    ...
    @parametrize
    @pytest.mark.respx(base_url=base_url)
    def test_raw_response_create(self, client: Dedalus, respx_mock: MockRouter) -> None:
        respx_mock.post("/v1/audio/speech").mock(return_value=httpx.Response(200, json={"foo": "bar"}))
...
class TestAsyncSpeech:
    ...
    @parametrize
    @pytest.mark.respx(base_url=base_url)
    async def test_raw_response_create(self, async_client: AsyncDedalus, respx_mock: MockRouter) -> None:
        respx_mock.post("/v1/audio/speech").mock(return_value=httpx.Response(200, json={"foo": "bar"}))
