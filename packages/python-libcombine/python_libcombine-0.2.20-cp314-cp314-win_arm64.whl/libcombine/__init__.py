...
class XMLNode(XMLToken):
    ...
    def readXMLNodeFromFile(filename):
        ...
        return _libcombine.XMLNode_readXMLNodeFromFile(filename)
...
class ASTNode(object):
    ...
    def removeChild(self, n, delremoved=False):
        ...
        return _libcombine.ASTNode_removeChild(self, n, delremoved)
    ...
    def getListOfNodesWithLevel(self, operatorsOnly=False):
        r"""getListOfNodesWithLevel(ASTNode self, bool operatorsOnly=False) -> ASTNodeLevels"""
        return _libcombine.ASTNode_getListOfNodesWithLevel(self, operatorsOnly)

    def fillListOfNodesWithLevel(self, predicate, vector_pairs, level):
        r"""fillListOfNodesWithLevel(ASTNode self, ASTNodePredicate predicate, ASTNodeLevels & vector_pairs, unsigned int level)"""
        return _libcombine.ASTNode_fillListOfNodesWithLevel(self, predicate, vector_pairs, level)
    ...
    def replaceArguments(self, bvars, args):
        r"""replaceArguments(ASTNode self, StringVector bvars, std::vector< ASTNode *,std::allocator< ASTNode * > > & args)"""
        return _libcombine.ASTNode_replaceArguments(self, bvars, args)
    ...
    def exactlyEqual(self, rhs):
        ...
        return _libcombine.ASTNode_exactlyEqual(self, rhs)

    def refactor(self):
        r"""refactor(ASTNode self)"""
        return _libcombine.ASTNode_refactor(self)

    def decompose(self):
        r"""decompose(ASTNode self)"""
        return _libcombine.ASTNode_decompose(self)

    def derivative(self, variable):
        r"""derivative(ASTNode self, string variable) -> ASTNode"""
        return _libcombine.ASTNode_derivative(self, variable)

    def getDeclaredNamespaces(self):
        r"""getDeclaredNamespaces(ASTNode self) -> XMLNamespaces"""
        return _libcombine.ASTNode_getDeclaredNamespaces(self)

    def setDeclaredNamespaces(self, xmlns):
        r"""setDeclaredNamespaces(ASTNode self, XMLNamespaces xmlns)"""
        return _libcombine.ASTNode_setDeclaredNamespaces(self, xmlns)

    def unsetDeclaredNamespaces(self):
        r"""unsetDeclaredNamespaces(ASTNode self)"""
        return _libcombine.ASTNode_unsetDeclaredNamespaces(self)

    def refactorNumbers(self):
        r"""refactorNumbers(ASTNode self)"""
        return _libcombine.ASTNode_refactorNumbers(self)

    def simplify(self):
        r"""simplify(ASTNode self)"""
        return _libcombine.ASTNode_simplify(self)

    def reorderArguments(self, level=0):
        r"""reorderArguments(ASTNode self, unsigned int level=0) -> bool"""
        return _libcombine.ASTNode_reorderArguments(self, level)

    def encompassUnaryMinus(self):
        r"""encompassUnaryMinus(ASTNode self)"""
        return _libcombine.ASTNode_encompassUnaryMinus(self)

    def createNonBinaryTree(self):
        r"""createNonBinaryTree(ASTNode self)"""
        return _libcombine.ASTNode_createNonBinaryTree(self)

    def convertRootToPower(self):
        r"""convertRootToPower(ASTNode self)"""
        return _libcombine.ASTNode_convertRootToPower(self)
...
def printNodeLevels(vector_pairs):
    r"""printNodeLevels(ASTNodeLevels & vector_pairs)"""
    return _libcombine.printNodeLevels(vector_pairs)
...
class CombineArchive(object):
    ...
    def addFileFromBuffer(self, buffer, targetName, format, isMaster=False):
        r"""addFileFromBuffer(CombineArchive self, std::vector< unsigned char,std::allocator< unsigned char > > const & buffer, string targetName, string format, bool isMaster=False) -> bool"""
        return _libcombine.CombineArchive_addFileFromBuffer(self, buffer, targetName, format, isMaster)
    ...
    def extractEntryToBuffer(self, name):
        r"""extractEntryToBuffer(CombineArchive self, string name) -> std::vector< unsigned char,std::allocator< unsigned char > >"""
        return _libcombine.CombineArchive_extractEntryToBuffer(self, name)
    ...
    def initializeFromUnzipper(self, pUnzipper, skipOmex=False):
        r"""initializeFromUnzipper(CombineArchive self, zipper::Unzipper * pUnzipper, bool skipOmex=False) -> bool"""
        return _libcombine.CombineArchive_initializeFromUnzipper(self, pUnzipper, skipOmex)

    def initializeFromBuffer(self, pBuffer, skipOmex=False):
        r"""initializeFromBuffer(CombineArchive self, std::vector< unsigned char,std::allocator< unsigned char > > const & pBuffer, bool skipOmex=False) -> bool"""
        return _libcombine.CombineArchive_initializeFromBuffer(self, pBuffer, skipOmex)
