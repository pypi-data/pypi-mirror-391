...
def main(argv=None):
    ...
    # Comandos que não precisam de projetos existentes
    ...
    # A partir daqui, todos os comandos precisam de um banco de dados populado
    projects = repo.get_all()
    if not projects:
        print("Nenhum projeto encontrado no banco de dados.")
        print("Por favor, execute 'devguide init-db' para popular o banco de dados.")
        return
