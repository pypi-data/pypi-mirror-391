...
_DISCOVERY_SPACE_SINGULAR = "space"
...
class AdoGetSupportedResourceTypes(Enum):
    ACTUATOR_CONFIGURATION_PLURAL = _ACTUATOR_CONFIGURATION_SINGULAR + "s"
    ACTUATOR_PLURAL = _ACTUATOR_SINGULAR + "s"
    CONTEXT_PLURAL = _CONTEXT_SINGULAR + "s"
    DATA_CONTAINER_PLURAL = _DATA_CONTAINER_SINGULAR + "s"
    DISCOVERY_SPACE_PLURAL = _DISCOVERY_SPACE_SINGULAR + "s"
    MEASUREMENT_REQUEST_PLURAL = _MEASUREMENT_REQUEST_SINGULAR
    OPERATION_PLURAL = _OPERATION_SINGULAR + "s"
    OPERATOR_PLURAL = _OPERATOR_SINGULAR + "s"
    SAMPLE_STORE_PLURAL = _SAMPLE_STORE_SINGULAR + "s"
