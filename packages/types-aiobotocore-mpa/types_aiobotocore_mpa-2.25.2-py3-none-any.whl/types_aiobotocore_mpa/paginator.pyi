...
class ListApprovalTeamsPaginator(_ListApprovalTeamsPaginatorBase):
    ...
    [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_mpa/paginators/#listapprovalteamspaginator)
    """
...
class ListIdentitySourcesPaginator(_ListIdentitySourcesPaginatorBase):
    ...
    [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_mpa/paginators/#listidentitysourcespaginator)
    """
    def paginate(  # type: ignore[override]
...
class ListPoliciesPaginator(_ListPoliciesPaginatorBase):
    ...
    [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_mpa/paginators/#listpoliciespaginator)
    """
    def paginate(  # type: ignore[override]
...
class ListPolicyVersionsPaginator(_ListPolicyVersionsPaginatorBase):
    ...
    [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_mpa/paginators/#listpolicyversionspaginator)
    """
    def paginate(  # type: ignore[override]
...
class ListResourcePoliciesPaginator(_ListResourcePoliciesPaginatorBase):
    ...
    [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_mpa/paginators/#listresourcepoliciespaginator)
    """
    def paginate(  # type: ignore[override]
...
class ListSessionsPaginator(_ListSessionsPaginatorBase):
    ...
    [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_mpa/paginators/#listsessionspaginator)
    """
    def paginate(  # type: ignore[override]
