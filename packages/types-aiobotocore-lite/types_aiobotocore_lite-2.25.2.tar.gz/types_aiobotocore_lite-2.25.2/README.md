...
[aiobotocore 2.25.2](https://pypi.org/project/aiobotocore/) compatible with
...
- `types-aiobotocore-lite[full]` - Type annotations for all 406 services in one
  package (recommended).
- `types-aiobotocore-lite[all]` - Type annotations for all 406 services in
  separate packages.
