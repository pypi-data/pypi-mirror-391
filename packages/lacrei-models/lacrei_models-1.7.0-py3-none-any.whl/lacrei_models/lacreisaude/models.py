...
class Professional(BaseProfile):
    ...
    # ... (O resto dos seus campos: about_me, profile_status, etc.) ...
    ...
    # OS MÉTODOS get_all_times, is_overlap, e get_available_times
    # FORAM REMOVIDOS DAQUI e movidos para o ProfessionalRepository
...
class Clinic(BaseModel):
    ...
    # ... (O resto dos seus campos: is_presential_clinic, name, etc.) ...
...
class ClinicOpeningSchedule(BaseModel):
    # ... (Definição do modelo permanece igual) ...
    ONLINE = "online"
...
class ProfessionalReview(BaseModel):
    ...
    # OS MÉTODOS pre_create_instance, save, e post_create_instance
    # FORAM REMOVIDOS DAQUI e movidos para o ProfessionalReviewRepository
...
class ContactRequest(BaseModel):
    ...
    # O ContactRequestManager FOI REMOVIDO DAQUI
    # (A lógica dele será substituída pelo Repositório)

    def __str__(self) -> str:
        return f"{self.requester} -> {self.professional}"

    # O MÉTODO pre_create_instance FOI REMOVIDO DAQUI
    # e movido para o ContactRequestRepository
...
class Complaint(BaseModel):
    ...
    # O MÉTODO post_create_instance FOI REMOVIDO DAQUI
    # e movido para o ComplaintRepository
