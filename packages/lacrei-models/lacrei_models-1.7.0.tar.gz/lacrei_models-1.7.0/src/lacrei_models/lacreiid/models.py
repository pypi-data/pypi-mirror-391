...
class Profile(BaseProfile):
    ...
    # --- O MÉTODO save() CUSTOMIZADO FOI REMOVIDO DAQUI ---
    # A lógica dele agora vive no ProfileRepository


class CustomEmailAddress(EmailAddress):
    # A lógica 'get_email_address_by_email' foi (corretamente) movida
    # para o UserRepository
    class Meta:
        proxy = True
        app_label = "lacreiid"
