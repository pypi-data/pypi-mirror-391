...
class UploadGuid(object):
    ...
    def __init__(self, upload_guid=None):  # noqa: E501
        """UploadGuid - a model defined in Swagger"""  # noqa: E501
        self._upload_guid = None
        self.discriminator = None
        if upload_guid is not None:
            self.upload_guid = upload_guid

    @property
    def upload_guid(self):
        """Gets the upload_guid of this UploadGuid.  # noqa: E501


        :return: The upload_guid of this UploadGuid.  # noqa: E501
        :rtype: str
        """
        return self._upload_guid

    @upload_guid.setter
    def upload_guid(self, upload_guid):
        """Sets the upload_guid of this UploadGuid.


        :param upload_guid: The upload_guid of this UploadGuid.  # noqa: E501
        :type: str
        """

        self._upload_guid = upload_guid
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UploadGuid):
            return False
