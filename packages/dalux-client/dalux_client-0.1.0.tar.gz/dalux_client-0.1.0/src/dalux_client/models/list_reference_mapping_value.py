...
class ListReferenceMappingValue(object):
    ...
    """
    swagger_types = {
        'reference': 'ListReferenceMappingValueReference'
    }
    ...
    def __init__(self, reference=None):  # noqa: E501
        """ListReferenceMappingValue - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def reference(self):
        """Gets the reference of this ListReferenceMappingValue.  # noqa: E501


        :return: The reference of this ListReferenceMappingValue.  # noqa: E501
        :rtype: ListReferenceMappingValueReference
        """
        return self._reference

    @reference.setter
    def reference(self, reference):
        """Sets the reference of this ListReferenceMappingValue.


        :param reference: The reference of this ListReferenceMappingValue.  # noqa: E501
        :type: ListReferenceMappingValueReference
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ListReferenceMappingValue, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListReferenceMappingValue):
            return False
