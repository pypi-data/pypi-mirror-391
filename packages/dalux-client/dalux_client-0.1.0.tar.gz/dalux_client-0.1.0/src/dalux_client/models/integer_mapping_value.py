...
class IntegerMappingValue(object):
    ...
    def __init__(self, integer=None):  # noqa: E501
        """IntegerMappingValue - a model defined in Swagger"""  # noqa: E501
        self._integer = None
    ...
    @property
    def integer(self):
        """Gets the integer of this IntegerMappingValue.  # noqa: E501


        :return: The integer of this IntegerMappingValue.  # noqa: E501
        :rtype: str
        """
    ...
    def integer(self, integer):
        """Sets the integer of this IntegerMappingValue.


        :param integer: The integer of this IntegerMappingValue.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(IntegerMappingValue, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IntegerMappingValue):
            return False
