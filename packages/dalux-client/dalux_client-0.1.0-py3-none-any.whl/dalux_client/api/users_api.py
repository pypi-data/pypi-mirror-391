...
class UsersApi(object):
    ...
    def get_project_user(self, project_id, user_id, **kwargs):  # noqa: E501
        """Get user on project  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_project_user(project_id, user_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str project_id: The ID of the project (required)
        :param str user_id: The ID of the user on the project (required)
        ...
        if kwargs.get('async_req'):
            return self.get_project_user_with_http_info(project_id, user_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_project_user_with_http_info(project_id, user_id, **kwargs)  # noqa: E501
            return data

    def get_project_user_with_http_info(self, project_id, user_id, **kwargs):  # noqa: E501
        """Get user on project  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_project_user_with_http_info(project_id, user_id, async_req=True)
        >>> result = thread.get()
        ...
        if ('project_id' not in params or
            ...
            raise ValueError("Missing the required parameter `project_id` when calling `get_project_user`")  # noqa: E501
        # verify the required parameter 'user_id' is set
        if ('user_id' not in params or
                params['user_id'] is None):
            raise ValueError("Missing the required parameter `user_id` when calling `get_project_user`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/1.1/projects/{projectId}/users/{userId}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def list_project_users(self, project_id, **kwargs):  # noqa: E501
        """Get users on project  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_project_users(project_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.list_project_users_with_http_info(project_id, **kwargs)  # noqa: E501
        else:
            (data) = self.list_project_users_with_http_info(project_id, **kwargs)  # noqa: E501
            return data

    def list_project_users_with_http_info(self, project_id, **kwargs):  # noqa: E501
        """Get users on project  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_project_users_with_http_info(project_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_project_users" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'project_id' is set
        if ('project_id' not in params or
                params['project_id'] is None):
            raise ValueError("Missing the required parameter `project_id` when calling `list_project_users`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/1.2/projects/{projectId}/users', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
