...
class WorkPackagesApi(object):
    ...
    def list_workpackages(self, project_id, **kwargs):  # noqa: E501
        """Browse all work packages on the given project  # noqa: E501

        Returns non-deleted work packages on the given project  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_workpackages(project_id, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.list_workpackages_with_http_info(project_id, **kwargs)  # noqa: E501
        else:
            (data) = self.list_workpackages_with_http_info(project_id, **kwargs)  # noqa: E501
            return data

    def list_workpackages_with_http_info(self, project_id, **kwargs):  # noqa: E501
        """Browse all work packages on the given project  # noqa: E501

        Returns non-deleted work packages on the given project  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_workpackages_with_http_info(project_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method list_workpackages" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('project_id' not in params or
            ...
            raise ValueError("Missing the required parameter `project_id` when calling `list_workpackages`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/1.0/projects/{projectId}/workpackages', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
