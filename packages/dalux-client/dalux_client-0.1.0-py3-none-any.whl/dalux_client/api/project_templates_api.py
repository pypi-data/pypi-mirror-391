...
class ProjectTemplatesApi(object):
    ...
    def list_project_templates(self, **kwargs):  # noqa: E501
        """Get all available project templates on the company profile  # noqa: E501

        Get all available project templates on the company profile  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_project_templates(async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.list_project_templates_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.list_project_templates_with_http_info(**kwargs)  # noqa: E501
            return data

    def list_project_templates_with_http_info(self, **kwargs):  # noqa: E501
        """Get all available project templates on the company profile  # noqa: E501

        Get all available project templates on the company profile  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_project_templates_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method list_project_templates" % key
                )
            params[key] = val
        del params['kwargs']
