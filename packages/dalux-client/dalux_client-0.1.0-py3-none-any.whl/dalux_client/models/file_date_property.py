...
class FileDateProperty(object):
    ...
    def __init__(self, _date=None):  # noqa: E501
        """FileDateProperty - a model defined in Swagger"""  # noqa: E501
        self.__date = None
    ...
    @property
    def _date(self):
        """Gets the _date of this FileDateProperty.  # noqa: E501

        Should be in the format yyyy-MM-dd.  # noqa: E501

        :return: The _date of this FileDateProperty.  # noqa: E501
        :rtype: date
        """
        return self.__date
    ...
    def _date(self, _date):
        """Sets the _date of this FileDateProperty.

        Should be in the format yyyy-MM-dd.  # noqa: E501

        :param _date: The _date of this FileDateProperty.  # noqa: E501
        :type: date
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(FileDateProperty, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FileDateProperty):
            return False
