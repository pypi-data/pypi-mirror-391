...
import six
from .object_response import ObjectResponse  # noqa: F401,E501

class InlineResponse20035(ObjectResponse):
    ...
    if hasattr(ObjectResponse, "swagger_types"):
        swagger_types.update(ObjectResponse.swagger_types)

    attribute_map = {
        'data': 'data'
    }
    if hasattr(ObjectResponse, "attribute_map"):
        attribute_map.update(ObjectResponse.attribute_map)
    ...
    def __init__(self, data=None, *args, **kwargs):  # noqa: E501
        ...
        if data is not None:
            self.data = data
        ObjectResponse.__init__(self, *args, **kwargs)
