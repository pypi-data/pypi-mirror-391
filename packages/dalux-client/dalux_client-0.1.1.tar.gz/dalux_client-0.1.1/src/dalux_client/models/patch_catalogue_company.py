...
import six
from .catalogue_company import CatalogueCompany  # noqa: F401,E501

class PatchCatalogueCompany(CatalogueCompany):
    ...
    """
    swagger_types = {
        'metadata': 'list[CatalogCompanyMetadata]'
    }
    if hasattr(CatalogueCompany, "swagger_types"):
        swagger_types.update(CatalogueCompany.swagger_types)

    attribute_map = {
        'metadata': 'metadata'
    }
    if hasattr(CatalogueCompany, "attribute_map"):
        attribute_map.update(CatalogueCompany.attribute_map)

    def __init__(self, metadata=None, *args, **kwargs):  # noqa: E501
        """PatchCatalogueCompany - a model defined in Swagger"""  # noqa: E501
        self._metadata = None
        self.discriminator = None
        if metadata is not None:
            self.metadata = metadata
        CatalogueCompany.__init__(self, *args, **kwargs)

    @property
    def metadata(self):
        """Gets the metadata of this PatchCatalogueCompany.  # noqa: E501


        :return: The metadata of this PatchCatalogueCompany.  # noqa: E501
        :rtype: list[CatalogCompanyMetadata]
        """
        return self._metadata

    @metadata.setter
    def metadata(self, metadata):
        """Sets the metadata of this PatchCatalogueCompany.


        :param metadata: The metadata of this PatchCatalogueCompany.  # noqa: E501
        :type: list[CatalogCompanyMetadata]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PatchCatalogueCompany, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PatchCatalogueCompany):
            return False
