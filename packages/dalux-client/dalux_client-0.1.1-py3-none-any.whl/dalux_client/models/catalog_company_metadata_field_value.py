...
class CatalogCompanyMetadataFieldValue(object):
    ...
    def __init__(self, text=None, reference=None):  # noqa: E501
        """CatalogCompanyMetadataFieldValue - a model defined in Swagger"""  # noqa: E501
        self._text = None
    ...
    @property
    def text(self):
        """Gets the text of this CatalogCompanyMetadataFieldValue.  # noqa: E501


        :return: The text of this CatalogCompanyMetadataFieldValue.  # noqa: E501
        :rtype: str
        """
        return self._text
    ...
    @text.setter
    def text(self, text):
        """Sets the text of this CatalogCompanyMetadataFieldValue.


        :param text: The text of this CatalogCompanyMetadataFieldValue.  # noqa: E501
        :type: str
        """
    ...
    @property
    def reference(self):
        """Gets the reference of this CatalogCompanyMetadataFieldValue.  # noqa: E501


        :return: The reference of this CatalogCompanyMetadataFieldValue.  # noqa: E501
    ...
    def reference(self, reference):
        """Sets the reference of this CatalogCompanyMetadataFieldValue.


        :param reference: The reference of this CatalogCompanyMetadataFieldValue.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CatalogCompanyMetadataFieldValue, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CatalogCompanyMetadataFieldValue):
            return False
