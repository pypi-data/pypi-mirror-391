...
class FormUserDefinedFields(object):
    ...
    def __init__(self, items=None):  # noqa: E501
        """FormUserDefinedFields - a model defined in Swagger"""  # noqa: E501
        self._items = None
    ...
    @property
    def items(self):
        """Gets the items of this FormUserDefinedFields.  # noqa: E501


        :return: The items of this FormUserDefinedFields.  # noqa: E501
    ...
    def items(self, items):
        """Sets the items of this FormUserDefinedFields.


        :param items: The items of this FormUserDefinedFields.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(FormUserDefinedFields, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FormUserDefinedFields):
            return False
