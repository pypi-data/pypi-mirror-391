...
class TextMappingValue(object):
    ...
    def __init__(self, text=None):  # noqa: E501
        """TextMappingValue - a model defined in Swagger"""  # noqa: E501
        self._text = None
    ...
    @property
    def text(self):
        """Gets the text of this TextMappingValue.  # noqa: E501


        :return: The text of this TextMappingValue.  # noqa: E501
        :rtype: str
        """
        return self._text
    ...
    @text.setter
    def text(self, text):
        """Sets the text of this TextMappingValue.


        :param text: The text of this TextMappingValue.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TextMappingValue, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TextMappingValue):
            return False
