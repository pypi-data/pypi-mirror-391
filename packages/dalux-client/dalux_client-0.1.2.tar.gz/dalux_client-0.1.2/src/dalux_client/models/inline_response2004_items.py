...
class InlineResponse2004Items(object):
    ...
    @property
    def data(self):
        """Gets the data of this InlineResponse2004Items.  # noqa: E501


        :return: The data of this InlineResponse2004Items.  # noqa: E501
        :rtype: BasicFieldMapping
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this InlineResponse2004Items.


        :param data: The data of this InlineResponse2004Items.  # noqa: E501
        :type: BasicFieldMapping
        """
