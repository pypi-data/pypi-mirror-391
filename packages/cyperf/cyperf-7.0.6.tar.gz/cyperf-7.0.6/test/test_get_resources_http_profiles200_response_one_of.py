...
class TestGetResourcesHttpProfiles200ResponseOneOf(unittest.TestCase):
    """GetResourcesHttpProfiles200ResponseOneOf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetResourcesHttpProfiles200ResponseOneOf:
        """Test GetResourcesHttpProfiles200ResponseOneOf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetResourcesHttpProfiles200ResponseOneOf`
        """
        model = GetResourcesHttpProfiles200ResponseOneOf()
        if include_optional:
            return GetResourcesHttpProfiles200ResponseOneOf(
                data = [
    ...
    def testGetResourcesHttpProfiles200ResponseOneOf(self):
        """Test GetResourcesHttpProfiles200ResponseOneOf"""
