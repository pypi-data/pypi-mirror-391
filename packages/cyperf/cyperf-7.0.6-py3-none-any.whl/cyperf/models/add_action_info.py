...
class AddActionInfo(BaseModel):
    """
    AddActionInfo
    """ # noqa: E501
    action_id: StrictStr = Field(alias="ActionID")
    insert_at_index: StrictInt = Field(alias="InsertAtIndex")
    is_strike: StrictBool = Field(alias="IsStrike")
    protocol_id: StrictStr = Field(alias="ProtocolID")
    __properties: ClassVar[List[str]] = ["ActionID", "InsertAtIndex", "IsStrike", "ProtocolID"]
...
#            _obj.api_client = client
        ...
        _obj = cls.model_validate({
            "ActionID": obj.get("ActionID"),
                        "InsertAtIndex": obj.get("InsertAtIndex"),
