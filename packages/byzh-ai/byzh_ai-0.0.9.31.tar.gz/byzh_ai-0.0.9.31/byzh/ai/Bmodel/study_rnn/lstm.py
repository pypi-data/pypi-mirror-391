...
class Spike_LSTM(nn.Module):
    ...
    def __init__(self, input_size, hidden_size, num_layers=1, batch_first=False,
        ...
        self.num_layers = num_layers
        self.batch_first = batch_first
        self.surrogate_function_i = deepcopy(surrogate_function1)
        self.surrogate_function_f = deepcopy(surrogate_function1)
        self.surrogate_function_g = deepcopy(surrogate_function2)
        self.surrogate_function_o = deepcopy(surrogate_function1)
