...
class EncoderLayer(nn.Module):
    ...
    def forward(self, enc_input, slf_attn_mask=None):
        '''
        enc_input: [B, L_in, d_word_vec]
        slf_attn_mask: [B, 1, L_in]
        '''
        ...
        # -> enc_output: [B, L_in, d_word_vec]
        # -> enc_slf_attn: [B, n_head, L_in, L_in]
...
class Encoder(nn.Module):
    ...
    def forward(self, src_seq, src_mask, return_attns=False):
        ...
        # 词嵌入向量
        enc_output = self.src_word_emb(src_seq) # [B, L_in, d_word_vec]
        if self.scale_emb:
...
class DecoderLayer(nn.Module):
    ...
    def forward(self, dec_input, enc_output, slf_attn_mask=None, dec_enc_attn_mask=None):
        ...
        dec_input: [B, L_out, d_word_vec]
        enc_output: [B, L_in, d_word_vec]
        slf_attn_mask: [B, L_out, L_out]
        dec_enc_attn_mask: [B, 1, L_in]
        '''
        ...
        # -> dec_output: [B, L_out, d_word_vec]
        # -> dec_slf_attn: [B, n_head, L_out, L_out]
        ...
        # -> dec_output: [B, L_out, d_word_vec]
        # -> dec_enc_attn: [B, n_head, L_out, L_in]
...
class Decoder(nn.Module):
    ...
    def forward(self, trg_seq, trg_mask, enc_output, src_mask, return_attns=False):
        ...
        dec_output = self.layer_norm(dec_output) # [B, L_out, d_word_vec]
