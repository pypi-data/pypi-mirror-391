...
def scatter(
    ...
    **kwargs,
    ...
    if multikey is not None:
        ...
        if ax is not None:
            logg.warning("Cannot specify `ax` when plotting multiple panels.")
        if is_list(title):
        ...
        # actual scatter plot
            ...
            # set cmap, edgecolor, basis, linewidth, frameon, use_raw
            if color is None:
