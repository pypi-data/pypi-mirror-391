...
# Run the pipeline
python run_with_llm.py --llm-provider litellm --llm-model llama-3.1-8b-instruct \
...
- **Asynchronous Source Analysis**: Non-blocking file and network operations for improved throughput
...
# Batch processing with auto-resume (using run_with_llm.py)
python run_with_llm.py --crates-file data/crate_list.txt --auto-resume --batch-size 5

# Force restart processing (using run_with_llm.py)
python run_with_llm.py --crates-file data/crate_list.txt --force-restart
```
...
**Rust Crate Pipeline v4.0.1** - Enterprise-grade Rust crate analysis with AI-powered insights, advanced caching, ML predictions, and microservices architecture.
