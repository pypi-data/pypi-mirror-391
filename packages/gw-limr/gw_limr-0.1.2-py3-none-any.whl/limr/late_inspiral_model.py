...
def load_late_inspiral_gp_amp_phase(model_save_path=None, modes=None):
    if not modes:
    ...
    if not model_save_path:
        ...
        model_save_path = Path("/Users/sebastian.khan/personal/data/20251109_pofh_gp_model_inspiral_model")
