...
class EzChLog:
    ...
    def get_branch_name(self, cat: Enum, ref: str, name: str) -> str:
    ...
    def add(self, *, dry_run: bool, message: str, cat: Enum, ref: str, create_branch: bool, add_to_index: bool) -> tuple[Path, str]:
    ...
    def list(self) -> list[Path]:
        return [p.relative_to(self.cfg.log_dir) for cat in list[Enum](self.cfg.category_class) for p in sorted((self.cfg.log_dir / cat.name).glob('*.md'))]
