                    ...
                    if variation_count > 1:
                        ...
                        for candidate in response.candidates:
                            ...
                            if candidate.content.parts[0].text:
                                ...
                                content = json.dumps(type(function_call).to_dict(function_call))
                            ...
                            if _formatter == "csv":
                                ...
                                try:
                                    content = _validate_obj.validate(
                                        content,
                                        schema=format_structure[index] if format_structure else None
                                    )
                        ...
                        try:
                            ...
                            raise ValidationException(f"AI response is not valid {_formatter}")
