...
import time
import uuid
from aibridgecore.exceptions import MistralException, AIBridgeException, ValidationException
    ...
    def get_prompt_context(self, context, model=None):
        ...
        if context:
            for _context in context:
                ...
                if not content:
                    print(f"[Mistral] skipping empty {_context['role']} message in context")
                    continue
