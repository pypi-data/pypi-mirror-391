...
def register_sidebar_callbacks(app):
    ...
    def toggle_sidebar(n_clicks):
        ...
        if n_clicks % 2 == 0:
            ...
            return ("sidebar sidebar-expanded", "fas fa-bars")
        else:
            # Collapsed state
            print("Setting sidebar to collapsed state")
            return ("sidebar sidebar-collapsed", "fas fa-arrow-right")

    @app.callback(Output("page-content", "style"), [Input("sidebar", "className")])
