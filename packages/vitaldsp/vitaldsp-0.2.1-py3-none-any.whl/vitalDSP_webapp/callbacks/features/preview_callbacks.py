...
def register_preview_callbacks(app):
    ...
    @app.callback(
        [Output("data-preview-plot", "figure"), Output("data-summary", "children")],
        [Input("btn-preview-data", "n_clicks"), Input("preview-window-size", "value")],
    ...
    def preview_data(n_clicks, window_size, data_store, config_store):
        ...
        try:
            ...
            signal_data = preview_df.iloc[
                :, 1
            ].values  # Assuming second column is signal
            ...
            summary = html.Div(
                [
                    ...
                    html.P(
                        f"Preview Duration: {window_size/sampling_freq:.2f} seconds"
                    ),
            ...
            error_summary = html.Div(
                [html.H5("Error"), html.P(f"Data preview failed: {str(e)}")]
            )
