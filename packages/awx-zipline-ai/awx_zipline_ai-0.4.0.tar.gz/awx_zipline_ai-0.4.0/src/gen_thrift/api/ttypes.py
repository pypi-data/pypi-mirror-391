...
class Model(object):
    ...
    def __init__(self, metaData = None, inferenceSpec = None, inputMapping = None, outputMapping = None,):
        self.metaData = metaData
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i275 in range(_size271):
                        ...
                        self.inputMapping[_key276] = _val277
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.MAP:
                    ...
                    for _i282 in range(_size278):
                        ...
                        self.outputMapping[_key283] = _val284
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.inputMapping is not None:
            ...
            for kiter285, viter286 in self.inputMapping.items():
        ...
        if self.outputMapping is not None:
            ...
            for kiter287, viter288 in self.outputMapping.items():
...
class InferenceSpec(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i293 in range(_size289):
                        ...
                        self.modelBackendParams[_key294] = _val295
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
    ...
    def write(self, oprot):
        ...
        if self.modelBackendParams is not None:
            ...
            for kiter296, viter297 in self.modelBackendParams.items():
...
class ModelTransforms(object):
    ...
    def __init__(self, sources = None, models = None, passthroughFields = None, metaData = None,):
        self.sources = sources
        self.models = models
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i314 in range(_size310):
                        _elem315 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.passthroughFields.append(_elem315)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
    ...
    def write(self, oprot):
        ...
        if self.passthroughFields is not None:
            ...
            for iter318 in self.passthroughFields:
