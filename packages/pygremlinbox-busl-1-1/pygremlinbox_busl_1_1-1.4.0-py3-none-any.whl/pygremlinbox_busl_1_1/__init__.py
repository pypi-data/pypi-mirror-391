...
"""
PyGremlinBox BUSL-1.1 - Supply chain security testing module.

This package is licenced under the Business Source Licence v1.1 (BUSL-1.1).
...
maintaining compliance with BUSL-1.1 requirements.
"""

__version__ = "1.4.0"
__licence__ = "BUSL-1.1"
...
def get_package_metadata():
    ...
    """
    return {
        "name": "pygremlinbox-busl-1-1",
        "version": __version__,
        "licence": __licence__,
        "description": "Supply chain security testing module with Business Source Licence v1.1",
        "spdx_licence_id": "BUSL-1.1"
    }
