...
"""
PyGremlinBox PolyForm-Small-Business-1.0.0 - Supply chain security testing module.

This package is licenced under PolyForm-Small-Business-1.0.0.
...
maintaining compliance with PolyForm-Small-Business-1.0.0 requirements.
"""

__version__ = "1.4.0"
__licence__ = "PolyForm-Small-Business-1.0.0"
...
def get_package_metadata():
    ...
    """
    return {
        "name": "PyGremlinBox-PolyForm-Small-Business-1-0-0",
        "version": __version__,
        "licence": __licence__,
        "description": "Supply chain security testing module with PolyForm-Small-Business-1.0.0 licence",
        "spdx_licence_id": "PolyForm-Small-Business-1.0.0"
    }
