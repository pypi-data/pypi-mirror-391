...
sectmap = {
    ...
    #     'Metal, Glass & Plastic Containers':('Materials','Materials','Containers & Packaging'),
    ...
    #     'Automotive Parts & Equipment':('Consumer Discretionary','Automobiles & Components','Auto Components'),
    ...
    #     'Agricultural Products & Services':('Consumer Staples','Food, Beverage & Tobacco','Food Products'),
    ...
    'equity_sector_mappings': {
        ...
        'Oil & Gas Storage & Transportation': ('Energy', 'Energy', 'Oil, Gas & Consumable Fuels'), 
        'Coal & Consumable Fuels': ('Energy', 'Energy', 'Oil, Gas & Consumable Fuels'), 
        'Commodity Chemicals': ('Materials', 'Materials', 'Chemicals'), 'Diversified Chemicals': ('Materials', 'Materials', 'Chemicals'), 'Fertilizers & Agricultural Chemicals': ('Materials', 'Materials', 'Chemicals'), 
        'Industrial Gases': ('Materials', 'Materials', 'Chemicals'), 
        'Specialty Chemicals': ('Materials', 'Materials', 'Chemicals'), 
        'Construction Materials': ('Materials', 'Materials', 'Construction Materials'), 
        'Metal, Glass & Plastic Containers': ('Materials', 'Materials', 'Containers & Packaging'), 
        'Paper & Plastic Packaging Products & Materials': ('Materials', 'Materials', 'Containers & Packaging'), 
        'Aluminum': ('Materials', 'Materials', 'Metals & Mining'), 
        'Diversified Metals & Mining': ('Materials', 'Materials', 'Metals & Mining'), 
        'Copper': ('Materials', 'Materials', 'Metals & Mining'), 
        'Gold': ('Materials', 'Materials', 'Metals & Mining'), 
        ...
        'Air Freight & Logistics': ('Industrials', 'Transportation', 'Air Freight & Logistics'), 
        'Passenger Airlines': ('Industrials', 'Transportation', 'Passenger Airlines'), 
        'Marine Transportation': ('Industrials', 'Transportation', 'Marine Transportation'), 
        'Rail Transportation': ('Industrials', 'Transportation', 'Ground Transportation'), 
        'Cargo Ground Transportation': ('Industrials', 'Transportation', 'Ground Transportation'), 
        'Passenger Ground Transportation': ('Industrials', 'Transportation', 'Ground Transportation'), 
        'Airport Services': ('Industrials', 'Transportation', 'Transportation Infrastructure'), 
        'Highways & Railtracks': ('Industrials', 'Transportation', 'Transportation Infrastructure'), 
        'Marine Ports & Services': ('Industrials', 'Transportation', 'Transportation Infrastructure'), 
        'Automotive Parts & Equipment': ('Consumer Discretionary', 'Automobiles & Components', 'Automobile Components'), 
        'Tires & Rubber': ('Consumer Discretionary', 'Automobiles & Components', 'Automobile Components'), 
        'Automobile Manufacturers': ('Consumer Discretionary', 'Automobiles & Components', 'Automobiles'), 
        'Motorcycle Manufacturers': ('Consumer Discretionary', 'Automobiles & Components', 'Automobiles'), 
        'Consumer Electronics': ('Consumer Discretionary', 'Consumer Durables & Apparel', 'Household Durables'), 
        'Home Furnishings': ('Consumer Discretionary', 'Consumer Durables & Apparel', 'Household Durables'), 
        ...
        'Housewares & Specialties': ('Consumer Discretionary', 'Consumer Durables & Apparel', 'Household Durables'), 
        'Leisure Products': ('Consumer Discretionary', 'Consumer Durables & Apparel', 'Leisure Products'), 
        'Apparel, Accessories & Luxury Goods': ('Consumer Discretionary', 'Consumer Durables & Apparel', 'Textiles, Apparel & Luxury Goods'), 'Footwear': ('Consumer Discretionary', 'Consumer Durables & Apparel', 'Textiles, Apparel & Luxury Goods'), 
        'Textiles': ('Consumer Discretionary', 'Consumer Durables & Apparel', 'Textiles, Apparel & Luxury Goods'), 
        'Casinos & Gaming': ('Consumer Discretionary', 'Consumer Services', 'Hotels, Restaurants & Leisure'), 
        'Hotels, Resorts & Cruise Lines': ('Consumer Discretionary', 'Consumer Services', 'Hotels, Restaurants & Leisure'), 
        'Leisure Facilities': ('Consumer Discretionary', 'Consumer Services', 'Hotels, Restaurants & Leisure'), 
        ...
        'Education Services': ('Consumer Discretionary', 'Consumer Services', 'Diversified Consumer Services'), 
        'Specialized Consumer Services': ('Consumer Discretionary', 'Consumer Services', 'Diversified Consumer Services'), 
        'Distributors': ('Consumer Discretionary', 'Consumer Discretionary Distribution & Retail', 'Distributors'), 
        'Broadline Retail': ('Consumer Discretionary', 'Consumer Discretionary Distribution & Retail', 'Broadline Retail'), 
        'Apparel Retail': ('Consumer Discretionary', 'Consumer Discretionary Distribution & Retail', 'Specialty Retail'), 
        'Computer & Electronics Retail': ('Consumer Discretionary', 'Consumer Discretionary Distribution & Retail', 'Specialty Retail'), 
        'Home Improvement Retail': ('Consumer Discretionary', 'Consumer Discretionary Distribution & Retail', 'Specialty Retail'), 
        'Other Specialty Retail': ('Consumer Discretionary', 'Consumer Discretionary Distribution & Retail', 'Specialty Retail'), 
        'Automotive Retail': ('Consumer Discretionary', 'Consumer Discretionary Distribution & Retail', 'Specialty Retail'), 
        'Homefurnishing Retail': ('Consumer Discretionary', 'Consumer Discretionary Distribution & Retail', 'Specialty Retail'), 
        'Drug Retail': ('Consumer Staples', 'Consumer Staples Distribution & Retail', 'Consumer Staples Distribution & Retail'), 
        'Food Distributors': ('Consumer Staples', 'Consumer Staples Distribution & Retail', 'Consumer Staples Distribution & Retail'), 'Food Retail': ('Consumer Staples', 'Consumer Staples Distribution & Retail', 'Consumer Staples Distribution & Retail'), 
        'Consumer Staples Merchandise Retail': ('Consumer Staples', 'Consumer Staples Distribution & Retail', 'Consumer Staples Distribution & Retail'), 
        'Brewers': ('Consumer Staples', 'Food, Beverage & Tobacco', 'Beverages'), 
        'Distillers & Vintners': ('Consumer Staples', 'Food, Beverage & Tobacco', 'Beverages'), 
        'Soft Drinks & Non-alcoholic Beverages': ('Consumer Staples', 'Food, Beverage & Tobacco', 'Beverages'), 
        'Agricultural Products & Services': ('Consumer Staples', 'Food, Beverage & Tobacco', 'Food Products'), 
        'Packaged Foods & Meats': ('Consumer Staples', 'Food, Beverage & Tobacco', 'Food Products'), 
        'Tobacco': ('Consumer Staples', 'Food, Beverage & Tobacco', 'Tobacco'), 'Household Products': ('Consumer Staples', 'Household & Personal Products', 'Household Products'), 
        ...
        'Biotechnology': ('Health Care', 'Pharmaceuticals, Biotechnology & Life Sciences', 'Biotechnology'), 
        'Pharmaceuticals': ('Health Care', 'Pharmaceuticals, Biotechnology & Life Sciences', 'Pharmaceuticals'), 
        'Life Sciences Tools & Services': ('Health Care', 'Pharmaceuticals, Biotechnology & Life Sciences', 'Life Sciences Tools & Services'), 'Diversified Banks': ('Financials', 'Banks', 'Banks'), 
        'Regional Banks': ('Financials', 'Banks', 'Banks'), 'Diversified Financial Services': ('Financials', 'Financial Services', 'Financial Services'), 
        'Multi-Sector Holdings': ('Financials', 'Financial Services', 'Financial Services'), 
        'Specialized Finance': ('Financials', 'Financial Services', 'Financial Services'), 
        'Commercial & Residential Mortgage Finance': ('Financials', 'Financial Services', 'Financial Services'), 
        'Transaction & Payment Processing Services': ('Financials', 'Financial Services', 'Financial Services'), 
        'Consumer Finance': ('Financials', 'Financial Services', 'Consumer Finance'), 
        'Asset Management & Custody Banks': ('Financials', 'Financial Services', 'Capital Markets'), 
        'Investment Banking & Brokerage': ('Financials', 'Financial Services', 'Capital Markets'), 
        'Diversified Capital Markets': ('Financials', 'Financial Services', 'Capital Markets'), 
        'Financial Exchanges & Data': ('Financials', 'Financial Services', 'Capital Markets'), 
        'Mortgage REITs': ('Financials', 'Financial Services', 'Mortgage Real Estate Investment Trusts (REITs)'), 
        'Insurance Brokers': ('Financials', 'Insurance', 'Insurance'), 
        'Life & Health Insurance': ('Financials', 'Insurance', 'Insurance'), 'Multi-line Insurance': ('Financials', 'Insurance', 'Insurance'), 'Property & Casualty Insurance': ('Financials', 'Insurance', 'Insurance'), 
        'Reinsurance': ('Financials', 'Insurance', 'Insurance'), 
        'IT Consulting & Other Services': ('Information Technology', 'Software & Services', 'IT Services'), 
        'Internet Services & Infrastructure': ('Information Technology', 'Software & Services', 'IT Services'), 
        'Application Software': ('Information Technology', 'Software & Services', 'Software'), 
        ...
        'Electronic Manufacturing Services': ('Information Technology', 'Technology Hardware & Equipment', 'Electronic Equipment, Instruments & Components'), 
        'Technology Distributors': ('Information Technology', 'Technology Hardware & Equipment', 'Electronic Equipment, Instruments & Components'), 
        'Semiconductor Materials & Equipment': ('Information Technology', 'Semiconductors & Semiconductor Equipment', 'Semiconductors & Semiconductor Equipment'), 
        'Semiconductors': ('Information Technology', 'Semiconductors & Semiconductor Equipment', 'Semiconductors & Semiconductor Equipment'), 'Alternative Carriers': ('Communication Services', 'Telecommunication Services', 'Diversified Telecommunication Services'), 
        'Integrated Telecommunication Services': ('Communication Services', 'Telecommunication Services', 'Diversified Telecommunication Services'), 
        'Wireless Telecommunication Services': ('Communication Services', 'Telecommunication Services', 'Wireless Telecommunication Services'), 'Advertising': ('Communication Services', 'Media & Entertainment', 'Media'), 
        'Broadcasting': ('Communication Services', 'Media & Entertainment', 'Media'), 'Cable & Satellite': ('Communication Services', 'Media & Entertainment', 'Media'), 
        'Publishing': ('Communication Services', 'Media & Entertainment', 'Media'), 
        'Movies & Entertainment': ('Communication Services', 'Media & Entertainment', 'Entertainment'), 
        'Interactive Home Entertainment': ('Communication Services', 'Media & Entertainment', 'Entertainment'), 
        'Interactive Media & Services': ('Communication Services', 'Media & Entertainment', 'Interactive Media & Services'), 
        'Electric Utilities': ('Utilities', 'Utilities', 'Electric Utilities'), 'Gas Utilities': ('Utilities', 'Utilities', 'Gas Utilities'), 'Multi-Utilities': ('Utilities', 'Utilities', 'Multi-Utilities'), 'Water Utilities': ('Utilities', 'Utilities', 'Water Utilities'), 'Independent Power Producers & Energy Traders': ('Utilities', 'Utilities', 'Independent Power and Renewable Electricity Producers'), 'Renewable Electricity': ('Utilities', 'Utilities', 'Independent Power and Renewable Electricity Producers'), 
        ...
        'Multi-Family Residential REITs': ('Real Estate', 'Equity Real Estate Investment Trusts (REITs)', 'Residential REITs'), 
        'Single-Family Residential REITs': ('Real Estate', 'Equity Real Estate Investment Trusts (REITs)', 'Residential REITs'), 
        'Retail REITs': ('Real Estate', 'Equity Real Estate Investment Trusts (REITs)', 'Retail REITs'), 
        'Other Specialized REITs': ('Real Estate', 'Equity Real Estate Investment Trusts (REITs)', 'Specialized REITs'), 
        'Self-Storage REITs': ('Real Estate', 'Equity Real Estate Investment Trusts (REITs)', 'Specialized REITs'), 
        'Telecom Tower REITs': ('Real Estate', 'Equity Real Estate Investment Trusts (REITs)', 'Specialized REITs'), 
        'Timber REITs': ('Real Estate', 'Equity Real Estate Investment Trusts (REITs)', 'Specialized REITs'), 
        'Data Center REITs': ('Real Estate', 'Equity Real Estate Investment Trusts (REITs)', 'Specialized REITs'), 
        'Diversified Real Estate Activities': ('Real Estate', 'Real Estate Management & Development', 'Real Estate Management & Development'), 'Real Estate Operating Companies': ('Real Estate', 'Real Estate Management & Development', 'Real Estate Management & Development'), 'Real Estate Development': ('Real Estate', 'Real Estate Management & Development', 'Real Estate Management & Development'), 
