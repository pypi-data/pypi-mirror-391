...
def generate_resume(
    ...
    try:
        ...
        if success and pdf_bytes:
            ...
            # Return both the file path and embedded PDF
            return f"""✅ Resume PDF generated successfully!

📄 Saved to: {output_path}

You can view the PDF below:

![Resume PDF](data:application/pdf;base64,{pdf_base64})

The PDF has been embedded above and saved to your disk at the path shown."""
        else:
...
@mcp.tool()
def create_resume(yaml_content: str, output_filename: str = "resume.pdf") -> str:
    """
