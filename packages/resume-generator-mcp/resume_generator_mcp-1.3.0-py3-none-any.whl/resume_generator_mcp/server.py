...
def generate_resume(
    ...
    try:
        ...
        if success and pdf_bytes:
            ...
            # Create response with text and images
            response = [
                TextContent(
                    type="text",
...
@mcp.tool()
def create_resume(yaml_content: str, output_filename: str = "resume.pdf") -> List[TextContent | ImageContent]:
    """
