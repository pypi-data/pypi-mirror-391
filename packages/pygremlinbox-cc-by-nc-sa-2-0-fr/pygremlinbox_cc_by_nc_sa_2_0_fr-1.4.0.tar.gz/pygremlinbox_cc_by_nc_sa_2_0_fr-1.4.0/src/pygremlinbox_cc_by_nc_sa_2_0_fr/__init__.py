# SPDX-License-Identifier: CC-BY-NC-SA-2.0-FR
# SPDX-FileCopyrightText: 2025 PyGremlinBox Maintainer <simon@sigre.xyz>

"""
PyGremlinBox CC-BY-NC-SA-2.0-FR - Supply chain security testing module.

This package is licenced under CC-BY-NC-SA-2.0-FR.
...
maintaining compliance with CC-BY-NC-SA-2.0-FR requirements.
"""

__version__ = "1.4.0"
__licence__ = "CC-BY-NC-SA-2.0-FR"
...
def get_package_metadata():
    ...
    """
    return {
        "name": "PyGremlinBox-CC-BY-NC-SA-2-0-FR",
        "version": __version__,
        "licence": __licence__,
        "description": "Supply chain security testing module with CC-BY-NC-SA-2.0-FR licence",
        "spdx_licence_id": "CC-BY-NC-SA-2.0-FR"
    }
