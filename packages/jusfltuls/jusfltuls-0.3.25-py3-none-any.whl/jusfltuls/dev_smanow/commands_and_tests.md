...
`lsblk -p -P -o NAME,TYPE,MOUNTPOINT | awk -F'"' '/TYPE="part"/{m=$6; if(m=="") m="not_mounted"; print $2 "\t" m}'`
...
# Summary command - showing device, filesystem, size, mounted:
