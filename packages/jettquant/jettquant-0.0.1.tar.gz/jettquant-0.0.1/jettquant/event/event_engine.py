...
class Event:
    ...
    def __init__(self, etype: str, edata: Any = None) -> None:
        """"""
        self.etype: str = etype
        self.edata: Any = edata
...
class EventEngine:
    ...
    def put_data(self, etype: str, edata: Any) -> None:
        event: Event = Event(etype=etype, edata=edata)
        self._queue.put(event)
...
if __name__ == '__main__':
    ...
    event_engine.register("123", on_tick)
    ...
    while True:
        ...
        # 生产事件
        event_engine.put_data("123", "1234")
