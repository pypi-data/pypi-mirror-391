# SPDX-License-Identifier: copyleft-next-0.3.0
# SPDX-FileCopyrightText: 2025 PyGremlinBox Maintainer <simon@sigre.xyz>

"""
PyGremlinBox copyleft-next-0.3.0 - Supply chain security testing module.

This package is licenced under copyleft-next-0.3.0.
...
maintaining compliance with copyleft-next-0.3.0 requirements.
"""

__version__ = "1.4.0"
__licence__ = "copyleft-next-0.3.0"
...
def get_package_metadata():
    ...
    """
    return {
        "name": "PyGremlinBox-copyleft-next-0-3-0",
        "version": __version__,
        "licence": __licence__,
        "description": "Supply chain security testing module with copyleft-next-0.3.0 licence",
        "spdx_licence_id": "copyleft-next-0.3.0"
    }
