...
class CloneMediaSpec(object):
    ...
    def __init__(self, dest_project=None, dest_section=None, dest_section_id=None, dest_type=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def dest_section_id(self):
        """
        Destination media section ID.

        :return: The dest_section_id of this CloneMediaSpec. 
        :rtype: int
        """
        return self._dest_section_id

    @dest_section_id.setter
    def dest_section_id(self, dest_section_id):
        """
        Destination media section ID.

        :param dest_section_id: The dest_section_id of this CloneMediaSpec.
        :type: int
        """

        self._dest_section_id = dest_section_id
