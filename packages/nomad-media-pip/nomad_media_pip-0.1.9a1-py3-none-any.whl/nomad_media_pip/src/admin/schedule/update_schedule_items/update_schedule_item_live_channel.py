"""
This module updates a schedule item live channel.

Functions:
    _update_schedule_item_live_channel: Updates a schedule item live channel.
"""
...
def _update_schedule_item_live_channel(
    self,
    schedule_id: int,
    item_id: int,
    days: list[dict] | None,
    ...
    return _send_request(self, "Update Schedule Item Live Channel", api_url, "PUT", None, body)
