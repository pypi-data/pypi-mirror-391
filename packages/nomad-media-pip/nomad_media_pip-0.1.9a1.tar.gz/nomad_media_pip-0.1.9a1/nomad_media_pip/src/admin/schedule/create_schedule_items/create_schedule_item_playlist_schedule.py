"""
This module creates a schedule item playlist schedule.

Functions:
    _create_schedule_item_playlist_schedule: Creates a schedule item playlist schedule.
"""

from nomad_media_pip.src.helpers.send_request import _send_request


def _create_schedule_item_playlist_schedule(
    self,
    scheudle_id: str,
    days: list[dict],
    ...
    return _send_request(self, "Create Schedule Item Playlist Schedule", api_url, "POST", None, body)
