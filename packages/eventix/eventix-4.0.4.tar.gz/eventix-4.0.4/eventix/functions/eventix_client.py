...
class EventixClient:
    ...
    @classmethod
    def get_task_by_unique_key_and_namespace(cls, unique_key: str, namespace: str = None, stati: list[EventixTaskStatusEnum] = None) -> TEventixTask:

        params = {"stati": [EventixTaskStatusEnum.scheduled.value, EventixTaskStatusEnum.retry.value] if stati is None else stati}
