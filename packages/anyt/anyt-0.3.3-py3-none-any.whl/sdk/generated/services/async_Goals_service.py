...
async def list_goals_v1_workspaces__workspace_id__goals__get(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, status_filter : Optional[Union[str,None]] = None, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> List[GoalResponse]:
...
async def create_goal_v1_workspaces__workspace_id__goals__post(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, data : CreateGoalRequest, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> GoalResponse:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def get_goal_v1_workspaces__workspace_id__goals__goal_id__get(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, goal_id : int, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> GoalResponse:
    api_config = api_config_override if api_config_override else APIConfig()
...
'X-Test-User-Id' : X_Test_User_Id
    ...
    return GoalResponse(**body) if body is not None else GoalResponse()
async def delete_goal_v1_workspaces__workspace_id__goals__goal_id__delete(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, goal_id : int, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> None:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def decompose_goal_v1_workspaces__workspace_id__goals__goal_id__decompose_post(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, goal_id : int, data : DecompositionRequest, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> DecompositionResponse:
    api_config = api_config_override if api_config_override else APIConfig()
