...
async def list_labels_v1_workspaces__workspace_id__labels__get(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> List[Label]:
...
async def create_label_v1_workspaces__workspace_id__labels__post(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, data : LabelCreate, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> Label:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def delete_label_v1_workspaces__workspace_id__labels__label_id__delete(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, label_id : int, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> None:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def update_label_v1_workspaces__workspace_id__labels__label_id__patch(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, label_id : int, data : LabelUpdate, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> Label:
    api_config = api_config_override if api_config_override else APIConfig()
