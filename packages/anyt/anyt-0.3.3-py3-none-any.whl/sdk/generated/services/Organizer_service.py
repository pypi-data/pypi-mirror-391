...
def create_summary_v1_workspaces__workspace_id__organize_summaries_post(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, data : SummaryRequest, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> SummaryResponse:
    api_config = api_config_override if api_config_override else APIConfig()
