...
def list_agents_v1_workspaces__workspace_id__agents__get(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> List[Agent]:
...
def create_agent_v1_workspaces__workspace_id__agents__post(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, data : CreateAgentRequest, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> Agent:
    api_config = api_config_override if api_config_override else APIConfig()
...
def get_agent_v1_workspaces__workspace_id__agents__agent_id__get(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, agent_id : str, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> Agent:
    api_config = api_config_override if api_config_override else APIConfig()
...
'X-Test-User-Id' : X_Test_User_Id
    ...
    return Agent(**body) if body is not None else Agent()
def delete_agent_v1_workspaces__workspace_id__agents__agent_id__delete(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, agent_id : str, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> None:
    api_config = api_config_override if api_config_override else APIConfig()
...
def update_agent_v1_workspaces__workspace_id__agents__agent_id__patch(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, agent_id : str, data : AgentUpdate, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> Agent:
    api_config = api_config_override if api_config_override else APIConfig()
...
'X-Test-User-Id' : X_Test_User_Id
    ...
    return Agent(**body) if body is not None else Agent()
def get_assignees_v1_workspaces__workspace_id__assignees__get(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> AssigneesData:
    api_config = api_config_override if api_config_override else APIConfig()
