...
async def organize_workspace_v1_workspaces__workspace_id__organize__post(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, data : OrganizeRequest, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> OrganizeResponse:
...
async def list_summaries_v1_workspaces__workspace_id__organize_summaries_get(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, period : Optional[Union[str,None]] = None, limit : Optional[int] = None, offset : Optional[int] = None, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> List[SummaryResponse]:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def create_summary_v1_workspaces__workspace_id__organize_summaries_post(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, data : SummaryRequest, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> SummaryResponse:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def get_duplicates_v1_workspaces__workspace_id__organize_duplicates_get(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> List[DuplicateSuggestion]:
    api_config = api_config_override if api_config_override else APIConfig()
