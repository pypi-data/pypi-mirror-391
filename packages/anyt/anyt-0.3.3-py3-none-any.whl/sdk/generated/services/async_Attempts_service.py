...
async def start_attempt_v1_workspaces__workspace_id__tasks__task_identifier__attempts_start_post(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, task_identifier : str, data : StartAttemptRequest, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> AttemptResponse:
...
async def finish_attempt_v1_workspaces__workspace_id__attempts__attempt_id__finish_post(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, attempt_id : int, data : FinishAttemptRequest, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> AttemptResponse:
    api_config = api_config_override if api_config_override else APIConfig()
...
'X-Test-User-Id' : X_Test_User_Id
    ...
    return AttemptResponse(**body) if body is not None else AttemptResponse()
async def get_attempt_v1_workspaces__workspace_id__attempts__attempt_id__get(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, attempt_id : int, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> AttemptResponse:
    api_config = api_config_override if api_config_override else APIConfig()
...
'X-Test-User-Id' : X_Test_User_Id
    ...
    return AttemptResponse(**body) if body is not None else AttemptResponse()
async def update_attempt_v1_workspaces__workspace_id__attempts__attempt_id__patch(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, attempt_id : int, data : AttemptUpdate, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> AttemptResponse:
    api_config = api_config_override if api_config_override else APIConfig()
...
'X-Test-User-Id' : X_Test_User_Id
    ...
    return AttemptResponse(**body) if body is not None else AttemptResponse()
async def list_task_attempts_v1_workspaces__workspace_id__tasks__task_identifier__attempts__get(api_config_override : Optional[APIConfig] = None, *, workspace_id : int, task_identifier : str, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> AttemptListResponse:
    api_config = api_config_override if api_config_override else APIConfig()
