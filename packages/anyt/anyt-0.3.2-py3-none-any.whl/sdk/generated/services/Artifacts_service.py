...
def list_attempt_artifacts_v1_workspaces__workspace_id__attempts__attempt_id__artifacts__get(api_config_override : Optional[APIConfig] = None, *, workspace_id : Union[int,None], attempt_id : int, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> ArtifactListResponse:
...
def create_artifact_v1_workspaces__workspace_id__attempts__attempt_id__artifacts__post(api_config_override : Optional[APIConfig] = None, *, workspace_id : Union[int,None], attempt_id : int, data : CreateArtifactRequest, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> Artifact:
    api_config = api_config_override if api_config_override else APIConfig()
...
def get_artifact_v1_workspaces__workspace_id__artifacts__artifact_id__get(api_config_override : Optional[APIConfig] = None, *, workspace_id : Union[int,None], artifact_id : int, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> Artifact:
    api_config = api_config_override if api_config_override else APIConfig()
