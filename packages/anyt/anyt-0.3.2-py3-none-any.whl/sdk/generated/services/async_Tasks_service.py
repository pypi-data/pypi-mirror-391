...
async def create_task_v1_projects__project_id__tasks__post(api_config_override : Optional[APIConfig] = None, *, project_id : int, data : CreateTaskRequest, workspace_id : Optional[Union[int,None]] = None, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> Task:
...
async def bulk_update_tasks_v1_workspaces__workspace_id__bulk_tasks_patch(api_config_override : Optional[APIConfig] = None, *, workspace_id : Union[int,None], data : BulkUpdateTasksRequest, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> BulkUpdateTasksResponse:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def get_task_v1_workspaces__workspace_id__tasks__task_identifier__get(api_config_override : Optional[APIConfig] = None, *, workspace_id : Union[int,None], task_identifier : str, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> Task:
    api_config = api_config_override if api_config_override else APIConfig()
...
'X-Test-User-Id' : X_Test_User_Id
    ...
    return Task(**body) if body is not None else Task()
async def delete_task_v1_workspaces__workspace_id__tasks__task_identifier__delete(api_config_override : Optional[APIConfig] = None, *, workspace_id : Union[int,None], task_identifier : str, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> None:
    api_config = api_config_override if api_config_override else APIConfig()
...
'X-Test-User-Id' : X_Test_User_Id
    ...
    return Task(**body) if body is not None else Task()
async def auto_fill_task_v1_workspaces__workspace_id__tasks__task_identifier__auto_fill_post(api_config_override : Optional[APIConfig] = None, *, workspace_id : Union[int,None], task_identifier : str, data : AutoFillRequest, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> AutoFillResponse:
    api_config = api_config_override if api_config_override else APIConfig()
