...
async def create_project_v1_workspaces__workspace_id__projects__post(api_config_override : Optional[APIConfig] = None, *, workspace_id : Union[int,None], data : CreateProjectRequest, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> Project:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def get_current_project_v1_workspaces__workspace_id__projects_current_get(api_config_override : Optional[APIConfig] = None, *, workspace_id : Union[int,None], X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> Project:
    api_config = api_config_override if api_config_override else APIConfig()
...
'X-Test-User-Id' : X_Test_User_Id
    ...
    return Project(**body) if body is not None else Project()
async def get_project_v1_workspaces__workspace_id__projects__project_id__get(api_config_override : Optional[APIConfig] = None, *, workspace_id : Union[int,None], project_id : int, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> Project:
    api_config = api_config_override if api_config_override else APIConfig()
...
'X-Test-User-Id' : X_Test_User_Id
    ...
    return Project(**body) if body is not None else Project()
async def delete_project_v1_workspaces__workspace_id__projects__project_id__delete(api_config_override : Optional[APIConfig] = None, *, workspace_id : Union[int,None], project_id : int, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> Dict[str, Any]:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def update_project_v1_workspaces__workspace_id__projects__project_id__patch(api_config_override : Optional[APIConfig] = None, *, workspace_id : Union[int,None], project_id : int, data : ProjectUpdate, X_API_Key : Optional[Union[str,None]] = None, X_Test_User_Id : Optional[Union[str,None]] = None) -> Project:
    api_config = api_config_override if api_config_override else APIConfig()
