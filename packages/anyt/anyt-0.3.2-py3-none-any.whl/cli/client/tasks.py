...
class TasksAPIClient:
    ...
    async def suggest_tasks(
        ...
        # Extract data from success response (still wrapped for this endpoint)
        from sdk.generated.models.SuccessResponse_TaskSuggestionsResponse_ import (
            SuccessResponse_TaskSuggestionsResponse_,
        )

        wrapped_response: SuccessResponse_TaskSuggestionsResponse_ = response
        response_data: TaskSuggestionsResponse_Output = wrapped_response.data
