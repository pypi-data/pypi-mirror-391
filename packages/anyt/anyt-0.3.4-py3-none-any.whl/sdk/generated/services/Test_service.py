...
def testSuccess(api_config_override : Optional[APIConfig] = None) -> Dict[str, Any]:
...
def testPaginated(api_config_override : Optional[APIConfig] = None, *, page : Optional[int] = None, per_page : Optional[int] = None) -> PaginatedResponse_TestItem_:
    api_config = api_config_override if api_config_override else APIConfig()
...
def testNotFound(api_config_override : Optional[APIConfig] = None) -> Any:
    api_config = api_config_override if api_config_override else APIConfig()
...
def testValidation(api_config_override : Optional[APIConfig] = None) -> Any:
    api_config = api_config_override if api_config_override else APIConfig()
...
def testBadRequest(api_config_override : Optional[APIConfig] = None) -> Any:
    api_config = api_config_override if api_config_override else APIConfig()
...
def testConflict(api_config_override : Optional[APIConfig] = None) -> Any:
    api_config = api_config_override if api_config_override else APIConfig()
...
def testVersionCheck(api_config_override : Optional[APIConfig] = None, *, item_id : int, If_Match : Optional[Union[str,None]] = None) -> Dict[str, Any]:
    api_config = api_config_override if api_config_override else APIConfig()
...
def testServerError(api_config_override : Optional[APIConfig] = None) -> Any:
    api_config = api_config_override if api_config_override else APIConfig()
...
def testAutomaticValidation(api_config_override : Optional[APIConfig] = None, *, data : CreateTestInput) -> Dict[str, Any]:
    api_config = api_config_override if api_config_override else APIConfig()
