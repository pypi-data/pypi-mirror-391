...
python -m build .
twine upload dist/*
pypi-AgEIcHlwaS5vcmcCJGU4ODFjZGRmLWI0MzctNDY4MS1iZjdlLWU2NjQwNDUyZjhmMgACKlszLCI4NWJmOWE2My0wNDdkLTQ0MjItODAzNS1iZTRlMjUxN2VhNTciXQAABiCVZZNPEpbLnAQavAMp-XdscRz1SFXhXCYdVHptf_v2Bg
```
...
```bash
pip install nbotbb-mcp-server
python -m nbotbb_mcp_server
```
