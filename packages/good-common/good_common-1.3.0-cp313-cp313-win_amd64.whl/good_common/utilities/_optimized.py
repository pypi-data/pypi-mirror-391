...
try:
    from ._collections_cy import (  # type: ignore[import-untyped]
...
try:
    from ._functional_cy import (  # type: ignore[import-untyped]
...
try:
    from ._strings_cy import (  # type: ignore[import-untyped]
