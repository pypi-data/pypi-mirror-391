...
This package is licenced under the GNU Affero General Public License v3.0 (AGPL-3.0).
...
def get_package_metadata():
    ...
    """
    return {
        "name": "pygremlinbox-agpl-3.0",
        "version": __version__,
        "licence": __licence__,
        "description": "Supply chain security testing module with AGPL-3.0 licence",
        "spdx_licence_id": "AGPL-3.0"
    }
