# SPDX-License-Identifier: NCGL-UK-2.0
# SPDX-FileCopyrightText: 2025 PyGremlinBox Maintainer <simon@sigre.xyz>

"""
PyGremlinBox NCGL-UK-2.0 - Supply chain security testing module.

This package is licenced under the Non-Commercial Government Licence UK v2.0 (NCGL-UK-2.0).
...
maintaining compliance with NCGL-UK-2.0 requirements.
"""

__version__ = "1.4.0"
__licence__ = "NCGL-UK-2.0"
...
def get_package_metadata():
    ...
    """
    return {
        "name": "pygremlinbox-ncgl-uk-2-0",
        "version": __version__,
        "licence": __licence__,
        "description": "Supply chain security testing module with Non-Commercial Government Licence UK v2.0",
        "spdx_licence_id": "NCGL-UK-2.0"
    }
