...
class UdfApi(object):
    ...
    def delete_udf_info(self, workspace, teamspace, array, **kwargs):  # noqa: E501
        ...
        >>> thread = api.delete_udf_info(workspace, teamspace, array, async_req=True)
        >>> result = thread.get()
    ...
    def delete_udf_info_with_http_info(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_udf_info_with_http_info(workspace, teamspace, array, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and (
            ...
            raise ApiValueError(
                "Missing the required parameter `teamspace` when calling `delete_udf_info`"
            )  # noqa: E501
        ...
        if self.api_client.client_side_validation and (
            ...
            raise ApiValueError(
                "Missing the required parameter `array` when calling `delete_udf_info`"
            )  # noqa: E501
