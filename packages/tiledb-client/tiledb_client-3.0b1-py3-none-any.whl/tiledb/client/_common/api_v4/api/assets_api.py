...
class AssetsApi(object):
    ...
    def search_assets(self, workspace, **kwargs):  # noqa: E501
        ...
        :param async_req bool: execute request asynchronously
        :param str workspace: The workspace name or id (required)
        :param str q: query text  By default, fuzzy text search rules apply trying to find a best match for all words entered.  Operators can be used to make a more precise query.  Double quotes `\"` enclose an exact match word or phrase: `\"cell wall\"`  A word with a leading `-` should return results without this word: `cell -honey`  By default more hits are better, but to _require_ all terms use the `AND` keyword: `cell AND mitochondria`
