...
class HostsManager:
    ...
    def _parse_expires_from_marker(self, line: str) -> Optional[datetime]:
        ...
        - New: "# StopWeb: expires=2025-11-04T13:45:00"
        - Legacy: "# StopWeb: expires 2025-11-04 16:20:15"
        """
        ...
        try:
            ...
            # Try new format: expires=<ISO>
            if comment.startswith("expires="):
                iso_str = comment.split("=", 1)[1].strip()
                return datetime.fromisoformat(iso_str)
            
            # Try legacy format: expires <datetime with space>
            if comment.startswith("expires "):
                datetime_str = comment.split("expires ", 1)[1].strip()
                # Convert "2025-11-04 16:20:15" to "2025-11-04T16:20:15"
                datetime_str = datetime_str.replace(" ", "T", 1)
