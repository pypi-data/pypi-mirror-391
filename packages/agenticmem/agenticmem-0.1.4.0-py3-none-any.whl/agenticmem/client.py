...
class AgenticMemClient:
    ...
    def publish_interaction(
        ...
        Args:
            ...
            request_group (str, optional): The request group
            is_shadow_request (bool, optional): If True, the request will be created as a shadow request.
        ...
        request = PublishUserInteractionRequest(
            ...
            is_shadow_request=is_shadow_request,
        )
