...
class Fit(Command):
    ...
    def execute(self, crispr_repo_dir="", learn_options_override=None, force_rebuild=False):  # type: ignore
        if crispr_repo_dir:
        ...
        from .. import prediction_pipeline
        importlib.reload(prediction_pipeline)
