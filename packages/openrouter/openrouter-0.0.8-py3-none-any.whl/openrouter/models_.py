...
class Models(BaseSDK):
    ...
    def count(
        ...
        *,
    ...
    ) -> models.ModelsCountResponseData:
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.ModelsCountResponse, http_res)
    ...
    def list(
        ...
        *,
        ...
        request = models.GetModelsRequest(
            category=category,
    ...
    def list_for_user(
        ...
        *,
        ...
        req = self._build_request(
            ...
            accept_header_value="application/json",
            http_headers=http_headers,
            security=utils.get_pydantic_model(security, models.ListModelsUserSecurity),
            timeout_ms=timeout_ms,
        )
