...
class Training(WMLResource):
    ...
    def monitor_logs(self, training_id: str | None = None, **kwargs: Any) -> None:
        ...
        **Example:**
        ...
        """
        warning_message = "`monitor_logs` function is deprecated and will be removed in a future release."
    ...
    async def amonitor_logs(self, training_id: str) -> None:
        ...
        **Example:**
        ...
        """
        warning_message = "`amonitor_logs` function is deprecated and will be removed in a future release."
        warn(warning_message, category=DeprecationWarning)
    ...
    def monitor_metrics(self, training_id: str | None = None, **kwargs: Any) -> None:
        ...
        **Example:**
        ...
        """
        warning_message = "`monitor_metrics` function is deprecated and will be removed in a future release."
        warn(warning_message, category=DeprecationWarning)
    ...
    async def amonitor_metrics(self, training_id: str) -> None:
        ...
        **Example:**
        ...
        """
        warning_message = "`amonitor_metrics` function is deprecated and will be removed in a future release."
        warn(warning_message, category=DeprecationWarning)
