...
class SyncCodeInterpreter(SyncSandboxInstance):
    ...
    class Execution:
        def __init__(self):
            ...
            self.error: Optional["SyncCodeInterpreter.ExecutionError"] = None
    ...
    def _parse_output(
        ...
        output: str,
        on_stdout: Optional[Callable[[Any], Any]] = None,
        on_stderr: Optional[Callable[[Any], Any]] = None,
