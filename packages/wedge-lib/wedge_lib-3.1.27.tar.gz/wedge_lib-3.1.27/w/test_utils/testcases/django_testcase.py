...
class DjangoTestCase(TestCaseMixin, TestCase):
    ...
    @classmethod
    def setup_class(cls):
        # ignore TestCaseMixin.setup_class because it is already called in setUpTestData
        pass
    ...
    @contextmanager
    def caplog(self, level=logging.ERROR):
    ...
    def assert_log(self, expected: str, captured_log: StringIO):
        assert expected in captured_log.getvalue()
