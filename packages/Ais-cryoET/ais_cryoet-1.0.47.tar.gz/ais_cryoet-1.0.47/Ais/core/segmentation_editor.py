            ...
            if imgui.core.begin_main_menu_bar():
                ...
                if imgui.begin_menu("Settings"):
                    ...
                    if imgui.begin_menu("Developer"):
                        ...
                        if imgui.menu_item("(debug) annotate actin", selected=cfg.settings["DEBUG_ANNOTATE_EASYMODE_FILAMENT"])[0]:
                            cfg.edit_setting("DEBUG_ANNOTATE_EASYMODE_FILAMENT", not cfg.settings["DEBUG_ANNOTATE_EASYMODE_FILAMENT"])
                        imgui.end_menu()
