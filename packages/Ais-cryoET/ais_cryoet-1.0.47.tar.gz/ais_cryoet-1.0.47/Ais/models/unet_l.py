...
def create(input_shape):
    ...
    # Up Block 3 (
    up3 = Conv2DTranspose(128, (2, 2), strides=(2, 2), padding='same')(conv14)
    up3 = concatenate([up3, conv4], axis=-1)
    conv15 = Conv2D(128, (3, 3), activation='relu', padding='same')(up3)
    ...
    # Up Block 4
    up4 = Conv2DTranspose(64, (2, 2), strides=(2, 2), padding='same')(conv16)
    up4 = concatenate([up4, conv2], axis=-1)
    conv17 = Conv2D(64, (3, 3), activation='relu', padding='same')(up4)
