#!/usr/bin/env python3
"""Test suite for session_mgmt_mcp.cli module.
...
class TestCliCommands:
    ...
    def test_status_command(self, cli_runner: CliRunner) -> None:
        ...
        with patch("session_mgmt_mcp.cli.show_status"):
