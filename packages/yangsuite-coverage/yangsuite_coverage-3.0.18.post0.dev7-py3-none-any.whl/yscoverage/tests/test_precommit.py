...
class TestPrecommit(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.modelpath = 'mgmt/dmi/model/yang/src/ned'
        cls.testpath = 'binos/mgmt/dmi/model/tests'
        cls.modelname = "Cisco-IOS-XE-cdp"
        cls.fset = set()
    ...
    def test_get_changed_xpaths(self):
        new_xp, del_xp, mod_xp, obs_xp, submod = get_changed_xpaths(self.withdiffs,
                                                                    self.modelpath,
                                                                    self.baseline,
                                                                    self.modelname)
        self.assertEqual({'/native/cdp/testrun'}, new_xp)
        self.assertEqual(set(), del_xp)
    ...
    def test_report_new_xpaths(self):
        ...
        modxps = {'/native/interface/AppGigabitEthernet/cdp/enable',
        ...
        no_cli, no_cliver, invalid_test = report_new_xpaths(self.reportname,
                                                            newxps,
                                                            modxps,
                                                            tdl)
        ...
        self.assertEqual(invalid_test, set())
    ...
    def test_report_invalid_testcases(self):
        ...
        self.assertEqual(len(invalid_test), 2)
