...
|---------------------------------------|------------------------------------------------------------|-----------------------|
| NEXT_TASK_DELAY_SECONDS               | Задержка (в секундах) перед запуском следующей задачи      | 90                    |
...
- Добавить значение по умолчанию:
  ```
    PROJECT_DEFAULT_CONFIG.update({
        ...
        ('rdm_general', 'RDM_COLLECT_CHUNKS_LIMIT'): 0,
        ('rdm_general', 'RDM_EXPORT_CHUNKS_LIMIT'): 0,
        ...
    })
  ```
