...
from .agent_memory_types import MemoryType, RelationType, MemoryRelation, EnhancedMemoryRecord as MemoryRecord
...
# Re-export MemoryType from agent_memory_types for compatibility
# class MemoryType is imported above
