...
class TestFillerMessage:
    """Test cases for initial_message feature"""

    def test_tool_with_initial_message_default(self):
        """Test that initial_message is set when defined in tool class"""
        tool = TestToolWithFillerMessage()
        assert tool.initial_message == "Processing your request, please wait..."

    def test_tool_instantiation_with_custom_initial_message(self):
        """Test tool instantiation with custom initial_message"""
        tool_args = {"initial_message": "Custom processing message..."}
        tool = TestToolWithFillerMessage.model_validate(tool_args)
        assert tool.initial_message == "Custom processing message..."

    def test_tool_serialization_includes_initial_message(self):
        """Test that initial_message is included in tool serialization"""
        tool = TestToolWithFillerMessage()
        tool_dict = tool.model_dump()

        assert "initial_message" in tool_dict
        expected_msg = "Processing your request, please wait..."
        assert tool_dict["initial_message"] == expected_msg

    def test_tool_json_serialization(self):
        """Test JSON serialization includes initial_message"""
        import json
    ...
    def test_tool_execution_with_initial_message(self):
        """Test that tool execution works correctly with initial_message"""
        import asyncio
        ...
        expected_msg = "Processing your request, please wait..."
        assert tool.initial_message == expected_msg
