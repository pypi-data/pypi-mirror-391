...
**Latest features:**
- Energy consumption tracking with `energy_consumption_wh`
- Session lifecycle states (`lifecycle_state`, `charging_state`)
- RFID authentication with card serial numbers
