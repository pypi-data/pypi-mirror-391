...
"""
PyGremlinBox CC-BY-SA-4.0 - Supply chain security testing module.

This package is licenced under the Creative Commons Attribution-ShareAlike 4.0 International.
...
maintaining compliance with CC-BY-SA-4.0 requirements.
"""

__version__ = "1.4.0"
__licence__ = "CC-BY-SA-4.0"
...
def get_package_metadata():
    ...
    """
    return {
        "name": "pygremlinbox-cc-by-sa-4.0",
        "version": __version__,
        "licence": __licence__,
        "description": "Supply chain security testing module with CC-BY-SA-4.0 licence",
        "spdx_licence_id": "CC-BY-SA-4.0"
    }
