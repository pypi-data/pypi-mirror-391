...
def bible_translation(b=1, c=1, v=1, area=1, tab1=None, tab2=None, **_):
    ...
    ui.label(f"Original Reader's Bible (ORB) - {chapter_title}").classes('text-2xl font-bold q-mb-md text-center w-full')
