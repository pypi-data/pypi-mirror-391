...
from biblemategui import BIBLEMATEGUI_APP_DIR, BIBLEMATEGUI_DATA, BIBLEMATEGUI_DATA_CUSTOM
...
def page_home(
    ...
    app.storage.general['bibles'] = {os.path.basename(i)[:-6]: i for i in glob.glob(os.path.join(BIBLEMATEGUI_DATA, "bibles", "*.bible"))}
    app.storage.general['bibles_custom'] = {os.path.basename(i)[:-6]: i for i in glob.glob(os.path.join(BIBLEMATEGUI_DATA_CUSTOM, "bibles", "*.bible"))}
