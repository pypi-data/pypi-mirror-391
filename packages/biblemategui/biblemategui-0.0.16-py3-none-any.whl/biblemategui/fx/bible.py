...
def getBibleVersionList() -> List[str]:
    ...
    return ["ORB", "OIB", "OPB", "ODB", "OLB"]+list(app.storage.general['bibles'].keys())+list(app.storage.general['bibles_custom'].keys())

def getBiblePath(bible) -> str:
    return app.storage.general['bibles_custom'][bible] if bible in app.storage.general['bibles_custom'] else app.storage.general['bibles'][bible]
