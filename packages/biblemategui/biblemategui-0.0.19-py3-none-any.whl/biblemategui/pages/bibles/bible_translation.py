...
def bible_translation(b=1, c=1, v=1, area=1, tab1=None, tab2=None, title="", **_):
    ...
    def change_chapter(version, book, chapter):
        ...
        if area == 1:
            config.load_area_1_content(bible_translation, version)
        else:
            config.load_area_2_content(bible_translation, version)

    bible_selector = BibleSelector(on_chapter_changed=change_chapter)
