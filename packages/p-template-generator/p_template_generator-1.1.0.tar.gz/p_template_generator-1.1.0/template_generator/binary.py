...
def updateBin(rootDir):
    ...
    if sys.platform == "win32":
        ...
        asset_md5 = "5388C174F1557A526DB0C7448E207261"
        asset_url = "https://oss.zjtemplate.com/linux/TemplateProcess/templateprocess_1.15_20251112_091407.zip"
    elif sys.platform == "darwin":
        asset_md5 = "721DC6C35101BC0944AFBA5339B78FBD"
        asset_url = "https://oss.zjtemplate.com/macos/TemplateProcess/templateprocess_1.15_20251112_091407.zip"
