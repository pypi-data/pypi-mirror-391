<p align="center">
<img src='https://github.com/aaspip/gallery/blob/main/aaspip/aspi-logo.png' alt='comp' width=320/>
</p>
...
Using the latest version
    ...
    git clone https://github.com/aaspip/aspi
    cd aspi
    pip install -v -e .
or using Pypi
...
or using pip directly from github (Preferrable because aaspip is updated very frequently)
    ...
    pip install git+https://github.com/aaspip/aspi
...
The gallery figures of the aaspip package can be found at
    https://github.com/aaspip/gallery/tree/main/aspi
...
Generated by [demos/test_aspi_seistr_somean2d.py](https://github.com/aaspip/aspi/tree/main/demos/test_aspi_seistr_somean2d.py)
...
Generated by [demos/test_aspi_seistr_somean3d.py](https://github.com/aaspip/aspi/tree/main/demos/test_aspi_seistr_somean3d.py)
...
Generated by [demos/test_aspi_seistr_somf2d.py](https://github.com/aaspip/aspi/tree/main/demos/test_aspi_seistr_somf2d.py)
...
Generated by [demos/test_aspi_seistr_somf3d.py](https://github.com/aaspip/aspi/tree/main/demos/test_aspi_seistr_somf3d.py)
...
Generated by [demos/test_aspi_seistr_passive_recon3d.py](https://github.com/aaspip/aspi/tree/main/demos/test_aspi_seistr_passive_recon3d.py)
...
Generated by [demos/test_aspi_seistr_ssprecursor.py](https://github.com/aaspip/aspi/tree/main/demos/test_aspi_seistr_ssprecursor.py)
...
Generated by [demos/test_aspi_seistr_rf.py](https://github.com/aaspip/aspi/tree/main/demos/test_aspi_seistr_rf.py)
...
Generated by [demos/test_aspi_seistr_das.py](https://github.com/aaspip/aspi/tree/main/demos/test_aspi_seistr_das.py)
...
Generated by [demos/test_aspi_seistr_soint2d.py](https://github.com/aaspip/aspi/tree/main/demos/test_aspi_seistr_soint2d.py)
...
Generated by [demos/test_aspi_seistr_soint2d_seafloor.py](https://github.com/aaspip/aspi/tree/main/demos/test_aspi_seistr_soint2d_seafloor.py)
...
Generated by [demos/test_aspi_seistr_soint2d2.py](https://github.com/aaspip/aspi/tree/main/demos/test_aspi_seistr_soint2d2.py)
...
Generated by [demos/test_aspi_seistr_rgt2d.py](https://github.com/aaspip/aspi/tree/main/demos/test_aspi_seistr_rgt2d.py)
...
Generated by [demos/test_aspi_seistr_sint2d.py](https://github.com/aaspip/aspi/tree/main/demos/test_aspi_seistr_sint2d.py)
...
Generated by [demos/test_aspi_seistr_das_animation](https://github.com/aaspip/aspi/tree/main/demos/test_aspi_seistr_das_animation.py)
...
DEMO1 
The following figure shows an example of traveltime calculation for 2D isotropic media (a) and anisotropic media (b). Generated by [demos/test_aspi_ekfmm_fig1.py](https://github.com/aaspip/aspi/blob/main/demos/test_aspi_ekfmm_fig1.py)
<img src='https://github.com/aaspip/gallery/blob/main/pyekfmm/test_pyekfmm_fig1.png' alt='DEMO1' width=960/>

DEMO2
The following figure shows an example of traveltime calculation for 3D isotropic media (a) and anisotropic media (b). Generated by [demos/test_aspi_ekfmm_fig2.py](https://github.com/aaspip/aspi/blob/main/demos/test_aspi_ekfmm_fig2.py)
<img src='https://github.com/aaspip/gallery/blob/main/pyekfmm/test_pyekfmm_fig2.png' alt='DEMO2' width=960/>

DEMO3
The following figure shows an example of benchmarking Pyekfmm with bh_tomo package (Matlab and Python)
 Generated by [demos/test_aspi_ekfmm_raytracing2d_benchmarkWITHbhtomo_pyttcr.py](https://github.com/aaspip/aspi/blob/main/demos/test_aspi_ekfmm_raytracing2d_benchmarkWITHbhtomo_pyttcr.py)
<img src='https://github.com/aaspip/gallery/blob/main/pyekfmm/test_pyekfmm_raytracing2d_benchmarkWITHbhtomo_pyttcr.png ' alt='DEMO2' width=960/>


## Examples of SEISDL
DEMO1 
The following figure shows an example of seismic denoising using the SGK method within the SEISDL module. Generated by [demos/test_aspi_seisdl_sgk3d.py](https://github.com/aaspip/aspi/blob/main/demos/test_aspi_seisdl_sgk3d.py)
<img src='https://github.com/aaspip/gallery/blob/main/aaspip/test_aspi_seisdl_sgk3d.png' alt='DEMO1' width=960/>
