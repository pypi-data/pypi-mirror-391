...
from ..fable_library.reflection import (TypeInfo, string_type, option_type, int32_type, bool_type, record_type, class_type)
from ..fable_library.types import (Record, FSharpRef)
from .cwltypes import CWLType

def _expr3475() -> TypeInfo:
...
InputBinding_reflection = _expr3475
