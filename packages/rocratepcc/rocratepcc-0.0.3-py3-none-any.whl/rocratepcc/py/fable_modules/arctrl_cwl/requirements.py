...
from ..fable_library.reflection import (TypeInfo, string_type, option_type, class_type, record_type, array_type, float64_type, union_type)
from ..fable_library.types import (Record, FSharpRef, Array, Union)
from .cwltypes import (SchemaDefRequirementType_reflection, SoftwarePackage_reflection, CWLType_reflection)

def _expr3469() -> TypeInfo:
...
DockerRequirement_reflection = _expr3469

def _expr3470() -> TypeInfo:
...
EnvironmentDef_reflection = _expr3470

def _expr3471() -> TypeInfo:
...
ResourceRequirementInstance_reflection = _expr3471
...
Requirement_reflection = _expr3472
