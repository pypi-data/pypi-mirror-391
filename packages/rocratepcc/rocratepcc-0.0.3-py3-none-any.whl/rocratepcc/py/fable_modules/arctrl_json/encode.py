...
from ..fable_library.date import to_string
from ..fable_library.list import (is_empty as is_empty_1, map as map_3, FSharpList)
from ..fable_library.option import (map, default_arg)
from ..fable_library.seq import (is_empty, map as map_1, append, to_array)
from ..fable_library.string_ import (to_fail, printf)
from ..fable_library.types import Array
from ..fable_library.util import (to_enumerable, count, IDictionary)
from ..thoth_json_core.encode import (seq, list_1 as list_1_1, tuple2)
from ..thoth_json_core.types import (IEncodable, IEncoderHelpers_1, Json)
...
def try_include_array(name: Any, encoder: Callable[[_VALUE], IEncodable], value: Array[Any]) -> tuple[__A, IEncodable | None]:
    def _arrow1364(__unit: None=None, name: Any=name, encoder: Any=encoder, value: Any=value) -> IEncodable:
        ...
        return ObjectExpr1363()

    return (name, None if (len(value) == 0) else _arrow1364())
...
def try_include_list_opt(name: Any, encoder: Callable[[_VALUE], IEncodable], value: FSharpList[Any] | None=None) -> tuple[__A, IEncodable | None]:
    def _arrow1365(__unit: None=None, name: Any=name, encoder: Any=encoder, value: Any=value) -> IEncodable | None:
        o: FSharpList[_VALUE] = value
        return None if is_empty_1(o) else list_1_1(map_3(encoder, o))

    return (name, _arrow1365() if (value is not None) else None)
...
def int_dictionary(value_encoder: Callable[[_VALUE], IEncodable], values: IDictionary[int, Any]) -> IEncodable:
    if count(values) == 0:
        ...
        def mapping(_arg: Any, value_encoder: Any=value_encoder, values: Any=values) -> IEncodable:
            ...
            def _arrow1379(value: int, _arg: Any=_arg) -> IEncodable:
                class ObjectExpr1378(IEncodable):
                    def Encode(self, helpers_1: IEncoderHelpers_1[Any]) -> Any:
                        return helpers_1.encode_signed_integral_number(value)

                return ObjectExpr1378()

            return tuple2(_arrow1379, value_encoder, k, active_pattern_result[1])
