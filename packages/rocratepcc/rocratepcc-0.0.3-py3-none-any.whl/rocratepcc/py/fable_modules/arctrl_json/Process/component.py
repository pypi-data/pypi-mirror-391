...
def encoder(value: Component) -> IEncodable:
    ...
    def _arrow1958(oa: OntologyAnnotation, value: Any=value) -> IEncodable:
        return OntologyAnnotation_encoder(oa)

    def _arrow1959(value_1: Value, value: Any=value) -> IEncodable:
        return encoder_1(None, value_1)

    def _arrow1960(oa_1: OntologyAnnotation, value: Any=value) -> IEncodable:
        return OntologyAnnotation_encoder(oa_1)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("type", _arrow1958, value.ComponentType), try_include("value", _arrow1959, value.ComponentValue), try_include("unit", _arrow1960, value.ComponentUnit)]))
...
def _arrow1964(get: IGetters) -> Component:
    ComponentType: OntologyAnnotation | None
    object_arg: IOptionalGetter = get.Optional
    ComponentType = object_arg.Field("type", OntologyAnnotation_decoder)
    def _arrow1962(__unit: None=None) -> Value | None:
        object_arg_1: IOptionalGetter = get.Optional
        return object_arg_1.Field("value", decoder_1)

    def _arrow1963(__unit: None=None) -> OntologyAnnotation | None:
        object_arg_2: IOptionalGetter = get.Optional
        return object_arg_2.Field("unit", OntologyAnnotation_decoder)

    return Component(_arrow1962(), _arrow1963(), ComponentType)


decoder: Decoder_1[Component] = object(_arrow1964)
...
def ISAJson_encoder(id_map: Any | None, c: Component) -> IEncodable:
    ...
    def _arrow1968(value: str, id_map: Any=id_map, c: Any=c) -> IEncodable:
    ...
    def _arrow1969(oa: OntologyAnnotation, id_map: Any=id_map, c: Any=c) -> IEncodable:
        return OntologyAnnotation_ISAJson_encoder(id_map, oa)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("componentName", _arrow1968, Component__get_ComponentName(c)), try_include("componentType", _arrow1969, c.ComponentType)]))
...
def _arrow1972(get: IGetters) -> Component:
    name: str | None
    object_arg: IOptionalGetter = get.Optional
    ...
    def _arrow1971(__unit: None=None) -> OntologyAnnotation | None:
        object_arg_1: IOptionalGetter = get.Optional
        return object_arg_1.Field("componentType", OntologyAnnotation_ISAJson_decoder)

    return Component(pattern_input_1[0], pattern_input_1[1], _arrow1971())


ISAJson_decoder: Decoder_1[Component] = object(_arrow1972)
