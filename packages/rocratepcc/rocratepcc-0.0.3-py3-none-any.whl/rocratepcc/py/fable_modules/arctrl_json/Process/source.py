...
def ROCrate_encoder(oa: Source) -> IEncodable:
    ...
    def _arrow2081(__unit: None=None, oa: Any=oa) -> IEncodable:
        value: str = ROCrate_genID(oa)
        class ObjectExpr2080(IEncodable):
            def Encode(self, helpers: IEncoderHelpers_1[Any]) -> Any:
                return helpers.encode_string(value)

        return ObjectExpr2080()
    ...
    def _arrow2085(value_3: str, oa: Any=oa) -> IEncodable:
    ...
    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow2081()), ("@type", list_1_1(singleton(ObjectExpr2082()))), ("additionalType", ObjectExpr2083()), try_include("name", _arrow2085, oa.Name), try_include_list_opt("characteristics", ROCrate_encoder_1, oa.Characteristics), ("@context", context_jsonvalue)]))
...
def _arrow2090(get: IGetters) -> Source:
    ...
    def _arrow2089(__unit: None=None) -> FSharpList[MaterialAttributeValue] | None:
    ...
    return Source(_arrow2087(), _arrow2088(), _arrow2089())


ROCrate_decoder: Decoder_1[Source] = object(_arrow2090)
...
def ISAJson_encoder(id_map: Any | None, oa: Source) -> IEncodable:
    def f(oa_1: Source, id_map: Any=id_map, oa: Any=oa) -> IEncodable:
        ...
        def _arrow2094(value: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2096(value_2: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2097(oa_2: MaterialAttributeValue, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_1(id_map, oa_2)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@id", _arrow2094, ROCrate_genID(oa_1)), try_include("name", _arrow2096, oa_1.Name), try_include_list_opt("characteristics", _arrow2097, oa_1.Characteristics)]))
    ...
    if id_map is not None:
        def _arrow2099(s_1: Source, id_map: Any=id_map, oa: Any=oa) -> str:
            return ROCrate_genID(s_1)

        return encode(_arrow2099, f, oa, id_map)
...
def _arrow2103(get: IGetters) -> Source:
    ...
    def _arrow2102(__unit: None=None) -> FSharpList[MaterialAttributeValue] | None:
    ...
    return Source(_arrow2100(), _arrow2101(), _arrow2102())


ISAJson_decoder: Decoder_1[Source] = Decode_objectNoAdditionalProperties(ISAJson_allowedFields, _arrow2103)
