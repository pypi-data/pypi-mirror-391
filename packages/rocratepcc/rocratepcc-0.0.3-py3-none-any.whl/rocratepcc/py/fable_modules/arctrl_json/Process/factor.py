...
def encoder(id_map: Any | None, value: Factor) -> IEncodable:
    def f_1(value_1: Factor, id_map: Any=id_map, value: Any=value) -> IEncodable:
        ...
        def _arrow1741(value_2: str, value_1: Any=value_1) -> IEncodable:
        ...
        def _arrow1745(value_4: str, value_1: Any=value_1) -> IEncodable:
        ...
        def _arrow1746(oa: OntologyAnnotation, value_1: Any=value_1) -> IEncodable:
            return OntologyAnnotation_ISAJson_encoder(id_map, oa)

        def _arrow1747(comment: Comment, value_1: Any=value_1) -> IEncodable:
            return ISAJson_encoder(id_map, comment)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@id", _arrow1741, gen_id(value_1)), try_include("factorName", _arrow1745, value_1.Name), try_include("factorType", _arrow1746, value_1.FactorType), try_include_seq("comments", _arrow1747, default_arg(value_1.Comments, []))]))
        ...
        return ObjectExpr1752()

    if id_map is not None:
        def _arrow1753(f_2: Factor, id_map: Any=id_map, value: Any=value) -> str:
            return gen_id(f_2)

        return encode(_arrow1753, f_1, value, id_map)
...
def _arrow1758(get: IGetters) -> Factor:
    def _arrow1754(__unit: None=None) -> str | None:
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("factorName", string)

    def _arrow1756(__unit: None=None) -> OntologyAnnotation | None:
    ...
    return Factor(_arrow1754(), _arrow1756(), _arrow1757())


decoder: Decoder_1[Factor] = object(_arrow1758)
