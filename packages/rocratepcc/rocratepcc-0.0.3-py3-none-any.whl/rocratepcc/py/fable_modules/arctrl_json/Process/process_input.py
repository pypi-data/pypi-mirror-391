...
def _arrow2115(Item: Sample) -> ProcessInput:
    return ProcessInput(1, Item)


def _arrow2116(Item_1: Source) -> ProcessInput:
    return ProcessInput(0, Item_1)


def _arrow2117(Item_2: Data) -> ProcessInput:
    return ProcessInput(2, Item_2)


def _arrow2118(Item_3: Material) -> ProcessInput:
    return ProcessInput(3, Item_3)


ROCrate_decoder: Decoder_1[ProcessInput] = one_of(of_array([map(_arrow2115, ROCrate_decoder_1), map(_arrow2116, ROCrate_decoder_2), map(_arrow2117, ROCrate_decoder_3), map(_arrow2118, ROCrate_decoder_4)]))
...
def _arrow2120(Item: Source) -> ProcessInput:
    return ProcessInput(0, Item)


def _arrow2121(Item_1: Sample) -> ProcessInput:
    return ProcessInput(1, Item_1)


def _arrow2122(Item_2: Data) -> ProcessInput:
    return ProcessInput(2, Item_2)


def _arrow2123(Item_3: Material) -> ProcessInput:
    return ProcessInput(3, Item_3)


ISAJson_decoder: Decoder_1[ProcessInput] = one_of(of_array([map(_arrow2120, ISAJson_decoder_1), map(_arrow2121, ISAJson_decoder_2), map(_arrow2122, ISAJson_decoder_3), map(_arrow2123, ISAJson_decoder_4)]))
