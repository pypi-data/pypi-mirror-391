...
IContext_reflection = _expr1344

def _arrow1349(__unit: None=None) -> IEncodable:
    class ObjectExpr1347(IEncodable):
        def Encode(self, helpers: IEncoderHelpers_1[Any]) -> Any:
            return helpers.encode_string("https://w3id.org/ro/crate/1.1")

    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("@id", ObjectExpr1347())])
    ...
    return ObjectExpr1348()


conforms_to_jsonvalue: IEncodable = _arrow1349()
...
def _arrow1357(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1350()), ("arc", ObjectExpr1351()), ("CreativeWork", ObjectExpr1352()), ("about", ObjectExpr1353()), ("conformsTo", ObjectExpr1354())])
