...
from ...arctrl_core.Helper.collections_ import ResizeArray_tryPick
...
class LDDataset:
    ...
    def try_get_license_as_creative_work(lp: LDNode, graph: LDGraph | None=None, context: LDContext | None=None) -> LDNode | None:
        ...
        if match_value is not None:
            def _arrow1055(__unit: None=None) -> bool:
    ...
    def try_get_measurement_method_as_defined_term(lp: LDNode, graph: LDGraph | None=None, context: LDContext | None=None) -> LDNode | None:
        ...
        (pattern_matching_result, n_1) = (None, None)
        if match_value is not None:
            def _arrow1058(__unit: None=None) -> bool:
                n: LDNode = match_value
    ...
    def try_get_variable_measured_as_property_value(lp: LDNode, graph: LDGraph | None=None, context: LDContext | None=None) -> LDNode | None:
        ...
        (pattern_matching_result, n_1) = (None, None)
        if match_value is not None:
            def _arrow1062(__unit: None=None) -> bool:
                n: LDNode = match_value
    ...
    def validate_investigation(lp: LDNode, context: LDContext | None=None) -> bool:
        class ObjectExpr1064:
            @property
            def Equals(self) -> Callable[[str, str], bool]:
                def _arrow1063(x: str, y: str) -> bool:
                    return x == y
        ...
        return contains("Investigation", lp.AdditionalType, ObjectExpr1064()) if LDDataset.validate(lp, context) else False

    @staticmethod
    def validate_study(lp: LDNode, context: LDContext | None=None) -> bool:
        class ObjectExpr1066:
            @property
            def Equals(self) -> Callable[[str, str], bool]:
                def _arrow1065(x: str, y: str) -> bool:
                    return x == y
        ...
        return contains("Study", lp.AdditionalType, ObjectExpr1066()) if LDDataset.validate(lp, context) else False
    ...
    def validate_assay(lp: LDNode, context: LDContext | None=None) -> bool:
        class ObjectExpr1068:
            @property
            def Equals(self) -> Callable[[str, str], bool]:
                def _arrow1067(x: str, y: str) -> bool:
                    return x == y
        ...
        return contains("Assay", lp.AdditionalType, ObjectExpr1068()) if LDDataset.validate(lp, context) else False
...
LDDataset_reflection = _expr1072
