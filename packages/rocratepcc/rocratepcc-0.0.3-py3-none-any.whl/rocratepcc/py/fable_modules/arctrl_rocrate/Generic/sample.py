...
class LDSample:
    ...
    def validate_sample(s: LDNode, context: LDContext | None=None) -> bool:
        ...
        return contains("Sample", s.AdditionalType, ObjectExpr1018()) if LDSample.validate(s, context) else False
    ...
    def validate_source(s: LDNode, context: LDContext | None=None) -> bool:
        class ObjectExpr1020:
            @property
            def Equals(self) -> Callable[[str, str], bool]:
                def _arrow1019(x: str, y: str) -> bool:
                    return x == y
        ...
        return contains("Source", s.AdditionalType, ObjectExpr1020()) if LDSample.validate(s, context) else False
    ...
    def validate_material(s: LDNode, context: LDContext | None=None) -> bool:
        ...
        return contains("Material", s.AdditionalType, ObjectExpr1022()) if LDSample.validate(s, context) else False
