...
def Config__get_WhitespaceString(this: Config) -> str:
    def _arrow3382(_arg: int, this: Any=this) -> str:
        return " "

    return initialize(this.Level * this.Whitespace, _arrow3382)


def _expr3383() -> TypeInfo:
...
Preprocessor_reflection = _expr3383

def _expr3385() -> TypeInfo:
...
class PreprocessorElement(Union):
    ...
    def __str__(self, __unit: None=None) -> str:
        ...
        def innerprint(next_1: PreprocessorElement, level: int) -> None:
            def _arrow3384(_arg: int, next_1: Any=next_1, level: Any=level) -> str:
                return " "

            indent: str = initialize(level * 2, _arrow3384)
            if next_1.tag == 1:
...
PreprocessorElement_reflection = _expr3385

def _expr3386() -> TypeInfo:
...
YAMLElement_reflection = _expr3387
