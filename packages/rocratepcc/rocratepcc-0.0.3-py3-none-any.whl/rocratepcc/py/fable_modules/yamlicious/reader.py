...
def collect_sequence_elements(eles: FSharpList[PreprocessorElement]) -> FSharpList[FSharpList[PreprocessorElement]]:
    ...
    if pattern_matching_result == 0:
        def _arrow3402(__unit: None=None, eles: Any=eles) -> IEnumerable_1[FSharpList[PreprocessorElement]]:
            def _arrow3401(__unit: None=None) -> IEnumerable_1[FSharpList[PreprocessorElement]]:
                return collect_sequence_elements(rest)

            return append(singleton(cons(PreprocessorElement(2, value_2(v["Value"])), yaml_ast_list)) if (v["Value"] is not None) else singleton(yaml_ast_list), delay(_arrow3401))

        return to_list(delay(_arrow3402))
        ...
        if is_empty(eles):
            ...
            if active_pattern_result_1 is not None:
                ...
                def _arrow3404(__unit: None=None, eles: Any=eles) -> IEnumerable_1[FSharpList[PreprocessorElement]]:
                    def _arrow3403(__unit: None=None) -> IEnumerable_1[FSharpList[PreprocessorElement]]:
                        return collect_sequence_elements(tail(eles))

                    return append(singleton(singleton_1(PreprocessorElement(2, value_2(v_1["Value"])))), delay(_arrow3403))

                return to_list(delay(_arrow3404))

            elif _007CYamlComment_007C__007C(head(eles)) is not None:
                def _arrow3406(__unit: None=None, eles: Any=eles) -> IEnumerable_1[FSharpList[PreprocessorElement]]:
                    def _arrow3405(__unit: None=None) -> IEnumerable_1[FSharpList[PreprocessorElement]]:
                        return collect_sequence_elements(tail(eles))

                    return append(singleton(singleton_1(head(eles))), delay(_arrow3405))

                return to_list(delay(_arrow3406))
...
def tokenize(yaml_list: FSharpList[PreprocessorElement], string_dict: Any, comment_dict: Any) -> YAMLElement:
    def loop_read(restlist_mut: FSharpList[PreprocessorElement], acc_mut: FSharpList[YAMLElement], yaml_list: Any=yaml_list, string_dict: Any=string_dict, comment_dict: Any=comment_dict) -> YAMLElement:
        while True:
            ...
            if pattern_matching_result == 0:
                def _arrow3407(e: PreprocessorElement, restlist: Any=restlist, acc: Any=acc) -> bool:
                    return is_sequence_element(e)

                sequence_elements: FSharpList[FSharpList[PreprocessorElement]] = collect_sequence_elements(to_list(take_while(_arrow3407, rest0)))
                def _arrow3408(e_1: PreprocessorElement, restlist: Any=restlist, acc: Any=acc) -> bool:
                    return is_sequence_element(e_1)

                restlist_mut = to_list(skip_while(_arrow3408, rest0))
                def _arrow3414(__unit: None=None, restlist: Any=restlist, acc: Any=acc) -> IEnumerable_1[YAMLElement]:
                    def _arrow3413(__unit: None=None) -> IEnumerable_1[YAMLElement]:
                        def _arrow3412(i: FSharpList[PreprocessorElement]) -> YAMLElement:
                            return loop_read(i, empty())

                        return map_1(_arrow3412, sequence_elements)

                    return append(singleton(loop_read(cons(PreprocessorElement(2, v["Key"]), yaml_ast_list), empty())), delay(_arrow3413))

                acc_mut = cons(YAMLElement(2, to_list(delay(_arrow3414))), acc)
                continue
                ...
                if pattern_matching_result_1 == 0:
                    def _arrow3415(e_2: PreprocessorElement, restlist: Any=restlist, acc: Any=acc) -> bool:
                        return is_sequence_element(e_2)

                    sequence_elements_1: FSharpList[FSharpList[PreprocessorElement]] = collect_sequence_elements(to_list(take_while(_arrow3415, rest0_1)))
                    def _arrow3416(e_3: PreprocessorElement, restlist: Any=restlist, acc: Any=acc) -> bool:
                        return is_sequence_element(e_3)

                    restlist_mut = to_list(skip_while(_arrow3416, rest0_1))
                    def _arrow3422(__unit: None=None, restlist: Any=restlist, acc: Any=acc) -> IEnumerable_1[YAMLElement]:
                        def _arrow3421(__unit: None=None) -> IEnumerable_1[YAMLElement]:
                            def _arrow3420(i_1: FSharpList[PreprocessorElement]) -> YAMLElement:
                                return loop_read(i_1, empty())

                            return map_1(_arrow3420, sequence_elements_1)

                        return append(singleton(loop_read(singleton_1(PreprocessorElement(2, v_1["Key"])), empty())), delay(_arrow3421))

                    acc_mut = cons(YAMLElement(2, to_list(delay(_arrow3422))), acc)
                    continue
                    ...
                    def _arrow3423(e_4: PreprocessorElement, restlist: Any=restlist, acc: Any=acc) -> bool:
                        return is_sequence_element(e_4)

                    sequence_elements_2: FSharpList[FSharpList[PreprocessorElement]] = collect_sequence_elements(to_list(take_while(_arrow3423, rest0_2)))
                    def _arrow3424(e_5: PreprocessorElement, restlist: Any=restlist, acc: Any=acc) -> bool:
                        return is_sequence_element(e_5)

                    restlist_mut = to_list(skip_while(_arrow3424, rest0_2))
                    def _arrow3430(__unit: None=None, restlist: Any=restlist, acc: Any=acc) -> IEnumerable_1[YAMLElement]:
                        def _arrow3429(__unit: None=None) -> IEnumerable_1[YAMLElement]:
                            def _arrow3428(i_2: FSharpList[PreprocessorElement]) -> YAMLElement:
                                return loop_read(i_2, empty())

                            return map_1(_arrow3428, sequence_elements_2)

                        return append(singleton(loop_read(object_list_1, empty())), delay(_arrow3429))

                    acc_mut = cons(YAMLElement(2, to_list(delay(_arrow3430))), acc)
                    continue
                    ...
                    if pattern_matching_result_2 == 0:
                        def _arrow3431(e_6: PreprocessorElement, restlist: Any=restlist, acc: Any=acc) -> bool:
                            return is_sequence_element(e_6)

                        sequence_elements_3: FSharpList[FSharpList[PreprocessorElement]] = collect_sequence_elements(to_list(take_while(_arrow3431, rest0_3)))
                        def _arrow3432(e_7: PreprocessorElement, restlist: Any=restlist, acc: Any=acc) -> bool:
                            return is_sequence_element(e_7)

                        restlist_mut = to_list(skip_while(_arrow3432, rest0_3))
                        def _arrow3438(__unit: None=None, restlist: Any=restlist, acc: Any=acc) -> IEnumerable_1[YAMLElement]:
                            def _arrow3437(__unit: None=None) -> IEnumerable_1[YAMLElement]:
                                def _arrow3436(i_3: FSharpList[PreprocessorElement]) -> YAMLElement:
                                    return loop_read(i_3, empty())

                                return map_1(_arrow3436, sequence_elements_3)

                            return append(singleton(loop_read(singleton_1(PreprocessorElement(2, value_2(v_3["Value"]))), empty())), delay(_arrow3437))

                        acc_mut = cons(YAMLElement(2, to_list(delay(_arrow3438))), acc)
                        continue
                        ...
                        def _arrow3440(__unit: None=None, restlist: Any=restlist, acc: Any=acc) -> IEnumerable_1[YAMLElement]:
                            def _arrow3439(value: str) -> YAMLElement:
                                return loop_read(singleton_1(PreprocessorElement(2, value.strip())), empty())

                            return map_1(_arrow3439, split)

                        current_4: YAMLElement = YAMLElement(2, to_list(delay(_arrow3440)))
                        restlist_mut = rest_4
                        ...
                        def _arrow3442(__unit: None=None, restlist: Any=restlist, acc: Any=acc) -> IEnumerable_1[YAMLElement]:
                            def _arrow3441(i_4: PreprocessorElement) -> IEnumerable_1[YAMLElement]:
                            ...
                            return collect(_arrow3441, i_list)

                        current_5: YAMLElement = YAMLElement(2, to_list(delay(_arrow3442)))
                        restlist_mut = rest_5
                        def _arrow3443(__unit: None=None, restlist: Any=restlist, acc: Any=acc) -> FSharpList[YAMLElement]:
                            c2_2: str = c2
                        ...
                        acc_mut = (cons(current_5, acc) if (c2 is None) else _arrow3443()) if (c1 is None) else (_arrow3444() if (c2 is None) else _arrow3445())
                        continue
                        ...
                        if pattern_matching_result_3 == 0:
                            ...
                            def _arrow3447(__unit: None=None, restlist: Any=restlist, acc: Any=acc) -> IEnumerable_1[YAMLElement]:
                                def _arrow3446(value_1: str) -> IEnumerable_1[YAMLElement]:
                                ...
                                return collect(_arrow3446, split_1)

                            current_6: FSharpList[YAMLElement] = reverse(to_list(delay(_arrow3447)))
                            restlist_mut = rest_6
                            ...
                            def _arrow3449(__unit: None=None, restlist: Any=restlist, acc: Any=acc) -> IEnumerable_1[YAMLElement]:
                                def _arrow3448(i_5: PreprocessorElement) -> IEnumerable_1[YAMLElement]:
                                ...
                                return collect(_arrow3448, i_list_1)

                            current_7: YAMLElement = YAMLElement(0, YAMLContent_create_27AED5E3(opener_1["Key"], c1_3), YAMLElement(3, to_list(delay(_arrow3449))))
                            restlist_mut = rest_7
                            ...
                            if pattern_matching_result_4 == 0:
                                ...
                                if pattern_matching_result_5 == 0:
                                    ...
                                    def _arrow3450(e_8: PreprocessorElement, restlist: Any=restlist, acc: Any=acc) -> bool:
                                        return is_sequence_element(e_8)

                                    sequence_elements_4: FSharpList[FSharpList[PreprocessorElement]] = collect_sequence_elements(to_list(take_while(_arrow3450, rest0_4)))
                                    def _arrow3451(e_9: PreprocessorElement, restlist: Any=restlist, acc: Any=acc) -> bool:
                                        return is_sequence_element(e_9)

                                    rest_9: FSharpList[PreprocessorElement] = to_list(skip_while(_arrow3451, rest0_4))
                                    def _arrow3454(__unit: None=None, restlist: Any=restlist, acc: Any=acc) -> IEnumerable_1[YAMLElement]:
                                        def _arrow3453(__unit: None=None) -> IEnumerable_1[YAMLElement]:
                                            def _arrow3452(i_6: FSharpList[PreprocessorElement]) -> YAMLElement:
                                                return loop_read(i_6, empty())

                                            return map_1(_arrow3452, sequence_elements_4)

                                        return append(singleton(loop_read(object_list_2, empty())), delay(_arrow3453))

                                    seq: YAMLElement = YAMLElement(2, to_list(delay(_arrow3454)))
                                    restlist_mut = rest_9
                                    ...
                                    if pattern_matching_result_6 == 0:
                                        ...
                                        def _arrow3455(e_10: PreprocessorElement, restlist: Any=restlist, acc: Any=acc) -> bool:
                                            return is_sequence_element(e_10)

                                        sequence_elements_5: FSharpList[FSharpList[PreprocessorElement]] = collect_sequence_elements(to_list(take_while(_arrow3455, rest0_5)))
                                        def _arrow3456(e_11: PreprocessorElement, restlist: Any=restlist, acc: Any=acc) -> bool:
                                            return is_sequence_element(e_11)

                                        rest_10: FSharpList[PreprocessorElement] = to_list(skip_while(_arrow3456, rest0_5))
                                        def _arrow3459(__unit: None=None, restlist: Any=restlist, acc: Any=acc) -> IEnumerable_1[YAMLElement]:
                                            def _arrow3458(__unit: None=None) -> IEnumerable_1[YAMLElement]:
                                                def _arrow3457(i_7: FSharpList[PreprocessorElement]) -> YAMLElement:
                                                    return loop_read(i_7, empty())

                                                return map_1(_arrow3457, sequence_elements_5)

                                            return append(singleton(loop_read(singleton_1(PreprocessorElement(2, value_2(w_1["Value"]))), empty())), delay(_arrow3458))

                                        seq_1: YAMLElement = YAMLElement(2, to_list(delay(_arrow3459)))
