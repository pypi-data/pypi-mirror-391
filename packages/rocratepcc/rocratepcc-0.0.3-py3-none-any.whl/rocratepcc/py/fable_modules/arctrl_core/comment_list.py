...
from ..fable_library.map import of_seq
from ..fable_library.option import value
from ..fable_library.seq import (try_pick, exists)
from ..fable_library.types import Array
from ..fable_library.util import (compare_primitives, equals)
...
def to_map(comments: Array[Comment]) -> Any:
    ...
    return of_seq(ResizeArray_choose(f, comments), ObjectExpr70())
