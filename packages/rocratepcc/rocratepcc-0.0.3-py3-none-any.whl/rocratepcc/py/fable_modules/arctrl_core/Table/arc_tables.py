...
class ArcTables:
    def __init__(self, init_tables: Array[ArcTable]) -> None:
        ...
        self.tables: Array[ArcTable] = _expr292()
    ...
    def AddRowAt(self, table_index: int, cells: Array[CompositeCell] | None=None, row_index: int | None=None) -> None:
        this: ArcTables = self
        def _arrow280(table: ArcTable) -> None:
            table.AddRow(cells, row_index)

        this.MapTableAt(table_index, _arrow280)
    ...
    def UpdateRowAt(self, table_index: int, row_index: int, cells: Array[CompositeCell]) -> None:
        this: ArcTables = self
        def _arrow284(table: ArcTable) -> None:
            table.UpdateRow(row_index, cells)

        this.MapTableAt(table_index, _arrow284)
    ...
    def update_reference_tables_by_sheets(reference_tables: ArcTables, sheet_tables: ArcTables, keep_unused_ref_tables: bool | None=None) -> ArcTables:
        ...
        reference_table_map: Any = of_seq_1(choose(chooser, reference_tables.Tables), ObjectExpr286())
        def _arrow289(__unit: None=None) -> IEnumerable_1[ArcTable]:
            ...
            def _arrow288(__unit: None=None) -> Array[ArcTable]:
                a: Array[ArcTable] = sheet_tables.Tables
                return ResizeArray_collect(ArcTable.SplitByProtocolREF(), a)

            s: Array[ArcTable] = ResizeArray_map(f_3, ResizeArray_groupBy(f_2, ResizeArray_map(f_1, _arrow288())))
        ...
        return ArcTables(list(_arrow289()))
