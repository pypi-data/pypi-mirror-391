...
from ..fable_library.array_ import add_range_in_place
from ..fable_library.option import default_arg
from ..fable_library.reflection import (TypeInfo, class_type)
from ..fable_library.seq import contains as contains_1
from ..fable_library.seq2 import Array_distinct
from ..fable_library.types import Array
from ..fable_library.util import (get_enumerator, dispose, equals, safe_hash, uncurry2)
...
def TemplatesAux_getComparer(match_all: bool | None=None) -> Callable[[bool, bool], bool]:
    if default_arg(match_all, False):
        def _arrow349(e: bool, match_all: Any=match_all) -> Callable[[bool], bool]:
            def _arrow348(e_1: bool) -> bool:
                return e and e_1
        ...
        def _arrow351(e_2: bool, match_all: Any=match_all) -> Callable[[bool], bool]:
            def _arrow350(e_3: bool) -> bool:
                return e_2 or e_3
    ...
    def f(t: Template, tag_getter: Any=tag_getter, query_tags: Any=query_tags, comparer: Any=comparer, templates: Any=templates) -> bool:
        ...
        try: 
            while enumerator.System_Collections_IEnumerator_MoveNext():
                ...
                contains: bool = contains_1(enumerator.System_Collections_Generic_IEnumerator_1_get_Current(), template_tags, ObjectExpr352())
...
class Templates:
    ...
    def get_distinct_ontology_annotations(templates: Array[Template]) -> Array[OntologyAnnotation]:
        ...
        return Array_distinct(list(oas), ObjectExpr353())

    @staticmethod
    def filter_by_tags(query_tags: Array[OntologyAnnotation], match_all: bool | None=None) -> Callable[[Array[Template]], Array[Template]]:
        def _arrow355(templates: Array[Template]) -> Array[Template]:
            def _arrow354(t: Template) -> Array[OntologyAnnotation]:
                return t.Tags

            return TemplatesAux_filterOnTags(_arrow354, query_tags, uncurry2(TemplatesAux_getComparer(match_all)), templates)
    ...
    def filter_by_endpoint_repositories(query_tags: Array[OntologyAnnotation], match_all: bool | None=None) -> Callable[[Array[Template]], Array[Template]]:
        def _arrow357(templates: Array[Template]) -> Array[Template]:
            def _arrow356(t: Template) -> Array[OntologyAnnotation]:
                return t.EndpointRepositories

            return TemplatesAux_filterOnTags(_arrow356, query_tags, uncurry2(TemplatesAux_getComparer(match_all)), templates)
    ...
    def filter_by_ontology_annotation(query_tags: Array[OntologyAnnotation], match_all: bool | None=None) -> Callable[[Array[Template]], Array[Template]]:
        def _arrow359(templates: Array[Template]) -> Array[Template]:
            def _arrow358(t: Template) -> Array[OntologyAnnotation]:
                return ResizeArray_append(t.Tags, t.EndpointRepositories)

            return TemplatesAux_filterOnTags(_arrow358, query_tags, uncurry2(TemplatesAux_getComparer(match_all)), templates)
