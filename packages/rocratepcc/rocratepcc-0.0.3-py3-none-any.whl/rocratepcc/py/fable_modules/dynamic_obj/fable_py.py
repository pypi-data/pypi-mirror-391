...
def Dictionary_ofSeq(s: IEnumerable_1[Any]) -> Any:
    ...
    d: Any = Dictionary([], ObjectExpr379())
...
def Dictionary_choose(f: Callable[[_T], _U | None], d: Any) -> Any:
    ...
    nd: Any = Dictionary([], ObjectExpr380())
...
def PropertyObjectModule_getGetter(o: PropertyObject) -> Callable[[Any], Any]:
    ...
    if match_value is None:
        def _arrow381(o_1: Any=None, o: Any=o) -> Any:
...
def PropertyObjectModule_getSetter(o: PropertyObject) -> Callable[[Any, Any], None]:
    ...
    if match_value is None:
        def _arrow383(s: Any=None, o: Any=o) -> Callable[[Any], None]:
            def _arrow382(o_1: Any=None) -> None:
...
def get_static_property_objects(o: Any=None) -> Any:
    ...
    def _arrow384(__unit: None=None, o: Any=o) -> Any:
        o_1: Any = o.__class__
        return vars(o_1).items()

    return Dictionary_choose(f, _arrow384())
...
def create_remover(prop_name: str, is_static: bool) -> Callable[[Any], None]:
    if is_static:
        def _arrow385(o: Any=None, prop_name: Any=prop_name, is_static: Any=is_static) -> None:
            remove_static_property_value(o, prop_name)

        return _arrow385

    else: 
        def _arrow386(o_1: Any=None, prop_name: Any=prop_name, is_static: Any=is_static) -> None:
...
def try_get_dynamic_property_helper(o: Any, prop_name: str) -> PropertyHelper | None:
    ...
    if match_value is None:
        ...
        def _arrow387(o_1: Any=None, o: Any=o, prop_name: Any=prop_name) -> Any:
            return create_getter(prop_name, o_1)

        def _arrow388(o_2: Any=None, value: Any=None, o: Any=o, prop_name: Any=prop_name) -> None:
            create_setter(prop_name, o_2, value)

        def _arrow389(o_3: Any=None, o: Any=o, prop_name: Any=prop_name) -> None:
            delattr(o_3,prop_name)

        return PropertyHelper(prop_name, False, True, True, False, _arrow387, _arrow388, _arrow389)
...
def try_get_static_property_helper(o: Any, prop_name: str) -> PropertyHelper | None:
    ...
    if match_value is None:
        ...
        def _arrow390(o_1: Any=None, o: Any=o, prop_name: Any=prop_name) -> Any:
            return create_getter(prop_name, o_1)

        def _arrow391(o_2: Any=None, value: Any=None, o: Any=o, prop_name: Any=prop_name) -> None:
            create_setter(prop_name, o_2, value)

        def _arrow392(o_3: Any=None, o: Any=o, prop_name: Any=prop_name) -> None:
            remove_static_property_value(o_3, prop_name)

        return PropertyHelper(prop_name, True, False, is_writable, not is_writable, _arrow390, _arrow391, _arrow392)
...
def get_dynamic_property_helpers(o: Any=None) -> Array[PropertyHelper]:
    def chooser(kv: Any, o: Any=o) -> PropertyHelper | None:
        ...
        if is_transpiled_property_helper(n):
            ...
            def _arrow393(o_1: Any=None, kv: Any=kv) -> Any:
                return create_getter(n, o_1)

            def _arrow394(o_2: Any=None, value: Any=None, kv: Any=kv) -> None:
                create_setter(n, o_2, value)

            def _arrow395(o_3: Any=None, kv: Any=kv) -> None:
                delattr(o_3,n)

            return PropertyHelper(n, False, True, True, False, _arrow393, _arrow394, _arrow395)
...
def get_static_property_helpers(o: Any=None) -> Array[PropertyHelper]:
    def mapping(kv: Any, o: Any=o) -> PropertyHelper:
        ...
        def _arrow396(o_1: Any=None, kv: Any=kv) -> Any:
            return create_getter(n, o_1)

        def _arrow397(o_2: Any=None, value: Any=None, kv: Any=kv) -> None:
            create_setter(n, o_2, value)

        def _arrow398(o_3: Any=None, kv: Any=kv) -> None:
            remove_static_property_value(o_3, n)

        return PropertyHelper(n, True, False, PropertyObjectModule_isWritable(po), not PropertyObjectModule_isWritable(po), _arrow396, _arrow397, _arrow398)
