...
from ..arctrl_core.Helper.collections_ import (ResizeArray_choose, ResizeArray_isEmpty)
...
from ..fable_library.seq import (iterate_indexed, append, map, try_find, try_pick, iterate)
from ..fable_library.string_ import (to_fail, printf, to_console)
from ..fable_library.types import Array
from ..fable_library.util import (IEnumerable_1, to_enumerable, get_enumerator, IEnumerator, ignore)
...
def ArcStudy_toMetadataSheet(study: ArcStudy, assays: FSharpList[ArcAssay] | None=None) -> FsWorksheet:
    ...
    def _arrow3332(__unit: None=None, study: Any=study, assays: Any=assays) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
    ...
    iterate_indexed(action, _arrow3332())
    return sheet
...
def ArcStudy_toMetadataCollection(study: ArcStudy, assays: FSharpList[ArcAssay] | None=None) -> IEnumerable_1[IEnumerable_1[str | None]]:
    ...
    def _arrow3333(__unit: None=None, study: Any=study, assays: Any=assays) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
        source_1: IEnumerable_1[IEnumerable_1[tuple[int, str]]] = to_rows(study, assays)
        return append(to_enumerable([SparseRowModule_fromValues(to_enumerable(["STUDY"]))]), source_1)

    return map(mapping, _arrow3333())
