...
def encode(col: FsColumn) -> IEncodable:
    def _arrow3067(__unit: None=None, col: Any=col) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("number", _arrow3067()), ("cells", seq(map(mapping, col.Cells)))])
...
def _arrow3071(builder: IGetters) -> tuple[int | None, IEnumerable_1[FsCell]]:
    n: int | None
    object_arg: IOptionalGetter = builder.Optional
    n = object_arg.Field("number", int_1)
    def _arrow3070(__unit: None=None) -> IEnumerable_1[FsCell] | None:
    ...
    return (n, default_arg(_arrow3070(), empty()))


decode: Decoder_1[tuple[int | None, IEnumerable_1[FsCell]]] = object(_arrow3071)
