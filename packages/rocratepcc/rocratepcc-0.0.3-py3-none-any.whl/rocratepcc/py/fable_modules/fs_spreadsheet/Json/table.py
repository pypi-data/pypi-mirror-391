...
def encode(sheet: FsTable) -> IEncodable:
    def _arrow3073(__unit: None=None, sheet: Any=sheet) -> IEncodable:
    ...
    def _arrow3075(__unit: None=None, sheet: Any=sheet) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("name", _arrow3073()), ("range", _arrow3075())])
...
def _arrow3077(builder: IGetters) -> FsTable:
    n: str
...
decode: Decoder_1[FsTable] = object(_arrow3077)
