...
from ...arctrl_json.workflow import (decoder as decoder_1, encoder, decoder_compressed, encoder_compressed)
...
def ARCtrl_ArcWorkflow__ArcWorkflow_toJsonString_Static_71136F3F(spaces: int | None=None) -> Callable[[ArcWorkflow], str]:
    def _arrow3799(obj: ArcWorkflow, spaces: Any=spaces) -> str:
