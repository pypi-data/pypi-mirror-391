...
class FactorValue(Record):
    ...
    def PrintCompact(self, __unit: None=None) -> str:
        ...
        def _arrow117(__unit: None=None) -> str:
            value_2: str = value
            return value_2

        def _arrow118(__unit: None=None) -> str:
        ...
        return ("" if (value is None) else _arrow117()) if (category is None) else (_arrow118() if (value is None) else _arrow119())
...
FactorValue_reflection = _expr120
...
def FactorValue__SetCategory_ZDED3A0F(this: FactorValue, c: OntologyAnnotation) -> FactorValue:
    def _arrow121(__unit: None=None, this: Any=this, c: Any=c) -> Factor | None:
    ...
    return FactorValue(this.ID, _arrow121(), this.Value, this.Unit)
