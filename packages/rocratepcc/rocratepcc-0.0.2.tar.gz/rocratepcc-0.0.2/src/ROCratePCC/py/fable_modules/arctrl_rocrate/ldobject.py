...
from ..dynamic_obj.hash_codes import merge_hashes
from ..dynamic_obj.property_helper import PropertyHelper
from ..fable_library.map_util import (get_item_from_dict, try_get_value, add_to_dict)
from ..fable_library.option import (default_arg, value as value_3, some, map)
from ..fable_library.reflection import (TypeInfo, class_type)
from ..fable_library.seq import (iterate, filter as filter_2, choose, exists, to_list, delay, enumerate_while, singleton as singleton_2, empty, try_find, map as map_1, enumerate_from_functions, append, collect)
from ..fable_library.seq2 import List_distinctBy
from ..fable_library.string_ import starts_with_exact
from ..fable_library.types import (Array, FSharpRef)
from ..fable_library.util import (is_iterable, IEnumerable, equals, identity_hash, string_hash, IEnumerable_1, get_enumerator, IEnumerator, curry2, ignore, structural_hash, is_array_like)
...
class LDGraph(DynamicObj):
    ...
    def TryGetNode(self, id: str) -> LDNode | None:
        ...
        out_arg: LDNode = None
        def _arrow924(__unit: None=None) -> LDNode:
            return out_arg

        def _arrow925(v: LDNode) -> None:
            nonlocal out_arg
            out_arg = v

        match_value = (try_get_value(this.mappings, id, FSharpRef(_arrow924, _arrow925)), out_arg)
    ...
    def set_context(context: LDContext) -> Callable[[__G], None]:
        def _arrow926(roc: __G | None=None) -> None:
    ...
    def try_get_context(__unit: None=None) -> Callable[[__F], LDContext | None]:
        def _arrow927(roc: __F | None=None) -> LDContext | None:
...
class LDNode(DynamicObj):
    ...
    def GetPropertyValues(self, property_name: str, filter: Callable[[Any, LDContext | None], bool] | None=None, context: LDContext | None=None) -> Array[Any]:
        this: LDNode = self
        def _arrow930(_arg: Any=None) -> Callable[[LDContext | None], bool]:
            def _arrow929(_arg_1: LDContext | None=None) -> bool:
                return True

            return _arrow929

        filter_1: Callable[[Any, LDContext | None], bool] = default_arg(map(curry2, filter), _arrow930)
        match_value: Any | None = this.TryGetProperty(property_name, context)
        ...
        if pattern_matching_result == 0:
            ...
            en: IEnumerator[Any] = get_enumerator(e)
            def _arrow933(__unit: None=None) -> IEnumerable_1[Any]:
                def _arrow931(__unit: None=None) -> bool:
                    return en.System_Collections_IEnumerator_MoveNext()

                def _arrow932(__unit: None=None) -> IEnumerable_1[Any]:
                ...
                return enumerate_while(_arrow931, delay(_arrow932))

            return list(to_list(delay(_arrow933)))
    ...
    def TryGetPropertyAsSingleNode(self, property_name: str, graph: LDGraph | None=None, context: LDContext | None=None) -> LDNode | None:
        ...
        if match_value is not None:
            if isinstance(value_3(match_value), LDNode):
                ...
                def _arrow934(__unit: None=None) -> bool:
            ...
            if pattern_matching_result == 0:
                ...
                if match_value is None:
                    ...
                    if filter is None:
                        ...
                        def _arrow935(f: Callable[[LDNode, LDContext | None], bool], o: Any=o) -> Callable[[LDNode, LDContext | None], bool]:
                            return curry2(f)

                        f_1: Callable[[LDNode, LDContext | None], bool] = map(_arrow935, filter)
                        return n
                ...
                if filter is None:
                    ...
                    def _arrow936(f: Callable[[LDNode, LDContext | None], bool], o: Any=o) -> Callable[[LDNode, LDContext | None], bool]:
                        return curry2(f)

                    f_3: Callable[[LDNode, LDContext | None], bool] = map(_arrow936, filter)
                    return n_1
    ...
    def HasProperty(self, property_name: str, context: LDContext | None=None) -> bool:
        ...
        def _arrow937(__unit: None=None) -> bool:
            v_2: Any = value_3(v)
            return False

        def _arrow938(__unit: None=None) -> bool:
            e: IEnumerable[Any] = value_3(v)
            return get_enumerator(e).System_Collections_IEnumerator_MoveNext()

        return (_arrow937() if equals(value_3(v), None) else (_arrow938() if is_iterable(value_3(v)) else True)) if (v is not None) else False
    ...
    def set_context(context: LDContext) -> Callable[[__C], None]:
        def _arrow939(roc: __C | None=None) -> None:
            roc.SetContext(context)
    ...
    def try_get_context(__unit: None=None) -> Callable[[__B], LDContext | None]:
        def _arrow940(roc: __B | None=None) -> LDContext | None:
            return roc.TryGetContext()
    ...
    def MergeAppendInto_InPlace(self, other: LDNode, flatten_to: LDGraph | None=None) -> None:
        ...
        if flatten_to is None:
            def _arrow941(x: Any=None) -> Any:
                return x

            flatten_to_singleton = _arrow941
        ...
        if flatten_to is None:
            def _arrow942(x_1: Array[Any]) -> Array[Any]:
                return x_1

            flatten_to_ra = _arrow942

        else: 
            graph_1: LDGraph = flatten_to
            def _arrow943(a: Array[Any]) -> Array[Any]:
                return ResizeArray_map(flatten_to_singleton, a)

            flatten_to_ra = _arrow943

        flatten_to_any: Callable[[Any], Any]
        if flatten_to is None:
            def _arrow944(x_2: Any=None) -> Any:
                return x_2

            flatten_to_any = _arrow944
            ...
            def f_2(o_1: Any=None) -> Any:
                if isinstance(o_1, LDNode):
                    ...
                    if active_pattern_result is not None:
                        ...
                        def _arrow948(__unit: None=None, o_1: Any=o_1) -> IEnumerable_1[Any]:
                            def _arrow945(__unit: None=None) -> IEnumerator[Any]:
                                return get_enumerator(e)

                            def _arrow946(enumerator: IEnumerator[Any]) -> bool:
                                return enumerator.System_Collections_IEnumerator_MoveNext()

                            def _arrow947(enumerator_1: IEnumerator[Any]) -> Any:
                                return enumerator_1.System_Collections_IEnumerator_get_Current()

                            return map_1(f_2, enumerate_from_functions(_arrow945, _arrow946, _arrow947))

                        return list(to_list(delay(_arrow948)))
        ...
        def action(pn: str) -> None:
            ...
            if match_value is None:
                ...
                if pattern_matching_result == 0:
                    def _arrow958(__unit: None=None, pn: Any=pn) -> IEnumerable_1[Any]:
                        def _arrow949(v_1: Any=None) -> Any:
                            return v_1

                        def _arrow950(__unit: None=None) -> IEnumerator[Any]:
                            return get_enumerator(e2)

                        def _arrow951(enumerator_2: IEnumerator[Any]) -> bool:
                            return enumerator_2.System_Collections_IEnumerator_MoveNext()

                        def _arrow952(enumerator_3: IEnumerator[Any]) -> Any:
                            return enumerator_3.System_Collections_IEnumerator_get_Current()

                        def _arrow957(__unit: None=None) -> IEnumerable_1[Any]:
                            def _arrow953(v_2: Any=None) -> Any:
                                return v_2

                            def _arrow954(__unit: None=None) -> IEnumerator[Any]:
                                return get_enumerator(e1)

                            def _arrow955(enumerator_4: IEnumerator[Any]) -> bool:
                                return enumerator_4.System_Collections_IEnumerator_MoveNext()

                            def _arrow956(enumerator_5: IEnumerator[Any]) -> Any:
                                return enumerator_5.System_Collections_IEnumerator_get_Current()

                            return map_1(_arrow953, enumerate_from_functions(_arrow954, _arrow955, _arrow956))

                        return append(map_1(_arrow949, enumerate_from_functions(_arrow950, _arrow951, _arrow952)), delay(_arrow957))
                    ...
                    l: Array[Any] = flatten_to_ra(list(List_distinctBy(to_equalitor, to_list(delay(_arrow958)), ObjectExpr959())))
                    ...
                    if active_pattern_result_3 is not None:
                        ...
                        def _arrow964(__unit: None=None, pn: Any=pn) -> IEnumerable_1[Any]:
                            def _arrow960(this_val_1: Any=None) -> IEnumerable_1[Any]:
                            ...
                            def _arrow961(__unit: None=None) -> IEnumerator[Any]:
                                return get_enumerator(these_vals)

                            def _arrow962(enumerator_6: IEnumerator[Any]) -> bool:
                                return enumerator_6.System_Collections_IEnumerator_MoveNext()

                            def _arrow963(enumerator_7: IEnumerator[Any]) -> Any:
                                return enumerator_7.System_Collections_IEnumerator_get_Current()

                            return collect(_arrow960, enumerate_from_functions(_arrow961, _arrow962, _arrow963))

                        l_1: Array[Any] = list(to_list(delay(_arrow964)))
                        if not is_contained:
                        ...
                        if active_pattern_result_4 is not None:
                            ...
                            def _arrow971(__unit: None=None, pn: Any=pn) -> IEnumerable_1[Any]:
                                def _arrow967(other_val_2: Any=None) -> IEnumerable_1[Any]:
                                    def _expr965():
                                        nonlocal is_contained_1
                                        is_contained_1 = True
                                        return empty()

                                    def _arrow966(__unit: None=None) -> IEnumerable_1[Any]:
                                        return singleton_2(other_val_2)

                                    return append(_expr965() if equals(to_equalitor(this_val), to_equalitor(other_val_2)) else empty(), delay(_arrow966))

                                def _arrow968(__unit: None=None) -> IEnumerator[Any]:
                                    return get_enumerator(other_vals)

                                def _arrow969(enumerator_8: IEnumerator[Any]) -> bool:
                                    return enumerator_8.System_Collections_IEnumerator_MoveNext()

                                def _arrow970(enumerator_9: IEnumerator[Any]) -> Any:
                                    return enumerator_9.System_Collections_IEnumerator_get_Current()

                                return collect(_arrow967, enumerate_from_functions(_arrow968, _arrow969, _arrow970))

                            l_2: Array[Any] = list(to_list(delay(_arrow971)))
    ...
    def Compact_InPlace(self, context: LDContext | None=None, set_context: bool | None=None) -> None:
        ...
        if context_1 is not None:
            ...
            def _arrow973(__unit: None=None) -> IEnumerable_1[str]:
                def _arrow972(st: str) -> IEnumerable_1[str]:
                    match_value: str | None = context_2.TryGetTerm(st)
                    return singleton_2(st) if (match_value is None) else singleton_2(match_value)

                return collect(_arrow972, this.SchemaType)

            new_types: Array[str] = list(to_list(delay(_arrow973)))
        ...
        def compact_value_in_place(o: Any=None) -> Any:
            ...
            if pattern_matching_result == 0:
                ...
                en: IEnumerator[Any] = get_enumerator(e)
                def _arrow976(__unit: None=None, o: Any=o) -> IEnumerable_1[Any]:
                    def _arrow974(__unit: None=None) -> bool:
                        return en.System_Collections_IEnumerator_MoveNext()

                    def _arrow975(__unit: None=None) -> IEnumerable_1[Any]:
                        return singleton_2(compact_value_in_place(en.System_Collections_IEnumerator_get_Current()))

                    return enumerate_while(_arrow974, delay(_arrow975))

                l: Array[Any] = list(to_list(delay(_arrow976)))
                if len(l) == 1:
                    return l[0]
    ...
    def Flatten(self, graph: LDGraph | None=None) -> LDGraph:
        ...
        def flatten_value(o: Any=None) -> Any:
            if isinstance(o, LDNode):
                ...
                def _arrow979(__unit: None=None, o: Any=o) -> IEnumerable_1[Any]:
                    def _arrow977(__unit: None=None) -> bool:
                        return en.System_Collections_IEnumerator_MoveNext()

                    def _arrow978(__unit: None=None) -> IEnumerable_1[Any]:
                        return singleton_2(flatten_value(en.System_Collections_IEnumerator_get_Current()))

                    return enumerate_while(_arrow977, delay(_arrow978))

                return list(to_list(delay(_arrow979)))
    ...
    def Unflatten(self, graph: LDGraph) -> None:
        ...
        def unflatten_value(o: Any=None) -> Any:
            if isinstance(o, LDRef):
                ...
                en: IEnumerator[Any] = get_enumerator(o)
                def _arrow982(__unit: None=None, o: Any=o) -> IEnumerable_1[Any]:
                    def _arrow980(__unit: None=None) -> bool:
                        return en.System_Collections_IEnumerator_MoveNext()

                    def _arrow981(__unit: None=None) -> IEnumerable_1[Any]:
                        return singleton_2(unflatten_value(en.System_Collections_IEnumerator_get_Current()))

                    return enumerate_while(_arrow980, delay(_arrow981))

                return list(to_list(delay(_arrow982)))
    ...
    def remove_context(__unit: None=None) -> Callable[[__A], bool]:
        def _arrow983(roc: __A | None=None) -> bool:
    ...
    def try_from_dynamic_obj(dyn_obj: DynamicObj) -> LDNode | None:
        ...
        if pattern_matching_result_1 == 0:
            def _arrow984(__unit: None=None) -> Array[str] | None:
            ...
            roc: LDNode = LDNode(id, st, _arrow984())
