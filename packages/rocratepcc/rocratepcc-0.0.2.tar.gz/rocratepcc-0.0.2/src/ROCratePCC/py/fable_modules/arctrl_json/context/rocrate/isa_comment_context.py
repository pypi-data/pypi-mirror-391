...
IContext_reflection = _expr1108

def _arrow1114(__unit: None=None) -> IEncodable:
    class ObjectExpr1109(IEncodable):
        def Encode(self, helpers: IEncoderHelpers_1[Any]) -> Any:
            return helpers.encode_string("http://schema.org/")

    class ObjectExpr1110(IEncodable):
        def Encode(self, helpers_1: IEncoderHelpers_1[Any]) -> Any:
            return helpers_1.encode_string("sdo:Comment")

    class ObjectExpr1111(IEncodable):
        def Encode(self, helpers_2: IEncoderHelpers_1[Any]) -> Any:
            return helpers_2.encode_string("sdo:name")

    class ObjectExpr1112(IEncodable):
        def Encode(self, helpers_3: IEncoderHelpers_1[Any]) -> Any:
            return helpers_3.encode_string("sdo:text")

    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1109()), ("Comment", ObjectExpr1110()), ("name", ObjectExpr1111()), ("value", ObjectExpr1112())])
    class ObjectExpr1113(IEncodable):
    ...
    return ObjectExpr1113()


context_jsonvalue: IEncodable = _arrow1114()
