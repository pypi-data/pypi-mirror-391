...
def ROCrate_encoder(oa: Material) -> IEncodable:
    ...
    def _arrow2047(__unit: None=None, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2051(value_3: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2052(value_5: MaterialType, oa: Any=oa) -> IEncodable:
        return ROCrate_encoder_1(value_5)

    def _arrow2053(oa_1: Material, oa: Any=oa) -> IEncodable:
        return ROCrate_encoder(oa_1)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow2047()), ("@type", list_1_1(singleton(ObjectExpr2048()))), ("additionalType", ObjectExpr2049()), try_include("name", _arrow2051, oa.Name), try_include("type", _arrow2052, oa.MaterialType), try_include_list_opt("characteristics", ROCrate_encoder_2, oa.Characteristics), try_include_list_opt("derivesFrom", _arrow2053, oa.DerivesFrom), ("@context", context_jsonvalue)]))
...
def _arrow2061(__unit: None=None) -> Decoder_1[Material]:
    def decode(__unit: None=None) -> Decoder_1[Material]:
        def _arrow2060(get: IGetters) -> Material:
            ...
            def _arrow2057(__unit: None=None) -> MaterialType | None:
                object_arg_4: IOptionalGetter = get.Optional
                return object_arg_4.Field("type", ROCrate_decoder_1)

            def _arrow2058(__unit: None=None) -> FSharpList[MaterialAttributeValue] | None:
            ...
            def _arrow2059(__unit: None=None) -> FSharpList[Material] | None:
                arg_13: Decoder_1[FSharpList[Material]] = list_1_2(decode(None))
                object_arg_6: IOptionalGetter = get.Optional
                return object_arg_6.Field("derivesFrom", arg_13)

            return Material(_arrow2055(), _arrow2056(), _arrow2057(), _arrow2058(), _arrow2059())

        return object(_arrow2060)

    return decode(None)


ROCrate_decoder: Decoder_1[Material] = _arrow2061()
...
def ISAJson_encoder(id_map: Any | None, c: Material) -> IEncodable:
    def f(oa: Material, id_map: Any=id_map, c: Any=c) -> IEncodable:
        ...
        def _arrow2065(value: str, oa: Any=oa) -> IEncodable:
        ...
        def _arrow2067(value_2: str, oa: Any=oa) -> IEncodable:
        ...
        def _arrow2068(oa_1: MaterialAttributeValue, oa: Any=oa) -> IEncodable:
            return ISAJson_encoder_2(id_map, oa_1)

        def _arrow2069(c_1: Material, oa: Any=oa) -> IEncodable:
            return ISAJson_encoder(id_map, c_1)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@id", _arrow2065, ROCrate_genID(oa)), try_include("name", _arrow2067, oa.Name), try_include("type", ISAJson_encoder_1, oa.MaterialType), try_include_list_opt("characteristics", _arrow2068, oa.Characteristics), try_include_list_opt("derivesFrom", _arrow2069, oa.DerivesFrom)]))
    ...
    if id_map is not None:
        def _arrow2071(m_1: Material, id_map: Any=id_map, c: Any=c) -> str:
            return ROCrate_genID(m_1)

        return encode(_arrow2071, f, c, id_map)
...
def _arrow2078(__unit: None=None) -> Decoder_1[Material]:
    def decode(__unit: None=None) -> Decoder_1[Material]:
        def _arrow2077(get: IGetters) -> Material:
            ...
            def _arrow2074(__unit: None=None) -> MaterialType | None:
                object_arg_2: IOptionalGetter = get.Optional
                return object_arg_2.Field("type", ISAJson_decoder_1)

            def _arrow2075(__unit: None=None) -> FSharpList[MaterialAttributeValue] | None:
            ...
            def _arrow2076(__unit: None=None) -> FSharpList[Material] | None:
                arg_9: Decoder_1[FSharpList[Material]] = list_1_2(decode(None))
                object_arg_4: IOptionalGetter = get.Optional
                return object_arg_4.Field("derivesFrom", arg_9)

            return Material(_arrow2072(), _arrow2073(), _arrow2074(), _arrow2075(), _arrow2076())

        return Decode_objectNoAdditionalProperties(ISAJson_allowedFields, _arrow2077)

    return decode(None)


ISAJson_decoder: Decoder_1[Material] = _arrow2078()
