...
def encode_rows(no_numbering: bool, wb: FsWorkbook) -> IEncodable:
    ...
    return ObjectExpr3079()


def _arrow3080(builder: IGetters) -> FsWorkbook:
...
decode_rows: Decoder_1[FsWorkbook] = object(_arrow3080)
...
def _arrow3082(builder: IGetters) -> FsWorkbook:
    wb: FsWorkbook = FsWorkbook()
    ws: IEnumerable_1[FsWorksheet]
...
decode_columns: Decoder_1[FsWorkbook] = object(_arrow3082)
