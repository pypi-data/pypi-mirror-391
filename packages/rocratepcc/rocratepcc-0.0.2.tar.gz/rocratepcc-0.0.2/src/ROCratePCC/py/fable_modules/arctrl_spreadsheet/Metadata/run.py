...
from ...arctrl_core.Helper.identifier import (create_missing_identifier, Assay_tryIdentifierFromFileName, Run_fileNameFromIdentifier)
from ...arctrl_core.ontology_annotation import OntologyAnnotation
from ...fable_library.list import (of_array, FSharpList, map as map_1, empty, cons, reverse)
...
from ...fable_library.string_ import (starts_with_exact, join)
...
def to_sparse_table(run: ArcRun) -> SparseTable:
    ...
    class ObjectExpr3182:
        @property
        def Equals(self) -> Callable[[str, str], bool]:
            def _arrow3181(x: str, y: str) -> bool:
                return x == y
    ...
    return SparseTable(matrix.Matrix, matrix.Keys, reverse(List_distinct(comment_keys, ObjectExpr3182())), matrix.ColumnCount)
