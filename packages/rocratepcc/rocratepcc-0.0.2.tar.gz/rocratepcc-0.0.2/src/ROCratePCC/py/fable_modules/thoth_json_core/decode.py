...
class ObjectExpr820(Decoder_1[str]):
...
string: Decoder_1[str] = ObjectExpr820()

class ObjectExpr821(Decoder_1[str]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_1: Any) -> FSharpResult_2[str, tuple[str, ErrorReason_1[__A_]]]:
...
char: Decoder_1[str] = ObjectExpr821()

class ObjectExpr824(Decoder_1[str]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_1: Any) -> FSharpResult_2[str, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_string(value_1):
            match_value: tuple[bool, str]
            out_arg: str = "00000000-0000-0000-0000-000000000000"
            def _arrow822(__unit: None=None) -> str:
                return out_arg

            def _arrow823(v: str) -> None:
                nonlocal out_arg
                out_arg = v

            match_value = (try_parse_1(helpers.as_string(value_1), FSharpRef(_arrow822, _arrow823)), out_arg)
...
guid: Decoder_1[str] = ObjectExpr824()

class ObjectExpr826(Decoder_1[None]):
...
unit: Decoder_1[None] = ObjectExpr826()

class ObjectExpr833(Decoder_1[int8]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_2: Any) -> FSharpResult_2[int8, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_2):
            ...
            def _arrow827(__unit: None=None) -> int8:
                return out_arg

            def _arrow828(v: int8) -> None:
                nonlocal out_arg
                out_arg = v or 0

            match_value = (try_parse_2(helpers.as_string(value_2), 511, False, 8, FSharpRef(_arrow827, _arrow828)), out_arg)
...
sbyte: Decoder_1[int8] = ObjectExpr833()

class ObjectExpr842(Decoder_1[uint8]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_2: Any) -> FSharpResult_2[uint8, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_2):
            ...
            def _arrow840(__unit: None=None) -> uint8:
                return out_arg

            def _arrow841(v: uint8) -> None:
                nonlocal out_arg
                out_arg = v

            match_value = (try_parse_2(helpers.as_string(value_2), 511, True, 8, FSharpRef(_arrow840, _arrow841)), out_arg)
...
byte: Decoder_1[uint8] = ObjectExpr842()
