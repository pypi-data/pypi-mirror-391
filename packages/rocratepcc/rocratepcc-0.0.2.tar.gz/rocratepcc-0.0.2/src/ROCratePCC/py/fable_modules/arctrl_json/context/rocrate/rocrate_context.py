...
def _arrow1357(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1350()), ("arc", ObjectExpr1352()), ("CreativeWork", ObjectExpr1353()), ("about", ObjectExpr1354()), ("conformsTo", ObjectExpr1355())])
