...
def encoder(assay: ArcAssay) -> IEncodable:
    ...
    def _arrow2380(__unit: None=None, assay: Any=assay) -> IEncodable:
    ...
    def _arrow2382(value_1: str, assay: Any=assay) -> IEncodable:
    ...
    def _arrow2384(value_3: str, assay: Any=assay) -> IEncodable:
    ...
    def _arrow2385(oa: OntologyAnnotation, assay: Any=assay) -> IEncodable:
        return OntologyAnnotation_encoder(oa)

    def _arrow2386(oa_1: OntologyAnnotation, assay: Any=assay) -> IEncodable:
        return OntologyAnnotation_encoder(oa_1)

    def _arrow2387(oa_2: OntologyAnnotation, assay: Any=assay) -> IEncodable:
        return OntologyAnnotation_encoder(oa_2)

    def _arrow2388(dm: DataMap, assay: Any=assay) -> IEncodable:
        return encoder_4(dm)

    def _arrow2389(table: ArcTable, assay: Any=assay) -> IEncodable:
        return encoder_5(table)

    def _arrow2390(person: Person, assay: Any=assay) -> IEncodable:
        return encoder_6(person)

    def _arrow2391(comment: Comment, assay: Any=assay) -> IEncodable:
        return encoder_7(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("Identifier", _arrow2380()), try_include("Title", _arrow2382, assay.Title), try_include("Description", _arrow2384, assay.Description), try_include("MeasurementType", _arrow2385, assay.MeasurementType), try_include("TechnologyType", _arrow2386, assay.TechnologyType), try_include("TechnologyPlatform", _arrow2387, assay.TechnologyPlatform), try_include("DataMap", _arrow2388, assay.DataMap), try_include_seq("Tables", _arrow2389, assay.Tables), try_include_seq("Performers", _arrow2390, assay.Performers), try_include_seq("Comments", _arrow2391, assay.Comments)]))
...
def _arrow2403(get: IGetters) -> ArcAssay:
    def _arrow2393(__unit: None=None) -> str:
...
def encoder_compressed(string_table: Any, oa_table: Any, cell_table: Any, assay: ArcAssay) -> IEncodable:
    ...
    def _arrow2407(__unit: None=None, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, assay: Any=assay) -> IEncodable:
        value: str = assay.Identifier
    ...
    def _arrow2409(value_1: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, assay: Any=assay) -> IEncodable:
    ...
    def _arrow2411(value_3: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, assay: Any=assay) -> IEncodable:
    ...
    def _arrow2412(oa: OntologyAnnotation, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, assay: Any=assay) -> IEncodable:
        return OntologyAnnotation_encoder(oa)

    def _arrow2413(oa_1: OntologyAnnotation, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, assay: Any=assay) -> IEncodable:
        return OntologyAnnotation_encoder(oa_1)

    def _arrow2414(oa_2: OntologyAnnotation, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, assay: Any=assay) -> IEncodable:
        return OntologyAnnotation_encoder(oa_2)

    def _arrow2415(table: ArcTable, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, assay: Any=assay) -> IEncodable:
        return encoder_compressed_1(string_table, oa_table, cell_table, table)

    def _arrow2416(dm: DataMap, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, assay: Any=assay) -> IEncodable:
        return encoder_compressed_2(string_table, oa_table, cell_table, dm)

    def _arrow2417(person: Person, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, assay: Any=assay) -> IEncodable:
        return encoder_6(person)

    def _arrow2418(comment: Comment, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, assay: Any=assay) -> IEncodable:
        return encoder_7(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("Identifier", _arrow2407()), try_include("Title", _arrow2409, assay.Title), try_include("Description", _arrow2411, assay.Description), try_include("MeasurementType", _arrow2412, assay.MeasurementType), try_include("TechnologyType", _arrow2413, assay.TechnologyType), try_include("TechnologyPlatform", _arrow2414, assay.TechnologyPlatform), try_include_seq("Tables", _arrow2415, assay.Tables), try_include("DataMap", _arrow2416, assay.DataMap), try_include_seq("Performers", _arrow2417, assay.Performers), try_include_seq("Comments", _arrow2418, assay.Comments)]))
...
def decoder_compressed(string_table: Array[str], oa_table: Array[OntologyAnnotation], cell_table: Array[CompositeCell]) -> Decoder_1[ArcAssay]:
    def _arrow2430(get: IGetters, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table) -> ArcAssay:
        def _arrow2420(__unit: None=None) -> str:
            object_arg: IRequiredGetter = get.Required
            return object_arg.Field("Identifier", string)
        ...
        def _arrow2425(__unit: None=None) -> OntologyAnnotation | None:
            object_arg_5: IOptionalGetter = get.Optional
            return object_arg_5.Field("TechnologyPlatform", OntologyAnnotation_decoder)

        def _arrow2426(__unit: None=None) -> Array[ArcTable] | None:
            arg_13: Decoder_1[Array[ArcTable]] = resize_array(decoder_compressed_1(string_table, oa_table, cell_table))
            object_arg_6: IOptionalGetter = get.Optional
            return object_arg_6.Field("Tables", arg_13)

        def _arrow2427(__unit: None=None) -> DataMap | None:
            arg_15: Decoder_1[DataMap] = decoder_compressed_2(string_table, oa_table, cell_table)
            object_arg_7: IOptionalGetter = get.Optional
            return object_arg_7.Field("DataMap", arg_15)

        def _arrow2428(__unit: None=None) -> Array[Person] | None:
            arg_17: Decoder_1[Array[Person]] = resize_array(decoder_3)
            object_arg_8: IOptionalGetter = get.Optional
            return object_arg_8.Field("Performers", arg_17)

        def _arrow2429(__unit: None=None) -> Array[Comment] | None:
            arg_19: Decoder_1[Array[Comment]] = resize_array(decoder_4)
            object_arg_9: IOptionalGetter = get.Optional
            return object_arg_9.Field("Comments", arg_19)

        return ArcAssay.create(_arrow2420(), _arrow2421(), _arrow2422(), _arrow2423(), _arrow2424(), _arrow2425(), _arrow2426(), _arrow2427(), _arrow2428(), _arrow2429())

    return object(_arrow2430)
...
def ROCrate_encoder(assay_name: str | None, a: ArcAssay) -> IEncodable:
    ...
    def _arrow2434(__unit: None=None, assay_name: Any=assay_name, a: Any=a) -> IEncodable:
    ...
    def _arrow2438(__unit: None=None, assay_name: Any=assay_name, a: Any=a) -> IEncodable:
    ...
    def _arrow2441(value_5: str, assay_name: Any=assay_name, a: Any=a) -> IEncodable:
    ...
    def _arrow2443(value_7: str, assay_name: Any=assay_name, a: Any=a) -> IEncodable:
    ...
    def _arrow2444(oa: OntologyAnnotation, assay_name: Any=assay_name, a: Any=a) -> IEncodable:
        return OntologyAnnotation_ROCrate_encoderPropertyValue(oa)

    def _arrow2445(oa_1: OntologyAnnotation, assay_name: Any=assay_name, a: Any=a) -> IEncodable:
        return OntologyAnnotation_ROCrate_encoderDefinedTerm(oa_1)

    def _arrow2446(oa_2: OntologyAnnotation, assay_name: Any=assay_name, a: Any=a) -> IEncodable:
        return OntologyAnnotation_ROCrate_encoderDefinedTerm(oa_2)

    def _arrow2447(oa_3: Person, assay_name: Any=assay_name, a: Any=a) -> IEncodable:
        return ROCrate_encoder_1(oa_3)

    def _arrow2448(oa_4: Data, assay_name: Any=assay_name, a: Any=a) -> IEncodable:
        return ROCrate_encoder_2(oa_4)

    def _arrow2450(__unit: None=None, assay_name: Any=assay_name, a: Any=a) -> Callable[[Process], IEncodable]:
        assay_name_1: str | None = a.Identifier
        def _arrow2449(oa_5: Process) -> IEncodable:
            return ROCrate_encoder_3(assay_name, assay_name_1, oa_5)

        return _arrow2449

    def _arrow2451(comment: Comment, assay_name: Any=assay_name, a: Any=a) -> IEncodable:
        return ROCrate_encoder_4(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow2434()), ("@type", list_1_1(singleton(ObjectExpr2435()))), ("additionalType", ObjectExpr2436()), ("identifier", _arrow2438()), ("filename", ObjectExpr2439()), try_include("title", _arrow2441, a.Title), try_include("description", _arrow2443, a.Description), try_include("measurementType", _arrow2444, a.MeasurementType), try_include("technologyType", _arrow2445, a.TechnologyType), try_include("technologyPlatform", _arrow2446, a.TechnologyPlatform), try_include_seq("performers", _arrow2447, a.Performers), try_include_list("dataFiles", _arrow2448, data_files), try_include_list("processSequence", _arrow2450(), processes), try_include_seq("comments", _arrow2451, a.Comments), ("@context", context_jsonvalue)]))
    class ObjectExpr2452(IEncodable):
    ...
    return ObjectExpr2452()


def _arrow2462(get: IGetters) -> ArcAssay:
    def _arrow2453(__unit: None=None) -> str | None:
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("identifier", string)

    identifier: str = default_arg(_arrow2453(), create_missing_identifier())
    ...
    def _arrow2459(__unit: None=None) -> OntologyAnnotation | None:
        object_arg_6: IOptionalGetter = get.Optional
        return object_arg_6.Field("technologyPlatform", OntologyAnnotation_ROCrate_decoderDefinedTerm)

    def _arrow2460(__unit: None=None) -> Array[Person] | None:
        arg_16: Decoder_1[Array[Person]] = resize_array(ROCrate_decoder_2)
        object_arg_7: IOptionalGetter = get.Optional
        return object_arg_7.Field("performers", arg_16)

    def _arrow2461(__unit: None=None) -> Array[Comment] | None:
        arg_18: Decoder_1[Array[Comment]] = resize_array(ROCrate_decoder_3)
        object_arg_8: IOptionalGetter = get.Optional
        return object_arg_8.Field("comments", arg_18)

    return ArcAssay(identifier, _arrow2455(), _arrow2456(), _arrow2457(), _arrow2458(), _arrow2459(), tables, None, _arrow2460(), _arrow2461())


ROCrate_decoder: Decoder_1[ArcAssay] = object(_arrow2462)
...
def ISAJson_encoder(study_name: str | None, id_map: Any | None, a: ArcAssay) -> IEncodable:
    def f(a_1: ArcAssay, study_name: Any=study_name, id_map: Any=id_map, a: Any=a) -> IEncodable:
        ...
        def _arrow2463(ps: FSharpList[Process], a_1: Any=a_1) -> IEncodable:
            return encoder_9(id_map, ps)

        encoded_materials: tuple[str, IEncodable | None] = try_include("materials", _arrow2463, Option_fromValueWithDefault(empty(), processes))
        ...
        def _arrow2466(__unit: None=None, a_1: Any=a_1) -> IEnumerable_1[Comment]:
            def _arrow2465(__unit: None=None) -> IEnumerable_1[Comment]:
                ...
                return append(singleton_1(Comment.create("title", value_9(a_1.Title))) if (a_1.Title is not None) else empty_1(), delay(_arrow2464))

            return append(a_1.Comments if (len(a_1.Comments) > 0) else empty_1(), delay(_arrow2465))

        comments: FSharpList[Comment] = to_list(delay(_arrow2466))
        ...
        def _arrow2470(value_5: str, a_1: Any=a_1) -> IEncodable:
        ...
        def _arrow2471(oa_2: OntologyAnnotation, a_1: Any=a_1) -> IEncodable:
            return OntologyAnnotation_ISAJson_encoder(id_map, oa_2)

        def _arrow2472(oa_3: OntologyAnnotation, a_1: Any=a_1) -> IEncodable:
            return OntologyAnnotation_ISAJson_encoder(id_map, oa_3)

        def _arrow2474(value_7: str, a_1: Any=a_1) -> IEncodable:
        ...
        def _arrow2476(__unit: None=None, a_1: Any=a_1) -> Callable[[Process], IEncodable]:
            assay_name: str | None = a_1.Identifier
            def _arrow2475(oa_4: Process) -> IEncodable:
                return ISAJson_encoder_2(study_name, assay_name, id_map, oa_4)

            return _arrow2475

        def _arrow2477(comment: Comment, a_1: Any=a_1) -> IEncodable:
            return ISAJson_encoder_3(id_map, comment)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("filename", ObjectExpr2468()), try_include("@id", _arrow2470, ROCrate_genID(a_1)), try_include("measurementType", _arrow2471, a_1.MeasurementType), try_include("technologyType", _arrow2472, a_1.TechnologyType), try_include("technologyPlatform", _arrow2474, map(mapping, a_1.TechnologyPlatform)), encoced_data_files, encoded_materials, encoded_characteristics, encoded_units, try_include_list("processSequence", _arrow2476(), processes), try_include_seq("comments", _arrow2477, comments)]))
    ...
    if id_map is not None:
        def _arrow2479(a_2: ArcAssay, study_name: Any=study_name, id_map: Any=id_map, a: Any=a) -> str:
            return ROCrate_genID(a_2)

        return encode(_arrow2479, f, a, id_map)
...
def _arrow2485(get: IGetters) -> ArcAssay:
    def _arrow2480(__unit: None=None) -> str | None:
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("filename", string)

    identifier: str = default_arg(bind(Assay_tryIdentifierFromFileName, _arrow2480()), create_missing_identifier())
    def mapping(arg_4: FSharpList[Process]) -> Array[ArcTable]:
        a: ArcTables = ARCtrl_ArcTables__ArcTables_fromProcesses_Static_62A3309D(arg_4)
        return a.Tables

    def _arrow2481(__unit: None=None) -> FSharpList[Process] | None:
        arg_3: Decoder_1[FSharpList[Process]] = list_1_2(ISAJson_decoder_1)
        object_arg_1: IOptionalGetter = get.Optional
        return object_arg_1.Field("processSequence", arg_3)

    tables: Array[ArcTable] | None = map(mapping, _arrow2481())
    ...
    def _arrow2484(__unit: None=None) -> OntologyAnnotation | None:
    ...
    return ArcAssay(identifier, title, description, _arrow2482(), _arrow2483(), _arrow2484(), tables, None, None, comments_1)


ISAJson_decoder: Decoder_1[ArcAssay] = Decode_objectNoAdditionalProperties(ISAJson_allowedFields, _arrow2485)
