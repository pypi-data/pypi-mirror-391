...
from ..arctrl_spreadsheet.arc_investigation import (ARCtrl_ArcInvestigation__ArcInvestigation_toFsWorkbook_Static_Z720BD3FF, ARCtrl_ArcInvestigation__ArcInvestigation_fromFsWorkbook_Static_32154C9D)
...
def _007CInvestigationPath_007C__007C(input: Array[str]) -> str | None:
    ...
    def _arrow3693(x: str, y: str, input: Any=input) -> bool:
        return x == y

    if (len(input) == 1) if (not equals_with(_arrow3693, input, None)) else False:
