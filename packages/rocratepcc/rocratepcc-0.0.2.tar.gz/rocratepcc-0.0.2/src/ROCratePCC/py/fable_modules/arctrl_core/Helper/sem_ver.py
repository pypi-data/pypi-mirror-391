...
from ...fable_library.option import value as value_3
from ...fable_library.reflection import (TypeInfo, int32_type, string_type, option_type, record_type)
from ...fable_library.reg_exp import (groups, get_item)
...
from ...fable_library.types import (Record, to_string)
...
def SemVer__AsString(this: SemVer) -> str:
    ...
    if this.PreRelease is not None:
        def _arrow68(__unit: None=None, this: Any=this) -> str:
            arg_3: str = value_3(this.PreRelease)
            return to_text(printf("-%s"))(arg_3)

        ignore(StringBuilder__Append_Z721C83C5(sb, _arrow68()))

    if this.Metadata is not None:
        def _arrow69(__unit: None=None, this: Any=this) -> str:
            arg_4: str = value_3(this.Metadata)
            return to_text(printf("+%s"))(arg_4)

        ignore(StringBuilder__Append_Z721C83C5(sb, _arrow69()))
