...
from ...arctrl_core.arc_types import (ArcStudy, ArcAssay)
from ...arctrl_core.comment import (Comment, Comment_reflection, Remark)
from ...arctrl_core.conversion import (ARCtrl_ArcTable__ArcTable_GetProtocols, ARCtrl_ArcTable__ArcTable_GetProcesses)
from ...arctrl_core.Helper.collections_ import (ResizeArray_iter, Option_fromValueWithDefault)
from ...arctrl_core.Helper.identifier import (create_missing_identifier, Study_fileNameFromIdentifier)
...
from ...arctrl_core.Process.process_sequence import get_factors
...
from ...fable_library.list import (FSharpList, of_array, map, empty, cons, reverse, append, of_seq)
...
from ...fable_library.seq import (collect, delay, append as append_1, singleton)
from ...fable_library.seq2 import List_distinct
from ...fable_library.string_ import starts_with_exact
from ...fable_library.types import (Record, Array)
from ...fable_library.util import (string_hash, IEnumerable_1, IEnumerator, to_enumerable)
...
StudyInfo_reflection = _expr3162
...
def StudyInfo_ToSparseTable_1680536E(study: ArcStudy) -> SparseTable:
    ...
    class ObjectExpr3164:
        @property
        def Equals(self) -> Callable[[str, str], bool]:
            def _arrow3163(x: str, y: str) -> bool:
                return x == y
    ...
    return SparseTable(matrix.Matrix, matrix.Keys, reverse(List_distinct(comment_keys, ObjectExpr3164())), matrix.ColumnCount)
...
def to_rows(study: ArcStudy, assays: FSharpList[ArcAssay] | None=None) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
    ...
    def _arrow3177(__unit: None=None, study: Any=study, assays: Any=assays) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
        def _arrow3176(__unit: None=None) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
            def _arrow3175(__unit: None=None) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
                def _arrow3174(__unit: None=None) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
                    def _arrow3173(__unit: None=None) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
                        def _arrow3172(__unit: None=None) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
                            def _arrow3171(__unit: None=None) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
                                def _arrow3170(__unit: None=None) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
                                    def _arrow3169(__unit: None=None) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
                                        def _arrow3168(__unit: None=None) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
                                            def _arrow3167(__unit: None=None) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
                                                def _arrow3166(__unit: None=None) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
                                                    def _arrow3165(__unit: None=None) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
                                                        return to_rows_6("Study Person", of_seq(study.Contacts))

                                                    return append_1(singleton(SparseRowModule_fromValues(to_enumerable(["STUDY CONTACTS"]))), delay(_arrow3165))

                                                return append_1(to_rows_5("Study Protocol", protocols), delay(_arrow3166))

                                            return append_1(singleton(SparseRowModule_fromValues(to_enumerable(["STUDY PROTOCOLS"]))), delay(_arrow3167))

                                        return append_1(to_rows_4("Study Assay", assays_1), delay(_arrow3168))

                                    return append_1(singleton(SparseRowModule_fromValues(to_enumerable(["STUDY ASSAYS"]))), delay(_arrow3169))

                                return append_1(to_rows_3("Study Factor", factors), delay(_arrow3170))

                            return append_1(singleton(SparseRowModule_fromValues(to_enumerable(["STUDY FACTORS"]))), delay(_arrow3171))

                        return append_1(to_rows_2("Study Publication", of_seq(study.Publications)), delay(_arrow3172))

                    return append_1(singleton(SparseRowModule_fromValues(to_enumerable(["STUDY PUBLICATIONS"]))), delay(_arrow3173))

                return append_1(to_rows_1("Study Design", of_seq(study.StudyDesignDescriptors)), delay(_arrow3174))

            return append_1(singleton(SparseRowModule_fromValues(to_enumerable(["STUDY DESIGN DESCRIPTORS"]))), delay(_arrow3175))

        return append_1(StudyInfo_toRows_1680536E(study), delay(_arrow3176))

    return delay(_arrow3177)
