...
from ....arctrl_core.Process.process_sequence import (get_sources, get_samples, get_materials)
from ....arctrl_core.Process.sample import Sample
from ....arctrl_core.Process.source import Source
from ....arctrl_json.encode import try_include_list
from ....arctrl_json.Process.material import ISAJson_encoder as ISAJson_encoder_2
from ....arctrl_json.Process.sample import ISAJson_encoder as ISAJson_encoder_1
from ....arctrl_json.Process.source import ISAJson_encoder
from ....fable_library.list import (FSharpList, choose, of_array)
...
def encoder(id_map: Any | None, ps: FSharpList[Process]) -> IEncodable:
    ...
    def _arrow3772(oa: Source, id_map: Any=id_map, ps: Any=ps) -> IEncodable:
        return ISAJson_encoder(id_map, oa)

    def _arrow3773(oa_1: Sample, id_map: Any=id_map, ps: Any=ps) -> IEncodable:
        return ISAJson_encoder_1(id_map, oa_1)

    def _arrow3774(c: Material, id_map: Any=id_map, ps: Any=ps) -> IEncodable:
        return ISAJson_encoder_2(id_map, c)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include_list("sources", _arrow3772, source), try_include_list("samples", _arrow3773, samples), try_include_list("otherMaterials", _arrow3774, materials)]))
    class ObjectExpr3775(IEncodable):
