...
from ...arctrl_core.Helper.orcid import try_get_orcid_url
from ...fable_library.option import (value as value_1, map, some, bind)
...
class LDPerson:
    ...
    def try_get_affiliation(p: LDNode, graph: LDGraph | None=None, context: LDContext | None=None) -> LDNode | None:
        ...
        if match_value is not None:
            def _arrow1010(__unit: None=None) -> bool:
    ...
    def gen_id(given_name: Any, orcid: str | None=None, family_name: Any | None=None) -> str:
        def _arrow1013(__unit: None=None) -> str:
