...
def int_1(value: YAMLElement) -> int:
    ...
    if pattern_matching_result == 0:
        ...
        out_arg: int = 0
        def _arrow3481(__unit: None=None, value: Any=value) -> int:
            return out_arg

        def _arrow3482(v_1: int, value: Any=value) -> None:
            nonlocal out_arg
            out_arg = v_1 or 0

        match_value = (try_parse(v.Value, 511, False, 32, FSharpRef(_arrow3481, _arrow3482)), out_arg)
        if match_value[0]:
...
def float_1(value: YAMLElement) -> float:
    ...
    if pattern_matching_result == 0:
        ...
        out_arg: float = 0.0
        def _arrow3483(__unit: None=None, value: Any=value) -> float:
            return out_arg

        def _arrow3484(v_1: float, value: Any=value) -> None:
            nonlocal out_arg
            out_arg = v_1

        match_value = (try_parse_1(v.Value, FSharpRef(_arrow3483, _arrow3484)), out_arg)
        if match_value[0]:
            return match_value[1]
...
def bool_1(value: YAMLElement) -> bool:
    ...
    if pattern_matching_result == 0:
        ...
        out_arg: bool = False
        def _arrow3485(__unit: None=None, value: Any=value) -> bool:
            return out_arg

        def _arrow3486(v_1: bool, value: Any=value) -> None:
            nonlocal out_arg
            out_arg = v_1

        match_value = (try_parse_2(v.Value, FSharpRef(_arrow3485, _arrow3486)), out_arg)
        if match_value[0]:
            return match_value[1]
...
def map(key_decoder: Callable[[str], _A], value_decoder: Callable[[YAMLElement], _B], value: YAMLElement) -> Any:
    if value.tag == 3:
        ...
        class ObjectExpr3487:
            @property
            def Compare(self) -> Callable[[_A_, _A_], int]:
                return compare

        return of_list(map_1(mapping, value.fields[0]), ObjectExpr3487())
...
def dict_1(key_decoder: Callable[[str], _A], value_decoder: Callable[[YAMLElement], _B], value: YAMLElement) -> Any:
    if value.tag == 3:
        ...
        class ObjectExpr3488:
            @property
            def Compare(self) -> Callable[[_A_, _A_], int]:
                return compare

        class ObjectExpr3489:
            @property
        ...
        return Dictionary(of_seq(map_1(mapping, value.fields[0]), ObjectExpr3488()), ObjectExpr3489())
...
def datetime(value: YAMLElement) -> Any:
    ...
    if pattern_matching_result == 0:
        ...
        def _arrow3490(__unit: None=None, value: Any=value) -> Any:
            return out_arg

        def _arrow3491(v_1: Any, value: Any=value) -> None:
            nonlocal out_arg
            out_arg = v_1

        match_value = (try_parse_3(v.Value, FSharpRef(_arrow3490, _arrow3491)), out_arg)
        if match_value[0]:
            return match_value[1]
...
def datetime_offset(value: YAMLElement) -> Any:
    ...
    if pattern_matching_result == 0:
        ...
        def _arrow3492(__unit: None=None, value: Any=value) -> Any:
            return out_arg

        def _arrow3493(v_1: Any, value: Any=value) -> None:
            nonlocal out_arg
            out_arg = v_1

        match_value = (try_parse_4(v.Value, FSharpRef(_arrow3492, _arrow3493)), out_arg)
        if match_value[0]:
            return match_value[1]
...
def _expr3504() -> TypeInfo:
    return class_type("YAMLicious.Decode.Getter", None, Getter)


class Getter:
    def __init__(self, ele: YAMLElement) -> None:
        def _arrow3497(__unit: None=None) -> IRequiredGetter:
            _this: Any = self
            class ObjectExpr3496(IRequiredGetter):
        ...
        self.required: IRequiredGetter = _arrow3497()
        def _arrow3499(__unit: None=None) -> IOptionalGetter:
            _this_1: Any = self
            class ObjectExpr3498(IOptionalGetter):
        ...
        self.optional: IOptionalGetter = _arrow3499()
        def _arrow3501(__unit: None=None) -> IMultipleOptionalGetter:
            _this_2: Any = self
            class ObjectExpr3500(IMultipleOptionalGetter):
        ...
        self.multiple_optional: IMultipleOptionalGetter = _arrow3501()
        def _arrow3503(__unit: None=None) -> IOverflowGetter:
            _this_3: Any = self
            class ObjectExpr3502(IOverflowGetter):
            ...
            return ObjectExpr3502()

        self.overflow: IOverflowGetter = _arrow3503()
