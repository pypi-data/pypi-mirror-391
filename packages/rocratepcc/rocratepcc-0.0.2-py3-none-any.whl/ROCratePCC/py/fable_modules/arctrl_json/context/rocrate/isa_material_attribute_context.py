...
IContext_reflection = _expr1176

def _arrow1183(__unit: None=None) -> IEncodable:
    class ObjectExpr1177(IEncodable):
        def Encode(self, helpers: IEncoderHelpers_1[Any]) -> Any:
            return helpers.encode_string("http://schema.org/")

    class ObjectExpr1178(IEncodable):
        def Encode(self, helpers_1: IEncoderHelpers_1[Any]) -> Any:
            return helpers_1.encode_string("http://purl.org/nfdi4plants/ontology/")

    class ObjectExpr1179(IEncodable):
        def Encode(self, helpers_2: IEncoderHelpers_1[Any]) -> Any:
            return helpers_2.encode_string("sdo:Property")

    class ObjectExpr1180(IEncodable):
        def Encode(self, helpers_3: IEncoderHelpers_1[Any]) -> Any:
            return helpers_3.encode_string("arc:ARC#ARC_00000050")

    class ObjectExpr1181(IEncodable):
        def Encode(self, helpers_4: IEncoderHelpers_1[Any]) -> Any:
            return helpers_4.encode_string("arc:ARC#ARC_00000098")

    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1177()), ("arc", ObjectExpr1178()), ("MaterialAttribute", ObjectExpr1179()), ("ArcMaterialAttribute", ObjectExpr1180()), ("characteristicType", ObjectExpr1181())])
    class ObjectExpr1182(IEncodable):
    ...
    return ObjectExpr1182()


context_jsonvalue: IEncodable = _arrow1183()
