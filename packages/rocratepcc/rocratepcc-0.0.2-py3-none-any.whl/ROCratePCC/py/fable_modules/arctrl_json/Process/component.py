...
from ...arctrl_core.Process.component import (Component, Component_createAsPV, Component__get_ComponentName, Component_decomposeName_Z721C83C5)
...
def encoder(value: Component) -> IEncodable:
    ...
    def _arrow1959(oa: OntologyAnnotation, value: Any=value) -> IEncodable:
        return OntologyAnnotation_encoder(oa)

    def _arrow1960(value_1: Value, value: Any=value) -> IEncodable:
        return encoder_1(None, value_1)

    def _arrow1961(oa_1: OntologyAnnotation, value: Any=value) -> IEncodable:
        return OntologyAnnotation_encoder(oa_1)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("type", _arrow1959, value.ComponentType), try_include("value", _arrow1960, value.ComponentValue), try_include("unit", _arrow1961, value.ComponentUnit)]))
...
def _arrow1965(get: IGetters) -> Component:
    ComponentType: OntologyAnnotation | None
    object_arg: IOptionalGetter = get.Optional
    ComponentType = object_arg.Field("type", OntologyAnnotation_decoder)
    def _arrow1963(__unit: None=None) -> Value | None:
        object_arg_1: IOptionalGetter = get.Optional
        return object_arg_1.Field("value", decoder_1)

    def _arrow1964(__unit: None=None) -> OntologyAnnotation | None:
        object_arg_2: IOptionalGetter = get.Optional
        return object_arg_2.Field("unit", OntologyAnnotation_decoder)

    return Component(_arrow1963(), _arrow1964(), ComponentType)


decoder: Decoder_1[Component] = object(_arrow1965)
...
def ISAJson_encoder(id_map: Any | None, c: Component) -> IEncodable:
    ...
    def _arrow1969(value: str, id_map: Any=id_map, c: Any=c) -> IEncodable:
    ...
    def _arrow1970(oa: OntologyAnnotation, id_map: Any=id_map, c: Any=c) -> IEncodable:
        return OntologyAnnotation_ISAJson_encoder(id_map, oa)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("componentName", _arrow1969, Component__get_ComponentName(c)), try_include("componentType", _arrow1970, c.ComponentType)]))
...
def _arrow1973(get: IGetters) -> Component:
    name: str | None
    object_arg: IOptionalGetter = get.Optional
    ...
    def _arrow1972(__unit: None=None) -> OntologyAnnotation | None:
        object_arg_1: IOptionalGetter = get.Optional
        return object_arg_1.Field("componentType", OntologyAnnotation_ISAJson_decoder)

    return Component(pattern_input_1[0], pattern_input_1[1], _arrow1972())


ISAJson_decoder: Decoder_1[Component] = object(_arrow1973)
