...
from ...fable_library.list import (choose, singleton, of_array, FSharpList, is_empty, head, tail)
...
from ...thoth_json_core.decode import (object, IOptionalGetter, IRequiredGetter, unit, list_1 as list_1_2, string, IGetters)
...
def ROCrate_encoder(oa: Source) -> IEncodable:
    ...
    def _arrow2082(__unit: None=None, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2086(value_3: str, oa: Any=oa) -> IEncodable:
    ...
    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow2082()), ("@type", list_1_1(singleton(ObjectExpr2083()))), ("additionalType", ObjectExpr2084()), try_include("name", _arrow2086, oa.Name), try_include_list_opt("characteristics", ROCrate_encoder_1, oa.Characteristics), ("@context", context_jsonvalue)]))
...
def _arrow2091(get: IGetters) -> Source:
    ...
    def _arrow2090(__unit: None=None) -> FSharpList[MaterialAttributeValue] | None:
    ...
    return Source(_arrow2088(), _arrow2089(), _arrow2090())


ROCrate_decoder: Decoder_1[Source] = object(_arrow2091)
...
def ISAJson_encoder(id_map: Any | None, oa: Source) -> IEncodable:
    def f(oa_1: Source, id_map: Any=id_map, oa: Any=oa) -> IEncodable:
        ...
        def _arrow2095(value: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2097(value_2: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2098(oa_2: MaterialAttributeValue, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_1(id_map, oa_2)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@id", _arrow2095, ROCrate_genID(oa_1)), try_include("name", _arrow2097, oa_1.Name), try_include_list_opt("characteristics", _arrow2098, oa_1.Characteristics)]))
    ...
    if id_map is not None:
        def _arrow2100(s_1: Source, id_map: Any=id_map, oa: Any=oa) -> str:
            return ROCrate_genID(s_1)

        return encode(_arrow2100, f, oa, id_map)
...
def _arrow2104(get: IGetters) -> Source:
    def _arrow2101(__unit: None=None) -> str | None:
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("@id", Decode_uri)

    def _arrow2102(__unit: None=None) -> str | None:
        object_arg_1: IOptionalGetter = get.Optional
        return object_arg_1.Field("name", string)

    def _arrow2103(__unit: None=None) -> FSharpList[MaterialAttributeValue] | None:
    ...
    return Source(_arrow2101(), _arrow2102(), _arrow2103())


ISAJson_decoder: Decoder_1[Source] = Decode_objectNoAdditionalProperties(ISAJson_allowedFields, _arrow2104)
