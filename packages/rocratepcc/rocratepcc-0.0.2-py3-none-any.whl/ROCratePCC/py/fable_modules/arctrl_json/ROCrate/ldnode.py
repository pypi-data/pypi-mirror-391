...
def get_decoder(expect_object: bool) -> Decoder_1[Any]:
    def decode(expect_object_1: bool, expect_object: Any=expect_object) -> Decoder_1[Any]:
        ...
        class ObjectExpr1431(Decoder_1[Array[Any]]):
                    ...
                    def folder(acc: FSharpResult_2[Array[Any], tuple[str, ErrorReason_1[__A_]]], value_2: __A_) -> FSharpResult_2[Array[Any], tuple[str, ErrorReason_1[__A_]]]:
                        ...
                        if acc.tag == 0:
                            ...
                            if match_value_1.tag == 0:
                                ...
                                def _arrow1430(__unit: None=None, acc: Any=acc, value_2: Any=value_2) -> tuple[str, ErrorReason_1[__A_]]:
                                ...
                                return FSharpResult_2(1, _arrow1430())
        ...
        resize_array: Decoder_1[Array[Any]] = ObjectExpr1431()
        if expect_object_1:
            def _arrow1432(value_4: LDNode, expect_object_1: Any=expect_object_1) -> Any:
                return value_4

            return map_1(_arrow1432, decode_object)

        else: 
            def _arrow1434(value_5: LDValue, expect_object_1: Any=expect_object_1) -> Any:
                return value_5

            def _arrow1435(value_6: LDNode, expect_object_1: Any=expect_object_1) -> Any:
                return value_6

            def _arrow1436(value_7: LDRef, expect_object_1: Any=expect_object_1) -> Any:
                return value_7

            def _arrow1437(value_8: Array[Any], expect_object_1: Any=expect_object_1) -> Any:
                return value_8

            def _arrow1438(value_9: str, expect_object_1: Any=expect_object_1) -> Any:
                return value_9

            def _arrow1439(value_10: int, expect_object_1: Any=expect_object_1) -> Any:
                return value_10

            def _arrow1440(value_11: Decimal, expect_object_1: Any=expect_object_1) -> Any:
                return value_11

            return one_of(of_array([map_1(_arrow1434, decoder_2), map_1(_arrow1435, decode_object), map_1(_arrow1436, decoder_3), map_1(_arrow1437, resize_array), map_1(_arrow1438, string), map_1(_arrow1439, int_1), map_1(_arrow1440, decimal)]))


    return decode(expect_object)


def _arrow1441(value: Any=None) -> LDNode:
    return value


decoder: Decoder_1[LDNode] = map_1(_arrow1441, get_decoder(True))
