...
def encode(sheet: FsTable) -> IEncodable:
    def _arrow3074(__unit: None=None, sheet: Any=sheet) -> IEncodable:
    ...
    def _arrow3076(__unit: None=None, sheet: Any=sheet) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("name", _arrow3074()), ("range", _arrow3076())])
...
def _arrow3078(builder: IGetters) -> FsTable:
    n: str
...
decode: Decoder_1[FsTable] = object(_arrow3078)
