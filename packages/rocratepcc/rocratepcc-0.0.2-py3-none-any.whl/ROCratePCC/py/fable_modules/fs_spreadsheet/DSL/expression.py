...
def _expr2989(gen0: TypeInfo) -> TypeInfo:
...
OptionalSource_1_reflection = _expr2989
...
def _expr2990(gen0: TypeInfo) -> TypeInfo:
...
RequiredSource_1_reflection = _expr2990
...
def _expr2991(gen0: TypeInfo) -> TypeInfo:
...
ExpressionSource_1_reflection = _expr2991
