...
class FsWorksheet:
    ...
    def Columns(self, __unit: None=None) -> IEnumerable_1[FsColumn]:
        ...
        def mapping(tupled_arg: tuple[int, IEnumerable_1[FsCell]]) -> FsColumn:
            ...
            def _arrow2977(__unit: None=None, tupled_arg: Any=tupled_arg) -> FsRangeAddress:
                tupled_arg_1: tuple[FsAddress, FsAddress]
                def projection_1(c_1: FsCell) -> int:
                    return c_1.RowNumber

                class ObjectExpr2974:
                    @property
                    def Compare(self) -> Callable[[int, int], int]:
                        return compare_primitives

                cells_1: IEnumerable_1[FsCell] = sort_by(projection_1, tupled_arg[1], ObjectExpr2974())
                def _arrow2975(__unit: None=None) -> int:
                    c_2: FsCell = head(cells_1)
                    return c_2.RowNumber

                def _arrow2976(__unit: None=None) -> int:
                    c_3: FsCell = last(cells_1)
                    return c_3.RowNumber

                tupled_arg_1 = (FsAddress(_arrow2975(), column_index), FsAddress(_arrow2976(), column_index))
                return FsRangeAddress(tupled_arg_1[0], tupled_arg_1[1])

            return FsColumn(_arrow2977(), self_1.CellCollection)

        def projection(c: FsCell) -> int:
            return c.ColumnNumber

        class ObjectExpr2979:
            @property
            def Equals(self) -> Callable[[int, int], bool]:
                def _arrow2978(x: int, y: int) -> bool:
                    return x == y
        ...
        return map(mapping, group_by(projection, self_1._cells.GetCells(), ObjectExpr2979()))
    ...
    def Copy(self, __unit: None=None) -> FsWorksheet:
        ...
        def _arrow2980(__unit: None=None) -> Array[FsRow]:
            n: Array[FsRow] = []
        ...
        def _arrow2981(__unit: None=None) -> Array[FsTable]:
            n_1: Array[FsTable] = []
        ...
        return FsWorksheet(self_1.Name, _arrow2980(), _arrow2981(), fcc)
    ...
    def RemoveRowAt(self, row_index: int) -> None:
        ...
        with get_enumerator(filter(predicate, self_1._rows)) as enumerator:
            while enumerator.System_Collections_IEnumerator_MoveNext():
                ...
                ignore(remove_in_place(enumerator.System_Collections_Generic_IEnumerator_1_get_Current(), self_1._rows, ObjectExpr2982()))
    ...
    def SortRows(self, __unit: None=None) -> None:
        ...
        class ObjectExpr2983:
            @property
            def Compare(self) -> Callable[[int, int], int]:
                return compare_primitives

        sorted: Array[FsRow] = list(sort_by(projection, self_1._rows, ObjectExpr2983()))
        clear(self_1._rows)
    ...
    def GetMaxRowIndex(self, __unit: None=None) -> FsRow:
        ...
        class ObjectExpr2984:
            @property
            def Compare(self) -> Callable[[int, int], int]:
                return compare_primitives

        return max_by(projection, self_1.Rows, ObjectExpr2984())
    ...
    def RescanRows(self, __unit: None=None) -> None:
        ...
        class ObjectExpr2985:
            @property
            def Compare(self) -> Callable[[int, int], int]:
                return compare_primitives

        rows: Any = of_seq(map(mapping, self_1._rows), ObjectExpr2985())
        ...
        class ObjectExpr2987:
            @property
            def Equals(self) -> Callable[[int, int], bool]:
                def _arrow2986(x_1: int, y_1: int) -> bool:
                    return x_1 == y_1
        ...
        iterate(action_1, group_by(projection, self_1._cells.GetCells(), ObjectExpr2987()))
...
FsWorksheet_reflection = _expr2988
