    ...
    def ShallowCopyDynamicPropertiesTo(self, target: Any, over_write: bool | None=None) -> None:
        ...
        def action(kv: Any) -> None:
            ...
            if match_value is None:
                ...
                def _arrow401(__unit: None=None, kv: Any=kv) -> bool:
                    pi: PropertyHelper = match_value
                    return over_write_1
    ...
    def DeepCopyPropertiesTo(self, target: Any, over_write: bool | None=None, include_instance_properties: bool | None=None) -> None:
        ...
        def action(kv: Any) -> None:
            ...
            if match_value is None:
                ...
                def _arrow402(__unit: None=None, kv: Any=kv) -> bool:
                    pi: PropertyHelper = match_value
                    return over_write_1
...
HashUtils_reflection = _expr404

def _expr405() -> TypeInfo:
...
def HashUtils_deepHash_4E60E31B(o: Any=None) -> int:
    if isinstance(o, DynamicObj):
        ...
        return box_hash_key_val_seq_by(f, sort_by(projection, o.GetProperties(True), ObjectExpr406()))
        ...
        def _arrow409(__unit: None=None, o: Any=o) -> IEnumerable_1[int]:
            def _arrow407(__unit: None=None) -> bool:
                return en.System_Collections_IEnumerator_MoveNext()

            def _arrow408(__unit: None=None) -> IEnumerable_1[int]:
                return singleton(HashUtils_deepHash_4E60E31B(en.System_Collections_IEnumerator_get_Current()))

            return enumerate_while(_arrow407, delay(_arrow408))

        l: FSharpList[int] = to_list(delay(_arrow409))
        if is_empty(l):
            return 0

        else: 
            def _arrow410(hash_1: int, hash_2: int, o: Any=o) -> int:
                return merge_hashes(hash_1, hash_2)

            return reduce(_arrow410, l)
...
def CopyUtils_tryDeepCopyObj_75B3D832(o: Any=None, include_instance_properties: bool | None=None) -> Any:
    ...
    def try_deep_copy_obj(o_1: Any=None, o: Any=o, include_instance_properties: Any=include_instance_properties) -> Any:
        ...
        if pattern_matching_result == 0:
            ...
            new_dict: Any = Dictionary([], ObjectExpr411())
            ...
            def _arrow412(__unit: None=None, o_1: Any=o_1) -> IEnumerable_1[DynamicObj]:
                return map_1(try_deep_copy_obj, o_1)

            return list(to_list(delay(_arrow412)))

        elif pattern_matching_result == 3:
            def _arrow413(__unit: None=None, o_1: Any=o_1) -> IEnumerable_1[DynamicObj]:
                return map_1(try_deep_copy_obj, o_1)

            return to_list(delay(_arrow413))
