...
from ....arctrl_core.template import Template
from ....arctrl_json.encode import default_spaces
from ....arctrl_json.Table.templates import (Template_encoder, Template_decoder, Template_decoderCompressed, Template_encoderCompressed)
...
from ....thoth_json_core.decode import array as array_2
...
def Templates_encoder(templates: Array[Template]) -> IEncodable:
    ...
    class ObjectExpr3788(IEncodable):
...
def ARCtrl_Template__Template_toJsonString_Static_71136F3F(spaces: int | None=None) -> Callable[[Template], str]:
    def _arrow3789(template: Template, spaces: Any=spaces) -> str:
...
def ARCtrl_Template__Template_toCompressedJsonString_Static_71136F3F(spaces: int | None=None) -> Callable[[Template], str]:
    def _arrow3790(obj: Template, spaces: Any=spaces) -> str:
