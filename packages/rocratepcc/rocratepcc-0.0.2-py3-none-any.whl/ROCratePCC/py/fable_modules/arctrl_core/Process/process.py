...
from ...fable_library.list import (length, empty, FSharpList, choose, collect, append, try_find, map as map_1, try_pick, zip)
from ...fable_library.option import (default_arg, bind, value as value_4, map)
from ...fable_library.reflection import (TypeInfo, string_type, option_type, list_type, record_type)
...
from ...fable_library.types import (to_string, Record)
from ...fable_library.util import (equals, safe_hash)
...
def Process_getInputCharacteristicValues_763471FF(p: Process) -> FSharpList[MaterialAttributeValue]:
    ...
    if match_value is None:
        ...
        return List_distinct(collect(mapping, match_value), ObjectExpr146())
...
def Process_getOutputCharacteristicValues_763471FF(p: Process) -> FSharpList[MaterialAttributeValue]:
    ...
    if match_value is None:
        ...
        return List_distinct(collect(mapping, match_value), ObjectExpr147())
...
def Process_getCharacteristicValues_763471FF(p: Process) -> FSharpList[MaterialAttributeValue]:
    ...
    return List_distinct(append(Process_getInputCharacteristicValues_763471FF(p), Process_getOutputCharacteristicValues_763471FF(p)), ObjectExpr148())
...
def Process_getCharacteristics_763471FF(p: Process) -> FSharpList[MaterialAttribute]:
    ...
    return List_distinct(choose(chooser, Process_getCharacteristicValues_763471FF(p)), ObjectExpr149())
...
def Process_getFactorValues_763471FF(p: Process) -> FSharpList[FactorValue]:
    ...
    return List_distinct(collect(mapping, default_arg(p.Outputs, empty())), ObjectExpr150())
...
def Process_getFactors_763471FF(p: Process) -> FSharpList[Factor]:
    ...
    return List_distinct(choose(chooser, Process_getFactorValues_763471FF(p)), ObjectExpr151())
...
def Process_getSources_763471FF(p: Process) -> FSharpList[Source]:
    ...
    return List_distinct(choose(chooser, default_arg(p.Inputs, empty())), ObjectExpr152())
...
def Process_getData_763471FF(p: Process) -> FSharpList[Data]:
    ...
    return List_distinct(append(choose(chooser, default_arg(p.Inputs, empty())), choose(chooser_1, default_arg(p.Outputs, empty()))), ObjectExpr153())
...
def Process_getSamples_763471FF(p: Process) -> FSharpList[Sample]:
    ...
    return List_distinct(append(choose(chooser, default_arg(p.Inputs, empty())), choose(chooser_1, default_arg(p.Outputs, empty()))), ObjectExpr154())
...
def Process_getMaterials_763471FF(p: Process) -> FSharpList[Material]:
    ...
    return List_distinct(append(choose(chooser, default_arg(p.Inputs, empty())), choose(chooser_1, default_arg(p.Outputs, empty()))), ObjectExpr155())
