...
from ..fable_library.array_ import (try_find, exists, filter)
from ..fable_library.list import (append, singleton, FSharpList, map, choose, of_array)
from ..fable_library.option import (default_arg, map as map_1)
from ..fable_library.reflection import (TypeInfo, class_type)
from ..fable_library.seq import length
...
from ..fable_library.util import (equals, ignore)
...
class Person:
    ...
    def exists_by_full_name(first_name: str, mid_initials: str, last_name: str, persons: Array[Person]) -> bool:
        ...
        return exists(_arrow103, persons)
    ...
    def remove_by_full_name(first_name: str, mid_initials: str, last_name: str, persons: Array[Person]) -> Array[Person]:
        ...
        return filter(_arrow104, persons)
    ...
    def __str__(self, __unit: None=None) -> str:
        ...
        def _arrow109(__unit: None=None) -> str:
        ...
        ignore(StringBuilder__Append_Z721C83C5(sb, join(",\n\t", map(mapping_1, choose(chooser, of_array([("FirstName", this.FirstName), ("LastName", this.LastName), ("MidInitials", this.MidInitials), ("EMail", this.EMail), ("Phone", this.Phone), ("Address", this.Address), ("Affiliation", this.Affiliation), ("Fax", this.Fax), ("ORCID", this.ORCID), ("Roles", _arrow109() if (length(this.Roles) > 0) else None), ("Comments", _arrow110() if (length(this.Comments) > 0) else None)]))))))
        ignore(StringBuilder__Append_Z721C83C5(sb, "\n}"))
        return to_string(sb)


Person_reflection = _expr111
