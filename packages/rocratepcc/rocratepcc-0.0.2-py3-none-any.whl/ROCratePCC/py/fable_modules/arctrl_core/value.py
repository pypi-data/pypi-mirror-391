...
class Value(Union):
    ...
    def from_string(value: str) -> Value:
        ...
        match_value = (try_parse(value, 511, False, 32, FSharpRef(_arrow73, _arrow74)), out_arg)
        if match_value[0]:
            ...
            out_arg_1: float = 0.0
            def _arrow75(__unit: None=None) -> float:
                return out_arg_1

            def _arrow76(v_2: float) -> None:
                nonlocal out_arg_1
                out_arg_1 = v_2

            match_value_1 = (try_parse_1(value, FSharpRef(_arrow75, _arrow76)), out_arg_1)
