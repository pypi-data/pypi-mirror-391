...
from ...arctrl_json.ROCrate.ldgraph import (decoder as decoder_2, encoder as encoder_1)
...
def ARCtrl_ROCrate_LDNode__LDNode_toROCrateJsonString_Static_71136F3F(spaces: int | None=None) -> Callable[[LDNode], str]:
    def _arrow3807(obj: LDNode, spaces: Any=spaces) -> str:
...
LDNodeExtensions_PyJsInterop_reflection = _expr3808
...
def ARCtrl_ROCrate_LDGraph__LDGraph_toROCrateJsonString_Static_71136F3F(spaces: int | None=None) -> Callable[[LDGraph], str]:
    def _arrow3809(obj: LDGraph, spaces: Any=spaces) -> str:
...
LDGraphExtensions_PyJsInterop_reflection = _expr3810
