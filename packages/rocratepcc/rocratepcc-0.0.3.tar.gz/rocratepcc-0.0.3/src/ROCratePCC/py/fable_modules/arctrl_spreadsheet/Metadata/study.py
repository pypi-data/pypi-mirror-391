...
StudyInfo_reflection = _expr3161
...
def StudyInfo_ToSparseTable_1680536E(study: ArcStudy) -> SparseTable:
    ...
    class ObjectExpr3163:
        ...
        def Equals(self) -> Callable[[str, str], bool]:
            def _arrow3162(x: str, y: str) -> bool:
                return x == y
    ...
    return SparseTable(matrix.Matrix, matrix.Keys, reverse(List_distinct(comment_keys, ObjectExpr3163())), matrix.ColumnCount)
...
def to_rows(study: ArcStudy, assays: FSharpList[ArcAssay] | None=None) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
    ...
    def _arrow3176(__unit: None=None, study: Any=study, assays: Any=assays) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
                                        ...
                                        def _arrow3167(__unit: None=None) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
                                            def _arrow3166(__unit: None=None) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
                                                def _arrow3165(__unit: None=None) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
                                                    def _arrow3164(__unit: None=None) -> IEnumerable_1[IEnumerable_1[tuple[int, str]]]:
                                                        return to_rows_6("Study Person", of_seq(study.Contacts))

                                                    return append_1(singleton(SparseRowModule_fromValues(to_enumerable(["STUDY CONTACTS"]))), delay(_arrow3164))

                                                return append_1(to_rows_5("Study Protocol", protocols), delay(_arrow3165))

                                            return append_1(singleton(SparseRowModule_fromValues(to_enumerable(["STUDY PROTOCOLS"]))), delay(_arrow3166))

                                        return append_1(to_rows_4("Study Assay", assays_1), delay(_arrow3167))

                                    return append_1(singleton(SparseRowModule_fromValues(to_enumerable(["STUDY ASSAYS"]))), delay(_arrow3168))

                                return append_1(to_rows_3("Study Factor", factors), delay(_arrow3169))

                            return append_1(singleton(SparseRowModule_fromValues(to_enumerable(["STUDY FACTORS"]))), delay(_arrow3170))

                        return append_1(to_rows_2("Study Publication", of_seq(study.Publications)), delay(_arrow3171))

                    return append_1(singleton(SparseRowModule_fromValues(to_enumerable(["STUDY PUBLICATIONS"]))), delay(_arrow3172))

                return append_1(to_rows_1("Study Design", of_seq(study.StudyDesignDescriptors)), delay(_arrow3173))

            return append_1(singleton(SparseRowModule_fromValues(to_enumerable(["STUDY DESIGN DESCRIPTORS"]))), delay(_arrow3174))

        return append_1(StudyInfo_toRows_1680536E(study), delay(_arrow3175))

    return delay(_arrow3176)
