...
def encode_tool_description(td: CWLToolDescription) -> str:
    ...
    def _arrow3668(__unit: None=None, td: Any=td) -> IEnumerable_1[str]:
            ...
            def _arrow3666(__unit: None=None) -> IEnumerable_1[str]:
                def _arrow3653(__unit: None=None) -> IEnumerable_1[str]:
                    ...
                    if match_value_1 is None:
                        ...
                        return append_1(match_value_1, delay(_arrow3652))
                ...
                def _arrow3665(__unit: None=None) -> IEnumerable_1[str]:
                    def _arrow3655(__unit: None=None) -> IEnumerable_1[str]:
                        ...
                        if match_value_2 is None:
                            ...
                            return append_1(match_value_2, delay(_arrow3654))
                    ...
                    def _arrow3664(__unit: None=None) -> IEnumerable_1[str]:
                        def _arrow3657(__unit: None=None) -> IEnumerable_1[str]:
                            ...
                            if match_value_3 is None:
                                ...
                                return append_1(match_value_3, delay(_arrow3656))
                        ...
                        def _arrow3663(__unit: None=None) -> IEnumerable_1[str]:
                            def _arrow3659(__unit: None=None) -> IEnumerable_1[str]:
                                ...
                                if match_value_4 is None:
                                    ...
                                    return append_1(match_value_4, delay(_arrow3658))
                            ...
                            def _arrow3662(__unit: None=None) -> IEnumerable_1[str]:
                                def _arrow3661(__unit: None=None) -> IEnumerable_1[str]:
                                    ...
                                    if pattern_matching_result_1 == 0:
                                        ...
                                        return append_1(singleton_1(""), delay(_arrow3660))

                                    elif pattern_matching_result_1 == 1:
                                        return empty_1()


                                return append_1(outputs_lines, delay(_arrow3661))

                            return append_1(_arrow3659(), delay(_arrow3662))

                        return append_1(_arrow3657(), delay(_arrow3663))

                    return append_1(_arrow3655(), delay(_arrow3664))

                return append_1(_arrow3653(), delay(_arrow3665))

            return append_1(singleton_1(""), delay(_arrow3666))

        return append_1(base_lines, delay(_arrow3667))

    return join("\r\n", merge(empty(), of_array(split(join("\r\n", to_list(delay(_arrow3668))), ["\r\n"], None, 0))))
...
def encode_workflow_description(wd: CWLWorkflowDescription) -> str:
    ...
    def mapping(r: Array[Requirement], wd: Any=wd) -> FSharpList[str]:
        def _arrow3669(r_1: Requirement, r: Any=r) -> YAMLElement:
            return encode_requirement(r_1)

        return section(singleton(("requirements", YAMLElement(2, of_seq(map_2(_arrow3669, r))))))
    ...
    def mapping_5(md: DynamicObj, wd: Any=wd) -> FSharpList[str]:
        def mapping_4(kvp: Any, md: Any=md) -> tuple[str, YAMLElement]:
            def _arrow3670(__unit: None=None, kvp: Any=kvp) -> YAMLElement:
                match_value: Any = kvp[1]
                return string(match_value) if (str(type(match_value)) == "<class \'str\'>") else string(to_string(kvp[1]))

            return (kvp[0], _arrow3670())
    ...
    def _arrow3682(__unit: None=None, wd: Any=wd) -> IEnumerable_1[str]:
        def _arrow3681(__unit: None=None) -> IEnumerable_1[str]:
            def _arrow3680(__unit: None=None) -> IEnumerable_1[str]:
                def _arrow3672(__unit: None=None) -> IEnumerable_1[str]:
                    ...
                    if match_value_1 is None:
                        ...
                        return append_1(match_value_1, delay(_arrow3671))


                def _arrow3679(__unit: None=None) -> IEnumerable_1[str]:
                    def _arrow3678(__unit: None=None) -> IEnumerable_1[str]:
                        def _arrow3677(__unit: None=None) -> IEnumerable_1[str]:
                                ...
                                def _arrow3675(__unit: None=None) -> IEnumerable_1[str]:
                                    def _arrow3674(__unit: None=None) -> IEnumerable_1[str]:
                                        ...
                                        if pattern_matching_result_1 == 0:
                                            ...
                                            return append_1(singleton_1(""), delay(_arrow3673))

                                        elif pattern_matching_result_1 == 1:
                                            return empty_1()


                                    return append_1(outputs_lines, delay(_arrow3674))

                                return append_1(singleton_1(""), delay(_arrow3675))

                            return append_1(steps_lines, delay(_arrow3676))

                        return append_1(singleton_1(""), delay(_arrow3677))

                    return append_1(inputs_lines, delay(_arrow3678))

                return append_1(_arrow3672(), delay(_arrow3679))

            return append_1(singleton_1(""), delay(_arrow3680))

        return append_1(base_lines, delay(_arrow3681))

    return join("\r\n", merge(empty(), of_array(split(join("\r\n", to_list(delay(_arrow3682))), ["\r\n"], None, 0))))
