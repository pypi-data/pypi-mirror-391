...
from ...arctrl_core.Helper.identifier import (create_missing_identifier, Workflow_tryIdentifierFromFileName, Workflow_fileNameFromIdentifier)
...
from ...fable_library.list import (of_array, FSharpList, map as map_1, empty, of_seq, cons, reverse)
...
def to_sparse_table(workflow: ArcWorkflow) -> SparseTable:
    ...
    class ObjectExpr3178:
        @property
        def Equals(self) -> Callable[[str, str], bool]:
            def _arrow3177(x: str, y: str) -> bool:
                return x == y
    ...
    return SparseTable(matrix.Matrix, matrix.Keys, reverse(List_distinct(comment_keys, ObjectExpr3178())), matrix.ColumnCount)
