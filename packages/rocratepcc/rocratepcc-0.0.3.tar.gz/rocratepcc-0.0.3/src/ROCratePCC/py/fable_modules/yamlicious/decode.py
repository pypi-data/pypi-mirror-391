...
def _expr3503() -> TypeInfo:
    return class_type("YAMLicious.Decode.Getter", None, Getter)


class Getter:
    def __init__(self, ele: YAMLElement) -> None:
        def _arrow3496(__unit: None=None) -> IRequiredGetter:
            _this: Any = self
            class ObjectExpr3495(IRequiredGetter):
        ...
        self.required: IRequiredGetter = _arrow3496()
        def _arrow3498(__unit: None=None) -> IOptionalGetter:
            _this_1: Any = self
            class ObjectExpr3497(IOptionalGetter):
        ...
        self.optional: IOptionalGetter = _arrow3498()
        def _arrow3500(__unit: None=None) -> IMultipleOptionalGetter:
            _this_2: Any = self
            class ObjectExpr3499(IMultipleOptionalGetter):
        ...
        self.multiple_optional: IMultipleOptionalGetter = _arrow3500()
        def _arrow3502(__unit: None=None) -> IOverflowGetter:
            _this_3: Any = self
            class ObjectExpr3501(IOverflowGetter):
            ...
            return ObjectExpr3501()

        self.overflow: IOverflowGetter = _arrow3502()
