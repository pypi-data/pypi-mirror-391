...
def _expr2987(gen0: TypeInfo) -> TypeInfo:
...
OptionalSource_1_reflection = _expr2987
...
def _expr2988(gen0: TypeInfo) -> TypeInfo:
...
RequiredSource_1_reflection = _expr2988
...
ExpressionSource_1_reflection = _expr2989
