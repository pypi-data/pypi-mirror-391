...
from ...arctrl_rocrate.ldobject import (LDNode, LDGraph)
from ...fable_library.list import (choose, FSharpList, is_empty, length, head)
from ...fable_library.option import map
from ...fable_library.result import FSharpResult_2
from ...fable_library.seq import (to_list, delay, append, singleton, collect, empty, map as map_1)
from ...fable_library.types import Array
from ...fable_library.util import (IEnumerable_1, get_enumerator, dispose)
from ...thoth_json_core.decode import (Getters_2__ctor_Z4BE6C149, Getters_2, IGetters, IOptionalGetter, string, resize_array, IRequiredGetter, Getters_2__get_Errors)
...
def encoder(obj: LDGraph) -> IEncodable:
    ...
    def _arrow1450(__unit: None=None, obj: Any=obj) -> IEnumerable_1[tuple[str, IEncodable | None]]:
        def _arrow1445(value: str) -> IEncodable:
        ...
        def _arrow1449(__unit: None=None) -> IEnumerable_1[tuple[str, IEncodable | None]]:
            def _arrow1448(__unit: None=None) -> IEnumerable_1[tuple[str, IEncodable | None]]:
                def _arrow1446(kv: Any) -> IEnumerable_1[tuple[str, IEncodable | None]]:
                    l: str = kv[0].lower()
                ...
                def _arrow1447(__unit: None=None) -> IEnumerable_1[tuple[str, IEncodable | None]]:
                    return singleton(("@graph", seq(map_1(encoder_2, obj.Nodes))))

                return append(collect(_arrow1446, obj.GetProperties(True)), delay(_arrow1447))

            return append(singleton(try_include("@context", encoder_1, obj.TryGetContext())), delay(_arrow1448))

        return append(singleton(try_include("@id", _arrow1445, obj.Id)), delay(_arrow1449))

    values_1: FSharpList[tuple[str, IEncodable]] = choose(chooser, to_list(delay(_arrow1450)))
...
class ObjectExpr1453(Decoder_1[LDGraph]):
...
decoder: Decoder_1[LDGraph] = ObjectExpr1453()
