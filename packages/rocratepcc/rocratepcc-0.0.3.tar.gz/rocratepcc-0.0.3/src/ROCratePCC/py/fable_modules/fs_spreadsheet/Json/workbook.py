...
def _arrow3079(builder: IGetters) -> FsWorkbook:
...
decode_rows: Decoder_1[FsWorkbook] = object(_arrow3079)
...
def encode_columns(no_numbering: bool, wb: FsWorkbook) -> IEncodable:
    ...
    return ObjectExpr3080()


def _arrow3081(builder: IGetters) -> FsWorkbook:
    wb: FsWorkbook = FsWorkbook()
    ws: IEnumerable_1[FsWorksheet]
...
decode_columns: Decoder_1[FsWorkbook] = object(_arrow3081)
