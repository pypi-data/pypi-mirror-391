...
class ObjectExpr832(Decoder_1[str]):
...
string: Decoder_1[str] = ObjectExpr832()

class ObjectExpr833(Decoder_1[str]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_1: Any) -> FSharpResult_2[str, tuple[str, ErrorReason_1[__A_]]]:
...
char: Decoder_1[str] = ObjectExpr833()

class ObjectExpr836(Decoder_1[str]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_1: Any) -> FSharpResult_2[str, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_string(value_1):
            match_value: tuple[bool, str]
            out_arg: str = "00000000-0000-0000-0000-000000000000"
            def _arrow834(__unit: None=None) -> str:
                return out_arg

            def _arrow835(v: str) -> None:
                nonlocal out_arg
                out_arg = v

            match_value = (try_parse_1(helpers.as_string(value_1), FSharpRef(_arrow834, _arrow835)), out_arg)
...
guid: Decoder_1[str] = ObjectExpr836()

class ObjectExpr837(Decoder_1[None]):
...
unit: Decoder_1[None] = ObjectExpr837()

class ObjectExpr840(Decoder_1[int8]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_2: Any) -> FSharpResult_2[int8, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_2):
            ...
            def _arrow838(__unit: None=None) -> int8:
                return out_arg

            def _arrow839(v: int8) -> None:
                nonlocal out_arg
                out_arg = v or 0

            match_value = (try_parse_2(helpers.as_string(value_2), 511, False, 8, FSharpRef(_arrow838, _arrow839)), out_arg)
...
sbyte: Decoder_1[int8] = ObjectExpr840()

class ObjectExpr843(Decoder_1[uint8]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_2: Any) -> FSharpResult_2[uint8, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_2):
            ...
            def _arrow841(__unit: None=None) -> uint8:
                return out_arg

            def _arrow842(v: uint8) -> None:
                nonlocal out_arg
                out_arg = v

            match_value = (try_parse_2(helpers.as_string(value_2), 511, True, 8, FSharpRef(_arrow841, _arrow842)), out_arg)
...
byte: Decoder_1[uint8] = ObjectExpr843()

class ObjectExpr846(Decoder_1[int16_1]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_2: Any) -> FSharpResult_2[int16_1, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_2):
            ...
            def _arrow844(__unit: None=None) -> int16_1:
                return out_arg

            def _arrow845(v: int16_1) -> None:
                nonlocal out_arg
                out_arg = v or 0

            match_value = (try_parse_2(helpers.as_string(value_2), 511, False, 16, FSharpRef(_arrow844, _arrow845)), out_arg)
...
int16: Decoder_1[int16_1] = ObjectExpr846()

class ObjectExpr849(Decoder_1[uint16_1]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_2: Any) -> FSharpResult_2[uint16_1, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_2):
            ...
            def _arrow847(__unit: None=None) -> uint16_1:
                return out_arg

            def _arrow848(v: uint16_1) -> None:
                nonlocal out_arg
                out_arg = v

            match_value = (try_parse_2(helpers.as_string(value_2), 511, True, 16, FSharpRef(_arrow847, _arrow848)), out_arg)
...
uint16: Decoder_1[uint16_1] = ObjectExpr849()

class ObjectExpr852(Decoder_1[int]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_2: Any) -> FSharpResult_2[int, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_2):
            ...
            out_arg: int = 0
            def _arrow850(__unit: None=None) -> int:
                return out_arg

            def _arrow851(v: int) -> None:
                nonlocal out_arg
                out_arg = v or 0

            match_value = (try_parse_2(helpers.as_string(value_2), 511, False, 32, FSharpRef(_arrow850, _arrow851)), out_arg)
...
int_1: Decoder_1[int] = ObjectExpr852()

class ObjectExpr855(Decoder_1[uint32_1]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_2: Any) -> FSharpResult_2[uint32_1, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_2):
            ...
            def _arrow853(__unit: None=None) -> uint32_1:
                return out_arg

            def _arrow854(v: uint32_1) -> None:
                nonlocal out_arg
                out_arg = v

            match_value = (try_parse_2(helpers.as_string(value_2), 511, True, 32, FSharpRef(_arrow853, _arrow854)), out_arg)
...
uint32: Decoder_1[uint32_1] = ObjectExpr855()

class ObjectExpr858(Decoder_1[int64_1]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_2: Any) -> FSharpResult_2[int64_1, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_2):
            ...
            def _arrow856(__unit: None=None) -> int64_1:
                return out_arg

            def _arrow857(v: int64_1) -> None:
                nonlocal out_arg
                out_arg = v

            match_value = (try_parse_3(helpers.as_string(value_2), 511, False, 64, FSharpRef(_arrow856, _arrow857)), out_arg)
...
int64: Decoder_1[int64_1] = ObjectExpr858()

class ObjectExpr861(Decoder_1[uint64_1]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_2: Any) -> FSharpResult_2[uint64_1, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_2):
            ...
            def _arrow859(__unit: None=None) -> uint64_1:
                return out_arg

            def _arrow860(v: uint64_1) -> None:
                nonlocal out_arg
                out_arg = v

            match_value = (try_parse_3(helpers.as_string(value_2), 511, True, 64, FSharpRef(_arrow859, _arrow860)), out_arg)
...
uint64: Decoder_1[uint64_1] = ObjectExpr861()

class ObjectExpr864(Decoder_1[int]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_1: Any) -> FSharpResult_2[int, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_1):
            ...
            def _arrow862(__unit: None=None) -> int:
                return out_arg

            def _arrow863(v: int) -> None:
                nonlocal out_arg
                out_arg = v

            parse_result = (try_parse_4(helpers.as_string(value_1), FSharpRef(_arrow862, _arrow863)), out_arg)
...
bigint: Decoder_1[int] = ObjectExpr864()

class ObjectExpr865(Decoder_1[bool]):
...
bool_1: Decoder_1[bool] = ObjectExpr865()

class ObjectExpr866(Decoder_1[float]):
...
float_1: Decoder_1[float] = ObjectExpr866()

class ObjectExpr867(Decoder_1[float32_1]):
...
float32: Decoder_1[float32_1] = ObjectExpr867()

class ObjectExpr870(Decoder_1[Decimal]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_1: Any) -> FSharpResult_2[Decimal, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_1):
            ...
            def _arrow868(__unit: None=None) -> Decimal:
                return out_arg

            def _arrow869(v: Decimal) -> None:
                nonlocal out_arg
                out_arg = v

            match_value = (try_parse_5(helpers.as_string(value_1), FSharpRef(_arrow868, _arrow869)), out_arg)
...
decimal: Decoder_1[Decimal] = ObjectExpr870()

class ObjectExpr873(Decoder_1[Any]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_1: Any) -> FSharpResult_2[Any, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_string(value_1):
            ...
            def _arrow871(__unit: None=None) -> Any:
                return out_arg

            def _arrow872(v: Any) -> None:
                nonlocal out_arg
                out_arg = v

            match_value = (try_parse_6(helpers.as_string(value_1), FSharpRef(_arrow871, _arrow872)), out_arg)
...
datetime_local: Decoder_1[Any] = ObjectExpr873()

class ObjectExpr876(Decoder_1[Any]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_1: Any) -> FSharpResult_2[Any, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_string(value_1):
            match_value: tuple[bool, Any]
            out_arg: Any = create(0)
            def _arrow874(__unit: None=None) -> Any:
                return out_arg

            def _arrow875(v: Any) -> None:
                nonlocal out_arg
                out_arg = v

            match_value = (try_parse_7(helpers.as_string(value_1), FSharpRef(_arrow874, _arrow875)), out_arg)
...
timespan: Decoder_1[Any] = ObjectExpr876()
...
def decode_maybe_null(helpers: IDecoderHelpers_1[Any], path: str, decoder: Decoder_1[Any], value_1: Any) -> FSharpResult_2[Any | None, tuple[str, ErrorReason_1[_JSONVALUE]]]:
    if helpers.is_null_value(value_1):
        ...
        if match_value.tag == 1:
            def _arrow877(__unit: None=None, helpers: Any=helpers, path: Any=path, decoder: Any=decoder, value_1: Any=value_1) -> tuple[str, ErrorReason_1[_JSONVALUE]]:
            ...
            return FSharpResult_2(1, _arrow877())
...
def optional(field_name: str, decoder: Decoder_1[Any]) -> Decoder_1[Any | None]:
    class ObjectExpr878(Decoder_1[_VALUE_ | None]):
...
def map2(ctor: Callable[[_A, _B], _OUTPUT], d1: Decoder_1[Any], d2: Decoder_1[Any]) -> Decoder_1[Any]:
    class ObjectExpr879(Decoder_1[_OUTPUT_]):
...
def index(requested_index: int, decoder: Decoder_1[Any]) -> Decoder_1[Any]:
    ...
    return ObjectExpr883()


def list_1(decoder: Decoder_1[Any]) -> Decoder_1[FSharpList[Any]]:
    class ObjectExpr885(Decoder_1[FSharpList[_VALUE_]]):
        def Decode(self, helpers: IDecoderHelpers_1[Any], value_1: Any, decoder: Any=decoder) -> FSharpResult_2[FSharpList[_VALUE_], tuple[str, ErrorReason_1[__A_]]]:
            if helpers.is_array(value_1):
                ...
                while (error is None) if (i < len(tokens)) else False:
                    ...
                    if match_value.tag == 1:
                        def _arrow884(__unit: None=None) -> tuple[str, ErrorReason_1[__A_]]:
                        ...
                        x: tuple[str, ErrorReason_1[__A_]] | None = _arrow884()
                        error = x
    ...
    return ObjectExpr885()


def resize_array(decoder: Decoder_1[Any]) -> Decoder_1[Array[Any]]:
    class ObjectExpr887(Decoder_1[Array[_VALUE_]]):
        def Decode(self, helpers: IDecoderHelpers_1[Any], value_1: Any, decoder: Any=decoder) -> FSharpResult_2[Array[_VALUE_], tuple[str, ErrorReason_1[__A_]]]:
            if helpers.is_array(value_1):
                ...
                while (error is None) if (i < len(tokens)) else False:
                    ...
                    match_value: FSharpResult_2[_VALUE_, tuple[str, ErrorReason_1[__A_]]] = decoder.Decode(helpers, value_2)
                    if match_value.tag == 1:
                        def _arrow886(__unit: None=None) -> tuple[str, ErrorReason_1[__A_]]:
                            tupled_arg: tuple[str, ErrorReason_1[__A_]] = match_value.fields[0]
                            return Helpers_prependPath((".[" + int32_to_string(i)) + "]", tupled_arg[0], tupled_arg[1])
    ...
    return ObjectExpr887()


def seq(decoder: Decoder_1[Any]) -> Decoder_1[IEnumerable_1[Any]]:
    class ObjectExpr889(Decoder_1[IEnumerable_1[_VALUE_]]):
                ...
                def folder(acc: FSharpResult_2[IEnumerable_1[_VALUE_], tuple[str, ErrorReason_1[__A_]]], value_2: __A_) -> FSharpResult_2[IEnumerable_1[_VALUE_], tuple[str, ErrorReason_1[__A_]]]:
                    ...
                    if acc.tag == 0:
                        ...
                        if match_value.tag == 0:
                            ...
                            def _arrow888(__unit: None=None, acc: Any=acc, value_2: Any=value_2) -> tuple[str, ErrorReason_1[__A_]]:
                                tupled_arg: tuple[str, ErrorReason_1[__A_]] = match_value.fields[0]
                                return Helpers_prependPath((".[" + int32_to_string(i)) + "]", tupled_arg[0], tupled_arg[1])

                            return FSharpResult_2(1, _arrow888())
    ...
    return ObjectExpr889()


def array(decoder: Decoder_1[Any]) -> Decoder_1[Array[Any]]:
    class ObjectExpr891(Decoder_1[Array[_VALUE_]]):
        def Decode(self, helpers: IDecoderHelpers_1[Any], value_1: Any, decoder: Any=decoder) -> FSharpResult_2[Array[_VALUE_], tuple[str, ErrorReason_1[__A_]]]:
            if helpers.is_array(value_1):
                i: int = -1
                tokens: Array[__A_] = helpers.as_array(value_1)
                def folder(acc: FSharpResult_2[Array[_VALUE_], tuple[str, ErrorReason_1[__A_]]], value_2: __A_) -> FSharpResult_2[Array[_VALUE_], tuple[str, ErrorReason_1[__A_]]]:
                    ...
                    if acc.tag == 0:
                        ...
                        if match_value.tag == 0:
                            ...
                            def _arrow890(__unit: None=None, acc: Any=acc, value_2: Any=value_2) -> tuple[str, ErrorReason_1[__A_]]:
                                tupled_arg: tuple[str, ErrorReason_1[__A_]] = match_value.fields[0]
                                return Helpers_prependPath((".[" + int32_to_string(i)) + "]", tupled_arg[0], tupled_arg[1])

                            return FSharpResult_2(1, _arrow890())
    ...
    return ObjectExpr891()


class ObjectExpr892(Decoder_1[FSharpList[str]]):
...
keys: Decoder_1[FSharpList[str]] = ObjectExpr892()

def key_value_pairs(decoder: Decoder_1[Any]) -> Decoder_1[FSharpList[tuple[str, _VALUE]]]:
    class ObjectExpr893(Decoder_1[FSharpList[tuple[str, _VALUE_]]]):
...
def one_of(decoders: FSharpList[Decoder_1[Any]]) -> Decoder_1[Any]:
    ...
    return ObjectExpr894()


def nil(output: Any | None=None) -> Decoder_1[Any]:
    class ObjectExpr895(Decoder_1[_A_]):
...
def succeed(output: Any | None=None) -> Decoder_1[Any]:
    class ObjectExpr896(Decoder_1[_A_]):
    ...
    return ObjectExpr896()


def fail(msg: str) -> Decoder_1[Any]:
    class ObjectExpr897(Decoder_1[_A_]):
...
def map4(ctor: Callable[[_A, _B, _C, _D], _OUTPUT], d1: Decoder_1[Any], d2: Decoder_1[Any], d3: Decoder_1[Any], d4: Decoder_1[Any]) -> Decoder_1[Any]:
    class ObjectExpr902(Decoder_1[_OUTPUT_]):
...
def map5(ctor: Callable[[_A, _B, _C, _D, _E], _OUTPUT], d1: Decoder_1[Any], d2: Decoder_1[Any], d3: Decoder_1[Any], d4: Decoder_1[Any], d5: Decoder_1[Any]) -> Decoder_1[Any]:
    class ObjectExpr903(Decoder_1[_OUTPUT_]):
...
def map6(ctor: Callable[[_A, _B, _C, _D, _E, _F], _OUTPUT], d1: Decoder_1[Any], d2: Decoder_1[Any], d3: Decoder_1[Any], d4: Decoder_1[Any], d5: Decoder_1[Any], d6: Decoder_1[Any]) -> Decoder_1[Any]:
    class ObjectExpr904(Decoder_1[_OUTPUT_]):
...
def map7(ctor: Callable[[_A, _B, _C, _D, _E, _F, _G], _OUTPUT], d1: Decoder_1[Any], d2: Decoder_1[Any], d3: Decoder_1[Any], d4: Decoder_1[Any], d5: Decoder_1[Any], d6: Decoder_1[Any], d7: Decoder_1[Any]) -> Decoder_1[Any]:
    class ObjectExpr905(Decoder_1[_OUTPUT_]):
...
def map8(ctor: Callable[[_A, _B, _C, _D, _E, _F, _G, _H], _OUTPUT], d1: Decoder_1[Any], d2: Decoder_1[Any], d3: Decoder_1[Any], d4: Decoder_1[Any], d5: Decoder_1[Any], d6: Decoder_1[Any], d7: Decoder_1[Any], d8: Decoder_1[Any]) -> Decoder_1[Any]:
    class ObjectExpr906(Decoder_1[_OUTPUT_]):
    ...
    return ObjectExpr906()


def lossy_option(decoder: Decoder_1[Any]) -> Decoder_1[Any | None]:
    class ObjectExpr907(Decoder_1[_VALUE_ | None]):
...
def and_map(__unit: None=None) -> Callable[[Decoder_1[_A], Decoder_1[Callable[[_A], _B]]], Decoder_1[_B]]:
    def _arrow909(d: Decoder_1[_A]) -> Callable[[Decoder_1[Callable[[_A], _B]]], Decoder_1[_B]]:
        def _arrow908(d_1: Decoder_1[Callable[[_A], _B]]) -> Decoder_1[_B]:
...
def _expr914(gen0: TypeInfo, gen1: TypeInfo) -> TypeInfo:
...
class Getters_2(Generic[_JSONVALUE, _T]):
    def __init__(self, helpers: IDecoderHelpers_1[Any], value_1: Any) -> None:
        ...
        def _arrow911(__unit: None=None) -> IRequiredGetter:
            _this: Any = self
            class ObjectExpr910(IRequiredGetter):
            ...
            return ObjectExpr910()

        self.required: IRequiredGetter = _arrow911()
        def _arrow913(__unit: None=None) -> IOptionalGetter:
            _this_1: Any = self
            class ObjectExpr912(IOptionalGetter):
            ...
            return ObjectExpr912()

        self.optional: IOptionalGetter = _arrow913()
...
def object(builder: Callable[[IGetters], _VALUE]) -> Decoder_1[Any]:
    class ObjectExpr915(Decoder_1[_VALUE_]):
...
def dict_1(decoder: Decoder_1[Any]) -> Decoder_1[Any]:
    def _arrow917(elements: FSharpList[tuple[str, _VALUE]], decoder: Any=decoder) -> Any:
        class ObjectExpr916:
            @property
            def Compare(self) -> Callable[[str, str], int]:
                return compare_primitives

        return of_list(elements, ObjectExpr916())

    return map(_arrow917, key_value_pairs(decoder))


def map_0027(key_decoder: Decoder_1[Any], value_decoder: Decoder_1[Any]) -> Decoder_1[Any]:
    def _arrow919(elements: Array[tuple[_KEY, _VALUE]], key_decoder: Any=key_decoder, value_decoder: Any=value_decoder) -> Any:
        class ObjectExpr918:
            @property
            def Compare(self) -> Callable[[_KEY_, _KEY_], int]:
                return compare

        return of_seq_1(elements, ObjectExpr918())

    return map(_arrow919, array(tuple2(key_decoder, value_decoder)))
