...
class FsWorksheet:
    ...
    def Columns(self, __unit: None=None) -> IEnumerable_1[FsColumn]:
        ...
        def mapping(tupled_arg: tuple[int, IEnumerable_1[FsCell]]) -> FsColumn:
            ...
            def _arrow2976(__unit: None=None, tupled_arg: Any=tupled_arg) -> FsRangeAddress:
                tupled_arg_1: tuple[FsAddress, FsAddress]
                def projection_1(c_1: FsCell) -> int:
                    return c_1.RowNumber

                class ObjectExpr2973:
                    @property
                    def Compare(self) -> Callable[[int, int], int]:
                        return compare_primitives

                cells_1: IEnumerable_1[FsCell] = sort_by(projection_1, tupled_arg[1], ObjectExpr2973())
                def _arrow2974(__unit: None=None) -> int:
                ...
                tupled_arg_1 = (FsAddress(_arrow2974(), column_index), FsAddress(_arrow2975(), column_index))
                return FsRangeAddress(tupled_arg_1[0], tupled_arg_1[1])

            return FsColumn(_arrow2976(), self_1.CellCollection)

        def projection(c: FsCell) -> int:
            return c.ColumnNumber

        class ObjectExpr2978:
            @property
            def Equals(self) -> Callable[[int, int], bool]:
                def _arrow2977(x: int, y: int) -> bool:
                    return x == y
        ...
        return map(mapping, group_by(projection, self_1._cells.GetCells(), ObjectExpr2978()))
    ...
    def Copy(self, __unit: None=None) -> FsWorksheet:
        ...
        def _arrow2979(__unit: None=None) -> Array[FsRow]:
            n: Array[FsRow] = []
        ...
        def _arrow2980(__unit: None=None) -> Array[FsTable]:
            n_1: Array[FsTable] = []
        ...
        return FsWorksheet(self_1.Name, _arrow2979(), _arrow2980(), fcc)
    ...
    def RemoveRowAt(self, row_index: int) -> None:
        ...
        with get_enumerator(filter(predicate, self_1._rows)) as enumerator:
            while enumerator.System_Collections_IEnumerator_MoveNext():
                ...
                ignore(remove_in_place(enumerator.System_Collections_Generic_IEnumerator_1_get_Current(), self_1._rows, ObjectExpr2981()))
    ...
    def SortRows(self, __unit: None=None) -> None:
        ...
        sorted: Array[FsRow] = list(sort_by(projection, self_1._rows, ObjectExpr2982()))
        clear(self_1._rows)
    ...
    def GetMaxRowIndex(self, __unit: None=None) -> FsRow:
        ...
        return max_by(projection, self_1.Rows, ObjectExpr2983())
    ...
    def RescanRows(self, __unit: None=None) -> None:
        ...
        rows: Any = of_seq(map(mapping, self_1._rows), ObjectExpr2984())
        ...
        class ObjectExpr2986:
            @property
            def Equals(self) -> Callable[[int, int], bool]:
                def _arrow2985(x_1: int, y_1: int) -> bool:
                    return x_1 == y_1
        ...
        iterate(action_1, group_by(projection, self_1._cells.GetCells(), ObjectExpr2986()))
...
FsWorksheet_reflection = _expr2990
