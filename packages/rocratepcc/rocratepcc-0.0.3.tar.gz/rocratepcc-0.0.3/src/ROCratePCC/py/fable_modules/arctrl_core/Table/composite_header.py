...
from ...fable_library.reflection import (name, get_union_cases, TypeInfo, string_type, union_type)
from ...fable_library.reg_exp import (get_item, groups)
from ...fable_library.string_ import (to_fail, printf)
from ...fable_library.types import (Array, to_string, Union)
...
class IOType(Union):
    ...
    def as_input(self, __unit: None=None) -> str:
        ...
        def string_create(x: Any | None=None) -> str:
            def _arrow187(__unit: None=None, x: Any=x) -> str:
                copy_of_struct: __A = x
                return to_string(copy_of_struct)

            return ("Input [" + _arrow187()) + "]"
    ...
    def as_output(self, __unit: None=None) -> str:
        this: IOType = self
        def string_create(x: Any | None=None) -> str:
            def _arrow188(__unit: None=None, x: Any=x) -> str:
                copy_of_struct: __A = x
                return to_string(copy_of_struct)

            return ("Output [" + _arrow188()) + "]"
...
CompositeHeader_reflection = _expr190
