...
IContext_reflection = _expr1300

def _arrow1310(__unit: None=None) -> IEncodable:
    ...
    class ObjectExpr1307(IEncodable):
        def Encode(self, helpers_6: IEncoderHelpers_1[Any]) -> Any:
            return helpers_6.encode_string("sdo:author")

    class ObjectExpr1308(IEncodable):
        def Encode(self, helpers_7: IEncoderHelpers_1[Any]) -> Any:
            return helpers_7.encode_string("sdo:disambiguatingDescription")

    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1301()), ("Publication", ObjectExpr1302()), ("pubMedID", ObjectExpr1303()), ("doi", ObjectExpr1304()), ("title", ObjectExpr1305()), ("status", ObjectExpr1306()), ("authorList", ObjectExpr1307()), ("comments", ObjectExpr1308())])
    ...
    return ObjectExpr1309()


context_jsonvalue: IEncodable = _arrow1310()
