...
IContext_reflection = _expr1174

def _arrow1183(__unit: None=None) -> IEncodable:
    class ObjectExpr1175(IEncodable):
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1175()), ("arc", ObjectExpr1178()), ("MaterialAttribute", ObjectExpr1179()), ("ArcMaterialAttribute", ObjectExpr1180()), ("characteristicType", ObjectExpr1181())])
