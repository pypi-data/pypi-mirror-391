...
def encode_rows(cell: FsCell) -> IEncodable:
    def _arrow3049(__unit: None=None, cell: Any=cell) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("column", _arrow3049()), ("value", encode(cell.Value))])
...
def decode_rows(row_number: int | None=None) -> Decoder_1[FsCell]:
    def _arrow3053(builder: IGetters, row_number: Any=row_number) -> FsCell:
        def _arrow3051(__unit: None=None) -> tuple[Any, DataType] | None:
            object_arg: IOptionalGetter = builder.Optional
            return object_arg.Field("value", decode)

        pattern_input: tuple[Any, DataType] = default_arg(_arrow3051(), ("", DataType(4)))
        def _arrow3052(__unit: None=None) -> int | None:
            object_arg_1: IOptionalGetter = builder.Optional
            return object_arg_1.Field("column", int_1)

        c: int = default_arg(_arrow3052(), 0) or 0
        return FsCell(pattern_input[0], pattern_input[1], FsAddress(default_arg(row_number, 0), c))

    return object(_arrow3053)


def encode_cols(cell: FsCell) -> IEncodable:
    def _arrow3055(__unit: None=None, cell: Any=cell) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("row", _arrow3055()), ("value", encode(cell.Value))])
...
def decode_cols(col_number: int | None=None) -> Decoder_1[FsCell]:
    def _arrow3062(builder: IGetters, col_number: Any=col_number) -> FsCell:
        def _arrow3059(__unit: None=None) -> tuple[Any, DataType] | None:
            object_arg: IOptionalGetter = builder.Optional
            return object_arg.Field("value", decode)

        pattern_input: tuple[Any, DataType] = default_arg(_arrow3059(), ("", DataType(4)))
        def _arrow3061(__unit: None=None) -> int | None:
            object_arg_1: IOptionalGetter = builder.Optional
            return object_arg_1.Field("row", int_1)

        return FsCell(pattern_input[0], pattern_input[1], FsAddress(default_arg(_arrow3061(), 0), default_arg(col_number, 0)))

    return object(_arrow3062)
