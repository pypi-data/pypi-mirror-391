...
def ROCrate_encoder(study_name: str | None, assay_name: str | None, process_name: str | None, oa: Protocol) -> IEncodable:
    ...
    def _arrow1990(__unit: None=None, study_name: Any=study_name, assay_name: Any=assay_name, process_name: Any=process_name, oa: Any=oa) -> IEncodable:
        value: str = ROCrate_genID(study_name, assay_name, process_name, oa)
        class ObjectExpr1989(IEncodable):
            def Encode(self, helpers: IEncoderHelpers_1[Any]) -> Any:
                return helpers.encode_string(value)

        return ObjectExpr1989()
    ...
    def _arrow1993(value_2: str, study_name: Any=study_name, assay_name: Any=assay_name, process_name: Any=process_name, oa: Any=oa) -> IEncodable:
    ...
    def _arrow1994(oa_1: OntologyAnnotation, study_name: Any=study_name, assay_name: Any=assay_name, process_name: Any=process_name, oa: Any=oa) -> IEncodable:
        return OntologyAnnotation_ROCrate_encoderDefinedTerm(oa_1)

    def _arrow1996(value_4: str, study_name: Any=study_name, assay_name: Any=assay_name, process_name: Any=process_name, oa: Any=oa) -> IEncodable:
    ...
    def _arrow1998(value_6: str, study_name: Any=study_name, assay_name: Any=assay_name, process_name: Any=process_name, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2000(value_8: str, study_name: Any=study_name, assay_name: Any=assay_name, process_name: Any=process_name, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2001(comment: Comment, study_name: Any=study_name, assay_name: Any=assay_name, process_name: Any=process_name, oa: Any=oa) -> IEncodable:
        return ROCrate_encoder_2(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow1990()), ("@type", list_1_1(singleton(ObjectExpr1991()))), try_include("name", _arrow1993, oa.Name), try_include("protocolType", _arrow1994, oa.ProtocolType), try_include("description", _arrow1996, oa.Description), try_include("uri", _arrow1998, oa.Uri), try_include("version", _arrow2000, oa.Version), try_include_list_opt("components", ROCrate_encoder_1, oa.Components), try_include_list_opt("comments", _arrow2001, oa.Comments), ("@context", context_jsonvalue)]))
...
def _arrow2014(get: IGetters) -> Protocol:
    def _arrow2006(__unit: None=None) -> FSharpList[Component]:
        list_4: FSharpList[Component]
        def _arrow2003(__unit: None=None) -> FSharpList[Component] | None:
            arg_1: Decoder_1[FSharpList[Component]] = list_1_2(ROCrate_decoder_1)
            object_arg: IOptionalGetter = get.Optional
            return object_arg.Field("components", arg_1)

        list_2: FSharpList[Component] = default_arg(_arrow2003(), empty())
        ...
        list_4 = append(default_arg(_arrow2004(), empty()), list_2)
        ...
        return append(default_arg(_arrow2005(), empty()), list_4)

    components: FSharpList[Component] | None = Option_fromValueWithDefault(empty(), _arrow2006())
    ...
    def _arrow2009(__unit: None=None) -> OntologyAnnotation | None:
    ...
    def _arrow2013(__unit: None=None) -> FSharpList[Comment] | None:
        arg_19: Decoder_1[FSharpList[Comment]] = list_1_2(ROCrate_decoder_2)
        object_arg_9: IOptionalGetter = get.Optional
        return object_arg_9.Field("comments", arg_19)

    return Protocol(_arrow2007(), _arrow2008(), _arrow2009(), _arrow2010(), _arrow2011(), _arrow2012(), None, components, _arrow2013())


ROCrate_decoder: Decoder_1[Protocol] = object(_arrow2014)
...
def ISAJson_encoder(study_name: str | None, assay_name: str | None, process_name: str | None, id_map: Any | None, oa: Protocol) -> IEncodable:
    def f(oa_1: Protocol, study_name: Any=study_name, assay_name: Any=assay_name, process_name: Any=process_name, id_map: Any=id_map, oa: Any=oa) -> IEncodable:
        ...
        def _arrow2018(value: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2020(value_2: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2021(oa_2: OntologyAnnotation, oa_1: Any=oa_1) -> IEncodable:
            return OntologyAnnotation_ISAJson_encoder(id_map, oa_2)

        def _arrow2023(value_4: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2025(value_6: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2027(value_8: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2028(value_10: ProtocolParameter, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_1(id_map, value_10)

        def _arrow2029(c: Component, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_2(id_map, c)

        def _arrow2030(comment: Comment, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_3(id_map, comment)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@id", _arrow2018, ROCrate_genID(study_name, assay_name, process_name, oa_1)), try_include("name", _arrow2020, oa_1.Name), try_include("protocolType", _arrow2021, oa_1.ProtocolType), try_include("description", _arrow2023, oa_1.Description), try_include("uri", _arrow2025, oa_1.Uri), try_include("version", _arrow2027, oa_1.Version), try_include_list_opt("parameters", _arrow2028, oa_1.Parameters), try_include_list_opt("components", _arrow2029, oa_1.Components), try_include_list_opt("comments", _arrow2030, oa_1.Comments)]))
    ...
    if id_map is not None:
        def _arrow2032(p_1: Protocol, study_name: Any=study_name, assay_name: Any=assay_name, process_name: Any=process_name, id_map: Any=id_map, oa: Any=oa) -> str:
            return ROCrate_genID(study_name, assay_name, process_name, p_1)

        return encode(_arrow2032, f, oa, id_map)
...
def _arrow2042(get: IGetters) -> Protocol:
    ...
    def _arrow2035(__unit: None=None) -> OntologyAnnotation | None:
        object_arg_2: IOptionalGetter = get.Optional
    ...
    def _arrow2039(__unit: None=None) -> FSharpList[ProtocolParameter] | None:
        arg_13: Decoder_1[FSharpList[ProtocolParameter]] = list_1_2(ISAJson_decoder_1)
        object_arg_6: IOptionalGetter = get.Optional
        return object_arg_6.Field("parameters", arg_13)

    def _arrow2040(__unit: None=None) -> FSharpList[Component] | None:
        arg_15: Decoder_1[FSharpList[Component]] = list_1_2(ISAJson_decoder_2)
        object_arg_7: IOptionalGetter = get.Optional
        return object_arg_7.Field("components", arg_15)

    def _arrow2041(__unit: None=None) -> FSharpList[Comment] | None:
        arg_17: Decoder_1[FSharpList[Comment]] = list_1_2(ISAJson_decoder_3)
        object_arg_8: IOptionalGetter = get.Optional
        return object_arg_8.Field("comments", arg_17)

    return Protocol(_arrow2033(), _arrow2034(), _arrow2035(), _arrow2036(), _arrow2037(), _arrow2038(), _arrow2039(), _arrow2040(), _arrow2041())


ISAJson_decoder: Decoder_1[Protocol] = object(_arrow2042)
