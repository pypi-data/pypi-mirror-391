...
from ...thoth_json_core.decode import (map, object, IOptionalGetter, IGetters)
...
def ISAJson_encoder(id_map: Any | None, value: ProtocolParameter) -> IEncodable:
    def f(value_1: ProtocolParameter, id_map: Any=id_map, value: Any=value) -> IEncodable:
        ...
        def _arrow1880(value_2: str, value_1: Any=value_1) -> IEncodable:
            class ObjectExpr1877(IEncodable):
                def Encode(self, helpers: IEncoderHelpers_1[Any]) -> Any:
                    return helpers.encode_string(value_2)

            return ObjectExpr1877()

        def _arrow1882(oa: OntologyAnnotation, value_1: Any=value_1) -> IEncodable:
            return OntologyAnnotation_ISAJson_encoder(id_map, oa)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@id", _arrow1880, ISAJson_genID(value_1)), try_include("parameterName", _arrow1882, value_1.ParameterName)]))
    ...
    if id_map is not None:
        def _arrow1887(p_1: ProtocolParameter, id_map: Any=id_map, value: Any=value) -> str:
            return ISAJson_genID(p_1)

        return encode(_arrow1887, f, value, id_map)
...
def _arrow1889(get: IGetters) -> ProtocolParameter:
    def _arrow1888(__unit: None=None) -> OntologyAnnotation | None:
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("parameterName", OntologyAnnotation_ISAJson_decoder)

    return ProtocolParameter(None, _arrow1888())


ISAJson_decoder: Decoder_1[ProtocolParameter] = object(_arrow1889)
