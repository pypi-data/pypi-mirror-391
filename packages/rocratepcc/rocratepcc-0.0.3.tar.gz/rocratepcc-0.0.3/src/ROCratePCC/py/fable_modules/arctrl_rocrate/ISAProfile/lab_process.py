...
from ...dynamic_obj.dyn_obj import (try_get_property_value, set_property, set_optional_property)
...
class LabProcess(LDNode):
    ...
    def get_name() -> Callable[[LabProcess], str]:
        def _arrow1049(lp: LabProcess) -> str:
            return lp.GetName()
    ...
    def get_agent() -> Callable[[LabProcess], str]:
        def _arrow1050(lp: LabProcess) -> str:
            return lp.GetAgent()
    ...
    def get_object() -> Callable[[LabProcess], str]:
        def _arrow1051(lp: LabProcess) -> str:
            return lp.GetObject()
    ...
    def get_result() -> Callable[[LabProcess], str]:
        def _arrow1052(lp: LabProcess) -> str:
            return lp.GetResult()

        return _arrow1052


LabProcess_reflection = _expr1053
