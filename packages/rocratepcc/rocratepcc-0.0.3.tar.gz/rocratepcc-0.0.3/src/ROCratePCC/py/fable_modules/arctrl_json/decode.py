...
from ..fable_library.list import (FSharpList, is_empty, length, head, empty, cons, tail)
from ..fable_library.map_util import add_to_dict
from ..fable_library.mutable_map import Dictionary
from ..fable_library.result import (FSharpResult_2, Result_Map)
from ..fable_library.seq import exists
from ..fable_library.set import (contains, of_seq)
from ..fable_library.string_ import (to_text, printf)
from ..fable_library.types import Array
from ..fable_library.util import (compare_primitives, IEnumerable_1, int32_to_string, equals, structural_hash)
from ..thoth_json_core.decode import (string, Getters_2__ctor_Z4BE6C149, Getters_2, Getters_2__get_Errors, IGetters, map, datetime_local, tuple2, int_1)
from ..thoth_json_core.types import (ErrorReason_1, Decoder_1, IDecoderHelpers_1)
...
class ObjectExpr1358(Decoder_1[str]):
...
Decode_uri: Decoder_1[str] = ObjectExpr1358()
...
def Decode_objectNoAdditionalProperties(allowed_properties: IEnumerable_1[str], builder: Callable[[IGetters], _VALUE]) -> Decoder_1[Any]:
    ...
    allowed_properties_1: Any = of_seq(allowed_properties, ObjectExpr1359())
    class ObjectExpr1360(Decoder_1[_VALUE_]):
...
def Decode_noAdditionalProperties(allowed_properties: IEnumerable_1[str], decoder: Decoder_1[Any]) -> Decoder_1[Any]:
    ...
    allowed_properties_1: Any = of_seq(allowed_properties, ObjectExpr1361())
    class ObjectExpr1362(Decoder_1[_VALUE_]):
                ...
                def folder(acc: FSharpResult_2[Array[_VALUE_], tuple[str, ErrorReason_1[__A_]]], value_1: __A_) -> FSharpResult_2[Array[_VALUE_], tuple[str, ErrorReason_1[__A_]]]:
                    ...
                    if acc.tag == 0:
                        ...
                        if match_value.tag == 0:
                            ...
                            def _arrow1366(__unit: None=None, acc: Any=acc, value_1: Any=value_1) -> tuple[str, ErrorReason_1[__A_]]:
                            ...
                            return FSharpResult_2(1, _arrow1366())
...
def Decode_dictionary(key_decoder: Decoder_1[Any], value_decoder: Decoder_1[Any]) -> Decoder_1[Any]:
    class ObjectExpr1377(Decoder_1[Any]):
        def Decode(self, helpers: IDecoderHelpers_1[Any], value: Any, key_decoder: Any=key_decoder, value_decoder: Any=value_decoder) -> FSharpResult_2[Any, tuple[str, ErrorReason_1[__A_]]]:
            if helpers.is_array(value):
                ...
                dict_1: Any = Dictionary([], ObjectExpr1372())
