...
def _arrow1092(__unit: None=None) -> IEncodable:
    class ObjectExpr1078(IEncodable):
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1078()), ("additionalType", ObjectExpr1079()), ("alternateName", ObjectExpr1080()), ("measurementMethod", ObjectExpr1081()), ("description", ObjectExpr1082()), ("category", ObjectExpr1083()), ("categoryCode", ObjectExpr1084()), ("value", ObjectExpr1085()), ("valueCode", ObjectExpr1087()), ("unit", ObjectExpr1088()), ("unitCode", ObjectExpr1089()), ("comments", ObjectExpr1090())])
