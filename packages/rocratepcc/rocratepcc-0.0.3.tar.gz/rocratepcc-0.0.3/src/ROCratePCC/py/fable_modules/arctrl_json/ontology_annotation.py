...
def OntologyAnnotation_ISAJson_encoder(id_map: Any | None, oa: OntologyAnnotation) -> IEncodable:
    def f(oa_1: OntologyAnnotation, id_map: Any=id_map, oa: Any=oa) -> IEncodable:
        ...
        def _arrow1560(value_2: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow1562(value_4: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow1564(value_6: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow1565(comment: Comment, oa_1: Any=oa_1) -> IEncodable:
            return encoder(comment)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@id", _arrow1558, OntologyAnnotation_ROCrate_genID(oa_1)), try_include("annotationValue", _arrow1560, oa_1.Name), try_include("termSource", _arrow1562, oa_1.TermSourceREF), try_include("termAccession", _arrow1564, oa_1.TermAccessionNumber), try_include_seq("comments", _arrow1565, comments)]))
        ...
        return ObjectExpr1566()

    if id_map is not None:
        def _arrow1567(o: OntologyAnnotation, id_map: Any=id_map, oa: Any=oa) -> str:
            return OntologyAnnotation_ROCrate_genID(o)

        return encode(_arrow1567, f, oa, id_map)
