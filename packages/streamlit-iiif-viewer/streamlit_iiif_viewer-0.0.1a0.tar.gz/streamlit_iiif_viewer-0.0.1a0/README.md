...
<!-- Badge section -->
[![Supported Python versions](https://img.shields.io/pypi/pyversions/pypistats.svg?logo=python&logoColor=FFE873)](https://pypi.org/project/)
...
<!-- lien vers demo streamlit -->

Streamlit component for viewing and interacting with <img src="./assets/iiif.png" width="15px">  manifests inside a
