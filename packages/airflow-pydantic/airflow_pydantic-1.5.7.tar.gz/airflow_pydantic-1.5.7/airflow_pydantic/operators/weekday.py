...
# Alias
BranchDayOfWeekOperatorArgs = BranchDayOfWeekTaskArgs


class BranchDayOfWeekTask(Task, BranchDayOfWeekTaskArgs):
    operator: ImportPath = Field(
        default="airflow_pydantic.airflow.BranchDayOfWeekOperator", description="airflow operator path", validate_default=True
    )
...
# Alias
BranchDayOfWeekOperator = BranchDayOfWeekTask
