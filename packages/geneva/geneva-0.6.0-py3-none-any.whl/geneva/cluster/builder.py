...
class HeadGroupBuilder:
    ...
    def __init__(self) -> None:
        self._image: str = _default_image()
...
class WorkerGroupBuilder:
    ...
    def build(self) -> WorkerGroupConfig:
        ...
        if self._image == _default_image() and self._num_gpus > 0:
            self._image = _default_image(gpu=True)
...
class GenevaClusterBuilder:
    ...
    def __init__(self) -> None:
        ...
        # Head group defaults
        self._head_image: str = _default_image()
...
def _default_image(gpu: bool = False) -> str:
    ...
    return get_ray_image(
        ...
        python_version,
        gpu=gpu,
        arm=platform.processor() in {"aarch64", "arm"},
    )
