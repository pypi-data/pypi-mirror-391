...
from .crud_base import CRUDRepository, T
...
class MongoDBRepository(CRUDRepository[JSONDict, JSONDict]):
    ...
    def create(self, obj: T) -> Dict[str, Any]:
        """Insert a new record into the collection.

        Args:
            obj (T): The domain object to persist (Pydantic BaseModel or dict).
    ...
    async def async_create(self, obj: T) -> Dict[str, Any]:
        ...
        Args:
            obj (T): The domain object to persist.
