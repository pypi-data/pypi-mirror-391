...
from ...models import ModelSchemaExtractor, State
...
class ExtractorNode(BaseNode):
    ...
    def _get_parsed_schema(self) -> Type[BaseModel]:
        ...
        """
        schema_descriptor: ModelSchemaExtractor = asyncio.run(self.schema_extractor.extract())
    ...
    def process(self, state: State, config: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        """
        pydantic_class = self._get_parsed_schema()
