...
class DataSchemaExtractor:
    ...
    async def execute(self, text: str, id_schema: str) -> dict[str, ModelDataExtractor]:
        ...
        Args:
            text (str): The raw input text to extract structured data from.
            id_schema (str): The identifier of the extractor_schema used for extraction.
        ...
        for name, d_extractor in self.data_extractors.items():
            data_extracted: ModelDataExtractor = await d_extractor.extract(text=text)
