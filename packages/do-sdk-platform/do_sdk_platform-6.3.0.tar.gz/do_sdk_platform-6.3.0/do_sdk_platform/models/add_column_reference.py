...
class AddColumnReference(BaseModel):
    """
    AddColumnReference
    """ # noqa: E501
    type: StrictStr
    ...
    __properties: ClassVar[List[str]] = ["type", "referenceDatabaseRowId", "name", "jsonField", "cardinality", "systemType", "isRequired", "enabledViewers", "cellJsonSchema", "inlineViewer"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AddColumnReference from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddColumnReference from a dict"""
        if obj is None:
            return None
