...
class AddColumnEditor(BaseModel):
    """
    AddColumnEditor
    """ # noqa: E501
    type: StrictStr
    ...
    __properties: ClassVar[List[str]] = ["type", "name", "jsonField", "cardinality", "systemType", "isRequired", "enabledViewers", "cellJsonSchema", "inlineViewer"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['editor']):
            raise ValueError("must be one of enum values ('editor')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AddColumnEditor from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddColumnEditor from a dict"""
        if obj is None:
            return None
