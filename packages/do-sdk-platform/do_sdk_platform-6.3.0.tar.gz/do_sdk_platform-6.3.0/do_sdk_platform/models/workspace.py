...
class Workspace(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "type", "hid", "name", "dateCreated", "dateUpdated", "createdByUserDrn", "editedByUserDrn", "parentId", "parentHid", "creationParentId", "creationBlockId", "editor"]
