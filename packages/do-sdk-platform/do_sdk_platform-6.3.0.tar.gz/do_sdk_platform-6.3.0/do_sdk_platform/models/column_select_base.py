...
class ColumnSelectBase(BaseModel):
    """
    ColumnSelectBase
    """ # noqa: E501
    type: StrictStr
    config_select: ColumnSelectBaseConfigSelect = Field(alias="configSelect")
    __properties: ClassVar[List[str]] = ["type", "configSelect"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ColumnSelectBase from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ColumnSelectBase from a dict"""
        if obj is None:
            return None
