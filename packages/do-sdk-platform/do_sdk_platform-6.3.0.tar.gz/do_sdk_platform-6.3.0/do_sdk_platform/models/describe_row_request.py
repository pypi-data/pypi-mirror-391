...
class DescribeRowRequest(BaseModel):
    """
    DescribeRowRequest
    """ # noqa: E501
    row_id: StrictStr = Field(alias="rowId")
    fields: Optional[StrictBool] = None
    column_selection: Optional[ColumnSelection] = Field(default=None, alias="columnSelection")
    __properties: ClassVar[List[str]] = ["rowId", "fields", "columnSelection"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DescribeRowRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DescribeRowRequest from a dict"""
        if obj is None:
            return None
