...
class FieldBase(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["columnId", "version", "validationStatus", "invalidData", "type", "systemType"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FieldBase from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FieldBase from a dict"""
        if obj is None:
            return None
