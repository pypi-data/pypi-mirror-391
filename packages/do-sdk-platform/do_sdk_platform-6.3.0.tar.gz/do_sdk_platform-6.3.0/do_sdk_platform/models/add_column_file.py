...
class AddColumnFile(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["type", "configFile", "name", "jsonField", "cardinality", "systemType", "isRequired", "enabledViewers", "cellJsonSchema", "inlineViewer"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AddColumnFile from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddColumnFile from a dict"""
        if obj is None:
            return None
