...
class AddColumnSelect(BaseModel):
    """
    AddColumnSelect
    """ # noqa: E501
    type: StrictStr
    ...
    __properties: ClassVar[List[str]] = ["type", "configSelect", "name", "jsonField", "cardinality", "systemType", "isRequired", "enabledViewers", "cellJsonSchema", "inlineViewer"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AddColumnSelect from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddColumnSelect from a dict"""
        if obj is None:
            return None
