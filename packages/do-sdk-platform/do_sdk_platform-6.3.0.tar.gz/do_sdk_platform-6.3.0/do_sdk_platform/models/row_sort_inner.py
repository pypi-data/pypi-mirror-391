...
class RowSortInner(BaseModel):
    """
    RowSortInner
    """ # noqa: E501
    column_id: StrictStr = Field(alias="columnId")
    sort: StrictStr
    __properties: ClassVar[List[str]] = ["columnId", "sort"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RowSortInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RowSortInner from a dict"""
        if obj is None:
            return None
