...
class DatabaseView(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "databaseId", "name", "filter", "rowSort", "columnSelection"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DatabaseView from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DatabaseView from a dict"""
        if obj is None:
            return None
