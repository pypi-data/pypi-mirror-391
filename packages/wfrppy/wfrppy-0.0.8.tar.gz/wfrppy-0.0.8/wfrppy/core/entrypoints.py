"""
Generate console_scripts entries dynamically for wfrppy commands.
"""
...
sys.modules.setdefault("wfrppy.core.entrypoints", sys.modules[__name__])
...
def build_console_scripts(skip: Iterable[str] = (), prefix: str = "") -> List[str]:
    ...
    for command_name, func_name in list_entry_functions(skip=skip):
        ...
        scripts.append(f"{script_name}=wfrppy.core.entrypoints:{func_name}")
    return scripts
