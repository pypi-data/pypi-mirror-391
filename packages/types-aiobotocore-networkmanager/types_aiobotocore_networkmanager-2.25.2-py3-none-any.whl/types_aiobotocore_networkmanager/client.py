...
class NetworkManagerClient(AioBaseClient):
    ...
    async def create_site(
        self, **kwargs: Unpack[CreateSiteRequestTypeDef]
    ) -> CreateSiteResponseTypeDef:
        """
    ...
    async def delete_site(
        self, **kwargs: Unpack[DeleteSiteRequestTypeDef]
    ) -> DeleteSiteResponseTypeDef:
        """
    ...
    async def get_devices(
        self, **kwargs: Unpack[GetDevicesRequestTypeDef]
    ) -> GetDevicesResponseTypeDef:
        """
    ...
    async def get_links(self, **kwargs: Unpack[GetLinksRequestTypeDef]) -> GetLinksResponseTypeDef:
        """
    ...
    async def get_sites(self, **kwargs: Unpack[GetSitesRequestTypeDef]) -> GetSitesResponseTypeDef:
        """
    ...
    async def update_site(
        self, **kwargs: Unpack[UpdateSiteRequestTypeDef]
    ) -> UpdateSiteResponseTypeDef:
        """
