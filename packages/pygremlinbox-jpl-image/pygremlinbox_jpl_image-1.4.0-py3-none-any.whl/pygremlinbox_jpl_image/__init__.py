# SPDX-License-Identifier: JPL-image
# SPDX-FileCopyrightText: 2025 PyGremlinBox Maintainer <simon@sigre.xyz>

"""
PyGremlinBox JPL-image - Supply chain security testing module.

This package is licenced under JPL-image.
...
maintaining compliance with JPL-image requirements.
"""

__version__ = "1.4.0"
__licence__ = "JPL-image"
...
def get_package_metadata():
    ...
    """
    return {
        "name": "PyGremlinBox-JPL-image",
        "version": __version__,
        "licence": __licence__,
        "description": "Supply chain security testing module with JPL-image licence",
        "spdx_licence_id": "JPL-image"
    }
