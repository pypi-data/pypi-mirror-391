...
from ...models.get_all_chargepointproducts_order_by import GetAllChargepointproductsOrderBy
...
def _get_kwargs(
    *,
    ...
    order_by: GetAllChargepointproductsOrderBy | Unset = GetAllChargepointproductsOrderBy.VALUE_0,
...
def sync_detailed(
    *,
    ...
    """Get a list of chargepointproducts.

     Get a paged list of chargepointproducts, taken the filters into account.

    Args:
        skip (int | Unset):
        take (int | Unset):
        search (str | Unset):
        order_by (GetAllChargepointproductsOrderBy | Unset):  Default:
            GetAllChargepointproductsOrderBy.VALUE_0.
