...
class WebhookPostDto:
    ...
    Attributes:
        ...
        ou_code (str | Unset):
        enabled (bool | Unset):
        event_types (list[WebhookPostDtoEventTypesItem] | Unset):
        headers (list[WebhookHeaderDto] | Unset):
        url (str | Unset):
    """
    ...
    event_types: list[WebhookPostDtoEventTypesItem] | Unset = UNSET
    headers: list[WebhookHeaderDto] | Unset = UNSET
    url: str | Unset = UNSET
