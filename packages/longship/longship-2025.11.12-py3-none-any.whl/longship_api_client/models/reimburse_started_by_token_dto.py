...
class ReimburseStartedByTokenDto:
    ...
    Attributes:
        ...
        token_type (ReimburseStartedByTokenDtoTokenType | Unset):  Default:
            ReimburseStartedByTokenDtoTokenType.AD_HOC_USER.
        contract_id (str | Unset):
        auth_method (ReimburseStartedByTokenDtoAuthMethod | Unset):  Default:
    ...
    token_type: ReimburseStartedByTokenDtoTokenType | Unset = ReimburseStartedByTokenDtoTokenType.AD_HOC_USER
    contract_id: str | Unset = UNSET
    auth_method: ReimburseStartedByTokenDtoAuthMethod | Unset = ReimburseStartedByTokenDtoAuthMethod.AUTH_REQUEST
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        token_type: ReimburseStartedByTokenDtoTokenType | Unset
        ...
        auth_method: ReimburseStartedByTokenDtoAuthMethod | Unset
