...
from ..models.organization_unit_get_dto_ou_type import OrganizationUnitGetDtoOuType
...
class OrganizationUnitGetDto:
    ...
    Attributes:
        ...
        ou_type (OrganizationUnitGetDtoOuType | Unset): This is the type of the OU: None(default), Company, Departement
            or Reimbursee.
        ...
        direct_payment_profile_id (str | Unset):
    ...
    ou_type: OrganizationUnitGetDtoOuType | Unset = UNSET
    ...
    direct_payment_profile_id: str | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ou_type: OrganizationUnitGetDtoOuType | Unset
        if isinstance(_ou_type, Unset) or _ou_type is None:
            ou_type = UNSET
        else:
            ou_type = OrganizationUnitGetDtoOuType(_ou_type)
