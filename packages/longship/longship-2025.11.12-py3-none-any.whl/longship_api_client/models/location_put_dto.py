...
class LocationPutDto:
    ...
    Attributes:
        ...
        parking_type (LocationPutDtoParkingType | Unset):  Default: LocationPutDtoParkingType.ALONG_MOTORWAY.
        ...
        facilities (list[LocationPutDtoFacilitiesItem] | Unset):
    ...
    parking_type: LocationPutDtoParkingType | Unset = LocationPutDtoParkingType.ALONG_MOTORWAY
    ...
    facilities: list[LocationPutDtoFacilitiesItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        parking_type: LocationPutDtoParkingType | Unset
