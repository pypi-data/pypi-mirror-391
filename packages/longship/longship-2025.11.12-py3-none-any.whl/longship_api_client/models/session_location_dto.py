...
class SessionLocationDto:
    ...
    Attributes:
        id (str | Unset):
        evse_id (str | Unset):
        power_type (SessionLocationDtoPowerType | Unset):  Default: SessionLocationDtoPowerType.AC_1_PHASE.
        ...
        coordinates (SessionGeoLocationDto | Unset):
        time_zone (str | Unset):
    ...
    power_type: SessionLocationDtoPowerType | Unset = SessionLocationDtoPowerType.AC_1_PHASE
    ...
    coordinates: SessionGeoLocationDto | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        power_type: SessionLocationDtoPowerType | Unset
