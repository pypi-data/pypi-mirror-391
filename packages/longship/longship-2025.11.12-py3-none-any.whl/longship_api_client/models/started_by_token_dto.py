...
class StartedByTokenDto:
    ...
    Attributes:
        ...
        token_type (StartedByTokenDtoTokenType | Unset):  Default: StartedByTokenDtoTokenType.AD_HOC_USER.
        contract_id (str | Unset):
        auth_method (StartedByTokenDtoAuthMethod | Unset):  Default: StartedByTokenDtoAuthMethod.AUTH_REQUEST.
    ...
    token_type: StartedByTokenDtoTokenType | Unset = StartedByTokenDtoTokenType.AD_HOC_USER
    contract_id: str | Unset = UNSET
    auth_method: StartedByTokenDtoAuthMethod | Unset = StartedByTokenDtoAuthMethod.AUTH_REQUEST
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        token_type: StartedByTokenDtoTokenType | Unset
        ...
        auth_method: StartedByTokenDtoAuthMethod | Unset
