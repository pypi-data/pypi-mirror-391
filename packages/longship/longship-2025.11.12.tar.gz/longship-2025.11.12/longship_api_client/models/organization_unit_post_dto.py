...
from ..models.organization_unit_post_dto_ou_type import OrganizationUnitPostDtoOuType
...
class OrganizationUnitPostDto:
    ...
    Attributes:
        ...
        ou_type (OrganizationUnitPostDtoOuType | Unset): This is the type of the OU: None(default), Company, Departement
            or Reimbursee.
    ...
    ou_type: OrganizationUnitPostDtoOuType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ou_type: OrganizationUnitPostDtoOuType | Unset
        if isinstance(_ou_type, Unset) or _ou_type is None:
            ou_type = UNSET
        else:
            ou_type = OrganizationUnitPostDtoOuType(_ou_type)
