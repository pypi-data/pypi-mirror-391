...
class CdrLocationDto:
    ...
    Attributes:
        id (str | Unset):
        evse_id (str | Unset):
        power_type (CdrLocationDtoPowerType | Unset):  Default: CdrLocationDtoPowerType.AC_1_PHASE.
        ...
        coordinates (CdrGeoLocationDto | Unset):
        time_zone (str | Unset):
    ...
    power_type: CdrLocationDtoPowerType | Unset = CdrLocationDtoPowerType.AC_1_PHASE
    ...
    coordinates: CdrGeoLocationDto | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        power_type: CdrLocationDtoPowerType | Unset
