...
class LocationPostDto:
    ...
    Attributes:
        ...
        publish (bool | Unset): Whether to publish this to roaming partners or not.
        ...
        parking_type (LocationPostDtoParkingType | Unset):
        ...
        facilities (list[LocationPostDtoFacilitiesItem] | Unset):
        ...
        ou (str | Unset): ou code like 0000-0001-00001.
        ou_id (str | Unset): Guid with ouId.
        ou_name (str | Unset):
    ...
    parking_type: LocationPostDtoParkingType | Unset = UNSET
    ...
    facilities: list[LocationPostDtoFacilitiesItem] | Unset = UNSET
