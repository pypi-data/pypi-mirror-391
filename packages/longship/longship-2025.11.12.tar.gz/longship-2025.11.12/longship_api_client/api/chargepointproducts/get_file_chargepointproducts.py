...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/products/chargepoints/download",
        "params": params,
    }
...
) -> FileContentResult | LongshipError | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[FileContentResult | LongshipError]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Gets a file of chargepointproducts.

     Gets a file of chargepointproducts, taken the filters into account.
...
def sync(
    *,
    ...
    Returns:
        FileContentResult | LongshipError
    """
