...
from ...models.reimbursement_tariff_put_dto import ReimbursementTariffPutDto
...
def _get_kwargs(
    id: str,
    *,
    body: ReimbursementTariffPutDto,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    """Patches the ReimbursementTariff.

     Patches the ReimbursementTariff based on the id.
