...
from ...models.reimbursement_tariff_post_dto import ReimbursementTariffPostDto
from ...types import Response


def _get_kwargs(
    *,
    body: ReimbursementTariffPostDto,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    """Creates a reimbursementtariff.

     Creates a new reimbursementtariff.
