...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/v1/chargepoints/{id}/authorization/{authorization_id}",
    }
...
) -> ChargePointAuthorizeGetDto | LongshipError | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ChargePointAuthorizeGetDto | LongshipError]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ChargePointAuthorizeGetDto | LongshipError
    """
