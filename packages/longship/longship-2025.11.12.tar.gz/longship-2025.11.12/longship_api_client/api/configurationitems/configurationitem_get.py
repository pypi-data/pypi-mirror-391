...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/v1/chargepoints/{id}/configurationitems",
    }
...
) -> LongshipError | list[ChargepointConfigurationItemsDto] | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[LongshipError | list[ChargepointConfigurationItemsDto]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        LongshipError | list[ChargepointConfigurationItemsDto]
    """
