...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/v1/organizationalunits/{id}",
    }
...
) -> LongshipError | OrganizationUnitGetDto | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[LongshipError | OrganizationUnitGetDto]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        LongshipError | OrganizationUnitGetDto
    """
