...
class AsyncMCPClient(AsyncToolClient):
    ...
    async def register_mcp_server(self, name: str, base_url: str, token: str | None = None) -> None:
        ...
        Args:
            ...
            token: Optional Bearer token for authentication. If not provided, will try to use MBXAI_API_TOKEN environment variable.
        """
