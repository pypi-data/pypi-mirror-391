...
class IntegratedDashboard:
    ...
    def _get_logs_stats(self):
        ...
        IMPORTANTE: Este método usa o endpoint otimizado /api/consulta/log/estatisticas_dia
        que retorna contadores agregados (COUNT) ao invés de todos os logs.
        
        Endpoint esperado:
            GET /api/consulta/log/estatisticas_dia?token=XXX&data=YYYY-MM-DD
        ...
        Resposta esperada:
            {
                ...
                "total_warnings": 8,
                "total_info": 500,
                "ultimo_erro": "2025-11-11 14:32:10"
            }
        ...
        try:
            ...
            # ========================================
            try:
                url_stats = f"https://{self.shortname}.oking.openk.com.br/api/consulta/log_estatisticas_dia/filtros"
                ...
                with urllib.request.urlopen(req_stats, timeout=10) as response:
                    ...
                    if isinstance(data, dict) and data.get('sucesso'):
                        total_erros = data.get('total_erros', 0)
                        ...
                        print(f"[WARNING] Logs: Resposta do endpoint otimizado inválida")
