...
def verify_jobs_change(job_config_dict: dict):
    ...
    try:
        ...
        # Passo 3: Limpa schedule atual e recarrega
        schedule.clear()
        logger.info('Schedule limpo - buscando nova configuracao...')
        
        # Busca configuracao atualizada
        new_config = oking.get(
            f'https://{src.shortname_interface}.oking.openk.com.br/api/consulta/oking_hub/'
        ...
        # Passo 4: Confirma reload para API
