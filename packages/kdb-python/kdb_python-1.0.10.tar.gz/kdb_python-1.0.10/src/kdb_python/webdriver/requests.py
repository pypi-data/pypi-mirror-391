...
def _get_proxies():
    http_proxy = os.getenv('KDB_REQUESTS_HTTP_PROXY')
    https_proxy = os.getenv('KDB_REQUESTS_HTTPS_PROXY')
...
def _get_verify():
    verify = os.getenv('KDB_REQUESTS_VERIFY_CERT')
    return None if verify is None else _convert_to_boolean(verify)
...
class Requests:
    ...
    @staticmethod
    def get(url, params=None, log=True, proxies=None, verify=None, **kwargs):
        ...
        try:
            ...
            if verify is None:
                verify = _get_verify()
            result = requests.get(url, params=params, proxies=proxies, verify=verify, **kwargs)
    ...
    @staticmethod
    def options(url, log=True, proxies=None, verify=None, **kwargs):
        ...
        try:
            ...
            if verify is None:
                verify = _get_verify()
            result = requests.options(url, proxies=proxies, verify=verify, **kwargs)
    ...
    @staticmethod
    def head(url, log=True, proxies=None, verify=None, **kwargs):
        ...
        try:
            ...
            if verify is None:
                verify = _get_verify()
            result = requests.head(url, proxies=proxies, verify=verify, **kwargs)
    ...
    @staticmethod
    def post(url, data=None, json=None, log=True, proxies=None, verify=None, **kwargs):
        ...
        try:
            ...
            if verify is None:
                verify = _get_verify()
            result = requests.post(url, data=data, json=json, proxies=proxies, verify=verify, **kwargs)
    ...
    @staticmethod
    def put(url, data=None, log=True, proxies=None, verify=None, **kwargs):
        ...
        try:
            ...
            if verify is None:
                verify = _get_verify()
            result = requests.put(url, data=data, proxies=proxies, verify=verify, **kwargs)
    ...
    @staticmethod
    def patch(url, data=None, log=True, proxies=None, verify=None, **kwargs):
        ...
        try:
            ...
            if verify is None:
                verify = _get_verify()
            result = requests.patch(url, data=data, proxies=proxies, verify=verify, **kwargs)
    ...
    @staticmethod
    def delete(url, log=True, proxies=None, verify=None, **kwargs):
        ...
        try:
            ...
            if verify is None:
                verify = _get_verify()
            result = requests.delete(url, proxies=proxies, verify=verify, **kwargs)
