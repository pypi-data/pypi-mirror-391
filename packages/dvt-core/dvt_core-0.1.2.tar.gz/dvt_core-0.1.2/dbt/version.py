...
def _resolve_version() -> str:
    try:
        # Try DVT-core first, then fall back to dbt-core for backward compatibility
        try:
        ...
        if not pyproject_path.exists():
            raise RuntimeError("Unable to locate pyproject.toml to determine dvt-core/dbt-core version")
        ...
        raise RuntimeError("Unable to determine dvt-core/dbt-core version from pyproject.toml")
