...
class NodalRelease(_message.Message):
    __slots__ = ("no", "user_defined_name_enabled", "name", "nodes", "nodal_release_type", "release_location", "released_members", "released_surfaces", "released_solids", "generated_released_objects", "deactivated", "define_release_type_for_each_object", "define_release_type_table", "comment", "id_for_export_import", "metadata_for_export_import")
