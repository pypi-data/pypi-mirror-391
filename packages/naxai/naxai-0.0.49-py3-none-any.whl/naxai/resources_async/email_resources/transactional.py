"""
Asynchronous transactional email resource for the Naxai SDK.

This module provides asynchronous methods for sending transactional emails through the
Naxai platform, including personalized, event-triggered communications such as account
