"""
Asynchronous SMS resource for the Naxai SDK.

This module provides asynchronous SMS messaging capabilities for the Naxai platform,
including sending text messages to individual recipients or groups, tracking message
delivery and engagement through activity logs, and analyzing messaging performance through
    ...
    async def send(self,
        ...
        Args:
            ...
            type_ (Literal["text", "unicode", "auto"], optional): The encoding type for the message.
                ...
                - "unicode": Unicode encoding for messages with special
                            characters (max 70 chars per part)
            ...
            idempotency_key (str, optional): A unique key to prevent duplicate message sending.
                If you retry a request with the same idempotency_key, only the first
            ...
            truncate (bool, optional): Whether to truncate messages that exceed the maximum length.
                If False and the message exceeds the maximum length or max_parts, an 
