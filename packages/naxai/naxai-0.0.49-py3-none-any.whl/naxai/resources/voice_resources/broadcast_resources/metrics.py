"""
Voice broadcast metrics resource for the Naxai SDK.

This module provides methods for retrieving and analyzing performance metrics for voice
broadcast campaigns, including call outcome statistics, delivery rates, and engagement
data. It also serves as a container for more specialized metrics resources such as
input tracking, helping users evaluate the effectiveness of their voice broadcasts.
