"""
SMS reporting resource for the Naxai SDK.

This module provides methods for retrieving and analyzing SMS messaging metrics,
including outgoing message statistics, delivery error reports, incoming message
...
class ReportingResource:
    ...
    def list_incoming_metrics(self,
        ...
        Example:
            ...
            >>> if daily_metrics.stats:
            ...     busiest_day = max(daily_metrics.stats, key=lambda day: day.sms)
            ...     print(f"Busiest day: {busiest_day.date} with {busiest_day.sms}"
            ...            " incoming messages")
