"""
Webhooks resource for the Naxai SDK.
...
class WebhooksResource:
    ...
    def update(self,
        ...
        Example:
            ...
            ... )
            >>> updated = client.webhooks.update([update_op])
        ...
        return UpdateWebhookResponse.model_validate_json(
            json.dumps(self._client._request("PATCH",
                                             self.root_path + "/" + webhook_id,
                                             json=json_str,
                                             headers=self.headers)
                                                   ))

    def list_last_events(self, webhook_id: str):
        """
        ...
        Example:
            >>> events = client.webhooks.list_last_events("wh_123abc")
