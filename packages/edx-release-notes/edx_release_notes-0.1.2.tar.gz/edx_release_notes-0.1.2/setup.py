#!/usr/bin/env python
"""
Package metadata for release_notes.
"""
import os
import re
import sys
...
VERSION = get_version('release_notes', '__init__.py')
...
setup(
    ...
    version=VERSION,
    description="""Edx Release Notes Backend.""",
    ...
    entry_points={
        "lms.djangoapp": [
            "release_notes = release_notes.apps:ReleaseNotesConfig",
        ],
        "cms.djangoapp": [
            "release_notes = release_notes.apps:ReleaseNotesConfig",
        ],
    },
    url='https://github.com/edx/release-notes',
    packages=find_packages(
        include=['release_notes', 'release_notes.*'],
        exclude=["*tests"],
    ),
