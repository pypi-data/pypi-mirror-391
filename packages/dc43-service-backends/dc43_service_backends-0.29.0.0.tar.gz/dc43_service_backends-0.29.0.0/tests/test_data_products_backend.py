...
def test_delta_backend_prefers_release_over_rc(tmp_path: Path) -> None:
    ...
    assert latest is not None
    assert latest.version == "0.29.0.0"


def test_version_key_orders_pre_releases() -> None:
    assert version_key("0.29.0.0dev1") < version_key("0.29.0.0rc1")
    assert version_key("0.29.0.0rc1") < version_key("0.29.0.0")
    assert version_key("0.29.0.0rc2") < version_key("0.29.0.0rc10")
    assert version_key("0.29.0.0draft2") < version_key("0.29.0.0draft10")
    assert version_key("0.29.0.0draft1") < version_key("0.29.0.0rc1")
