...
class WorkflowWithEntityAndFields(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["urls", "navigationMode", "name", "description", "tags", "limit", "location", "monitoring", "interval", "schedules", "bypassPreview", "autoStart", "interactions", "dataValidationEnabled", "additionalData", "entity", "fields"]
