...
"""
PyGremlinBox CDDL-1.0 - Supply chain security testing module.

This package is licenced under the Common Development and Distribution License 1.0 (CDDL-1.0).
...
maintaining compliance with CDDL-1.0 requirements.
"""

__version__ = "1.4.0"
__licence__ = "CDDL-1.0"
...
def get_package_metadata():
    ...
    """
    return {
        "name": "pygremlinbox-cddl-1-0",
        "version": __version__,
        "licence": __licence__,
        "description": "Supply chain security testing module with Common Development and Distribution License 1.0",
        "spdx_licence_id": "CDDL-1.0"
    }
