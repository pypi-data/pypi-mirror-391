...
def frps_cleanup(*, keep_dir: bool) -> int:
    ...
    service_units = _discover_frps_units(systemd_path)

    _run_systemctl(["stop", "frps"], require_sudo=True)
    _run_systemctl(["disable", "frps"], require_sudo=True)
    ...
    template_file = systemd_path / "frps@.service"
    ...
    base_service = systemd_path / "frps.service"
