...
#    Models Generator
##############################
class CompeletedCodeGenerator(GeneratorInterface):
    """
    ...
    def generate(self):
        """
        Generates GUI code based on provided python code and saves it to the specified output directory.
        ...
        template = env.get_template('complete_code.py.j2')
