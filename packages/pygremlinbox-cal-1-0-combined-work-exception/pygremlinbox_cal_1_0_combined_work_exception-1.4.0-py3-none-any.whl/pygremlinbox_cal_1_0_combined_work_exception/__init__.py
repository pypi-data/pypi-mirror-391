...
"""
PyGremlinBox CAL-1.0-Combined-Work-Exception - Supply chain security testing module.

This package is licenced under CAL-1.0-Combined-Work-Exception.
...
maintaining compliance with CAL-1.0-Combined-Work-Exception requirements.
"""

__version__ = "1.4.0"
__licence__ = "CAL-1.0-Combined-Work-Exception"
...
def get_package_metadata():
    ...
    """
    return {
        "name": "PyGremlinBox-CAL-1-0-Combined-Work-Exception",
        "version": __version__,
        "licence": __licence__,
        "description": "Supply chain security testing module with CAL-1.0-Combined-Work-Exception licence",
        "spdx_licence_id": "CAL-1.0-Combined-Work-Exception"
    }
