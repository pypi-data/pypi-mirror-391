...
"""
PyGremlinBox LGPL-3.0 - Supply chain security testing module.

This package is licenced under the GNU Lesser General Public License v3.0 (LGPL-3.0).
...
def get_package_metadata():
    ...
    """
    return {
        "name": "pygremlinbox-lgpl-3.0",
        "version": __version__,
        "licence": __licence__,
        "description": "Supply chain security testing module with LGPL-3.0 licence",
        "spdx_licence_id": "LGPL-3.0"
    }
