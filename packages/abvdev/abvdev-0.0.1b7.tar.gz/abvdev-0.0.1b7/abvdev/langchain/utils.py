...
#   Decided to not make this a dependency of abv as few people will have this. Need to match these models manually
...
def _extract_model_name(
    ...
    **kwargs: Any,
    ...
    """Extracts the model name from the serialized or kwargs object. This is used to get the model names for ABV."""
    ...
    # Third, for some models, we are unable to extract the model by a path in an object. ABV provides us with a string representation of the model pbjects
