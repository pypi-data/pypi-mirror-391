...
# our own api errors
from abvdev._utils.request import APIError, APIErrors
from abvdev.api.core import ApiError

# fern api errors
from abvdev.api.resources.commons.errors import (
    AccessDeniedError,
    Error,
...
from abvdev.api.resources.health.errors import ServiceUnavailableError
