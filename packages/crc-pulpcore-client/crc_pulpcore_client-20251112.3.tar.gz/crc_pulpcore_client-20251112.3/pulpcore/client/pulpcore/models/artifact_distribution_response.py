...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["base_path", "hidden", "pulp_created", "no_content_change_since", "pulp_labels", "content_guard", "base_url", "name", "pulp_href", "pulp_last_updated", "prn"]
