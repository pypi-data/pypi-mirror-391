...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["prn", "pulp_created", "base_url", "pulp_labels", "pulp_last_updated", "pulp_href", "base_path", "hidden", "content_guard", "name", "no_content_change_since"]
