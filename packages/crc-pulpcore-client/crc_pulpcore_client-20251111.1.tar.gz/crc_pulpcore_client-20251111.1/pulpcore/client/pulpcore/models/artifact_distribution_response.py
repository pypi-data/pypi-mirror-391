...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "content_guard", "no_content_change_since", "pulp_last_updated", "pulp_labels", "prn", "pulp_created", "hidden", "base_url", "base_path", "pulp_href"]
