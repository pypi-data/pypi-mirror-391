...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["hidden", "pulp_created", "base_url", "pulp_last_updated", "name", "pulp_href", "content_guard", "no_content_change_since", "pulp_labels", "prn", "base_path"]
