...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["prn", "hidden", "no_content_change_since", "pulp_last_updated", "name", "pulp_labels", "base_path", "pulp_created", "content_guard", "base_url", "pulp_href"]
