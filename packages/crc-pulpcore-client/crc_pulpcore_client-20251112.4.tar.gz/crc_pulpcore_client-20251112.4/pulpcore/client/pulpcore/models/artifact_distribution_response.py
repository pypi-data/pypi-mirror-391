...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["no_content_change_since", "pulp_last_updated", "pulp_labels", "pulp_href", "hidden", "base_path", "base_url", "content_guard", "pulp_created", "prn", "name"]
