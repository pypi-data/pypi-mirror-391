...
class AppStreamClient(AioBaseClient):
    ...
    async def associate_software_to_image_builder(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_appstream/client/#associate_software_to_image_builder)
        """
    ...
    async def describe_app_license_usage(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_appstream/client/#describe_app_license_usage)
        """
    ...
    async def describe_software_associations(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_appstream/client/#describe_software_associations)
        """
    ...
    async def disassociate_software_from_image_builder(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_appstream/client/#disassociate_software_from_image_builder)
        """
    ...
    async def start_software_deployment_to_image_builder(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_appstream/client/#start_software_deployment_to_image_builder)
        """
