...
def send_invoice_anaf(
    ...
    with open(r"E:\ENCORSA\e-Factura-V2\e-Factura-PythonLibrary\Encorsa_e_Factura\tests\Playground\scalars.json", "w") as f:
        f.write(json.dumps(scalars_map, indent=4))
    
    print("Got XML from Builder: ")
    with open(r"E:\ENCORSA\e-Factura-V2\e-Factura-PythonLibrary\Encorsa_e_Factura\tests\Playground\result.xml", "w") as f:
        f.write(str(xml_str))
