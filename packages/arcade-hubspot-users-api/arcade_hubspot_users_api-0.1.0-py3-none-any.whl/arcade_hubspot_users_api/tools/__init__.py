...
@tool(requires_auth=OAuth2(id="arcade-hubspot", scopes=["settings.users.teams.read"]))
...
@tool(
    requires_auth=OAuth2(
        id="arcade-hubspot", scopes=["crm.objects.users.read", "settings.users.read"]
    )
)
...
@tool(
    requires_auth=OAuth2(
        id="arcade-hubspot", scopes=["crm.objects.users.write", "settings.users.write"]
    )
)
