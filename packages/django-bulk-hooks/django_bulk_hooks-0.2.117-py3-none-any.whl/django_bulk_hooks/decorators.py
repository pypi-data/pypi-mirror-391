...
def _validate_and_extract_fields(fields: tuple, model_cls: Type[models.Model]) -> tuple:
    ...
    Automatically expands related fields to include MTI child models,
    ensuring that select_related loads the complete object graph.
    ...
    # Auto-expand MTI child models
    expanded_fields = expand_mti_related_fields(fields, model_cls)

    logger.info(f"VALIDATE FIELDS: expanded to {expanded_fields}")
