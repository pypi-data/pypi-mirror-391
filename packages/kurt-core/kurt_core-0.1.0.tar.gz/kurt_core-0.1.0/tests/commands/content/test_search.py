...
class TestContentSearchCommand:
    ...
    def test_search_no_sources_directory(self, isolated_cli_runner):
        ...
        assert "not exist" in result.output or "No documents" in result.output or "no content files" in result.output
    ...
    def test_search_basic(self, isolated_cli_runner):
        ...
        content_file.write_text("This is a test document.\nIt contains authentication information.\nAnother line here.")
    ...
    def test_search_with_include_pattern(self, isolated_cli_runner):
        ...
        # Search only in docs
        result = runner.invoke(main, ["content", "search", "authentication", "--include", "*/docs/*"])
