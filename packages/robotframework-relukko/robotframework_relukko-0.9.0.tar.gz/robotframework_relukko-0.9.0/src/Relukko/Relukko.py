...
class Relukko:
    ...
    | acquire_wait_for_timeout    | pyrelukko.pyrelukko |     |
    | acquire_modulo              | pyrelukko.pyrelukko |     |
    | disable_websocket           | pyrelukko.pyrelukko |     |
    | raise_when_acquire_fails    | pyrelukko.pyrelukko | (11) |
    | ws_ping_interval            | pyrelukko.pyrelukko |     |
    | ws_ping_timeout             | pyrelukko.pyrelukko |     |
    | ws_wait_for_timeout         | pyrelukko.pyrelukko |     |
    ...
    def acquire_relukko(
        ...
        if self.lock is not None and isinstance(self.lock, Dict):
    ...
    def get_relukko_created_at_time(self, refresh: bool=False) -> datetime:
        ...
        created_at = datetime.fromisoformat(self.lock.get("created_at"))
