...
try:
    ...
    (
        ...
        # 步骤 5: 添加标注与收尾
        .add_grouped_labels(groups={'a': ['main_plot'], 'b': ['side_plots.twin_axis_plot', 'side_plots.subgrid_group.detail_A', 'side_plots.subgrid_group.detail_B']}, fontsize=14)
        .add_subplot_labels(tags=['side_plots.twin_axis_plot', 'side_plots.subgrid_group.detail_A', 'side_plots.subgrid_group.detail_B'],
    label_style='numeric',
    template='{label}.',
    position=(0.05,1),
                            )
