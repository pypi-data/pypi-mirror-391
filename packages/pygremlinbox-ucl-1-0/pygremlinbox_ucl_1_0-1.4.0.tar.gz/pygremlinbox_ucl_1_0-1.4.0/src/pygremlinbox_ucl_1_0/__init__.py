...
"""
PyGremlinBox UCL-1.0 - Supply chain security testing module.

This package is licenced under UCL-1.0.
...
maintaining compliance with UCL-1.0 requirements.
"""
...
def get_package_metadata():
    ...
    """
    return {
        "name": "PyGremlinBox-UCL-1-0",
        "version": __version__,
        "licence": __licence__,
        "description": "Supply chain security testing module with UCL-1.0 licence",
        "spdx_licence_id": "UCL-1.0"
    }
