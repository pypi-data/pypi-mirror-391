...
"""
PyGremlinBox CC-BY-NC-SA-3.0-IGO - Supply chain security testing module.

This package is licenced under CC-BY-NC-SA-3.0-IGO.
...
maintaining compliance with CC-BY-NC-SA-3.0-IGO requirements.
"""

__version__ = "1.4.0"
__licence__ = "CC-BY-NC-SA-3.0-IGO"
...
def get_package_metadata():
    ...
    """
    return {
        "name": "PyGremlinBox-CC-BY-NC-SA-3-0-IGO",
        "version": __version__,
        "licence": __licence__,
        "description": "Supply chain security testing module with CC-BY-NC-SA-3.0-IGO licence",
        "spdx_licence_id": "CC-BY-NC-SA-3.0-IGO"
    }
